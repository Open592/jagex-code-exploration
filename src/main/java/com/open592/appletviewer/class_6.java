...
final class class_6 extends WindowAdapter implements ActionListener {
   ...
   class_6(String var1) {
      ...
      this.field_22 = new Dialog(AppletViewer.field_35, AppletViewer.method_19("information", 0), true);
      TextArea var2 = new TextArea();
      var2.setText(AppletViewer.method_19("copy_paste_url", 0) + ":\n" + var1);
      var2.setEditable(false);
      this.field_22.add(var2);
      Button var3 = new Button(AppletViewer.method_19("ok", 0));
