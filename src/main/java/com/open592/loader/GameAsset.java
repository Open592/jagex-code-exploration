...
public class GameAsset {
    ...
    public GameAsset(
        ...
        try {
            ...
            throw LoaderRuntimeException.create(e, "b.<init>(" + (localFilename != null ? "{...}" : "null") + ',' + (remoteFilename != null ? "{...}" : "null") + ',' + (loadingStatusContent != null ? "{...}" : "null") + ',' + uncompressedSize + ',' + compressedSize + ',' + (sha1Bytes != null ? "{...}" : "null") + ')');
        }
    }
}
