...
public class Cache implements Runnable {
    ...
    private class_4 method_32(int var1, Object var2, int var4, int var5) {
        class_4 var6 = new class_4();
    ...
    public final class_4 method_34(int var1, Component var2, boolean var3) {
        return var1 != -23993 ? (class_4) null : this.method_32(15, var2, var3 ? 1 : 0, 0);
    }
    ...
    public final class_4 method_42(URL var1, int var2) {
        ...
        return this.method_32(4, var1, 0, 0);
    }
    ...
    public File resolveCacheFilePath(String filename, int modewhat, String gameName) {
        ...
        if (null != var4) {
            ...
            String[] var6 = new String[]{".jagex_cache_" + modewhat, ".file_store_" + modewhat};

            for (int var7 = 0; ~var7 > -3; ++var7) {
                for (String s : var6) {
                    for (int var9 = 0; ~var5.length < ~var9; ++var9) {
                        String var10 = var5[var9] + s + "/" + (null == gameName ? "" : gameName + "/") + filename;
                        ...
                        try {
                            ...
                            if (~var7 != -1 || var12.exists()) {
                                ...
                                if (~var7 != -2 || -1 <= ~var13.length() || (new File(var13)).exists()) {
                                    (new File(var5[var9] + s)).mkdir();
                                    if (null != gameName) {
                                        (new File(var5[var9] + s + "/" + gameName)).mkdir();
                                    }
