...
public final class Static439 {
	...
	public static void dropSettingsCookie(@OriginalArg(1) String settings) {
		...
		try {
			@Pc(18) String cookiePrefix = GameShell.signLink.hostApplet.getParameter("cookieprefix");
			@Pc(23) String cookieHost = GameShell.signLink.hostApplet.getParameter("cookiehost");
			...
			Static458.evaluateJavaScript("document.cookie=\"" + cookieString + "\"", GameShell.signLink.hostApplet);
	...
	public static boolean method5554(@OriginalArg(0) Class76 arg0, @OriginalArg(1) Node_Sub15_Sub1 arg1, @OriginalArg(2) Class76 arg2, @OriginalArg(3) Class76 arg3) {
