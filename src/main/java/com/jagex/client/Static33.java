...
public final class Static33 {
  ...
  public static int method631(@OriginalArg(1) Class16_Sub1_Sub5_Sub1 arg0) {
    @Pc(14)
    int local14 = arg0.anInt4333;
    @Pc(18)
    Class151 local18 = arg0.method4757();
    if (arg0.aBoolean562) {
      local14 = arg0.anInt4313;
    } else if (local18.anInt4669 == arg0.anInt6076
        || arg0.anInt6076 == local18.anInt4656
        || local18.anInt4665 == arg0.anInt6076
        || local18.anInt4686 == arg0.anInt6076) {
      local14 = arg0.anInt4322;
    } else if (arg0.anInt6076 == local18.anInt4667
        || local18.anInt4681 == arg0.anInt6076
        || arg0.anInt6076 == local18.anInt4688
        || arg0.anInt6076 == local18.anInt4675) {
  ...
  public static void method632(
      ...
      @OriginalArg(3) Class16_Sub1_Sub5_Sub2 arg2) {
    if (arg0 == arg2.anInt6021 && arg0 != -1) {
      @Pc(25)
      Class138 local25 = Static182.aClass55_1.method1397(arg0);
      @Pc(28)
      int local28 = local25.anInt4406;
      if (local28 == 1) {
        arg2.anInt6046 = arg1;
        arg2.anInt6060 = 0;
        arg2.anInt6058 = 1;
        ...
        arg2.anInt6073 = 0;
        Static15.method156(
            arg2.anInt6893, arg2.anInt6060, arg2.aByte82, arg2.anInt6892, local25, false);
      }
      if (local28 == 2) {
        arg2.anInt6012 = 0;
        return;
        ...
        || arg2.anInt6021 == -1
        || Static182.aClass55_1.method1397(arg0).anInt4413
            >= Static182.aClass55_1.method1397(arg2.anInt6021).anInt4413) {
      arg2.anInt6012 = 0;
      arg2.anInt6058 = 1;
      arg2.anInt6073 = 0;
      ...
      Static15.method156(
          ...
          arg2.aByte82,
          arg2.anInt6892,
          Static182.aClass55_1.method1397(arg2.anInt6021),
          false);
    }
  }
  ...
  public static boolean method634(
    ...
    @Pc(50)
    int local50 = local41 + 1;
    Static416.anIntArray526[0] = arg7;
    @Pc(55)
    int[][] local55 = arg1.anIntArrayArray48;
    while (local50 != local43) {
      local7 = Static129.anIntArray182[local43];
      local9 = Static416.anIntArray526[local43];
      @Pc(70)
      int local70 = local9 - local33;
      local43 = local43 + 1 & 0xFFF;
      @Pc(81)
      int local81 = local7 - local23;
      @Pc(87)
      int local87 = local7 - arg1.anInt6230;
      @Pc(92)
      int local92 = local9 - arg1.anInt6235;
      if (arg0 == -4) {
      ...
      @Pc(251)
      int local251 = Static14.anIntArrayArray1[local81][local70] + 1;
      if (local81 > 0
          && Static159.anIntArrayArray30[local81 - 1][local70] == 0
          && (local55[local87 - 1][local92] & 0x43A40000) == 0
          && (local55[local87 - 1][local92 + 1] & 0x4E240000) == 0) {
      ...
      if (local81 < 126
          && Static159.anIntArrayArray30[local81 + 1][local70] == 0
          && (local55[local87 + 2][local92] & 0x60E40000) == 0
          && (local55[local87 + 2][local92 + 1] & 0x78240000) == 0) {
        Static129.anIntArray182[local50] = local7 + 1;
        Static416.anIntArray526[local50] = local9;
      ...
      if (local70 > 0
          && Static159.anIntArrayArray30[local81][local70 - 1] == 0
          && (local55[local87][local92 - 1] & 0x43A40000) == 0
          && (local55[local87 + 1][local92 - 1] & 0x60E40000) == 0) {
      ...
      if (local70 < 126
          && Static159.anIntArrayArray30[local81][local70 + 1] == 0
          && (local55[local87][local92 + 2] & 0x4E240000) == 0
          && (local55[local87 + 1][local92 + 2] & 0x78240000) == 0) {
        Static129.anIntArray182[local50] = local7;
        Static416.anIntArray526[local50] = local9 + 1;
        local50 = local50 + 1 & 0xFFF;
      ...
      if (local81 > 0
          && local70 > 0
          && Static159.anIntArrayArray30[local81 - 1][local70 - 1] == 0
          && (local55[local87 - 1][local92] & 0x4FA40000) == 0
          && (local55[local87 - 1][local92 - 1] & 0x43A40000) == 0
          && (local55[local87][local92 - 1] & 0x63E40000) == 0) {
        Static129.anIntArray182[local50] = local7 - 1;
        Static416.anIntArray526[local50] = local9 - 1;
      ...
      if (local81 < 126
          && local70 > 0
          && Static159.anIntArrayArray30[local81 + 1][local70 - 1] == 0
          && (local55[local87 + 1][local92 - 1] & 0x63E40000) == 0
          && (local55[local87 + 2][local92 - 1] & 0x60E40000) == 0
          && (local55[local87 + 2][local92] & 0x78E40000) == 0) {
        Static129.anIntArray182[local50] = local7 + 1;
        Static416.anIntArray526[local50] = local9 - 1;
        local50 = local50 + 1 & 0xFFF;
      ...
      if (local81 > 0
          && local70 < 126
          && Static159.anIntArrayArray30[local81 - 1][local70 + 1] == 0
          && (local55[local87 - 1][local92 + 1] & 0x4FA40000) == 0
          && (local55[local87 - 1][local92 + 2] & 0x4E240000) == 0
          && (local55[local87][local92 + 2] & 0x7E240000) == 0) {
        Static129.anIntArray182[local50] = local7 - 1;
        Static416.anIntArray526[local50] = local9 + 1;
      ...
      if (local81 < 126
          && local70 < 126
          && Static159.anIntArrayArray30[local81 + 1][local70 + 1] == 0
          && (local55[local87 + 1][local92 + 2] & 0x7E240000) == 0
          && (local55[local87 + 2][local92 + 2] & 0x78240000) == 0
          && (local55[local87 + 2][local92 + 1] & 0x78E40000) == 0) {
        Static129.anIntArray182[local50] = local7 + 1;
        Static416.anIntArray526[local50] = local9 + 1;
        local50 = local50 + 1 & 0xFFF;
