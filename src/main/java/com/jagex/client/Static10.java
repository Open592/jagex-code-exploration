...
public final class Static10 {
  ...
  public static boolean method102(
    ...
    if (arg1 != arg2 || arg3 != arg4) {
      ...
      @Pc(142)
      int local142 = (arg3 << Static231.anInt4434) + 2;
      @Pc(151)
      int local151 = Static417.aClass65Array4[arg0].l(arg1, arg3) + arg5;
      if (!Static299.method4088(local20, local151, local142)) {
        return false;
      }
      @Pc(164)
      int local164 = (arg2 << Static231.anInt4434) - 1;
      if (!Static299.method4088(local164, local151, local142)) {
        return false;
      }
      @Pc(177)
      int local177 = (arg4 << Static231.anInt4434) - 1;
      ...
      return Static299.method4088(
              local16 + 1, Static417.aClass65Array4[arg0].l(arg1, arg3) + arg5, local20 + 1)
          && Static299.method4088(
              local16 + Static4.anInt5935 - 1,
              Static417.aClass65Array4[arg0].l(arg1 + 1, arg3) + arg5,
              local20 + 1)
          && Static299.method4088(
              local16 + Static4.anInt5935 - 1,
              Static417.aClass65Array4[arg0].l(arg1 + 1, arg3 + 1) + arg5,
              local20 + Static4.anInt5935 - 1)
          && Static299.method4088(
              local16 + 1,
              Static417.aClass65Array4[arg0].l(arg1, arg3 + 1) + arg5,
              local20 + Static4.anInt5935 - 1);
    } else {
      return false;
    }
