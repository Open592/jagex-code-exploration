...
public final class Static179 {
  ...
  @OriginalMember(
      owner = "client!ja",
      name = "a",
      descriptor = "(IIZLjava/lang/String;ZZIIJLjava/lang/String;I)V")
  public static void method2848(
      ...
      @OriginalArg(9) String arg8,
      @OriginalArg(10) int arg9) {
    @Pc(8)
    int[] local8 = new int[4];
    for (@Pc(10) int local10 = 0; local10 < 3; local10++) {
      local8[local10] = (int) (Math.random() * 9.9999999E7D);
    }
    @Pc(30)
    Packet local30 = new Packet(128);
    local30.p1(10);
    ...
    local120.pjstr(arg8);
    @Pc(134)
    int local134 = 8 - Static269.method3856(arg8) % 8;
  ...
  public static void method2849(@OriginalArg(0) Class16_Sub1_Sub5 arg0) {
    ...
    if (arg0.anInt6023 == client.gameLogicStepCount
        || arg0.anInt6021 == -1
        || arg0.anInt6046 != 0) {
      local5 = true;
    } else {
      @Pc(26)
      Class138 local26 = Static182.aClass55_1.method1397(arg0.anInt6021);
    ...
    if (local5) {
      @Pc(54)
      int local54 = arg0.anInt6023 - arg0.anInt6018;
      @Pc(60)
      int local60 = client.gameLogicStepCount - arg0.anInt6018;
      @Pc(71)
      int local71 = arg0.anInt6043 * 128 + arg0.method4751() * 64;
      @Pc(83)
      int local83 = arg0.anInt6052 * 128 + arg0.method4751() * 64;
      @Pc(95)
      int local95 = arg0.anInt6044 * 128 + arg0.method4751() * 64;
      @Pc(107)
      int local107 = arg0.anInt6074 * 128 + arg0.method4751() * 64;
