...
public final class Node_Sub6_Sub33 extends Node_Sub6 {
  ...
  public int[] method5510(@OriginalArg(1) int arg0) {
    ...
    if (super.aClass82_41.aBoolean243) {
      ...
      @Pc(33)
      int local33 = local27 - 2048 >> 1;
      for (@Pc(35) int local35 = 0; local35 < Static80.anInt1616; local35++) {
        @Pc(41)
        int local41 = Static341.anIntArray504[local35];
        @Pc(47)
        int local47 = local41 - 2048 >> 1;
        @Pc(70)
        int local70;
        if (this.anInt6439 == 0) {
          ...
          @Pc(60)
          int local60 = local33 * local33 + local47 * local47 >> 12;
