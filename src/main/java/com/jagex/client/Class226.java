...
public final class Class226 {
  ...
  public void method5022() {
    @Pc(11)
    Class68 local11 = this.aClass68_46;
    synchronized (this.aClass68_46) {
  ...
  public void method5024() {
    @Pc(2)
    Class68 local2 = this.aClass68_46;
    synchronized (this.aClass68_46) {
  ...
  public Class58 method5025(@OriginalArg(1) int arg0) {
    @Pc(6)
    Class68 local6 = this.aClass68_46;
    @Pc(16)
    Class58 local16;
    synchronized (this.aClass68_46) {
    ...
    @Pc(38)
    byte[] local38 = this.aJs5_88.method2104(arg0, 30);
    local16 = new Class58();
    if (local38 != null) {
      local16.method1509(new Packet(local38));
    }
    @Pc(54)
    Class68 local54 = this.aClass68_46;
    synchronized (this.aClass68_46) {
