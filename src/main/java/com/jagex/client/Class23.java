...
public final class Class23 {
  ...
  private SecondaryNode_Sub1_Sub4 aClass4_Sub1_Sub4_2;
  ...
  @OriginalMember(
      owner = "client!bi",
      name = "<init>",
      descriptor = "(Lclient!ya;Lclient!rd;IIIIIIZI)V")
  public Class23(
      @OriginalArg(0) Class19 arg0,
      @OriginalArg(1) Class202 arg1,
  ...
  public Class110 method578(
      @OriginalArg(0) int arg0,
      @OriginalArg(1) boolean arg1,
      @OriginalArg(2) Class19 arg2,
      @OriginalArg(3) int arg3,
      @OriginalArg(4) int arg4,
      @OriginalArg(6) boolean arg5) {
    @Pc(11)
    Class202 local11 = Static267.aClass262_2.method5560(this.anInt548);
    ...
    if (local110) {
      Static110.method2015(
          this.aClass4_Sub1_Sub4_2,
          this.aByte10,
          this.anInt543,
          this.anInt544,
          this.aBooleanArray4);
    ...
    @Pc(142)
    Class65 local142 = Static417.aClass65Array4[this.aByte10];
    @Pc(160)
    Class65 local160;
    if (this.aBoolean56) {
    ...
    if (this.aClass138_1 != null) {
      ...
      local168 =
          local11.method4594(
              this.anInt536 == 11 ? 10 : this.anInt536,
              local142.a(this.anInt543, this.anInt544),
              this.anInt533,
              this.anInt538,
              arg2,
              this.aClass138_1,
              this.anInt552,
              this.anInt543,
              this.anInt536 == 11 ? this.anInt551 + 4 : this.anInt551,
              this.anInt544,
              arg4,
              local160,
              local142);
      if (local168 == null) {
        ...
        if (local110) {
          ...
          Static52.method844(
              this.aClass4_Sub1_Sub4_2, this.aByte10, arg3, arg0, this.aBooleanArray4);
        }
        this.anInt535 = local168.MA();
      }
      this.aClass110_3 = null;
    } else if (this.aClass110_3 != null
        && arg4 == (this.aClass110_3.P() & arg4)
        && this.anInt539 == local11.anInt5823) {
  ...
  private void method579(@OriginalArg(0) int arg0) {
    ...
    if (arg0 == -1) {
      @Pc(19)
      Class202 local19 = Static267.aClass262_2.method5560(this.anInt548);
      @Pc(21)
      Class202 local21 = local19;
      ...
      if (local19.anIntArray405 != null) {
        ...
        } else if (local21 != null
            && local21.anInt5840 != -1
            && local21.anInt5823 != this.anInt539) {
    ...
    if (local9) {
      ...
      this.anInt533 =
          (int) (Math.random() * (double) this.aClass138_1.anIntArray296[this.anInt538]) + 1;
    } else {
      this.anInt533 = 1;
      this.anInt538 = 0;
    }
  ...
  private void method585(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
    ...
    while (true) {
      ...
      @Pc(33)
      int local33 = client.gameLogicStepCount - this.anInt549;
      if (local33 > 100 && this.aClass138_1.anInt4405 > 0) {
        @Pc(49)
        int local49 = this.aClass138_1.anIntArray295.length - this.aClass138_1.anInt4405;
        ...
        if (this.anInt538 >= local49) {
          @Pc(92)
          int local92 = 0;
          for (@Pc(94) int local94 = local49;
              local94 < this.aClass138_1.anIntArray295.length;
              local94++) {
  ...
  public void method586(
      ...
      @OriginalArg(3) Class110 arg2,
      @OriginalArg(4) int arg3,
      @OriginalArg(5) Class19 arg4,
      @OriginalArg(6) int arg5,
      @OriginalArg(7) int arg6) {
    @Pc(6)
    Class29[] local6 = arg2.method4881();
    @Pc(16)
    Class179[] local16 = arg2.method4885();
    if ((this.aClass3_Sub2_1 == null || this.aClass3_Sub2_1.aBoolean24)
        && (local6 != null || local16 != null)) {
      @Pc(33)
      Class202 local33 = Static267.aClass262_2.method5560(this.anInt548);
