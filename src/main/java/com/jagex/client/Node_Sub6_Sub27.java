...
public final class Node_Sub6_Sub27 extends Node_Sub6 {
  ...
  public int[] method5510(@OriginalArg(1) int arg0) {
    ...
    if (super.aClass82_41.aBoolean243) {
      for (@Pc(17) int local17 = 0; local17 < Static80.anInt1616; local17++) {
        @Pc(31)
        int local31 = (Static341.anIntArray504[local17] << 12) / this.anInt5238 + this.anInt5243;
        @Pc(43)
        int local43 = (Static165.anIntArray209[arg0] << 12) / this.anInt5238 + this.anInt5239;
        @Pc(49)
        int local49 = local31;
        @Pc(51)
        int local51 = local43;
        @Pc(57)
        int local57 = local31 * local31 >> 12;
        @Pc(63)
        int local63 = local43 * local43 >> 12;
        @Pc(65)
        int local65 = 0;
