...
public final class Node_Sub6_Sub3_Sub1 extends Node_Sub6_Sub3 {
  ...
  public int[][] method5514(@OriginalArg(1) int arg0) {
    ...
    if (super.aClass153_41.aBoolean437 && this.method986()) {
      @Pc(23)
      int[] local23 = local11[0];
      @Pc(27)
      int[] local27 = local11[1];
      @Pc(31)
      int[] local31 = local11[2];
      @Pc(39)
      int local39 = super.anInt1086 * (arg0 % super.anInt1086);
      for (@Pc(41) int local41 = 0; local41 < Static80.anInt1616; local41++) {
        @Pc(53)
        int local53 = super.anIntArray62[local39 + local41 % super.anInt1078];
