...
public final class Class40 {
	...
	private void method915(@OriginalArg(0) Class19_Sub2 arg0, @OriginalArg(1) int arg1) {
		...
		this.aClass4_Sub12_Sub2_1.position = 0;
			...
			for (local101 = arg1 - 1; local101 >= 0; local101--) {
				...
				if (local116 > 0) {
					for (local125 = local116 - 1; local125 >= 0; local125--) {
						...
						this.aClass4_Sub12_Sub2_1.writeByte(local142);
						this.aClass4_Sub12_Sub2_1.writeByte(local147);
						this.aClass4_Sub12_Sub2_1.writeByte(local150);
						this.aClass4_Sub12_Sub2_1.writeByte(local155);
					...
					if (this.anIntArray58[local101] > 64) {
						...
						for (local137 = this.anIntArray57[local442] - 1; local137 >= 0; local137--) {
							...
							this.aClass4_Sub12_Sub2_1.writeByte(local150);
							this.aClass4_Sub12_Sub2_1.writeByte(local155);
							this.aClass4_Sub12_Sub2_1.writeByte(local474);
							this.aClass4_Sub12_Sub2_1.writeByte(local479);
							this.aClass4_Sub12_Sub2_1.method2556(1.0F);
							this.aClass4_Sub12_Sub2_1.method2556(0.0F);
		...
		if (this.aClass4_Sub12_Sub2_1.position != 0) {
			this.anInterface11_1.method5184(this.aClass4_Sub12_Sub2_1.position, 24, this.aClass4_Sub12_Sub2_1.bytes);
			arg0.method1934(this.aClass177_1, null, this.aClass177_3, this.aClass177_2);
			arg0.method1925(this.aClass4_Sub12_Sub2_1.position / 24);
		}
	}
