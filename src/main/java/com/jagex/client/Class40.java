...
public final class Class40 {
  ...
  private void method915(@OriginalArg(0) Class19_Sub2 arg0, @OriginalArg(1) int arg1) {
    ...
    @Pc(15)
    float local15 = this.aFloatArray4[0];
    @Pc(20)
    float local20 = this.aFloatArray4[4];
    @Pc(25)
    float local25 = this.aFloatArray4[8];
    @Pc(30)
    float local30 = this.aFloatArray4[1];
    @Pc(35)
    float local35 = this.aFloatArray4[5];
    @Pc(40)
    float local40 = this.aFloatArray4[9];
    @Pc(44)
    float local44 = local30 + local15;
    @Pc(48)
    float local48 = local20 + local35;
    @Pc(52)
    float local52 = local40 + local25;
    @Pc(57)
    float local57 = local15 - local30;
    @Pc(70)
    float local70 = local20 - local35;
    @Pc(75)
    float local75 = local25 - local40;
    @Pc(80)
    float local80 = local30 - local15;
    @Pc(85)
    float local85 = local35 - local20;
    this.aClass4_Sub12_Sub2_1.pos = 0;
    @Pc(94)
    float local94 = local40 - local25;
    @Pc(101)
    int local101;
    @Pc(116)
    int local116;
      ...
      for (local101 = arg1 - 1; local101 >= 0; local101--) {
        ...
        if (local116 > 0) {
          for (local125 = local116 - 1; local125 >= 0; local125--) {
            ...
            this.aClass4_Sub12_Sub2_1.p1(local142);
            this.aClass4_Sub12_Sub2_1.p1(local147);
            this.aClass4_Sub12_Sub2_1.p1(local150);
            this.aClass4_Sub12_Sub2_1.p1(local155);
          ...
          if (this.anIntArray58[local101] > 64) {
            ...
            for (local137 = this.anIntArray57[local442] - 1; local137 >= 0; local137--) {
              ...
              this.aClass4_Sub12_Sub2_1.p1(local150);
              this.aClass4_Sub12_Sub2_1.p1(local155);
              this.aClass4_Sub12_Sub2_1.p1(local474);
              this.aClass4_Sub12_Sub2_1.p1(local479);
              this.aClass4_Sub12_Sub2_1.method2556(1.0F);
              this.aClass4_Sub12_Sub2_1.method2556(0.0F);
    ...
    if (this.aClass4_Sub12_Sub2_1.pos != 0) {
      this.anInterface11_1.method5184(
          this.aClass4_Sub12_Sub2_1.pos, 24, this.aClass4_Sub12_Sub2_1.data);
      arg0.method1934(this.aClass177_1, null, this.aClass177_3, this.aClass177_2);
      arg0.method1925(this.aClass4_Sub12_Sub2_1.pos / 24);
    }
  }
  ...
  public void method916(@OriginalArg(1) Class146 arg0, @OriginalArg(2) Class19_Sub2 arg1) {
    ...
    this.method920(arg1);
    @Pc(17)
    float local17 = arg1.aClass31_Sub1_4.aFloat206;
    @Pc(21)
    float local21 = arg1.aClass31_Sub1_4.aFloat203;
    @Pc(25)
    float local25 = arg1.aClass31_Sub1_4.aFloat199;
    @Pc(37)
    float local37 = arg1.aClass31_Sub1_4.aFloat198;
    try {
      @Pc(47)
      int local47;
      @Pc(57)
      ...
      if (arg0.aBoolean417) {
        ...
        @Pc(79)
        Class3_Sub1 local79 = arg0.aClass232_1.aClass3_Sub1_7;
        local82 = local79.aClass3_Sub1_6;
        @Pc(84)
        int local84 = -2;
        @Pc(86)
        boolean local86 = true;
        @Pc(88)
        boolean local88 = true;
        while (local79 != local82) {
          ...
          while (local79 != local82) {
            @Pc(124)
            Class3_Sub1_Sub1 local124 = (Class3_Sub1_Sub1) local82;
            if (local88) {
            ...
            local188 =
                (int)
                            ((float) (local124.anInt4068 >> Static172.anInt3366) * local17
                                + (float) (local124.anInt4076 >> Static172.anInt3366) * local21
                                + (float) (local124.anInt4073 >> Static172.anInt3366) * local25
                                + local37)
                        - arg0.anInt4520
                    >> local57;
            if (local188 < 1600) {
              if (this.anIntArray58[local188] >= 64) {
                label198:
                {
                  ...
                  local245 =
                      this.aClass3_Sub1_Sub1ArrayArray2[this.anIntArray58[local188] - 64 - 1];
                  local255 = this.anIntArray58[local188] - 1 - 64;
                  local257 = this.anIntArray57[this.anIntArray58[local188] - 1 - 64];
                  this.anIntArray57[local255] =
                      this.anIntArray57[this.anIntArray58[local188] - 1 - 64] + 1;
                  local245[local257] = local124;
                }
              } else {
                this.aClass3_Sub1_Sub1ArrayArray1[local188][this.anIntArray58[local188]++] =
                    local124;
              }
            }
        ...
        @Pc(357)
        Class3_Sub1 local357;
        @Pc(389)
        int local389;
        for (local357 = local82.aClass3_Sub1_6;
            local357 != local82;
            local357 = local357.aClass3_Sub1_6) {
          @Pc(362)
          Class3_Sub1_Sub1 local362 = (Class3_Sub1_Sub1) local357;
          local389 =
              (int)
                  (local37
                      + (float) (local362.anInt4068 >> Static172.anInt3366) * local17
                      + local21 * (float) (local362.anInt4076 >> Static172.anInt3366)
                      + (float) (local362.anInt4073 >> Static172.anInt3366) * local25);
        ...
        local95 = -2;
        @Pc(451)
        boolean local451 = true;
        @Pc(453)
        boolean local453 = true;
        while (local357 != local82) {
          ...
          while (local357 != local82) {
            @Pc(489)
            Class3_Sub1_Sub1 local489 = (Class3_Sub1_Sub1) local357;
            if (local453) {
            ...
            if (local47 > 0
                && (local95 != local489.anInt4077 || local451 != local489.aBoolean375)) {
              local453 = true;
              break;
            }
            @Pc(532)
            int local532 = this.anIntArray59[local47++] - local57 >> local389;
            if (local532 < 1600) {
              if (this.anIntArray58[local532] < 64) {
                this.aClass3_Sub1_Sub1ArrayArray1[local532][this.anIntArray58[local532]++] =
                    local489;
              } else {
                label148:
                {
                  ...
                  this.anIntArray57[local255] =
                      this.anIntArray57[this.anIntArray58[local532] - 64 - 1] + 1;
