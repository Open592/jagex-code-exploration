...
public final class Class80_Sub1 extends Class80 implements MouseListener, MouseMotionListener {
  ...
  private int method2240(@OriginalArg(0) MouseEvent arg0) {
    @Pc(6)
    int local6 = arg0.getModifiers();
    @Pc(17)
    boolean local17 = (local6 & 0x10) != 0;
    @Pc(25)
    boolean local25 = (local6 & 0x8) != 0;
    @Pc(33)
    boolean local33 = (local6 & 0x4) != 0;
  ...
  public synchronized void mouseReleased(@OriginalArg(0) MouseEvent arg0) {
    @Pc(8)
    int local8 = this.method2240(arg0);
  ...
  public synchronized void method2236() {
    ...
    @Pc(25)
    LinkedList local25 = this.aLinkedList_16;
  ...
  private void method2243(
    ...
    @Pc(7)
    Node_Sub5_Sub1 local7 = new Node_Sub5_Sub1();
  ...
  public synchronized void mousePressed(@OriginalArg(0) MouseEvent arg0) {
    @Pc(10)
    int local10 = this.method2240(arg0);
    if (local10 == 1) {
