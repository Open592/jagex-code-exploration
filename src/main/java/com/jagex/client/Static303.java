...
public final class Static303 {
    ...
    try {
      if (Static27.anInt461 == 2) {
        if (Static143.aClass4_Sub30_2 == null) {
          Static143.aClass4_Sub30_2 =
              Static461.method3724(Static236.aJs5_49, Static14.anInt190, Static397.anInt742);
          if (Static143.aClass4_Sub30_2 == null) {
            return false;
          }
        }
        ...
        if (Static56.aClass4_Sub15_Sub1_1.method1456(
            Static419.aClass171_1, Static195.aJs5_43, Static143.aClass4_Sub30_2)) {
  ...
  public static void method4113(@OriginalArg(0) boolean arg0, @OriginalArg(2) String arg1) {
    @Pc(4)
    String local4 = arg1.toLowerCase();
    @Pc(11)
    short[] local11 = new short[16];
    @Pc(13)
    int local13 = 0;
    @Pc(19)
    int local19 = arg0 ? 32768 : 0;
    @Pc(35)
    int local35 =
        local19 + (arg0 ? Static445.aClass81_2.anInt2663 : Static445.aClass81_2.anInt2661);
    for (@Pc(37) int local37 = local19; local37 < local35; local37++) {
      @Pc(44)
      SecondaryNode_Sub1_Sub3 local44 = Static445.aClass81_2.method2258(local37);
      if (local44.aBoolean32 && local44.method229().toLowerCase().indexOf(local4) != -1) {
        ...
        if (local13 >= local11.length) {
          @Pc(80)
          short[] local80 = new short[local11.length * 2];
    ...
    @Pc(115)
    String[] local115 = new String[Static406.anInt6702];
  ...
  public static void method4114(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
    @Pc(15)
    SecondaryNode_Sub1_Sub11 local15 = Static405.method5222(arg0, 13);
    local15.method2604();
