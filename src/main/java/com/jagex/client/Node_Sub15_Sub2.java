...
public final class Node_Sub15_Sub2 extends Node_Sub15 {
  ...
  private void method2956(
    ...
    for (@Pc(5) Node_Sub15 local5 = (Node_Sub15) this.aLinkedList_26.tail();
        local5 != null;
        local5 = (Node_Sub15) this.aLinkedList_26.previous()) {
  ...
  private void method2957(@OriginalArg(0) Node_Sub44 arg0) {
    ...
    arg0.method5668();
    @Pc(9)
    Node local9 = this.aLinkedList_27.sentinelNode.previous;
  ...
  private void method2958(@OriginalArg(0) Node arg0, @OriginalArg(1) Node_Sub44 arg1) {
    while (arg0 != this.aLinkedList_27.sentinelNode
        && ((Node_Sub44) arg0).anInt7350 <= arg1.anInt7350) {
      arg0 = arg0.previous;
    }
  ...
  private void method2960() {
    ...
    for (@Pc(8) Node_Sub44 local8 = (Node_Sub44) this.aLinkedList_27.tail();
        local8 != null;
        local8 = (Node_Sub44) this.aLinkedList_27.previous()) {
  ...
  public synchronized void method4861(@OriginalArg(0) int arg0) {
    do {
      ...
      @Pc(29)
      int local29 = this.anInt3580 - this.anInt3581;
      this.method2959(local29);
      arg0 -= local29;
      this.anInt3581 += local29;
      this.method2960();
      @Pc(50)
      Node_Sub44 local50 = (Node_Sub44) this.aLinkedList_27.tail();
      synchronized (local50) {
        @Pc(58)
        int local58 = local50.method5669(this);
        if (local58 < 0) {
          local50.anInt7350 = 0;
  ...
  public synchronized void method4855(
    ...
    do {
      ...
      @Pc(33)
      int local33 = this.anInt3580 - this.anInt3581;
      ...
      this.method2960();
      @Pc(60)
      Node_Sub44 local60 = (Node_Sub44) this.aLinkedList_27.tail();
      synchronized (local60) {
        @Pc(68)
        int local68 = local60.method5669(this);
        if (local68 < 0) {
          local60.anInt7350 = 0;
