...
public final class Class4_Sub30 extends Class4 {
	...
	public Class4_Sub30(@OriginalArg(0) ByteBuffer arg0) {
		...
		local22 += arg0.position - local46;
		@Pc(176) int local176 = arg0.position;
		...
		for (@Pc(204) int local204 = 0; local204 < local29; local204++) {
			local202 = local202 + arg0.readByteIntoInt() & 0x7F;
		...
		@Pc(297) int local297 = arg0.position;
		arg0.position += local198;
		@Pc(306) int local306 = arg0.position;
		arg0.position += local39;
		@Pc(315) int local315 = arg0.position;
		arg0.position += local37;
		@Pc(324) int local324 = arg0.position;
		arg0.position += local35;
		@Pc(333) int local333 = arg0.position;
		arg0.position += local178;
		@Pc(342) int local342 = arg0.position;
		arg0.position += local182;
		@Pc(351) int local351 = arg0.position;
		arg0.position += local186;
		@Pc(360) int local360 = arg0.position;
		arg0.position += local31 + local33 + local39;
		@Pc(373) int local373 = arg0.position;
		arg0.position += local31;
		@Pc(382) int local382 = arg0.position;
		arg0.position += local200;
		@Pc(391) int local391 = arg0.position;
		arg0.position += local33;
		@Pc(400) int local400 = arg0.position;
		arg0.position += local180;
		@Pc(409) int local409 = arg0.position;
		arg0.position += local184;
		@Pc(418) int local418 = arg0.position;
		arg0.position += local188;
		@Pc(427) int local427 = arg0.position;
		arg0.position += local41;
		@Pc(436) int local436 = arg0.position;
		arg0.position += local35;
		@Pc(445) int local445 = arg0.position;
		arg0.position += local190;
		@Pc(454) int local454 = arg0.position;
		arg0.position += local192;
		@Pc(463) int local463 = arg0.position;
		arg0.position += local194;
		@Pc(472) int local472 = arg0.position;
		arg0.position += local196;
		@Pc(481) int local481 = arg0.position;
		arg0.position += local27 * 3;
		this.aByteArray58 = new byte[local22];
		@Pc(499) ByteBuffer local499 = new ByteBuffer(this.aByteArray58);
		local499.writeIntBE(1297377380);
		local499.writeIntBE(6);
		local499.writeInt16BE(local12 > 1 ? 1 : 0);
		local499.writeInt16BE(local12);
		local499.writeInt16BE(local16);
		arg0.position = local46;
		...
		label220: for (@Pc(548) int local548 = 0; local548 < local12; local548++) {
			local499.writeIntBE(1297379947);
			local499.position += 4;
			@Pc(562) int local562 = local499.position;
			...
			while (true) {
				while (true) {
					...
					if (local580 == 7) {
						if (local587) {
							local499.writeByte(255);
						}
						local499.writeByte(47);
						local499.writeByte(0);
						local499.method2514(local499.position - local562);
						continue label220;
					}
					if (local580 == 23) {
						if (local587) {
						...
						local499.writeByte(81);
						local499.writeByte(3);
						local499.writeByte(arg0.bytes[local481++]);
						local499.writeByte(arg0.bytes[local481++]);
						local499.writeByte(arg0.bytes[local481++]);
					} else {
						local529 ^= local580 >> 4;
						if (local564 == 0) {
							if (local587) {
								local499.writeByte(local529 + 144);
							}
							local531 += arg0.bytes[local360++];
							local533 += arg0.bytes[local373++];
							local499.writeByte(local531 & 0x7F);
							local499.writeByte(local533 & 0x7F);
						} else if (local564 == 1) {
							if (local587) {
								local499.writeByte(local529 + 128);
							}
							local531 += arg0.bytes[local360++];
							local535 += arg0.bytes[local391++];
							local499.writeByte(local531 & 0x7F);
							local499.writeByte(local535 & 0x7F);
						} else if (local564 == 2) {
							if (local587) {
								local499.writeByte(local529 + 176);
							}
							local202 = local202 + arg0.bytes[local176++] & 0x7F;
							local499.writeByte(local202);
							...
							local499.writeByte(local907 & 0x7F);
						} else if (local564 == 3) {
							if (local587) {
								local499.writeByte(local529 + 224);
							}
							local537 += arg0.bytes[local436++];
							local537 += arg0.bytes[local324++] << 7;
							local499.writeByte(local537 & 0x7F);
							local499.writeByte(local537 >> 7 & 0x7F);
						} else if (local564 == 4) {
							if (local587) {
								local499.writeByte(local529 + 208);
							}
							local539 += arg0.bytes[local315++];
							local499.writeByte(local539 & 0x7F);
						} else if (local564 == 5) {
							if (local587) {
								local499.writeByte(local529 + 160);
							}
							local531 += arg0.bytes[local360++];
							local541 += arg0.bytes[local306++];
							local499.writeByte(local531 & 0x7F);
							local499.writeByte(local541 & 0x7F);
						} else if (local564 == 6) {
							if (local587) {
								local499.writeByte(local529 + 192);
							}
							local499.writeByte(arg0.bytes[local427++]);
						} else {
							throw new RuntimeException();
						}
					}
