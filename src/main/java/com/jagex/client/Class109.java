...
public final class Class109 {
  ...
  public Class178 method2758(@OriginalArg(0) int arg0) {
    ...
    @Pc(33)
    byte[] local33 = this.aJs5_40.method2104(arg0, 3);
    local16 = new Class178();
    local16.aClass109_1 = this;
    if (local33 != null) {
      local16.method4091(new Packet(local33));
    }
    @Pc(52)
    Class68 local52 = this.aClass68_17;
    synchronized (this.aClass68_17) {
  ...
  public void method2759() {
    @Pc(13)
    Class68 local13 = this.aClass68_17;
    synchronized (this.aClass68_17) {
