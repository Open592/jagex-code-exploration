...
public final class Static342 {
  ...
  public static boolean method4630(
    ...
    if (Static112.method2030(arg0, arg1, arg2)) {
      ...
      return Static299.method4088(
              local10 + 1, Static417.aClass65Array4[arg0].l(arg1, arg2) + arg3, local14 + 1)
          && Static299.method4088(
              local10 + Static4.anInt5935 - 1,
              Static417.aClass65Array4[arg0].l(arg1 + 1, arg2) + arg3,
              local14 + 1)
          && Static299.method4088(
              local10 + Static4.anInt5935 - 1,
              Static417.aClass65Array4[arg0].l(arg1 + 1, arg2 + 1) + arg3,
              local14 + Static4.anInt5935 - 1)
          && Static299.method4088(
              local10 + 1,
              Static417.aClass65Array4[arg0].l(arg1, arg2 + 1) + arg3,
              local14 + Static4.anInt5935 - 1);
    } else {
      return false;
    }
  ...
  public static int method4632(
    ...
    @Pc(26)
    int local26 = (arg1 * (arg0 & 0xFF00) & 0xFF0000 | (arg0 & 0xFF00FF) * arg1 & 0xFF00FF00) >>> 8;
    @Pc(31)
    int local31 = 255 - arg1;
    return ((local31 * (arg2 & 0xFF00) & 0xFF0000 | local31 * (arg2 & 0xFF00FF) & 0xFF00FF00) >>> 8)
        + local26;
  }
}
