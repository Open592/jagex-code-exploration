...
public final class Static290 {
  ...
  public static void method5013(
    ...
    if (Static341.aBoolean599) {
      ...
      if (Static53.method900(arg0).method3903()
          && (Static434.anInt7378 & 0x20) != 0
          && (local181 == null
              || arg0.method5299(local181.anInt4123, Static7.anInt5460) != local181.anInt4123)) {
        Static380.method5017(
            47,
            false,
            0L,
            arg0.anInt6865,
            Static49.aString28 + " -> " + arg0.aString66,
            true,
            Static388.aString62,
            arg0.anInt6809,
            arg0.anInt6779,
    ...
    for (@Pc(9) int local9 = 9; local9 >= 5; local9--) {
      ...
      if (local16 != null) {
        Static380.method5017(
            ...
            arg0.anInt6809,
            arg0.anInt6779,
            Static72.method1350(local9, arg0));
      }
    }
    ...
    for (@Pc(79) int local79 = 4; local79 >= 0; local79--) {
      @Pc(86)
      String local86 = Static420.method5386(local79, arg0);
      if (local86 != null) {
        Static380.method5017(
            48,
            false,
            ...
            arg0.anInt6809,
            arg0.anInt6779,
            Static72.method1350(local79, arg0));
      }
    }
