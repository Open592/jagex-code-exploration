...
public final class Class235 {
  ...
  public Class235(@OriginalArg(0) int[] arg0) {
    ...
    while (local47 < arg0.length) {
      @Pc(57)
      int local57;
      for (local57 = arg0[local47] & local5 - 1;
          this.anIntArray503[local57 + local57 + 1] != -1;
          local57 = local5 - 1 & local57 + 1) {}
  ...
  public int method5174(@OriginalArg(1) int arg0) {
    @Pc(19)
    int local19 = (this.anIntArray503.length >> 1) - 1;
    @Pc(23)
    int local23 = local19 & arg0;
    while (true) {
      @Pc(32)
      int local32 = this.anIntArray503[local23 + local23 + 1];
      if (local32 == -1) {
        return -1;
      }
