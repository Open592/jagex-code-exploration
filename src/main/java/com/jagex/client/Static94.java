...
public final class Static94 {
  ...
  public static void method1652(
    ...
    @Pc(8)
    SecondaryNode_Sub1_Sub11 local8 = Static405.method5222(arg0, 8);
    local8.method2604();
  ...
  public static void method1653(
    ...
    @Pc(10)
    int local10 = arg0 - arg4;
    @Pc(14)
    int local14 = arg4 + arg5;
    ...
    @Pc(63)
    int local63 = arg3 - arg4;
    @Pc(67)
    int local67 = arg1 + arg4;
    for (@Pc(69) int local69 = local14; local69 <= local10; local69++) {
      @Pc(75)
      int[] local75 = Static96.anIntArrayArray21[local69];
  ...
  public static void handleClientError(
      @OriginalArg(0) Throwable error, @OriginalArg(1) String context) {
    try {
      @Pc(7)
      String errorMessage = "";
      if (error != null) {
      ...
      if (Static386.signLink.hostApplet != null) {
        @Pc(99)
        Message message =
            Static386.signLink.emitOpenURLStreamMessage(
                new URL(
                    Static386.signLink.hostApplet.getCodeBase(),
                    "clienterror.ws?c="
                        + Static13.gameVersion
                        + "&u="
                        + Static286.aLong174
                        + "&v1="
                        + SignLink.javaVendor
        ...
        if (message.status == 1) {
          @Pc(125)
          DataInputStream responseStream = (DataInputStream) message.output;
          responseStream.read();
