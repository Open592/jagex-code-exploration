...
public final class Class3_Sub1_Sub1_Sub1 extends Class3_Sub1_Sub1 {
  ...
  public Class3_Sub1_Sub1_Sub1(
      @OriginalArg(0) Class3_Sub6 arg0,
  ...
  public void method3304(@OriginalArg(0) long arg0) {
    @Pc(6)
    int local6 = super.anInt4068 >> Static231.anInt4434 + 12;
    @Pc(13)
    int local13 = super.anInt4073 >> Static231.anInt4434 + 12;
    @Pc(18)
    int local18 = super.anInt4076 >> Static172.anInt3366;
    if (local18 > 0
        || local18 < -262144
        || local6 < 0
        || local6 >= Static422.anInt6945
        || local13 < 0
        || local13 >= Static171.anInt3361) {
      this.method3303();
      return;
    }
    @Pc(40)
    ...
    @Pc(54)
    int local54 = local46[local40.anInt217].l(local6, local13);
    @Pc(70)
    int local70;
    ...
    if (local6 >= local40.anInt215
        && local6 <= local40.anInt218
        && local13 >= local40.anInt219
        && local13 <= local40.anInt214
        && local18 <= local54
        && local18 >= local70) {
    ...
    @Pc(158)
    int local158;
    for (local158 = Static235.anInt4487 - 1;
        local158 > 0 && local18 > local46[local158].l(local6, local13);
        local158--) {}
    if (local158 == 0 && local18 > local46[0].l(local6, local13)) {
      this.method3303();
    } else if (local158 == Static235.anInt4487 - 1
        && local46[local158].l(local6, local13) - local18 > 0x8 << Static231.anInt4434) {
      this.method3303();
    } else {
      @Pc(211)
      Class164 local211 = Static202.aClass164ArrayArrayArray5[local158][local6][local13];
      if (local211 == null) {
        if (local158 == 0) {
          local211 =
              Static202.aClass164ArrayArrayArray5[0][local6][local13] =
                  new Class164(0, local6, local13);
        }
        @Pc(243)
        boolean local243 =
            Static202.aClass164ArrayArrayArray5[0][local6][local13].aClass164_1 != null;
        ...
        for (@Pc(253) int local253 = 1; local253 <= local158; local253++) {
          if (Static202.aClass164ArrayArrayArray5[local253][local6][local13] == null) {
            local211 =
                Static202.aClass164ArrayArrayArray5[local253][local6][local13] =
                    new Class164(local253, local6, local13);
            if (local243) {
              local211.aByte53++;
            }
          }
  ...
  private void method3306() {
    @Pc(4)
    int local4 = this.aClass3_Sub6_1.aClass3_Sub2_6.anInt212;
  ...
  public void method3307(@OriginalArg(0) long arg0, @OriginalArg(1) int arg1) {
    ...
    @Pc(17)
    int local17 = super.anInt4068 >> Static172.anInt3366;
    @Pc(22)
    int local22 = super.anInt4076 >> Static172.anInt3366;
    @Pc(27)
    int local27 = super.anInt4073 >> Static172.anInt3366;
    @Pc(31)
    ...
    if (local35.anInt3782 != 0) {
      if (this.aShort50 - this.aShort53 <= local35.anInt3797) {
        local65 =
            (super.anInt4072 >> 8 & 0xFF00)
                + (this.anInt4078 >> 16 & 0xFF)
                + local35.anInt3803 * arg1;
        local82 =
            (super.anInt4072 & 0xFF00) + (this.anInt4078 >> 8 & 0xFF) + local35.anInt3812 * arg1;
        local99 =
            ((super.anInt4072 & 0xFF) << 8) + (this.anInt4078 & 0xFF) + local35.anInt3778 * arg1;
        if (local65 < 0) {
          local65 = 0;
      ...
      if (this.aShort50 - this.aShort53 <= local35.anInt3779) {
        local65 =
            (super.anInt4072 >> 16 & 0xFF00)
                + (this.anInt4078 >> 24 & 0xFF)
                + local35.anInt3819 * arg1;
        if (local65 < 0) {
          local65 = 0;
        } else if (local65 > 65535) {
          local65 = 65535;
    ...
    if (local35.anInt3792 == 1) {
      ...
      local340 =
          (int)
              Math.sqrt((double) (local313 * local313 + local319 * local319 + local325 * local325));
    ...
    if (local35.anIntArray256 != null) {
      @Pc(426)
      Node local426 = local31.aLinkedList_1.sentinelNode;
      for (@Pc(429) Node local429 = local426.previous;
          local429 != local426;
          local429 = local429.previous) {
        @Pc(433)
        SecondaryNode_Sub1_Sub12 local433 = (SecondaryNode_Sub1_Sub12) local429;
        @Pc(436)
        Class8 local436 = local433.aClass8_1;
        if (local436.anInt121 != 1) {
          @Pc(442)
          boolean local442 = false;
          ...
          if (local442) {
            @Pc(468)
            int local468 = local17 - local433.anInt3220;
            @Pc(473)
            int local473 = local22 - local433.anInt3222;
            ...
            if (local491 <= local436.aLong6) {
              ...
              long local529 =
                  (long)
                          (local468 * local433.anInt3218
                              + local473 * local436.anInt125
                              + local478 * local433.anInt3221)
                      * 65535L
                      / (long) (local436.anInt119 * local501);
              if (local529 >= (long) local436.anInt124) {
                ...
                if (local436.anInt123 != 0) {
                  @Pc(643)
                  int local643 = (local468 << 15) / local501 * local436.anInt119;
                  @Pc(652)
                  int local652 = (local473 << 15) / local501 * local436.anInt119;
                  @Pc(661)
                  int local661 = (local478 << 15) / local501 * local436.anInt119;
    ...
    if (local35.anIntArray255 != null) {
      for (local313 = 0; local313 < local35.anIntArray255.length; local313++) {
        @Pc(743)
        SecondaryNode_Sub1_Sub12 local743 =
            (SecondaryNode_Sub1_Sub12)
                Static166.aClass100_1.method2671((long) local35.anIntArray255[local313]);
        while (local743 != null) {
          @Pc(747)
          Class8 local747 = local743.aClass8_1;
          local340 = local17 - local743.anInt3220;
          @Pc(757)
          int local757 = local22 - local743.anInt3222;
          local444 = local27 - local743.anInt3225;
          @Pc(775)
          long local775 = (long) (local340 * local340 + local757 * local757 + local444 * local444);
          if (local775 > local747.aLong6) {
            local743 = (SecondaryNode_Sub1_Sub12) Static166.aClass100_1.method2670();
          } else {
            ...
            local491 =
                (long)
                        (local340 * local743.anInt3218
                            + local757 * local747.anInt125
                            + local444 * local743.anInt3221)
                    * 65535L
                    / (long) (local747.anInt119 * local478);
            if (local491 < (long) local747.anInt124) {
              ...
              if (local747.anInt123 != 0) {
                @Pc(939)
                int local939 = (local340 << 15) / local478 * local747.anInt119;
                @Pc(948)
                int local948 = (local757 << 15) / local478 * local747.anInt119;
    ...
    if (local35.anIntArray257 != null) {
      if (local35.anIntArray259 == null) {
        ...
        for (local313 = 0; local313 < local35.anIntArray257.length; local313++) {
          ...
          local35.anIntArray259[local313] =
              ((Node_Sub37) Static18.A_HASH_MAP___2.get((long) local35.anIntArray257[local313]))
                  .anInt5426;
        }
      }
      for (local313 = 0; local313 < local35.anIntArray259.length; local313++) {
        @Pc(1082)
        Class8 local1082 = Static392.aClass8Array1[local35.anIntArray259[local313]];
    ...
    super.anInt4068 =
        (int)
            ((long) super.anInt4068
                + ((long) this.aShort52 * (long) this.anInt4079 >> 23) * (long) arg1);
    super.anInt4076 =
        (int)
            ((long) super.anInt4076
                + ((long) this.aShort48 * (long) this.anInt4079 >> 23) * (long) arg1);
    super.anInt4073 =
        (int)
            ((long) super.anInt4073
                + ((long) this.aShort49 * (long) this.anInt4079 >> 23) * (long) arg1);
  }
}
