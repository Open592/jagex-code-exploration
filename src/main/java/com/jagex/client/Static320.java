		...
		if (Static281.aClass247_12 == null) {
			if (!Static234.aBoolean411 && Static407.anInt6710 > 0) {
				if (Static434.isShiftClickEnabled && Static384.aClass244_1.method5489(81) && Static407.anInt6710 > 2) {
					return ((LinkedEntry_Sub39) Static206.aClass183_28.aLinkedEntry_207.next.next).anInt5698;
				}
				return ((LinkedEntry_Sub39) Static206.aClass183_28.aLinkedEntry_207.next).anInt5698;
			}
			...
			if (local20 > local26 && local30 + local26 > local20) {
				...
				if (local44 != -1) {
					...
					for (@Pc(138) LinkedEntry_Sub39 local138 = (LinkedEntry_Sub39) local133.method1611(); local138 != null; local138 = (LinkedEntry_Sub39) local133.method1612()) {
						if (local64++ == local44) {
