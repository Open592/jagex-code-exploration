...
public final class Node_Sub25 extends Node {
  ...
  @OriginalMember(
      owner = "client!jh",
      name = "a",
      descriptor = "(IZBILclient!lp;IILclient!cj;ILclient!ya;)Lclient!t;")
  public Class110 method2929(
      @OriginalArg(1) boolean arg0,
      @OriginalArg(3) int arg1,
      @OriginalArg(4) Class138 arg2,
      @OriginalArg(5) int arg3,
      @OriginalArg(6) int arg4,
      @OriginalArg(7) Class37 arg5,
      @OriginalArg(8) int arg6,
      @OriginalArg(9) Class19 arg7) {
    @Pc(7)
    Class110 local7 = null;
    @Pc(9)
    int local9 = 2048;
    @Pc(11)
    Class151 local11 = null;
    if (arg4 != -1) {
      local11 = Static222.aClass249_1.method5325(arg4);
    }
    @Pc(23)
    int[] local23 = this.anIntArray230;
    if (local11 != null && local11.anIntArray306 != null) {
      ...
      for (@Pc(35) int local35 = 0; local35 < local11.anIntArray306.length; local35++) {
        @Pc(42)
        int local42 = local11.anIntArray306[local35];
    ...
    @Pc(74)
    boolean local74 = false;
    @Pc(76)
    boolean local76 = false;
    @Pc(78)
    boolean local78 = false;
    @Pc(85)
    boolean local85 = false;
    @Pc(87)
    int local87 = -1;
    @Pc(89)
    int local89 = -1;
    ...
    int local91 = 0;
    @Pc(93)
    SecondaryNode_Sub1_Sub17 local93 = null;
    @Pc(95)
    SecondaryNode_Sub1_Sub17 local95 = null;
    if (arg2 != null) {
      local9 = 2080;
      local87 = arg2.anIntArray295[arg6];
      @Pc(110)
      int local110 = local87 >>> 16;
      local87 &= 0xFFFF;
    ...
    @Pc(259)
    long local259 = this.method2931(local23, arg4, arg0, arg5 == null ? null : arg5.anIntArray52);
    ...
    if (local7 == null || arg7.method4269(local7.P(), local9) != 0) {
      ...
      int local288 = local9;
      @Pc(290)
      boolean local290 = false;
      for (@Pc(292) int local292 = 0; local292 < local23.length; local292++) {
        if (local23[local292] != -1
            && !Static444.aClass206_3.method4703(local23[local292]).method4784(arg0)) {
          local290 = true;
        }
      }
      if (local290) {
      ...
      @Pc(329)
      Class122[] local329 = new Class122[local23.length];
      ...
      if (local11 != null && local11.anIntArrayArray38 != null) {
        for (@Pc(369) int local369 = 0; local369 < local11.anIntArrayArray38.length; local369++) {
          if (local11.anIntArrayArray38[local369] != null && local329[local369] != null) {
            ...
            @Pc(396)
            int local396 = local11.anIntArrayArray38[local369][1];
            @Pc(403)
            int local403 = local11.anIntArrayArray38[local369][2];
            @Pc(410)
            int local410 = local11.anIntArrayArray38[local369][3];
            @Pc(417)
            int local417 = local11.anIntArrayArray38[local369][4];
            @Pc(424)
            int local424 = local11.anIntArrayArray38[local369][5];
      ...
      @Pc(477)
      Class122 local477 = new Class122(local329, local329.length);
      if (arg5 != null) {
      ...
      if (arg5 != null) {
        for (local389 = 0; local389 < 5; local389++) {
          if (Static26.aShortArrayArray2[local389].length > arg5.anIntArray52[local389]) {
            local7.BA(
                Static299.aShortArray179[local389],
                Static26.aShortArrayArray2[local389][arg5.anIntArray52[local389]]);
          }
          if (Static15.aShortArrayArray1[local389].length > arg5.anIntArray52[local389]) {
            local7.BA(
                Static434.aShortArray252[local389],
                Static15.aShortArrayArray1[local389][arg5.anIntArray52[local389]]);
          }
        }
      }
      if (Static172.aClass68_18 != null) {
    ...
    if (arg2 == null || local93 == null) {
      ...
      @Pc(571)
      Class110 local571 = local7.method4887((byte) 1, local9, true);
      local571.method4883(
          0, local91, arg2.aBoolean406, local87, local89, local93, local95, arg3 - 1);
      return local571;
    }
  }

  @OriginalMember(owner = "client!jh", name = "a", descriptor = "([IIZI[I)J")
  private long method2931(
      @OriginalArg(0) int[] arg0,
      @OriginalArg(1) int arg1,
      @OriginalArg(2) boolean arg2,
      @OriginalArg(4) int[] arg3) {
    @Pc(7)
    long[] local7 = Class80.aLongArray4;
    @Pc(9)
    long local9 = -1L;
    @Pc(25)
    long local25 = local9 >>> 8 ^ local7[(int) (((long) (arg1 >> 8) ^ local9) & 0xFFL)];
