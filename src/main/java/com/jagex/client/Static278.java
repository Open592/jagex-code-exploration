...
public final class Static278 {
  ...
  @OriginalMember(
      owner = "client!ob",
      name = "a",
      descriptor = "(ILjava/awt/Canvas;ILclient!et;ILclient!ga;)Lclient!ya;")
  public static Class19 method3941(
      @OriginalArg(0) int arg0,
      @OriginalArg(1) Canvas arg1,
      @OriginalArg(3) SignLink arg2,
      @OriginalArg(4) int arg3,
      @OriginalArg(5) Interface7 arg4) {
    ...
    for (@Pc(1) int local1 = Static358.anInt6251; local1 < Static235.anInt4487; local1++) {
      for (@Pc(4) int local4 = 0; local4 < Static422.anInt6945; local4++) {
        for (@Pc(7) int local7 = 0; local7 < Static171.anInt3361; local7++) {
          @Pc(16)
          Class164 local16 = Static202.aClass164ArrayArrayArray5[local1][local4][local7];
          if (local16 != null) {
            @Pc(21)
            Class16_Sub5 local21 = local16.aClass16_Sub5_3;
            @Pc(24)
            Class16_Sub5 local24 = local16.aClass16_Sub5_2;
            ...
            for (@Pc(70) Class7 local70 = local16.aClass7_3;
                local70 != null;
                local70 = local70.aClass7_1) {
              @Pc(74)
              Class16_Sub1 local74 = local70.aClass16_Sub1_1;
              if (local74 != null && local74.method5338()) {
                Static100.method1774(
                    arg0,
                    local74,
                    local1,
                    local4,
                    local7,
                    local74.aShort97 + 1 - local74.aShort94,
                    local74.aShort95 - local74.aShort96 + 1);
                local74.method5333();
              }
            }
            @Pc(111)
            Class16_Sub4 local111 = local16.aClass16_Sub4_2;
