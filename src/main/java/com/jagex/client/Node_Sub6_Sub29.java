...
public final class Node_Sub6_Sub29 extends Node_Sub6 {
  ...
  public int[][] method5514(@OriginalArg(1) int arg0) {
    @Pc(11)
    int[][] local11 = super.aClass153_41.method3679(arg0);
    if (super.aClass153_41.aBoolean437) {
      @Pc(29)
      int local29 = this.anInt5795 + this.anInt5795 + 1;
      @Pc(33)
      int local33 = 65536 / local29;
      @Pc(41)
      int local41 = this.anInt5800 + this.anInt5800 + 1;
      @Pc(45)
      int local45 = 65536 / local41;
      @Pc(48)
      int[][][] local48 = new int[local29][][];
      @Pc(71)
      int local71;
      @Pc(73)
      int local73;
      for (@Pc(53) int local53 = arg0 - this.anInt5795;
          local53 <= arg0 + this.anInt5795;
          local53++) {
        @Pc(63)
        int[][] local63 = this.method5516(0, Static211.anInt3929 & local53);
        @Pc(67)
        int[][] local67 = new int[3][Static80.anInt1616];
        @Pc(69)
        int local69 = 0;
        local71 = 0;
        local73 = 0;
        @Pc(77)
        int[] local77 = local63[0];
        @Pc(81)
        int[] local81 = local63[1];
        @Pc(85)
        int[] local85 = local63[2];
        for (@Pc(89) int local89 = -this.anInt5800; local89 <= this.anInt5800; local89++) {
          @Pc(95)
          int local95 = local89 & Static203.anInt3883;
          local69 += local77[local95];
          local71 += local81[local95];
          local73 += local85[local95];
        }
        @Pc(126)
        int[] local126 = local67[0];
        @Pc(130)
        int[] local130 = local67[1];
        @Pc(134)
        int[] local134 = local67[2];
        @Pc(136)
        int local136 = 0;
        while (Static80.anInt1616 > local136) {
          ...
          @Pc(170)
          int local170 = Static203.anInt3883 & local136 - this.anInt5800;
          local71 -= local81[local170];
          local69 -= local77[local170];
          local136++;
          local73 -= local85[local170];
          @Pc(196)
          int local196 = Static203.anInt3883 & local136 + this.anInt5800;
      ...
      @Pc(245)
      int[] local245 = local11[0];
      @Pc(249)
      int[] local249 = local11[1];
      @Pc(253)
      int[] local253 = local11[2];
  ...
  public int[] method5510(@OriginalArg(1) int arg0) {
    ...
    if (super.aClass82_41.aBoolean243) {
      @Pc(31)
      int local31 = this.anInt5795 + this.anInt5795 + 1;
      @Pc(35)
      int local35 = 65536 / local31;
      @Pc(43)
      int local43 = this.anInt5800 + this.anInt5800 + 1;
      @Pc(47)
      int local47 = 65536 / local43;
      @Pc(50)
      int[][] local50 = new int[local31][];
      @Pc(71)
      int local71;
      for (@Pc(56) int local56 = arg0 - this.anInt5795;
          local56 <= arg0 + this.anInt5795;
          local56++) {
        @Pc(66)
        int[] local66 = this.method5508(Static211.anInt3929 & local56, 0);
        @Pc(69)
        int[] local69 = new int[Static80.anInt1616];
        local71 = 0;
