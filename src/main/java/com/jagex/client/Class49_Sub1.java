...
public final class Class49_Sub1 extends Class49 {
  ...
  public void method2065(@OriginalArg(0) int arg0) throws LineUnavailableException {
    try {
      ...
      Info local20 =
          new Info(
              SourceDataLine.class, this.anAudioFormat1, arg0 << (Static422.aBoolean649 ? 2 : 1));
      ...
      this.anInt1453 = arg0;
        ...
        @Pc(36)
        LineUnavailableException local36) {
  ...
  protected void method2073() {
    ...
    for (@Pc(9) int local9 = 0; local9 < local1; local9++) {
      @Pc(17)
      int local17 = this.anIntArray162[local9];
  ...
  public void method2066(@OriginalArg(0) Component arg0) {
    @Pc(1)
    javax.sound.sampled.Mixer.Info[] local1 = AudioSystem.getMixerInfo();
    if (local1 != null) {
      for (@Pc(7) int local7 = 0; local7 < local1.length; local7++) {
        @Pc(19)
        javax.sound.sampled.Mixer.Info local19 = local1[local7];
        if (local19 != null) {
          @Pc(25)
          String local25 = local19.getName();
    ...
    this.anAudioFormat1 =
        new AudioFormat(
            (float) Static261.anInt4928, 16, Static422.aBoolean649 ? 2 : 1, true, false);
  ...
  protected void method2072() throws LineUnavailableException {
    ...
    Info local34 =
        new Info(
            ...
            this.anAudioFormat1,
            this.anInt1453 << (Static422.aBoolean649 ? 2 : 1));
