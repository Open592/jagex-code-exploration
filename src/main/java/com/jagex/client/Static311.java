...
public final class Static311 {
  ...
  public static void method4167(
    ...
    @Pc(70)
    int local70 = Static86.anInt1771;
    Static86.anInt1771 = (Static453.anInt7373 - (Static283.anInt5187 >> 4)) * 8;
    Static197.aClass4_Sub1_Sub5_2 =
        Static148.method4494(Static169.anInt3265 * 8, Static453.anInt7373 * 8);
    Static292.aClass195_2 = null;
    @Pc(92)
    int local92 = Static180.anInt3453 - local59;
    @Pc(97)
    int local97 = Static86.anInt1771 - local70;
    @Pc(107)
    int local107;
    @Pc(115)
    int local115;
    if (arg0) {
      ...
      @Pc(113)
      int local113 = Static283.anInt5187 * 128 - 128;
      for (local115 = 0; local115 < 32768; local115++) {
        @Pc(121)
        Class16_Sub1_Sub5_Sub2 local121 = Static143.aClass16_Sub1_Sub5_Sub2Array1[local115];
        if (local121 != null) {
          local121.anInt6892 -= local97 * 128;
          local121.anInt6893 -= local92 * 128;
          if (local121.anInt6893 >= 0
              && local107 >= local121.anInt6893
              && local121.anInt6892 >= 0
              && local113 >= local121.anInt6892) {
            @Pc(162)
            boolean local162 = true;
            for (@Pc(164) int local164 = 0; local164 < 10; local164++) {
              ...
              if (local121.anIntArray426[local164] < 0
                  || Static326.anInt5666 <= local121.anIntArray426[local164]
                  || local121.anIntArray427[local164] < 0
                  || Static283.anInt5187 <= local121.anIntArray427[local164]) {
                local162 = false;
              }
            }
            if (local162) {
      ...
      for (local107 = 0; local107 < 32768; local107++) {
        @Pc(270)
        Class16_Sub1_Sub5_Sub2 local270 = Static143.aClass16_Sub1_Sub5_Sub2Array1[local107];
        if (local270 != null) {
    ...
    for (local107 = 0; local107 < 2048; local107++) {
      @Pc(326)
      Class16_Sub1_Sub5_Sub1 local326 = Static267.aClass16_Sub1_Sub5_Sub1Array1[local107];
      if (local326 != null) {
        for (local115 = 0; local115 < 10; local115++) {
    ...
    @Pc(378)
    Class38[] local378 = Static306.aClass38Array1;
    for (local115 = 0; local115 < local378.length; local115++) {
      @Pc(386)
      Class38 local386 = local378[local115];
      if (local386 != null) {
    ...
    for (@Pc(418) Node_Sub9 local418 = (Node_Sub9) Static115.aLinkedList_15.tail();
        local418 != null;
        local418 = (Node_Sub9) Static115.aLinkedList_15.previous()) {
      local418.anInt790 -= local97;
      local418.anInt793 -= local92;
      if (Static448.anInt7307 != 3
          && (local418.anInt793 < 0
              || local418.anInt790 < 0
              || local418.anInt793 >= Static326.anInt5666
              || local418.anInt790 >= Static283.anInt5187)) {
        local418.popSelf();
      }
    }
