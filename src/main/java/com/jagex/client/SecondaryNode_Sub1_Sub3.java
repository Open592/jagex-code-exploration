...
public final class SecondaryNode_Sub1_Sub3 extends SecondaryNode {
  ...
  public Class98 method226(@OriginalArg(0) int arg0) {
    return this.anIntArray18 == null || arg0 < 0 || this.anIntArray18.length < arg0
        ? null
        : Static12.method128(this.anIntArray18[arg0]);
  }
  ...
  public int method227(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
    if (this.anIntArray18 == null || arg1 < 0 || this.anIntArray18.length < arg1) {
      return -1;
    } else if (this.anIntArrayArray2[arg1] == null
        || arg0 < 0
        || arg0 > this.anIntArrayArray2[arg1].length) {
      return -1;
    } else {
  ...
  public String method229() {
    @Pc(10)
    StringBuffer local10 = new StringBuffer(80);
  ...
  public void method231(@OriginalArg(1) int[] arg0, @OriginalArg(2) Packet arg1) {
    ...
    for (@Pc(16) int local16 = 0; local16 < this.anIntArray18.length; local16++) {
      ...
      @Pc(24)
      int local24 = this.method226(local16).anInt3056;
      if (local24 > 0) {
  ...
  public void method232(@OriginalArg(0) Packet arg0) {
    while (true) {
      @Pc(9)
      int local9 = arg0.g1();
      if (local9 == 0) {
  ...
  public String method234(@OriginalArg(0) Packet arg0) {
    @Pc(17)
    StringBuffer local17 = new StringBuffer(80);
    if (this.anIntArray18 != null) {
      for (@Pc(22) int local22 = 0; local22 < this.anIntArray18.length; local22++) {
        local17.append(this.aStringArray3[local22]);
        local17.append(
            this.aClass81_1.method2255(
                this.method226(local22),
                this.anIntArrayArray2[local22],
                arg0.gVarLong(Static12.method128(this.anIntArray18[local22]).anInt3058)));
      }
    }
  ...
  private void method235(@OriginalArg(0) Packet arg0, @OriginalArg(1) int arg1) {
    ...
    if (arg1 == 3) {
      ...
      for (local28 = 0; local28 < local22; local28++) {
        ...
        int local67 = arg0.g2();
        @Pc(71)
        Class98 local71 = Static12.method128(local67);
        if (local71 != null) {
