...
public final class Class153 {
	...
	private ListNode_Sub20[] aClass4_Sub20Array1;
	...
	public Class153(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		this.anInt4749 = arg0;
		this.anInt4754 = arg1;
		this.aClass4_Sub20Array1 = new ListNode_Sub20[this.anInt4754];
	...
	public int[][] method3679(@OriginalArg(1) int arg0) {
		if (this.anInt4749 == this.anInt4754) {
			...
			@Pc(72) ListNode_Sub20 local72 = this.aClass4_Sub20Array1[arg0];
			if (local72 == null) {
				this.aBoolean437 = true;
				if (this.anInt4747 >= this.anInt4749) {
					@Pc(97) ListNode_Sub20 local97 = (ListNode_Sub20) this.aClass183_33.method4139();
					local72 = new ListNode_Sub20(arg0, local97.anInt2616);
					this.aClass4_Sub20Array1[local97.anInt2614] = null;
					local97.popSelf();
				} else {
					local72 = new ListNode_Sub20(arg0, this.anInt4747);
					this.anInt4747++;
				}
