...
public final class Class81 {
  ...
  @OriginalMember(
      owner = "client!gh",
      name = "<init>",
      descriptor = "(ILclient!fs;Lclient!fs;Lclient!lo;)V")
  public Class81(
      @OriginalArg(0) int arg0,
      @OriginalArg(1) Js5 arg1,
      @OriginalArg(2) Js5 arg2,
      @OriginalArg(3) Interface8 arg3) {
  ...
  @OriginalMember(
      owner = "client!gh",
      name = "a",
      descriptor = "(Lclient!ho;B[IJ)Ljava/lang/String;")
  public String method2255(
      @OriginalArg(0) Class98 arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) long arg2) {
    if (this.anInterface8_1 != null) {
      @Pc(22)
      String local22 = this.anInterface8_1.method3205(arg2, arg1, arg0);
      if (local22 != null) {
        return local22;
      }
    }
  ...
  public SecondaryNode_Sub1_Sub3 method2258(@OriginalArg(0) int arg0) {
    @Pc(11)
    SecondaryNode_Sub1_Sub3 local11 =
        (SecondaryNode_Sub1_Sub3) this.aClass68_12.method1787((long) arg0);
    if (local11 != null) {
      return local11;
    }
    @Pc(36)
