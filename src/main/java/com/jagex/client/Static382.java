...
public final class Static382 {
  ...
  public static void method5042(@OriginalArg(0) LinkedList arg0, @OriginalArg(2) Class19 arg1) {
    ...
    for (@Pc(21) Node_Sub3 local21 = (Node_Sub3) arg0.tail();
        local21 != null;
        local21 = (Node_Sub3) arg0.previous()) {
      @Pc(29)
      Class157 local29 = Static148.aClass182_3.method4124(local21.anInt234);
      if (Static428.method5473(local29)) {
        @Pc(41)
        boolean local41 = Static272.method3908(arg1, local21, local29);
        if (local41) {
  ...
  public static void method5043(
    ...
    if (arg0 == 1004) {
      ...
      Static271.method3899(GameShell.aClass186_3, arg2, arg1);
    }
  }
  ...
  public static void method5045(@OriginalArg(0) int arg0) {
    @Pc(17)
    SecondaryNode_Sub1_Sub11 local17 = Static405.method5222(arg0, 5);
    local17.method2608();
  }
}
