...
public final class Static126 {
  ...
  public static final LocalizedString A_LOCALIZED_STRING___49 =
      new LocalizedString("skill: ", "Fertigkeit: ", "compétence ", "habilidade: ");
  ...
  public static boolean method2260(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
    @Pc(13)
    Class202 local13 = Static267.aClass262_2.method5560(arg0);
    if (arg1 == 11) {
      arg1 = 10;
    }
    if (arg1 >= 5 && arg1 <= 8) {
  ...
  @OriginalMember(
      owner = "client!gi",
      name = "a",
      descriptor = "(IILclient!rs;Lclient!lh;IIILclient!rd;)V")
  public static void method2264(
      @OriginalArg(0) int arg0,
      @OriginalArg(2) Class16_Sub1_Sub5_Sub2 arg1,
      @OriginalArg(3) Class16_Sub1_Sub5_Sub1 arg2,
      @OriginalArg(4) int arg3,
      @OriginalArg(5) int arg4,
      @OriginalArg(6) int arg5,
      @OriginalArg(7) Class202 arg6) {
    @Pc(7)
    Node_Sub8 local7 = new Node_Sub8();
    ...
    if (arg6 != null) {
      ...
      @Pc(145)
      int local145 = arg6.anInt5816;
      @Pc(148)
      int local148 = arg6.anInt5801;
      if (arg4 == 1 || arg4 == 3) {
      ...
      if (local7.anIntArray37 != null) {
        local7.anInt618 =
            local7.anInt623 + (int) ((double) (local7.anInt622 - local7.anInt623) * Math.random());
      }
    ...
    Static341.A_HASH_MAP___38.set((long) arg2.anInt6037, local7);
    return;
  }
}
