...
public final class Static15 {
  ...
  public static void method156(
      ...
      @OriginalArg(5) Class138 arg4,
      @OriginalArg(6) boolean arg5) {
    if (Static109.anInt6886 >= 50
        || (arg4 == null
            || arg4.anIntArrayArray36 == null
            || arg1 >= arg4.anIntArrayArray36.length
            || arg4.anIntArrayArray36[arg1] == null)) {
      return;
    }
    @Pc(32)
    int local32 = arg4.anIntArrayArray36[arg1][0];
    @Pc(36)
    int local36 = local32 >> 8;
    @Pc(42)
    int local42 = local32 >> 5 & 0x7;
    @Pc(46)
    int local46 = local32 & 0x1F;
    @Pc(65)
    int local65;
    ...
    if (local46 == 0) {
      ...
      Static86.aClass269Array1[Static109.anInt6886++] =
          new Class269(
              ...
              0,
              255,
              (local65 << 16) + (arg2 << 24) + (local109 << 8) + local46);
    }
  }
