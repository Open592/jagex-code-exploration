...
public final class Static177 {
  ...
  public static void method2527() {
    for (@Pc(7) int local7 = 0; local7 < Static109.anInt6886; local7++) {
      @Pc(13)
      Class269 local13 = Static86.aClass269Array1[local7];
      @Pc(15)
          ...
          if (local13.anInt7336 < 0) {
            if (local13.anInt7341 == 0) {
              ...
              if (local140 == Static1.aClass16_Sub1_Sub5_Sub1_1.aByte82) {
                @Pc(159)
                int local159 = (local13.anInt7341 & 0xFF) << 7;
                @Pc(166)
                int local166 = local13.anInt7341 >> 16 & 0xFF;
                @Pc(176)
                int local176 = (local166 << 7) + 64 - Static1.aClass16_Sub1_Sub5_Sub1_1.anInt6893;
                if (local176 < 0) {
                  local176 = -local176;
                }
                @Pc(188)
                int local188 = local13.anInt7341 >> 8 & 0xFF;
                @Pc(198)
                int local198 = (local188 << 7) + 64 - Static1.aClass16_Sub1_Sub5_Sub1_1.anInt6892;
                if (local198 < 0) {
                  local198 = -local198;
                }
                @Pc(212)
                int local212 = local198 + local176 - 128;
            ...
            if (local131 > 0) {
              ...
              @Pc(274)
              Node_Sub15_Sub3 local274 =
                  local13.aClass4_Sub15_Sub3_4 = Static462.method4489(local246, local131);
              local274.method4461(local13.anInt7342 - 1);
              Static360.aClass4_Sub15_Sub2_2.method2954(local274);
            }
          }
        }
      } else if (!local13.aClass4_Sub15_Sub3_4.hasNext()) {
        local15 = true;
      }
      if (local15) {
        Static109.anInt6886--;
  ...
  public static int method2539(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
    ...
    int local12 = arg1 >>> 24;
    @Pc(16)
    int local16 = 255 - local12;
    @Pc(34)
    int local34 =
        ((arg1 & 0xFF00FF) * local12 & 0xFF00FF00 | local12 * (arg1 & 0xFF00) & 0xFF0000) >>> 8;
    return local34
        + (((arg0 & 0xFF00) * local16 & 0xFF0000 | local16 * (arg0 & 0xFF00FF) & 0xFF00FF00) >>> 8);
  }
}
