...
public final class Node_Sub6_Sub31 extends Node_Sub6 {
  ...
  public void method5518(@OriginalArg(1) int arg0, @OriginalArg(2) Packet arg1) {
    if (arg0 == 0) {
      this.anInt5971 = arg1.g2();
    } else if (arg0 == 1) {
      this.anInt5974 = arg1.g2();
    } else if (arg0 == 2) {
  ...
  public int[][] method5514(@OriginalArg(1) int arg0) {
    @Pc(19)
    int[][] local19 = super.aClass153_41.method3679(arg0);
    if (super.aClass153_41.aBoolean437) {
      @Pc(29)
      int[][] local29 = this.method5516(0, arg0);
      @Pc(33)
      int[] local33 = local29[0];
      @Pc(37)
      int[] local37 = local29[1];
      @Pc(41)
      int[] local41 = local29[2];
      @Pc(45)
      int[] local45 = local19[0];
      @Pc(49)
      int[] local49 = local19[1];
      @Pc(53)
      int[] local53 = local19[2];
