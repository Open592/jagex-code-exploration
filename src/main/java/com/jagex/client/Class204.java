...
public final class Class204 {
  ...
  public void method4672() {
    @Pc(6)
    Class68 local6 = this.aClass68_39;
    synchronized (this.aClass68_39) {
      this.aClass68_39.clear();
    }
  }
  ...
  public void method4673() {
    @Pc(2)
    Class68 local2 = this.aClass68_39;
    synchronized (this.aClass68_39) {
  ...
  public Class190 method4677(@OriginalArg(0) int arg0) {
    @Pc(15)
    Class68 local15 = this.aClass68_39;
    @Pc(25)
    Class190 local25;
    synchronized (this.aClass68_39) {
    ...
    @Pc(42)
    byte[] local42 = this.aJs5.method2104(arg0, 31);
    local25 = new Class190();
    if (local42 != null) {
      local25.method4218(new Packet(local42));
    }
    @Pc(58)
    Class68 local58 = this.aClass68_39;
    synchronized (this.aClass68_39) {
