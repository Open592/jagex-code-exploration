...
public final class Static331 {
  ...
  public static void method4515(
    ...
    @Pc(8)
    Class145 local8 = arg2.method5312(Static122.aClass19_16);
    if (local8 == null) {
      return;
    }
    Static122.aClass19_16.OA(arg0, arg1, arg0 + arg2.anInt6833, arg2.anInt6805 + arg1);
    if (Static184.anInt3532 < 3) {
      Static163.aClass57_16.method5533(
          (float) arg0 + (float) arg2.anInt6833 / 2.0F,
          (float) arg1 + (float) arg2.anInt6805 / 2.0F,
          ((int) -Static368.aFloat192 & 0x3FFF) << 2,
          local8,
          arg0,
          arg1);
    } else {
