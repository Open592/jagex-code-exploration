...
public final class SecondaryNode_Sub1_Sub18 extends SecondaryNode {
	...
	private HashMap aLinkedHashMap_Iterator_35;
	...
	private void method4667(@OriginalArg(0) Packet arg0, @OriginalArg(1) int arg1) {
		...
		if (this.aLinkedHashMap_Iterator_35 == null) {
			...
			this.aLinkedHashMap_Iterator_35 = new HashMap(local23);
		}
	...
	public int method4670(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		if (this.aLinkedHashMap_Iterator_35 == null) {
			...
			@Pc(23) Node_Sub37 local23 = (Node_Sub37) this.aLinkedHashMap_Iterator_35.get((long) arg1);
	...
	public String method4671(@OriginalArg(1) String arg0, @OriginalArg(2) int arg1) {
		if (this.aLinkedHashMap_Iterator_35 == null) {
			...
			@Pc(21) Node_Sub7 local21 = (Node_Sub7) this.aLinkedHashMap_Iterator_35.get((long) arg1);
