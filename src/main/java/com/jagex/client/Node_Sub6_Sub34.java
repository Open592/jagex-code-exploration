...
public final class Node_Sub6_Sub34 extends Node_Sub6 {
  ...
  public int[] method5510(@OriginalArg(1) int arg0) {
    ...
    if (super.aClass82_41.aBoolean243) {
      @Pc(32)
      int local32 = this.anInt6525 * Static165.anIntArray209[arg0] + 2048;
      @Pc(36)
      int local36 = local32 >> 12;
      @Pc(40)
      int local40 = local36 + 1;
      for (@Pc(42) int local42 = 0; local42 < Static80.anInt1616; local42++) {
        ...
        @Pc(61)
        int local61 = Static341.anIntArray504[local42] * this.anInt6520 + 2048;
        @Pc(65)
        int local65 = local61 >> 12;
        @Pc(69)
        int local69 = local65 + 1;
        @Pc(158)
        int local158;
        for (@Pc(73) int local73 = local36 - 1; local73 <= local40; local73++) {
          ...
          int local98 =
              this.aByteArray92[
                      (local73 >= this.anInt6525 ? local73 - this.anInt6525 : local73) & 0xFF]
                  & 0xFF;
          for (@Pc(102) int local102 = local65 - 1; local102 <= local69; local102++) {
            @Pc(130)
            int local130 =
                (this.aByteArray92[
                            (local102 >= this.anInt6520 ? local102 - this.anInt6520 : local102)
                                    + local98
                                & 0xFF]
                        & 0xFF)
                    * 2;
            @Pc(135)
            int local135 = local61 - (local102 << 12);
            @Pc(139)
            int local139 = local130 + 1;
            @Pc(142)
            int local142 = local135 - this.aShortArray234[local130];
            @Pc(155)
            int local155 = local32 - (local73 << 12) - this.aShortArray234[local139];
            ...
            if (local158 == 1) {
              ...
              local142 =
                  (int)
                      (Math.sqrt((double) ((float) (local142 < 0 ? -local142 : local142) / 4096.0F))
                          * 4096.0D);
              local155 =
                  (int)
                      (Math.sqrt(
                              (double) ((float) (local155 >= 0 ? local155 : -local155) / 4096.0F))
                          * 4096.0D);
              ...
              local190 =
                  (int)
                      (Math.sqrt(Math.sqrt((double) ((float) (local155 + local142) / 1.6777216E7F)))
                          * 4096.0D);
            } else if (local158 == 2) {
              local190 =
                  (local142 >= 0 ? local142 : -local142) + (local155 >= 0 ? local155 : -local155);
            } else {
              local190 =
                  (int)
                      (Math.sqrt(
                              (double)
                                  ((float) (local155 * local155 + local142 * local142)
                                      / 1.6777216E7F))
                          * 4096.0D);
            }
  ...
  private void method5114() {
    @Pc(18)
    Random local18 = new Random((long) this.anInt6519);
  ...
  public void method5518(@OriginalArg(1) int arg0, @OriginalArg(2) Packet arg1) {
    if (arg0 == 0) {
      this.anInt6520 = this.anInt6525 = arg1.g1();
    } else if (arg0 == 1) {
      this.anInt6519 = arg1.g1();
    } else if (arg0 == 2) {
      this.anInt6522 = arg1.g2();
    } else if (arg0 == 3) {
      this.anInt6523 = arg1.g1();
    } else if (arg0 == 4) {
      this.anInt6524 = arg1.g1();
    } else if (arg0 == 5) {
      this.anInt6520 = arg1.g1();
    } else if (arg0 == 6) {
      this.anInt6525 = arg1.g1();
    }
  }
}
