...
public final class LinkedHashEntry_Sub1_Sub14 extends LinkedHashEntry_Sub1 {
	...
	private final LinkedHashEntry_Sub6 aClass4_Sub6_1;

	@OriginalMember(owner = "client!kv", name = "L", descriptor = "Lclient!oc;")
	private final LinkedHashEntry_Sub6 aClass4_Sub6_2;

	@OriginalMember(owner = "client!kv", name = "Q", descriptor = "Lclient!oc;")
	private final LinkedHashEntry_Sub6 aClass4_Sub6_3;

	@OriginalMember(owner = "client!kv", name = "G", descriptor = "[Lclient!oc;")
	private final LinkedHashEntry_Sub6[] aClass4_Sub6Array23;

	@OriginalMember(owner = "client!kv", name = "<init>", descriptor = "()V")
	private LinkedHashEntry_Sub1_Sub14() {
		this.anIntArray264 = new int[0];
		this.anIntArray265 = new int[0];
		this.aClass4_Sub6_1 = new LinkedHashEntry_Sub6_Sub21(0);
		this.aClass4_Sub6_1.anInt7106 = 1;
		this.aClass4_Sub6_2 = new LinkedHashEntry_Sub6_Sub21();
		this.aClass4_Sub6_2.anInt7106 = 1;
		this.aClass4_Sub6_3 = new LinkedHashEntry_Sub6_Sub21();
		this.aClass4_Sub6_3.anInt7106 = 1;
		this.aClass4_Sub6Array23 = new LinkedHashEntry_Sub6[] { this.aClass4_Sub6_2, this.aClass4_Sub6_3, this.aClass4_Sub6_1 };
	}

	@OriginalMember(owner = "client!kv", name = "<init>", descriptor = "(Lclient!iv;)V")
	public LinkedHashEntry_Sub1_Sub14(@OriginalArg(0) Packet arg0) {
		@Pc(7) int local7 = arg0.g1();
		@Pc(9) int local9 = 0;
		@Pc(11) int local11 = 0;
		@Pc(14) int[][] local14 = new int[local7][];
		this.aClass4_Sub6Array23 = new LinkedHashEntry_Sub6[local7];
		@Pc(50) int local50;
		for (@Pc(20) int local20 = 0; local20 < local7; local20++) {
			@Pc(26) LinkedHashEntry_Sub6 local26 = Static158.method2680(arg0);
		...
		for (@Pc(91) int local91 = 0; local91 < local7; local91++) {
			@Pc(98) LinkedHashEntry_Sub6 local98 = this.aClass4_Sub6Array23[local91];
