...
public final class Node_Sub38 extends Node {
  ...
  public Node_Sub4_Sub1[] aClass4_Sub4_Sub1Array1;
  ...
  public Node_Sub38(@OriginalArg(0) byte[] arg0) {
    this.aShortArray192 = new short[128];
    this.aByteArray71 = new byte[128];
    this.aClass4_Sub4_Sub1Array1 = new Node_Sub4_Sub1[128];
    ...
    local36.pos++;
    @Pc(80)
    int local80 = local36.pos;
    local36.pos += local38;
    @Pc(88)
    int local88;
    for (local88 = 0; local36.data[local88 + local36.pos] != 0; local88++) {}
    @Pc(105)
    byte[] local105 = new byte[local88];
    ...
    local88++;
    @Pc(133)
    int local133 = local36.pos;
    local36.pos += local88;
    @Pc(141)
    int local141;
    for (local141 = 0; local36.data[local36.pos + local141] != 0; local141++) {}
    @Pc(159)
    byte[] local159 = new byte[local141];
    ...
    local141++;
    @Pc(187)
    byte[] local187 = new byte[local141];
    @Pc(200)
    int local200;
    @Pc(202)
    int local202;
    ...
    @Pc(241)
    Class252[] local241 = new Class252[local200];
    for (local202 = 0; local202 < local241.length; local202++) {
      @Pc(253)
      Class252 local253 = local241[local202] = new Class252();
      @Pc(257)
      int local257 = local36.g1();
      if (local257 > 0) {
    ...
    local208 = local36.g1();
    @Pc(308)
    byte[] local308 = local208 <= 0 ? null : new byte[local208 * 2];
    local208 = local36.g1();
    @Pc(321)
    byte[] local321 = local208 <= 0 ? null : new byte[local208 * 2];
    @Pc(323)
    int local323;
    for (local323 = 0; local36.data[local323 + local36.pos] != 0; local323++) {}
    @Pc(340)
    byte[] local340 = new byte[local323];
    ...
    for (@Pc(424) int local424 = 0; local424 < 128; local424++) {
      ...
      this.aShortArray192[local424] =
          (short) (this.aShortArray192[local424] + ((local422 - 1 & 0x2) << 14));
    ...
    for (@Pc(484) int local484 = 0; local484 < 128; local484++) {
      if (this.anIntArray393[local484] != 0) {
        if (local418 == 0) {
          local482 = local36.data[local80++] - 1;
    ...
    for (@Pc(538) int local538 = 0; local538 < 128; local538++) {
      if (this.anIntArray393[local538] != 0) {
        if (local418 == 0) {
          local536 = local36.data[local133++] + 16 << 2;
    ...
    if (local308 != null) {
      ...
      while (local308.length > local956) {
        ...
        @Pc(968)
        byte local968 = local308[local956 + 1];
    ...
    if (local321 != null) {
      ...
      while (local321.length > local956) {
        ...
        for (local982 = local923; local982 < local962; local982++) {
          local992 = Static190.method2976(local980, local962 - local923);
          @Pc(1187)
          int local1187 = local992 + (this.aByteArray71[local982] & 0xFF);
          if (local1187 < 0) {
            local1187 = 0;
          }
          if (local1187 > 128) {
    ...
    for (local807 = 0; local807 < local200; local807++) {
      local241[local807].anInt6937 = local36.g1();
    }
    for (local852 = 0; local852 < local200; local852++) {
      @Pc(1294)
      Class252 local1294 = local241[local852];
      if (local1294.aByteArray100 != null) {
        local1294.anInt6943 = local36.g1();
      }
      if (local1294.aByteArray101 != null) {
        local1294.anInt6941 = local36.g1();
      }
      if (local1294.anInt6937 > 0) {
        local1294.anInt6938 = local36.g1();
      }
    }
    for (local1105 = 0; local1105 < local200; local1105++) {
      local241[local1105].anInt6939 = local36.g1();
    }
    for (local929 = 0; local929 < local200; local929++) {
      @Pc(1345)
      Class252 local1345 = local241[local929];
      if (local1345.anInt6939 > 0) {
        local1345.anInt6940 = local36.g1();
      }
    }
    for (local956 = 0; local956 < local200; local956++) {
      @Pc(1365)
      Class252 local1365 = local241[local956];
      if (local1365.anInt6940 > 0) {
        local1365.anInt6944 = local36.g1();
      }
    }
  }
  ...
  public boolean method4398(
      @OriginalArg(0) Class171 arg0, @OriginalArg(2) byte[] arg1, @OriginalArg(3) int[] arg2) {
    @Pc(16)
    boolean local16 = true;
    @Pc(18)
    int local18 = 0;
    @Pc(20)
    Node_Sub4_Sub1 local20 = null;
    for (@Pc(22) int local22 = 0; local22 < 128; local22++) {
      if (arg1 == null || arg1[local22] != 0) {
        @Pc(37)
        int local37 = this.anIntArray393[local22];
        if (local37 != 0) {
          if (local37 != local18) {
            local18 = local37--;
            if ((local37 & 0x1) == 0) {
