...
public final class Class9_Sub5 extends Class9 {
  ...
  public void method5370(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
    @Pc(14)
    float local14 = (float) ((arg0 & 0x3) + 1) * -5.0E-4F;
    @Pc(25)
    float local25 = (float) ((arg0 >> 3 & 0x3) + 1) * 5.0E-4F;
    @Pc(36)
    float local36 = (arg0 & 0x40) == 0 ? 4.8828125E-4F : 9.765625E-4F;
    super.aClass19_Sub2_41.method1936(1);
    @Pc(49)
    boolean local49 = (arg0 & 0x80) != 0;
    if (local49) {
    ...
    if (this.aClass144_5.aBoolean415) {
      ...
      @Pc(162)
      int local162 = (int) ((float) super.aClass19_Sub2_41.anInt2274 * 16.0F * local25);
