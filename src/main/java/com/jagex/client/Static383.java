...
public final class Static383 {
  ...
  public static Packet aPacket_7 = new Packet(1);

  @OriginalMember(owner = "client!tj", name = "g", descriptor = "[I")
  public static final int[] anIntArray496 =
      new int[] {36064, 36065, 36066, 36067, 36068, 36069, 36070, 36071, 36096};
  ...
  public static void method5070(@OriginalArg(0) String arg0) {
    ...
    @Pc(24)
    String local24 = Static123.method4868(arg0);
    if (local24 == null) {
      return;
    }
    for (@Pc(29) int local29 = 0; local29 < Static49.anInt2346; local29++) {
      @Pc(35)
      String local35 = Static194.aStringArray14[local29];
