	...
	public static void method2572(@OriginalArg(1) Class21 arg0) {
		...
		if (Static133.aClass21_8 == arg0) {
			...
			if (local49 >= 0 && local55 >= 0 && local49 < Static326.anInt5666 && Static283.anInt5187 > local55) {
				Static28.method528(new LinkedEntry_Sub45(local16, local12), local49, local55, Static113.anInt2426);
		...
		if (Static294.aClass21_4 == arg0) {
			...
			if (local40 >= 0 && local49 >= 0 && Static326.anInt5666 > local40 && local49 < Static283.anInt5187) {
				@Pc(395) LinkedEntry_Sub18 local395 = (LinkedEntry_Sub18) Static440.aLinkedHashMap_Iterator_40.get((long) (Static113.anInt2426 << 28 | local49 << 14 | local40));
				if (local395 != null) {
					for (@Pc(403) LinkedEntry_Sub45 local403 = (LinkedEntry_Sub45) local395.aClass183_14.method4140(); local403 != null; local403 = (LinkedEntry_Sub45) local395.aClass183_14.method4144()) {
			...
			if (arg0 == Static38.aClass21_6) {
				...
				if (Static440.aLinkedHashMap_Iterator_40 != null && local16 >= 0 && local40 >= 0 && Static326.anInt5666 > local16 && local40 < Static283.anInt5187) {
					@Pc(1265) LinkedEntry_Sub18 local1265 = (LinkedEntry_Sub18) Static440.aLinkedHashMap_Iterator_40.get((long) (local16 | local40 << 14 | Static113.anInt2426 << 28));
					if (local1265 != null) {
						for (@Pc(1273) LinkedEntry_Sub45 local1273 = (LinkedEntry_Sub45) local1265.aClass183_14.method4140(); local1273 != null; local1273 = (LinkedEntry_Sub45) local1265.aClass183_14.method4144()) {
				...
				if (local49 >= 0 && local55 >= 0 && Static326.anInt5666 > local49 && Static283.anInt5187 > local55 && local16 != Static207.anInt5452) {
					Static28.method528(new LinkedEntry_Sub45(local12, local126), local49, local55, Static113.anInt2426);
					Static443.method5595(Static113.anInt2426, local49, local55);
				}
