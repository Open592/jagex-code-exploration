...
public final class Class65_Sub2 extends Class65 {
  ...
  private Node_Sub16[][][] aClass4_Sub16ArrayArrayArray1;
  ...
  public Class65_Sub2(
    ...
    this.aClass4_Sub16ArrayArrayArray1 = new Node_Sub16[arg3][arg4][];
    ...
    for (@Pc(117) int local117 = 1; local117 < super.anInt5258; local117++) {
      for (@Pc(121) int local121 = 1; super.anInt5262 > local121; local121++) {
        @Pc(139)
        int local139 = arg6[local121 + 1][local117] - arg6[local121 - 1][local117];
        @Pc(156)
        int local156 = arg6[local121][local117 + 1] - arg6[local121][local117 - 1];
        @Pc(177)
        float local177 =
            (float)
                (1.0D
                    / Math.sqrt(
                        (double) (local139 * local139 + arg7 * arg7 * 4 + local156 * local156)));
  ...
  public void p(
    ...
    if (this.aClass236_2 != null && arg0 != null) {
      @Pc(24)
      int local24 =
          arg1 - (arg2 * this.aClass19_Sub2_30.anInt2289 >> 8) >> this.aClass19_Sub2_30.anInt2275;
      @Pc(39)
      int local39 =
          arg3 - (this.aClass19_Sub2_30.anInt2311 * arg2 >> 8) >> this.aClass19_Sub2_30.anInt2275;
  ...
  public SecondaryNode_Sub1_Sub4 k(
    ...
    @Pc(24)
    int local24 = super.anInt5261 >> this.aClass19_Sub2_30.anInt2275;
    @Pc(27)
    SecondaryNode_Sub1_Sub4_ local27 = (SecondaryNode_Sub1_Sub4_) arg2;
    @Pc(43)
    SecondaryNode_Sub1_Sub4_ local43;
    if (local27 != null && local27.method2301(local24, local24)) {
      local43 = local27;
      local27.method2304();
    } else {
      local43 = new SecondaryNode_Sub1_Sub4_(this.aClass19_Sub2_30, local24, local24);
    }
  ...
  public void method4025(
    ...
    Static370.aFloatArray28[5] =
        (float) 1024 / ((float) this.aClass19_Sub2_30.anInt2138 * 128.0F * (float) super.anInt5261);
    ...
    Static370.aFloatArray28[0] =
        (float) 1024 / ((float) this.aClass19_Sub2_30.anInt2240 * 128.0F * (float) super.anInt5261);
    Static370.aFloatArray28[12] =
        -1.0F
            - ((float) 0 + (float) (arg0 * 1024) / 128.0F)
                / (float) this.aClass19_Sub2_30.anInt2240;
    Static370.aFloatArray28[4] = 0.0F;
    Static370.aFloatArray28[8] = 0.0F;
    Static370.aFloatArray28[11] = 0.0F;
    Static370.aFloatArray28[13] =
        1.0F
            - ((float) 0 + (float) (arg3 * 1024) / 128.0F)
                / (float) this.aClass19_Sub2_30.anInt2138;
    ...
    this.aClass19_Sub2_30.method1934(
        this.aClass177_13, this.aClass177_16, this.aClass177_14, this.aClass177_15);
    if (Static383.aPacket_7.data.length < this.anInt5270 * 2) {
      Static383.aPacket_7 = new Packet(this.anInt5270 * 2);
    } else {
      Static383.aPacket_7.pos = 0;
    }
    @Pc(305)
    int local305 = 0;
    @Pc(311)
          ...
          if (arg4[local323 - arg0][local311 - arg1]) {
            ...
            if (local342 != null) {
              for (local346 = 0; local346 < local342.length; local346++) {
                Static383.aPacket_7.p2(local342[local346] & 0xFFFF);
                local305++;
              }
            }
          }
        ...
        for (local323 = arg0; local323 < arg2; local323++) {
          if (arg4[local323 - arg0][local311 - arg1]) {
            ...
            if (local342 != null) {
              for (local346 = 0; local346 < local342.length; local346++) {
                local305++;
                Static383.aPacket_7.p2_alt1(local342[local346] & 0xFFFF);
              }
            }
          }
          local321++;
    ...
    if (local305 > 0) {
      @Pc(470)
      Class64_Sub1 local470 =
          new Class64_Sub1(
              this.aClass19_Sub2_30, 5123, Static383.aPacket_7.data, Static383.aPacket_7.pos);
  ...
  public boolean method4022(
    ...
    if (this.aClass236_2 == null || arg0 == null) {
      ...
      @Pc(24)
      int local24 =
          arg1 - (this.aClass19_Sub2_30.anInt2289 * arg2 >> 8) >> this.aClass19_Sub2_30.anInt2275;
      @Pc(39)
      int local39 =
          arg3 - (arg2 * this.aClass19_Sub2_30.anInt2311 >> 8) >> this.aClass19_Sub2_30.anInt2275;
  ...
  public void method4023(
    ...
    @Pc(8)
    int local8 = arg9.length;
    @Pc(13)
    int[] local13 = new int[local8 * 3];
    @Pc(18)
    int[] local18 = new int[local8 * 3];
    @Pc(23)
    int[] local23 = new int[local8 * 3];
    @Pc(28)
    int[] local28 = new int[local8 * 3];
    @Pc(33)
    int[] local33 = new int[local8 * 3];
    @Pc(38)
    int[] local38 = new int[local8 * 3];
    @Pc(47)
    int[] local47 = arg3 == null ? null : new int[local8 * 3];
    @Pc(56)
    int[] local56 = arg5 == null ? null : new int[local8 * 3];
    @Pc(58)
    int local58 = 0;
    for (@Pc(60) int local60 = 0; local60 < local8; local60++) {
      @Pc(66)
      int local66 = arg6[local60];
      @Pc(70)
      int local70 = arg7[local60];
      @Pc(74)
      int local74 = arg8[local60];
    ...
    this.B(
        arg0, arg1, local13, local47, local18, local56, local23, local28, local33, local38, arg13,
        arg14, arg15, false);
  }
  ...
  private void method4032(
      @OriginalArg(0) SecondaryNode_Sub1_Sub4_ arg0,
      @OriginalArg(1) int arg1,
      @OriginalArg(3) int arg2) {
    @Pc(12)
    int[] local12 = this.anIntArrayArrayArray6[arg1][arg2];
    @Pc(19)
    int[] local19 = this.anIntArrayArrayArray7[arg1][arg2];
    @Pc(22)
    int local22 = local12.length;
    ...
    for (@Pc(34) int local34 = 0; local34 < local22; local34++) {
      Static227.anIntArray293[local34] =
          (local12[local34] & 0xFF) >> this.aClass19_Sub2_30.anInt2275;
      Static321.anIntArray387[local34] =
          (local19[local34] & 0xFF) >> this.aClass19_Sub2_30.anInt2275;
    }
    @Pc(74)
    int local74 = 0;
    while (local22 > local74) {
      @Pc(80)
      int local80 = Static227.anIntArray293[local74];
      @Pc(85)
      int local85 = Static321.anIntArray387[local74++];
      @Pc(89)
      int local89 = Static227.anIntArray293[local74];
      @Pc(94)
      int local94 = Static321.anIntArray387[local74++];
      @Pc(98)
      int local98 = Static227.anIntArray293[local74];
      @Pc(103)
      int local103 = Static321.anIntArray387[local74++];
      if (-((local98 - local89) * (-local85 + local94)) + (local94 - local103) * (local80 - local89)
          > 0) {
  ...
  public void B(
    ...
    @Pc(88)
    Node_Sub16[] local88 =
        this.aClass4_Sub16ArrayArrayArray1[arg0][arg1] = new Node_Sub16[arg6.length];
    for (@Pc(90) int local90 = 0; local90 < arg6.length; local90++) {
      ...
      long local119 =
          (long) arg10 << 28
              | (long) arg12 << 48
              | (long) arg11 << 42
              | (long) (arg9[local90] << 14)
              | (long) arg8[local90];
      @Pc(125)
      Node local125;
      for (local125 = this.aHashMap_27.get(local119);
          local125 != null;
          local125 = this.aHashMap_27.nextFoundNode()) {
        @Pc(130)
        Node_Sub16 local130 = (Node_Sub16) local125;
        if (arg8[local90] == local130.anInt1647
            && local130.aFloat46 == (float) arg9[local90]
            && local130.anInt1641 == arg10
            && local130.anInt1640 == arg11
            && local130.anInt1645 == arg12) {
          break;
        }
      }
      if (local125 == null) {
  ...
  public int a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
    @Pc(8)
    int local8 = arg0 >> super.anInt5256;
    @Pc(13)
    int local13 = arg1 >> super.anInt5256;
    if (local8 < 0
        || local13 < 0
        || super.anInt5262 - 1 < local8
        || super.anInt5258 - 1 < local13) {
      return 0;
    }
    @Pc(44)
    int local44 = super.anInt5261 - 1 & arg0;
    @Pc(51)
    int local51 = super.anInt5261 - 1 & arg1;
    @Pc(78)
    int local78 =
        this.anIntArrayArray44[local8 + 1][local13] * local44
                + this.anIntArrayArray44[local8][local13] * (super.anInt5261 - local44)
            >> super.anInt5256;
    @Pc(110)
    int local110 =
        (super.anInt5261 - local44) * this.anIntArrayArray44[local8][local13 + 1]
                + local44 * this.anIntArrayArray44[local8 + 1][local13 + 1]
            >> super.anInt5256;
  ...
  public void ca() {
    if (this.anInt5288 <= 0) {
      ...
      @Pc(23)
      byte[][] local23 = new byte[super.anInt5262 + 1][super.anInt5258 + 1];
      @Pc(29)
      int local29;
      for (@Pc(25) int local25 = 1; local25 < super.anInt5262; local25++) {
        for (local29 = 1; super.anInt5258 > local29; local29++) {
          local23[local25][local29] =
              (byte)
                  ((this.aByteArrayArray23[local25 + 1][local29] >> 3)
                      + (this.aByteArrayArray23[local25 - 1][local29] >> 2)
                      + (this.aByteArrayArray23[local25][local29 - 1] >> 2)
                      + (this.aByteArrayArray23[local25][local29 + 1] >> 3)
                      + (this.aByteArrayArray23[local25][local29] >> 1));
        }
      }
      ...
      @Pc(163)
      NativeBuffer local163 = this.aClass19_Sub2_30.aNativeHeap2.a(local141 * this.anInt5288);
      @Pc(168)
      NativeStream local168 = new NativeStream(local163);
      @Pc(172)
      Node_Sub16[] local172 = new Node_Sub16[this.anInt5288];
      @Pc(179)
      int local179 = Static159.method2696(this.anInt5288 / 4);
      if (local179 < 1) {
        local179 = 1;
      }
      @Pc(189)
      HashMap local189 = new HashMap(local179);
      @Pc(193)
      Node_Sub16[] local193 = new Node_Sub16[this.anInt5287];
      @Pc(199)
      int local199;
      for (@Pc(195) int local195 = 0; super.anInt5262 > local195; local195++) {
        for (local199 = 0; local199 < super.anInt5258; local199++) {
          if (this.anIntArrayArrayArray11[local195][local199] != null) {
            @Pc(215)
            Node_Sub16[] local215 = this.aClass4_Sub16ArrayArrayArray1[local195][local199];
            @Pc(222)
            int[] local222 = this.anIntArrayArrayArray6[local195][local199];
            @Pc(229)
            int[] local229 = this.anIntArrayArrayArray7[local195][local199];
            @Pc(236)
            int[] local236 = this.anIntArrayArrayArray10[local195][local199];
            @Pc(243)
            int[] local243 = this.anIntArrayArrayArray11[local195][local199];
            @Pc(255)
            int[] local255 =
                this.anIntArrayArrayArray8 == null
                    ? null
                    : this.anIntArrayArrayArray8[local195][local199];
            @Pc(267)
            int[] local267 =
                this.anIntArrayArrayArray9 == null
                    ? null
                    : this.anIntArrayArrayArray9[local195][local199];
            if (local236 == null) {
              local236 = local243;
            }
            @Pc(278)
            float local278 = this.aFloatArrayArray9[local195][local199];
            @Pc(285)
            float local285 = this.aFloatArrayArray7[local195][local199];
            @Pc(292)
            float local292 = this.aFloatArrayArray8[local195][local199];
            @Pc(301)
            float local301 = this.aFloatArrayArray9[local195][local199 + 1];
            @Pc(310)
            float local310 = this.aFloatArrayArray7[local195][local199 + 1];
            @Pc(319)
            float local319 = this.aFloatArrayArray8[local195][local199 + 1];
            @Pc(330)
            float local330 = this.aFloatArrayArray9[local195 + 1][local199 + 1];
            @Pc(341)
            float local341 = this.aFloatArrayArray7[local195 + 1][local199 + 1];
            @Pc(352)
            float local352 = this.aFloatArrayArray8[local195 + 1][local199 + 1];
            @Pc(361)
            float local361 = this.aFloatArrayArray9[local195 + 1][local199];
            @Pc(370)
            float local370 = this.aFloatArrayArray7[local195 + 1][local199];
            @Pc(379)
            float local379 = this.aFloatArrayArray8[local195 + 1][local199];
            @Pc(387)
            int local387 = local23[local195][local199] & 0xFF;
            @Pc(397)
            int local397 = local23[local195][local199 + 1] & 0xFF;
            @Pc(409)
            int local409 = local23[local195 + 1][local199 + 1] & 0xFF;
            @Pc(419)
            int local419 = local23[local195 + 1][local199] & 0xFF;
            @Pc(421)
            int local421 = 0;
            @Pc(431)
            int local431;
            label335:
            for (@Pc(423) int local423 = 0; local423 < local243.length; local423++) {
              @Pc(429)
              Node_Sub16 local429 = local215[local423];
            ...
            @Pc(473)
            short[] local473 =
                this.aShortArrayArray9[local199 * super.anInt5262 + local195] =
                    new short[local243.length];
            for (local431 = 0; local431 < local243.length; local431++) {
              @Pc(487)
              int local487 = (local195 << super.anInt5256) + local222[local431];
              @Pc(496)
              int local496 = (local199 << super.anInt5256) + local229[local431];
              @Pc(501)
              int local501 = local487 >> this.anInt5272;
              @Pc(506)
              int local506 = local496 >> this.anInt5272;
              @Pc(510)
              int local510 = local243[local431];
              @Pc(514)
              int local514 = local236[local431];
              @Pc(522)
              int local522 = local255 == null ? 0 : local255[local431];
              @Pc(540)
              long local540 =
                  (long) local506
                      | (long) local510 << 32
                      ...
                      | (long) (local501 << 16);
              @Pc(544)
              int local544 = local222[local431];
              @Pc(548)
              int local548 = local229[local431];
              @Pc(550)
              byte local550 = 74;
              @Pc(552)
              int local552 = 0;
              ...
              if (local544 == 0 && local548 == 0) {
                ...
                @Pc(612)
                float local612 = (float) local544 / (float) super.anInt5261;
                @Pc(619)
                float local619 = (float) local548 / (float) super.anInt5261;
                @Pc(627)
                float local627 = local278 + local612 * (local361 - local278);
                local636 = local285 + local612 * (local370 - local285);
                @Pc(645)
                float local645 = local292 + (local379 - local292) * local612;
                @Pc(653)
                float local653 = (local330 - local301) * local612 + local301;
                @Pc(661)
                float local661 = local310 + local612 * (local341 - local310);
                local588 = local636 + local619 * (local661 - local636);
                @Pc(679)
                float local679 = (local352 - local319) * local612 + local319;
                local586 = (local653 - local627) * local619 + local627;
                local590 = local645 + local619 * (local679 - local645);
                @Pc(709)
                int local709 = local387 + (local544 * (local419 - local387) >> super.anInt5256);
                @Pc(721)
                int local721 = (local544 * (local409 - local397) >> super.anInt5256) + local397;
                local594 =
                    local550 - local709 - ((local721 - local709) * local548 >> super.anInt5256);
              }
              @Pc(774)
              float local774 = 1.0F;
              if (local510 != -1) {
                @Pc(785)
                int local785 = (local510 & 0x7F) * local594 >> 7;
                if (local785 < 2) {
                  local785 = 2;
                ...
                if ((this.anInt5285 & 0x7) == 0) {
                  local774 =
                      this.aClass19_Sub2_30.aFloatArray19[1] * local588
                          + local586 * this.aClass19_Sub2_30.aFloatArray19[0]
                          + local590 * this.aClass19_Sub2_30.aFloatArray19[2];
                  local774 =
                      local774
                              * (local774 > 0.0F
                                  ? this.aClass19_Sub2_30.aFloat73
                                  : this.aClass19_Sub2_30.aFloat65)
                          + this.aClass19_Sub2_30.aFloat70;
                }
              }
              @Pc(861)
              Node local861 = null;
              ...
              if (local861 == null) {
                if (local510 == local514) {
                  ...
                  @Pc(904)
                  int local904 = local594 * (local514 & 0x7F) >> 7;
                  if (local904 < 2) {
                    local904 = 2;
                  ...
                  if ((this.anInt5285 & 0x7) == 0) {
                    local636 =
                        this.aClass19_Sub2_30.aFloatArray19[2] * local590
                            + this.aClass19_Sub2_30.aFloatArray19[0] * local586
                            + this.aClass19_Sub2_30.aFloatArray19[1] * local588;
                    local636 =
                        this.aClass19_Sub2_30.aFloat70
                            + (local774 > 0.0F
                                ...
                                * local774;
                    @Pc(982)
                    int local982 = local894 >> 16 & 0xFF;
                    @Pc(988)
                    int local988 = local894 >> 8 & 0xFF;
                    @Pc(992)
                    int local992 = local894 & 0xFF;
                ...
                local189.set(local540, new Node_Sub31(local473[local431]));
              } else {
                local473[local431] = ((Node_Sub31) local861).aShort62;
                local1229 = local473[local431] & 0xFFFF;
                if (local510 != -1 && local172[local1229].hashKey > local215[local431].hashKey) {
                  local172[local1229] = local215[local431];
                }
              }
      ...
      for (local199 = 0; local199 < this.anInt5280; local199++) {
        @Pc(1337)
        Node_Sub16 local1337 = local172[local199];
        if (local1337 != null) {
      ...
      for (@Pc(1350) int local1350 = 0; super.anInt5262 > local1350; local1350++) {
        for (@Pc(1354) int local1354 = 0; local1354 < super.anInt5258; local1354++) {
          @Pc(1366)
          short[] local1366 = this.aShortArrayArray9[local1354 * super.anInt5262 + local1350];
          if (local1366 != null) {
            local1370 = 0;
            @Pc(1372)
            int local1372 = 0;
            while (local1372 < local1366.length) {
              @Pc(1381)
              int local1381 = local1366[local1372++] & 0xFFFF;
              @Pc(1388)
              int local1388 = local1366[local1372++] & 0xFFFF;
              @Pc(1395)
              int local1395 = local1366[local1372++] & 0xFFFF;
              @Pc(1399)
              Node_Sub16 local1399 = local172[local1381];
              @Pc(1403)
              Node_Sub16 local1403 = local172[local1388];
              @Pc(1407)
              Node_Sub16 local1407 = local172[local1395];
              @Pc(1409)
              Node_Sub16 local1409 = null;
              if (local1399 != null) {
              ...
              if (local1403 != null) {
                ...
                if (local1409 == null || local1409.hashKey > local1403.hashKey) {
                  local1409 = local1403;
                }
              }
              if (local1407 != null) {
                local1407.method1464(local1354, local1370, local1350);
                if (local1409 == null || local1409.hashKey > local1407.hashKey) {
                  local1409 = local1407;
                }
              }
              if (local1409 != null) {
      ...
      @Pc(1586)
      long[] local1586 = new long[this.aClass4_Sub16Array1.length];
      for (local1370 = 0; local1370 < this.aClass4_Sub16Array1.length; local1370++) {
        @Pc(1595)
        Node_Sub16 local1595 = this.aClass4_Sub16Array1[local1370];
        local1586[local1370] = local1595.hashKey;
  ...
  private void method4034(
    ...
    @Pc(8)
    float local8 = this.aClass19_Sub2_30.aFloat67;
    @Pc(12)
    float local12 = this.aClass19_Sub2_30.aFloat63;
    @Pc(19)
    int local19 = arg4 + arg4 + 1;
    @Pc(23)
    int local23 = local19 * local19;
    ...
    for (@Pc(119) int local119 = local59; local119 <= local81; local119++) {
      @Pc(128)
      boolean[] local128 = arg2[local119 - local61];
    ...
    if (!this.aLinkedList_37.isEmpty()) {
      ...
      @Pc(227)
      int local227 = this.aClass19_Sub2_30.anInt2315;
      ...
      for (@Pc(294) Node local294 = this.aLinkedList_37.tail();
          local294 != null;
          local294 = this.aLinkedList_37.previous()) {
        @Pc(299)
        Node_Sub24 local299 = (Node_Sub24) local294;
