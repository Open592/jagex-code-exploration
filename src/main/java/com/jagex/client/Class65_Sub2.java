...
public final class Class65_Sub2 extends Class65 {
	...
	@Override
	public void p(@OriginalArg(0) Node_Sub1_Sub4 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5) {
	...
	@Override
	public Node_Sub1_Sub4 k(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Node_Sub1_Sub4 arg2) {
		if ((this.aByteArrayArray22[arg0][arg1] & 0x1) == 0) {
			return null;
		}
		@Pc(24) int local24 = super.anInt5261 >> this.aClass19_Sub2_30.anInt2275;
		@Pc(27) Node_Sub1_Sub4_Sub1 local27 = (Node_Sub1_Sub4_Sub1) arg2;
		@Pc(43) Node_Sub1_Sub4_Sub1 local43;
		if (local27 != null && local27.method2301(local24, local24)) {
			local43 = local27;
			local27.method2304();
		} else {
			local43 = new Node_Sub1_Sub4_Sub1(this.aClass19_Sub2_30, local24, local24);
		}
	...
	@Override
	public void b(@OriginalArg(0) Node_Sub1_Sub4 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5) {
		if (this.aClass236_2 != null && arg0 != null) {
			@Pc(24) int local24 = arg1 - (arg2 * this.aClass19_Sub2_30.anInt2289 >> 8) >> this.aClass19_Sub2_30.anInt2275;
			@Pc(39) int local39 = arg3 - (this.aClass19_Sub2_30.anInt2311 * arg2 >> 8) >> this.aClass19_Sub2_30.anInt2275;
	...
	private void method4032(@OriginalArg(0) Node_Sub1_Sub4_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2) {
	...
	public void ca() {
		if (this.anInt5288 <= 0) {
			...
			this.aClass4_Sub16Array1 = new Node_Sub16[this.aClass102_27.method2698()];
					...
					if (this.anIntArrayArrayArray11[local195][local199] != null) {
						...
						for (local431 = 0; local431 < local243.length; local431++) {
							...
							if (local861 == null) {
								...
								local189.method2703(local540, new Node_Sub31(local473[local431]));
							} else {
