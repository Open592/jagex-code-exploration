...
public final class Static293 {
  ...
  public static void method4033(@OriginalArg(1) Class19 arg0) {
    ...
    @Pc(13)
    int local13 = Static112.anInt2392;
    ...
    Static331.aClass46_10.method5058(
        ...
        local7 + 3);
    @Pc(77)
    int local77 = Static420.aClass80_1.method2234();
    @Pc(81)
    int local81 = Static420.aClass80_1.method2230();
    @Pc(83)
    int local83 = 0;
    for (@Pc(90) Node_Sub39 local90 = (Node_Sub39) Static206.A_LINKED_LIST___28.tail();
        local90 != null;
        local90 = (Node_Sub39) Static206.A_LINKED_LIST___28.previous()) {
      @Pc(105)
      int local105 = (Static407.anInt6710 - local83 - 1) * 16 + local9 + 31;
      @Pc(107)
      short local107 = -1;
      if (local7 < local77
          && local7 + local11 > local77
          && local81 > local105 - 13
          && local105 + 3 > local81
          && local90.aBoolean512) {
        local107 = -256;
      ...
      if (Static441.method5569(local90.anInt5699)) {
        ...
        @Pc(214)
        Class16_Sub1_Sub5_Sub2 local214 =
            Static143.aClass16_Sub1_Sub5_Sub2Array1[(int) local90.aLong192];
        if (local214 != null) {
          @Pc(219)
          Class264 local219 = local214.aClass264_1;
        ...
        if (local90.anInt5699 == 1010) {
          ...
          local186 =
              Static267.aClass262_2.method5560((int) (local90.aLong192 >>> 32 & 0x7FFFFFFFL));
        }
      ...
      @Pc(255)
      String local255 = Static200.method3166(local90);
      if (local149 != null) {
      ...
      if (local90.aBoolean511) {
        Static389.aClass57_22.method5534(
            Static118.aClass89_5.method2340(local255) + local7 + 5, local105 + -12);
      }
    }
