...
public final class Class194 {
  ...
  public Class194(
    ...
    this.aJs5_71 = arg3;
    @Pc(26)
    int local26 = this.aJs5_72.method2100() - 1;
    this.aJs5_72.method2108(local26);
  }
  ...
  public void method4419() {
    @Pc(2)
    Class68 local2 = this.aClass68_36;
    synchronized (this.aClass68_36) {
  ...
  public Class161 method4421(@OriginalArg(1) int arg0) {
    @Pc(12)
    Class68 local12 = this.aClass68_36;
    @Pc(22)
    Class161 local22;
    synchronized (this.aClass68_36) {
    ...
    @Pc(43)
    byte[] local43 =
        this.aJs5_72.method2104(Static177.method2530(arg0), Static236.method3528(arg0));
    local22 = new Class161();
    local22.anInt5005 = arg0;
    local22.aClass194_1 = this;
    if (local43 != null) {
      local22.method3831(new Packet(local43));
    }
    @Pc(65)
    Class68 local65 = this.aClass68_36;
    synchronized (this.aClass68_36) {
