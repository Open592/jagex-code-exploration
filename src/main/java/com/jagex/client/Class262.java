...
public final class Class262 {
  ...
  public Class262(
    ...
    if (this.aJs5_101 != null) {
      @Pc(47)
      int local47 = this.aJs5_101.method2100() - 1;
  ...
  public void method5556() {
    @Pc(2)
    Class68 local2 = this.aClass68_54;
    synchronized (this.aClass68_54) {
  ...
  public Class202 method5560(@OriginalArg(0) int arg0) {
    @Pc(10)
    Class68 local10 = this.aClass68_54;
    @Pc(20)
    Class202 local20;
    synchronized (this.aClass68_54) {
    ...
    @Pc(41)
    byte[] local41 = this.aJs5_101.method2104(Static27.method523(arg0), Static306.method4142(arg0));
    local20 = new Class202();
    local20.aClass262_4 = this;
    local20.anInt5823 = arg0;
    if (local41 != null) {
      local20.method4596(new Packet(local41));
    }
    local20.method4581();
    ...
    @Pc(87)
    Class68 local87 = this.aClass68_54;
    synchronized (this.aClass68_54) {
