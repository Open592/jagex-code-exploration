...
public final class Class150 implements Interface3 {
  ...
  public void method3614(@OriginalArg(0) SecondaryNode_Sub1_Sub13 arg0, @OriginalArg(1) int arg1) {
    if (this.anInt4609 == -1) {
      throw new RuntimeException();
    }
    @Pc(23)
    int local23 = 0x1 << arg1;
  ...
  public boolean method3616() {
    @Pc(7)
    int local7 = OpenGL.glCheckFramebufferStatusEXT(this.anInt4609);
    return local7 == 36053;
  }
