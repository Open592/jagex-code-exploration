...
public final class Node_Sub10_Sub1 extends Node_Sub10 {
  ...
  public Node_Sub10_Sub1(@OriginalArg(0) Class19_Sub2 arg0) {
    super(arg0);
  }
  ...
  public void method2000(
      ...
      @OriginalArg(2) Class6_Sub1 arg1,
      @OriginalArg(3) Class6_Sub1 arg2) {
    ...
    if (this.aClass6_Sub1Array1 == null) {
      ...
      @Pc(266)
      long local266 = this.aClass210_6.aLong202;
      ...
      OpenGL.glUniform3fARB(
          OpenGL.glGetUniformLocationARB(local266, "params"), Static15.aFloat7, 0.0F, 0.0F);
      OpenGL.glBegin(7);
      ...
      @Pc(32)
      int local32 = Static159.method2696(this.anInt2349);
      @Pc(37)
      int local37 = Static159.method2696(this.anInt2354);
      @Pc(39)
      int local39 = 0;
      ...
      OpenGL.glUniform3fARB(
          OpenGL.glGetUniformLocationARB(local198, "params"), Static15.aFloat7, 0.0F, 0.0F);
      OpenGL.glBegin(7);
      OpenGL.glTexCoord2f(0.0F, 0.0F);
      OpenGL.glVertex2i(0, 0);
      OpenGL.glTexCoord2f(1.0F, 0.0F);
    ...
    OpenGL.glUniform3fARB(
        OpenGL.glGetUniformLocationARB(local338, "step"), 0.0F, 0.00390625F, 0.0F);
    OpenGL.glBegin(7);
    OpenGL.glTexCoord2f(0.0F, 0.0F);
    OpenGL.glVertex2i(0, 0);
    OpenGL.glTexCoord2f(1.0F, 0.0F);
    ...
    OpenGL.glUniform3fARB(
        OpenGL.glGetUniformLocationARB(local198, "params"),
        Static421.aFloat215,
        Static159.aFloat108,
        0.0F);
  ...
  public boolean method2008() {
    return super.aClass19_Sub2_16.aBoolean191
        && super.aClass19_Sub2_16.aBoolean214
        && super.aClass19_Sub2_16.aBoolean193;
  }
  ...
  public boolean method2005() {
    if (!super.aClass19_Sub2_16.aBoolean191
        || !super.aClass19_Sub2_16.aBoolean214
        || !super.aClass19_Sub2_16.aBoolean193) {
      return false;
    }
  ...
  public void method2007(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
    ...
    this.anInt2354 = arg0;
    @Pc(20)
    int local20 = Static159.method2696(this.anInt2349);
    @Pc(25)
    int local25 = Static159.method2696(this.anInt2354);
      ...
      while (true) {
        if (local42 <= 256 && local82 <= 256) {
          ...
          while (true) {
            ...
            this.aClass6_Sub1Array1[local84++] =
                new Class6_Sub1(super.aClass19_Sub2_16, 3553, 34842, local42, local82);
            if (local82 > 256) {
              local82 >>= 0x1;
            }
            if (local42 > 256) {
