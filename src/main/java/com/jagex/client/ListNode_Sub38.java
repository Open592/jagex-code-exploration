...
public final class ListNode_Sub38 extends ListNode {
	...
	public ListNode_Sub4_Sub1[] aClass4_Sub4_Sub1Array1;
	...
	private ListNode_Sub38() {
	}

	@OriginalMember(owner = "client!qh", name = "<init>", descriptor = "([B)V")
	public ListNode_Sub38(@OriginalArg(0) byte[] arg0) {
		this.aShortArray192 = new short[128];
		this.aByteArray71 = new byte[128];
		this.aClass4_Sub4_Sub1Array1 = new ListNode_Sub4_Sub1[128];
	...
	public boolean method4398(@OriginalArg(0) Class171 arg0, @OriginalArg(2) byte[] arg1, @OriginalArg(3) int[] arg2) {
		...
		@Pc(18) int local18 = 0;
		@Pc(20) ListNode_Sub4_Sub1 local20 = null;
