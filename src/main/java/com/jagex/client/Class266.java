...
public class Class266 {
  ...
  private final int[] anIntArray556 =
      new int[] {0, 0, 0, 64, 128, 128, 128, 64, 64, 96, 32, 32, 64};

  @OriginalMember(owner = "client!wj", name = "l", descriptor = "[I")
  private final int[] anIntArray555 =
      new int[] {0, 64, 128, 128, 128, 64, 0, 0, 32, 64, 32, 96, 64};
  ...
  @OriginalMember(
      owner = "client!wj",
      name = "<init>",
      descriptor = "(IIIZLclient!kb;Lclient!qd;)V")
  protected Class266(
      @OriginalArg(0) int arg0,
      @OriginalArg(1) int arg1,
      @OriginalArg(2) int arg2,
      @OriginalArg(3) boolean arg3,
      @OriginalArg(4) Class124 arg4,
      @OriginalArg(5) Class192 arg5) {
  ...
  public final void method5631(
    ...
    for (@Pc(3) int local3 = arg3; local3 < arg3 + arg0; local3++) {
      for (local7 = arg4; local7 < arg2 + arg4; local7++) {
        if (local7 >= 0 && local7 < this.anInt7296 && local3 >= 0 && this.anInt7290 > local3) {
          this.anIntArrayArrayArray15[arg1][local7][local3] =
              arg1 <= 0 ? 0 : this.anIntArrayArrayArray15[arg1 - 1][local7][local3] - 240;
        }
      }
    }
    if (arg4 > 0 && arg4 < this.anInt7296) {
      for (local7 = arg3 + 1; local7 < arg0 + arg3; local7++) {
        if (local7 >= 0 && local7 < this.anInt7290) {
          this.anIntArrayArrayArray15[arg1][arg4][local7] =
              this.anIntArrayArrayArray15[arg1][arg4 - 1][local7];
        }
      }
    }
    if (arg3 > 0 && arg3 < this.anInt7290) {
      for (local7 = arg4 + 1; local7 < arg4 + arg2; local7++) {
        if (local7 >= 0 && local7 < this.anInt7296) {
          this.anIntArrayArrayArray15[arg1][local7][arg3] =
              this.anIntArrayArrayArray15[arg1][local7][arg3 - 1];
        }
      }
    }
    ...
    if (arg1 != 0) {
      if (arg4 > 0
          && this.anIntArrayArrayArray15[arg1 - 1][arg4 - 1][arg3]
              != this.anIntArrayArrayArray15[arg1][arg4 - 1][arg3]) {
        this.anIntArrayArrayArray15[arg1][arg4][arg3] =
            this.anIntArrayArrayArray15[arg1][arg4 - 1][arg3];
        return;
      }
      if (arg3 > 0
          && this.anIntArrayArrayArray15[arg1 - 1][arg4][arg3 - 1]
              != this.anIntArrayArrayArray15[arg1][arg4][arg3 - 1]) {
        this.anIntArrayArrayArray15[arg1][arg4][arg3] =
            this.anIntArrayArrayArray15[arg1][arg4][arg3 - 1];
        return;
      }
      if (arg4 > 0
          && arg3 > 0
          && this.anIntArrayArrayArray15[arg1 - 1][arg4 - 1][arg3 - 1]
              != this.anIntArrayArrayArray15[arg1][arg4 - 1][arg3 - 1]) {
        this.anIntArrayArrayArray15[arg1][arg4][arg3] =
            this.anIntArrayArrayArray15[arg1][arg4 - 1][arg3 - 1];
        return;
      }
  ...
  public final void method5633(@OriginalArg(1) int[][] arg0) {
    @Pc(10)
    int[][] local10 = this.anIntArrayArrayArray15[0];
  ...
  public final void method5634(
      @OriginalArg(1) int arg0,
      @OriginalArg(2) int arg1,
      @OriginalArg(3) Packet arg2,
      @OriginalArg(4) int arg3,
      @OriginalArg(5) Class213[] arg4,
    ...
    if (!this.aBoolean687) {
      for (local16 = 0; local16 < 4; local16++) {
        @Pc(22)
        Class213 local22 = arg4[local16];
        for (local24 = 0; local24 < 64; local24++) {
          for (local28 = 0; local28 < 64; local28++) {
            local34 = arg3 + local24;
            @Pc(38)
            int local38 = arg5 + local28;
            if (local34 >= 0
                && local34 < this.anInt7296
                && local38 >= 0
                && this.anInt7290 > local38) {
  ...
  public final void method5635(
      @OriginalArg(0) int[][][] arg0,
      @OriginalArg(2) Class213[] arg1,
      @OriginalArg(3) Class19 arg2) {
    @Pc(6)
    int local6;
    @Pc(10)
    int local10;
    ...
    for (local6 = 0; local6 < this.anInt7302; local6++) {
      ...
      @Pc(149)
      int[][] local149 =
          arg0 == null || local6 >= arg0.length
              ? this.anIntArrayArrayArray15[local6]
              : arg0[local6];
      Static263.method3808(
          local6,
          arg2.method4297(
              this.anInt7296,
              this.anInt7290,
  ...
  @OriginalMember(
      owner = "client!wj",
      name = "a",
      descriptor = "(ILclient!ta;Lclient!ta;Lclient!ya;)V")
  public final void method5636(
      @OriginalArg(1) Class65 arg0, @OriginalArg(2) Class65 arg1, @OriginalArg(3) Class19 arg2) {
    ...
    @Pc(38)
    int[][] local38 = new int[this.anInt7296][this.anInt7290];
    @Pc(44)
    int local44;
    for (@Pc(40) int local40 = 0; local40 < this.anInt7302; local40++) {
      ...
      for (@Pc(77) int local77 = -5; local77 < this.anInt7296; local77++) {
        ...
        for (@Pc(81) int local81 = 0; local81 < this.anInt7290; local81++) {
          ...
          if (this.anInt7296 > local87) {
            ...
            if (local102 > 0) {
              @Pc(112)
              Class221 local112 = this.aClass192_5.method4340(local102 - 1);
          ...
          if (local102 >= 0) {
            ...
            if (local168 > 0) {
              @Pc(183)
              Class221 local183 = this.aClass192_5.method4340(local168 - 1);
        ...
        if (local77 >= 0) {
          ...
          for (@Pc(248) int local248 = -5; local248 < this.anInt7290; local248++) {
            ...
            if (local248 >= 0 && local244 > 0 && local246 > 0) {
              local38[local77][local248] =
                  Static89.method1599(
                      local102 / local246, local87 * 256 / local244, local168 / local246);
            }
          }
        }
      }
      if (Static54.aBoolean93) {
        this.method5639(
            ...
            local38,
            arg2,
            Static417.aClass65Array4[local40],
            local40 == 0 ? arg1 : null);
      } else {
        this.method5638(
            arg2,
    ...
    while (true) {
      ...
      if (local60 == 0) {
        if (this.aBoolean687) {
          ...
          this.anIntArrayArrayArray15[0][arg8 + arg2][arg0 + arg7] =
              -Static194.method3056(arg3 + 932731, arg1 + 556238) * 8 << 0;
          return;
        } else {
          this.anIntArrayArrayArray15[arg6][arg2 + arg8][arg7 + arg0] =
              this.anIntArrayArrayArray15[arg6 - 1][arg8 + arg2][arg7 + arg0] - 240;
          return;
        }
      }
      if (local60 == 1) {
        @Pc(196)
        int local196 = arg9.g1();
        if (!this.aBoolean687) {
          if (local196 == 1) {
            local196 = 0;
          }
          if (arg6 != 0) {
            this.anIntArrayArrayArray15[arg6][arg8 + arg2][arg0 + arg7] =
                this.anIntArrayArrayArray15[arg6 - 1][arg8 + arg2][arg0 + arg7]
                    - (local196 * 8 << 0);
            return;
          }
  ...
  @OriginalMember(
      owner = "client!wj",
      name = "a",
      descriptor = "(Lclient!ya;Lclient!ta;Lclient!ta;[[IIILclient!ta;)V")
  private void method5638(
      @OriginalArg(0) Class19 arg0,
      @OriginalArg(1) Class65 arg1,
      @OriginalArg(2) Class65 arg2,
      @OriginalArg(3) int[][] arg3,
      @OriginalArg(5) int arg4,
      @OriginalArg(6) Class65 arg5) {
    for (@Pc(12) int local12 = 0; local12 < this.anInt7296; local12++) {
      for (@Pc(16) int local16 = 0; local16 < this.anInt7290; local16++) {
        if (Static259.anInt4877 == -1
            || Static310.method4164(local12, Static259.anInt4877, arg4, local16)) {
          @Pc(40)
          byte local40 = this.aByteArrayArrayArray13[arg4][local12][local16];
          @Pc(49)
          byte local49 = this.aByteArrayArrayArray17[arg4][local12][local16];
          @Pc(60)
          int local60 = this.aByteArrayArrayArray15[arg4][local12][local16] & 0xFF;
          @Pc(71)
          int local71 = this.aByteArrayArrayArray16[arg4][local12][local16] & 0xFF;
          @Pc(86)
          Class113 local86 = local60 == 0 ? null : this.aClass124_7.method3150(local60 - 1);
          @Pc(100)
          Class221 local100 = local71 == 0 ? null : this.aClass192_5.method4340(local71 - 1);
          @Pc(102)
          int local102 = 0;
          @Pc(104)
          int local104 = 0;
          ...
          @Pc(145)
          int local145 = local102 + local104;
          @Pc(147)
          int local147 = 0;
          if (local145 != 0) {
            @Pc(152)
            int[] local152 = new int[local145];
            @Pc(155)
            int[] local155 = new int[local145];
            @Pc(158)
            int[] local158 = new int[local145];
            @Pc(161)
            int[] local161 = new int[local145];
            @Pc(163)
            boolean local163 = false;
            @Pc(182)
            int local182;
            @Pc(214)
            int local214;
            if (local86 == null
                || local86.anInt3381 == -1 && local86.anInt3372 == -1 && local86.anInt3378 == -1) {
              ...
              if (!this.aBoolean687 && arg4 == 0) {
                Static73.method1358(
                    local12, local16, local86.anInt3376, local86.anInt3383 * 8, local86.anInt3384);
              }
            }
            if (!local163) {
              local155 = null;
            ...
            @Pc(354)
            int[] local354 = new int[local182];
            @Pc(357)
            int[] local357 = new int[local182];
            @Pc(364)
            int[] local364 = arg2 == null ? null : new int[local182];
            @Pc(373)
            int[] local373 = arg2 == null && arg1 == null ? null : new int[local182];
            @Pc(382)
            int local382;
            @Pc(387)
            int local387;
            ...
            if (arg4 > 0) {
              ...
              if (local600
                  ...
                  && local382 == local472
                  && local478 == local382) {
                this.aByteArrayArrayArray12[arg4][local12][local16] =
                    (byte) (this.aByteArrayArrayArray12[arg4][local12][local16] | 0x4);
              }
            }
            @Pc(654)
            int local654 = 0;
            ...
            arg5.method4023(
                ...
                local357,
                local373,
                Static369.anIntArrayArray58[local40],
                Static108.anIntArrayArray23[local40],
                Static447.anIntArrayArray65[local40],
                local152,
                local155,
                local158,
                local161,
  ...
  @OriginalMember(
      owner = "client!wj",
      name = "a",
      descriptor = "(ILclient!ta;[[ILclient!ya;BLclient!ta;Lclient!ta;)V")
  private void method5639(
      @OriginalArg(0) int arg0,
      @OriginalArg(1) Class65 arg1,
      @OriginalArg(2) int[][] arg2,
      @OriginalArg(3) Class19 arg3,
      @OriginalArg(5) Class65 arg4,
      @OriginalArg(6) Class65 arg5) {
    @Pc(10)
    byte[][] local10 = this.aByteArrayArrayArray13[arg0];
    @Pc(24)
    byte[][] local24 = this.aByteArrayArrayArray17[arg0];
    @Pc(29)
    byte[][] local29 = this.aByteArrayArrayArray16[arg0];
    @Pc(34)
    byte[][] local34 = this.aByteArrayArrayArray15[arg0];
    for (@Pc(36) int local36 = 0; local36 < this.anInt7296; local36++) {
      @Pc(54)
      int local54 = this.anInt7296 - 1 > local36 ? local36 + 1 : local36;
      for (@Pc(56) int local56 = 0; local56 < this.anInt7290; local56++) {
        @Pc(70)
        int local70 = local56 >= this.anInt7290 - 1 ? local56 : local56 + 1;
        if (Static259.anInt4877 == -1
            || Static310.method4164(local36, Static259.anInt4877, arg0, local56)) {
          @Pc(84)
          boolean local84 = false;
          @Pc(86)
          boolean local86 = false;
          @Pc(89)
          boolean[] local89 = new boolean[4];
          @Pc(95)
          int local95 = local10[local36][local56];
          @Pc(101)
          int local101 = local24[local36][local56];
          @Pc(109)
          int local109 = local34[local36][local56] & 0xFF;
          @Pc(117)
          int local117 = local29[local36][local56] & 0xFF;
          @Pc(125)
          int local125 = local29[local36][local70] & 0xFF;
          @Pc(133)
          int local133 = local29[local54][local70] & 0xFF;
          @Pc(141)
          int local141 = local29[local54][local56] & 0xFF;
          if (local109 != 0 || local117 != 0) {
            @Pc(160)
            Class113 local160 = local109 == 0 ? null : this.aClass124_7.method3150(local109 - 1);
            @Pc(172)
            Class221 local172 = local117 == 0 ? null : this.aClass192_5.method4340(local117 - 1);
            if (local95 == 0 && local160 == null) {
              local95 = 12;
            }
            @Pc(180)
            Class113 local180 = local160;
            if (local160 != null) {
            ...
            @Pc(384)
            int local384;
            if ((local95 == 0 || local95 == 12)
                && local36 > 0
                && local56 > 0
                && this.anInt7296 > local36
                && this.anInt7290 > local56) {
              @Pc(248)
              int local248 = local117 == local29[local54][local70] ? 1 : -1;
              @Pc(263)
              int local263 = local117 == local29[local54][local56 - 1] ? 1 : -1;
            ...
            @Pc(465)
            boolean[] local465 =
                local160 != null && local160.aBoolean283
                    ? Static1.aBooleanArrayArray1[local95]
                    : Static169.aBooleanArrayArray2[local95];
            this.method5642(
                this.anInt7290,
                local34,
                local95,
                ...
                arg3);
            @Pc(498)
            boolean local498 = local160 != null && local160.anInt3381 != local160.anInt3372;
            if (!local498) {
              for (local301 = 0; local301 < 8; local301++) {
                if (Static154.anIntArray49[local301] >= 0
                    && Static115.anIntArray164[local301] != Static326.anIntArray395[local301]) {
                  local498 = true;
                  break;
                }
              }
            ...
            if (!local465[local101 + 1 & 0x3]) {
              local89[1] =
                  Static211.method3201(
                      local89[1], (Static299.anIntArray354[2] & Static299.anIntArray354[4]) == 0);
            }
            if (!local465[local101 + 3 & 0x3]) {
              local89[3] =
                  Static211.method3201(
                      local89[3], (Static299.anIntArray354[6] & Static299.anIntArray354[0]) == 0);
            }
            if (!local465[local101 & 0x3]) {
              local89[0] =
                  Static211.method3201(
                      local89[0], (Static299.anIntArray354[0] & Static299.anIntArray354[2]) == 0);
            }
            if (!local465[local101 + 2 & 0x3]) {
              local89[2] =
                  Static211.method3201(
                      local89[2], (Static299.anIntArray354[4] & Static299.anIntArray354[6]) == 0);
            }
            ...
            @Pc(807)
            boolean local807 = !local86 && !local89[0] && !local89[2] && !local89[1] && !local89[3];
            @Pc(809)
            int[] local809 = null;
            @Pc(821)
            int[] local821;
            ...
            @Pc(911)
            int local911 = local384 + local374;
            if (local911 <= 0) {
              ...
              int local943 = 0;
              @Pc(947)
              int local947 = local911 * 3;
              @Pc(954)
              int[] local954 = local498 ? new int[local947] : null;
              @Pc(957)
              int[] local957 = new int[local947];
              @Pc(960)
              int[] local960 = new int[local947];
              @Pc(963)
              int[] local963 = new int[local947];
              @Pc(966)
              int[] local966 = new int[local947];
              @Pc(969)
              int[] local969 = new int[local947];
              @Pc(976)
              int[] local976 = arg1 == null ? null : new int[local947];
              @Pc(985)
              int[] local985 = arg1 == null && arg5 == null ? null : new int[local947];
              @Pc(987)
              int local987 = -1;
              @Pc(989)
              int local989 = -1;
                ...
                for (local1015 = 0; local1015 < local384; local1015++) {
                  ...
                  for (local1246 = 0; local1246 < local1059; local1246++) {
                    ...
                    if (local976 != null && Static192.aBooleanArrayArray3[local95][local1252]) {
                      ...
                      local976[local943] =
                          arg1.a(local1341, local1347) - arg4.a(local1341, local1347);
                    }
                    if (local985 != null) {
                      if (arg1 != null && !Static192.aBooleanArrayArray3[local95][local1252]) {
                        ...
                        local1347 = local1291 + (local56 << 7);
                        local985[local943] =
                            arg4.a(local1341, local1347) - arg1.a(local1341, local1347);
                      } else if (arg5 != null
                          && !Static379.aBooleanArrayArray5[local95][local1252]) {
                        local1341 = local1289 + (local36 << 7);
                        local1347 = (local56 << 7) + local1291;
                        local985[local943] =
                            arg5.a(local1341, local1347) - arg4.a(local1341, local1347);
                      }
                    }
                    if (local1252 < 8 && Static154.anIntArray49[local1261] > local160.anInt3373) {
                      ...
                      local966[local943] =
                          arg3.method4243() ? local160.anInt3378 : local160.anInt3375;
              ...
              if (local172 != null) {
                ...
                @Pc(1596)
                Class221 local1596 = this.aClass192_5.method4340(local117 - 1);
                @Pc(1604)
                Class221 local1604 = this.aClass192_5.method4340(local125 - 1);
                @Pc(1612)
                Class221 local1612 = this.aClass192_5.method4340(local133 - 1);
                @Pc(1620)
                Class221 local1620 = this.aClass192_5.method4340(local141 - 1);
                for (local1261 = 0; local1261 < local374; local1261++) {
                  ...
                  for (local1266 = 0; local1266 < local1059; local1266++) {
                    ...
                    if (local976 != null && Static192.aBooleanArrayArray3[local95][local1289]) {
                      ...
                      local976[local943] =
                          arg1.a(local1942, local1948) - arg4.a(local1942, local1948);
                    }
                    if (local985 != null) {
                      if (arg1 != null && !Static192.aBooleanArrayArray3[local95][local1289]) {
                        ...
                        local985[local943] =
                            arg4.a(local1942, local1948) - arg1.a(local1942, local1948);
                      } else if (arg5 != null
                          && !Static379.aBooleanArrayArray5[local95][local1289]) {
                        local1942 = (local36 << 7) + local1341;
                        local1948 = (local56 << 7) + local1889;
                        local985[local943] =
                            arg5.a(local1942, local1948) - arg4.a(local1942, local1948);
                      }
                    }
                    if (local1289 < 8 && Static154.anIntArray49[local1271] >= 0) {
                      ...
                      if (local86 && Static192.aBooleanArrayArray3[local95][local1289]) {
                        ...
                        local1942 =
                            Static74.method1361(
                                local1341 << 7 >> 7,
                                arg2[local36][local56],
                                arg2[local54][local56]);
                        local1948 =
                            Static74.method1361(
                                local1341 << 7 >> 7,
                                arg2[local36][local70],
                                arg2[local54][local70]);
                        local963[local943] =
                            Static74.method1361(local1889 << 7 >> 7, local1942, local1948);
                      }
                      if (local954 != null) {
              ...
              if (arg0 > 0) {
                ...
                if (local2368
                    ...
                    && local1246 == local1013
                    && local1252 == local1013) {
                  this.aByteArrayArrayArray12[arg0][local36][local56] =
                      (byte) (this.aByteArrayArrayArray12[arg0][local36][local56] | 0x4);
                }
              }
              local1261 = 0;
              local1266 = 0;
              ...
              arg4.B(
                  local36, local56, local957, local976, local960, local985, local963, local954,
                  local966, local969, local1261, local1266, local1289, local84);
              Static172.method2809(arg0, local36, local56);
            }
          }
        }
  ...
  @OriginalMember(
      owner = "client!wj",
      name = "a",
      descriptor = "(ILclient!iv;I[Lclient!sd;BIIIII)V")
  public final void method5640(
      @OriginalArg(0) int arg0,
      @OriginalArg(1) Packet arg1,
      @OriginalArg(2) int arg2,
      @OriginalArg(3) Class213[] arg3,
      @OriginalArg(5) int arg4,
      @OriginalArg(6) int arg5,
    ...
    if (!this.aBoolean687) {
      @Pc(18)
      Class213 local18 = arg3[arg5];
      for (local20 = 0; local20 < 8; local20++) {
        for (@Pc(24) int local24 = 0; local24 < 8; local24++) {
          @Pc(38)
          int local38 = arg7 + Static407.method5252(local24 & 0x7, arg0, local20 & 0x7);
          local51 = arg6 + Static251.method3636(arg0, local20 & 0x7, local24 & 0x7);
          if (local38 > 0
              && local38 < this.anInt7296 - 1
              && local51 > 0
              && local51 < this.anInt7290 - 1) {
    ...
    @Pc(89)
    int local89 = (arg4 & 0x7) * 8;
    @Pc(95)
    int local95 = (arg8 & 0xFFFFFFF8) << 3;
          ...
          if (local51 == arg2
            ...
            if (local11 + 8 == local138 || local142 == local89 + 8) {
              ...
              if (local138 == 63 || local142 == 63) {
                @Pc(350)
                int local350 = local138 == 63 ? 64 : local138;
                @Pc(359)
                int local359 = local142 == 63 ? 64 : local142;
                @Pc(388)
                int local388;
                @Pc(379)
                int local379;
                ...
                if (local388 >= 0
                    && this.anInt7296 > local388
                    && local379 >= 0
                    && local379 < this.anInt7290) {
                  this.anIntArrayArrayArray15[arg5][local388][local379] =
                      this.anIntArrayArrayArray15[arg5][local223 + local103][local214 + local111];
                }
              }
            }
          } else {
  ...
  @OriginalMember(
      owner = "client!wj",
      name = "a",
      descriptor = "(II[[BIII[ZIILclient!is;[[BLclient!sr;[[BLclient!ya;)V")
  private void method5642(
      ...
      @OriginalArg(4) int arg3,
      @OriginalArg(5) int arg4,
      @OriginalArg(6) boolean[] arg5,
      @OriginalArg(7) int arg6,
      @OriginalArg(8) int arg7,
      @OriginalArg(9) Class113 arg8,
      @OriginalArg(10) byte[][] arg9,
      @OriginalArg(11) Class221 arg10,
      @OriginalArg(12) byte[][] arg11,
      @OriginalArg(13) Class19 arg12) {
    @Pc(53)
    int local53;
    if (arg8 != null && arg10 != null || arg10 != null && arg2 == 12 || arg8 != null && arg2 == 0) {
      @Pc(34)
      boolean[] local34 =
          arg8 != null && arg8.aBoolean283
              ? Static1.aBooleanArrayArray1[arg2]
              : Static169.aBooleanArrayArray2[arg2];
      @Pc(68)
      Class113 local68;
      @Pc(85)
      byte local85;
          ...
          if (local53 > 0) {
            ...
            if (local68.anInt3381 != -1 && local68.aBoolean283) {
              ...
              if (Static192.aBooleanArrayArray3[local85][local101]) {
                ...
                Static192.anIntArray240[0] =
                    arg12.method4243() ? local68.anInt3378 : local68.anInt3375;
          ...
          if (local68.anInt3381 != -1) {
            ...
            if (local68.aBoolean283) {
              ...
              for (local550 = 0; local550 < 3; local550++) {
                local106 &= 0x7;
                local543 &= 0x7;
                if (Static192.aBooleanArrayArray3[local85][local543]
                  ...
                  Static192.anIntArray240[local106] =
                      arg12.method4243() ? local68.anInt3378 : local68.anInt3375;
          ...
          if (local68.anInt3381 != -1) {
            ...
            if (local68.aBoolean283) {
              ...
              for (local550 = 0; local550 < 3; local550++) {
                ...
                local106 &= 0x7;
                if (Static192.aBooleanArrayArray3[local85][local543]
                    && local68.anInt3373 >= Static154.anIntArray49[local106]) {
                  Static326.anIntArray395[local106] = local68.anInt3381;
                  Static115.anIntArray164[local106] = local548;
                  Static192.anIntArray240[local106] =
                      arg12.method4243() ? local68.anInt3378 : local68.anInt3375;
    ...
    @Pc(1253)
    int local1253 = Static200.method3169(arg8, arg12);
    if (!arg8.aBoolean283) {
      return;
    }
    for (local53 = 0; local53 < 8; local53++) {
      @Pc(1269)
      int local1269 = local53 - arg4 * 2 & 0x7;
      if (Static192.aBooleanArrayArray3[arg2][local53]
          && arg8.anInt3373 >= Static154.anIntArray49[local1269]) {
