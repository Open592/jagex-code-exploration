...
public final class Static250 {
	...
	public static final SecondaryLinkedList A_SECONDARY_DOUBLY_LINKED_LIST___4 = new SecondaryLinkedList();

	@OriginalMember(owner = "client!mo", name = "a", descriptor = "(II)V")
	public static void method3629(@OriginalArg(1) int arg0) {
		@Pc(8) SecondaryNode_Sub1_Sub11 local8 = Static405.method5222(arg0, 2);
		local8.method2608();
	}
