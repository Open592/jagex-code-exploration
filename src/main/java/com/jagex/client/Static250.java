...
public final class Static250 {
  ...
  public static final SecondaryLinkedList A_SECONDARY_DOUBLY_LINKED_LIST___4 =
  ...
  public static void method3629(@OriginalArg(1) int arg0) {
    @Pc(8)
    SecondaryNode_Sub1_Sub11 local8 = Static405.method5222(arg0, 2);
    local8.method2608();
  }
  ...
  public static void method3634(
    ...
    if (arg4 > 0 && !Static424.method5413(arg4)) {
      ...
      @Pc(34)
      int local34 = Static9.method92(6408);
      @Pc(36)
      int local36 = 0;
      @Pc(47)
      int local47 = arg4 < arg5 ? arg4 : arg5;
      @Pc(51)
      int local51 = arg4 >> 1;
      @Pc(55)
      int local55 = arg5 >> 1;
      ...
      float[] local63 = arg2;
      @Pc(70)
      float[] local70 = new float[local55 * local51 * local34];
      while (true) {
        ...
        for (@Pc(92) int local92 = 0; local92 < local34; local92++) {
          ...
          int local98 = local92;
          @Pc(102)
          int local102 = local90 + local92;
          for (@Pc(104) int local104 = 0; local104 < local55; local104++) {
            for (@Pc(108) int local108 = 0; local108 < local51; local108++) {
              @Pc(114)
              float local114 = local63[local98];
              local98 += local34;
              @Pc(124)
              float local124 = local114 + local63[local98];
              @Pc(130)
              float local130 = local124 + local63[local102];
              local98 += local34;
              local102 += local34;
              @Pc(144)
              float local144 = local130 + local63[local102];
              local102 += local34;
