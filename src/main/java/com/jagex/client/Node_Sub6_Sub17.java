...
public final class Node_Sub6_Sub17 extends Node_Sub6 {
  ...
  public void method5513(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
    ...
    if (this.anInt3750 >= 0 && Static331.anInterface7_7 != null) {
      @Pc(27)
      int local27 = Static331.anInterface7_7.method2396(this.anInt3750).aBoolean637 ? 64 : 128;
      this.anIntArray254 =
          Static331.anInterface7_7.method2393(false, this.anInt3750, 1.0F, local27, local27);
  ...
  public int[][] method5514(@OriginalArg(1) int arg0) {
    ...
    if (super.aClass153_41.aBoolean437) {
      @Pc(41)
      int local41 =
          (Static262.anInt4939 == this.anInt3748
                  ? arg0
                  : arg0 * this.anInt3748 / Static262.anInt4939)
              * this.anInt3747;
      @Pc(45)
      int[] local45 = local11[0];
      @Pc(49)
      int[] local49 = local11[1];
      @Pc(53)
      int[] local53 = local11[2];
      @Pc(63)
      int local63;
      @Pc(71)
      int local71;
      if (Static80.anInt1616 == this.anInt3747) {
        ...
        for (local63 = 0; local63 < Static80.anInt1616; local63++) {
          ...
          @Pc(119)
          int local119 = this.anIntArray254[local71 + local41];
