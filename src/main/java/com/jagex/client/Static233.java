...
public final class Static233 {
	...
	public static void method3478(@OriginalArg(0) String arg0) {
		...
		if (Static49.anInt2346 >= 100 && !ClientSettings.aBoolean423 || Static49.anInt2346 >= 200) {
			Static415.method5323(Static386.A_LOCALIZED_STRING___80.getLocalizedString(ClientSettings.langID));
			return;
		}
		...
		for (@Pc(37) int local37 = 0; local37 < Static49.anInt2346; local37++) {
			...
			if (local45 != null && local45.equals(local27)) {
				Static415.method5323(arg0 + Static294.A_LOCALIZED_STRING___17.getLocalizedString(ClientSettings.langID));
				return;
			}
		...
		for (@Pc(105) int local105 = 0; local105 < Static413.anInt6823; local105++) {
			...
			if (local75 != null && local75.equals(local27)) {
				Static415.method5323(Static368.A_LOCALIZED_STRING___124.getLocalizedString(ClientSettings.langID) + arg0 + Static422.A_LOCALIZED_STRING___144.getLocalizedString(ClientSettings.langID));
				return;
			}
		...
		if (Static123.method4868(Static1.aClass16_Sub1_Sub5_Sub1_1.aString44).equals(local27)) {
			Static415.method5323(Static18.A_LOCALIZED_STRING___8.getLocalizedString(ClientSettings.langID));
		} else {
