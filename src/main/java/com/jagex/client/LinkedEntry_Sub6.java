...
public abstract class LinkedEntry_Sub6 extends LinkedEntry {
	...
	public final LinkedEntry_Sub6[] aClass4_Sub6Array42;

	@OriginalMember(owner = "client!oc", name = "<init>", descriptor = "(IZ)V")
	protected LinkedEntry_Sub6(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1) {
		this.aBoolean665 = arg1;
		this.aClass4_Sub6Array42 = new LinkedEntry_Sub6[arg0];
	}
