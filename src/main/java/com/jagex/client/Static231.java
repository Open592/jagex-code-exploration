...
public final class Static231 {
	...
	public static void method3475() {
		@Pc(17) Node_Sub5 local17 = (Node_Sub5) Static413.A_LINKED_LIST___47.tail();
		...
		if (Static434.isShiftClickEnabled && Static384.aClass244_1.method5489(81) && Static407.anInt6710 > 2) {
			if (local28) {
				Static413.aClass4_Sub39_2 = (Node_Sub39) Static206.A_LINKED_LIST___28.sentinelNode.next.next;
			} else {
				Static247.method3617(local17.method519(), (Node_Sub39) Static206.A_LINKED_LIST___28.sentinelNode.next.next, local17.method518());
			}
		} else if (local28) {
			Static413.aClass4_Sub39_2 = (Node_Sub39) Static206.A_LINKED_LIST___28.sentinelNode.next;
		} else {
			Static247.method3617(local17.method519(), (Node_Sub39) Static206.A_LINKED_LIST___28.sentinelNode.next, local17.method518());
		}
	}
}
