...
public final class qa extends Class19 implements Interface4 {
  ...
  private final HashMap aHashMap_28 = new HashMap(4);
  ...
  @OriginalMember(
      owner = "client!qa",
      name = "<init>",
      descriptor = "(ILjava/awt/Canvas;Lclient!ga;Lclient!et;)V")
  public qa(
      @OriginalArg(0) int arg0,
      @OriginalArg(1) Canvas arg1,
      @OriginalArg(2) Interface7 arg2,
      @OriginalArg(3) SignLink signLink) {
    super(arg0, arg2);
    try {
  ...
  private void method4313(@OriginalArg(0) Class146 arg0, @OriginalArg(1) boolean arg1) {
    ...
    @Pc(9)
    int local9 = 0;
    for (@Pc(15) Class3_Sub1_Sub1 local15 = (Class3_Sub1_Sub1) arg0.aClass232_1.method5127();
        local15 != null;
        local15 = (Class3_Sub1_Sub1) arg0.aClass232_1.method5124()) {
  ...
  public Class57 method4308(@OriginalArg(0) Class18 arg0) {
    ...
    if (arg0.aByteArray5 == null) {
      local32 =
          new k(this, this.aNa2, local2, local5, 0, arg0.anInt367, arg0.anInt367, arg0.anInt366);
    } else {
      @Pc(37)
      int local37 = local8 * local11;
      @Pc(40)
      int[] local40 = new int[local37];
      @Pc(43)
      byte[] local43 = arg0.aByteArray5;
      @Pc(52)
      int local52;
      @Pc(54)
      int local54;
      if (local43 == null) {
        ...
        if (local100) {
          local32 =
              new ra(this, this.aNa2, local40, 0, arg0.anInt367, arg0.anInt367, arg0.anInt366);
        } else {
          local32 =
              new ia(this, this.aNa2, local40, 0, arg0.anInt367, arg0.anInt367, arg0.anInt366);
        }
      } else {
        for (@Pc(47) int local47 = 0; local47 < local11; local47++) {
          ...
          for (local54 = 0; local54 < local8; local54++) {
            local40[local52 + local54] =
                local2[local5[local52 + local54] & 0xFF] | local43[local52 + local54] << 24;
          }
        }
  ...
  public Class57 method4280(
    ...
    return arg4
        ? new ra(this, this.aNa2, arg0, arg1, arg2, arg3)
        : new ia(this, this.aNa2, arg0, arg1, arg2, arg3);
  }
  ...
  public void method4249(@OriginalArg(0) Canvas arg0) {
    @Pc(8)
    za local8 = (za) this.aHashMap_28.get((long) arg0.hashCode());
    if (local8 != null) {
      return;
    }
    try {
      @Pc(13)
      Class local13 = Class.forName("java.awt.Canvas");
      @Pc(23)
      Method local23 = local13.getMethod("setIgnoreRepaint", Boolean.TYPE);
    ...
    this.aHashMap_28.set((long) arg0.hashCode(), local8);
  }
  ...
  private native void za(
      @OriginalArg(0) int arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) float[] arg2);
    ...
    for (@Pc(5) int local5 = 0; local5 < arg3; local5++) {
      for (@Pc(8) int local8 = 0; local8 < arg2; local8++) {
        ...
        if (local16 != 0 && local16 != 255) {
          local1 = true;
          return local1
              ? new ra(this, this.aNa2, arg0, 0, arg1, arg2, arg3)
              : new ia(this, this.aNa2, arg0, 0, arg1, arg2, arg3);
        }
      }
    }
    return local1
    ...
    if (arg3 == null) {
      this.method4317()
          .Y(
              ...
              null,
              arg4,
              Static319.anIntArray385,
              Static319.anIntArray383,
              Static319.anIntArray381,
              Static319.aShortArray186,
              Static319.aByteArray68,
              arg1.aClass232_1.method5128(),
              Static319.anIntArray384);
    } else {
      @Pc(28)
      Class3_Sub5 local28 = arg3[0];
  ...
  public void method4246(@OriginalArg(0) int arg0) {
    ...
    this.ma(arg0);
    for (@Pc(10) na local10 = (na) this.aLinkedList_40.tail();
        local10 != null;
        local10 = (na) this.aLinkedList_40.previous()) {
      local10.a();
    }
  }
  ...
  protected void method4239() {
    for (@Pc(5) na local5 = (na) this.aLinkedList_40.tail();
        local5 != null;
        local5 = (na) this.aLinkedList_40.previous()) {
      local5.H();
    }
  ...
  public int method4269(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
    @Pc(3)
    int local3 = arg0 & 0xFFFFF;
    @Pc(7)
    int local7 = arg1 & 0xFFFFF;
  ...
  public void method4272(@OriginalArg(0) Canvas arg0) {
    ...
    za local8 = (za) this.aHashMap_28.get((long) arg0.hashCode());
    @Pc(11)
    Dimension local11 = arg0.getSize();
  ...
  private native void aa(
      ...
      @OriginalArg(6) byte arg6,
      @OriginalArg(7) byte arg7,
      @OriginalArg(8) byte arg8,
      @OriginalArg(9) int arg9,
      @OriginalArg(10) int arg10,
      @OriginalArg(11) boolean arg11,
      @OriginalArg(12) boolean arg12);
  ...
  public void method4250(@OriginalArg(0) Canvas arg0) {
    if (arg0 == null) {
      ...
      @Pc(10)
      za local10 = (za) this.aHashMap_28.get((long) arg0.hashCode());
      this.aCanvas6 = arg0;
      this.aZa1 = local10;
      this.PA(local10);
    }
  ...
  public void method4263(@OriginalArg(0) Canvas arg0) {
    ...
    @Pc(15)
    za local15 = (za) this.aHashMap_28.get((long) arg0.hashCode());
    if (local15 != null) {
      local15.popSelf();
    }
    local15.method5685();
  ...
  private boolean method4318(@OriginalArg(0) short arg0) {
    ...
    synchronized (super.anInterface7_6) {
      ...
      @Pc(22)
      Class251 local22 = super.anInterface7_6.method2396(arg0);
      if (local22 == null) {
        return false;
      }
      @Pc(46)
