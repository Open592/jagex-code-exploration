...
public final class Static377 {
	...
	public static void method4026(@OriginalArg(1) boolean arg0, @OriginalArg(2) Class16_Sub1_Sub5_Sub1 arg1) {
		...
		if (Static1.aClass16_Sub1_Sub5_Sub1_1 != arg1) {
			...
			if (arg1.anInt4336 == 0) {
				...
				local85 = arg1.method3428() + " (" + Static126.A_LOCALIZED_STRING___49.getLocalizedString(ClientSettings.langID) + arg1.anInt4336 + ")";
			}
			...
			if (!arg0) {
				for (@Pc(440) Node_Sub39 local440 = (Node_Sub39) Static206.A_LINKED_LIST___28.tail(); local440 != null; local440 = (Node_Sub39) Static206.A_LINKED_LIST___28.previous()) {
			...
			Static380.method5017(8, false, 0L, 0, Static49.aString28 + " -> <col=ffffff>" + Static223.A_LOCALIZED_STRING___91.getLocalizedString(ClientSettings.langID), true, Static388.aString62, 0, -1, Static273.anInt5120);
		}
	}
	...
	private static void method4030(@OriginalArg(2) int arg0, @OriginalArg(3) int arg1, @OriginalArg(4) Class16_Sub1_Sub5 arg2, @OriginalArg(5) Class16_Sub1_Sub5 arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6) {
		...
		if (local20 == null) {
			@Pc(27) Class18[] local27 = Static456.method327(Static293.aJs5_60, local7);
			if (local27 == null) {
				return;
			}
