...
public final class Class68 {
  ...
  public Object method1782() {
    @Pc(11)
    SecondaryNode_Sub1_Sub8 local11 = (SecondaryNode_Sub1_Sub8) this.aHashMap_10.next();
    while (local11 != null) {
      @Pc(23)
      Object local23 = local11.method3885();
      if (local23 != null) {
        return local23;
      }
      @Pc(29)
      SecondaryNode_Sub1_Sub8 local29 = local11;
  ...
  private void method1783(@OriginalArg(0) long arg0) {
    @Pc(10)
    SecondaryNode_Sub1_Sub8 local10 = (SecondaryNode_Sub1_Sub8) this.aHashMap_10.get(arg0);
  ...
  public int method1786() {
    ...
    int local7 = 0;
    for (@Pc(13)
        SecondaryNode_Sub1_Sub8 local13 =
            (SecondaryNode_Sub1_Sub8) this.aSecondaryLinkedList_2.getHead();
        local13 != null;
        local13 = (SecondaryNode_Sub1_Sub8) this.aSecondaryLinkedList_2.next()) {
  ...
  public Object method1787(@OriginalArg(0) long arg0) {
    ...
    @Pc(18)
    Object local18 = local10.method3885();
    if (local18 == null) {
      local10.popSelf();
    ...
    if (local10.method3883()) {
      @Pc(51)
      SecondaryNode_Sub1_Sub8_Sub1 local51 =
          new SecondaryNode_Sub1_Sub8_Sub1(local18, local10.anInt5084);
  ...
  public void method1788(@OriginalArg(0) int arg0) {
    ...
    for (@Pc(13)
      ...
      if (local13.method3883()) {
        ...
        @Pc(39)
        SecondaryNode_Sub1_Sub8 local39 = Static293.aClass174_1.method4040(local13);
  ...
  public Object method1789() {
    @Pc(16)
    SecondaryNode_Sub1_Sub8 local16 = (SecondaryNode_Sub1_Sub8) this.aHashMap_10.head();
    while (local16 != null) {
      @Pc(22)
      Object local22 = local16.method3885();
      if (local22 != null) {
        return local22;
      }
      @Pc(26)
      SecondaryNode_Sub1_Sub8 local26 = local16;
  ...
  private void method1790(@OriginalArg(0) Object arg0, @OriginalArg(2) long arg1) {
    ...
    while (this.anInt2034 < 0) {
      @Pc(32)
      SecondaryNode_Sub1_Sub8 local32 =
          (SecondaryNode_Sub1_Sub8) this.aSecondaryLinkedList_2.popHead();
      this.method1792(local32);
    }
    @Pc(45)
    SecondaryNode_Sub1_Sub8_Sub1 local45 = new SecondaryNode_Sub1_Sub8_Sub1(arg0, 1);
  ...
  public void method1791() {
    for (@Pc(7)
        SecondaryNode_Sub1_Sub8 local7 =
            (SecondaryNode_Sub1_Sub8) this.aSecondaryLinkedList_2.getHead();
        local7 != null;
        local7 = (SecondaryNode_Sub1_Sub8) this.aSecondaryLinkedList_2.next()) {
