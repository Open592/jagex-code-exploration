...
public final class Class68 {
	...
	public Object method1782() {
		@Pc(11) ContextualEntry_Sub1_Sub8 local11 = (ContextualEntry_Sub1_Sub8) this.aLinkedHashMap_Iterator_10.nextEntry();
		while (local11 != null) {
			@Pc(23) Object local23 = local11.method3885();
			if (local23 != null) {
				return local23;
			}
			@Pc(29) ContextualEntry_Sub1_Sub8 local29 = local11;
			local11 = (ContextualEntry_Sub1_Sub8) this.aLinkedHashMap_Iterator_10.nextEntry();
			local29.popSelf();
			local29.popContextEntry();
	...
	private void method1783(@OriginalArg(0) long arg0) {
		@Pc(10) ContextualEntry_Sub1_Sub8 local10 = (ContextualEntry_Sub1_Sub8) this.aLinkedHashMap_Iterator_10.get(arg0);
	...
	public int method1786() {
		@Pc(7) int local7 = 0;
		for (@Pc(13) ContextualEntry_Sub1_Sub8 local13 = (ContextualEntry_Sub1_Sub8) this.aClass229_2.method5089(); local13 != null; local13 = (ContextualEntry_Sub1_Sub8) this.aClass229_2.method5092()) {
	...
	public Object method1787(@OriginalArg(0) long arg0) {
		...
		if (local18 == null) {
			local10.popSelf();
			local10.popContextEntry();
			this.anInt2034 += local10.anInt5084;
			return null;
		}
		if (local10.method3883()) {
			@Pc(51) ContextualEntry_Sub1_Sub8_ local51 = new ContextualEntry_Sub1_Sub8_(local18, local10.anInt5084);
		...
		for (@Pc(13) ContextualEntry_Sub1_Sub8 local13 = (ContextualEntry_Sub1_Sub8) this.aClass229_2.method5089(); local13 != null; local13 = (ContextualEntry_Sub1_Sub8) this.aClass229_2.method5092()) {
			if (local13.method3883()) {
				if (local13.method3885() == null) {
					local13.popSelf();
					local13.popContextEntry();
					this.anInt2034++;
				}
			} else if (++local13.context > (long) arg0) {
				@Pc(39) ContextualEntry_Sub1_Sub8 local39 = Static293.aClass174_1.method4040(local13);
	...
	public Object method1789() {
		@Pc(16) ContextualEntry_Sub1_Sub8 local16 = (ContextualEntry_Sub1_Sub8) this.aLinkedHashMap_Iterator_10.head();
		while (local16 != null) {
			@Pc(22) Object local22 = local16.method3885();
			if (local22 != null) {
				return local22;
			}
			@Pc(26) ContextualEntry_Sub1_Sub8 local26 = local16;
			local16 = (ContextualEntry_Sub1_Sub8) this.aLinkedHashMap_Iterator_10.nextEntry();
			local26.popSelf();
			local26.popContextEntry();
	...
	private void method1790(@OriginalArg(0) Object arg0, @OriginalArg(2) long arg1) {
		...
		while (this.anInt2034 < 0) {
			@Pc(32) ContextualEntry_Sub1_Sub8 local32 = (ContextualEntry_Sub1_Sub8) this.aClass229_2.method5091();
			this.method1792(local32);
		}
		@Pc(45) ContextualEntry_Sub1_Sub8_ local45 = new ContextualEntry_Sub1_Sub8_(arg0, 1);
	...
	public void method1791() {
		for (@Pc(7) ContextualEntry_Sub1_Sub8 local7 = (ContextualEntry_Sub1_Sub8) this.aClass229_2.method5089(); local7 != null; local7 = (ContextualEntry_Sub1_Sub8) this.aClass229_2.method5092()) {
	...
	private void method1792(@OriginalArg(0) ContextualEntry_Sub1_Sub8 arg0) {
		if (arg0 != null) {
			arg0.popSelf();
