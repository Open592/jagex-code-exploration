...
public final class Static208 {
  ...
  public static void method2249(
    ...
    @Pc(47)
    Class202 local47 = Static267.aClass262_2.method5560(arg10);
    @Pc(56)
    int local56;
    @Pc(59)
    int local59;
    ...
    @Pc(73)
    int local73 = (local56 >> 1) + arg0;
    @Pc(82)
    int local82 = arg0 + (local56 + 1 >> 1);
    @Pc(88)
    int local88 = arg9 + (local59 >> 1);
    @Pc(104)
    int local104 = arg9 + (local59 + 1 >> 1);
    @Pc(108)
    Class65 local108 = Static417.aClass65Array4[arg7];
    @Pc(132)
    int local132 =
        local108.l(local73, local88)
                + local108.l(local82, local88)
                + local108.l(local73, local104)
                + local108.l(local82, local104)
            >> 2;
    @Pc(136)
    Node_Sub23 local136 = new Node_Sub23();
