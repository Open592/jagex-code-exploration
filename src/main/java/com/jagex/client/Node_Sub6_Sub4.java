...
public final class Node_Sub6_Sub4 extends Node_Sub6 {
  ...
  public int[] method5510(@OriginalArg(1) int arg0) {
    ...
    if (super.aClass82_41.aBoolean243) {
      @Pc(19)
      int local19 = Static165.anIntArray209[arg0];
      for (@Pc(21) int local21 = 0; local21 < Static80.anInt1616; local21++) {
        @Pc(27)
        int local27 = Static341.anIntArray504[local21];
        @Pc(68)
        int local68;
        if (local27 > this.anInt1400
            && 4096 - this.anInt1400 > local27
            && 2048 - this.anInt1400 < local19
            && this.anInt1400 + 2048 > local19) {
          ...
          @Pc(179)
          int local179 = local68 < 0 ? -local68 : local68;
          @Pc(184)
          int local184 = local179 - this.anInt1400;
          @Pc(188)
          int local188 = local184 << 12;
