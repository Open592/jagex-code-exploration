...
public final class Static306 {
  ...
  public static void method4134(
    ...
    int local39 = -1;
    @Pc(43)
    int[] local43 = Static96.anIntArrayArray21[arg5];
    @Pc(48)
    int local48 = arg2 - local18;
    Static251.method3640(arg2 - arg1, arg0, local48, local43);
    @Pc(65)
    int local65 = arg2 + local18;
  ...
  public static boolean method4135(
      @OriginalArg(0) int arg0,
      @OriginalArg(1) boolean arg1,
      @OriginalArg(3) int arg2,
      @OriginalArg(4) int arg3,
      @OriginalArg(5) Class164[][][] arg4) {
    @Pc(14)
    byte local14 = arg1 ? 1 : (byte) (Static361.anInt6264 & 0xFF);
    if (local14 == Static12.aByteArrayArrayArray1[Static263.anInt4963][arg0][arg2]) {
      ...
      @Pc(53)
      int local53 = local39 + 1;
      Static407.anIntArray513[0] = arg2;
      Static12.aByteArrayArrayArray1[Static263.anInt4963][arg0][arg2] = local14;
      while (local53 != local41) {
        @Pc(71)
        int local71 = Static123.anIntArray442[local41] & 0xFFFF;
        @Pc(79)
        int local79 = Static123.anIntArray442[local41] >> 16 & 0xFF;
        @Pc(87)
        int local87 = Static123.anIntArray442[local41] >> 24 & 0xFF;
        @Pc(93)
        int local93 = Static407.anIntArray513[local41] & 0xFFFF;
        @Pc(101)
        int local101 = Static407.anIntArray513[local41] >> 16 & 0xFF;
        ...
        @Pc(123)
        boolean local123 = false;
        @Pc(165)
        int local165;
        @Pc(210)
        int local210;
        label231:
        for (@Pc(127) int local127 = Static263.anInt4963 + 1; local127 <= 3; local127++) {
          if ((Static79.aByteArrayArrayArray2[local127][local71][local93] & 0x8) == 0) {
            @Pc(312)
            Class16_Sub1 local312;
            @Pc(322)
            int local322;
            @Pc(301)
            Class164 local301;
            ...
            if (local109 && arg4[local127][local71][local93] != null) {
              if (arg4[local127][local71][local93].aClass16_Sub5_3 != null) {
                ...
                if (local165 == arg4[local127][local71][local93].aClass16_Sub5_3.anInt6551
                    || arg4[local127][local71][local93].aClass16_Sub5_2 != null
                        && arg4[local127][local71][local93].aClass16_Sub5_2.anInt6551 == local165) {
                  continue;
                }
                if (local87 != 0) {
                  local210 = Static265.method3818(local87);
                  if (arg4[local127][local71][local93].aClass16_Sub5_3.anInt6551 == local210
                      || arg4[local127][local71][local93].aClass16_Sub5_2 != null
                          && arg4[local127][local71][local93].aClass16_Sub5_2.anInt6551
                              == local210) {
                    continue;
                  }
                }
                if (local101 != 0) {
                  ...
                  if (local210 == arg4[local127][local71][local93].aClass16_Sub5_3.anInt6551
                      || arg4[local127][local71][local93].aClass16_Sub5_2 != null
                          && local210
                              == arg4[local127][local71][local93].aClass16_Sub5_2.anInt6551) {
                    continue;
              ...
              if (local301.aClass7_3 != null) {
                for (local307 = local301.aClass7_3;
                    local307 != null;
                    local307 = local307.aClass7_1) {
                  local312 = local307.aClass16_Sub1_1;
                  if (local312 instanceof Interface6) {
                    @Pc(318)
                    Interface6 local318 = (Interface6) local312;
                    local322 = local318.method5354();
                    @Pc(326)
                    int local326 = local318.method5347();
                    if (local322 == 21) {
                      local322 = 19;
                    }
                    @Pc(337)
                    int local337 = local322 | local326 << 6;
                    if (local337 == local79
                        || local87 != 0 && local87 == local337
                        || local101 != 0 && local337 == local101) {
                      continue label231;
                    }
                  }
                }
            ...
            if (local301 != null && local301.aClass7_3 != null) {
              for (local307 = local301.aClass7_3; local307 != null; local307 = local307.aClass7_1) {
                local312 = local307.aClass16_Sub1_1;
                if (local312.aShort94 != local312.aShort97
                    || local312.aShort96 != local312.aShort95) {
                  for (@Pc(399) int local399 = local312.aShort94;
                      local399 <= local312.aShort97;
                      local399++) {
        ...
        if (!local109) {
          if (local71 >= 1
              && Static12.aByteArrayArrayArray1[Static263.anInt4963][local71 - 1][local93]
                  != local14) {
          ...
          if (local93 < Static283.anInt5187) {
            if (local71 - 1 >= 0
                && local14
                    != Static12.aByteArrayArrayArray1[Static263.anInt4963][local71 - 1][local93]
                && (Static79.aByteArrayArrayArray2[Static263.anInt4963][local71][local93] & 0x4)
                    == 0
                && (Static79.aByteArrayArrayArray2[Static263.anInt4963][local71 - 1][local93 - 1]
                        & 0x4)
                    == 0) {
            ...
            if (Static326.anInt5666 > local71 + 1
                && local14
                    != Static12.aByteArrayArrayArray1[Static263.anInt4963][local71 + 1][local93]
                && (Static79.aByteArrayArrayArray2[Static263.anInt4963][local71][local93] & 0x4)
                    == 0
          ...
          local93--;
          if (local71 + 1 < Static326.anInt5666
              && local14
                  != Static12.aByteArrayArrayArray1[Static263.anInt4963][local71 + 1][local93]) {
