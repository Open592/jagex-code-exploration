...
public final class Class19_Sub2 extends Class19 {
  ...
  private final Node_Sub21[] aClass4_Sub21Array1;
  ...
  private Node_Sub10_Sub1 aClass4_Sub10_Sub1_1;
  ...
  @OriginalMember(
      owner = "client!fd",
      name = "<init>",
      descriptor = "(ILjava/awt/Canvas;Lclient!ga;ILclient!et;)V")
  public Class19_Sub2(
      @OriginalArg(0) int arg0,
      @OriginalArg(1) Canvas arg1,
      @OriginalArg(2) Interface7 arg2,
      @OriginalArg(3) int arg3,
      @OriginalArg(4) SignLink arg4) {
    super(arg0, arg2);
    ...
    this.anInt2296 = 0;
    this.anInt2286 = -1;
    this.aClass4_Sub21Array1 = new Node_Sub21[Static182.anInt3494];
    this.anInt2293 = 0;
    this.anInt2287 = -1;
    this.anInt2292 = 0;
    this.anInt2294 = 512;
    ...
    try {
      if (Static179.aBoolean288 == null || !Static179.aBoolean288) {
        if (arg4 == null) {
          ...
          @Pc(254)
          String local254 = System.getProperty("os.name").toLowerCase();
          if (!local254.startsWith("mac")) {
            System.loadLibrary("jawt");
          }
          if (local254.startsWith("linux") || local254.startsWith("sunos")) {
            System.load(arg4.resolveCacheFilePath("libjaggl.so").toString());
          } else if (local254.startsWith("mac")) {
            System.load(arg4.resolveCacheFilePath("libjaggl.jnilib").toString());
          } else if (local254.startsWith("win")) {
            System.load(arg4.resolveCacheFilePath("jaggl.dll").toString());
          } else {
      ...
      if (this.aString27.indexOf("radeon") != -1) {
        local376 = 0;
        @Pc(378)
        boolean local378 = false;
        @Pc(380)
        boolean local380 = false;
        @Pc(389)
        String[] local389 = Static113.method2058(this.aString27.replace('/', ' '), ' ');
        for (@Pc(391) int local391 = 0; local391 < local389.length; local391++) {
          @Pc(397)
          String local397 = local389[local391];
          try {
            if (local397.length() > 0) {
              if (local397.charAt(0) == 'x'
                  && local397.length() >= 3
                  && Static88.method1590(local397.substring(1, 3))) {
      ...
      if (this.aClass260_1.method5531()) {
        this.aClass4_Sub10_Sub1_1 = new Node_Sub10_Sub1(this);
  ...
  private void method1896() {
    ...
    while (!this.anOpenGL1.attach()) {
      ...
      ThreadingUtilities.sleepFor(1000L);
    }
  }
  ...
  public void X(
    ...
    @Pc(28)
    float local28 =
        (float) arg2 * this.aClass31_Sub1_4.aFloat199
            + this.aClass31_Sub1_4.aFloat203 * (float) arg1
            + this.aClass31_Sub1_4.aFloat206 * (float) arg0
            + this.aClass31_Sub1_4.aFloat198;
    ...
    int local85 =
        (int)
            ((float) this.anInt2309
                * (this.aClass31_Sub1_4.aFloat209
                    + (float) arg2 * this.aClass31_Sub1_4.aFloat208
                    + this.aClass31_Sub1_4.aFloat202 * (float) arg0
                    + (float) arg1 * this.aClass31_Sub1_4.aFloat207)
                / local28);
    @Pc(117)
    int local117 =
        (int)
            ((this.aClass31_Sub1_4.aFloat205
                    + this.aClass31_Sub1_4.aFloat200 * (float) arg0
                    + (float) arg1 * this.aClass31_Sub1_4.aFloat204
                    + (float) arg2 * this.aClass31_Sub1_4.aFloat201)
                * (float) this.anInt2294
                / local28);
    if ((float) local85 >= this.aFloat75
        && this.aFloat64 >= (float) local85
        && (float) local117 >= this.aFloat62
        && (float) local117 <= this.aFloat68) {
      arg3[2] = (int) local28;
  ...
  public void method4263(@OriginalArg(0) Canvas arg0) {
    if (arg0 == this.aCanvas3) {
      ...
      @Pc(22)
      Long local22 = (Long) this.aHashtable2.get(arg0);
  ...
  @OriginalMember(
      owner = "client!fd",
      name = "a",
      descriptor = "(ZILclient!jaggl/memory/NativeBuffer;II)Lclient!vd;")
  public Interface11 method1902(
      @OriginalArg(2) NativeBuffer arg0, @OriginalArg(3) int arg1, @OriginalArg(4) int arg2) {
    return (Interface11)
        (this.aBoolean205
            ? new Class152_Sub2(this, arg2, arg0, arg1, false)
            : new Class64_Sub2(this, arg2, arg0));
  }
  ...
  private void method1903() {
    ...
    for (local7 = 0; local7 < this.anInt2291; local7++) {
      @Pc(19)
      Node_Sub21 local19 = this.aClass4_Sub21Array1[local7];
      @Pc(23)
      int local23 = local7 + 16386;
      ...
      @Pc(57)
      int local57 = local19.method3162();
      @Pc(63)
      float local63 = local19.method3159() / 255.0F;
  ...
  public void method1905(@OriginalArg(1) Class6 arg0) {
    @Pc(11)
    Class6 local11 = this.aClass6Array1[this.anInt2301];
    if (local11 != arg0) {
      if (arg0 == null) {
  ...
  public Node_Sub2 method4284(@OriginalArg(0) int arg0) {
    @Pc(8)
    Node_Sub2_Sub1 local8 = new Node_Sub2_Sub1(arg0);
  ...
  private void method1909() {
    if (this.aCanvas2 == null) {
      ...
      @Pc(14)
      Dimension local14 = this.aCanvas2.getSize();
  ...
  public void O(
    ...
    @Pc(8)
    float local8 = (float) arg0 + 0.35F;
    @Pc(13)
    float local13 = (float) arg1 + 0.35F;
    @Pc(18)
    float local18 = (float) arg2 + local8;
    this.method1977();
    @Pc(26)
    float local26 = (float) arg3 + local13;
  ...
  public synchronized void method1910(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
    @Pc(8)
    Node_Sub37 local8 = new Node_Sub37(arg0);
    local8.hashKey = arg1;
  ...
  public void method1913(
      @OriginalArg(1) float arg0,
      @OriginalArg(2) float arg1,
      @OriginalArg(3) float arg2,
      @OriginalArg(4) float arg3) {
  ...
  @Override
  public Class110 method4254(
      @OriginalArg(0) Class122 arg0,
      @OriginalArg(1) int arg1,
      @OriginalArg(2) int arg2,
      @OriginalArg(3) int arg3,
      @OriginalArg(4) int arg4) {
  ...
  public void method4272(@OriginalArg(0) Canvas arg0) {
    ...
    if (arg0 == null || this.aCanvas3 == arg0) {
      ...
      @Pc(27)
      Long local27 = (Long) this.aHashtable2.get(arg0);
      local5 = local27;
    }
    if (local5 == 0L) {
      throw new RuntimeException();
  ...
  private void method1915() {
    if (this.anInt2313 <= this.anInt2292 && this.anInt2318 <= this.anInt2296) {
      OpenGL.glScissor(
          this.anInt2313 + this.anInt2308,
          -this.anInt2296 + (this.anInt2283 - -this.anInt2138),
          this.anInt2292 - this.anInt2313,
          this.anInt2296 + -this.anInt2318);
    } else {
  ...
  public void method4250(@OriginalArg(0) Canvas arg0) {
    ...
    if (arg0 == null || arg0 == this.aCanvas3) {
      ...
      @Pc(26)
      Long local26 = (Long) this.aHashtable2.get(arg0);
  ...
  private void method1923() {
    @Pc(6)
    float[] local6 = this.bf;
    @Pc(18)
    float local18 = (float) (-this.anInt2295 * this.anInt2290) / (float) this.anInt2309;
    @Pc(32)
    float local32 =
        (float) ((this.anInt2240 - this.anInt2295) * this.anInt2290) / (float) this.anInt2309;
    @Pc(52)
    float local52 = (float) (this.anInt2297 * this.anInt2290) / (float) this.anInt2294;
    @Pc(67)
    float local67 =
        (float) (this.anInt2290 * (this.anInt2297 - this.anInt2138)) / (float) this.anInt2294;
    if (local18 == local32 || local67 == local52) {
      ...
      @Pc(81)
      float local81 = (float) this.anInt2290 * 2.0F;
      local6[6] = 0.0F;
      local6[3] = 0.0F;
      local6[13] = 0.0F;
      ...
      local6[14] =
          this.aFloat60 =
              -(local81 * (float) this.anInt2312) / (float) (this.anInt2312 - this.anInt2290);
      local6[2] = 0.0F;
      local6[15] = 0.0F;
      local6[10] =
          this.aFloat69 =
              (float) -(this.anInt2312 + this.anInt2290)
                  / (float) (this.anInt2312 - this.anInt2290);
      local6[1] = 0.0F;
      local6[11] = -1.0F;
  ...
  public Class99 method4268(
    ...
    return this.aBoolean199
        ? new Class99_Sub1_Sub2(this, arg0, arg1, arg2, arg3, arg4, arg5)
        : null;
  }
  ...
  @OriginalMember(
      owner = "client!fd",
      name = "a",
      descriptor = "(Lclient!tb;Lclient!tb;FLclient!tb;)Lclient!tb;")
  @Override
  public Class99 method4298(
      @OriginalArg(0) Class99 arg0,
      @OriginalArg(1) Class99 arg1,
      @OriginalArg(2) float arg2,
      @OriginalArg(3) Class99 arg3) {
    if (arg0 != null && arg1 != null && this.aBoolean199 && this.aBoolean191 && this.aBoolean204) {
      @Pc(18)
      Class99_Sub1_Sub1 local18 = null;
      @Pc(21)
      Class99_Sub1 local21 = (Class99_Sub1) arg0;
      @Pc(24)
      Class99_Sub1 local24 = (Class99_Sub1) arg1;
      @Pc(28)
      Class6_Sub4 local28 = local21.method3232();
      @Pc(32)
      Class6_Sub4 local32 = local24.method3232();
      if (local28 != null && local32 != null) {
        @Pc(51)
        int local51 = local32.anInt3257 < local28.anInt3257 ? local28.anInt3257 : local32.anInt3257;
        if (arg3 != arg0 && arg3 != arg1 && arg3 instanceof Class99_Sub1_Sub1) {
          @Pc(63)
          Class99_Sub1_Sub1 local63 = (Class99_Sub1_Sub1) arg3;
  ...
  @OriginalMember(
      owner = "client!fd",
      name = "a",
      descriptor = "(Lclient!t;Lclient!mc;Lclient!c;Lclient!mi;I)V")
  @Override
  public void method4262(
      @OriginalArg(0) Class110 arg0,
      @OriginalArg(1) Class146 arg1,
      @OriginalArg(2) Class31 arg2,
      @OriginalArg(3) Class3_Sub5 arg3) {
  ...
  public void method1926(
      @OriginalArg(0) boolean arg0, @OriginalArg(2) int arg1, @OriginalArg(3) boolean arg2) {
    if (this.anInt2314 != arg1) {
      if (arg1 < 0) {
        ...
        @Pc(13)
        Class6_Sub1 local13 = this.aClass59_1.method1549(arg1);
        @Pc(19)
        Class251 local19 = super.anInterface7_6.method2396(arg1);
        if (local19.aByte91 == 0 && local19.aByte93 == 0) {
          this.method1917();
        } else {
          @Pc(35)
          int local35 = local19.aBoolean637 ? 64 : 128;
          @Pc(39)
          int local39 = local35 * 50;
          this.method1963(
              (float) (local19.aByte93 * (this.anInt2274 % local39)) / (float) local39,
              (float) (local19.aByte91 * (this.anInt2274 % local39)) / (float) local39,
              0.0F);
        }
        if (this.aBoolean192) {
  ...
  public void T(
      @OriginalArg(0) int arg0,
      @OriginalArg(1) float arg1,
      @OriginalArg(2) float arg2,
      @OriginalArg(3) float arg3,
      @OriginalArg(4) float arg4,
      @OriginalArg(5) float arg5) {
    @Pc(11)
    boolean local11 = this.anInt2286 != arg0;
    ...
    if (this.aFloatArray18[0] == arg3
        && arg4 == this.aFloatArray18[1]
    ...
    @Pc(138)
    float local138 = (float) (1.0D / Math.sqrt((double) (arg4 * arg4 + arg3 * arg3 + arg5 * arg5)));
  ...
  public synchronized void method4246(@OriginalArg(0) int arg0) {
    @Pc(9)
    int local9 = arg0 & Integer.MAX_VALUE;
    @Pc(11)
    int local11 = 0;
    @Pc(19)
    Node_Sub37 local19;
    ...
    if (this.IA() > 100663296
        && MonotonicClock.getCurrentTimeInMilliseconds() > this.aLong74 + 60000L) {
      System.gc();
  ...
  public void method4287(
      ...
      @OriginalArg(3) int arg3,
      @OriginalArg(4) int arg4,
      @OriginalArg(6) Class145 arg5,
      @OriginalArg(7) int arg6,
      @OriginalArg(8) int arg7) {
    @Pc(6)
    Class145_Sub1 local6 = (Class145_Sub1) arg5;
    @Pc(9)
    Class6_Sub1_Sub1 local9 = local6.aClass6_Sub1_Sub1_5;
    this.method1930();
    ...
    @Pc(39)
    float local39 = local9.aFloat172 / (float) local9.anInt5470;
    @Pc(46)
    float local46 = local9.aFloat171 / (float) local9.anInt5474;
    OpenGL.glColor4ub((byte) (arg4 >> 16), (byte) (arg4 >> 8), (byte) arg4, (byte) (arg4 >> 24));
    OpenGL.glBegin(1);
  ...
  private void method1933() {
    @Pc(15)
    float local15 = (float) -this.anInt2295 * this.aFloat66 / (float) this.anInt2309;
    @Pc(27)
    float local27 = this.aFloat66 * (float) -this.anInt2297 / (float) this.anInt2294;
    @Pc(48)
    float local48 =
        this.aFloat66 * (float) (this.anInt2240 - this.anInt2295) / (float) this.anInt2309;
    @Pc(63)
    float local63 =
        (float) (this.anInt2138 - this.anInt2297) * this.aFloat66 / (float) this.anInt2294;
    OpenGL.glMatrixMode(5889);
    OpenGL.glLoadIdentity();
    if (local15 != local48 && local27 != local63) {
      OpenGL.glOrtho(
          ...
          (double) -local63,
          (double) -local27,
          (double) ((float) this.anInt2290 - this.aFloat67),
          (double) ((float) this.anInt2312 - this.aFloat67));
    }
    OpenGL.glMatrixMode(5888);
  }
  ...
  @OriginalMember(
      owner = "client!fd",
      name = "a",
      descriptor = "(Lclient!pc;ILclient!pc;Lclient!pc;Lclient!pc;)V")
  public void method1934(
      @OriginalArg(0) Class177 arg0,
      @OriginalArg(2) Class177 arg1,
      @OriginalArg(3) Class177 arg2,
      @OriginalArg(4) Class177 arg3) {
    if (arg3 == null) {
      ...
      OpenGL.glVertexPointer(
          arg3.aByte56,
          arg3.aShort68,
          this.anInterface11_3.method5182(),
          this.anInterface11_3.method5183() + (long) arg3.aByte55);
    ...
    if (arg1 == null) {
      ...
      OpenGL.glNormalPointer(
          arg1.aShort68,
          this.anInterface11_3.method5182(),
          this.anInterface11_3.method5183() + (long) arg1.aByte55);
    ...
    if (arg0 == null) {
      ...
      OpenGL.glColorPointer(
          ...
          arg0.aShort68,
          this.anInterface11_3.method5182(),
          this.anInterface11_3.method5183() + (long) arg0.aByte55);
    ...
    if (arg2 == null) {
      ...
      OpenGL.glTexCoordPointer(
          ...
          arg2.aShort68,
          this.anInterface11_3.method5182(),
          this.anInterface11_3.method5183() + (long) arg2.aByte55);
  ...
  public void method4244(@OriginalArg(0) Node_Sub2 arg0) {
    this.aNativeHeap2 = ((Node_Sub2_Sub1) arg0).aNativeHeap1;
    if (this.anInterface11_2 != null) {
      return;
    }
    @Pc(16)
    Node_Sub12_Sub2 local16 = new Node_Sub12_Sub2(80);
    if (this.aBoolean215) {
    ...
    this.anInterface11_2 = this.method1960(local16.pos, local16.data, false, 20);
  ...
  public synchronized void method1939(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
    @Pc(12)
    Node_Sub37 local12 = new Node_Sub37(arg1);
  ...
  public synchronized void method1941(@OriginalArg(1) int arg0) {
    @Pc(12)
    Node_Sub37 local12 = new Node_Sub37(arg0);
  ...
  protected void method4239() {
    for (@Pc(6) Node local6 = this.aLinkedList_6.tail();
        local6 != null;
        local6 = this.aLinkedList_6.previous()) {
    ...
    if (this.anOpenGL1 != null) {
      this.method1921();
      @Pc(40)
      Enumeration local40 = this.aHashtable2.keys();
      while (local40.hasMoreElements()) {
        @Pc(46)
        Canvas local46 = (Canvas) local40.nextElement();
        @Pc(52)
        Long local52 = (Long) this.aHashtable2.get(local46);
  ...
  public Interface1 method1955(
      @OriginalArg(1) int arg0, @OriginalArg(2) boolean arg1, @OriginalArg(3) byte[] arg2) {
    return (Interface1)
        (this.aBoolean205 && (!arg1 || this.aBoolean208)
            ? new Class152_Sub1(this, 5123, arg2, arg0, arg1)
            : new Class64_Sub1(this, 5123, arg2, arg0));
  }
  ...
  public void method4281() {
    ...
    @Pc(19)
    int local19 = this.anInt2313;
    @Pc(22)
    int local22 = this.anInt2292;
    @Pc(25)
    int local25 = this.anInt2318;
    @Pc(28)
    int local28 = this.anInt2296;
    this.e();
  ...
  public void method4257(
      @OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2) {
  ...
  public void method4312(
    ...
    float local13 = (float) arg1 + 0.35F;
    @Pc(20)
    float local20 = (float) arg2 + local8 - 1.0F;
    @Pc(27)
    float local27 = (float) arg3 + local13 - 1.0F;
    this.method1977();
    this.method1958(arg5);
    OpenGL.glColor4ub((byte) (arg4 >> 16), (byte) (arg4 >> 8), (byte) arg4, (byte) (arg4 >> 24));
    if (this.aBoolean194) {
  ...
  public void ca(
      ...
      @OriginalArg(3) int arg3) {
    @Pc(6)
    Class145_Sub1 local6 = (Class145_Sub1) arg1;
    @Pc(9)
    Class6_Sub1_Sub1 local9 = local6.aClass6_Sub1_Sub1_5;
    this.method1930();
    this.method1905(local6.aClass6_Sub1_Sub1_5);
    ...
    OpenGL.glBegin(7);
    OpenGL.glTexCoord2f(
        (float) (this.anInt2313 - arg2) * local39, (float) (this.anInt2318 - arg3) * local46);
    OpenGL.glVertex2i(this.anInt2313, this.anInt2318);
    OpenGL.glTexCoord2f(
        local39 * (float) (this.anInt2313 - arg2), (float) (this.anInt2296 - arg3) * local46);
    OpenGL.glVertex2i(this.anInt2313, this.anInt2296);
    OpenGL.glTexCoord2f(
        local39 * (float) (this.anInt2292 - arg2), local46 * (float) (this.anInt2296 - arg3));
    OpenGL.glVertex2i(this.anInt2292, this.anInt2296);
    OpenGL.glTexCoord2f(
        (float) (this.anInt2292 - arg2) * local39, (float) (this.anInt2318 - arg3) * local46);
  ...
  public Interface11 method1960(
      @OriginalArg(1) int arg0,
      @OriginalArg(2) byte[] arg1,
      @OriginalArg(3) boolean arg2,
      @OriginalArg(4) int arg3) {
    return (Interface11)
        (this.aBoolean205 && (!arg2 || this.aBoolean208)
            ? new Class152_Sub2(this, arg3, arg1, arg0, arg2)
            : new Class64_Sub2(this, arg3, arg1, arg0));
  }
  ...
  @OriginalMember(
      owner = "client!fd",
      name = "a",
      descriptor = "([Lclient!t;Lclient!c;[Lclient!mi;I)V")
  @Override
  public void method4307(
      @OriginalArg(0) Class110[] arg0,
      @OriginalArg(1) Class31 arg1,
      @OriginalArg(2) Class3_Sub5[] arg2,
      @OriginalArg(3) int arg3) {
  ...
  @OriginalMember(
      owner = "client!fd",
      name = "a",
      descriptor = "(Lclient!gt;[Lclient!bb;Z)Lclient!la;")
  @Override
  ...
  public void method4249(@OriginalArg(0) Canvas arg0) {
    if (this.aCanvas3 == arg0) {
      ...
      try {
        @Pc(26)
        Class local26 = Class.forName("java.awt.Canvas");
        @Pc(36)
        Method local36 = local26.getMethod("setIgnoreRepaint", Boolean.TYPE);
      ...
      @Pc(53)
      long local53 = this.anOpenGL1.prepareSurface(arg0);
      if (local53 == -1L) {
        throw new RuntimeException();
      }
  ...
  private void method1963(
      @OriginalArg(1) float arg0, @OriginalArg(2) float arg1, @OriginalArg(3) float arg2) {
    OpenGL.glMatrixMode(5890);
    if (this.aBoolean206) {
      OpenGL.glLoadIdentity();
    }
  ...
  public void DA(
    ...
    if (this.aClass6_Sub1_Sub1_1 == null
        || this.aClass6_Sub1_Sub1_1.anInt5466 < arg2
        || this.aClass6_Sub1_Sub1_1.anInt5458 < arg3) {
      ...
      local45 =
          (float) arg2
              * this.aClass6_Sub1_Sub1_1.aFloat172
              / (float) this.aClass6_Sub1_Sub1_1.anInt5466;
      local41 =
          (float) arg3
              * this.aClass6_Sub1_Sub1_1.aFloat171
              / (float) this.aClass6_Sub1_Sub1_1.anInt5458;
    }
    this.method1930();
    ...
    @Pc(147)
    float local147 = (float) arg0;
    @Pc(150)
    float local150 = (float) arg1;
    @Pc(155)
    float local155 = local147 + (float) arg2;
    OpenGL.glBegin(7);
    @Pc(162)
    float local162 = (float) arg3 + local150;
  ...
  public Node_Sub21 method4310(
      ...
      @OriginalArg(4) int arg4,
      @OriginalArg(5) float arg5) {
    return new Node_Sub21_Sub1(arg0, arg1, arg2, arg3, arg4, arg5);
  }
  ...
  public void TA(
    ...
    @Pc(15)
    float local15 = (float) arg0 + 0.35F;
    @Pc(20)
    float local20 = (float) arg1 + 0.35F;
  ...
  public void b(
    ...
    OpenGL.glColor4ub((byte) (arg3 >> 16), (byte) (arg3 >> 8), (byte) arg3, (byte) (arg3 >> 24));
    @Pc(35)
    float local35 = (float) arg1 + 0.35F;
    OpenGL.glBegin(1);
  ...
  public void method1967(
      @OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) Interface1 arg2) {
    @Pc(13)
    int local13 = arg2.method3659();
    @Pc(20)
    int local20 = arg0 * this.method1897(local13);
  ...
  public boolean JA(
    ...
    float local28 =
        (float) arg2 * this.aClass31_Sub1_4.aFloat199
            + (float) arg1 * this.aClass31_Sub1_4.aFloat203
            + (float) arg0 * this.aClass31_Sub1_4.aFloat206
            + this.aClass31_Sub1_4.aFloat198;
    if (local28 < 1.0F) {
      local28 = 1.0F;
    }
    ...
    float local59 =
        this.aClass31_Sub1_4.aFloat198
            + this.aClass31_Sub1_4.aFloat206 * (float) arg3
            + this.aClass31_Sub1_4.aFloat203 * (float) arg4
            + this.aClass31_Sub1_4.aFloat199 * (float) arg5;
    if (local59 < 1.0F) {
      local59 = 1.0F;
    }
    if ((float) this.anInt2290 > local28 && (float) this.anInt2290 > local59
        || !(!(local28 > (float) this.anInt2312) || !(local59 > (float) this.anInt2312))) {
      return false;
    }
    @Pc(123)
    int local123 =
    ...
    int local155 =
        (int)
            ((float) this.anInt2309
                * (this.aClass31_Sub1_4.aFloat202 * (float) arg3
                    + (float) arg4 * this.aClass31_Sub1_4.aFloat207
                    + this.aClass31_Sub1_4.aFloat208 * (float) arg5
                    + this.aClass31_Sub1_4.aFloat209)
                / local59);
    if ((float) local123 < this.aFloat75 && (float) local155 < this.aFloat75
        || this.aFloat64 < (float) local123 && this.aFloat64 < (float) local155) {
      return false;
    } else {
      @Pc(213)
      int local213 =
          (int)
              ((this.aClass31_Sub1_4.aFloat201 * (float) arg2
                      + this.aClass31_Sub1_4.aFloat200 * (float) arg0
                      + this.aClass31_Sub1_4.aFloat204 * (float) arg1
                      + this.aClass31_Sub1_4.aFloat205)
                  * (float) this.anInt2294
                  / local28);
      @Pc(245)
      int local245 =
          (int)
              ((float) this.anInt2294
                  * (this.aClass31_Sub1_4.aFloat201 * (float) arg5
                      + (float) arg3 * this.aClass31_Sub1_4.aFloat200
                      + this.aClass31_Sub1_4.aFloat204 * (float) arg4
                      + this.aClass31_Sub1_4.aFloat205)
                  / local59);
      return (!((float) local213 < this.aFloat62) || !(this.aFloat62 > (float) local245))
          && (!((float) local213 > this.aFloat68) || !((float) local245 > this.aFloat68));
    }
  }
  ...
  private void method1969() {
    ...
    @Pc(125)
    float[] local125 = new float[] {0.0F, 0.0F, 0.0F, 1.0F};
    for (@Pc(127) int local127 = 0; local127 < 8; local127++) {
      @Pc(133)
      int local133 = local127 + 16384;
  ...
  public int[] F(
      ...
      @OriginalArg(3) int arg3) {
    @Pc(10)
    int[] local10 = new int[arg2 * arg3];
    for (@Pc(12) int local12 = 0; local12 < arg3; local12++) {
      OpenGL.glReadPixelsi(
          arg0,
          this.anInt2138 - local12 - arg1,
          arg2,
          1,
          32993,
          this.anInt2307,
  ...
  public Class57 method4308(@OriginalArg(0) Class18 arg0) {
    @Pc(12)
    int[] local12 = new int[arg0.anInt366 * arg0.anInt367];
    @Pc(14)
    int local14 = 0;
    @Pc(16)
    int local16 = 0;
    ...
    if (arg0.aByteArray5 == null) {
      for (local21 = 0; local21 < arg0.anInt366; local21++) {
        for (local25 = 0; local25 < arg0.anInt367; local25++) {
          @Pc(38)
          int local38 = arg0.anIntArray25[arg0.aByteArray4[local14++] & 0xFF];
      ...
      for (local21 = 0; local21 < arg0.anInt366; local21++) {
        for (local25 = 0; local25 < arg0.anInt367; local25++) {
          local12[local16++] =
              arg0.aByteArray5[local14] << 24 | arg0.anIntArray25[arg0.aByteArray4[local14] & 0xFF];
          local14++;
        }
      }
    }
    @Pc(122)
    Class57 local122 = this.method4265(local12, arg0.anInt367, arg0.anInt367, arg0.anInt366);
  ...
  private int method1974() {
    ...
    @Pc(46)
    String local46 = OpenGL.glGetString(7938);
    @Pc(54)
    String[] local54 = Static113.method2058(local46.replace('.', ' '), ' ');
    if (local54.length < 2) {
      local5 |= 0x4;
    } else {
      try {
  ...
  private void method1975() {
    if (this.aFloat67 == (float) 0) {
      ...
      @Pc(28)
      float local28 = this.aFloat63 / (this.aFloat63 + this.aFloat67);
      @Pc(32)
      float local32 = local28 * local28;
      @Pc(47)
      float local47 = -this.aFloat60 * (1.0F - local28) * (1.0F - local28) / this.aFloat67;
  ...
  public void p(@OriginalArg(0) int arg0) {
    this.method1958(0);
    OpenGL.glClearColor(
        (float) (arg0 & 0xFF0000) / 1.671168E7F,
        (float) (arg0 & 0xFF00) / 65280.0F,
        (float) (arg0 & 0xFF) / 255.0F,
        (float) (arg0 >>> 24) / 255.0F);
    OpenGL.glClear(16384);
  }
  ...
  public synchronized void method1978(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
    @Pc(8)
    Node_Sub37 local8 = new Node_Sub37(arg1);
    local8.hashKey = arg0;
