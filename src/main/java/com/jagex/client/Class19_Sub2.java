...
public final class Class19_Sub2 extends Class19 {
	...
	private final LinkedHashEntry_Sub21[] aClass4_Sub21Array1;
	...
	private LinkedHashEntry_Sub10_Sub1 aClass4_Sub10_Sub1_1;
	...
	public Class19_Sub2(@OriginalArg(0) int arg0, @OriginalArg(1) Canvas arg1, @OriginalArg(2) Interface7 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) SignLink arg4) {
		...
		this.anInt2296 = 0;
		this.anInt2286 = -1;
		this.aClass4_Sub21Array1 = new LinkedHashEntry_Sub21[Static182.anInt3494];
		this.anInt2293 = 0;
		this.anInt2287 = -1;
		this.anInt2292 = 0;
		this.anInt2294 = 512;
		...
		try {
			...
			if (this.aClass260_1.method5531()) {
				this.aClass4_Sub10_Sub1_1 = new LinkedHashEntry_Sub10_Sub1(this);
	...
	private void method1903() {
		...
		for (local7 = 0; local7 < this.anInt2291; local7++) {
			@Pc(19) LinkedHashEntry_Sub21 local19 = this.aClass4_Sub21Array1[local7];
	...
	public LinkedHashEntry_Sub2 method4284(@OriginalArg(0) int arg0) {
		@Pc(8) LinkedHashEntry_Sub2_Sub1 local8 = new LinkedHashEntry_Sub2_Sub1(arg0);
	...
	public synchronized void method1908(@OriginalArg(0) int arg0) {
		@Pc(13) LinkedHashEntry local13 = new LinkedHashEntry();
	...
	public synchronized void method1910(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
		@Pc(8) LinkedHashEntry_Sub37 local8 = new LinkedHashEntry_Sub37(arg0);
		local8.hashKey = arg1;
	...
	public synchronized void method4246(@OriginalArg(0) int arg0) {
		...
		@Pc(11) int local11 = 0;
		@Pc(19) LinkedHashEntry_Sub37 local19;
		while (!this.aClass183_8.method4147()) {
			local19 = (LinkedHashEntry_Sub37) this.aClass183_8.method4136();
		...
		while (!this.aClass183_9.method4147()) {
			local19 = (LinkedHashEntry_Sub37) this.aClass183_9.method4136();
			Static429.anIntArray537[local11++] = (int) local19.hashKey;
		...
		while (!this.aClass183_10.method4147()) {
			local19 = (LinkedHashEntry_Sub37) this.aClass183_10.method4136();
		...
		while (!this.aClass183_11.method4147()) {
			local19 = (LinkedHashEntry_Sub37) this.aClass183_11.method4136();
			Static429.anIntArray537[local11++] = (int) local19.hashKey;
		...
		while (!this.aClass183_7.method4147()) {
			local19 = (LinkedHashEntry_Sub37) this.aClass183_7.method4136();
			OpenGL.glDeleteLists((int) local19.hashKey, local19.anInt5426);
		}
		@Pc(215) LinkedHashEntry local215;
	...
	public void method4244(@OriginalArg(0) LinkedHashEntry_Sub2 arg0) {
		this.aNativeHeap2 = ((LinkedHashEntry_Sub2_Sub1) arg0).aNativeHeap1;
		if (this.anInterface11_2 != null) {
			return;
		}
		@Pc(16) LinkedHashEntry_Sub12_Sub2 local16 = new LinkedHashEntry_Sub12_Sub2(80);
		if (this.aBoolean215) {
	...
	public synchronized void method1939(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(12) LinkedHashEntry_Sub37 local12 = new LinkedHashEntry_Sub37(arg1);
	...
	public synchronized void method1941(@OriginalArg(1) int arg0) {
		@Pc(12) LinkedHashEntry_Sub37 local12 = new LinkedHashEntry_Sub37(arg0);
	...
	protected void method4239() {
		for (@Pc(6) LinkedHashEntry local6 = this.aClass183_6.method4140(); local6 != null; local6 = this.aClass183_6.method4144()) {
			((LinkedHashEntry_Sub2_Sub1) local6).method104();
		}
	...
	public LinkedHashEntry_Sub21 method4310(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) float arg5) {
		return new LinkedHashEntry_Sub21_Sub1(arg0, arg1, arg2, arg3, arg4, arg5);
	}
	...
	public synchronized void method1973(@OriginalArg(1) long arg0) {
		@Pc(7) LinkedHashEntry local7 = new LinkedHashEntry();
		local7.hashKey = arg0;
	...
	public synchronized void method1978(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		@Pc(8) LinkedHashEntry_Sub37 local8 = new LinkedHashEntry_Sub37(arg1);
		local8.hashKey = arg0;
