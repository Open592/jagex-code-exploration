...
public final class LinkedEntry_Sub15_Sub2 extends LinkedEntry_Sub15 {
	...
	public synchronized void method2954(@OriginalArg(0) LinkedEntry_Sub15 arg0) {
		this.aClass183_26.method4133(arg0);
	}

	@OriginalMember(owner = "client!jl", name = "b", descriptor = "(Lclient!ti;)V")
	public synchronized void method2955(@OriginalArg(0) LinkedEntry_Sub15 arg0) {
		arg0.popSelf();
	}
	...
	public LinkedEntry_Sub15 method4857() {
		return (LinkedEntry_Sub15) this.aClass183_26.method4144();
	}
	...
	private void method2956(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		for (@Pc(5) LinkedEntry_Sub15 local5 = (LinkedEntry_Sub15) this.aClass183_26.method4140(); local5 != null; local5 = (LinkedEntry_Sub15) this.aClass183_26.method4144()) {
	...
	public LinkedEntry_Sub15 method4860() {
		return (LinkedEntry_Sub15) this.aClass183_26.method4140();
	}

	@OriginalMember(owner = "client!jl", name = "a", descriptor = "(Lclient!wr;)V")
	private void method2957(@OriginalArg(0) LinkedEntry_Sub44 arg0) {
		arg0.popSelf();
		arg0.method5668();
		@Pc(9) LinkedEntry local9 = this.aClass183_27.aLinkedEntry_207.previous;
		if (local9 == this.aClass183_27.aLinkedEntry_207) {
			this.anInt3580 = -1;
		} else {
			this.anInt3580 = ((LinkedEntry_Sub44) local9).anInt7350;
		}
	}

	@OriginalMember(owner = "client!jl", name = "a", descriptor = "(Lclient!vu;Lclient!wr;)V")
	private void method2958(@OriginalArg(0) LinkedEntry arg0, @OriginalArg(1) LinkedEntry_Sub44 arg1) {
		while (arg0 != this.aClass183_27.aLinkedEntry_207 && ((LinkedEntry_Sub44) arg0).anInt7350 <= arg1.anInt7350) {
			arg0 = arg0.previous;
		}
		Static245.method3597(arg0, arg1);
		this.anInt3580 = ((LinkedEntry_Sub44) this.aClass183_27.aLinkedEntry_207.previous).anInt7350;
	}
	...
	private void method2960() {
		...
		for (@Pc(8) LinkedEntry_Sub44 local8 = (LinkedEntry_Sub44) this.aClass183_27.method4140(); local8 != null; local8 = (LinkedEntry_Sub44) this.aClass183_27.method4144()) {
	...
	public synchronized void method4861(@OriginalArg(0) int arg0) {
		do {
			...
			this.method2960();
			@Pc(50) LinkedEntry_Sub44 local50 = (LinkedEntry_Sub44) this.aClass183_27.method4140();
	...
	public synchronized void method4855(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		do {
			...
			this.method2960();
			@Pc(60) LinkedEntry_Sub44 local60 = (LinkedEntry_Sub44) this.aClass183_27.method4140();
