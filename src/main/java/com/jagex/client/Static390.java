    ...
    for (@Pc(3) int local3 = 0; local3 < arg0.anInt7302; local3++) {
      ...
      for (@Pc(9) int local9 = 0; local9 < Static326.anInt5666 >> 3; local9++) {
        for (@Pc(13) int local13 = 0; local13 < Static283.anInt5187 >> 3; local13++) {
          @Pc(23)
          int local23 = Static313.anIntArrayArrayArray12[local3][local9][local13];
          if (local23 != -1) {
            @Pc(33)
            int local33 = local23 >> 24 & 0x3;
            if (!arg0.aBoolean687 || local33 == 0) {
              @Pc(47)
              int local47 = local23 >> 1 & 0x3;
              @Pc(53)
              int local53 = local23 >> 14 & 0x3FF;
              @Pc(59)
              int local59 = local23 >> 3 & 0x7FF;
              @Pc(70)
              int local70 = (local53 / 8 << 8) + (local59 / 8);
