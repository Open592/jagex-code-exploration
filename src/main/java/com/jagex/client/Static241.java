...
public final class Static241 {
  ...
  public static void method3552() {
    for (@Pc(7) int local7 = 0; local7 < Static41.anInt759; local7++) {
      @Pc(13)
      int local13 = Static440.anIntArray543[local7];
      @Pc(17)
      Class16_Sub1_Sub5_Sub2 local17 = Static143.aClass16_Sub1_Sub5_Sub2Array1[local13];
      @Pc(21)
      int local21 = Static146.aClass4_Sub12_Sub1_3.g1();
      if ((local21 & 0x40) != 0) {
        local21 += Static146.aClass4_Sub12_Sub1_3.g1() << 8;
      }
      @Pc(44)
      int local44;
      if ((local21 & 0x1000) != 0) {
        local44 = Static146.aClass4_Sub12_Sub1_3.g1_alt2();
        @Pc(47)
        int[] local47 = new int[local44];
        @Pc(50)
        int[] local50 = new int[local44];
        @Pc(53)
        int[] local53 = new int[local44];
        for (@Pc(55) int local55 = 0; local55 < local44; local55++) {
          @Pc(61)
          int local61 = Static146.aClass4_Sub12_Sub1_3.g2();
          if (local61 == 65535) {
            local61 = -1;
          }
          local47[local55] = local61;
          local50[local55] = Static146.aClass4_Sub12_Sub1_3.g1_alt1();
          local53[local55] = Static146.aClass4_Sub12_Sub1_3.g2();
        }
      ...
      if ((local21 & 0x400) != 0) {
        ...
        local17.anInt6095 = Static146.aClass4_Sub12_Sub1_3.g2_alt1();
      }
      if ((local21 & 0x100) != 0) {
      ...
      if ((local21 & 0x4) != 0) {
        local44 = Static146.aClass4_Sub12_Sub1_3.g2_alt1();
        if (local44 == 65535) {
          local44 = -1;
        }
        local162 = Static146.aClass4_Sub12_Sub1_3.g1_alt3();
      ...
      if ((local21 & 0x200) != 0) {
        local44 = Static146.aClass4_Sub12_Sub1_3.g2_alt3();
        local17.anInt6051 = Static146.aClass4_Sub12_Sub1_3.g1_alt1();
    ...
    for (@Pc(3) int local3 = 0; local3 < Static79.aByteArrayArrayArray2.length; local3++) {
      for (@Pc(7) int local7 = 0; local7 < Static79.aByteArrayArrayArray2[0].length; local7++) {
        for (@Pc(11) int local11 = 0;
            local11 < Static79.aByteArrayArrayArray2[0][0].length;
            local11++) {
