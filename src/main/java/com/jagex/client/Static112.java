...
public final class Static112 {
  ...
  public static boolean method2029(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
    if (Static72.method1353(arg0, arg1) | (arg1 & 0x10000) != 0
        || Static230.method3468(arg0, arg1)) {
      return true;
    } else {
  ...
  public static boolean method2030(
      @OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
    @Pc(7)
    int local7 = Static162.anIntArrayArrayArray13[arg0][arg1][arg2];
    if (local7 == -Static143.anInt2891) {
      ...
      @Pc(22)
      int local22 = arg1 << Static231.anInt4434;
      @Pc(26)
      int local26 = arg2 << Static231.anInt4434;
      if (Static299.method4088(
              local22 + 1, Static417.aClass65Array4[arg0].l(arg1, arg2), local26 + 1)
          && Static299.method4088(
              local22 + Static4.anInt5935 - 1,
              Static417.aClass65Array4[arg0].l(arg1 + 1, arg2),
              local26 + 1)
          && Static299.method4088(
              local22 + Static4.anInt5935 - 1,
              Static417.aClass65Array4[arg0].l(arg1 + 1, arg2 + 1),
              local26 + Static4.anInt5935 - 1)
          && Static299.method4088(
              local22 + 1,
              Static417.aClass65Array4[arg0].l(arg1, arg2 + 1),
              local26 + Static4.anInt5935 - 1)
          && Static299.method4088(
              local22 + Static333.anInt5747,
              Static417.aClass65Array4[arg0].l(arg1, arg2),
              local26 + 1)
          && Static299.method4088(
              local22 + Static4.anInt5935 - 1,
              Static417.aClass65Array4[arg0].l(arg1 + 1, arg2),
  ...
  public static short[] method2031(@OriginalArg(0) short[] arg0) {
    if (arg0 == null) {
      ...
      @Pc(18)
      short[] local18 = new short[arg0.length];
  ...
  public static void method2032(@OriginalArg(0) Class16_Sub1_Sub5 arg0) {
    if (arg0 instanceof Class16_Sub1_Sub5_Sub2) {
      ...
      @Pc(8)
      Class16_Sub1_Sub5_Sub1 local8 = (Class16_Sub1_Sub5_Sub1) arg0;
  ...
  public static void method2033(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
    @Pc(12)
    SecondaryNode_Sub1_Sub11 local12 = Static405.method5222(arg1, 5);
    local12.method2604();
  ...
  public static boolean method2034(@OriginalArg(1) int arg0) {
    if (Static453.aBooleanArray25[arg0]) {
      ...
      @Pc(30)
      int local30 = Static356.aJs5_81.method2108(arg0);
      if (local30 == 0) {
      ...
      for (@Pc(52) int local52 = 0; local52 < local30; local52++) {
        if (Static297.aClass247ArrayArray2[arg0][local52] == null) {
          @Pc(66)
          byte[] local66 = Static356.aJs5_81.method2104(local52, arg0);
          if (local66 != null) {
            @Pc(78)
            Class247 local78 = Static297.aClass247ArrayArray2[arg0][local52] = new Class247();
    ...
    try {
      ...
      if (Static50.anInt862 == 1) {
        ...
        Static125.aServerConnection_5 =
            new ServerConnection((Socket) Static292.aClass199_8.output, GameShell.signLink);
      ...
      Static125.aServerConnection_5.readBytesFromServer(
          Static215.anInt3980, local78, Static273.aByteArray64);
      ...
      if (Static422.anInt6950 > Static215.anInt3980) {
        ...
        local110 = 0;
        for (@Pc(211) int local211 = Static396.anInt4816;
            local211 <= Static339.anInt5874;
            local211++) {
          @Pc(217)
          Class78_Sub1 local217 = Static206.method3192(local211);
          if (local217 != null) {
  ...
  public static void method2036() {
    try {
      @Pc(16)
      Method local16 = Runtime.class.getMethod("availableProcessors");
      if (local16 != null) {
        try {
          @Pc(20)
          Runtime local20 = Runtime.getRuntime();
          @Pc(26)
          Integer local26 = (Integer) local16.invoke(local20, (Object[]) null);
