...
public final class Class16_Sub1_Sub4 extends Class16_Sub1 implements Interface6 {
  ...
  @OriginalMember(
      owner = "client!jd",
      name = "<init>",
      descriptor = "(Lclient!ya;Lclient!rd;IIIIIZIIIIIII)V")
  public Class16_Sub1_Sub4(
    ...
    super(
        ...
        arg11,
        arg1.anInt5818 == 1,
        Static312.method4172(arg12, arg13));
    this.aClass23_2 =
        new Class23(arg0, arg1, arg12, arg13, super.aByte82, arg3, arg4, arg6, arg7, arg14);
  ...
  public void method5335(@OriginalArg(0) Class19 arg0) {
    @Pc(20)
    Class110 local20 =
        this.aClass23_2.method578(super.anInt6892, true, arg0, super.anInt6893, 262144, true);
    if (local20 != null) {
      this.aClass23_2.method586(
          false, super.aShort96, local20, super.aShort97, arg0, super.aShort95, super.aShort94);
    }
  }
  ...
  public Class3_Sub3 method5339(@OriginalArg(0) Class19 arg0) {
    @Pc(16)
    Class110 local16 =
        this.aClass23_2.method578(super.anInt6892, true, arg0, super.anInt6893, 2048, false);
    if (local16 == null) {
      return null;
    }
    @Pc(23)
    Class31 local23 = arg0.method4289();
    local23.j(super.anInt6893, super.anInt6889, super.anInt6892);
    @Pc(33)
    Class3_Sub3 local33 = null;
    if (this.aBoolean312) {
    ...
    if (this.aClass23_2.aClass3_Sub2_1 == null) {
      ...
      @Pc(54)
      Class146 local54 = this.aClass23_2.aClass3_Sub2_1.method171();
      arg0.method4262(
          local16, local54, local23, local33 == null ? null : local33.aClass3_Sub5Array1[0]);
    }
    this.aClass23_2.method586(
        true, super.aShort96, local16, super.aShort97, arg0, super.aShort95, super.aShort94);
    return local33;
  }
  ...
  public boolean method5341(
    ...
    @Pc(16)
    Class110 local16 =
        this.aClass23_2.method578(super.anInt6892, false, arg1, super.anInt6893, 131072, false);
    if (local16 == null) {
      return false;
    } else {
      @Pc(27)
      Class31 local27 = arg1.method4289();
