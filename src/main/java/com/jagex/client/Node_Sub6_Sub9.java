...
public final class Node_Sub6_Sub9 extends Node_Sub6 {
  ...
  public int[] method5510(@OriginalArg(1) int arg0) {
    @Pc(11)
    int[] local11 = super.aClass82_41.method2265(arg0);
    if (!super.aClass82_41.aBoolean243) {
      return local11;
    }
    @Pc(20)
    int[][] local20 = super.aClass82_41.method2263();
    @Pc(22)
    int local22 = 0;
    @Pc(24)
    int local24 = 0;
    ...
    int local30 = 0;
    @Pc(32)
    boolean local32 = true;
    @Pc(34)
    boolean local34 = true;
    @Pc(36)
    int local36 = 0;
    @Pc(38)
    int local38 = 0;
    @Pc(45)
    int local45 = this.anInt2019 * Static80.anInt1616 >> 12;
    @Pc(52)
    int local52 = this.anInt2010 * Static80.anInt1616 >> 12;
    @Pc(59)
    int local59 = Static262.anInt4939 * this.anInt2012 >> 12;
    @Pc(66)
    int local66 = this.anInt2017 * Static262.anInt4939 >> 12;
    if (local66 <= 1) {
      return local20[arg0];
    }
    this.anInt2006 = Static80.anInt1616 / 8 * this.anInt2011 >> 12;
    @Pc(91)
    int local91 = Static80.anInt1616 / local45 + 1;
    @Pc(95)
    int[][] local95 = new int[local91][3];
    @Pc(99)
    int[][] local99 = new int[local91][3];
    @Pc(106)
    Random local106 = new Random((long) this.anInt2021);
    while (true) {
      while (true) {
        @Pc(116)
        int local116 = local45 + Static226.method3443(local106, local52 - local45);
        @Pc(125)
        int local125 = Static226.method3443(local106, local66 - local59) + local59;
        @Pc(129)
        int local129 = local116 + local28;
        ...
        if (local34) {
          ...
          @Pc(150)
          int local150 = local30;
          @Pc(154)
          int[] local154 = local99[local30];
          local156 = 0;
          @Pc(161)
          int local161 = local129 + local22;
          if (local161 < 0) {
          ...
          while (true) {
            @Pc(185)
            int[] local185 = local99[local150];
            if (local161 >= local185[0] && local161 <= local185[1]) {
              if (local150 != local30) {
                @Pc(219)
                int local219 = local28 + local22;
                if (local219 < 0) {
                ...
                for (@Pc(237) int local237 = 1; local237 <= local156; local237++) {
                  @Pc(248)
                  int[] local248 = local99[(local30 + local237) % local36];
                  local146 = Math.max(local146, local248[2]);
                }
                for (@Pc(264) int local264 = 0; local264 <= local156; local264++) {
                  @Pc(274)
                  int[] local274 = local99[(local264 + local30) % local36];
                  @Pc(278)
                  int local278 = local274[2];
                  if (local278 != local146) {
                    @Pc(285)
                    int local285 = local274[0];
                    @Pc(289)
                    int local289 = local274[1];
                    @Pc(301)
                    int local301;
                    @Pc(303)
                    int local303;
  ...
  private void method1776(
      ...
      @OriginalArg(6) Random arg5) {
    @Pc(22)
    int local22 = this.anInt2008 <= 0 ? 4096 : 4096 - Static226.method3443(arg5, this.anInt2008);
    @Pc(30)
    int local30 = this.anInt2007 * this.anInt2006 >> 12;
    @Pc(45)
    int local45 = this.anInt2006 - (local30 > 0 ? Static226.method3443(arg5, local30) : 0);
    ...
    if (local45 > 0) {
      if (arg1 > 0 && arg2 > 0) {
        ...
        local71 = arg1 / 2;
        @Pc(78)
        int local78 = local67 < local45 ? local67 : local45;
        @Pc(85)
        int local85 = local45 > local71 ? local71 : local45;
        @Pc(89)
        int local89 = arg4 + local78;
        @Pc(96)
        int local96 = arg2 - local78 * 2;
        for (@Pc(98) int local98 = 0; local98 < arg1; local98++) {
          @Pc(107)
          int[] local107 = arg3[local98 + arg0];
          @Pc(116)
          int local116;
          @Pc(121)
          int local121;
          ...
          if (local85 > local98) {
            ...
            if (this.anInt2016 == 0) {
              for (local121 = 0; local121 < local78; local121++) {
                ...
                local107[local121 + arg4 & Static203.anInt3883] =
                    local107[Static203.anInt3883 & arg2 + arg4 - local121 - 1] =
                        local129 * local116 >> 12;
              }
            } else {
              for (local121 = 0; local121 < local78; local121++) {
                local129 = local22 * local121 / local78;
                local107[arg4 + local121 & Static203.anInt3883] =
                    local107[arg2 + arg4 - local121 - 1 & Static203.anInt3883] =
                        local116 > local129 ? local129 : local116;
              }
            }
            ...
            if (local85 > local116) {
              ...
              if (this.anInt2016 == 0) {
                for (local129 = 0; local129 < local78; local129++) {
                  ...
                  local107[local129 + arg4 & Static203.anInt3883] =
                      local107[Static203.anInt3883 & arg4 + arg2 - local129 - 1] =
                          local264 * local121 >> 12;
                }
              } else {
                for (local129 = 0; local129 < local78; local129++) {
                  local264 = local22 * local129 / local78;
                  local107[local129 + arg4 & Static203.anInt3883] =
                      local107[Static203.anInt3883 & arg2 + arg4 - local129 - 1] =
                          local264 >= local121 ? local121 : local264;
                }
              }
      ...
      for (local71 = 0; local71 < arg1; local71++) {
        @Pc(481)
        int[] local481 = arg3[arg0 + local71];
