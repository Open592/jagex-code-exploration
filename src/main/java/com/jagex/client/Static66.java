...
public final class Static66 {
  ...
  public static void method4399(
    ...
    @Pc(33)
    float local33 = (float) Static148.anInt5733 / (float) Static148.anInt5729;
    @Pc(35)
    int local35 = arg0;
    @Pc(37)
    int local37 = arg4;
    ...
    @Pc(64)
    int local64 = arg2 + (arg0 - local35) / 2;
    @Pc(73)
    int local73 = arg3 + (arg4 - local37) / 2;
    if (Static229.aClass57_18 == null
        || arg0 != Static229.aClass57_18.la()
        || Static229.aClass57_18.ma() != arg4) {
      Static148.method4513(
          Static148.anInt5732,
          Static148.anInt5724 + Static148.anInt5733,
          Static148.anInt5732 - -Static148.anInt5729,
          Static148.anInt5724,
          local64,
          local73,
          local64 + local35,
    ...
    @Pc(127)
    int local127 = Static17.anInt220 * local35 / Static148.anInt5729;
    @Pc(133)
    int local133 = Static384.anInt6470 * local37 / Static148.anInt5733;
    @Pc(149)
    int local149 = Static188.anInt5352 * local35 / Static148.anInt5729 + local64;
    @Pc(163)
    int local163 =
        local37 + local73 - local133 - Static455.anInt5537 * local37 / Static148.anInt5733;
    @Pc(165)
    int local165 = -1996554240;
    ...
    for (@Pc(213) Node_Sub3 local213 = (Node_Sub3) Static148.A_LINKED_LIST___41.tail();
        local213 != null;
        local213 = (Node_Sub3) Static148.A_LINKED_LIST___41.previous()) {
      @Pc(221)
      Class157 local221 = Static148.aClass182_3.method4124(local213.anInt234);
      if (Static428.method5473(local221)) {
        ...
        if (local213.anInt234 == Static85.anInt1763) {
          ...
          local259 =
              local37 * (Static148.anInt5733 - local213.anInt228) / Static148.anInt5733 + local73;
  ...
  public static void method4403() {
    Static208.A_HASH_MAP___11.clear();
  }
}
