...
public final class Static194 {
  ...
  public static void method3044() {
    @Pc(16)
    int local16 = Static34.aByteArrayArray1.length;
    for (@Pc(18) int local18 = 0; local18 < local16; local18++) {
      if (Static34.aByteArrayArray1[local18] != null) {
        ...
        @Pc(67)
        Packet local67 = new Packet(Static34.aByteArrayArray1[local18]);
        @Pc(69)
        int local69 = 0;
        while (local67.pos < Static34.aByteArrayArray1[local18].length
            && local69 < 511
            && Static12.anInt163 < 1023) {
          @Pc(90)
          int local90 = local26 | local69++ << 6;
          @Pc(94)
          int local94 = local67.g2();
          @Pc(98)
          int local98 = local94 >> 14;
          @Pc(104)
          int local104 = local94 >> 7 & 0x3F;
          @Pc(108)
          int local108 = local94 & 0x3F;
          @Pc(121)
          int local121 =
              (Static308.anIntArray372[local18] >> 8) * 64 + local104 - Static180.anInt3453;
          @Pc(135)
          int local135 =
          ...
          if (Static143.aClass16_Sub1_Sub5_Sub2Array1[local90] == null
              ...
              && local121 >= 0
              && local121 + local142.anInt7201 < Static326.anInt5666
              && local135 >= 0
              && Static283.anInt5187 > local142.anInt7201 + local135) {
            ...
            @Pc(188)
            Class16_Sub1_Sub5_Sub2 local188 = Static143.aClass16_Sub1_Sub5_Sub2Array1[local90];
  ...
  public static void method3046(
    ...
    for (@Pc(13) Class7 local13 = local7.aClass7_3; local13 != null; local13 = local13.aClass7_1) {
      @Pc(17)
      Class16_Sub1 local17 = local13.aClass16_Sub1_1;
      if (arg3.isAssignableFrom(local17.getClass())
          && local17.aShort94 == arg1
          && local17.aShort96 == arg2) {
  ...
  public static void method3052(@OriginalArg(0) long arg0) {
    @Pc(12)
    int local12 = Static428.anInt7059;
    @Pc(14)
    int local14 = Static452.anInt7360;
    @Pc(26)
    int local26;
    @Pc(34)
    int local34;
  ...
  public static int method3056(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
    @Pc(41)
    int local41 =
        Static104.method1972(4, arg1 + 91923, arg0 + 45365)
            + (Static104.method1972(2, arg1 + 37821, arg0 + 10294) + -128 >> 1)
            + (Static104.method1972(1, arg1, arg0) - 128 >> 2)
            - 128;
