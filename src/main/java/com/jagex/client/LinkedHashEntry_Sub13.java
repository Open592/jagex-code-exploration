...
public final class LinkedHashEntry_Sub13 extends LinkedHashEntry {
	...
	public LinkedHashEntry_Sub13(@OriginalArg(0) byte[] arg0) {
	...
	public LinkedHashEntry_Sub4_Sub1 method1322(@OriginalArg(0) int[] arg0) {
		...
		return new LinkedHashEntry_Sub4_Sub1(this.anInt1467, local129, this.anInt1462, this.anInt1463, this.aBoolean126);
	}
