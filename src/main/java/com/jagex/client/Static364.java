...
public final class Static364 {
  ...
  @OriginalMember(
      owner = "client!sk",
      name = "a",
      descriptor = "(Lclient!bc;[Lclient!sk;)Lclient!sk;")
  public static Class110_Sub2 method4912(
      @OriginalArg(0) Class19_Sub1 arg0, @OriginalArg(1) Class110_Sub2[] arg1) {
    @Pc(1)
    int local1 = 0;
    @Pc(3)
    Class110_Sub2 local3 = null;
