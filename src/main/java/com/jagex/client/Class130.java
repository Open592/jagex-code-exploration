...
public final class Class130 implements Interface8 {
  ...
  @OriginalMember(
      owner = "client!ko",
      name = "a",
      descriptor = "(JB[ILclient!ho;)Ljava/lang/String;")
  @Override
  public String method3205(
      @OriginalArg(0) long arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) Class98 arg2) {
    if (Static289.aClass98_13 == arg2) {
      @Pc(15)
      Class200 local15 = Static416.aClass158_1.method3790(arg1[0]);
