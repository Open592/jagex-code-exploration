...
public final class Static170 {
	...
	public static boolean method2771(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		...
		if (arg1 == -1 && local35.anInt6840 == 0) {
			for (local46 = (Node_Sub39) Static206.A_LINKED_LIST___28.tail(); local46 != null; local46 = (Node_Sub39) Static206.A_LINKED_LIST___28.previous()) {
	...
	public static void method2773(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) Class202 arg3) {
		for (@Pc(14) Node_Sub8 local14 = (Node_Sub8) Static281.A_LINKED_LIST___34.tail(); local14 != null; local14 = (Node_Sub8) Static281.A_LINKED_LIST___34.previous()) {
