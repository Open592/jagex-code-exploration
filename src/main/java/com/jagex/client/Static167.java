...
public final class Static167 {
	...
	public static void method2736() {
		...
		for (@Pc(5778) LinkedHashEntry_Sub43 local5778 = (LinkedHashEntry_Sub43) Static325.aLinkedHashMap_Iterator_29.head(); local5778 != null; local5778 = (LinkedHashEntry_Sub43) Static325.aLinkedHashMap_Iterator_29.nextEntry()) {
			if (!local5778.hasNext()) {
				local5778 = (LinkedHashEntry_Sub43) Static325.aLinkedHashMap_Iterator_29.head();
				if (local5778 == null) {
					break;
				}
			}
	...
	public static void method2738(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		@Pc(18) int local18 = arg3 - arg0;
		@Pc(23) int local23 = arg4 - arg1;
		if (local23 == 0) {
			if (local18 != 0) {
			...
			@Pc(75) boolean local75 = local23 < local18;
			@Pc(79) int local79;
			@Pc(83) int local83;
			if (local75) {
				local79 = arg1;
			...
			@Pc(140) int local140 = arg3 > arg0 ? 1 : -1;
			@Pc(144) int local144;
			if (local75) {
