...
public final class Static321 {
  ...
  public static void method4336(@OriginalArg(0) int arg0, @OriginalArg(1) ISAACPacket arg1) {
    while (true) {
      @Pc(15)
      Node_Sub36 local15 = (Node_Sub36) Static421.aLinkedList_48.tail();
      if (local15 == null) {
        return;
      }
      @Pc(20)
      ...
      for (@Pc(106) int local106 = 0; local106 < local15.anInt5309; local106++) {
        if (local15.anIntArray351[local106] == 0) {
          try {
            @Pc(127)
            int local127 = local15.anIntArray349[local106];
            @Pc(139)
            Field local139;
            @Pc(143)
            int local143;
            ...
            if (local127 == 3) {
              ...
              @Pc(212)
              byte[][] local212 = local15.aByteArrayArrayArray4[local106];
              @Pc(216)
              Object[] local216 = new Object[local212.length];
              for (@Pc(218) int local218 = 0; local218 < local212.length; local218++) {
                @Pc(230)
                ObjectInputStream local230 =
                    new ObjectInputStream(new ByteArrayInputStream(local212[local218]));
                local216[local218] = local230.readObject();
              }
              @Pc(245)
              Object local245 = local207.invoke(null, local216);
              if (local245 == null) {
                arg1.p1(0);
              ...
              @Pc(313)
              ClassNotFoundException local313) {
            arg1.p1(-10);
          } catch (
              @Pc(319)
              InvalidClassException local319) {
            arg1.p1(-11);
          } catch (
              @Pc(325)
              StreamCorruptedException local325) {
            arg1.p1(-12);
          } catch (
              @Pc(331)
              OptionalDataException local331) {
            arg1.p1(-13);
          } catch (
              @Pc(337)
              IllegalAccessException local337) {
            arg1.p1(-14);
          } catch (
              @Pc(343)
              IllegalArgumentException local343) {
            arg1.p1(-15);
          } catch (
              @Pc(349)
              InvocationTargetException local349) {
            arg1.p1(-16);
          } catch (
              @Pc(355)
              SecurityException local355) {
            arg1.p1(-17);
          } catch (
              @Pc(361)
              IOException local361) {
            arg1.p1(-18);
          } catch (
              @Pc(367)
              NullPointerException local367) {
            arg1.p1(-19);
          } catch (
              @Pc(373)
              Exception local373) {
