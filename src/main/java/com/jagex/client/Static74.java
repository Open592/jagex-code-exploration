...
public final class Static74 {
  ...
  public static int method1361(
    ...
    @Pc(18)
    int local18 = 128 - arg0;
    @Pc(32)
    int local32 = arg0 * (arg2 & 0x7F) + local18 * (arg1 & 0x7F) >> 7;
    @Pc(46)
    int local46 = arg0 * (arg2 & 0x380) + local18 * (arg1 & 0x380) >> 7;
    @Pc(60)
    int local60 = local18 * (arg1 & 0xFC00) + (arg2 & 0xFC00) * arg0 >> 7;
