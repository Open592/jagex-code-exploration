...
public final class Class46_Sub3 extends Class46 {
  ...
  protected void OA(
    ...
    @Pc(18)
    int local18 = this.anIntArray388[arg0];
    @Pc(23)
    int local23 = this.anIntArray392[arg0];
    @Pc(27)
    int local27 = this.aClass19_Sub1_7.anInt430;
    @Pc(33)
    ...
    if (arg4) {
      this.method4364(
          this.aByteArrayArray25[arg0],
          this.aClass19_Sub1_7.anIntArray26,
          arg3,
          local41,
          local33,
          local18,
  ...
  private void method4365(
    ...
    @Pc(14)
    int local14 = arg9 - this.aClass19_Sub1_7.lb;
    @Pc(16)
    int local16 = arg10;
    if (arg14 > arg10) {
      local16 = arg14;
  ...
  private void method4366(
      ...
      @OriginalArg(13) Class145 arg13,
      @OriginalArg(14) int arg14,
      @OriginalArg(15) int arg15) {
    @Pc(2)
    Class145_Sub2 local2 = (Class145_Sub2) arg13;
    @Pc(5)
    int[] local5 = local2.anIntArray554;
    @Pc(8)
    int[] local8 = local2.anIntArray553;
    @Pc(14)
    int local14 = arg10 - this.aClass19_Sub1_7.lb;
    @Pc(16)
    int local16 = arg11;
    if (arg15 > arg11) {
      local16 = arg15;
    ...
    @Pc(56)
    int local56 = arg15 + local5.length < arg11 + arg7 ? arg15 + local5.length : arg11 + arg7;
    for (@Pc(60) int local60 = local16; local60 < local56; local60++) {
      @Pc(69)
      int local69 = local5[local60 - arg15] + arg14;
      @Pc(75)
      int local75 = local8[local60 - arg15];
      @Pc(77)
      int local77 = arg6;
      @Pc(84)
      int local84;
  ...
  protected void method5051(
    ...
    arg2 += this.anIntArray389[arg0];
    @Pc(28)
    int local28 = this.anIntArray388[arg0];
    @Pc(33)
    int local33 = this.anIntArray392[arg0];
    @Pc(37)
    int local37 = this.aClass19_Sub1_7.anInt430;
    @Pc(43)
