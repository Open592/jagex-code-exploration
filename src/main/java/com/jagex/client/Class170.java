...
public final class Class170 {
	...
	public void method3966(@OriginalArg(0) ByteBuffer arg0) {
		while (true) {
	...
	private void method3968(@OriginalArg(0) int arg0, @OriginalArg(2) ByteBuffer arg1) {
		if (arg0 == 1) {
			this.anInt5190 = arg1.method2536();
		} else if (arg0 == 2) {
			this.anIntArray341 = new int[arg1.readByteIntoInt()];
			for (@Pc(26) int local26 = 0; local26 < this.anIntArray341.length; local26++) {
				this.anIntArray341[local26] = arg1.method2536();
			}
		} else if (arg0 == 3) {
			this.anInt5189 = arg1.readByteIntoInt();
		}
	}
}
