...
public final class Class16_Sub5_Sub3 extends Class16_Sub5 implements Interface6 {
  ...
  @OriginalMember(
      owner = "client!tt",
      name = "<init>",
      descriptor = "(Lclient!ya;Lclient!rd;IIIIIZIII)V")
  public Class16_Sub5_Sub3(
    ...
    this.aClass23_4 =
        new Class23(
            arg0, arg1, arg8, arg9, arg2, arg3, super.anInt6550, super.anInt6552, arg7, arg10);
  ...
  public Class3_Sub3 method5339(@OriginalArg(0) Class19 arg0) {
    @Pc(16)
    Class110 local16 =
        this.aClass23_4.method578(super.anInt6552, true, arg0, super.anInt6550, 2048, false);
    if (local16 == null) {
      return null;
    }
    @Pc(23)
    ...
    if (this.aClass23_4.aClass3_Sub2_1 == null) {
      ...
      @Pc(54)
      Class146 local54 = this.aClass23_4.aClass3_Sub2_1.method171();
      arg0.method4262(
          local16, local54, local23, local38 == null ? null : local38.aClass3_Sub5Array1[0]);
    }
    @Pc(87)
    int local87 = super.anInt6550 >> 7;
    @Pc(92)
    int local92 = super.anInt6552 >> 7;
  ...
  public boolean method5341(
    ...
    @Pc(20)
    Class110 local20 =
        this.aClass23_4.method578(super.anInt6552, false, arg1, super.anInt6550, 131072, false);
    if (local20 == null) {
      return false;
    } else {
      @Pc(27)
  ...
  public void method5335(@OriginalArg(0) Class19 arg0) {
    @Pc(22)
    Class110 local22 =
        this.aClass23_4.method578(super.anInt6552, true, arg0, super.anInt6550, 262144, true);
    if (local22 != null) {
      @Pc(29)
      int local29 = super.anInt6550 >> 7;
      @Pc(34)
      int local34 = super.anInt6552 >> 7;
