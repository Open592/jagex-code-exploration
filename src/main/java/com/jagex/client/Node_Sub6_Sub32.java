...
public final class Node_Sub6_Sub32 extends Node_Sub6 {
  ...
  public void method5518(@OriginalArg(1) int arg0, @OriginalArg(2) Packet arg1) {
    if (arg0 == 0) {
      this.anInt6374 = arg1.g1();
    } else if (arg0 == 1) {
      this.anInt6370 = arg1.g1();
    }
  }
  ...
  public int[][] method5514(@OriginalArg(1) int arg0) {
    @Pc(17)
    int[][] local17 = super.aClass153_41.method3679(arg0);
    if (super.aClass153_41.aBoolean437) {
      @Pc(26)
      int local26 = Static80.anInt1616 / this.anInt6374;
      @Pc(31)
      int local31 = Static262.anInt4939 / this.anInt6370;
      @Pc(50)
      int[][] local50;
      if (local31 > 0) {
        @Pc(40)
        int local40 = arg0 % local31;
        local50 = this.method5516(0, local40 * Static262.anInt4939 / local31);
      } else {
        local50 = this.method5516(0, 0);
      }
      @Pc(62)
      int[] local62 = local50[0];
      @Pc(66)
      int[] local66 = local50[1];
      @Pc(70)
      int[] local70 = local50[2];
      @Pc(74)
      int[] local74 = local17[0];
      @Pc(78)
      int[] local78 = local17[1];
      @Pc(82)
      int[] local82 = local17[2];
  ...
  public int[] method5510(@OriginalArg(1) int arg0) {
    ...
    if (super.aClass82_41.aBoolean243) {
      @Pc(28)
      int local28 = Static80.anInt1616 / this.anInt6374;
      @Pc(33)
      int local33 = Static262.anInt4939 / this.anInt6370;
      @Pc(52)
      int[] local52;
      @Pc(42)
      int local42;
