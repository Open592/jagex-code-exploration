...
public final class Class212 {
  ...
  @OriginalMember(
      owner = "client!sb",
      name = "a",
      descriptor = "(Lclient!ya;Ljava/lang/String;[IIIIZ)V")
  private void method4817(
    ...
    @Pc(7)
    int local7 = arg5 | 0xFF000000;
    for (@Pc(9) int local9 = 0; local9 < arg1.length(); local9++) {
      @Pc(16)
      int local16 = anIntArray440[arg1.charAt(local9)];
      if (arg6) {
  ...
  @OriginalMember(
      owner = "client!sb",
      name = "a",
      descriptor = "(Lclient!ya;Ljava/lang/String;IIIZ)V")
  public void method4819(
      ...
      @OriginalArg(4) int arg4) {
    @Pc(5)
    int local5 = this.method4820(arg1) / 2;
    arg0.da(this.anIntArray438);
    if (arg2 - local5 <= this.anIntArray438[2]
        && (arg2 + local5 >= this.anIntArray438[0]
            && (arg3 - this.anInt6210 <= this.anIntArray438[3]
                && arg3 + this.anInt6208 >= this.anIntArray438[1]))) {
  ...
  public int method4820(@OriginalArg(0) String arg0) {
    ...
    for (@Pc(3) int local3 = 0; local3 < arg0.length(); local3++) {
      @Pc(10)
      int local10 = anIntArray440[arg0.charAt(local3)];
  ...
  @OriginalMember(
      owner = "client!sb",
      name = "a",
      descriptor = "(Lclient!ya;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V")
  private void method4822(
      @OriginalArg(0) Class19 arg0,
      @OriginalArg(1) Font arg1,
      @OriginalArg(2) FontMetrics arg2,
      @OriginalArg(3) char arg3,
      @OriginalArg(4) int arg4,
      @OriginalArg(5) boolean arg5) {
    @Pc(3)
    int local3 = arg2.charWidth(arg3);
    @Pc(5)
    int local5 = local3;
    if (arg5) {
      try {
    ...
    @Pc(49)
    int local49 = arg2.getMaxAscent();
    @Pc(55)
    int local55 = arg2.getMaxAscent() + arg2.getMaxDescent();
    @Pc(58)
    int local58 = arg2.getHeight();
    @Pc(63)
    Image local63 = GameShell.canvas.createImage(local3, local55);
    @Pc(66)
    Graphics local66 = local63.getGraphics();
    ...
    @Pc(100)
    int[] local100 = new int[local3 * local55];
    @Pc(112)
    PixelGrabber local112 = new PixelGrabber(local63, 0, 0, local3, local55, local100, 0, local3);
    try {
      local112.grabPixels();
    } catch (
        @Pc(117)
    ...
    int local128;
    label66:
    for (@Pc(125) int local125 = 0; local125 < local55; local125++) {
      for (local128 = 0; local128 < local3; local128++) {
        @Pc(137)
        int local137 = local100[local128 + local125 * local3];
