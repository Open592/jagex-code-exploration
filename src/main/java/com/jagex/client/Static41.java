...
public final class Static41 {
  ...
  public static void method727(@OriginalArg(0) Class3_Sub3 arg0) {
    ...
    synchronized (Class147.aClass84Array1) {
      if (local12 < Class147.aClass84Array1.length && Static95.anIntArray154[local12] < 200) {
        ...
        @Pc(65)
        int local65 = Static95.anIntArray154[local12]++;
      }
    }
  }
  ...
  public static void method729(
      ...
      @OriginalArg(1) ISAACPacket arg1,
      @OriginalArg(2) int arg2,
      @OriginalArg(4) Class16_Sub1_Sub5_Sub1 arg3) {
    @Pc(7)
    byte local7 = -1;
    if ((arg0 & 0x40) != 0) {
    ...
    if ((arg0 & 0x10000) != 0) {
      local243 = arg1.g1();
      @Pc(297)
      int[] local297 = new int[local243];
      @Pc(300)
      int[] local300 = new int[local243];
      @Pc(303)
      int[] local303 = new int[local243];
      for (@Pc(305) int local305 = 0; local305 < local243; local305++) {
        @Pc(311)
        int local311 = arg1.g2();
        if (local311 == 65535) {
          local311 = -1;
        }
    ...
    if ((arg0 & 0x80) != 0) {
      ...
      @Pc(427)
      int local427 = arg1.pos;
      @Pc(435)
      boolean local435 = (local243 & 0x8000) != 0;
      if (arg3.aString44 != null && arg3.aClass37_1 != null) {
        @Pc(443)
        boolean local443 = false;
        if (local363 <= 1) {
          if (!local435
        ...
        if (!local443 && Static65.anInt1373 == 0) {
          ...
          if (local435) {
            local243 &= 0x7FFF;
            @Pc(499)
            Class257 local499 = Static419.method5378(Static154.A_BYTE_BUFFER___2);
            local489 = local499.anInt7070;
            local508 = local499.aClass4_Sub1_Sub3_1.method234(Static154.A_BYTE_BUFFER___2);
          } else {
            local508 = Static22.method297(Static261.method3776(Static154.A_BYTE_BUFFER___2));
          }
    ...
    if ((arg0 & 0x20) != 0) {
      local243 = arg1.g1();
      @Pc(818)
      byte[] local818 = new byte[local243];
      @Pc(823)
      Packet local823 = new Packet(local818);
  ...
  public static void method730() {
    ...
    for (@Pc(15) Node_Sub39 local15 = (Node_Sub39) Static206.A_LINKED_LIST___28.tail();
        local15 != null;
        local15 = (Node_Sub39) Static206.A_LINKED_LIST___28.previous()) {
    ...
    int local43 = -1;
    @Pc(48)
    Node_Sub5 local48 = (Node_Sub5) Static413.A_LINKED_LIST___47.tail();
    if (local48 != null) {
      local43 = local48.method515();
    }
    if (!Static234.aBoolean411) {
      if (local43 == 0
          && (Static64.anInt1361 == 1 && Static407.anInt6710 > 2 || Static158.method2677())) {
        local43 = 2;
      }
    ...
    if (local43 == -1) {
      ...
      if (Static310.anInt5424 - 10 > local133
          || local133 > Static173.anInt3370 + Static310.anInt5424 + 10
          || Static172.anInt3367 - 10 > local137
          || local137 > Static112.anInt2392 + Static172.anInt3367 + 10) {
    ...
    @Pc(188)
    int local188 = Static173.anInt3370;
    @Pc(194)
    int local194 = local48.method518();
    @Pc(198)
    int local198 = local48.method519();
    @Pc(200)
    int local200 = -1;
    @Pc(219)
    int local219;
    for (@Pc(202) int local202 = 0; local202 < Static407.anInt6710; local202++) {
      if (Static299.aBoolean481) {
        ...
        if (local194 > local133
            && local194 < local133 + local188
            && local198 > local219 - 13
            && local198 < local219 + 4) {
          local200 = local202;
        }
      } else {
        local219 = local137 + (Static407.anInt6710 - local202 - 1) * 16 + 31;
        if (local133 < local194
            && local188 + local133 > local194
            && local219 - 13 < local198
            && local219 + 3 > local198) {
          local200 = local202;
        }
      }
    ...
    if (local200 != -1) {
      local219 = 0;
      @Pc(301)
      Class63 local301 = new Class63(Static206.A_LINKED_LIST___28);
      for (@Pc(306) Node_Sub39 local306 = (Node_Sub39) local301.method1611();
          local306 != null;
          local306 = (Node_Sub39) local301.method1612()) {
