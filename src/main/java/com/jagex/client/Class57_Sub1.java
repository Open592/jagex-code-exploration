...
public abstract class Class57_Sub1 extends Class57 {
  ...
  protected Class57_Sub1(
      @OriginalArg(0) Class19_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
  ...
  @Override
  protected final void method5535(
    ...
    @Pc(18)
    Class145_Sub2 local18 = (Class145_Sub2) arg6;
    this.method5545(
        local18.anIntArray554,
        local18.anIntArray553,
        Static359.anInt7170 - arg7,
        -arg8 - (Static359.anInt7141 - Static359.anInt7149));
  }
  ...
  private void method5543(
      ...
      @OriginalArg(5) float arg5) {
    @Pc(8)
    int local8 = this.anInt7157 + this.anInt7168 + this.anInt7155;
    @Pc(17)
    int local17 = this.anInt7148 + this.anInt7144 + this.anInt7162;
    @Pc(32)
    float local32;
    @Pc(39)
    float local39;
    ...
    if (local8 != this.anInt7168 || local17 != this.anInt7144) {
      ...
      @Pc(84)
      float local84 = -local32 * (float) this.anInt7155;
      @Pc(91)
      float local91 = -local39 * (float) this.anInt7155;
      @Pc(98)
      float local98 = -local46 * (float) this.anInt7162;
      @Pc(105)
      float local105 = -local53 * (float) this.anInt7162;
    ...
    Static359.anInt7140 =
        (int) (local46 * 16.0F + 8.0F - (arg0 + arg2 + arg4 + local32) / 4.0F * 16.0F);
    Static359.anInt7163 =
        (int) (local59 * 16.0F + 8.0F - (arg1 + arg3 + arg5 + local39) / 4.0F * 16.0F);
    Static359.anInt7145 =
        (this.anInt7168 >> 1 << 12) + (Static359.anInt7163 * Static359.anInt7169 >> 4);
    Static359.anInt7146 =
        (this.anInt7144 >> 1 << 12) + (Static359.anInt7163 * Static359.anInt7150 >> 4);
  ...
  public abstract void method5542(
      @OriginalArg(0) int arg0,
      @OriginalArg(1) int arg1,
  ...
  protected final void a(
    ...
    if (arg6 != 1) {
      ...
      if (arg6 == 0) {
        ...
        @Pc(66)
        int local66 = (arg7 & 0xFF00FF) * Static359.anInt7166 & 0xFF00FF00;
        @Pc(74)
        int local74 = (arg7 & 0xFF00) * Static359.anInt7166 & 0xFF0000;
  ...
  public final void JA(
    ...
    this.aClass19_Sub1_11.fa(
        this.aClass19_Sub1_11.lb, this.aClass19_Sub1_11.anInt425, arg0 + arg2, arg1 + arg3);
    @Pc(37)
    int local37 = this.j();
    @Pc(40)
    int local40 = this.T();
    @Pc(48)
    int local48 = (arg2 + local37 - 1) / local37;
    @Pc(56)
    int local56 = (arg3 + local40 - 1) / local40;
    for (@Pc(58) int local58 = 0; local58 < local56; local58++) {
      @Pc(63)
      int local63 = local58 * local40;
      for (@Pc(65) int local65 = 0; local65 < local48; local65++) {
        this.r(arg0 + local65 * local37, arg1 + local63, arg4, arg5, arg6);
      }
    }
    this.aClass19_Sub1_11.OA(
        this.anIntArray541[0], this.anIntArray541[1], this.anIntArray541[2], this.anIntArray541[3]);
  }

  @OriginalMember(owner = "client!sf", name = "a", descriptor = "([I[III)V")
  protected abstract void method5545(
      @OriginalArg(0) int[] arg0,
      @OriginalArg(1) int[] arg1,
      @OriginalArg(2) int arg2,
      @OriginalArg(3) int arg3);
