...
public final class Static13 {
  ...
  public static int method135(
    ...
    if (local11 < 0
        || local15 < 0
        || Static326.anInt5666 - 1 < local11
        || Static283.anInt5187 - 1 < local15) {
      return 0;
    }
    @Pc(43)
    int local43 = arg1;
  ...
  public static boolean method137(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
    if (Static44.method760(arg0, arg1)) {
      return (arg1 & 0xB000) != 0 | Static93.method1643(arg0, arg1) | Static55.method934(arg1, arg0)
          ? true
          : (Static72.method1353(arg0, arg1) | Static183.method2904(arg0, arg1))
              & (arg0 & 0x37) == 0;
    } else {
      return false;
    }
