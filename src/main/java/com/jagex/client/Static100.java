...
public final class Static100 {
  ...
  public static void method1774(
    ...
    int local3 = arg3;
    @Pc(7)
    int local7 = arg3 + arg5;
    @Pc(11)
    int local11 = arg4 - 1;
    @Pc(15)
    int local15 = arg4 + arg6;
        ...
        for (@Pc(23) int local23 = local3; local23 <= local7; local23++) {
          if (local23 >= 0 && local23 < Static422.anInt6945) {
            for (@Pc(32) int local32 = local11; local32 <= local15; local32++) {
              if (local32 >= 0
                  && local32 < Static171.anInt3361
                  && (!local1
                      || local23 >= local7
                      || local32 >= local15
                      || local32 < arg4 && local23 != arg3)) {
                @Pc(62)
                Class164 local62 = Static202.aClass164ArrayArrayArray5[local17][local23][local32];
                if (local62 != null) {
                  @Pc(140)
                  int local140 =
                      (Static417.aClass65Array4[local17].l(local23, local32)
                                  + Static417.aClass65Array4[local17].l(local23 + 1, local32)
                                  + Static417.aClass65Array4[local17].l(local23, local32 + 1)
                                  + Static417.aClass65Array4[local17].l(local23 + 1, local32 + 1))
                              / 4
                          - (Static417.aClass65Array4[arg2].l(arg3, arg4)
                                  + Static417.aClass65Array4[arg2].l(arg3 + 1, arg4)
                                  + Static417.aClass65Array4[arg2].l(arg3, arg4 + 1)
                                  + Static417.aClass65Array4[arg2].l(arg3 + 1, arg4 + 1))
                              / 4;
                  @Pc(143)
                  Class16_Sub5 local143 = local62.aClass16_Sub5_3;
                  @Pc(146)
                  Class16_Sub5 local146 = local62.aClass16_Sub5_2;
                  if (local143 != null && local143.method5338()) {
                    arg1.method5337(
                        (local32 - arg4) * Static4.anInt5935 + (1 - arg6) * Static333.anInt5747,
                        (local23 - arg3) * Static4.anInt5935 + (1 - arg5) * Static333.anInt5747,
                        local143,
                        local1,
                        arg0,
                        local140);
                  ...
                  for (@Pc(219) Class7 local219 = local62.aClass7_3;
                      local219 != null;
                      local219 = local219.aClass7_1) {
                    @Pc(223)
                    Class16_Sub1 local223 = local219.aClass16_Sub1_1;
                    if (local223 != null
                        && local223.method5338()
                        && (local23 == local223.aShort94 || local23 == local3)
                        && (local32 == local223.aShort96 || local32 == local11)) {
                      @Pc(252)
                      int local252 = local223.aShort97 + 1 - local223.aShort94;
                      @Pc(260)
                      int local260 = local223.aShort95 + 1 - local223.aShort96;
                      arg1.method5337(
                          (local223.aShort96 - arg4) * Static4.anInt5935
                              + (local260 - arg6) * Static333.anInt5747,
                          (local223.aShort94 - arg3) * Static4.anInt5935
                              + (local252 - arg5) * Static333.anInt5747,
                          local223,
                          local1,
                          arg0,
                          local140);
