...
public final class Static68 {
  ...
  public static Node_Sub13 method1316(@OriginalArg(0) Js5 arg0, @OriginalArg(1) int arg1) {
    if (method1320(arg0)) {
      @Pc(14)
      byte[] local14 = arg0.method2122(arg1);
  ...
  public static int method1317() {
    @Pc(7)
    int local7 = aByteArray15[anInt1461] >> anInt1460 & 0x1;
    anInt1460++;
  ...
  public static Node_Sub13 method1318(
      @OriginalArg(0) Js5 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
    if (method1320(arg0)) {
      @Pc(16)
      byte[] local16 = arg0.method2104(arg2, arg1);
  ...
  private static void method1319(@OriginalArg(0) byte[] arg0) {
    ...
    for (@Pc(17) int local17 = 0; local17 < 2; local17++) {
      ...
      local36 = local24 >> 3;
      @Pc(39)
      float[] local39 = new float[local28];
      for (local41 = 0; local41 < local32; local41++) {
        local39[local41 * 2] =
            (float) Math.cos((double) (local41 * 4) * 3.141592653589793D / (double) local24);
        local39[local41 * 2 + 1] =
            -((float) Math.sin((double) (local41 * 4) * 3.141592653589793D / (double) local24));
      }
      @Pc(84)
      float[] local84 = new float[local28];
      for (local86 = 0; local86 < local32; local86++) {
        local84[local86 * 2] =
            (float)
                Math.cos((double) (local86 * 2 + 1) * 3.141592653589793D / (double) (local24 * 2));
        local84[local86 * 2 + 1] =
            (float)
                Math.sin((double) (local86 * 2 + 1) * 3.141592653589793D / (double) (local24 * 2));
      }
      @Pc(136)
      float[] local136 = new float[local32];
      for (local138 = 0; local138 < local36; local138++) {
        local136[local138 * 2] =
            (float) Math.cos((double) (local138 * 4 + 2) * 3.141592653589793D / (double) local24);
        local136[local138 * 2 + 1] =
            -((float)
                Math.sin((double) (local138 * 4 + 2) * 3.141592653589793D / (double) local24));
      }
      @Pc(185)
      int[] local185 = new int[local36];
  ...
  private static boolean method1320(@OriginalArg(0) Js5 arg0) {
    if (!aBoolean124) {
      @Pc(7)
      byte[] local7 = arg0.method2104(0, 0);
      if (local7 == null) {
        return false;
      }
      method1319(local7);
  ...
  public static float method1323(@OriginalArg(0) int arg0) {
    @Pc(3)
    int local3 = arg0 & 0x1FFFFF;
    @Pc(7)
    int local7 = arg0 & Integer.MIN_VALUE;
    @Pc(13)
    int local13 = arg0 >> 21 & 0x3FF;
    if (local7 != 0) {
      local3 = -local3;
    }
