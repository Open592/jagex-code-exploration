...
public class Node_Sub6_Sub3 extends Node_Sub6 {
  ...
  public int[][] method5514(@OriginalArg(1) int arg0) {
    ...
    if (super.aClass153_41.aBoolean437 && this.method986()) {
      @Pc(28)
      int[] local28 = local11[0];
      @Pc(32)
      int[] local32 = local11[1];
      @Pc(36)
      int[] local36 = local11[2];
      @Pc(52)
      int local52 =
          (Static262.anInt4939 == this.anInt1086
                  ? arg0
                  : this.anInt1086 * arg0 / Static262.anInt4939)
              * this.anInt1078;
      @Pc(62)
      int local62;
      @Pc(71)
      ...
      if (Static80.anInt1616 == this.anInt1078) {
        ...
        for (local62 = 0; local62 < Static80.anInt1616; local62++) {
          ...
          @Pc(79)
          int local79 = this.anIntArray62[local52 + local71];
    ...
    if (this.anIntArray62 != null) {
      ...
      Class18 local32 =
          Static182.anInt3496 >= 0
              ? Static456.method318(Static40.aJs5_9, Static182.anInt3496, this.anInt1085)
              : Static456.method328(Static40.aJs5_9, this.anInt1085);
      local32.method322();
