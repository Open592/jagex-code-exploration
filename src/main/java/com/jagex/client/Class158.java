...
public final class Class158 {
  ...
  public Class158(
    ...
    if (this.aJs5_53 != null) {
      @Pc(20)
      int local20 = this.aJs5_53.method2100() - 1;
  ...
  public Class200 method3790(@OriginalArg(0) int arg0) {
    @Pc(14)
    Class68 local14 = this.aClass68_28;
    @Pc(24)
    Class200 local24;
    ...
    @Pc(45)
    byte[] local45 = this.aJs5_53.method2104(Static167.method2739(arg0), Static7.method4190(arg0));
    local24 = new Class200();
    if (local45 != null) {
      local24.method4534(new Packet(local45));
    }
    @Pc(61)
    Class68 local61 = this.aClass68_28;
    synchronized (this.aClass68_28) {
