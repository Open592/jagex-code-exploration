...
public abstract class Class57 {
  ...
  public final void method5533(
      @OriginalArg(0) float arg0,
      @OriginalArg(1) float arg1,
      @OriginalArg(3) int arg2,
      @OriginalArg(4) Class145 arg3,
      @OriginalArg(5) int arg4,
      @OriginalArg(6) int arg5) {
    this.method5538(
        arg0, arg1, (float) this.j() / 2.0F, (float) this.T() / 2.0F, 4096, arg2, arg3, arg4, arg5);
  }
  ...
  public final void method5536(
      ...
      @OriginalArg(5) int arg4) {
    this.method5540(
        arg0, arg1, (float) this.j() / 2.0F, (float) this.T() / 2.0F, arg2, arg3, 0, arg4);
  }
  ...
  public final void method5538(
    ...
    @Pc(9)
    double local9 = (double) (arg5 & 0xFFFF) * 9.587379924285257E-5D;
    @Pc(16)
    float local16 = (float) Math.sin(local9) * (float) arg4;
    @Pc(23)
    float local23 = (float) Math.cos(local9) * (float) arg4;
    @Pc(37)
    float local37 = (-arg2 * local23 + -arg3 * local16) / 4096.0F + arg0;
    @Pc(50)
    float local50 = (arg2 * local16 + -arg3 * local23) / 4096.0F + arg1;
    @Pc(67)
    float local67 = (((float) this.j() - arg2) * local23 + -arg3 * local16) / 4096.0F + arg0;
    @Pc(85)
    float local85 = (-((float) this.j() - arg2) * local16 + -arg3 * local23) / 4096.0F + arg1;
    @Pc(102)
    float local102 = (-arg2 * local23 + ((float) this.T() - arg3) * local16) / 4096.0F + arg0;
    @Pc(118)
    float local118 = (arg2 * local16 + ((float) this.T() - arg3) * local23) / 4096.0F + arg1;
