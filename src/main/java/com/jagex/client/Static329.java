...
public final class Static329 {
  ...
  public static String method4429(@OriginalArg(0) Throwable arg0) throws IOException {
    ...
    if (arg0 instanceof RuntimeException_Sub1) {
      @Pc(16)
      RuntimeException_Sub1 local16 = (RuntimeException_Sub1) arg0;
    ...
    @Pc(37)
    StringWriter local37 = new StringWriter();
    @Pc(42)
    PrintWriter local42 = new PrintWriter(local37);
    arg0.printStackTrace(local42);
    local42.close();
    @Pc(50)
    String local50 = local37.toString();
    @Pc(58)
    BufferedReader local58 = new BufferedReader(new StringReader(local50));
    @Pc(61)
    String local61 = local58.readLine();
    while (true) {
      @Pc(64)
      String local64 = local58.readLine();
      if (local64 == null) {
        return local29 + "| " + local61;
      }
      @Pc(70)
      int local70 = local64.indexOf(40);
      @Pc(77)
      int local77 = local64.indexOf(41, local70 + 1);
      @Pc(85)
      String local85;
      if (local70 == -1) {
        local85 = local64;
      ...
      if (local70 != -1 && local77 != -1) {
        @Pc(129)
        int local129 = local64.indexOf(".java:", local70);
        if (local129 >= 0) {
  ...
  public static void method4430() {
    @Pc(9)
    int local9 = Static146.anInt266 * 128 + 64;
    @Pc(15)
    int local15 = Static188.anInt5355 * 128 + 64;
    @Pc(24)
    int local24 = Static13.method135(local9, Static263.anInt4963, local15) - Static365.anInt6311;
    if (Static286.anInt5198 < 100) {
      if (Static163.anInt3197 < local9) {
        Static163.anInt3197 +=
            Static67.anInt1408 + (local9 - Static163.anInt3197) * Static286.anInt5198 / 1000;
        if (Static163.anInt3197 > local9) {
      ...
      if (Static100.anInt2024 < local24) {
        Static100.anInt2024 +=
            Static67.anInt1408 + Static286.anInt5198 * (local24 - Static100.anInt2024) / 1000;
      ...
      if (local9 < Static163.anInt3197) {
        Static163.anInt3197 -=
            (Static163.anInt3197 - local9) * Static286.anInt5198 / 1000 + Static67.anInt1408;
        if (local9 > Static163.anInt3197) {
          Static163.anInt3197 = local9;
        }
      }
      if (local15 > Static145.anInt2906) {
        Static145.anInt2906 +=
            Static67.anInt1408 + (local15 - Static145.anInt2906) * Static286.anInt5198 / 1000;
        if (local15 < Static145.anInt2906) {
      ...
      if (Static100.anInt2024 > local24) {
        Static100.anInt2024 -=
            Static67.anInt1408 + (Static100.anInt2024 - local24) * Static286.anInt5198 / 1000;
        if (Static100.anInt2024 < local24) {
          Static100.anInt2024 = local24;
        }
      }
      if (local15 < Static145.anInt2906) {
        Static145.anInt2906 -=
            Static67.anInt1408 + (Static145.anInt2906 - local15) * Static286.anInt5198 / 1000;
      ...
      Static100.anInt2024 =
          Static13.method135(Static163.anInt3197, Static263.anInt4963, Static145.anInt2906)
              - Static365.anInt6311;
    }
    ...
    @Pc(218)
    int local218 = local9 - Static163.anInt3197;
    @Pc(223)
    int local223 = local24 - Static100.anInt2024;
    @Pc(228)
    int local228 = local15 - Static145.anInt2906;
    @Pc(240)
    int local240 = (int) Math.sqrt((double) (local218 * local218 + local228 * local228));
    @Pc(251)
    int local251 =
        (int) (Math.atan2((double) local223, (double) local240) * 2607.5945876176133D) & 0x3FFF;
    if (local251 < 1024) {
      local251 = 1024;
    }
    @Pc(269)
    int local269 =
        (int) (Math.atan2((double) local218, (double) local228) * -2607.5945876176133D) & 0x3FFF;
    if (local251 > 3072) {
      local251 = 3072;
    }
    if (local251 > Static431.anInt7074) {
      Static431.anInt7074 +=
          Static381.anInt6417 * (local251 - Static431.anInt7074 >> 3) / 1000 + Static222.anInt4125
              << 3;
      if (local251 < Static431.anInt7074) {
    ...
    if (Static431.anInt7074 > local251) {
      Static431.anInt7074 -=
          Static381.anInt6417 * (Static431.anInt7074 - local251 >> 3) / 1000 + Static222.anInt4125
              << 3;
      if (Static431.anInt7074 < local251) {
        Static431.anInt7074 = local251;
      }
    ...
    @Pc(341)
    int local341 = local269 - Static136.anInt2790;
    if (local341 > 8192) {
      local341 -= 16384;
    }
    if (local341 < -8192) {
    ...
    @Pc(407)
    int local407 = local269 - Static136.anInt2790;
    if (local407 > 8192) {
      local407 -= 16384;
    }
    if (local407 < -8192) {
