...
public final class Static198 {
	...
	public static LinkedHashEntry_Sub39 aClass4_Sub39_1;
	...
	public static void method3118() {
		for (@Pc(1) int local1 = 0; local1 < Static43.anInt7322; local1++) {
			if (!Static124.aBooleanArray12[local1]) {
				...
				@Pc(13) LinkedHashEntry_Sub21 local13 = local10.aClass4_Sub21_2;
				...
				for (@Pc(78) int local78 = local53; local78 <= local61; local78++) {
					...
					for (@Pc(125) int local125 = local100; local125 <= local108; local125++) {
						...
						@Pc(141) Class16_Sub1 local141 = Static36.method648(local16, local125, local78, Class16_Sub1.class);
