  ...
  public static void method3118() {
    for (@Pc(1) int local1 = 0; local1 < Static43.anInt7322; local1++) {
      if (!Static124.aBooleanArray12[local1]) {
        @Pc(10)
        Class191 local10 = Static106.aClass191Array1[local1];
        @Pc(13)
        Node_Sub21 local13 = local10.aClass4_Sub21_2;
        @Pc(16)
        int local16 = local10.anInt5570;
        @Pc(22)
        int local22 = local13.method3165() - Static333.anInt5747;
        @Pc(30)
        int local30 = (local22 * 2 >> Static231.anInt4434) + 1;
        @Pc(32)
        int local32 = 0;
        @Pc(37)
        int[] local37 = new int[local30 * local30];
        @Pc(45)
        int local45 = local13.method3160() - local22 >> Static231.anInt4434;
        @Pc(53)
        int local53 = local13.method3164() - local22 >> Static231.anInt4434;
        @Pc(61)
        int local61 = local13.method3164() + local22 >> Static231.anInt4434;
        if (local53 < 0) {
          local32 = -local53;
          local53 = 0;
        }
        ...
        for (@Pc(78) int local78 = local53; local78 <= local61; local78++) {
          @Pc(84)
          short local84 = local10.aShortArray189[local32];
          @Pc(88)
          int local88 = local84 >>> 8;
          @Pc(94)
          int local94 = local32 * local30 + local88;
          @Pc(100)
          int local100 = local45 + (local84 >>> 8);
          @Pc(108)
          int local108 = local100 + (local84 & 0xFF) - 1;
          if (local100 < 0) {
            local94 -= local100;
            local100 = 0;
          }
          ...
          for (@Pc(125) int local125 = local100; local125 <= local108; local125++) {
            ...
            byte local128 = 1;
            @Pc(141)
            Class16_Sub1 local141 =
                Static36.method648(local16, local125, local78, Class16_Sub1.class);
