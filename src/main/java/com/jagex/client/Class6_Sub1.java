...
public class Class6_Sub1 extends Class6 {
  ...
  public Class6_Sub1(
    ...
    if (arg8) {
      @Pc(28)
      byte[] local28 = new byte[arg6.length];
      for (@Pc(30) int local30 = 0; local30 < arg4; local30++) {
        @Pc(36)
        int local36 = arg3 * local30;
        @Pc(45)
        int local45 = (arg4 - local30 - 1) * arg3;
  ...
  public Class6_Sub1(
    ...
    OpenGL.glTexImage2Dub(
        ...
        arg4,
        0,
        Static304.method4122(super.anInt5443),
        5121,
        null,
        0);
    this.method4181(true);
  ...
  public Class6_Sub1(
    ...
    if (arg7) {
      @Pc(28)
      int[] local28 = new int[arg6.length];
      for (@Pc(30) int local30 = 0; local30 < arg4; local30++) {
        @Pc(36)
        int local36 = arg3 * local30;
        @Pc(45)
        int local45 = arg3 * (arg4 - local30 - 1);
        for (@Pc(47) int local47 = 0; local47 < arg3; local47++) {
          local28[local36++] = arg6[local45++];
        }
      }
    ...
    if (arg5 && super.anInt5441 != 34037) {
      Static37.method665(
          ...
          this.anInt5458,
          this.anInt5466,
          super.aClass19_Sub2_31.anInt2307,
          super.anInt5441);
      this.method4185(true);
    } else {
  ...
  protected Class6_Sub1(
    ...
    this.anInt5458 = arg5;
    @Pc(30)
    int local30 = super.aClass19_Sub2_31.anInt2138 - arg3 - arg5;
    super.aClass19_Sub2_31.method1905(this);
  ...
  public final void method4191(
      ...
      @OriginalArg(8) boolean arg4) {
    if (arg4) {
      @Pc(23)
      int local23 = Static9.method92(6406);
      @Pc(27)
      int local27 = local23 * arg0;
      @Pc(31)
      int local31 = local23 * arg0;
      @Pc(36)
      byte[] local36 = new byte[local27 * arg2];
      for (@Pc(38) int local38 = 0; local38 < arg2; local38++) {
        @Pc(44)
        int local44 = local38 * local27;
        @Pc(55)
        int local55 = (arg2 - local38 - 1) * local31;
  ...
  public final void method4193(
    ...
    @Pc(12)
    int local12 = super.aClass19_Sub2_31.anInt2138 - arg4;
    super.aClass19_Sub2_31.method1905(this);
    OpenGL.glCopyTexSubImage2D(
        super.anInt5441, 0, arg2, this.anInt5458 - arg3 - arg4, 0, local12, arg5, arg4);
    OpenGL.glFlush();
  }
  ...
  protected final void method4197(
      @OriginalArg(1) int arg0, @OriginalArg(4) int[] arg1, @OriginalArg(8) int arg2) {
    @Pc(19)
    int[] local19 = new int[arg0 * arg2];
    for (@Pc(21) int local21 = 0; local21 < arg0; local21++) {
      @Pc(27)
      int local27 = local21 * arg2;
      @Pc(39)
      int local39 = arg2 * (arg0 - local21 - 1);
    ...
    OpenGL.glTexSubImage2Di(
        super.anInt5441, 0, 0, 0, arg2, arg0, 32993, super.aClass19_Sub2_31.anInt2307, local19, 0);
    if (arg2 != arg2) {
      OpenGL.glPixelStorei(3314, 0);
    }
  }
