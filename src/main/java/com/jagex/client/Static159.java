...
public final class Static159 {
  ...
  public static int method2696(@OriginalArg(0) int arg0) {
    ...
    int local12 = arg0 >>> 1;
    @Pc(18)
    int local18 = local12 | local12 >>> 1;
    @Pc(24)
    int local24 = local18 | local18 >>> 2;
    @Pc(30)
    int local30 = local24 | local24 >>> 4;
    @Pc(36)
    int local36 = local30 | local30 >>> 8;
    @Pc(42)
    int local42 = local36 | local36 >>> 16;
    return ~local42 & arg0;
  }
  ...
  public static void method2702(@OriginalArg(0) ISAACPacket arg0, @OriginalArg(1) int arg1) {
    @Pc(17)
    boolean local17 = arg0.method1143(1) == 1;
    if (local17) {
      Static388.anIntArray497[Static441.anInt7199++] = arg1;
    }
    @Pc(32)
    int local32 = arg0.method1143(2);
    @Pc(36)
    Class16_Sub1_Sub5_Sub1 local36 = Static267.aClass16_Sub1_Sub5_Sub1Array1[arg1];
    if (local32 != 0) {
      @Pc(155)
      int local155;
      @Pc(160)
      ...
      if (local32 == 1) {
        ...
        if (local155 == 0) {
          ...
          local449 =
              (local427 + Static180.anInt3453 + local36.anIntArray426[0] & 0x3FFF)
                  - Static180.anInt3453;
          local457 =
              (Static86.anInt1771 + local36.anIntArray427[0] + local435 & 0x3FFF)
                  - Static86.anInt1771;
          if (local17) {
            local36.anInt4335 = local449;
            local36.aBoolean401 = true;
      ...
      @Pc(64)
      Class253 local64 = Static306.aClass253Array1[arg1] = new Class253();
      local64.anInt6949 =
          (local36.anIntArray427[0] + Static86.anInt1771 >> 6)
              + (local36.aByte82 << 28)
              + (Static180.anInt3453 + local36.anIntArray426[0] >> 6 << 14);
