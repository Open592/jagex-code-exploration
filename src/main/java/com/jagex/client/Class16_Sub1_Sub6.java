...
public final class Class16_Sub1_Sub6 extends Class16_Sub1 implements Interface6 {
  ...
  private SecondaryNode_Sub1_Sub4 aClass4_Sub1_Sub4_6;

  @OriginalMember(
      owner = "client!vb",
      name = "<init>",
      descriptor = "(Lclient!ya;Lclient!rd;IIIIIZIIIIIIZ)V")
  public Class16_Sub1_Sub6(
    ...
    super(
        ...
        arg11,
        arg1.anInt5818 == 1,
        Static125.method2257(arg13, arg12));
    ...
    @Pc(95)
    Class149 local95 = this.method5361(local80, arg0, this.aBoolean633);
    if (local95 != null) {
  ...
  public void method5337(
    ...
    if (arg2 instanceof Class16_Sub5_Sub2) {
      @Pc(13)
      Class16_Sub5_Sub2 local13 = (Class16_Sub5_Sub2) arg2;
      ...
      @Pc(35)
      Class16_Sub1_Sub6 local35 = (Class16_Sub1_Sub6) arg2;
  ...
  public boolean method5341(
    ...
    @Pc(9)
    Class110 local9 = this.method5357(arg1, 131072);
    if (local9 == null) {
      return false;
    } else {
      @Pc(19)
  ...
  private Class110 method5357(@OriginalArg(0) Class19 arg0, @OriginalArg(2) int arg1) {
    if (this.aClass110_7 != null && arg0.method4269(this.aClass110_7.P(), arg1) == 0) {
      ...
      @Pc(26)
      Class149 local26 = this.method5361(arg1, arg0, false);
  ...
  public void method5348(@OriginalArg(0) Class19 arg0) {
    @Pc(14)
    SecondaryNode_Sub1_Sub4 local14;
    if (this.aClass4_Sub1_Sub4_6 == null && this.aBoolean633) {
      @Pc(25)
      Class149 local25 = this.method5361(262144, arg0, true);
  ...
  private Class149 method5361(
      @OriginalArg(1) int arg0, @OriginalArg(2) Class19 arg1, @OriginalArg(3) boolean arg2) {
    @Pc(18)
    Class202 local18 = Static267.aClass262_2.method5560(this.aShort98 & 0xFFFF);
    @Pc(43)
    Class65 local43;
    @Pc(29)
    Class65 local29;
    ...
    return local18.method4589(
        arg1,
        super.anInt6893,
        arg0,
        super.anInt6889,
        arg2,
        this.aByte86 == 11 ? this.aByte84 + 4 : this.aByte84,
        local29,
        super.anInt6892,
        this.aByte86 == 11 ? 10 : this.aByte86,
        local43);
  }
