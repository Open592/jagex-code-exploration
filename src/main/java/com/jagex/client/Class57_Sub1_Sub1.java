...
public final class Class57_Sub1_Sub1 extends Class57_Sub1 {
  ...
  public Class57_Sub1_Sub1(
    ...
    for (@Pc(19) int local19 = 0; local19 < arg5; local19++) {
      for (@Pc(22) int local22 = 0; local22 < arg4; local22++) {
        @Pc(28)
        int local28 = arg1[arg2++];
        if (local28 >>> 24 == 255) {
          @Pc(37)
          int local37 = local28 & 0xFFFFFF;
          if (local37 == 0) {
              ...
              for (local273 = -arg3; local273 < 0; local273++) {
                ...
                for (local338 = -arg2; local338 < 0; local338++) {
                  ...
                  if (local341 == 0) {
                    ...
                    local252[local64++] =
                        ((local341 & 0xFF00FF) * local262 + (local351 & 0xFF00FF) * local270
                                    & 0xFF00FF00)
                                + ((local341 & 0xFF00) * local262 + (local351 & 0xFF00) * local270
                                    & 0xFF0000)
                            >> 8;
                  }
                  local14 += local44;
              ...
              for (local341 = -arg3; local341 < 0; local341++) {
                ...
                for (local359 = -arg2; local359 < 0; local359++) {
                  ...
                  if (local367 == 0) {
                    ...
                    local252[local64++] =
                        ((local367 & 0xFF00FF) * local330 + (local857 & 0xFF00FF) * local338
                                    & 0xFF00FF00)
                                + ((local367 & 0xFF00) * local330 + (local857 & 0xFF00) * local338
                                    & 0xFF0000)
                            >> 8;
                  }
                  local14 += local44;
            ...
            for (local273 = -arg3; local273 < 0; local273++) {
              ...
              for (local338 = -arg2; local338 < 0; local338++) {
                ...
                if (local341 == 0 && local262 != 255) {
                  ...
                  local367 =
                      ((local341 & 0xFF00FF) * local262 + (local367 & 0xFF00FF) * local270
                                  & 0xFF00FF00)
                              + ((local341 & 0xFF00) * local262 + (local367 & 0xFF00) * local270
                                  & 0xFF0000)
                          >> 8;
                }
          ...
          for (local338 = -arg3; local338 < 0; local338++) {
            ...
            for (local351 = -arg2; local351 < 0; local351++) {
              ...
              if (local359 == 0) {
                ...
                @Pc(1668)
                int local1668 = (local837 & 0x1000100) + (local375 - local837 & 0x10000);
  ...
  public void t(
    ...
    for (@Pc(5) int local5 = 0; local5 < arg3; local5++) {
      @Pc(15)
      int local15 = (arg1 + local5) * super.anInt7168 + arg0;
      @Pc(25)
      int local25 = (arg5 + local5) * super.aClass19_Sub1_11.anInt430 + arg4;
  ...
  public void method5542(
    ...
    for (@Pc(212) int local212 = local171; local212 < local210; local212++) {
      ...
      for (@Pc(304) int local304 = -local227; local304 < 0; local304++) {
        @Pc(311)
        int local311 = this.anIntArray140[local19++];
        if (local311 == 0) {
          local41++;
        } else {
  ...
  public void r(
    ...
    if (arg2 == 0) {
        ...
        for (local506 = -local32; local506 < 0; local506++) {
          for (local617 = -local35; local617 < 0; local617++) {
            ...
            if (local624 == 0) {
              ...
              local160[local27++] =
                  ((local624 & 0xFF00FF) * local492 + (local630 & 0xFF00FF) * local499 & 0xFF00FF00)
                          + ((local624 & 0xFF00) * local492 + (local630 & 0xFF00) * local499
                              & 0xFF0000)
                      >> 8;
            }
          }
          ...
          for (local711 = -local35; local711 < 0; local711++) {
            ...
            if (local718 == 0) {
              ...
              if (local617 == 255) {
                ...
                @Pc(759)
                int local759 = local160[local27];
                local160[local27++] =
                    ((local718 & 0xFF00FF) * local617 + (local759 & 0xFF00FF) * local624
                                & 0xFF00FF00)
                            + ((local718 & 0xFF00) * local617 + (local759 & 0xFF00) * local624
                                & 0xFF0000)
                        >> 8;
              }
            }
      ...
      for (local506 = -local32; local506 < 0; local506++) {
        for (local617 = -local35; local617 < 0; local617++) {
          ...
          if (local624 == 0 && local492 != 255) {
            ...
            local718 =
                ((local624 & 0xFF00FF) * local492 + (local718 & 0xFF00FF) * local499 & 0xFF00FF00)
                        + ((local624 & 0xFF00) * local492 + (local718 & 0xFF00) * local499
                            & 0xFF0000)
                    >> 8;
          }
      ...
      @Pc(996)
      int local996 = (local506 | local617) >>> 8;
              ...
              if (arg0 == 1) {
                ...
                if (local209 != 0) {
                  if ((Static359.anInt7160 & 0xFFFFFF) == 16777215) {
                    ...
                    local3[local51] =
                        ((local209 & 0xFF00FF) * local234 + (local242 & 0xFF00FF) * local238
                                    & 0xFF00FF00)
                                + ((local209 & 0xFF00) * local234 + (local242 & 0xFF00) * local238
                                    & 0xFF0000)
                            >> 8;
                    ...
                    local3[local51] =
                        ((local209 & 0xFF00FF) * Static359.anInt7161
                                        + (local314 & 0xFF00FF) * Static359.anInt7159
                                    & 0xFF00FF00)
                                + ((local209 & 0xFF00) * Static359.anInt7161
                                        + (local314 & 0xFF00) * Static359.anInt7159
                                    & 0xFF0000)
                            >> 8;
                  }
                }
