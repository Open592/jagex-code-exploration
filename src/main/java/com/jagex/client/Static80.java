...
public final class Static80 {
  ...
  public static void method1433() {
    for (@Pc(16) Node_Sub9 local16 = (Node_Sub9) Static115.aLinkedList_15.tail();
        local16 != null;
        local16 = (Node_Sub9) Static115.aLinkedList_15.previous()) {
      ...
      if (local16.anInt796 != 0) {
        ...
        if (local16.anInt799 == 0
            && local16.anInt793 >= 1
            && local16.anInt790 >= 1
            && Static326.anInt5666 - 2 >= local16.anInt793
            && local16.anInt790 <= Static283.anInt5187 - 2
            && (local16.anInt794 < 0 || Static126.method2260(local16.anInt794, local16.anInt801))) {
          Static27.method524(
              local16.anInt800,
              local16.anInt793,
              local16.anInt801,
          ...
          if (local16.anInt797 == local16.anInt794 && local16.anInt797 == -1) {
            local16.popSelf();
          } else if (local16.anInt797 == local16.anInt794
              && local16.anInt804 == local16.anInt803
              && local16.anInt801 == local16.anInt802) {
            local16.popSelf();
          }
        }
