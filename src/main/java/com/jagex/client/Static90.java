...
public final class Static90 {
  ...
  public static void method1606(
      @OriginalArg(0) boolean arg0, @OriginalArg(1) Node_Sub43 arg1, @OriginalArg(2) boolean arg2) {
    @Pc(8)
    int local8 = arg1.anInt6979;
    @Pc(12)
    int local12 = (int) arg1.hashKey;
    arg1.popSelf();
    if (arg0) {
    ...
    @Pc(27)
    Class247 local27 = Static392.method5121(local12);
    if (local27 != null) {
    ...
    @Pc(58)
    Class25 local58 = new Class25(Static325.aHashMap_29);
    for (@Pc(63) Node_Sub43 local63 = (Node_Sub43) local58.method641();
        local63 != null;
        local63 = (Node_Sub43) local58.method640()) {
      if (!local63.hasNext()) {
      ...
      if (local63.anInt6981 == 3) {
        @Pc(85)
        int local85 = (int) local63.hashKey;
  ...
  public static void method1608(@OriginalArg(0) int arg0) {
    @Pc(8)
    SecondaryNode_Sub1_Sub11 local8 = Static405.method5222(arg0, 3);
    local8.method2608();
  }

  @OriginalMember(owner = "client!ek", name = "a", descriptor = "(IILclient!fs;I)Lclient!cn;")
  public static SecondaryNode_Sub1_Sub5 method1609(
      @OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Js5 arg2) {
    @Pc(16)
    Packet local16 = new Packet(arg2.method2104(arg1, arg0));
    @Pc(49)
    SecondaryNode_Sub1_Sub5 local49 =
        new SecondaryNode_Sub1_Sub5(
            arg1,
            local16.gStringCP1252ToUTF8(),
            local16.gStringCP1252ToUTF8(),
            local16.g4(),
            local16.g4(),
            local16.g1() == 1,
            ...
            local16.g1());
    @Pc(53)
    int local53 = local16.g1();
    for (@Pc(55) int local55 = 0; local55 < local53; local55++) {
      local49.aLinkedList_4.addFirst(
          new Node_Sub41(
              local16.g1(),
              local16.g2(),
              local16.g2(),
  ...
  public static void method1610(
    ...
    @Pc(90)
    int local90;
    for (@Pc(74) int local74 = 0;
        local74 < Static230.anInt4431 + Static230.anInt4431 + 2;
        local74++) {
      for (local77 = 0; local77 < Static230.anInt4431 + Static230.anInt4431 + 2; local77++) {
        ...
        if (local84 >= 0
            && local90 >= 0
            && local84 < Static422.anInt6945
            && local90 < Static171.anInt3361) {
          @Pc(104)
          int local104 = local84 << Static231.anInt4434;
          @Pc(108)
          int local108 = local90 << Static231.anInt4434;
          @Pc(124)
          int local124 =
              Static67.aClass65Array1[Static67.aClass65Array1.length - 1].l(local84, local90)
                  - (0x3E8 << Static231.anInt4434 - 7);
          @Pc(144)
          int local144 =
              Static285.aClass65Array3 == null
                  ? Static67.aClass65Array1[0].l(local84, local90) + Static4.anInt5935
                  : Static285.aClass65Array3[0].l(local84, local90) + Static4.anInt5935;
          Static440.aBooleanArrayArray6[local74][local77] =
              Static390.aClass19_37.JA(local104, local124, local108, local104, local144, local108);
        } else {
    ...
    for (local77 = 0; local77 < Static230.anInt4431 + Static230.anInt4431 + 1; local77++) {
      for (local84 = 0; local84 < Static230.anInt4431 + Static230.anInt4431 + 1; local84++) {
        Static252.aBooleanArrayArray4[local77][local84] =
            Static440.aBooleanArrayArray6[local77][local84]
                || Static440.aBooleanArrayArray6[local77 + 1][local84]
                || Static440.aBooleanArrayArray6[local77][local84 + 1]
                || Static440.aBooleanArrayArray6[local77 + 1][local84 + 1];
      }
    }
    ...
    for (@Pc(260) Class3_Sub3 local260 = (Class3_Sub3) Static18.aClass84_2.method2312();
        local260 != null;
        local260 = (Class3_Sub3) Static18.aClass84_2.method2309()) {
      local260.method5676();
