...
public final class Static90 {
	...
	public static void method1608(@OriginalArg(0) int arg0) {
		@Pc(8) Node_Sub1_Sub11 local8 = Static405.method5222(arg0, 3);
		local8.method2608();
	}

	@OriginalMember(owner = "client!ek", name = "a", descriptor = "(IILclient!fs;I)Lclient!cn;")
	public static Node_Sub1_Sub5 method1609(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class76 arg2) {
		@Pc(16) Packet local16 = new Packet(arg2.method2104(arg1, arg0));
		@Pc(49) Node_Sub1_Sub5 local49 = new Node_Sub1_Sub5(arg1, local16.gStringCP1252ToUTF8(), local16.gStringCP1252ToUTF8(), local16.g4(), local16.g4(), local16.g1() == 1, local16.g1(), local16.g1());
