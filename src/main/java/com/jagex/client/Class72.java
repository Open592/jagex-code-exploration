...
public final class Class72 {
  ...
  public void method1985() {
    @Pc(10)
    Class68 local10 = this.aClass68_10;
    synchronized (this.aClass68_10) {
  ...
  public SecondaryNode_Sub1_Sub18 method1988(@OriginalArg(0) int arg0) {
    @Pc(6)
    Class68 local6 = this.aClass68_10;
    @Pc(16)
    SecondaryNode_Sub1_Sub18 local16;
    synchronized (this.aClass68_10) {
      local16 = (SecondaryNode_Sub1_Sub18) this.aClass68_10.method1787((long) arg0);
    }
    if (local16 != null) {
      return local16;
    }
    @Pc(35)
    byte[] local35 = this.aJs5_26.method2104(arg0, 26);
    local16 = new SecondaryNode_Sub1_Sub18();
    if (local35 != null) {
      local16.method4668(new Packet(local35));
    }
    @Pc(51)
    Class68 local51 = this.aClass68_10;
    synchronized (this.aClass68_10) {
