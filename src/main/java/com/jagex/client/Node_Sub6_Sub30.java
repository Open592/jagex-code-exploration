...
public final class Node_Sub6_Sub30 extends Node_Sub6 {

  @OriginalMember(owner = "client!rh", name = "<init>", descriptor = "()V")
  public Node_Sub6_Sub30() {
    super(3, false);
  }
  ...
  public int[] method5510(@OriginalArg(1) int arg0) {
    ...
    if (super.aClass82_41.aBoolean243) {
      ...
      @Pc(41)
      int[] local41 = this.method5508(arg0, 2);
      for (@Pc(43) int local43 = 0; local43 < Static80.anInt1616; local43++) {
        @Pc(49)
        int local49 = local41[local43];
        if (local49 == 4096) {
  ...
  public int[][] method5514(@OriginalArg(1) int arg0) {
    ...
    if (super.aClass153_41.aBoolean437) {
      @Pc(26)
      int[] local26 = this.method5508(arg0, 2);
      @Pc(32)
      int[][] local32 = this.method5516(0, arg0);
      @Pc(38)
      int[][] local38 = this.method5516(1, arg0);
      @Pc(42)
      int[] local42 = local16[0];
      @Pc(46)
      int[] local46 = local16[1];
      @Pc(50)
      int[] local50 = local16[2];
      @Pc(54)
      int[] local54 = local32[0];
      @Pc(58)
      int[] local58 = local32[1];
      @Pc(62)
      int[] local62 = local32[2];
      @Pc(66)
      int[] local66 = local38[0];
      @Pc(70)
      int[] local70 = local38[1];
      @Pc(74)
      int[] local74 = local38[2];
      for (@Pc(76) int local76 = 0; local76 < Static80.anInt1616; local76++) {
        @Pc(82)
        int local82 = local26[local76];
        if (local82 == 4096) {
