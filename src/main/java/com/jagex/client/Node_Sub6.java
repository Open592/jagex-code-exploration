...
public abstract class Node_Sub6 extends Node {
  ...
  public final Node_Sub6[] aClass4_Sub6Array42;

  @OriginalMember(owner = "client!oc", name = "<init>", descriptor = "(IZ)V")
  protected Node_Sub6(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1) {
    this.aBoolean665 = arg1;
    this.aClass4_Sub6Array42 = new Node_Sub6[arg0];
  }
  ...
  protected final int[] method5508(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
    return this.aClass4_Sub6Array42[arg1].aBoolean665
        ? this.aClass4_Sub6Array42[arg1].method5510(arg0)
        : this.aClass4_Sub6Array42[arg1].method5514(arg0)[0];
  }
  ...
  public void method5513(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
    @Pc(20)
    int local20 = this.anInt7106 == 255 ? arg0 : this.anInt7106;
    if (this.aBoolean665) {
  ...
  protected final int[][] method5516(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
    if (this.aClass4_Sub6Array42[arg0].aBoolean665) {
      @Pc(30)
      int[] local30 = this.aClass4_Sub6Array42[arg0].method5510(arg1);
