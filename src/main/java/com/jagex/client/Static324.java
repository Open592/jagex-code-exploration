...
public final class Static324 {
  ...
  public static void method4384() {
    if (SignLink.anInt1987 == 2) {
      Static70.anInt1503 = 96;
      return;
    }
    try {
      @Pc(26)
      Method local26 = Runtime.class.getMethod("maxMemory");
      if (local26 != null) {
        try {
          @Pc(30)
          Runtime local30 = Runtime.getRuntime();
          @Pc(36)
          Long local36 = (Long) local26.invoke(local30, (Object[]) null);
  ...
  public static boolean method4385(
      @OriginalArg(0) Class16_Sub1 arg0, @OriginalArg(1) boolean arg1) {
    @Pc(6)
    boolean local6 = Static417.aClass65Array4 == Static285.aClass65Array3;
    @Pc(8)
    int local8 = 0;
    @Pc(10)
    byte local10 = 0;
    ...
    if (arg0.aShort94 < 0
        || arg0.aShort96 < 0
        || arg0.aShort97 >= Static422.anInt6945
        || arg0.aShort95 >= Static171.anInt3361) {
      return false;
    }
    @Pc(38)
    int local38;
    for (@Pc(34) int local34 = arg0.aShort94; local34 <= arg0.aShort97; local34++) {
      for (local38 = arg0.aShort96; local38 <= arg0.aShort95; local38++) {
        @Pc(45)
        Class164 local45 = Static341.method5175(arg0.aByte82, local34, local38);
        if (local45 != null) {
          @Pc(49)
          int local49 = 0;
          ...
          @Pc(74)
          Class7 local74 = Static83.method1513(local49, arg0);
          @Pc(77)
          Class7 local77 = local45.aClass7_3;
          if (local77 == null) {
  ...
  public static void method4387(@OriginalArg(0) Class57[] arg0) {
    ...
    for (@Pc(41) int local41 = Static277.anInt5150;
        local41 < Static385.aClass57Array16.length;
        local41++) {
