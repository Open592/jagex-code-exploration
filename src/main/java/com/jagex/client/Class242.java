...
public final class Class242 {
  ...
  public boolean method5248(@OriginalArg(1) int arg0, @OriginalArg(2) Class19 arg1) {
    ...
    if (this.anInt6716 != arg0) {
      this.anInt6716 = arg0;
      @Pc(20)
      int local20 = Static370.method4949(arg0);
      if (local20 > arg0) {
      ...
      if (this.aClass5Array1 != null) {
        this.anInt6712 = 0;
        @Pc(55)
        int[] local55 = new int[this.aClass5Array1.length];
        for (local57 = 0; local57 < this.aClass5Array1.length; local57++) {
          @Pc(64)
          Class5 local64 = this.aClass5Array1[local57];
    ...
    if (this.aBoolean606) {
      ...
      for (local57 = this.anInt6712 - 1; local57 >= 0; local57--) {
        @Pc(143)
        boolean local143 = this.aClass5Array2[local57].method39(arg1, this.aClass5_1);
  ...
  public void method5255(
    ...
    @Pc(12)
    int local12 = arg3 + arg0 & 0x3FFF;
    if (this.anInt6721 == -1) {
      arg5.O(arg1, arg2, arg6, arg8, arg7, 0);
    } else {
      @Pc(32)
      Class251 local32 = Static402.anInterface7_8.method2396(this.anInt6721);
      if (this.aClass57_24 == null && Static402.anInterface7_8.method2392(this.anInt6721)) {
        @Pc(70)
        int[] local70 =
            local32.aBoolean640
                ? Static402.anInterface7_8.method2393(
                    false, this.anInt6721, 0.7F, this.anInt6714, this.anInt6714)
                : Static402.anInterface7_8.method2395(
                    this.anInt6721, 0.7F, this.anInt6714, this.anInt6714);
      ...
      if (this.aClass57_24 != null) {
        @Pc(103)
        int local103 = local32.aBoolean640 ? 0 : 1;
        @Pc(109)
        int local109 = arg4 * arg8 / -4096;
        @Pc(121)
        int local121;
        for (local121 = (arg6 - arg8) / 2 + arg8 * local12 / 4096;
            local121 > arg8;
            local121 -= arg8) {}
        while (local121 < 0) {
          local121 += arg8;
