...
public final class Class157 {
  ...
  public String method3777(@OriginalArg(1) String arg0, @OriginalArg(2) int arg1) {
    if (this.aHashMap_24 == null) {
      return arg0;
    } else {
      @Pc(23)
      Node_Sub7 local23 = (Node_Sub7) this.aHashMap_24.get((long) arg1);
  ...
  public int method3779(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
    if (this.aHashMap_24 == null) {
      ...
      @Pc(16)
      Node_Sub37 local16 = (Node_Sub37) this.aHashMap_24.get((long) arg1);
  ...
  public Class57 method3780(@OriginalArg(1) Class19 arg0) {
    ...
    Class57 local20 =
        (Class57)
            this.aClass182_2.aClass68_34.method1787(
                (long) (this.anInt4912 | 0x20000 | arg0.anInt5532 << 29));
    if (local20 != null) {
      return local20;
    }
    this.aClass182_2.aJs5_63.method2125(this.anInt4912);
    @Pc(45)
    Class18 local45 = Static456.method318(this.aClass182_2.aJs5_63, this.anInt4912, 0);
    if (local45 != null) {
      local20 = arg0.method4308(local45);
      this.aClass182_2.aClass68_34.method1779(
          (long) (arg0.anInt5532 << 29 | this.anInt4912 | 0x20000), local20);
    }
    return local20;
  }
              ...
              if (arg1 != 18) {
                if (arg1 == 19) {
                  ...
                  if (this.aHashMap_24 == null) {
                    ...
                    this.aHashMap_24 = new HashMap(local196);
                  }
                  for (local196 = 0; local196 < local189; local196++) {
                    @Pc(215)
                    boolean local215 = arg0.g1() == 1;
                    @Pc(219)
                    int local219 = arg0.g3();
                    @Pc(228)
                    Node local228;
                    if (local215) {
                    ...
                    this.aHashMap_24.set((long) local219, local228);
                  }
                  return;
                }
                return;
  ...
  public Class57 method3785(@OriginalArg(0) Class19 arg0, @OriginalArg(1) boolean arg1) {
    @Pc(11)
    int local11 = arg1 ? this.anInt4913 : this.anInt4930;
    @Pc(18)
    int local18 = local11 | arg0.anInt5532 << 29;
    @Pc(32)
    Class57 local32 = (Class57) this.aClass182_2.aClass68_34.method1787((long) local18);
    if (local32 != null) {
      return local32;
    } else if (this.aClass182_2.aJs5_63.method2125(local11)) {
      @Pc(52)
      Class18 local52 = Static456.method318(this.aClass182_2.aJs5_63, local11, 0);
      if (local52 != null) {
