...
public final class Static368 {
  ...
  public static final LocalizedString A_LOCALIZED_STRING___124 =
      new LocalizedString(
  ...
  public static void method4938(@OriginalArg(0) int arg0) {
    ...
    if (arg0 != -1) {
      @Pc(30)
      Class74 local30 = Static118.aClass172_2.method3977(arg0);
      @Pc(34)
      Class18 local34 = local30.method2061();
      if (local34 == null) {
        arg0 = -1;
      } else {
        GameShell.signLink.emitSetCustomCursorMessage(
            GameShell.canvas,
            local34.method324(),
            local34.method325(),
            local34.method319(),
            new Point(local30.anInt2420, local30.anInt2419));
