...
public final class Static407 {
  ...
  public static void method5247(
    ...
    if (Static202.aClass164ArrayArrayArray5 == null) {
    ...
    } else if (Static1.aClass16_Sub1_Sub5_Sub1_1.anInt6893 >= 0
        && Static326.anInt5666 * 128 > Static1.aClass16_Sub1_Sub5_Sub1_1.anInt6893
        && Static1.aClass16_Sub1_Sub5_Sub1_1.anInt6892 >= 0
        && Static1.aClass16_Sub1_Sub5_Sub1_1.anInt6892 < Static283.anInt5187 * 128) {
      Static361.anInt6264++;
      if (Static1.aClass16_Sub1_Sub5_Sub1_1 != null
          && Static1.aClass16_Sub1_Sub5_Sub1_1.anInt6893
                      - (Static1.aClass16_Sub1_Sub5_Sub1_1.method4751() - 1) * 64
                  >> 7
              == Static343.anInt771
      ...
      GameShell.method878(arg3, arg1, arg0, true, arg4);
      @Pc(113)
      int local113 = Static329.anInt5685;
      @Pc(115)
      int local115 = Static119.anInt2527;
      @Pc(117)
      int local117 = Static120.anInt2574;
      @Pc(119)
      int local119 = Static120.anInt2600;
      @Pc(127)
      int local127;
      @Pc(164)
      int local164;
      if (Static111.anInt2386 == 1) {
        ...
        Static195.method3072(
            ...
            Static325.anInt5636,
            local164,
            Static13.method135(Static428.anInt7059, Static263.anInt4963, Static452.anInt7360) - 50,
            local115,
            local127);
      ...
      @Pc(276)
      int local276 = Static145.anInt2906;
      @Pc(278)
      int local278 = Static431.anInt7074;
      @Pc(280)
      int local280 = Static136.anInt2790;
      @Pc(323)
      int local323;
      for (@Pc(282) int local282 = 0; local282 < 5; local282++) {
        if (Static342.aBooleanArray17[local282]) {
          local323 =
              (int)
                  (Math.random() * (double) (Static105.anIntArray161[local282] * 2 + 1)
                      - (double) Static105.anIntArray161[local282]
                      + Math.sin(
                              (double) Static61.anIntArray65[local282]
                                  / 100.0D
                                  * (double) Static390.anIntArray486[local282])
                          * (double) Static41.anIntArray46[local282]);
          if (local282 == 3) {
      ...
      if (Static10.aClass242_1 == null) {
        ...
        Static10.aClass242_1.method5255(
            Static100.anInt2023 << 3,
            local119,
            local117,
            Static136.anInt2790,
            Static431.anInt7074,
      ...
      Static111.aClass31_1.s(
          Static163.anInt3197,
          Static100.anInt2024,
          Static145.anInt2906,
          -Static431.anInt7074 & 0x3FFF,
          -Static136.anInt2790 & 0x3FFF,
          -Static103.anInt2070 & 0x3FFF);
      Static122.aClass19_16.ea(Static111.aClass31_1);
      Static122.aClass19_16.H(
          local113 / 2 + local119,
          local117 + local115 / 2,
          Static219.anInt6458 << 1,
          Static219.anInt6458 << 1);
      Static100.method1772(
          Static219.anInt6458 << 1,
          local113 / 2 + local119,
          local115 / 2 + local117,
          Static219.anInt6458 << 1);
      Static446.method5621(
          -Static136.anInt2790 & 0x3FFF,
          -Static103.anInt2070 & 0x3FFF,
          Static163.anInt3197,
          Static145.anInt2906,
      ...
      @Pc(548)
      byte local548 =
          ClientPreferences.preferences.method2858(Static177.anInt2973) == 2
              ? (byte) Static361.anInt6264
              : 1;
      Static90.method1610(
          Static122.aClass19_16,
          ...
          Static100.anInt2024,
          Static145.anInt2906,
          Static12.aByteArrayArrayArray1,
          Static306.anIntArray360,
          Static21.anIntArray19,
          Static443.anIntArray549,
          Static316.anIntArray376,
          Static52.anIntArray53,
          Static1.aClass16_Sub1_Sub5_Sub1_1.aByte82 + 1,
          local548,
          Static1.aClass16_Sub1_Sub5_Sub1_1.anInt6893 >> 7,
          Static1.aClass16_Sub1_Sub5_Sub1_1.anInt6892 >> 7,
          !ClientPreferences.preferences.aBoolean295);
      Static159.method2701();
      ...
      if (Static439.aBoolean676 && client.js5NetQueue.getUrgentRequestCount() == 0) {
  ...
  public static void method5249(
    ...
    @Pc(18)
    int local18 = (arg0 + arg3) / 2;
    @Pc(20)
    int local20 = arg0;
    @Pc(24)
    Class78_Sub1 local24 = Static392.aClass78_Sub1Array1[local18];
    ...
    for (@Pc(36) int local36 = arg0; local36 < arg3; local36++) {
      if (Static308.method4155(
              arg5, Static392.aClass78_Sub1Array1[local36], arg2, local24, arg1, arg4)
          <= 0) {
        @Pc(56)
        Class78_Sub1 local56 = Static392.aClass78_Sub1Array1[local36];
  ...
  public static void method5254(@OriginalArg(0) double arg0) {
    ...
    for (@Pc(7) int local7 = 0; local7 < 256; local7++) {
      @Pc(19)
      int local19 = (int) (Math.pow((double) local7 / 255.0D, arg0) * 255.0D);
