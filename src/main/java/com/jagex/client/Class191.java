...
public final class Class191 {
  ...
  public Node_Sub21 aClass4_Sub21_2;
  ...
  public Class191(
      @OriginalArg(0) Class19 arg0, @OriginalArg(1) Packet arg1, @OriginalArg(2) int arg2) {
    if (Static119.anIntArray169 == null) {
      Static244.method2568();
    }
    this.anInt5570 = arg1.g1();
    this.aBoolean499 = (this.anInt5570 & 0x8) != 0;
    this.aBoolean500 = (this.anInt5570 & 0x10) != 0;
    this.anInt5570 &= 0x7;
    @Pc(50)
    int local50 = arg1.g2() << arg2;
    @Pc(56)
    int local56 = arg1.g2() << arg2;
    @Pc(62)
    int local62 = arg1.g2() << arg2;
    @Pc(66)
    int local66 = arg1.g1();
    @Pc(72)
    int local72 = local66 * 2 + 1;
    this.aShortArray189 = new short[local72];
    @Pc(89)
    int local89;
    for (@Pc(78) int local78 = 0; local78 < this.aShortArray189.length; local78++) {
      @Pc(85)
      short local85 = (short) arg1.g2();
      local89 = local85 >>> 8;
      @Pc(93)
      int local93 = local85 & 0xFF;
      if (local72 <= local89) {
        local89 = local72 - 1;
      }
    ...
    int local160 =
        Static72.anIntArray115 == null
            ? Static335.anIntArray423[Static82.method1470(arg1.g2()) & 0xFFFF]
            : Static72.anIntArray115[arg1.g2()];
    local89 = arg1.g1();
  ...
  public void method4332(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1) {
    ...
    if (arg1) {
      ...
      @Pc(28)
      int local28 = arg0 * this.anInt5568 / 50 + this.anInt5566 & 0x7FF;
      @Pc(31)
    ...
    this.aClass4_Sub21_2.method3158(
        (float) (this.anInt5565 + (this.anInt5561 * local14 >> 11)) / 2048.0F);
  }

  @OriginalMember(owner = "client!qc", name = "a", descriptor = "(B)V")
  private void method4333() {
    @Pc(12)
    int local12 = this.anInt5562;
    if (local12 == 2) {
      this.anInt5565 = 0;
      this.anInt5567 = 1;
      this.anInt5561 = 2048;
