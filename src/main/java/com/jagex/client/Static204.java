...
public final class Static204 {
  ...
  public static int method3185(
      @OriginalArg(1) boolean arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
    @Pc(10)
    Node_Sub25 local10 = Static175.method2834(false, arg1);
    if (local10 == null) {
      return 0;
    }
    @Pc(16)
    ...
    for (@Pc(23) int local23 = 0; local23 < local10.anIntArray230.length; local23++) {
      if (local10.anIntArray230[local23] >= 0
          && local10.anIntArray230[local23] < Static444.aClass206_3.anInt5987) {
        @Pc(49)
        Class211 local49 = Static444.aClass206_3.method4703(local10.anIntArray230[local23]);
        @Pc(59)
        int local59 = local49.method4781(arg2, Static153.aClass180_1.method4121(arg2).anInt4123);
        if (arg0) {
  ...
  public static Class99 method3186(
    ...
    long local38 =
        (long) arg2 * 76724863L
            ...
            ^ (long) arg1 * 475427L;
    @Pc(44)
    Class99 local44 = (Class99) Static406.aClass68_51.method1787(local38);
    if (local44 == null) {
