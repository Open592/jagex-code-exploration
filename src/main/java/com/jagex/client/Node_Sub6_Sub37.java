...
public final class Node_Sub6_Sub37 extends Node_Sub6 {
  ...
  public void method5518(@OriginalArg(1) int arg0, @OriginalArg(2) Packet arg1) {
    if (arg0 == 0) {
      this.anInt7001 = arg1.g2();
    } else if (arg0 == 1) {
      this.aBoolean658 = arg1.g1() == 1;
    }
  }
  ...
  public int[][] method5514(@OriginalArg(1) int arg0) {
    ...
    if (super.aClass153_41.aBoolean437) {
      @Pc(30)
      int[] local30 = this.method5508(Static211.anInt3929 & arg0 - 1, 0);
      @Pc(36)
      int[] local36 = this.method5508(arg0, 0);
      @Pc(46)
      int[] local46 = this.method5508(Static211.anInt3929 & arg0 + 1, 0);
      @Pc(50)
      int[] local50 = local11[0];
      @Pc(54)
      int[] local54 = local11[1];
      @Pc(58)
      int[] local58 = local11[2];
      for (@Pc(60) int local60 = 0; local60 < Static80.anInt1616; local60++) {
        @Pc(73)
        int local73 = (local46[local60] - local30[local60]) * this.anInt7001;
        @Pc(92)
        int local92 =
            (local36[local60 + 1 & Static203.anInt3883]
                    - local36[Static203.anInt3883 & local60 - 1])
                * this.anInt7001;
        @Pc(96)
        int local96 = local92 >> 12;
        @Pc(100)
        int local100 = local73 >> 12;
        @Pc(106)
        int local106 = local96 * local96 >> 12;
        @Pc(112)
        int local112 = local100 * local100 >> 12;
        @Pc(127)
        int local127 =
            (int) (Math.sqrt((double) ((float) (local106 + local112 + 4096) / 4096.0F)) * 4096.0D);
        @Pc(133)
        int local133;
        @Pc(131)
        int local131;
