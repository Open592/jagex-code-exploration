...
public final class LinkedHashEntry_Sub15_Sub1 extends LinkedHashEntry_Sub15 {
	...
	private LinkedHashEntry_Sub30 aClass4_Sub30_1;
	...
	private final LinkedHashEntry_Sub28[][] aClass4_Sub28ArrayArray1 = new LinkedHashEntry_Sub28[16][128];
	...
	private final LinkedHashEntry_Sub28[][] aClass4_Sub28ArrayArray2 = new LinkedHashEntry_Sub28[16][128];
	...
	private final LinkedHashEntry_Sub15_Sub4 aClass4_Sub15_Sub4_1 = new LinkedHashEntry_Sub15_Sub4(this);

	@OriginalMember(owner = "client!dv", name = "J", descriptor = "Lclient!ib;")
	private final LinkedHashMapIterator aLinkedHashMap_Iterator_8 = new LinkedHashMapIterator(128);

	@OriginalMember(owner = "client!dv", name = "<init>", descriptor = "()V")
	public LinkedHashEntry_Sub15_Sub1() {
		this.method1447();
	...
	private void method1421(@OriginalArg(1) int arg0) {
		for (@Pc(8) LinkedHashEntry_Sub28 local8 = (LinkedHashEntry_Sub28) this.aClass4_Sub15_Sub4_1.aClass183_44.method4140(); local8 != null; local8 = (LinkedHashEntry_Sub28) this.aClass4_Sub15_Sub4_1.aClass183_44.method4144()) {
	...
	private void method1424(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		if ((this.anIntArray133[arg0] & 0x2) != 0) {
			for (@Pc(28) LinkedHashEntry_Sub28 local28 = (LinkedHashEntry_Sub28) this.aClass4_Sub15_Sub4_1.aClass183_44.method4139(); local28 != null; local28 = (LinkedHashEntry_Sub28) this.aClass4_Sub15_Sub4_1.aClass183_44.method4145()) {
		...
		@Pc(115) LinkedHashEntry_Sub38 local115 = (LinkedHashEntry_Sub38) this.aLinkedHashMap_Iterator_8.get((long) this.anIntArray122[arg0]);
		if (local115 == null) {
			return;
		}
		@Pc(123) LinkedHashEntry_Sub4_Sub1 local123 = local115.aClass4_Sub4_Sub1Array1[arg1];
		if (local123 == null) {
			return;
		}
		@Pc(130) LinkedHashEntry_Sub28 local130 = new LinkedHashEntry_Sub28();
		...
		if (local130.anInt4385 >= 0) {
			@Pc(288) LinkedHashEntry_Sub28 local288 = this.aClass4_Sub28ArrayArray2[arg0][local130.anInt4385];
	...
	private synchronized void method1426(@OriginalArg(0) LinkedHashEntry_Sub30 arg0, @OriginalArg(1) boolean arg1, @OriginalArg(3) boolean arg2) {
	...
	@Override
	public synchronized LinkedHashEntry_Sub15 method4860() {
	...
	private void method1429(@OriginalArg(1) int arg0) {
		for (@Pc(19) LinkedHashEntry_Sub28 local19 = (LinkedHashEntry_Sub28) this.aClass4_Sub15_Sub4_1.aClass183_44.method4140(); local19 != null; local19 = (LinkedHashEntry_Sub28) this.aClass4_Sub15_Sub4_1.aClass183_44.method4144()) {
	...
	public boolean method1430(@OriginalArg(1) LinkedHashEntry_Sub28 arg0) {
	...
	private int method1435(@OriginalArg(0) LinkedHashEntry_Sub28 arg0) {
	...
	public void method1436(@OriginalArg(0) boolean arg0, @OriginalArg(2) LinkedHashEntry_Sub28 arg1) {
	...
	public synchronized void method1438() {
		for (@Pc(15) LinkedHashEntry_Sub38 local15 = (LinkedHashEntry_Sub38) this.aLinkedHashMap_Iterator_8.head(); local15 != null; local15 = (LinkedHashEntry_Sub38) this.aLinkedHashMap_Iterator_8.nextEntry()) {
			local15.method4393();
		}
	}

	@OriginalMember(owner = "client!dv", name = "a", descriptor = "(Lclient!lm;I)I")
	private int method1439(@OriginalArg(0) LinkedHashEntry_Sub28 arg0) {
	...
	private void method1446(@OriginalArg(1) int arg0) {
		...
		for (@Pc(26) LinkedHashEntry_Sub28 local26 = (LinkedHashEntry_Sub28) this.aClass4_Sub15_Sub4_1.aClass183_44.method4140(); local26 != null; local26 = (LinkedHashEntry_Sub28) this.aClass4_Sub15_Sub4_1.aClass183_44.method4144()) {
	...
	@Override
	public synchronized LinkedHashEntry_Sub15 method4857() {
		return null;
	}

	@OriginalMember(owner = "client!dv", name = "a", descriptor = "(Lclient!lm;[IIZI)Z")
	public boolean method1449(@OriginalArg(0) LinkedHashEntry_Sub28 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3) {
	...
	public synchronized void method1450(@OriginalArg(0) boolean arg0, @OriginalArg(2) LinkedHashEntry_Sub30 arg1) {
	...
	private void method1451(@OriginalArg(1) int arg0) {
		...
		for (@Pc(18) LinkedHashEntry_Sub28 local18 = (LinkedHashEntry_Sub28) this.aClass4_Sub15_Sub4_1.aClass183_44.method4140(); local18 != null; local18 = (LinkedHashEntry_Sub28) this.aClass4_Sub15_Sub4_1.aClass183_44.method4144()) {
	...
	private void method1452(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
		@Pc(12) LinkedHashEntry_Sub28 local12 = this.aClass4_Sub28ArrayArray1[arg0][arg2];
		if (local12 == null) {
			return;
		}
		...
		for (@Pc(49) LinkedHashEntry_Sub28 local49 = (LinkedHashEntry_Sub28) this.aClass4_Sub15_Sub4_1.aClass183_44.method4140(); local49 != null; local49 = (LinkedHashEntry_Sub28) this.aClass4_Sub15_Sub4_1.aClass183_44.method4144()) {
	...
	private int method1454(@OriginalArg(1) LinkedHashEntry_Sub28 arg0) {
	...
	public synchronized boolean method1456(@OriginalArg(1) Class171 arg0, @OriginalArg(3) Class76 arg1, @OriginalArg(4) LinkedHashEntry_Sub30 arg2) {
		arg2.method3726();
		@Pc(9) boolean local9 = true;
		@Pc(20) int[] local20 = new int[] { 22050 };
		for (@Pc(26) LinkedHashEntry_Sub19 local26 = (LinkedHashEntry_Sub19) arg2.aLinkedHashMap_Iterator_23.head(); local26 != null; local26 = (LinkedHashEntry_Sub19) arg2.aLinkedHashMap_Iterator_23.nextEntry()) {
			@Pc(32) int local32 = (int) local26.hashKey;
			@Pc(40) LinkedHashEntry_Sub38 local40 = (LinkedHashEntry_Sub38) this.aLinkedHashMap_Iterator_8.get((long) local32);
			if (local40 == null) {
