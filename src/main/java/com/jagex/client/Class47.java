...
public final class Class47 {
  ...
  public boolean method1248() {
    if (this.aClass19_Sub2_8.aBoolean191
        && this.aClass19_Sub2_8.aBoolean214
        && this.aClass210_2 == null) {
      @Pc(26)
      Class267 local26 =
          Static325.method4397(
              this.aClass19_Sub2_8,
              35632,
  ...
  public boolean method1250(
      ...
      @OriginalArg(1) Class6_Sub3 arg1,
      @OriginalArg(3) Class6_Sub3 arg2) {
    if (!this.method1248()) {
      return false;
    }
    @Pc(15)
    Class150 local15 = this.aClass19_Sub2_8.aClass150_2;
    @Pc(26)
    SecondaryNode_Sub1_Sub13 local26 =
        new SecondaryNode_Sub1_Sub13(this.aClass19_Sub2_8, 6408, arg2.anInt833, arg2.anInt841);
    ...
    if (local15.method3616()) {
      ...
      OpenGL.glUniform1iARB(
          OpenGL.glGetUniformLocationARB(this.aClass210_2.aLong202, "heightMap"), 0);
      OpenGL.glUniform1fARB(
          OpenGL.glGetUniformLocationARB(this.aClass210_2.aLong202, "rcpRelief"), 1.0F / arg0);
      OpenGL.glUniform2fARB(
          OpenGL.glGetUniformLocationARB(this.aClass210_2.aLong202, "sampleSize"),
          1.0F / (float) arg1.anInt833,
          1.0F / (float) arg1.anInt841);
      for (@Pc(107) int local107 = 0; local107 < arg2.anInt835; local107++) {
        @Pc(116)
        float local116 = (float) local107 / (float) arg2.anInt835;
