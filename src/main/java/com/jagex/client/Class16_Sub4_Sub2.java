...
public final class Class16_Sub4_Sub2 extends Class16_Sub4 implements Interface6 {
  ...
  @OriginalMember(
      owner = "client!ft",
      name = "<init>",
      descriptor = "(Lclient!ya;Lclient!rd;IIIIIZII)V")
  public Class16_Sub4_Sub2(
  ...
  public boolean method5341(
    ...
    @Pc(16)
    Class110 local16 =
        this.aClass23_1.method578(super.anInt3647, false, arg1, super.anInt3646, 131072, false);
    if (local16 == null) {
      return false;
    } else {
      @Pc(27)
  ...
  public void method5335(@OriginalArg(0) Class19 arg0) {
    @Pc(23)
    Class110 local23 =
        this.aClass23_1.method578(super.anInt3647, true, arg0, super.anInt3646, 262144, true);
    if (local23 != null) {
      @Pc(30)
      int local30 = super.anInt3646 >> 7;
      @Pc(35)
      int local35 = super.anInt3647 >> 7;
  ...
  public Class3_Sub3 method5339(@OriginalArg(0) Class19 arg0) {
    @Pc(16)
    Class110 local16 =
        this.aClass23_1.method578(super.anInt3647, true, arg0, super.anInt3646, 2048, false);
    if (local16 == null) {
      return null;
    }
    @Pc(23)
    ...
    if (this.aClass23_1.aClass3_Sub2_1 == null) {
      ...
      @Pc(49)
      Class146 local49 = this.aClass23_1.aClass3_Sub2_1.method171();
      arg0.method4262(
          local16, local49, local23, local33 == null ? null : local33.aClass3_Sub5Array1[0]);
    }
    @Pc(82)
    int local82 = super.anInt3646 >> 7;
    @Pc(94)
    int local94 = super.anInt3647 >> 7;
