...
public final class Class16_Sub2_Sub1 extends Class16_Sub2 implements Interface6 {
  ...
  private SecondaryNode_Sub1_Sub4 aClass4_Sub1_Sub4_1;

  @OriginalMember(
      owner = "client!bh",
      name = "<init>",
      descriptor = "(Lclient!ya;Lclient!rd;IIIIZIIIII)V")
  ...
  public void method5349(@OriginalArg(1) Class19 arg0) {
    ...
    if (this.aClass4_Sub1_Sub4_1 == null && this.aBoolean50) {
      @Pc(25)
      Class149 local25 = this.method572(262144, true, arg0);
  ...
  private Class149 method572(
      @OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1, @OriginalArg(3) Class19 arg2) {
    @Pc(18)
    Class202 local18 = Static267.aClass262_2.method5560(this.aShort10 & 0xFFFF);
    @Pc(26)
    Class65 local26;
    @Pc(30)
    Class65 local30;
  ...
  public void method5348(@OriginalArg(0) Class19 arg0) {
    ...
    if (this.aClass4_Sub1_Sub4_1 == null && this.aBoolean50) {
      @Pc(31)
      Class149 local31 = this.method572(262144, true, arg0);
  ...
  public boolean method5341(
    ...
    @Pc(13)
    Class110 local13 = this.method574(131072, arg1);
    if (local13 == null) {
      return false;
    } else {
      @Pc(18)
  ...
  private Class110 method574(@OriginalArg(0) int arg0, @OriginalArg(1) Class19 arg1) {
    if (this.aClass110_2 != null && arg1.method4269(this.aClass110_2.P(), arg0) == 0) {
      ...
      @Pc(33)
      Class149 local33 = this.method572(arg0, false, arg1);
  ...
  public Class3_Sub3 method5339(@OriginalArg(0) Class19 arg0) {
    ...
    local16.j(
        super.anInt4566 + super.anInt4550, super.anInt4559, super.anInt4551 + super.anInt4552);
    @Pc(32)
    Class3_Sub3 local32 = null;
    if (this.aBoolean51) {
