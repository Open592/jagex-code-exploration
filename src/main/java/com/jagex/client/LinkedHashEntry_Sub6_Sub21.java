...
public final class LinkedHashEntry_Sub6_Sub21 extends LinkedHashEntry_Sub6 {

	@OriginalMember(owner = "client!lc", name = "H", descriptor = "I")
	private int anInt4099;

	@OriginalMember(owner = "client!lc", name = "<init>", descriptor = "(I)V")
	public LinkedHashEntry_Sub6_Sub21(@OriginalArg(0) int arg0) {
		super(0, true);
		this.anInt4099 = 4096;
		this.anInt4099 = arg0;
	}
	...
	public LinkedHashEntry_Sub6_Sub21() {
		this(4096);
	}
