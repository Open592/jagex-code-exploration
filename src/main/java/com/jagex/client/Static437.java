...
public final class Static437 {
  ...
  public static int stringToInt(@OriginalArg(1) int base, @OriginalArg(3) String input) {
    ...
    int local30 = 0;
    @Pc(33)
    int local33 = input.length();
    for (@Pc(35) int local35 = 0; local35 < local33; local35++) {
      @Pc(41)
      char local41 = input.charAt(local35);
      if (local35 == 0) {
        if (local41 == '-') {
          local26 = true;
          continue;
      ...
      @Pc(111)
      int local111 = local67 + local30 * base;
  ...
  public static String method4044(
      @OriginalArg(0) String arg0, @OriginalArg(2) String arg1, @OriginalArg(3) String arg2) {
    for (@Pc(14) int local14 = arg2.indexOf(arg1);
        local14 != -1;
        local14 = arg2.indexOf(arg1, arg0.length() + local14)) {
