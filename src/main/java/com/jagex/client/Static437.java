...
public final class Static437 {
	...
	public static void method4042() {
		...
		@Pc(99) LinkedEntry_Sub5 local99 = (LinkedEntry_Sub5) Static413.aClass183_47.method4140();
		@Pc(119) int local119;
		@Pc(140) int local140;
		@Pc(159) int local159;
		...
		if (local99 != null || MonotonicClock.getCurrentTimeInMilliseconds() - 2000L > Static292.aLong177) {
			...
			for (@Pc(124) LinkedEntry_Sub5 local124 = (LinkedEntry_Sub5) Static348.aClass183_42.method4140(); local124 != null && Static3.aClass4_Sub12_Sub1_5.pos - local119 < 240; local124 = (LinkedEntry_Sub5) Static348.aClass183_42.method4144()) {
				local124.popSelf();
		...
		while (true) {
			@Pc(1462) LinkedEntry_Sub34 local1462;
			@Pc(1467) Class247 local1467;
			do {
				local1462 = (LinkedEntry_Sub34) Static237.aClass183_52.method4136();
				if (local1462 == null) {
					while (true) {
						do {
							local1462 = (LinkedEntry_Sub34) Static39.aClass183_3.method4136();
							if (local1462 == null) {
								while (true) {
									do {
										local1462 = (LinkedEntry_Sub34) Static291.aClass183_35.method4136();
										if (local1462 == null) {
