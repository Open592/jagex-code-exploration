...
public final class Node_Sub6_Sub24 extends Node_Sub6 {
  ...
  public int[] method5510(@OriginalArg(1) int arg0) {
    ...
    if (super.aClass82_41.aBoolean243) {
      ...
      @Pc(33)
      int local33;
      for (local33 = Static165.anIntArray209[arg0] + this.anInt4809;
          local33 < 0;
          local33 += 4096) {}
      while (local33 > 4096) {
        local33 -= 4096;
      ...
      @Pc(70)
      int local70 = local25 - 1;
      @Pc(78)
      boolean local78 = (local25 & 0x1) == 0;
      @Pc(83)
      int local83 = this.anIntArray313[local25];
      @Pc(90)
      int local90 = this.anIntArray313[local25 - 1];
      if (local33 > local90 + this.anInt4795 && local33 < local83 - this.anInt4795) {
        for (@Pc(108) int local108 = 0; local108 < Static80.anInt1616; local108++) {
          @Pc(119)
          int local119 = local78 ? this.anInt4802 : -this.anInt4802;
          @Pc(121)
          int local121 = 0;
          @Pc(132)
          int local132;
          for (local132 = (this.anInt4810 * local119 >> 12) + Static341.anIntArray504[local108];
              local132 < 0;
              local132 += 4096) {}
          while (local132 > 4096) {
            local132 -= 4096;
          }
          while (this.anInt4806 > local121
              && local132 >= this.anIntArrayArray39[local70][local121]) {
            local121++;
          }
          @Pc(168)
          int local168 = local121 - 1;
          @Pc(175)
          int local175 = this.anIntArrayArray39[local70][local168];
          @Pc(182)
          int local182 = this.anIntArrayArray39[local70][local121];
  ...
  private void method3711() {
    ...
    for (@Pc(70) int local70 = 0; local70 < this.anInt4811; local70++) {
      ...
      if (local70 > 0) {
        ...
        @Pc(100)
        int local100 = local80 + (local92 * local47 >> 12);
      ...
      for (local80 = 0; local80 < this.anInt4806; local80++) {
        if (local80 > 0) {
          ...
          @Pc(143)
          int local143 = (Static226.method3443(local12, 4096) - 2048) * this.anInt4796 >> 12;
          local92 += local35 * local143 >> 12;
          this.anIntArrayArray39[local70][local80] =
              local92 + this.anIntArrayArray39[local70][local80 - 1];
        }
        this.anIntArrayArray40[local70][local80] =
            this.anInt4807 > 0 ? 4096 - Static226.method3443(local12, this.anInt4807) : 4096;
      }
