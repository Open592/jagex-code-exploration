				...
				if (Static300.aClass22_246 == Static41.aClass22_45) {
					...
					if (Static300.aClass22_246 == Static115.aClass22_102) {
						...
						if (Static302.aClass22_247 == Static300.aClass22_246) {
							...
							if (Static326.method4415(local70)) {
								local1576 = (Node_Sub43) Static325.aLinkedHashMap_Iterator_29.get((long) local335);
								if (local1576 != null) {
									...
									if (Static421.aClass22_311 == Static300.aClass22_246) {
										...
										if (Static326.method4415(local335)) {
											for (local1190 = local327; local1190 <= local228; local1190++) {
												...
												local2317 = (Node_Sub33) Static211.A_ITERABLE_HASH_MAP___18.get(local2311);
												if (local2317 != null) {
										...
										if (Static372.aClass22_290 == Static300.aClass22_246) {
											...
											if (Static435.aClass22_328 == Static300.aClass22_246) {
												...
												if (Static4.aClass22_277 == Static300.aClass22_246) {
													...
													for (@Pc(5469) Node_Sub18 local5469 = (Node_Sub18) Static440.aLinkedHashMap_Iterator_40.head(); local5469 != null; local5469 = (Node_Sub18) Static440.aLinkedHashMap_Iterator_40.next()) {
													...
													local70 = Static146.aClass4_Sub12_Sub1_3.g4();
													if (Static326.method4415(local327)) {
														@Pc(5751) Node_Sub43 local5751 = (Node_Sub43) Static325.aLinkedHashMap_Iterator_29.get((long) local70);
														if (local5751 != null) {
													...
													local335 = Static146.aClass4_Sub12_Sub1_3.g2_alt1();
													if (Static326.method4415(local335)) {
														@Pc(6126) Node_Sub43 local6126 = (Node_Sub43) Static325.aLinkedHashMap_Iterator_29.get((long) local70);
														local1576 = (Node_Sub43) Static325.aLinkedHashMap_Iterator_29.get((long) local327);
														if (local1576 != null) {
