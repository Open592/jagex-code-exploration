	...
	public static boolean method2816() throws IOException {
		...
		if (Static300.aClass22_246 == Static7.aClass22_254) {
			...
			if (Static326.method4415(local327)) {
				@Pc(421) LinkedEntry_Sub34 local421 = new LinkedEntry_Sub34();
			...
			if (Static300.aClass22_246 == Static352.aClass22_281) {
				...
				if (Static300.aClass22_246 == Static41.aClass22_45) {
					...
					if (Static300.aClass22_246 == Static115.aClass22_102) {
						...
						@Pc(1576) LinkedEntry_Sub43 local1576;
						if (Static302.aClass22_247 == Static300.aClass22_246) {
							...
							if (Static326.method4415(local70)) {
								local1576 = (LinkedEntry_Sub43) Static325.aLinkedHashMap_Iterator_29.get((long) local335);
								if (local1576 != null) {
							...
							if (Static422.aClass22_312 == Static300.aClass22_246) {
								...
								if (Static233.aClass22_195 == Static300.aClass22_246) {
									...
									@Pc(2329) LinkedEntry_Sub33 local2329;
									@Pc(2317) LinkedEntry_Sub33 local2317;
									if (Static421.aClass22_311 == Static300.aClass22_246) {
										...
										if (Static326.method4415(local335)) {
											for (local1190 = local327; local1190 <= local228; local1190++) {
												...
												local2317 = (LinkedEntry_Sub33) Static211.A_ITERABLE_HASH_MAP___18.get(local2311);
												if (local2317 != null) {
													local2329 = new LinkedEntry_Sub33(local70, local2317.anInt5110);
													local2317.popSelf();
												} else if (local1190 == -1) {
													local2329 = new LinkedEntry_Sub33(local70, Static392.method5121(local224).aClass4_Sub33_2.anInt5110);
												} else {
													local2329 = new LinkedEntry_Sub33(local70, -1);
												}
												...
												if (Static4.aClass22_277 == Static300.aClass22_246) {
													...
													if (Static326.method4415(local70)) {
														for (local1190 = local228; local1190 <= local327; local1190++) {
															...
															local2317 = (LinkedEntry_Sub33) Static211.A_ITERABLE_HASH_MAP___18.get(local2311);
															if (local2317 != null) {
																local2329 = new LinkedEntry_Sub33(local2317.anInt5105, local224);
																local2317.popSelf();
															} else if (local1190 == -1) {
																local2329 = new LinkedEntry_Sub33(Static392.method5121(local335).aClass4_Sub33_2.anInt5105, local224);
															} else {
																local2329 = new LinkedEntry_Sub33(0, local224);
															}
															Static211.A_ITERABLE_HASH_MAP___18.set(local2311, local2329);
														}
													}
													...
													for (@Pc(5469) LinkedEntry_Sub18 local5469 = (LinkedEntry_Sub18) Static440.aLinkedHashMap_Iterator_40.head(); local5469 != null; local5469 = (LinkedEntry_Sub18) Static440.aLinkedHashMap_Iterator_40.nextEntry()) {
													...
													for (@Pc(5544) LinkedEntry_Sub9 local5544 = (LinkedEntry_Sub9) Static115.aClass183_15.method4140(); local5544 != null; local5544 = (LinkedEntry_Sub9) Static115.aClass183_15.method4144()) {
													...
													local70 = Static146.aClass4_Sub12_Sub1_3.g4();
													if (Static326.method4415(local327)) {
														@Pc(5751) LinkedEntry_Sub43 local5751 = (LinkedEntry_Sub43) Static325.aLinkedHashMap_Iterator_29.get((long) local70);
														if (local5751 != null) {
													...
													local335 = Static146.aClass4_Sub12_Sub1_3.g2_alt1();
													if (Static326.method4415(local335)) {
														@Pc(6126) LinkedEntry_Sub43 local6126 = (LinkedEntry_Sub43) Static325.aLinkedHashMap_Iterator_29.get((long) local70);
														local1576 = (LinkedEntry_Sub43) Static325.aLinkedHashMap_Iterator_29.get((long) local327);
														if (local1576 != null) {
