...
public class Packet extends Node {
  ...
  public final int g2s() {
    ...
    @Pc(38)
    int result = (this.data[this.pos - 1] & 0xFF) + ((this.data[this.pos - 2] & 0xFF) << 8);
  ...
  public final int g2s_alt1() {
    ...
    @Pc(37)
    int result = ((this.data[this.pos - 1] & 0xFF) << 8) + (this.data[this.pos - 2] & 0xFF);
  ...
  public final int g2s_alt2() {
    ...
    @Pc(39)
    int result = (this.data[this.pos - 1] - 128 & 0xFF) + ((this.data[this.pos - 2] & 0xFF) << 8);
  ...
  public final int gts_alt3() {
    ...
    @Pc(39)
    int result = ((this.data[this.pos - 1] & 0xFF) << 8) + (this.data[this.pos - 2] - 128 & 0xFF);
  ...
  public final long g8() {
    @Pc(10)
    long first = (long) this.g4() & 0xFFFFFFFFL;
    @Pc(22)
    long second = (long) this.g4() & 0xFFFFFFFFL;
  ...
  public final int gVarInt() {
    @Pc(16)
    byte currentByte = this.data[this.pos++];
    @Pc(23)
    int result = 0;
  ...
  public final long gVarLong(@OriginalArg(1) int size) {
    ...
    @Pc(29)
    int shiftWidth = shiftWidthMultiple * 8;
    @Pc(31)
    long result = 0L;
  ...
  public final void pjstr(@OriginalArg(1) String value) {
    @Pc(7)
    int nullCharLocation = value.indexOf(0);
  ...
  public final int method2525(@OriginalArg(0) int arg0) {
    @Pc(16)
    int local16 = CRC32Checksum.calculateChecksum(this.data, this.pos, arg0);
  ...
  public final boolean method2500() {
    ...
    @Pc(17)
    int local17 = CRC32Checksum.calculateChecksum(this.data, this.pos, 0);
    @Pc(21)
    int local21 = this.g4();
  ...
  @OriginalMember(
      owner = "client!iv",
      name = "a",
      descriptor = "(Ljava/math/BigInteger;BLjava/math/BigInteger;)V")
