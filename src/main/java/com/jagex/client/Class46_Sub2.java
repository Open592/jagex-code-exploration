...
public final class Class46_Sub2 extends Class46 {
  ...
  @OriginalMember(
      owner = "client!fm",
      name = "<init>",
      descriptor = "(Lclient!fd;Lclient!gt;[Lclient!bb;Z)V")
  public Class46_Sub2(
    ...
    @Pc(37)
    int local37 = local8 * 16;
    @Pc(44)
    byte[] local44 = new byte[local37 * local37];
    @Pc(57)
    int local57;
    @Pc(60)
    int local60;
    ...
    @Pc(290)
    float local290 =
        this.aClass6_Sub1_Sub1_2.aFloat172 / (float) this.aClass6_Sub1_Sub1_2.anInt5470;
    @Pc(299)
    float local299 =
        this.aClass6_Sub1_Sub1_2.aFloat171 / (float) this.aClass6_Sub1_Sub1_2.anInt5474;
    for (@Pc(301) int local301 = 0; local301 < 256; local301++) {
      @Pc(306)
      Class18 local306 = arg2[local301];
      local57 = local306.anInt366;
      local60 = local306.anInt367;
      local66 = local306.anInt370;
      local72 = local306.anInt368;
      @Pc(325)
      float local325 = (float) (local301 % 16 * local8);
      @Pc(332)
      float local332 = (float) (local301 / 16 * local8);
      @Pc(336)
      float local336 = local325 * local290;
      @Pc(340)
      float local340 = local332 * local299;
      @Pc(347)
      float local347 = (local325 + (float) local60) * local290;
      @Pc(354)
      float local354 = (local332 + (float) local57) * local299;
  ...
  protected void method5051(
    ...
    @Pc(2)
    Class145_Sub1 local2 = (Class145_Sub1) arg5;
    @Pc(5)
    Class6_Sub1_Sub1 local5 = local2.aClass6_Sub1_Sub1_5;
    ...
    @Pc(71)
    float local71 = local5.aFloat172 / (float) local5.anInt5470;
    @Pc(78)
    float local78 = local5.aFloat171 / (float) local5.anInt5474;
