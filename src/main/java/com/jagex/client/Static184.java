			...
			if (local58 != -1 && local60 != -1) {
				if (Static341.aBoolean599 && (Static434.anInt7378 & 0x40) != 0) {
					...
					if (Static393.currentGameDetails == Static317.stellardawnGameDetails) {
						Static380.method5017(59, false, 0L, local58, "", true, Static218.aClass83_83.method2267(Static178.langID), local60, -1, -1);
					}
		...
		for (@Pc(373) Class3_Sub3 local373 = (Class3_Sub3) local368.method2312(); local373 != null; local373 = (Class3_Sub3) local368.method2309()) {
			if (local373.anInt2381 == Static1.aClass16_Sub1_Sub5_Sub1_1.aByte82 && local373.method2024(arg1, arg2, arg0)) {
				...
				if (local373.aClass16_1 instanceof Class16_Sub3_Sub1) {
					@Pc(1063) LinkedHashEntry_Sub18 local1063 = (LinkedHashEntry_Sub18) Static440.aLinkedHashMap_Iterator_40.get((long) (local373.anInt2384 | local373.anInt2381 << 28 | local373.anInt2383 << 14));
					if (local1063 != null) {
						for (@Pc(1071) LinkedHashEntry_Sub45 local1071 = (LinkedHashEntry_Sub45) local1063.aClass183_14.method4139(); local1071 != null; local1071 = (LinkedHashEntry_Sub45) local1063.aClass183_14.method4145()) {
							...
							if (!Static341.aBoolean599) {
								...
								Static380.method5017(1009, Static1.aClass16_Sub1_Sub5_Sub1_1.aByte82 != local373.anInt2381, (long) local1071.anInt7355, local373.anInt2384, "<col=ff9040>" + local1081.aString61, true, Static21.aClass83_12.method2267(Static178.langID), local373.anInt2383, -1, Static103.anInt2066);
				...
				if (local373.aClass16_1 instanceof Interface6) {
					...
					if (local1304 != null) {
						if (!Static341.aBoolean599) {
							...
							Static380.method5017(1010, local373.anInt2381 != Static1.aClass16_Sub1_Sub5_Sub1_1.aByte82, (long) local1304.anInt5823, local373.anInt2384, "<col=00ffff>" + local1304.aString59, true, Static21.aClass83_12.method2267(Static178.langID), local373.anInt2383, -1, Static103.anInt2066);
						} else if (Static1.aClass16_Sub1_Sub5_Sub1_1.aByte82 == local373.anInt2381) {
