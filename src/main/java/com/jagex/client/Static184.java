...
public final class Static184 {
  ...
  public static void method2920(
      @OriginalArg(1) Class19 arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
    ...
    @Pc(43)
    Class31 local43 = arg0.method4274();
    local43.s(
        Static43.anInt7321,
        Static210.anInt3926,
        Static95.anInt1909,
    ...
    if (Static67.aClass65Array1 != null) {
      ...
      local43.m(local116);
      @Pc(134)
      int[] local134 = new int[] {local93, local101, local84};
      local43.m(local134);
      @Pc(139)
      float local139 = 0.0F;
      ...
      @Pc(165)
      int local165 = local134[2] - local116[2];
      while (local139 < 1.0F) {
        @Pc(178)
        int local178 = (int) ((float) local116[0] + local139 * (float) local147);
        @Pc(182)
        int local182 = local178 >> 7;
        @Pc(193)
        int local193 = (int) (local139 * (float) local165 + (float) local116[2]);
        @Pc(197)
        int local197 = local193 >> 7;
        if (local182 > 0
            && local197 > 0
            && Static326.anInt5666 > local182
            && Static283.anInt5187 > local197) {
          @Pc(221)
          int local221 = Static1.aClass16_Sub1_Sub5_Sub1_1.aByte82;
          if (local221 < 3 && (Static79.aByteArrayArrayArray2[1][local182][local197] & 0x2) != 0) {
            local221++;
          }
          if ((float) Static67.aClass65Array1[local221].a(local178, local193)
              < local139 * (float) local156 + (float) local116[1]) {
      ...
      if (local58 != -1 && local60 != -1) {
        if (Static341.aBoolean599 && (Static434.anInt7378 & 0x40) != 0) {
          @Pc(348)
          Class247 local348 = Static378.method3230(Static408.anInt6726, Static23.anInt350);
          if (local348 == null) {
    ...
    @Pc(368)
    Class84 local368 = Static18.aClass84_2;
    for (@Pc(373) Class3_Sub3 local373 = (Class3_Sub3) local368.method2312();
        local373 != null;
        local373 = (Class3_Sub3) local368.method2309()) {
      if (local373.anInt2381 == Static1.aClass16_Sub1_Sub5_Sub1_1.aByte82
          && local373.method2024(arg1, arg2, arg0)) {
        @Pc(503)
        int local503;
        if (local373.aClass16_1 instanceof Class16_Sub1_Sub5_Sub1) {
          @Pc(399)
          Class16_Sub1_Sub5_Sub1 local399 = (Class16_Sub1_Sub5_Sub1) local373.aClass16_1;
          local72 = local399.method4751();
          if ((local72 & 0x1) == 0
                  && (local399.anInt6893 & 0x7F) == 0
                  && (local399.anInt6892 & 0x7F) == 0
              || (local72 & 0x1) == 1
                  && (local399.anInt6893 & 0x7F) == 64
                  && (local399.anInt6892 & 0x7F) == 64) {
            ...
            for (local93 = 0; local93 < Static12.anInt163; local93++) {
              @Pc(480)
              Class16_Sub1_Sub5_Sub2 local480 =
                  Static143.aClass16_Sub1_Sub5_Sub2Array1[Static342.anIntArray412[local93]];
              if (local480 != null
                ...
                if (local503 >= local81
                  ...
                  local480.anInt6048 = client.gameLogicStepCount;
                }
              }
            }
            ...
            for (local515 = 0; local515 < local101; local515++) {
              @Pc(587)
              Class16_Sub1_Sub5_Sub1 local587 =
                  Static267.aClass16_Sub1_Sub5_Sub1Array1[local116[local515]];
              if (local587 != null
                  && client.gameLogicStepCount != local587.anInt6048
                  && local587 != local399
                  && local587.aBoolean561) {
                local147 = local587.anInt6893 - (local587.method4751() - 1 << 6);
                local156 = local587.anInt6892 - (local587.method4751() - 1 << 6);
                if (local147 >= local81
                    && local587.method4751() <= local399.method4751() - (local147 - local81 >> 7)
                    && local84 <= local156
                    && local587.method4751() <= local399.method4751() - (local156 - local84 >> 7)) {
                  Static377.method4026(
                      local373.anInt2381 != Static1.aClass16_Sub1_Sub5_Sub1_1.aByte82, local587);
                  local587.anInt6048 = client.gameLogicStepCount;
                }
              }
            }
          }
          if (client.gameLogicStepCount == local399.anInt6048) {
            continue;
          }
          Static377.method4026(
              local373.anInt2381 != Static1.aClass16_Sub1_Sub5_Sub1_1.aByte82, local399);
          local399.anInt6048 = client.gameLogicStepCount;
        }
        if (local373.aClass16_1 instanceof Class16_Sub1_Sub5_Sub2) {
          ...
          if (local721.aClass264_1 != null) {
            if ((local721.aClass264_1.anInt7201 & 0x1) == 0
              ...
              for (local84 = 0; local84 < Static12.anInt163; local84++) {
                ...
                Class16_Sub1_Sub5_Sub2 local798 =
                    Static143.aClass16_Sub1_Sub5_Sub2Array1[Static342.anIntArray412[local84]];
                if (local798 != null
              ...
              @Pc(914)
              int[] local914 = Static99.anIntArray157;
              for (local503 = 0; local503 < local93; local503++) {
                @Pc(924)
                Class16_Sub1_Sub5_Sub1 local924 =
                    Static267.aClass16_Sub1_Sub5_Sub1Array1[local914[local503]];
                if (local924 != null
                    && local924.anInt6048 != client.gameLogicStepCount
                    && local924.aBoolean561) {
                  @Pc(946)
                  int local946 = local924.anInt6893 - (local924.method4751() - 1 << 6);
            ...
            if (local721.anInt6048 == client.gameLogicStepCount) {
              continue;
            }
            Static325.method4396(
                local373.anInt2381 != Static1.aClass16_Sub1_Sub5_Sub1_1.aByte82, local721);
            local721.anInt6048 = client.gameLogicStepCount;
          }
        }
        if (local373.aClass16_1 instanceof Class16_Sub3_Sub1) {
          @Pc(1063)
          Node_Sub18 local1063 =
              (Node_Sub18)
                  Static440.aHashMap_40.get(
                      (long)
                          (local373.anInt2384
                              | local373.anInt2381 << 28
                              | local373.anInt2383 << 14));
          if (local1063 != null) {
            for (@Pc(1071) Node_Sub45 local1071 = (Node_Sub45) local1063.aLinkedList_14.head();
                local1071 != null;
                local1071 = (Node_Sub45) local1063.aLinkedList_14.next()) {
              @Pc(1081)
              Class211 local1081 = Static444.aClass206_3.method4703(local1071.anInt7355);
              if (!Static341.aBoolean599) {
                ...
                Class133 local1098 =
                    Static7.anInt5460 == -1
                        ? null
                        : Static153.aClass180_1.method4121(Static7.anInt5460);
                if ((Static434.anInt7378 & 0x1) != 0
                    && (local1098 == null
                        || local1081.method4781(Static7.anInt5460, local1098.anInt4123)
                            != local1098.anInt4123)) {
                  Static380.method5017(
                      6,
                      false,
        ...
        if (local373.aClass16_1 instanceof Interface6) {
          @Pc(1297)
          Interface6 local1297 = (Interface6) local373.aClass16_1;
          @Pc(1304)
          Class202 local1304 = Static267.aClass262_2.method5560(local1297.method5350());
          ...
          if (local1304 != null) {
            if (!Static341.aBoolean599) {
              if (local373.anInt2381 == Static1.aClass16_Sub1_Sub5_Sub1_1.aByte82) {
                @Pc(1328)
                String[] local1328 = local1304.aStringArray28;
                if (local1328 != null) {
                  for (local84 = 4; local84 >= 0; local84--) {
                    if (local1328[local84] != null) {
                      ...
                      Static380.method5017(
                          local1340,
                          false,
                          Static346.method4675(local373.anInt2384, local1297, local373.anInt2383),
                          local373.anInt2384,
              ...
              Static380.method5017(
                  1010,
                  local373.anInt2381 != Static1.aClass16_Sub1_Sub5_Sub1_1.aByte82,
                  (long) local1304.anInt5823,
                  local373.anInt2384,
                  "<col=00ffff>" + local1304.aString59,
                  true,
                  Static21.A_LOCALIZED_STRING___12.getString(ClientSettings.langID),
              ...
              Class133 local1485 =
                  Static7.anInt5460 == -1
                      ? null
                      : Static153.aClass180_1.method4121(Static7.anInt5460);
              if ((Static434.anInt7378 & 0x4) != 0
                  && (local1485 == null
                      || local1304.method4585(Static7.anInt5460, local1485.anInt4123)
                          != local1485.anInt4123)) {
                Static380.method5017(
                    30,
                    false,
                    Static346.method4675(local373.anInt2384, local1297, local373.anInt2383),
                    local373.anInt2384,
                    Static49.aString28 + " -> <col=00ffff>" + local1304.aString59,
                    true,
                    Static388.aString62,
                    local373.anInt2383,
                    -1,
