...
public final class Static113 {
  ...
  public static void method2057(
      @OriginalArg(0) Class155 arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
  ...
  @OriginalMember(
      owner = "client!fn",
      name = "a",
      descriptor = "(BLjava/lang/String;C)[Ljava/lang/String;")
  public static String[] method2058(@OriginalArg(1) String arg0, @OriginalArg(2) char arg1) {
    @Pc(10)
    int local10 = Static255.method3690(arg0, arg1);
    @Pc(23)
    String[] local23 = new String[local10 + 1];
    @Pc(25)
    int local25 = 0;
    @Pc(27)
    int local27 = 0;
