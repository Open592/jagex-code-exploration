...
public final class Class119 {
  ...
  public Class119(@OriginalArg(0) byte[] arg0) {
    @Pc(6)
    int local6 = arg0.length;
    this.aByteArray40 = arg0;
    this.anIntArray231 = new int[local6];
    this.anIntArray232 = new int[8];
    @Pc(20)
    int[] local20 = new int[33];
    @Pc(22)
    int local22 = 0;
    for (@Pc(24) int local24 = 0; local24 < local6; local24++) {
      @Pc(30)
      byte local30 = arg0[local24];
      if (local30 != 0) {
        @Pc(39)
        int local39 = 0x1 << 32 - local30;
        @Pc(43)
        int local43 = local20[local30];
        ...
        for (local91 = 0; local91 < local30; local91++) {
          @Pc(157)
          int local157 = Integer.MIN_VALUE >>> local91;
          ...
          if (this.anIntArray232.length <= local77) {
            @Pc(205)
            int[] local205 = new int[this.anIntArray232.length * 2];
  ...
  public int method2935(
    ...
    while (arg2 < local16) {
      @Pc(28)
      int local28 = arg0[arg2] & 0xFF;
      @Pc(33)
      int local33 = this.anIntArray231[local28];
      @Pc(38)
      byte local38 = this.aByteArray40[local28];
      if (local38 == 0) {
        throw new RuntimeException("No codeword for data value " + local28);
      }
      @Pc(58)
      int local58 = local20 >> 3;
      @Pc(62)
      int local62 = local20 & 0x7;
      local12 &= -local62 >> 31;
      @Pc(79)
      int local79 = (local38 + local62 - 1 >> 3) + local58;
      @Pc(80)
      int local80 = local62 + 24;
