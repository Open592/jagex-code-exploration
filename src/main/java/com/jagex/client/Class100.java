...
public final class Class100 {
	...
	private ListNode_Sub1 aClass4_Sub1_31;

	@OriginalMember(owner = "client!hu", name = "g", descriptor = "[Lclient!ac;")
	private final ListNode_Sub1[] aClass4_Sub1Array1;
	...
	public Class100(@OriginalArg(0) int arg0) {
		this.aClass4_Sub1Array1 = new ListNode_Sub1[arg0];
		this.anInt3143 = arg0;
		for (@Pc(10) int local10 = 0; local10 < arg0; local10++) {
			@Pc(20) ListNode_Sub1 local20 = this.aClass4_Sub1Array1[local10] = new ListNode_Sub1();
	...
	public ListNode_Sub1 method2670() {
		if (this.aClass4_Sub1_31 == null) {
			return null;
		}
		@Pc(23) ListNode_Sub1 local23 = this.aClass4_Sub1Array1[(int) ((long) (this.anInt3143 - 1) & this.aLong110)];
		while (this.aClass4_Sub1_31 != local23) {
			if (this.aClass4_Sub1_31.aLong198 == this.aLong110) {
				@Pc(35) ListNode_Sub1 local35 = this.aClass4_Sub1_31;
	...
	public ListNode_Sub1 method2671(@OriginalArg(0) long arg0) {
		this.aLong110 = arg0;
		@Pc(20) ListNode_Sub1 local20 = this.aClass4_Sub1Array1[(int) (arg0 & (long) (this.anInt3143 - 1))];
		for (this.aClass4_Sub1_31 = local20.aClass4_Sub1_55; this.aClass4_Sub1_31 != local20; this.aClass4_Sub1_31 = this.aClass4_Sub1_31.aClass4_Sub1_55) {
			if (this.aClass4_Sub1_31.aLong198 == arg0) {
				@Pc(39) ListNode_Sub1 local39 = this.aClass4_Sub1_31;
				this.aClass4_Sub1_31 = this.aClass4_Sub1_31.aClass4_Sub1_55;
				return local39;
			}
		}
	...
	public void method2674(@OriginalArg(1) ListNode_Sub1 arg0, @OriginalArg(2) long arg1) {
		if (arg0.aClass4_Sub1_56 != null) {
			arg0.method4662();
		}
		@Pc(21) ListNode_Sub1 local21 = this.aClass4_Sub1Array1[(int) (arg1 & (long) (this.anInt3143 - 1))];
