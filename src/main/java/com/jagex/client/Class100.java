...
public final class Class100 {
	...
	public Class100(@OriginalArg(0) int arg0) {
		...
		for (@Pc(10) int local10 = 0; local10 < arg0; local10++) {
			@Pc(20) SecondaryNode local20 = this.aClass4_Sub1Array1[local10] = new SecondaryNode();
	...
	public SecondaryNode method2670() {
		...
		@Pc(23) SecondaryNode local23 = this.aClass4_Sub1Array1[(int) ((long) (this.anInt3143 - 1) & this.aLong110)];
		while (this.aClass4_Sub1_31 != local23) {
			if (this.aClass4_Sub1_31.secondaryValue == this.aLong110) {
				@Pc(35) SecondaryNode local35 = this.aClass4_Sub1_31;
	...
	public SecondaryNode method2671(@OriginalArg(0) long arg0) {
		this.aLong110 = arg0;
		@Pc(20) SecondaryNode local20 = this.aClass4_Sub1Array1[(int) (arg0 & (long) (this.anInt3143 - 1))];
		for (this.aClass4_Sub1_31 = local20.secondaryPrevious; this.aClass4_Sub1_31 != local20; this.aClass4_Sub1_31 = this.aClass4_Sub1_31.secondaryPrevious) {
			if (this.aClass4_Sub1_31.secondaryValue == arg0) {
				@Pc(39) SecondaryNode local39 = this.aClass4_Sub1_31;
				this.aClass4_Sub1_31 = this.aClass4_Sub1_31.secondaryPrevious;
				return local39;
			}
		}
	...
	public void method2674(@OriginalArg(1) SecondaryNode arg0, @OriginalArg(2) long arg1) {
		...
		@Pc(21) SecondaryNode local21 = this.aClass4_Sub1Array1[(int) (arg1 & (long) (this.anInt3143 - 1))];
