...
public final class Static79 {
	...
	public static void method1398(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1) {
		@Pc(8) SecondaryNode_Sub1_Sub11 local8 = Static405.method5222(arg1, 3);
		local8.method2604();
	...
	public static void method1399(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
		@Pc(13) SecondaryNode_Sub1_Sub11 local13 = Static405.method5222(arg1, 16);
		local13.method2604();
	...
	public static void method1400(@OriginalArg(0) Class19 arg0) {
		...
		@Pc(58) Node_Sub17 local58;
		if (Static177.anInt2973 == 0) {
			for (local58 = (Node_Sub17) Static379.A_LINKED_LIST___45.tail(); local58 != null; local58 = (Node_Sub17) Static379.A_LINKED_LIST___45.previous()) {
