...
public final class Class198 {
  ...
  public Class198() {
    @Pc(33)
    int[] local33 = new int[this.anInt5753];
    @Pc(38)
    int local38;
    for (@Pc(35) int local35 = 0; local35 < this.anInt5753; local35++) {
      local38 = 0;
      @Pc(41)
      int local41 = Static68.method1314(3);
      @Pc(47)
      boolean local47 = Static68.method1317() != 0;
      if (local47) {
    ...
    for (local38 = 0; local38 < this.anInt5753 * 8; local38++) {
      this.anIntArray401[local38] =
          (local33[local38 >> 3] & 0x1 << (local38 & 0x7)) == 0 ? -1 : Static68.method1314(8);
    }
  }

  @OriginalMember(owner = "client!qs", name = "a", descriptor = "([FIZ)V")
  public void method4531(
      @OriginalArg(0) float[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2) {
    ...
    @Pc(19)
    int local19 = Static68.aClass134Array1[this.anInt5752].anInt4350;
    @Pc(25)
    int local25 = this.anInt5757 - this.anInt5755;
    @Pc(30)
    int local30 = local25 / this.anInt5756;
    @Pc(33)
    ...
    for (@Pc(35) int local35 = 0; local35 < 8; local35++) {
      ...
      while (local38 < local30) {
        ...
        for (local47 = 0; local47 < local19; local47++) {
          ...
          @Pc(90)
          int local90 = this.anIntArray401[local51 * 8 + local35];
          if (local90 >= 0) {
            @Pc(100)
            int local100 = this.anInt5755 + local38 * this.anInt5756;
            @Pc(104)
            Class134 local104 = Static68.aClass134Array1[local90];
            @Pc(113)
            int local113;
            if (this.anInt5754 == 0) {
              ...
              for (@Pc(115) int local115 = 0; local115 < local113; local115++) {
                @Pc(119)
                float[] local119 = local104.method3436();
              ...
              while (local113 < this.anInt5756) {
                @Pc(153)
                float[] local153 = local104.method3436();
