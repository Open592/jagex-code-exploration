...
public final class BufferedFile {
    ...
    try {
      ...
      if (this.aLong143 != -1L
          && (this.aLong143 > this.filePointer
              || this.filePointer > this.aLong143 + (long) this.anInt4426)) {
        this.method3472();
      }
      if (this.aLong143 != -1L
          && this.filePointer + (long) arg2 > this.aLong143 + (long) this.writeBuffer.length) {
        @Pc(100)
        int local100 = (int) (this.aLong143 + (long) this.writeBuffer.length - this.filePointer);
        Static459.method3330(
            arg1, arg0, this.writeBuffer, (int) (this.filePointer - this.aLong143), local100);
        arg0 += local100;
      ...
      if (arg2 > this.writeBuffer.length) {
        ...
        @Pc(197)
        long local197 = -1L;
        if (this.filePointer >= this.aLong146
            && this.aLong146 + (long) this.offset > this.filePointer) {
          local195 = this.filePointer;
        } else if (this.aLong146 >= this.filePointer
            && this.aLong146 < (long) arg2 + this.filePointer) {
          local195 = this.aLong146;
        }
        if (this.aLong146 < (long) arg2 + this.filePointer
            && (long) arg2 + this.filePointer <= (long) this.offset + this.aLong146) {
          local197 = (long) arg2 + this.filePointer;
        } else if (this.aLong146 + (long) this.offset > this.filePointer
            && this.filePointer + (long) arg2 >= this.aLong146 + (long) this.offset) {
          local197 = (long) this.offset + this.aLong146;
        }
        if (local195 > -1L && local195 < local197) {
          @Pc(335)
          int local335 = (int) (local197 - local195);
          Static459.method3330(
              arg1,
              (int) (local195 + (long) arg0 - this.filePointer),
              this.readBuffer,
              (int) (local195 - this.aLong146),
              local335);
        }
        ...
        Static459.method3330(
            arg1, arg0, this.writeBuffer, (int) (this.filePointer - this.aLong143), arg2);
        this.filePointer += arg2;
  ...
  public void method3471(int offset, int length, byte[] buffer) throws IOException {
    try {
      ...
      if (this.aLong143 != -1L
          && this.aLong143 <= this.filePointer
          && (long) this.anInt4426 + this.aLong143 >= this.filePointer + (long) length) {
        Static459.method3330(
            this.writeBuffer, (int) (this.filePointer - this.aLong143), buffer, 0, length);
      ...
      if (this.aLong146 <= this.filePointer
          && this.filePointer < this.aLong146 + (long) this.offset) {
        local124 = (int) (this.aLong146 + (long) this.offset - this.filePointer);
        if (length < local124) {
          local124 = length;
        }
        Static459.method3330(
            this.readBuffer, (int) (this.filePointer - this.aLong146), buffer, 0, local124);
        offset = local124;
        length -= local124;
      ...
      if (this.aLong143 != -1L) {
        ...
        if ((long) this.anInt4426 + this.aLong143 > local82
            && this.aLong143 + (long) this.anInt4426 <= local82 - -((long) local86)) {
          local361 = (long) this.anInt4426 + this.aLong143;
        } else if (this.aLong143 < local82 + (long) local86
            && local82 + (long) local86 <= (long) this.anInt4426 + this.aLong143) {
        ...
        if (local312 > -1L && local361 > local312) {
          ...
          Static459.method3330(
              this.writeBuffer,
              (int) (local312 - this.aLong143),
              buffer,
              (int) (local312 - local82),
              local440);
  ...
  private void method3472() throws IOException {
    ...
    } else if (this.aLong143 <= this.aLong146
        && (long) this.anInt4426 + this.aLong143 > this.aLong146) {
      local63 = this.aLong146;
    }

    if (this.aLong143 + (long) this.anInt4426 > this.aLong146
        && this.aLong143 + (long) this.anInt4426 <= (long) this.offset + this.aLong146) {
      local65 = (long) this.anInt4426 + this.aLong143;
    } else if (this.aLong143 < (long) this.offset + this.aLong146
        && (long) this.anInt4426 + this.aLong143 >= (long) this.offset + this.aLong146) {
      local65 = this.aLong146 + (long) this.offset;
    }

    if (local63 > -1L && local65 > local63) {
      @Pc(203)
      int local203 = (int) (local65 - local63);

      Static459.method3330(
          this.writeBuffer,
          (int) (local63 - this.aLong143),
          this.readBuffer,
          (int) (local63 - this.aLong146),
          local203);
    }
