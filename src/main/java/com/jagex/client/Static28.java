...
public final class Static28 {
  ...
  public static void method528(
      @OriginalArg(0) Node_Sub45 arg0,
      @OriginalArg(1) int arg1,
      @OriginalArg(2) int arg2,
      @OriginalArg(4) int arg3) {
    @Pc(20)
    long local20 = (long) (arg1 | arg3 << 28 | arg2 << 14);
    @Pc(26)
    Node_Sub18 local26 = (Node_Sub18) Static440.aHashMap_40.get(local20);
    if (local26 == null) {
    ...
    for (@Pc(71) Node_Sub45 local71 = (Node_Sub45) local26.aLinkedList_14.tail();
        local71 != null;
