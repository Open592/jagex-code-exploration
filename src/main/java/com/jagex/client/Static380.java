...
public final class Static380 {
  ...
  @OriginalMember(
      owner = "client!te",
      name = "a",
      descriptor = "(IILclient!et;ILjava/awt/Component;)Lclient!ln;")
  public static Class49 method5016(
      @OriginalArg(0) int arg0,
      @OriginalArg(2) SignLink arg1,
      @OriginalArg(3) int arg2,
      @OriginalArg(4) Component arg3) {
    ...
    try {
      ...
      try {
        @Pc(128)
        Class49_Sub2 local128 = new Class49_Sub2(arg1, arg0);
  ...
  @OriginalMember(
      owner = "client!te",
      name = "a",
      descriptor = "(IBZJILjava/lang/String;ZLjava/lang/String;III)V")
  public static void method5017(
      @OriginalArg(0) int arg0,
      @OriginalArg(2) boolean arg1,
      @OriginalArg(3) long arg2,
      @OriginalArg(4) int arg3,
      @OriginalArg(5) String arg4,
      @OriginalArg(6) boolean arg5,
      @OriginalArg(7) String arg6,
      @OriginalArg(8) int arg7,
      @OriginalArg(9) int arg8,
      @OriginalArg(10) int arg9) {
    if (!Static234.aBoolean411 && Static407.anInt6710 < 500) {
      @Pc(16)
      int local16 = arg9 == -1 ? Static157.anInt3147 : arg9;
      @Pc(30)
      Node_Sub39 local30 =
          new Node_Sub39(arg6, arg4, local16, arg0, arg8, arg2, arg3, arg7, arg5, arg1);
      Static206.A_LINKED_LIST___28.addFirst(local30);
      Static407.anInt6710++;
    }
  }
  ...
  @OriginalMember(
      owner = "client!te",
      name = "a",
      descriptor = "(Lclient!fs;ILjava/lang/String;Z)Lclient!qk;")
  public static Class195 method5018(
    ...
    @Pc(31)
    int[] local31 = arg0.method2124(local18);
    @Pc(37)
    Class195 local37 = new Class195(local31.length);
    @Pc(39)
    int local39 = 0;
    @Pc(41)
    int local41 = 0;
    while (true) {
      while (local37.anInt5679 > local39) {
        @Pc(55)
        Packet local55 = new Packet(arg0.method2104(local31[local41++], local18));
        @Pc(59)
        int local59 = local55.g4();
        @Pc(63)
        int local63 = local55.g2();
        @Pc(67)
        int local67 = local55.g1();
        if (!arg2 && local67 == 1) {
          local37.anInt5679--;
        } else {
