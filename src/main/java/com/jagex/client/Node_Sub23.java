...
public final class Node_Sub23 extends Node {
  ...
  public Class110 method2719(@OriginalArg(1) Class19 arg0, @OriginalArg(2) int arg1) {
    @Pc(8)
    int local8 = Static201.anIntArray410[this.anInt3195];
    if (local8 == 0) {
      @Pc(112)
      Class16_Sub5 local112 = Static227.method3449(this.anInt3196, this.anInt3189, this.anInt3193);
      if (local112 instanceof Class16_Sub5_Sub1) {
        @Pc(118)
        Class16_Sub5_Sub1 local118 = (Class16_Sub5_Sub1) local112;
      ...
      @Pc(87)
      Class16_Sub2 local87 = Static54.method918(this.anInt3196, this.anInt3189, this.anInt3193);
      if (local87 instanceof Class16_Sub2_Sub2) {
        @Pc(93)
        Class16_Sub2_Sub2 local93 = (Class16_Sub2_Sub2) local87;
      ...
      @Pc(32)
      Class16_Sub1 local32 =
          Static36.method648(this.anInt3196, this.anInt3189, this.anInt3193, Interface6.class);
      if (local32 instanceof Class16_Sub1_Sub1) {
        @Pc(38)
        Class16_Sub1_Sub1 local38 = (Class16_Sub1_Sub1) local32;
      ...
      @Pc(62)
      Class16_Sub4 local62 = Static117.method2096(this.anInt3196, this.anInt3189, this.anInt3193);
      if (local62 instanceof Class16_Sub4_Sub1) {
        @Pc(68)
        Class16_Sub4_Sub1 local68 = (Class16_Sub4_Sub1) local62;
