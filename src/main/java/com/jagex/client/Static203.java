...
public final class Static203 {
  ...
  public static void method3177(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
    @Pc(10)
    HashMap local10 = new HashMap(16);
    for (@Pc(20) Node_Sub18 local20 = (Node_Sub18) Static440.aHashMap_40.head();
        local20 != null;
        local20 = (Node_Sub18) Static440.aHashMap_40.next()) {
      local20.popSelf();
      @Pc(31)
      int local31 = (int) (local20.hashKey >> 28);
      @Pc(41)
      int local41 = (int) (local20.hashKey >> 14 & 0x3FFFL) - arg1;
      @Pc(49)
      int local49 = (int) (local20.hashKey & 0x3FFFL) - arg0;
      if (local49 >= 0
          && local41 >= 0
          && local49 < Static326.anInt5666
          && Static283.anInt5187 > local41) {
