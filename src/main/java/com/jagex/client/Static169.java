  ...
  public static void method2755(
    ...
    while (local14 > local7) {
      ...
      if (local17 >= 0) {
        ...
        local17 -= local14 << 1;
        @Pc(59)
        int[] local59 = Static96.anIntArrayArray21[local14 + arg2];
        @Pc(65)
        int[] local65 = Static96.anIntArrayArray21[arg2 - local14];
        @Pc(69)
        int local69 = arg0 + local7;
        @Pc(74)
        int local74 = arg0 - local7;
        Static251.method3640(local74, arg3, local69, local59);
        Static251.method3640(local74, arg3, local69, local65);
      }
      @Pc(91)
      int local91 = arg0 + local14;
      @Pc(96)
      int local96 = arg0 - local14;
      @Pc(103)
      int[] local103 = Static96.anIntArrayArray21[arg2 + local7];
      @Pc(110)
      int[] local110 = Static96.anIntArrayArray21[arg2 - local7];
