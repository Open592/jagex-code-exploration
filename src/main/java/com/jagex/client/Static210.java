...
public final class Static210 {
  ...
  public static int method3197(@OriginalArg(0) Node_Sub39 arg0) {
    @Pc(14)
    String local14 = Static200.method3166(arg0);
    @Pc(16)
    int[] local16 = null;
    ...
    @Pc(137)
    int local137 = Static118.aClass89_5.method2342(local14, Static385.aClass57Array16);
    if (arg0.aBoolean511) {
  ...
  public static boolean method3198(@OriginalArg(0) char arg0) {
    if (Character.isISOControl(arg0)) {
      ...
      @Pc(18)
      char[] local18 = Static55.aCharArray2;
      for (@Pc(20) int local20 = 0; local20 < local18.length; local20++) {
        @Pc(26)
        char local26 = local18[local20];
        if (local26 == arg0) {
          return true;
        }
      }
      @Pc(46)
      char[] local46 = Static437.aCharArray6;
      for (@Pc(48) int local48 = 0; local48 < local46.length; local48++) {
        @Pc(54)
        char local54 = local46[local48];
        if (local54 == arg0) {
          return true;
        }
      }
