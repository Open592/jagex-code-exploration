...
public final class LinkedEntry_Sub30 extends LinkedEntry {
	...
	public LinkedEntry_Sub30(@OriginalArg(0) Packet arg0) {
				...
				while (local29.anIntArray347[local51] == local56) {
					...
					if (local80 == 144) {
						...
						if (local99 > 0) {
							...
							@Pc(182) LinkedEntry_Sub19 local182 = (LinkedEntry_Sub19) this.aLinkedHashMap_Iterator_23.get((long) local174);
							if (local182 == null) {
								local182 = new LinkedEntry_Sub19(new byte[128]);
