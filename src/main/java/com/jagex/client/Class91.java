...
public final class Class91 implements Interface7 {
  ...
  @OriginalMember(
      owner = "client!hb",
      name = "<init>",
      descriptor = "(Lclient!fs;Lclient!fs;Lclient!fs;)V")
  public Class91(@OriginalArg(0) Js5 arg0, @OriginalArg(1) Js5 arg1, @OriginalArg(2) Js5 arg2) {
    this.aJs5_34 = arg2;
    this.aJs5_35 = arg1;
    @Pc(24)
    Packet local24 = new Packet(arg0.method2104(0, 0));
    @Pc(28)
    int local28 = local24.g2();
    ...
    for (@Pc(338) int local338 = 0; local338 < local28; local338++) {
      if (this.aClass251Array1[local338] != null) {
        this.aClass251Array1[local338].aBoolean641 = local24.g1() == 1;
      }
    }
    for (@Pc(366) int local366 = 0; local366 < local28; local366++) {
      if (this.aClass251Array1[local366] != null) {
        this.aClass251Array1[local366].aBoolean645 = local24.g1() == 1;
      }
    }
  ...
  public int[] method2395(
      ...
      @OriginalArg(3) float arg1,
      @OriginalArg(4) int arg2,
      @OriginalArg(5) int arg3) {
    return this.method2397(arg0)
        .method3282(
            arg3, this.aJs5_34, this, arg2, (double) arg1, this.aClass251Array1[arg0].aBoolean645);
  }
  ...
  public int[] method2393(
    ...
    return this.method2397(arg1)
        .method3277(
            this,
            arg0,
            this.aClass251Array1[arg1].aBoolean645,
            this.aJs5_34,
            (double) arg2,
            arg4,
            arg3);
  ...
  public float[] method2394(
      ...
      @OriginalArg(4) int arg3) {
    return this.method2397(arg1)
        .method3283(this, this.aJs5_34, arg3, this.aClass251Array1[arg1].aBoolean645, arg2);
  }
  ...
  private SecondaryNode_Sub1_Sub14 method2397(@OriginalArg(0) int arg0) {
    @Pc(10)
    SecondaryNode local10 = this.aClass142_2.method3483((long) arg0);
    if (local10 != null) {
      return (SecondaryNode_Sub1_Sub14) local10;
    }
    @Pc(26)
    byte[] local26 = this.aJs5_35.method2122(arg0);
    if (local26 == null) {
      return null;
    } else {
      @Pc(38)
      SecondaryNode_Sub1_Sub14 local38 = new SecondaryNode_Sub1_Sub14(new Packet(local26));
  ...
  public boolean method2392(@OriginalArg(0) int arg0) {
    @Pc(15)
    SecondaryNode_Sub1_Sub14 local15 = this.method2397(arg0);
