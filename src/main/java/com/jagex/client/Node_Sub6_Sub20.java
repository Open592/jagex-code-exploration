...
public final class Node_Sub6_Sub20 extends Node_Sub6 {
  ...
  public int[] method5510(@OriginalArg(1) int arg0) {
    ...
    if (super.aClass82_41.aBoolean243) {
      @Pc(29)
      int local29 = Static165.anIntArray209[arg0] - 2048;
      for (@Pc(31) int local31 = 0; local31 < Static80.anInt1616; local31++) {
        @Pc(39)
        int local39 = Static341.anIntArray504[local31] - 2048;
        @Pc(44)
        int local44 = local39 + this.anInt4005;
        @Pc(55)
        int local55 = local44 < -2048 ? local44 + 4096 : local44;
        @Pc(66)
        int local66 = local55 > 2048 ? local55 - 4096 : local55;
        @Pc(71)
        int local71 = this.anInt4004 + local29;
        @Pc(82)
        int local82 = local71 < -2048 ? local71 + 4096 : local71;
        @Pc(91)
        int local91 = local82 <= 2048 ? local82 : local82 - 4096;
        @Pc(97)
        int local97 = local39 + this.anInt4007;
        @Pc(106)
        int local106 = local97 < -2048 ? local97 + 4096 : local97;
        @Pc(117)
        int local117 = local106 <= 2048 ? local106 : local106 - 4096;
        @Pc(122)
        int local122 = local29 + this.anInt4006;
        @Pc(133)
        int local133 = local122 < -2048 ? local122 + 4096 : local122;
        @Pc(142)
        int local142 = local133 <= 2048 ? local133 : local133 - 4096;
        local11[local31] =
            this.method3259(local66, local91) || this.method3260(local142, local117) ? 4096 : 0;
      }
    }
    return local11;
  }
  ...
  private boolean method3259(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
    @Pc(13)
    int local13 = (arg1 - arg0) * this.anInt4009 >> 12;
    @Pc(23)
    int local23 = Static345.anIntArray416[local13 * 255 >> 12 & 0xFF];
    @Pc(30)
    int local30 = (local23 << 12) / this.anInt4009;
    @Pc(37)
    int local37 = (local30 << 12) / this.anInt4010;
    @Pc(44)
    int local44 = local37 * this.anInt4001 >> 12;
  ...
  private boolean method3260(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
    @Pc(12)
    int local12 = this.anInt4009 * (arg1 + arg0) >> 12;
    @Pc(22)
    int local22 = Static345.anIntArray416[local12 * 255 >> 12 & 0xFF];
    @Pc(29)
    int local29 = (local22 << 12) / this.anInt4009;
    @Pc(36)
    int local36 = (local29 << 12) / this.anInt4010;
    @Pc(43)
    int local43 = this.anInt4001 * local36 >> 12;
