...
public abstract class Class46 {
  ...
  public final void method5046(
      @OriginalArg(0) int arg0,
      @OriginalArg(2) int arg1,
      @OriginalArg(3) String arg2,
    ...
    @Pc(16)
    int local16 = arg2.length();
    @Pc(24)
    int[] local24 = new int[local16];
    @Pc(27)
    int[] local27 = new int[local16];
    ...
    this.method5052(
        null, arg0, arg1 - this.aClass89_9.method2340(arg2) / 2, arg2, local24, null, local27);
  }

  @OriginalMember(
      owner = "client!la",
      name = "a",
      descriptor = "(III[I[Lclient!l;ILjava/util/Random;Ljava/lang/String;IIIII[II)I")
  public final int method5047(
      @OriginalArg(0) int arg0,
      @OriginalArg(1) int arg1,
      @OriginalArg(2) int arg2,
      @OriginalArg(3) int[] arg3,
      @OriginalArg(4) Class57[] arg4,
      @OriginalArg(5) int arg5,
      @OriginalArg(6) Random arg6,
      @OriginalArg(7) String arg7,
    ...
    @Pc(20)
    int local20 = (arg6.nextInt() & 0x1F) + 192;
    this.method5054(arg10 & 0xFFFFFF | local20 << 24, local20 << 24 | arg8 & 0xFFFFFF);
    @Pc(40)
    int local40 = arg7.length();
    @Pc(43)
    int[] local43 = new int[local40];
    @Pc(45)
    int local45 = 0;
    ...
    int local73 = arg5;
    @Pc(80)
    int local80 = arg13 + this.aClass89_9.anInt2783;
    @Pc(82)
    int local82 = -1;
    if (arg11 == 1) {
  ...
  @OriginalMember(
      owner = "client!la",
      name = "a",
      descriptor = "(III[Lclient!l;[IZIIIIILjava/lang/String;IILclient!ma;II)I")
  public final int method5048(
      @OriginalArg(0) int arg0,
      @OriginalArg(1) int arg1,
      @OriginalArg(2) int arg2,
      @OriginalArg(3) Class57[] arg3,
      ...
      @OriginalArg(11) String arg10,
      @OriginalArg(12) int arg11,
      @OriginalArg(13) int arg12,
      @OriginalArg(14) Class145 arg13,
      @OriginalArg(15) int arg14,
      @OriginalArg(16) int arg15) {
    if (arg10 == null) {
      return 0;
    }
    ...
    @Pc(57)
    int local57 = this.aClass89_9.method2339(arg3, local44, Static227.aStringArray17, arg10);
    if (arg12 == -1) {
      arg12 = arg1 / arg6;
      if (arg12 <= 0) {
        arg12 = 1;
    ...
    if (arg12 > 0 && arg12 <= local57) {
      Static227.aStringArray17[arg12 - 1] =
          this.aClass89_9.method2346(arg3, Static227.aStringArray17[arg12 - 1], arg15);
      local57 = arg12;
    }
    if (arg9 == 3 && local57 == 1) {
      arg9 = 1;
    ...
    if (arg9 == 0) {
      ...
      local111 =
          (arg1 - arg6 * (local57 - 1) - this.aClass89_9.anInt2778 - this.aClass89_9.anInt2783) / 2
              + this.aClass89_9.anInt2783
              + arg11;
    } else if (arg9 == 2) {
      local111 = arg1 + arg11 - (local57 - 1) * arg6 - this.aClass89_9.anInt2778;
    } else {
      local173 =
          (arg1 - arg6 * (local57 - 1) - this.aClass89_9.anInt2783 - this.aClass89_9.anInt2778)
              / (local57 - -1);
      if (local173 < 0) {
        local173 = 0;
      }
    ...
    for (local173 = 0; local173 < local57; local173++) {
      if (arg14 == 0) {
        this.method5062(
            Static227.aStringArray17[local173], arg8, arg4, arg7, arg3, local111, arg13, arg0);
      } else if (arg14 == 1) {
        this.method5062(
            Static227.aStringArray17[local173],
            arg8,
            arg4,
            arg7,
            arg3,
            local111,
            arg13,
            arg0 + (arg15 - this.aClass89_9.method2340(Static227.aStringArray17[local173])) / 2);
      } else if (arg14 == 2) {
        this.method5062(
            Static227.aStringArray17[local173],
            arg8,
            ...
            local111,
            arg13,
            arg15 + arg0 - this.aClass89_9.method2340(Static227.aStringArray17[local173]));
  ...
  public final void method5050(
      @OriginalArg(0) int arg0,
      @OriginalArg(1) String arg1,
  ...
  @OriginalMember(
      owner = "client!la",
      name = "a",
      descriptor = "([IIIILjava/lang/String;[I[Lclient!l;[I)V")
  private void method5052(
      @OriginalArg(0) int[] arg0,
      @OriginalArg(1) int arg1,
      @OriginalArg(3) int arg2,
      @OriginalArg(4) String arg3,
      @OriginalArg(5) int[] arg4,
      @OriginalArg(6) Class57[] arg5,
      @OriginalArg(7) int[] arg6) {
    @Pc(7)
    int local7 = arg1 - this.aClass89_9.anInt2786;
    @Pc(13)
    int local13 = -1;
    @Pc(15)
    int local15 = -1;
    ...
    for (@Pc(28) int local28 = 0; local28 < local20; local28++) {
      ...
      if (local39 == '<') {
        ...
        if (local39 == '>' && local13 != -1) {
          @Pc(63)
          String local63 = arg3.substring(local13 + 1, local28);
          local13 = -1;
            ...
            if (!local63.equals("reg")) {
              if (local63.startsWith("img=")) {
                try {
                  ...
                  @Pc(165)
                  int local165 = arg0 == null ? local156.T() : arg0[local152];
                  local156.r(
                      local131 + arg2,
                      -local165 + this.aClass89_9.anInt2786 + local7 - -local141,
                      1,
                      0,
                      1);
                  local15 = -1;
        ...
        if (local13 == -1) {
          ...
          if (local39 != ' ') {
            if ((Static382.anInt6447 & 0xFF000000) != 0) {
              this.OA(
                  local39, local231 + arg2 + 1, local7 - -local131 + 1, Static382.anInt6447, true);
            }
          ...
          if (Static305.anInt5387 != -1) {
            this.aClass19_38.method4256(
                local141,
                local7 + (int) ((double) this.aClass89_9.anInt2786 * 0.7D),
                arg2,
                Static305.anInt5387);
          }
          if (Static81.anInt1642 != -1) {
            this.aClass19_38.method4256(
                local141, local7 + this.aClass89_9.anInt2786, arg2, Static81.anInt1642);
          }
          arg2 += local141;
          local15 = local39;
        }
  ...
  @OriginalMember(
      owner = "client!la",
      name = "a",
      descriptor = "(Ljava/util/Random;[Lclient!l;I[IILjava/lang/String;IIII)I")
  public final int method5053(
      @OriginalArg(0) Random arg0,
      @OriginalArg(1) Class57[] arg1,
      @OriginalArg(3) int[] arg2,
      @OriginalArg(4) int arg3,
      @OriginalArg(5) String arg4,
      @OriginalArg(8) int arg5,
    ...
    @Pc(21)
    int local21 = (arg0.nextInt() & 0x1F) + 192;
    this.method5054((local21 | 0x0) << 24, local21 << 24 | 0xFFFFFF);
    @Pc(41)
    int local41 = arg4.length();
    @Pc(44)
    int[] local44 = new int[local41];
    @Pc(46)
    int local46 = 0;
  ...
  private void method5055(@OriginalArg(1) String arg0) {
    try {
      if (arg0.startsWith("col=")) {
        Static187.anInt3560 =
            Static187.anInt3560 & 0xFF000000 | Static371.method4962(arg0.substring(4)) & 0xFFFFFF;
  ...
  public final void method5056(
    ...
    if (arg4 != null) {
      ...
      this.method5062(
          arg4, 0, null, 0, null, arg2, null, arg0 - this.aClass89_9.method2340(arg4) / 2);
    }
  }
  ...
  @OriginalMember(
      owner = "client!la",
      name = "a",
      descriptor = "(B[II[Lclient!l;ILjava/lang/String;II)V")
  public final void method5057(
      @OriginalArg(1) int[] arg0,
      @OriginalArg(3) Class57[] arg1,
      @OriginalArg(4) int arg2,
      @OriginalArg(5) String arg3,
  ...
  private void method5060(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1) {
    ...
    for (@Pc(16) int local16 = 0; local16 < arg0.length(); local16++) {
      @Pc(22)
      char local22 = arg0.charAt(local16);
      if (local22 == '<') {
        local14 = true;
      } else if (local22 == '>') {
        local14 = false;
  ...
  @OriginalMember(
      owner = "client!la",
      name = "a",
      descriptor = "(Ljava/lang/String;I[II[Lclient!l;IZLclient!ma;I)V")
  private void method5062(
      @OriginalArg(0) String arg0,
      @OriginalArg(1) int arg1,
      @OriginalArg(2) int[] arg2,
      @OriginalArg(3) int arg3,
      @OriginalArg(4) Class57[] arg4,
      @OriginalArg(5) int arg5,
      @OriginalArg(7) Class145 arg6,
      @OriginalArg(8) int arg7) {
    @Pc(7)
    int local7 = arg5 - this.aClass89_9.anInt2786;
    @Pc(13)
    int local13 = -1;
    @Pc(15)
    int local15 = -1;
    ...
    for (@Pc(28) int local28 = 0; local28 < local18; local28++) {
      ...
      if (local39 == '<') {
        ...
        if (local39 == '>' && local13 != -1) {
          @Pc(61)
          String local61 = arg0.substring(local13 + 1, local28);
          local13 = -1;
            ...
            if (!local61.equals("reg")) {
              if (local61.startsWith("img=")) {
                try {
                  ...
                  @Pc(140)
                  int local140 = arg2 == null ? local131.T() : arg2[local127];
                  if ((-16777216 & Static187.anInt3560) == -16777216) {
                    local131.r(arg7, local7 + this.aClass89_9.anInt2786 - local140, 1, 0, 1);
                  } else {
                    local131.r(
                        arg7,
                        this.aClass89_9.anInt2786 + local7 - local140,
                        0,
                        Static187.anInt3560 & 0xFF000000 | 0xFFFFFF,
                        1);
                  }
                  local15 = -1;
        ...
        if (local13 == -1) {
          ...
          if (local39 == ' ') {
            ...
            if ((Static382.anInt6447 & 0xFF000000) != 0) {
              this.method5051(
                  local39, arg7 + 1, local7 - -1, Static382.anInt6447, true, arg6, arg1, arg3);
            }
            this.method5051(local39, arg7, local7, Static187.anInt3560, false, arg6, arg1, arg3);
          }
          @Pc(308)
          int local308 = this.aClass89_9.method2343(local39);
          if (Static305.anInt5387 != -1) {
            this.aClass19_38.method4256(
                local308,
                (int) ((double) this.aClass89_9.anInt2786 * 0.7D) + local7,
                arg7,
                Static305.anInt5387);
          }
          if (Static81.anInt1642 != -1) {
            this.aClass19_38.method4256(
                local308, this.aClass89_9.anInt2786 + local7 + 1, arg7, Static81.anInt1642);
          }
          arg7 += local308;
          local15 = local39;
        }
  ...
  @OriginalMember(
      owner = "client!la",
      name = "a",
      descriptor = "(II[Lclient!l;IILclient!ma;IIIIIIIILjava/lang/String;[I)I")
  public final int method5063(
      @OriginalArg(0) int arg0,
      @OriginalArg(1) int arg1,
      @OriginalArg(2) Class57[] arg2,
      @OriginalArg(3) int arg3,
      @OriginalArg(5) Class145 arg4,
      @OriginalArg(6) int arg5,
      @OriginalArg(7) int arg6,
      @OriginalArg(10) int arg7,
      @OriginalArg(11) int arg8,
      @OriginalArg(12) int arg9,
      @OriginalArg(13) int arg10,
      @OriginalArg(14) String arg11,
      @OriginalArg(15) int[] arg12) {
    return this.method5048(
        arg6, arg7, arg9, arg2, arg12, arg0, 0, arg1, arg3, arg10, arg11, arg5, 0, arg4, 1, arg8);
  }
  ...
  public final void method5064(
    ...
    this.method5054(-16777216, arg0);
    @Pc(21)
    double local21 = 7.0D - (double) arg5 / 8.0D;
    if (local21 < 0.0D) {
      local21 = 0.0D;
    }
    @Pc(30)
    int local30 = arg2.length();
    @Pc(33)
    int[] local33 = new int[local30];
    for (@Pc(35) int local35 = 0; local35 < local30; local35++) {
      local33[local35] = (int) (Math.sin((double) local35 / 1.5D + (double) arg4) * local21);
    }
    this.method5052(
        null, arg1, arg3 - this.aClass89_9.method2340(arg2) / 2, arg2, null, null, local33);
  }
}
