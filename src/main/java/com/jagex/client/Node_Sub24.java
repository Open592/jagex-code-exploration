...
public final class Node_Sub24 extends Node {
  ...
  private final Node_Sub21 aClass4_Sub21_1;
  ...
  @OriginalMember(
      owner = "client!iu",
      name = "<init>",
      descriptor = "(Lclient!fd;Lclient!oq;Lclient!vp;[I)V")
  public Node_Sub24(
      @OriginalArg(0) Class19_Sub2 arg0,
      @OriginalArg(1) Class65_Sub2 arg1,
      @OriginalArg(2) Node_Sub21 arg2,
      @OriginalArg(3) int[] arg3) {
    this.aClass19_Sub2_22 = arg0;
    this.aClass65_Sub2_2 = arg1;
    this.aClass4_Sub21_1 = arg2;
    @Pc(22)
    int local22 = this.aClass4_Sub21_1.method3165() - (arg1.anInt5261 >> 1);
    ...
    @Pc(78)
    int local78 = this.anInt3412 + 1 - this.anInt3406;
    @Pc(87)
    int local87 = this.anInt3409 + 1 - this.anInt3415;
        ...
        for (local141 = 0; local141 <= local78; local141++) {
          ...
          if (local148 > 0 && local148 < this.aClass65_Sub2_2.anInt5262 - 1) {
            ...
            float local208 =
                (float)
                    (1.0D
                        / Math.sqrt((double) (local178 * local178 + local193 * local193 + 65536)));
      ...
      if (local148 >= 0 && arg1.anInt5258 > local148) {
        for (local178 = this.anInt3406; local178 <= this.anInt3412; local178++) {
          if (local178 >= 0 && local178 < arg1.anInt5262) {
            ...
            @Pc(293)
            int[] local293 = arg1.anIntArrayArrayArray6[local178][local148];
    ...
    if (local123 > 0) {
        ...
        if (local193 >= 0 && local193 < arg1.anInt5258) {
          ...
          for (@Pc(405) int local405 = this.anInt3406; local405 <= this.anInt3412; local405++) {
            if (local405 >= 0 && arg1.anInt5262 > local405) {
              @Pc(421)
              int local421 = arg3[local141];
              @Pc(428)
              int[] local428 = arg1.anIntArrayArrayArray6[local405][local193];
              @Pc(435)
              int[] local435 = arg1.anIntArrayArrayArray7[local405][local193];
              if (local428 != null && local421 != 0) {
                if (local421 == 1) {
                  ...
                  this.method2839(arg1.anInt5261, 0, local178, local402, local193, local405);
                  this.method2839(
                      arg1.anInt5261, arg1.anInt5261, local178, local402, local193, local405);
                  this.method2839(0, 0, local178, local402, local193, local405);
                } else if (local421 == 5) {
                  this.method2839(
                      arg1.anInt5261, arg1.anInt5261, local178, local402, local193, local405);
      ...
      this.anInterface1_3 =
          this.aClass19_Sub2_22.method1955(this.aPacket_3.pos, false, this.aPacket_3.data);
      this.anInterface11_5 =
          this.aClass19_Sub2_22.method1960(
              this.aNode_Sub12_Sub2_2.pos, this.aNode_Sub12_Sub2_2.data, false, 16);
  ...
  private void method2839(
    ...
    long local7 = -1L;
    @Pc(21)
    int local21 = (arg5 << this.aClass65_Sub2_2.anInt5256) + arg0;
    @Pc(29)
    int local29 = (arg4 << this.aClass65_Sub2_2.anInt5256) + arg1;
    @Pc(35)
    int local35 = this.aClass65_Sub2_2.a(local21, local29);
    if ((arg0 & 0x7F) == 0 || (arg1 & 0x7F) == 0) {
      local7 = (long) local21 & 0xFFFFL | (long) local29 << 16 & 0xFFFFL << 16;
      @Pc(66)
      Node local66 = this.aHashMap_17.get(local7);
      if (local66 != null) {
    ...
    @Pc(84)
    short local84 = (short) this.anInt3410++;
    if (local7 != -1L) {
    ...
    if (arg0 == 0 && arg1 == 0) {
      ...
      @Pc(206)
      float local206 =
          local188 + (this.aFloatArrayArray3[arg3 + 1][arg2 + 1] - local188) * local141;
      @Pc(221)
      float local221 = local170 + (this.aFloatArrayArray4[arg3][arg2 + 1] - local170) * local141;
      local230 = this.aFloatArrayArray4[arg3 + 1][arg2];
      @Pc(248)
      float local248 =
          local179 + (this.aFloatArrayArray2[arg3 + 1][arg2 + 1] - local179) * local141;
      @Pc(263)
      float local263 = local156 + (this.aFloatArrayArray2[arg3][arg2 + 1] - local156) * local141;
      @Pc(279)
      float local279 = local163 + (this.aFloatArrayArray3[arg3][arg2 + 1] - local163) * local141;
      local287 = local149 * (local206 - local279) + local279;
      @Pc(305)
      float local305 =
          local230 + (this.aFloatArrayArray4[arg3 + 1][arg2 + 1] - local230) * local141;
    ...
    local163 =
        (float)
            Math.sqrt((double) (local156 * local156 + local149 * local149 + local141 * local141));
    ...
    @Pc(543)
    float local543 = local230 * local188 * 2.0F;
    if (local543 > 1.0F) {
      local543 = 1.0F;
    }
    @Pc(554)
    int local554 = this.aClass4_Sub21_1.method3162();
    @Pc(564)
    int local564 = (int) (local543 * (float) (local554 >> 16 & 0xFF));
    if (local564 > 255) {
      local564 = 255;
    }
    @Pc(581)
    int local581 = (int) ((float) (local554 >> 8 & 0xFF) * local543);
    if (local581 > 255) {
      local581 = 255;
    }
    @Pc(594)
    int local594 = (int) (local543 * (float) (local554 & 0xFF));
  ...
  public void method2842(
    ...
    if (this.anInterface1_3 == null
        || (arg0 + arg1 < this.anInt3406
            || (arg1 - arg0 > this.anInt3412
                || (this.anInt3415 > arg2 + arg0 || arg2 - arg0 > this.anInt3409)))) {
      return;
    }
    for (@Pc(53) int local53 = this.anInt3415; local53 <= this.anInt3409; local53++) {
      for (@Pc(58) int local58 = this.anInt3406; local58 <= this.anInt3412; local58++) {
        @Pc(65)
        int local65 = local58 - arg1;
        @Pc(69)
        int local69 = local53 - arg2;
        if (local65 > -arg0
            && arg0 > local65
            && local69 > -arg0
            && arg0 > local69
            && arg3[arg0 + local65][local69 + arg0]) {
          this.aClass19_Sub2_22.method1901(
              (int) (this.aClass4_Sub21_1.method3159() * 255.0F) << 24);
