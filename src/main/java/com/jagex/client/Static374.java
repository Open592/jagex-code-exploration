...
public final class Static374 {
  ...
  public static final LocalizedString A_LOCALIZED_STRING___128 =
      new LocalizedString("Drop", "Fallen lassen", "Poser", "Largar");

  @OriginalMember(owner = "client!su", name = "o", descriptor = "Lclient!gk;")
  public static final LocalizedString stellarDawnIsLoadingPleaseWaitLocalizedString =
      new LocalizedString(
          "Stellar Dawn is loading - please wait...",
          "Mechscape wird geladen - bitte warten...",
  ...
  public static void method4994(@OriginalArg(0) boolean arg0) {
    if (arg0) {
      ...
      for (@Pc(19) Node_Sub43 local19 = (Node_Sub43) Static325.aHashMap_29.head();
          local19 != null;
          local19 = (Node_Sub43) Static325.aHashMap_29.next()) {
        if (!local19.hasNext()) {
          local19 = (Node_Sub43) Static325.aHashMap_29.head();
          if (local19 == null) {
            break;
          }
        }
  ...
  public static void method4998(@OriginalArg(0) Class247 arg0, @OriginalArg(2) boolean arg1) {
    @Pc(15)
    int local15 = arg0.anInt6821 == 0 ? arg0.anInt6833 : arg0.anInt6821;
    @Pc(27)
    int local27 = arg0.anInt6834 == 0 ? arg0.anInt6805 : arg0.anInt6834;
    Static218.method3278(
        local15,
        local27,
        Static297.aClass247ArrayArray2[arg0.anInt6809 >> 16],
        arg0.anInt6809,
        arg1);
    ...
    @Pc(62)
    Node_Sub43 local62 = (Node_Sub43) Static325.aHashMap_29.get((long) arg0.anInt6809);
    if (local62 != null) {
