...
public final class ListNode_Sub13 extends ListNode {
	...
	public ListNode_Sub13(@OriginalArg(0) byte[] arg0) {
	...
	public ListNode_Sub4_Sub1 method1322(@OriginalArg(0) int[] arg0) {
		...
		return new ListNode_Sub4_Sub1(this.anInt1467, local129, this.anInt1462, this.anInt1463, this.aBoolean126);
	}
