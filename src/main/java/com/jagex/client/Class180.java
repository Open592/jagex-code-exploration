...
public final class Class180 {
  ...
  public Class180(
    ...
    this.aJs5_62 = arg2;
    if (this.aJs5_62 != null) {
      this.aJs5_62.method2108(11);
    }
  }
  ...
  public void method4116() {
    @Pc(14)
    Class68 local14 = this.aClass68_32;
    synchronized (this.aClass68_32) {
      this.aClass68_32.clear();
    }
  }
  ...
  public void method4118() {
    @Pc(2)
    Class68 local2 = this.aClass68_32;
    synchronized (this.aClass68_32) {
  ...
  public Class133 method4121(@OriginalArg(1) int arg0) {
    @Pc(6)
    Class68 local6 = this.aClass68_32;
    @Pc(24)
    Class133 local24;
    synchronized (this.aClass68_32) {
    ...
    @Pc(41)
    byte[] local41 = this.aJs5_62.method2104(arg0, 11);
    local24 = new Class133();
    if (local41 != null) {
      local24.method3354(new Packet(local41));
    }
    @Pc(57)
    Class68 local57 = this.aClass68_32;
    synchronized (this.aClass68_32) {
