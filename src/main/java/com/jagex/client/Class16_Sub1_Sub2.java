...
public final class Class16_Sub1_Sub2 extends Class16_Sub1 {
  ...
  public Class16_Sub1_Sub2(
    ...
    this.anInt1349 = arg4;
    @Pc(49)
    Class161 local49 = Static352.aClass194_2.method4421(this.anInt1365);
    @Pc(52)
    int local52 = local49.anInt5002;
    if (local52 == -1) {
    ...
    if (this.anInt1346 == arg2) {
      Static15.method156(
          super.anInt6893, this.anInt1358, super.aByte82, super.anInt6892, this.aClass138_2, false);
    }
  }

  @OriginalMember(owner = "client!dd", name = "a", descriptor = "(IILclient!ya;B)Lclient!t;")
  private Class110 method1240(
      @OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class19 arg2) {
    @Pc(13)
    Class161 local13 = Static352.aClass194_2.method4421(arg0);
    @Pc(18)
    Class65 local18 = Static67.aClass65Array1[super.aByte82];
    @Pc(31)
    Class65 local31 = this.anInt1349 >= 3 ? null : Static67.aClass65Array1[this.anInt1349 + 1];
  ...
  public void method5335(@OriginalArg(0) Class19 arg0) {
    @Pc(16)
    Class110 local16 = this.method1240(this.anInt1365, 0, arg0);
    if (local16 != null) {
  ...
  public Class3_Sub3 method5339(@OriginalArg(0) Class19 arg0) {
    @Pc(26)
    Class110 local26 = this.method1240(this.anInt1365, (this.anInt1347 == 0 ? 0 : 5) | 0x800, arg0);
    if (local26 == null) {
      return null;
    }
    if (this.anInt1347 != 0) {
  ...
  private void method1245(@OriginalArg(0) Class110 arg0, @OriginalArg(1) Class19 arg1) {
    @Pc(6)
    Class29[] local6 = arg0.method4881();
    @Pc(14)
    Class179[] local14 = arg0.method4885();
    if ((this.aClass3_Sub2_2 == null || this.aClass3_Sub2_2.aBoolean24)
        && (local6 != null || local14 != null)) {
