...
public final class Static313 {
  ...
  public static void method4175(
    ...
    if (Static381.anInt6417 >= 100) {
      @Pc(30)
      int local30 = Static111.anInt2379 * 128 + 64;
      @Pc(36)
      int local36 = Static419.anInt6924 * 128 + 64;
      @Pc(45)
      int local45 = Static13.method135(local30, Static263.anInt4963, local36) - Static238.anInt4509;
      @Pc(50)
      int local50 = local30 - Static163.anInt3197;
      @Pc(55)
      int local55 = local45 - Static100.anInt2024;
      @Pc(59)
      int local59 = local36 - Static145.anInt2906;
      @Pc(70)
      int local70 = (int) Math.sqrt((double) (local59 * local59 + local50 * local50));
      Static431.anInt7074 =
          (int) (Math.atan2((double) local55, (double) local70) * 2607.5945876176133D) & 0x3FFF;
      Static136.anInt2790 =
          (int) (Math.atan2((double) local50, (double) local59) * -2607.5945876176133D) & 0x3FFF;
  ...
  public static void method4176(@OriginalArg(1) int arg0) {
    @Pc(13)
    SecondaryNode_Sub1_Sub11 local13 = Static405.method5222(arg0, 12);
    local13.method2608();
  }
}
