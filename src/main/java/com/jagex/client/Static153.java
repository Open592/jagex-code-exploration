...
public final class Static153 {
  ...
  public static final LocalizedString A_LOCALIZED_STRING___60 =
      new LocalizedString("green:", "grün:", "vert:", "verde:");
  ...
  public static void method2603(
    ...
    @Pc(19)
    long local19 = (long) (arg2 | (arg4 ? Integer.MIN_VALUE : 0));
    @Pc(25)
    Node_Sub25 local25 = (Node_Sub25) Static208.A_HASH_MAP___11.get(local19);
    if (local25 == null) {
      local25 = new Node_Sub25();
      Static208.A_HASH_MAP___11.set(local19, local25);
    }
    if (local25.anIntArray230.length <= arg0) {
      @Pc(48)
      int[] local48 = new int[arg0 + 1];
      @Pc(53)
      int[] local53 = new int[arg0 + 1];
  ...
  public static void method2610(@OriginalArg(0) int arg0) {
    @Pc(7)
    int local7 = client.gameLogicStepCount - Static294.anInt446;
    if (local7 >= 100) {
      Static111.anInt2386 = 1;
      return;
    }
    @Pc(16)
    int local16 = (int) Static164.aFloat142;
    ...
    @Pc(53)
    int local53 = Static273.anInt5119 + (int) Static368.aFloat192 & 0x3FFF;
    Static195.method3072(
        ...
        local16);
    @Pc(98)
    float local98 = 1.0F - (float) ((100 - local7) * (-local7 + 100) * (100 - local7)) / 1000000.0F;
    Static145.anInt2906 =
        (int)
            (local98 * (float) (Static145.anInt2906 - Static59.anInt1090)
                + (float) Static59.anInt1090);
    Static100.anInt2024 =
        (int)
            ((float) Static105.anInt2321
                + (float) (Static100.anInt2024 - Static105.anInt2321) * local98);
    Static431.anInt7074 =
        (int)
            ((float) Static204.anInt3896
                + (float) (Static431.anInt7074 - Static204.anInt3896) * local98);
    Static163.anInt3197 =
        (int)
            ((float) (Static163.anInt3197 - Static124.anInt2626) * local98
                + (float) Static124.anInt2626);
    @Pc(155)
    int local155 = Static136.anInt2790 - Static179.anInt3427;
    if (local155 > 8192) {
      local155 -= 16384;
