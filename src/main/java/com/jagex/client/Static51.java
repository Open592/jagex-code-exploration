...
public final class Static51 {
  ...
  public static boolean method839(@OriginalArg(0) String arg0) {
    ...
    @Pc(33)
    boolean local33 = false;
    @Pc(35)
    int local35 = 0;
    @Pc(38)
    int local38 = arg0.length();
    for (@Pc(40) int local40 = 0; local40 < local38; local40++) {
      @Pc(46)
      char local46 = arg0.charAt(local40);
      if (local40 == 0) {
        if (local46 == '-') {
          local26 = true;
          continue;
      ...
      @Pc(120)
      int local120 = local35 * 10 + local93;
  ...
  public static void method840(
    ...
    if (arg0 > 0 && !Static424.method5413(arg0)) {
      ...
      @Pc(38)
      int local38 = Static9.method92(arg4);
      @Pc(40)
      int local40 = 0;
      @Pc(47)
      int local47 = arg2 <= arg0 ? arg2 : arg0;
      @Pc(51)
      int local51 = arg0 >> 1;
      @Pc(55)
      int local55 = arg2 >> 1;
      ...
      byte[] local57 = arg3;
      @Pc(64)
      byte[] local64 = new byte[local38 * local51 * local55];
      while (true) {
        ...
        @Pc(83)
        int local83 = local38 * arg0;
        @Pc(85)
        byte[] local85 = local64;
        for (@Pc(87) int local87 = 0; local87 < local38; local87++) {
          ...
          int local93 = local87;
          @Pc(97)
          int local97 = local83 + local87;
          for (@Pc(99) int local99 = 0; local99 < local55; local99++) {
            for (@Pc(103) int local103 = 0; local103 < local51; local103++) {
              @Pc(109)
              byte local109 = local57[local93];
              local93 += local38;
              @Pc(119)
              int local119 = local109 + local57[local93];
              local93 += local38;
              @Pc(129)
              int local129 = local119 + local57[local97];
              local97 += local38;
              @Pc(139)
              int local139 = local129 + local57[local97];
