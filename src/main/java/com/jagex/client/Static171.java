...
public final class Static171 {
  ...
  public static void method2796(@OriginalArg(0) int arg0, @OriginalArg(2) boolean arg1) {
    @Pc(10)
    Node_Sub25 local10 = Static175.method2834(arg1, arg0);
    if (local10 != null) {
  ...
  public static String timestampToDateString(@OriginalArg(0) long timestamp) {
    ...
    @Pc(18)
    int dayOfWeek = Static253.GMTCalendar.get(Calendar.DAY_OF_WEEK);
    @Pc(22)
    int dayOfMonth = Static253.GMTCalendar.get(Calendar.DAY_OF_MONTH);
    @Pc(26)
    int monthString = Static253.GMTCalendar.get(Calendar.MONTH);
    @Pc(30)
    int year = Static253.GMTCalendar.get(Calendar.YEAR);
    @Pc(34)
    int hour = Static253.GMTCalendar.get(Calendar.HOUR_OF_DAY);
    @Pc(38)
    int minute = Static253.GMTCalendar.get(Calendar.MINUTE);
    @Pc(42)
    int second = Static253.GMTCalendar.get(Calendar.SECOND);
