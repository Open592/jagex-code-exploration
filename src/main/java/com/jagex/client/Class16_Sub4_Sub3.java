...
public final class Class16_Sub4_Sub3 extends Class16_Sub4 implements Interface6 {
  ...
  @OriginalMember(
      owner = "client!jp",
      name = "<init>",
      descriptor = "(Lclient!ya;Lclient!rd;IIIIZIZ)V")
  public Class16_Sub4_Sub3(
    ...
    @Pc(82)
    Class149 local82 = this.method3035(local67, this.aBoolean340, arg0);
    if (local82 != null) {
  ...
  private Class110 method3033(@OriginalArg(0) Class19 arg0, @OriginalArg(2) int arg1) {
    if (this.aClass110_4 != null && arg0.method4269(this.aClass110_4.P(), arg1) == 0) {
      ...
      @Pc(28)
      Class149 local28 = this.method3035(arg1, false, arg0);
  ...
  private Class149 method3035(
      @OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1, @OriginalArg(3) Class19 arg2) {
    @Pc(19)
    Class202 local19 = Static267.aClass262_2.method5560(this.aShort40 & 0xFFFF);
    @Pc(42)
    Class65 local42;
    @Pc(33)
    Class65 local33;
  ...
  public void method5337(
    ...
    @Pc(16)
    Class16_Sub4_Sub3 local16 = (Class16_Sub4_Sub3) arg2;
  ...
  public void method5348(@OriginalArg(0) Class19 arg0) {
    @Pc(20)
    SecondaryNode_Sub1_Sub4 local20;
    if (this.aClass4_Sub1_Sub4_3 == null && this.aBoolean340) {
      @Pc(33)
      Class149 local33 = this.method3035(262144, true, arg0);
  ...
  public boolean method5341(
    ...
    @Pc(15)
    Class110 local15 = this.method3033(arg1, 131072);
    if (local15 == null) {
      return false;
    } else {
      @Pc(20)
      Class31 local20 = arg1.method4289();
  ...
  public void method5349(@OriginalArg(1) Class19 arg0) {
    ...
    if (this.aClass4_Sub1_Sub4_3 == null && this.aBoolean340) {
      @Pc(25)
      Class149 local25 = this.method3035(262144, true, arg0);
