...
public final class Static53 {
  ...
  public static void method896(@OriginalArg(0) int arg0) {
    @Pc(1)
    int local1 = Static33.anInt606;
    @Pc(3)
    int[] local3 = Static99.anIntArray157;
    @Pc(11)
    int local11 = Static66.aBoolean508 ? local1 : local1 + Static12.anInt163;
    for (@Pc(13) int local13 = 0; local13 < local11; local13++) {
      @Pc(23)
      Class16_Sub1_Sub5 local23;
      if (local13 < local1) {
        local23 = Static267.aClass16_Sub1_Sub5_Sub1Array1[local3[local13]];
      } else {
        local23 =
            Static143.aClass16_Sub1_Sub5_Sub2Array1[Static342.anIntArray412[local13 - local1]];
      }
      if (local23.aByte82 == arg0) {
        ...
        if (local23.anInt6025 < 0) {
          ...
          @Pc(50)
          int local50 = local23.method4751();
          if ((local50 & 0x1) == 0) {
          ...
          if (local50 == 1) {
            ...
            @Pc(151)
            int local151 = local23.anInt6892 - local92 >> 7;
            @Pc(158)
            int local158 = local23.anInt6893 + local92 >> 7;
            @Pc(165)
            int local165 = local23.anInt6892 + local92 >> 7;
          ...
          if (local23 instanceof Class16_Sub1_Sub5_Sub1
              && local23.aClass4_Sub23_3 != null
              && client.gameLogicStepCount >= local23.aClass4_Sub23_3.anInt3191
              && client.gameLogicStepCount < local23.aClass4_Sub23_3.anInt3202) {
            ((Class16_Sub1_Sub5_Sub1) local23).aBoolean402 = false;
          }
          local23.aBoolean561 = false;
          local23.anInt6889 =
              Static13.method135(local23.anInt6893, local23.aByte82, local23.anInt6892);
  ...
  public static Node_Sub33 method900(@OriginalArg(0) Class247 arg0) {
    ...
    Node_Sub33 local13 =
        (Node_Sub33)
            Static211.A_HASH_MAP___18.get(((long) arg0.anInt6809 << 32) + (long) arg0.anInt6865);
  ...
  public static void method901(
    ...
    for (@Pc(1) int local1 = 0; local1 < arg0.length; local1++) {
      @Pc(6)
      Class247 local6 = arg0[local1];
      if (local6 != null && local6.anInt6850 == arg1) {
        @Pc(17)
        int local17 = local6.anInt6836 + arg6;
        @Pc(22)
        int local22 = local6.anInt6859 + arg7;
        @Pc(28)
        int local28;
        @Pc(30)
        int local30;
        ...
        if (local6.anInt6840 == 2) {
          ...
          @Pc(40)
          int local40 = local17 + local6.anInt6833;
          @Pc(45)
          int local45 = local22 + local6.anInt6805;
        ...
        if (local6.anInt6840 == 0
            || local6.aBoolean612
            || method900(local6).anInt5105 != 0
            || local6 == Static57.aClass247_1
            || local6.anInt6842 == Static155.anInt3645) {
          if (!method895(local6)) {
            ...
            if (local6.aBoolean624 || local28 < local32 && local30 < local34) {
              if (local6.aBoolean622
                  && arg8 >= local28
                  && arg9 >= local30
                  && arg8 < local32
                  && arg9 < local34) {
                for (@Pc(148)
                    Node_Sub34 local148 = (Node_Sub34) Static291.A_LINKED_LIST___35.tail();
                    local148 != null;
                    local148 = (Node_Sub34) Static291.A_LINKED_LIST___35.previous()) {
              ...
              @Pc(204)
              boolean local204;
              if (Static420.aClass80_1.method2234() >= local28
                  && Static420.aClass80_1.method2230() >= local30
                  && Static420.aClass80_1.method2234() < local32
                  && Static420.aClass80_1.method2230() < local34) {
                local204 = true;
              } else {
                local204 = false;
              }
              ...
              @Pc(248)
              boolean local248 = false;
              if (Static420.aClass80_1.method2235() && local204) {
                local248 = true;
              }
              @Pc(258)
              boolean local258 = false;
              @Pc(263)
              Node_Sub5 local263 = (Node_Sub5) Static413.A_LINKED_LIST___47.tail();
              if (local263 != null
                  && local263.method515() == 0
                  && local263.method518() >= local28
                  && local263.method519() >= local30
                  && local263.method518() < local32
                  && local263.method519() < local34) {
                local258 = true;
              }
              @Pc(296)
              int local296;
                ...
                for (local296 = 0; local296 < local6.aByteArray96.length; local296++) {
                  if (Static384.aClass244_1.method5489(local6.aByteArray96[local296])) {
                    if (local6.anIntArray516 == null
                        || client.gameLogicStepCount >= local6.anIntArray516[local296]) {
                      @Pc(328)
                      byte local328 = local6.aByteArray97[local296];
                      if (local328 == 0
                          || ((local328 & 0x8) == 0
                                  || !Static384.aClass244_1.method5489(86)
                                      && !Static384.aClass244_1.method5489(82)
                                      && !Static384.aClass244_1.method5489(81))
                              && ((local328 & 0x2) == 0 || Static384.aClass244_1.method5489(86))
                              && ((local328 & 0x1) == 0 || Static384.aClass244_1.method5489(82))
                              && ((local328 & 0x4) == 0 || Static384.aClass244_1.method5489(81))) {
                        if (local296 < 10) {
                          Static413.method5309(local296 + 1, "", local6.anInt6809, -1);
                        } else if (local296 == 10) {
                          Static336.method5139();
                          @Pc(399)
                          Node_Sub33 local399 = method900(local6);
                        ...
                        if (local430 == 0) {
                          ...
                          local6.anIntArray516[local296] = client.gameLogicStepCount + local430;
                        }
                      }
                    }
              ...
              if (local258) {
                Static96.method1680(
                    local263.method519() - local22, local6, local263.method518() - local17);
              }
              if (Static281.aClass247_12 != null
                  && Static281.aClass247_12 != local6
                  && local204
                  && method900(local6).method3904()) {
              ...
              if (local6.aBoolean612 || local6.anInt6842 != 0) {
                ...
                if (local204 && Static430.anInt3862 != 0 && local6.anObjectArray24 != null) {
                  ...
                  Static291.A_LINKED_LIST___35.addFirst(local515);
                }
                if (Static281.aClass247_12 != null
                    || Static234.aBoolean411
                    || local6.anInt6842 != Static329.anInt5689 && Static64.anInt1367 > 0) {
                  local258 = false;
                  local248 = false;
                  local204 = false;
                }
                ...
                if (local6.anInt6842 != 0) {
                  if (local6.anInt6842 == Static21.anInt295
                      || local6.anInt6842 == Static38.anInt671) {
                    ...
                    if (local6.anInt6842 == Static21.anInt295) {
                      if (!Static234.aBoolean411
                        ...
                        for (@Pc(598)
                            Class3_Sub4 local598 = (Class3_Sub4) Static101.aClass84_5.method2312();
                            local598 != null;
                            local598 = (Class3_Sub4) Static101.aClass84_5.method2309()) {
                          if (arg8 >= local598.anInt4019
                              && arg8 < local598.anInt4022
                              && arg9 >= local598.anInt4023
                              && arg9 < local598.anInt4021) {
                            Static314.method4198();
                  ...
                  if (local6.anInt6842 == Static155.anInt3645) {
                    if (local6.method5312(Static122.aClass19_16) == null
                        || Static184.anInt3532 != 0 && Static184.anInt3532 != 3
                        || Static234.aBoolean411
                        || arg8 < local28
                        || arg9 < local30
                        || arg8 >= local32
                    ...
                    if (local296 < local430
                        || local296 > local430 + local6.anIntArray519[local670]) {
                      continue;
                    }
                    ...
                    @Pc(754)
                    int local754 = local670 * local721 + local296 * local725 >> 15;
                    @Pc(764)
                    int local764 = local670 * local725 - local296 * local721 >> 15;
                    @Pc(775)
                    int local775;
                    @Pc(783)
                    int local783;
                    if (Static111.anInt2386 == 4) {
                      ...
                      @Pc(792)
                      int local792 = (Static1.aClass16_Sub1_Sub5_Sub1_1.method4751() - 1) * 64;
                      local775 =
                          (Static1.aClass16_Sub1_Sub5_Sub1_1.anInt6893 - local792 >> 7)
                              + (local754 >> 2);
                      local783 =
                          (Static1.aClass16_Sub1_Sub5_Sub1_1.anInt6892 - local792 >> 7)
                              - (local764 >> 2);
                    }
                    if (Static341.aBoolean599 && (Static434.anInt7378 & 0x40) != 0) {
                      @Pc(825)
                      Class247 local825 =
                          Static378.method3230(Static408.anInt6726, Static23.anInt350);
                      if (local825 == null) {
                        Static336.method5139();
                      } else {
                        Static380.method5017(
                            19,
                            false,
                            1L,
                            local775,
                  ...
                  if (local6.anInt6842 == Static329.anInt5689) {
                    ...
                    if (local258) {
                      local296 =
                          (int)
                              ((double) (local263.method518() - local17 - local6.anInt6833 / 2)
                                  * 2.0D
                                  / (double) Static148.aFloat178);
                      local670 =
                          (int)
                              -((double) (local263.method519() - local22 - local6.anInt6805 / 2)
                                  * 2.0D
                                  / (double) Static148.aFloat178);
                      local430 = Static314.anInt5471 + local296 + Static148.anInt5732;
                      local709 = Static46.anInt5156 + local670 + Static148.anInt5724;
                      @Pc(939)
                      SecondaryNode_Sub1_Sub5 local939 = Static107.method1990();
                      if (local939 == null) {
                        continue;
                      }
                      @Pc(944)
                      int[] local944 = new int[3];
                        ...
                        Static4.method4663(
                            Static450.anInt7339
                                + (int)
                                    ((double)
                                            (Static187.anInt3559
                                                - Static420.aClass80_1.method2234())
                                        * 2.0D
                                        / (double) Static148.aFloat179));
                        Static453.method5679(
                            Static96.anInt1933
                                - (int)
                                    ((double)
                                            (Static452.anInt7359
                                                - Static420.aClass80_1.method2230())
                                        * 2.0D
                                        / (double) Static148.aFloat179));
                      }
                      continue;
                    ...
                    if (Static64.anInt1367 > 0 && !Static105.aBoolean218) {
                      if ((Static64.anInt1361 == 1 || Static158.method2677())
                  ...
                  if (local6.anInt6842 == Static186.anInt3548) {
                    if (local248) {
                      Static79.method1395(
                          local6.anInt6833,
                          Static420.aClass80_1.method2234() - local17,
                          local6.anInt6805,
                          Static420.aClass80_1.method2230() - local22);
                    }
                    continue;
                  }
                ...
                if (local6.aBoolean617 && !local248) {
                  ...
                  if (local6.anObjectArray33 != null) {
                    ...
                    Static39.A_LINKED_LIST___3.addFirst(local515);
                  }
                }
                ...
                if (local6.anObjectArray8 != null) {
                  ...
                  Static237.A_LINKED_LIST___52.addFirst(local515);
                }
                @Pc(1483)
                Node_Sub34 local1483;
                if (local6.anObjectArray30 != null && Static314.anInt5473 > local6.anInt6827) {
                  if (local6.anIntArray518 == null || Static314.anInt5473 - local6.anInt6827 > 32) {
                    ...
                    label678:
                    for (local296 = local6.anInt6827; local296 < Static314.anInt5473; local296++) {
                ...
                if (local6.anObjectArray34 != null && Static218.anInt4042 > local6.anInt6806) {
                  if (local6.anIntArray517 == null || Static218.anInt4042 - local6.anInt6806 > 32) {
                    ...
                    label654:
                    for (local296 = local6.anInt6806; local296 < Static218.anInt4042; local296++) {
                ...
                if (local6.anObjectArray18 != null && Static292.anInt5255 > local6.anInt6847) {
                  if (local6.anIntArray515 == null || Static292.anInt5255 - local6.anInt6847 > 32) {
                    ...
                    label630:
                    for (local296 = local6.anInt6847; local296 < Static292.anInt5255; local296++) {
                ...
                if (local6.anObjectArray19 != null && Static140.anInt2841 > local6.anInt6839) {
                  if (local6.anIntArray520 == null || Static140.anInt2841 - local6.anInt6839 > 32) {
                    ...
                    label606:
                    for (local296 = local6.anInt6839; local296 < Static140.anInt2841; local296++) {
                ...
                if (local6.anObjectArray36 != null && Static346.anInt5948 > local6.anInt6820) {
                  if (local6.anIntArray522 == null || Static346.anInt5948 - local6.anInt6820 > 32) {
                    ...
                    label582:
                    for (local296 = local6.anInt6820; local296 < Static346.anInt5948; local296++) {
                ...
                if (local6.anObjectArray20 != null) {
                  for (local296 = 0; local296 < Static190.anInt3602; local296++) {
                    @Pc(1951)
                    Node_Sub34 local1951 = new Node_Sub34();
                    ...
                    Static291.A_LINKED_LIST___35.addFirst(local1951);
                  }
                }
              ...
              if (local6.anInt6840 == 5 && local6.anInt6780 != -1) {
                local6
                    .method5311(Static238.aClass226_1, Static296.aClass217_1)
                    .method5248(local6.anInt6805, Static122.aClass19_16);
              }
              ...
              if (local6.anInt6840 == 0) {
                method901(
                    ...
                    local32,
                    local34,
                    local17 - local6.anInt6825,
                    local22 - local6.anInt6849,
                    arg8,
                    arg9);
                if (local6.aClass247Array2 != null) {
                  method901(
                      local6.aClass247Array2,
                      local6.anInt6809,
                      local28,
                      local30,
                      local32,
                ...
                @Pc(2073)
                Node_Sub43 local2073 =
                    (Node_Sub43) Static325.aHashMap_29.get((long) local6.anInt6809);
                if (local2073 != null) {
                  if (ClientSettings.modeGame.isRunescape()
                      && local2073.anInt6981 == 0
                      && !Static234.aBoolean411
                      && local204
                      && !Static415.aBoolean626) {
                    Static314.method4198();
                  }
                  Static59.method988(
                      local28,
  ...
  public static void method902(@OriginalArg(0) int arg0) {
    ...
    for (@Pc(5) int local5 = 0; local5 < local1 + Static12.anInt163; local5++) {
      ...
      if (local15.aByte82 == arg0 && local15.anInt6025 >= 0) {
        @Pc(35)
        int local35 = local15.method4751();
        if ((local35 & 0x1) == 0) {
        ...
        if (local35 == 1) {
          ...
          @Pc(138)
          int local138 = local15.anInt6892 - local71 >> 7;
          @Pc(145)
          int local145 = local15.anInt6893 + local71 >> 7;
          @Pc(152)
          int local152 = local15.anInt6892 + local71 >> 7;
  ...
  public static void method904() {
    ...
    for (@Pc(13) int local13 = 0; local13 < local11; local13++) {
      ...
      if (local23.anInt6025 >= 0) {
        @Pc(39)
        int local39 = local23.method4751();
        if ((local39 & 0x1) == 0) {
          if ((local23.anInt6893 & 0x7F) == 0 && (local23.anInt6892 & 0x7F) == 0) {
            continue;
          }
  ...
  public static Class247 method906(@OriginalArg(0) Class247 arg0) {
    @Pc(4)
    int local4 = method900(arg0).method3910();
    if (local4 == 0) {
      return null;
    }
  ...
  public static void method907() {
    ...
    for (@Pc(3) int local3 = 0; local3 < Static12.anInt163; local3++) {
      @Pc(10)
      Class16_Sub1_Sub5_Sub2 local10 =
          Static143.aClass16_Sub1_Sub5_Sub2Array1[Static342.anIntArray412[local3]];
      if (local10.aBoolean561 && local10.method4756() != -1) {
        @Pc(28)
        int local28 = (local10.method4751() - 1) * 64 + 60;
        @Pc(35)
        int local35 = local10.anInt6893 - local28 >> 7;
        @Pc(42)
        int local42 = local10.anInt6892 - local28 >> 7;
        @Pc(49)
        Class16_Sub1_Sub5 local49 = Static285.method3513(local42, local35, local10.aByte82);
        if (local49 != null) {
          @Pc(54)
          int local54 = local49.anInt6037;
    ...
    Static77.method1387(
        Static414.anIntArray525, 0, Static225.anIntArray290, Static304.anInt5369 - 1);
  }
  ...
  public static void method909() {
    for (@Pc(1) int local1 = 0; local1 < Static326.anInt5666; local1++) {
      @Pc(6)
      int[] local6 = Static50.anIntArrayArray8[local1];
  ...
  public static void method911() {
    ...
    for (@Pc(22) int local22 = 0; local22 < local1; local22++) {
      @Pc(29)
      Class16_Sub1_Sub5_Sub1 local29 = Static267.aClass16_Sub1_Sub5_Sub1Array1[local3[local22]];
      if (local29.method3425()) {
        local29.method5346();
        if (local29.aShort94 >= 0
            && local29.aShort96 >= 0
            && local29.aShort97 < Static326.anInt5666
            && local29.aShort95 < Static283.anInt5187) {
          ...
          if (local29 == Static1.aClass16_Sub1_Sub5_Sub1_1) {
            ...
            if (local29.anInt6072 > client.gameLogicStepCount) {
              local75 += 2;
            }
    ...
    for (@Pc(116) int local116 = 0; local116 < Static12.anInt163; local116++) {
      ...
      if (local123.method4762() && local123.aClass264_1.method5572(Static257.aClass114_1)) {
        ...
        if (local123.aShort94 >= 0
            && local123.aShort96 >= 0
            && local123.aShort97 < Static326.anInt5666
            && local123.aShort95 < Static283.anInt5187) {
          @Pc(160)
          int local160 = 0;
          if (!local123.aBoolean561) {
            local160++;
          }
          if (local123.anInt6072 > client.gameLogicStepCount) {
            local160 += 2;
          }
    ...
    for (local75 = 0; local75 < Static306.aClass38Array1.length; local75++) {
      @Pc(226)
      Class38 local226 = Static306.aClass38Array1[local75];
      if (local226 != null) {
        if (local226.anInt891 == 1) {
          @Pc(237)
          Class16_Sub1_Sub5_Sub2 local237 =
              Static143.aClass16_Sub1_Sub5_Sub2Array1[local226.anInt885];
          if (local237 != null && local237.anInt6025 >= 0) {
            local237.anInt6025 += 2048;
          }
        } else if (local226.anInt891 == 10) {
          @Pc(258)
          Class16_Sub1_Sub5_Sub1 local258 =
              Static267.aClass16_Sub1_Sub5_Sub1Array1[local226.anInt885];
          if (local258 != null
              && local258 != Static1.aClass16_Sub1_Sub5_Sub1_1
              && local258.anInt6025 >= 0) {
