...
public final class Static325 {
  ...
  public static int method4392(@OriginalArg(1) Class16_Sub1_Sub5_Sub2 arg0) {
    ...
    @Pc(28)
    int local28 = local8.anInt7202;
    @Pc(34)
    Class151 local34 = arg0.method4757();
    if (arg0.aBoolean562) {
      local28 = local8.anInt7210;
    } else if (arg0.anInt6076 == local34.anInt4669
        || local34.anInt4656 == arg0.anInt6076
        || local34.anInt4665 == arg0.anInt6076
        || arg0.anInt6076 == local34.anInt4686) {
      local28 = local8.anInt7212;
    } else if (arg0.anInt6076 == local34.anInt4667
        || local34.anInt4681 == arg0.anInt6076
        || arg0.anInt6076 == local34.anInt4688
        || local34.anInt4675 == arg0.anInt6076) {
  ...
  public static void method4395(
    ...
    @Pc(7)
    Class38[] local7 = Static306.aClass38Array1;
    for (@Pc(9) int local9 = 0; local9 < local7.length; local9++) {
      @Pc(15)
      Class38 local15 = local7[local9];
      if (local15 != null && local15.anInt891 == 2) {
        Static270.method3871(
            local15.anInt892,
            local15.anInt894,
            local15.anInt887,
            local15.anInt895 * 2,
        ...
        if (Static449.anIntArray557[0] > -1 && client.gameLogicStepCount % 20 < 10) {
          Static59.aClass57Array3[local15.anInt886].method5534(
              arg3 + Static449.anIntArray557[0] - 12, arg0 + (Static449.anIntArray557[1] - 28));
        }
      }
    }
  }
  ...
  public static void method4396(
      @OriginalArg(0) boolean arg0, @OriginalArg(1) Class16_Sub1_Sub5_Sub2 arg1) {
    ...
    if (!Static341.aBoolean599) {
      if (!arg0) {
        ...
        if (local84 != null) {
          for (local94 = 4; local94 >= 0; local94--) {
            if (local84[local94] != null
              ...
              byte local114 = 0;
              @Pc(116)
              int local116 = Static207.anInt5453;
              if (local94 == 0) {
                local114 = 11;
              }
              if (local94 == 1) {
        ...
        if (ClientSettings.modeGame.isRunescape() && local84 != null) {
          for (local94 = 4; local94 >= 0; local94--) {
            if (local84[local94] != null
                && local84[local94].equalsIgnoreCase(
                    Static81.A_LOCALIZED_STRING___33.getString(ClientSettings.langID))) {
      ...
      @Pc(339)
      Class133 local339 =
          Static7.anInt5460 == -1 ? null : Static153.aClass180_1.method4121(Static7.anInt5460);
      if ((Static434.anInt7378 & 0x2) != 0) {
        if (local339 == null
            || local16.method5582(local339.anInt4123, Static7.anInt5460) != local339.anInt4123) {
          Static380.method5017(
              22,
              false,
              (long) arg1.anInt6037,
              0,
              Static49.aString28 + " -> <col=ffff00>" + local34,
              true,
              Static388.aString62,
              0,
              -1,
  ...
  @OriginalMember(
      owner = "client!qh",
      name = "a",
      descriptor = "(BLclient!fd;ILjava/lang/String;)Lclient!wl;")
  public static Class267 method4397(
      @OriginalArg(1) Class19_Sub2 arg0, @OriginalArg(2) int arg1, @OriginalArg(3) String arg2) {
    @Pc(6)
    long local6 = OpenGL.glCreateShaderObjectARB(arg1);
    ...
    if (Static353.anIntArray434[0] == 0) {
      ...
      if (Static353.anIntArray434[1] > 1) {
        @Pc(53)
        byte[] local53 = new byte[Static353.anIntArray434[1]];
        OpenGL.glGetInfoLogARB(
            local6, Static353.anIntArray434[1], Static353.anIntArray434, 0, local53, 0);
