...
public final class SystemNanosecondFrameTimer extends FrameTimer {
	...
	private long getAverageIntervalNanoTime() {
		@Pc(1) long currentNanoTime = System.nanoTime();
		@Pc(7) long nanoDifference = currentNanoTime - this.lastNanoTime;
	...
	public int method2253(@OriginalArg(1) int frameTimeInMilliseconds) {
		@Pc(9) long frameTimeInNanoseconds = (long) frameTimeInMilliseconds * 1000000L;
