...
public final class Class217 {
  ...
  public void method4931() {
    @Pc(12)
    Class68 local12 = this.aClass68_44;
  ...
  public void method4932() {
    @Pc(2)
    Class68 local2 = this.aClass68_44;
    synchronized (this.aClass68_44) {
      this.aClass68_44.clear();
    }
  }
  ...
  public void method4933() {
    @Pc(5)
    Class68 local5 = this.aClass68_44;
    synchronized (this.aClass68_44) {
  ...
  public Class242 method4934(
      @OriginalArg(0) int arg0,
      @OriginalArg(1) int arg1,
      @OriginalArg(3) int arg2,
      @OriginalArg(4) int arg3,
      @OriginalArg(5) Class226 arg4) {
    @Pc(12)
    Class5[] local12 = null;
    @Pc(17)
    Class170 local17 = this.method4935(arg1);
    if (local17.anIntArray341 != null) {
      ...
      for (@Pc(27) int local27 = 0; local27 < local12.length; local27++) {
        @Pc(37)
        Class58 local37 = arg4.method5025(local17.anIntArray341[local27]);
        local12[local27] =
            new Class5(
                local37.anInt1719,
                local37.anInt1723,
  ...
  private Class170 method4935(@OriginalArg(0) int arg0) {
    @Pc(6)
    Class68 local6 = this.aClass68_44;
    @Pc(16)
    Class170 local16;
    synchronized (this.aClass68_44) {
    ...
    @Pc(33)
    byte[] local33 = this.aJs5_84.method2104(arg0, 29);
    local16 = new Class170();
    if (local33 != null) {
      local16.method3966(new Packet(local33));
    }
    @Pc(57)
    Class68 local57 = this.aClass68_44;
    synchronized (this.aClass68_44) {
