...
public final class Node_Sub15_Sub4 extends Node_Sub15 {
  ...
  private final Node_Sub15_Sub1 aClass4_Sub15_Sub1_2;

  @OriginalMember(owner = "client!se", name = "<init>", descriptor = "(Lclient!dv;)V")
  public Node_Sub15_Sub4(@OriginalArg(0) Node_Sub15_Sub1 arg0) {
  ...
  public void method4855(
    ...
    for (@Pc(17) Node_Sub28 local17 = (Node_Sub28) this.aLinkedList_44.tail();
        local17 != null;
        local17 = (Node_Sub28) this.aLinkedList_44.previous()) {
  ...
  private void method4862(@OriginalArg(1) Node_Sub28 arg0, @OriginalArg(2) int arg1) {
    if ((this.aClass4_Sub15_Sub1_2.anIntArray133[arg0.anInt4386] & 0x4) != 0
        && arg0.anInt4394 < 0) {
      @Pc(30)
      int local30 = this.aClass4_Sub15_Sub1_2.anIntArray129[arg0.anInt4386] / Static261.anInt4928;
      @Pc(39)
      int local39 = (local30 + 1048575 - arg0.anInt4391) / local30;
      arg0.anInt4391 = arg0.anInt4391 + local30 * arg1 & 0xFFFFF;
      if (local39 <= arg1) {
        if (this.aClass4_Sub15_Sub1_2.anIntArray124[arg0.anInt4386] == 0) {
          arg0.aClass4_Sub15_Sub3_3 =
              Static462.method4486(
                  arg0.aClass4_Sub4_Sub1_1,
                  arg0.aClass4_Sub15_Sub3_3.method4484(),
                  arg0.aClass4_Sub15_Sub3_3.method4469(),
                  arg0.aClass4_Sub15_Sub3_3.method4474());
        } else {
          arg0.aClass4_Sub15_Sub3_3 =
              Static462.method4486(
                  arg0.aClass4_Sub4_Sub1_1,
                  ...
                  0,
                  arg0.aClass4_Sub15_Sub3_3.method4474());
          this.aClass4_Sub15_Sub1_2.method1436(
              arg0.aClass4_Sub38_1.aShortArray192[arg0.anInt4384] < 0, arg0);
        }
  ...
  public Node_Sub15 method4860() {
    @Pc(9)
    Node_Sub28 local9 = (Node_Sub28) this.aLinkedList_44.tail();
    if (local9 == null) {
      return null;
  ...
  private void method4863(
      ...
      @OriginalArg(3) Node_Sub28 arg3,
      @OriginalArg(4) int arg4) {
    if ((this.aClass4_Sub15_Sub1_2.anIntArray133[arg3.anInt4386] & 0x4) != 0
        && arg3.anInt4394 < 0) {
      @Pc(31)
      int local31 = this.aClass4_Sub15_Sub1_2.anIntArray129[arg3.anInt4386] / Static261.anInt4928;
      while (true) {
        @Pc(42)
        int local42 = (local31 + 1048575 - arg3.anInt4391) / local31;
        if (local42 > arg2) {
        ...
        arg1 += local42;
        @Pc(73)
        int local73 = Static261.anInt4928 / 100;
        @Pc(77)
        int local77 = 262144 / local31;
        if (local77 < local73) {
          local73 = local77;
        }
        @Pc(85)
        Node_Sub15_Sub3 local85 = arg3.aClass4_Sub15_Sub3_3;
        if (this.aClass4_Sub15_Sub1_2.anIntArray124[arg3.anInt4386] == 0) {
          arg3.aClass4_Sub15_Sub3_3 =
              Static462.method4486(
                  arg3.aClass4_Sub4_Sub1_1,
                  local85.method4484(),
                  local85.method4469(),
                  local85.method4474());
        } else {
          arg3.aClass4_Sub15_Sub3_3 =
              Static462.method4486(
                  arg3.aClass4_Sub4_Sub1_1, local85.method4484(), 0, local85.method4474());
          this.aClass4_Sub15_Sub1_2.method1436(
              arg3.aClass4_Sub38_1.aShortArray192[arg3.anInt4384] < 0, arg3);
  ...
  public void method4861(@OriginalArg(0) int arg0) {
    ...
    for (@Pc(15) Node_Sub28 local15 = (Node_Sub28) this.aLinkedList_44.tail();
        local15 != null;
        local15 = (Node_Sub28) this.aLinkedList_44.previous()) {
