...
public final class Class27_Sub1 extends Class27 {
  ...
  public void method3935(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
    @Pc(16)
    int local16 = this.anInt653 * arg1 >> 12;
    @Pc(23)
    int local23 = arg0 * this.anInt644 >> 12;
    @Pc(30)
    int local30 = arg1 * this.anInt645 >> 12;
    @Pc(37)
    int local37 = this.anInt643 * arg0 >> 12;
    @Pc(44)
    int local44 = this.anInt650 * arg1 >> 12;
    @Pc(51)
    int local51 = this.anInt651 * arg0 >> 12;
    @Pc(58)
    int local58 = this.anInt657 * arg1 >> 12;
    @Pc(65)
    int local65 = this.anInt646 * arg0 >> 12;
    Static376.method4895(
        local58, local44, local37, local65, local30, local51, local16, super.anInt5152, local23);
  }
