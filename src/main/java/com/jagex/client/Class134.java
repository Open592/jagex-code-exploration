...
public final class Class134 {
  ...
  public Class134() {
    ...
    @Pc(23)
    boolean local23 = Static68.method1317() != 0;
    @Pc(27)
    int local27;
    @Pc(32)
    int local32;
    ...
    if (local23) {
      ...
      while (local27 < this.anInt4349) {
        @Pc(41)
        int local41 = Static68.method1314(Static329.method4426(this.anInt4349 - local27));
      ...
      @Pc(66)
      boolean local66 = Static68.method1317() != 0;
    ...
    if (local27 > 0) {
      @Pc(103)
      float local103 = Static68.method1323(Static68.method1314(32));
      @Pc(107)
      float local107 = Static68.method1323(Static68.method1314(32));
      local43 = Static68.method1314(4) + 1;
      @Pc(118)
      boolean local118 = Static68.method1317() != 0;
      @Pc(127)
      int local127;
      if (local27 == 1) {
      ...
      if (local27 == 1) {
        for (local163 = 0; local163 < this.anInt4349; local163++) {
          ...
          for (local170 = 0; local170 < this.anInt4350; local170++) {
            @Pc(177)
            int local177 = local163 / local168 % local127;
            @Pc(189)
            float local189 = (float) this.anIntArray285[local177] * local107 + local103 + local166;
      ...
      for (local163 = 0; local163 < this.anInt4349; local163++) {
        ...
        for (local170 = 0; local170 < this.anInt4350; local170++) {
          @Pc(240)
          float local240 = (float) this.anIntArray285[local168] * local107 + local103 + local166;
  ...
  private void method3433() {
    @Pc(3)
    int[] local3 = new int[this.anInt4349];
    @Pc(6)
    int[] local6 = new int[33];
    @Pc(14)
    int local14;
    @Pc(22)
    int local22;
      ...
      if (local26 != 0) {
        ...
        for (local54 = 0; local54 < local26; local54++) {
          ...
          if (local49 >= this.anIntArray287.length) {
            @Pc(178)
            int[] local178 = new int[this.anIntArray287.length * 2];
  ...
  public int method3434() {
    ...
    int local1;
    for (local1 = 0;
        this.anIntArray287[local1] >= 0;
        local1 = Static68.method1317() == 0 ? local1 + 1 : this.anIntArray287[local1]) {}
