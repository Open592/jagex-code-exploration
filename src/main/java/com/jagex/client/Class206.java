...
public final class Class206 {
  ...
  @OriginalMember(
      owner = "client!ro",
      name = "<init>",
      descriptor = "(Lclient!jk;IZLclient!ph;Lclient!fs;Lclient!fs;)V")
  public Class206(
      @OriginalArg(0) ModeGame arg0,
      @OriginalArg(1) int arg1,
      @OriginalArg(2) boolean arg2,
      @OriginalArg(3) Class180 arg3,
      @OriginalArg(4) Js5 arg4,
      @OriginalArg(5) Js5 arg5) {
  ...
  @OriginalMember(
      owner = "client!ro",
      name = "a",
      descriptor = "(ZLclient!cj;Lclient!la;IILclient!ya;ZIIIZLclient!ya;)Lclient!l;")
  public Class57 method4699(
      @OriginalArg(0) boolean arg0,
      @OriginalArg(1) Class37 arg1,
      ...
      @OriginalArg(11) Class19 arg10) {
    @Pc(16)
    Class57 local16 = this.method4700(arg10, arg3, arg1, arg4, arg7, arg9, arg8);
    if (local16 != null) {
      return local16;
    }
    @Pc(30)
    Class211 local30 = this.method4703(arg3);
    ...
    @Pc(92)
    int[] local92 = local30.method4774(arg1, arg0, arg2, arg7, arg9, arg4, arg10, arg8, arg5);
    if (local92 == null) {
      return null;
    }
    @Pc(106)
    ...
    if (!arg6) {
      @Pc(122)
      Class154 local122 = new Class154();
  ...
  @OriginalMember(
      owner = "client!ro",
      name = "a",
      descriptor = "(Lclient!ya;IILclient!cj;IIII)Lclient!l;")
  public Class57 method4700(
      @OriginalArg(0) Class19 arg0,
      @OriginalArg(1) int arg1,
      @OriginalArg(3) Class37 arg2,
  ...
  public void method4701() {
    @Pc(6)
    Class220 local6 = this.aClass220_1;
  ...
  public void method4702() {
    @Pc(12)
    Class68 local12 = this.aClass68_40;
    ...
    @Pc(44)
    Class220 local44 = this.aClass220_1;
    synchronized (this.aClass220_1) {
  ...
  public void method4706() {
    ...
    @Pc(38)
    Class220 local38 = this.aClass220_1;
    synchronized (this.aClass220_1) {
