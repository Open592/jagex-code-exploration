...
public final class Static119 {
	...
	public static LinkedEntry_Sub1_Sub1 method2147(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) Class186 arg2) {
		@Pc(10) int local10 = arg2.anInt5418 | arg1 << 8;
		@Pc(19) LinkedEntry_Sub1_Sub1 local19 = (LinkedEntry_Sub1_Sub1) Static48.aClass142_1.method3483((long) local10 << 16);
		if (local19 != null) {
			return local19;
		}
		...
		if (local33 == null) {
			...
			local19 = (LinkedEntry_Sub1_Sub1) Static48.aClass142_1.method3483((long) local10 << 16);
			if (local19 != null) {
				return local19;
			}
	...
	public static void method2150(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
		@Pc(16) LinkedEntry_Sub1_Sub11 local16 = Static405.method5222(arg0, 9);
		local16.method2604();
