...
public final class Class254 implements Runnable {
	...
	public LinkedHashEntry_Sub1_Sub6_Sub2 method5431(@OriginalArg(1) Class222 arg0, @OriginalArg(2) int arg1) {
		@Pc(7) LinkedHashEntry_Sub1_Sub6_Sub2 local7 = new LinkedHashEntry_Sub1_Sub6_Sub2();
	...
	public LinkedHashEntry_Sub1_Sub6_Sub2 method5432(@OriginalArg(0) Class222 arg0, @OriginalArg(2) int arg1) {
		@Pc(9) LinkedHashEntry_Sub1_Sub6_Sub2 local9 = new LinkedHashEntry_Sub1_Sub6_Sub2();
		local9.anInt4117 = 1;
		@Pc(15) Class229 local15 = this.aClass229_6;
		synchronized (this.aClass229_6) {
			@Pc(23) LinkedHashEntry_Sub1_Sub6_Sub2 local23 = (LinkedHashEntry_Sub1_Sub6_Sub2) this.aClass229_6.method5089();
			while (true) {
				if (local23 == null) {
					break;
				}
				...
				local23 = (LinkedHashEntry_Sub1_Sub6_Sub2) this.aClass229_6.method5092();
			}
		}
	...
	public void run() {
		while (!this.aBoolean659) {
			...
			@Pc(18) LinkedHashEntry_Sub1_Sub6_Sub2 local18;
			synchronized (this.aClass229_6) {
				local18 = (LinkedHashEntry_Sub1_Sub6_Sub2) this.aClass229_6.method5091();
				if (local18 == null) {
					try {
	...
	private void method5434(@OriginalArg(1) LinkedHashEntry_Sub1_Sub6_Sub2 arg0) {
	...
	public LinkedHashEntry_Sub1_Sub6_Sub2 method5435(@OriginalArg(1) int arg0, @OriginalArg(2) byte[] arg1, @OriginalArg(3) Class222 arg2) {
		@Pc(13) LinkedHashEntry_Sub1_Sub6_Sub2 local13 = new LinkedHashEntry_Sub1_Sub6_Sub2();
