...
public final class Node_Sub40 extends Node {
  ...
  public Node_Sub40(
    ...
    if (arg3) {
      @Pc(16)
      int[] local16 = new int[this.anInt6272];
      @Pc(20)
      int[] local20 = new int[this.anInt6272];
      @Pc(24)
      int[] local24 = new int[this.anInt6272];
      if (Static362.anIntArray445 == null
          || Static362.anIntArray445.length < this.anIntArray446.length) {
        Static362.anIntArray445 = new int[this.anIntArray446.length];
      }
      @Pc(40)
      int local40 = this.anInt6272;
      @Pc(43)
      int local43 = this.anInt6272;
      @Pc(47)
      int local47 = local40 - 1;
      @Pc(51)
      int local51 = local43 - 1;
      @Pc(55)
      int local55 = local40 * local43;
      @Pc(58)
      int local58 = local40;
      @Pc(59)
      int local59 = local40;
      ...
      for (@Pc(61) int local61 = 2; local61 >= 0; local61--) {
        for (local64 = local47; local64 >= 0; local64--) {
          local58--;
          @Pc(71)
          int local71 = this.anIntArray446[local58];
      ...
      for (@Pc(116) int local116 = local51; local116 >= 0; local116--) {
        ...
        for (local64 = local47; local64 >= 0; local64--) {
          ...
          local119--;
          @Pc(165)
          int local165 = local127 / 9;
          @Pc(169)
          int local169 = local124 / 9;
          @Pc(173)
          int local173 = local126 / 9;
          local114--;
        ...
        for (local64 = local47; local64 >= 0; local64--) {
          local58--;
          @Pc(236)
          int local236 = this.anIntArray446[local58];
          local59--;
          @Pc(242)
          int local242 = this.anIntArray446[local59];
      ...
      @Pc(306)
      int[] local306 = this.anIntArray446;
  ...
  public void method4876(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
    ...
    @Pc(21)
    int local21 = this.anIntArray446.length;
    @Pc(28)
    int local28 = this.anInt6272 - 1;
    @Pc(33)
    int local33 = this.anInt6272 * arg1;
    @Pc(37)
    int local37 = local21 - 1;
    for (@Pc(39) int local39 = 0; local39 < local21; local39 += this.anInt6272) {
      @Pc(46)
      int local46 = local39 + local33 & local37;
      for (@Pc(48) int local48 = 0; local48 < this.anInt6272; local48++) {
        @Pc(53)
        int local53 = local39 + local48;
        @Pc(61)
        int local61 = local46 + (local48 + arg0 & local28);
        Static362.anIntArray445[local53] = this.anIntArray446[local61];
      }
    }
    @Pc(84)
    int[] local84 = this.anIntArray446;
    this.anIntArray446 = Static362.anIntArray445;
