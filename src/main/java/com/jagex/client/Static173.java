...
public final class Static173 {
  ...
  public static void method2814(@OriginalArg(0) ISAACPacket arg0) {
    for (@Pc(3) int local3 = 0; local3 < Static441.anInt7199; local3++) {
      @Pc(9)
      int local9 = Static388.anIntArray497[local3];
      @Pc(13)
      Class16_Sub1_Sub5_Sub1 local13 = Static267.aClass16_Sub1_Sub5_Sub1Array1[local9];
      @Pc(17)
      int local17 = arg0.g1();
      if ((local17 & 0x4) != 0) {
        local17 += arg0.g1() << 8;
