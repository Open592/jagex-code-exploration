...
public final class Class16_Sub1_Sub5_Sub2 extends Class16_Sub1_Sub5 {
  ...
  public void method4760(
    ...
    if (super.anInt6029 != -1) {
      ...
      if (local37.aBoolean459
          && local37.anInt5002 != -1
          && Static182.aClass55_1.method1397(local37.anInt5002).anInt4410 == 1) {
        super.anInt6029 = -1;
      }
    }
    ...
    if (!arg3) {
      @Pc(96)
      int local96 = arg1 - super.anIntArray426[0];
      @Pc(104)
      int local104 = arg4 - super.anIntArray427[0];
  ...
  public Class3_Sub3 method5339(@OriginalArg(0) Class19 arg0) {
    ...
    @Pc(22)
    Class31 local22 = arg0.method4289();
    @Pc(27)
    int local27 = super.aClass35_7.method811();
    local22.ra(local27);
    ...
    if (Static323.aClass50_Sub1_1.aBoolean302 && local55.aBoolean684 && local42.aBoolean428) {
      ...
      @Pc(97)
      Class138 local97 =
          super.anInt6076 == -1 || super.aBoolean562 && local80 != null
              ? null
    ...
    @Pc(180)
    Class3_Sub3 local180 = null;
    if (this.method4765()) {
      local180 = Static38.method672(super.aClass110Array3.length);
    }
    if (super.aClass3_Sub2_7 == null) {
      arg0.method4307(
          super.aClass110Array3, local22, local180 == null ? null : local180.aClass3_Sub5Array1, 0);
    } else {
      @Pc(211)
      Class146 local211 = super.aClass3_Sub2_7.method171();
      arg0.method4299(
          super.aClass110Array3,
          local211,
          local22,
          local180 == null ? null : local180.aClass3_Sub5Array1,
          0);
    }
    ...
    if (super.aClass110Array3[2] != null) {
      ...
      super.aClass110Array3[2].JA(
          super.anInt6893 - super.aClass4_Sub23_3.anInt3198,
  ...
  public void method4763(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
    @Pc(18)
    int local18 = super.anIntArray426[0];
    @Pc(23)
    int local23 = super.anIntArray427[0];
    if (arg0 == 0) {
      local23++;
    }
    if (arg0 == 1) {
    ...
    if (super.anInt6029 != -1) {
      ...
      if (local91.aBoolean459
          && local91.anInt5002 != -1
          && Static182.aClass55_1.method1397(local91.anInt5002).anInt4410 == 1) {
        super.anInt6029 = -1;
      }
    }
    if (super.anInt6045 != -1) {
  ...
  private boolean method4764(@OriginalArg(1) Class19 arg0, @OriginalArg(2) int arg1) {
    ...
    @Pc(43)
    Class138 local43 =
        super.anInt6076 == -1 || super.aBoolean562 && local26 != null
            ? null
            : Static182.aClass55_1.method1397(super.anInt6076);
    @Pc(46)
    int local46 = local11.anInt4662;
    @Pc(49)
    int local49 = local11.anInt4670;
    ...
    boolean local98 =
        super.aByte68 != 0
            && client.gameLogicStepCount >= super.anInt6020
    ...
    @Pc(152)
    int local152 = super.aClass35_7.method811();
    ...
    if (super.aClass4_Sub23_3 != null) {
      if (super.aClass4_Sub23_3.anInt3202 <= client.gameLogicStepCount) {
        super.aClass4_Sub23_3 = null;
      } else if (super.aClass4_Sub23_3.anInt3191 <= client.gameLogicStepCount) {
        @Pc(564)
        Class110 local564 = super.aClass4_Sub23_3.method2719(arg0, local7 | 0x7);
        if (local564 != null) {
          local564.JA(
              -super.anInt6893 + super.aClass4_Sub23_3.anInt3198,
              super.aClass4_Sub23_3.anInt3188 + -super.anInt6889,
