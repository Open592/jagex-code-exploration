...
public final class LinkedHashEntry_Sub35 extends LinkedHashEntry {
	...
	private LinkedHashEntry_Sub35() {
	}

	@OriginalMember(owner = "client!ou", name = "<init>", descriptor = "(Ljava/lang/String;I)V")
	public LinkedHashEntry_Sub35(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1) {
		this.aString51 = arg0;
	}
}
