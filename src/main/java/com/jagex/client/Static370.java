...
public final class Static370 {
  ...
  public static Node_Sub12_Sub2 aNode_Sub12_Sub2_3 = new Node_Sub12_Sub2(8192);

  @OriginalMember(owner = "client!sq", name = "a", descriptor = "(ILclient!fs;BI)Lclient!jq;")
  public static Class122 method4948(@OriginalArg(1) Js5 arg0, @OriginalArg(3) int arg1) {
    @Pc(11)
    byte[] local11 = arg0.method2104(0, arg1);
  ...
  public static int method4949(@OriginalArg(0) int arg0) {
    ...
    int local0 = arg0 - 1;
    @Pc(15)
    int local15 = local0 | local0 >>> 1;
    @Pc(21)
    int local21 = local15 | local15 >>> 2;
    @Pc(27)
    int local27 = local21 | local21 >>> 4;
    @Pc(33)
    int local33 = local27 | local27 >>> 8;
    @Pc(39)
    int local39 = local33 | local33 >>> 16;
    return local39 + 1;
  }
}
