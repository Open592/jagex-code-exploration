...
public final class Class70_Sub1 extends Class70 {
  ...
  public void method5077(@OriginalArg(1) int arg0) {
    @Pc(14)
    Object local14 = this.anObject12;
  ...
  private void method1814(@OriginalArg(1) int arg0) {
    ...
    if (this.anInt2072 > 0) {
      @Pc(53)
      Object local53 = this.anObject12;
      synchronized (this.anObject12) {
        this.anObject12.notifyAll();
      }
    }
  ...
  public void method5073() {
    @Pc(12)
    Object local12 = this.anObject12;
    synchronized (this.anObject12) {
  ...
  public void method5075(@OriginalArg(0) int arg0) {
    ...
    int local7 = 0;
    @Pc(10)
    Object local10 = this.anObject12;
    synchronized (this.anObject12) {
      @Pc(18)
      int local18;
  ...
  private void method1817(@OriginalArg(1) int arg0) {
    ...
    if (this.anInt2072 > 0) {
      @Pc(49)
      Object local49 = this.anObject12;
      synchronized (this.anObject12) {
        this.anObject12.notifyAll();
      }
    }
    ...
    try {
      ...
      if (!local7) {
        ...
        if (local45 == 21) {
          ...
          @Pc(134)
          Class164 local134 = (Class164) arg0.anObject27;
          ...
          for (@Pc(179) Class7 local179 = local134.aClass7_3;
              local179 != null;
              local179 = local179.aClass7_1) {
          ...
          ((Class65) arg0.anObject27)
              .method4029(
                  Static431.anInt7073,
                  Static93.anInt1887,
                  Static230.anInt4431,
                  Static252.aBooleanArrayArray4,
                  local45 - 30 == 0);
      ...
      @Pc(339)
      Object local339 = null;
      if (local7) {
        @Pc(405)
        Object local405 = this.anObject12;
        synchronized (this.anObject12) {
          super.anInt6473--;
          if (super.anInt6473 == 0) {
            this.anObject12.notifyAll();
