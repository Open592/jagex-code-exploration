...
public final class Class99_Sub1_Sub2 extends Class99_Sub1 {
  ...
  public Class6_Sub4 method3232() {
    if (this.aClass6_Sub4_2 == null) {
      @Pc(17)
      Interface7 local17 = this.aClass19_Sub2_24.anInterface7_6;
      ...
      for (@Pc(53) int local53 = 0; local53 < 6; local53++) {
        ...
        @Pc(73)
        Class251 local73 = local17.method2396(Static259.anIntArray314[local53]);
        @Pc(80)
        int local80 = local73.aBoolean637 ? 64 : 128;
      ...
      for (@Pc(105) int local105 = 0; local105 < 6; local105++) {
        Static365.anIntArrayArray57[local105] =
            local17.method2393(false, Static259.anIntArray314[local105], 1.0F, local51, local51);
      }
      this.aClass6_Sub4_2 =
          new Class6_Sub4(
              this.aClass19_Sub2_24, 6407, local51, local49, Static365.anIntArrayArray57);
    }
