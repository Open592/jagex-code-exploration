...
public final class Static40 {
  ...
  public static void method697(
      @OriginalArg(1) Class247 arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
  ...
  public static int method698(
      @OriginalArg(1) String arg0, @OriginalArg(2) String arg1, @OriginalArg(3) int arg2) {
    @Pc(8)
    int local8 = arg1.length();
    @Pc(11)
    int local11 = arg0.length();
    @Pc(13)
    int local13 = 0;
    @Pc(15)
    int local15 = 0;
    ...
    @Pc(137)
    int local137 = Math.min(local8, local11);
    for (@Pc(139) int local139 = 0; local139 < local137; local139++) {
      ...
      @Pc(170)
      char local170 = arg1.charAt(local13);
      @Pc(174)
      char local174 = arg0.charAt(local15);
      if (local174 != local170
          && Character.toUpperCase(local170) != Character.toUpperCase(local174)) {
    ...
    @Pc(215)
    int local215 = local8 - local11;
    if (local215 != 0) {
      return local215;
    }
    for (@Pc(229) int local229 = 0; local229 < local137; local229++) {
      @Pc(235)
      char local235 = arg1.charAt(local229);
      @Pc(239)
      char local239 = arg0.charAt(local229);
