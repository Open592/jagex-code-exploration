...
public final class Node_Sub15_Sub1 extends Node_Sub15 {
	...
	private void method1424(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		@Pc(123) Node_Sub4_Sub1 local123 = local115.aClass4_Sub4_Sub1Array1[arg1];
		if (local123 == null) {
			return;
		}
		@Pc(130) Node_Sub28 local130 = new Node_Sub28();
		...
		if (local130.anInt4385 >= 0) {
			@Pc(288) Node_Sub28 local288 = this.aClass4_Sub28ArrayArray2[arg0][local130.anInt4385];
	...
	private synchronized void method1426(@OriginalArg(0) Node_Sub30 arg0, @OriginalArg(1) boolean arg1, @OriginalArg(3) boolean arg2) {
	...
	public boolean method1449(@OriginalArg(0) Node_Sub28 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3) {
	...
	public synchronized void method1450(@OriginalArg(0) boolean arg0, @OriginalArg(2) Node_Sub30 arg1) {
	...
	private void method1452(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
		@Pc(12) Node_Sub28 local12 = this.aClass4_Sub28ArrayArray1[arg0][arg2];
		if (local12 == null) {
			return;
		}
