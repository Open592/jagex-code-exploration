...
public final class Node_Sub15_Sub1 extends Node_Sub15 {
  ...
  private Node_Sub30 aClass4_Sub30_1;
  ...
  private final Node_Sub28[][] aClass4_Sub28ArrayArray1 = new Node_Sub28[16][128];
  ...
  private final Node_Sub28[][] aClass4_Sub28ArrayArray2 = new Node_Sub28[16][128];
  ...
  private void method1421(@OriginalArg(1) int arg0) {
    for (@Pc(8) Node_Sub28 local8 = (Node_Sub28) this.aClass4_Sub15_Sub4_1.aLinkedList_44.tail();
        local8 != null;
        local8 = (Node_Sub28) this.aClass4_Sub15_Sub4_1.aLinkedList_44.previous()) {
  ...
  private void method1422(@OriginalArg(1) int arg0) {
    ...
    if (local9 == 128) {
      ...
      if (local28 == 101) {
        this.anIntArray121[local22] =
            (local125 << 7) + (this.anIntArray121[local22] & 0x7F) + 16384;
      }
      if (local28 == 100) {
      ...
      if (local28 == 6) {
        ...
        if (local516 == 16384) {
          this.anIntArray135[local22] =
              (local125 << 7) + (this.anIntArray135[local22] & 0xFFFFC07F);
        }
      }
      if (local28 == 38) {
        local516 = this.anIntArray121[local22];
  ...
  private void method1423(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
    ...
    this.anIntArray129[arg0] =
        (int) (Math.pow(2.0D, (double) arg1 * 5.4931640625E-4D) * 2097152.0D + 0.5D);
  }
  ...
  private void method1424(
    ...
    if ((this.anIntArray133[arg0] & 0x2) != 0) {
      for (@Pc(28)
          Node_Sub28 local28 = (Node_Sub28) this.aClass4_Sub15_Sub4_1.aLinkedList_44.head();
          local28 != null;
          local28 = (Node_Sub28) this.aClass4_Sub15_Sub4_1.aLinkedList_44.next()) {
        if (arg0 == local28.anInt4386 && local28.anInt4394 < 0) {
          ...
          @Pc(71)
          int local71 = local28.anInt4399 + (local28.anInt4390 * local28.anInt4398 >> 12);
    ...
    @Pc(115)
    Node_Sub38 local115 = (Node_Sub38) this.aHashMap_8.get((long) this.anIntArray122[arg0]);
    if (local115 == null) {
      return;
    }
    @Pc(123)
    Node_Sub4_Sub1 local123 = local115.aClass4_Sub4_Sub1Array1[arg1];
    if (local123 == null) {
      return;
    }
    @Pc(130)
    Node_Sub28 local130 = new Node_Sub28();
    ...
    local130.anInt4388 =
        local115.anInt5637 * arg2 * arg2 * local115.aByteArray70[arg1] + 1024 >> 11;
    ...
    if (this.anIntArray124[arg0] == 0) {
      local130.aClass4_Sub15_Sub3_3 =
          Static462.method4486(
              local123,
              this.method1454(local130),
              this.method1435(local130),
              this.method1439(local130));
    } else {
      local130.aClass4_Sub15_Sub3_3 =
          Static462.method4486(local123, this.method1454(local130), 0, this.method1439(local130));
    ...
    if (local130.anInt4385 >= 0) {
      @Pc(288)
      Node_Sub28 local288 = this.aClass4_Sub28ArrayArray2[arg0][local130.anInt4385];
  ...
  private synchronized void method1426(
      @OriginalArg(0) Node_Sub30 arg0, @OriginalArg(1) boolean arg1, @OriginalArg(3) boolean arg2) {
    this.method1443(arg1);
    this.aClass175_1.method4054(arg0.aByteArray58);
    this.aLong56 = 0L;
    this.aBoolean156 = arg2;
    @Pc(32)
    int local32 = this.aClass175_1.method4060();
  ...
  @Override
  public synchronized Node_Sub15 method4860() {
  ...
  private void method1429(@OriginalArg(1) int arg0) {
    for (@Pc(19) Node_Sub28 local19 = (Node_Sub28) this.aClass4_Sub15_Sub4_1.aLinkedList_44.tail();
        local19 != null;
        local19 = (Node_Sub28) this.aClass4_Sub15_Sub4_1.aLinkedList_44.previous()) {
  ...
  public boolean method1430(@OriginalArg(1) Node_Sub28 arg0) {
    ...
    if (arg0.anInt4394 >= 0) {
      arg0.popSelf();
      if (arg0.anInt4385 > 0
          && this.aClass4_Sub28ArrayArray2[arg0.anInt4386][arg0.anInt4385] == arg0) {
  ...
  public synchronized void method4861(@OriginalArg(0) int arg0) {
    if (this.aClass175_1.method4057()) {
      @Pc(14)
      int local14 = this.aClass175_1.anInt5296 * this.anInt1596 / Static261.anInt4928;
      do {
        @Pc(23)
        long local23 = (long) arg0 * (long) local14 + this.aLong56;
        if (this.aLong57 - local23 >= 0L) {
          this.aLong56 = local23;
          break;
        }
        @Pc(51)
        int local51 = (int) ((this.aLong57 + (long) local14 - this.aLong56 - 1L) / (long) local14);
  ...
  private void method1432() {
    @Pc(8)
    int local8 = this.anInt1631;
    @Pc(11)
    int local11 = this.anInt1632;
    @Pc(14)
    long local14 = this.aLong57;
    ...
    while (local11 == this.anInt1632) {
      while (this.aClass175_1.anIntArray347[local8] == local11) {
        ...
        @Pc(47)
        int local47 = this.aClass175_1.method4058(local8);
        if (local47 == 1) {
  ...
  private int method1435(@OriginalArg(0) Node_Sub28 arg0) {
    if (this.anIntArray125[arg0.anInt4386] == 0) {
      return 0;
    }
    @Pc(14)
    Class252 local14 = arg0.aClass252_1;
    @Pc(30)
    int local30 =
        this.anIntArray120[arg0.anInt4386] * this.anIntArray134[arg0.anInt4386] + 4096 >> 13;
    @Pc(38)
    int local38 = local30 * local30 + 16384 >> 15;
    @Pc(47)
    int local47 = local38 * arg0.anInt4388 + 16384 >> 15;
    @Pc(56)
    int local56 = local47 * this.anInt1602 + 128 >> 8;
    local30 = this.anIntArray125[arg0.anInt4386] * local56 + 128 >> 8;
    if (local14.anInt6937 > 0) {
      local30 =
          (int)
              (Math.pow(0.5D, (double) local14.anInt6937 * (double) arg0.anInt4396 * 1.953125E-5D)
                      * (double) local30
                  + 0.5D);
    }
    @Pc(103)
    ...
    if (local14.aByteArray100 != null) {
      ...
      if (arg0.anInt4395 < local14.aByteArray100.length - 2) {
        ...
        local111 +=
            (local103 - local133)
                * (local14.aByteArray100[arg0.anInt4395 - -3] - local111)
                / (local145 - local133);
      }
    ...
    if (arg0.anInt4394 > 0 && local14.aByteArray101 != null) {
      ...
      if (local14.aByteArray101.length - 2 > arg0.anInt4382) {
        ...
        local111 +=
            (local14.aByteArray101[arg0.anInt4382 + 3] - local111)
                * (-local133 + local103)
                / (local145 - local133);
      }
      local30 = local30 * local111 + 32 >> 6;
  ...
  public void method1436(@OriginalArg(0) boolean arg0, @OriginalArg(2) Node_Sub28 arg1) {
    @Pc(17)
    int local17 = arg1.aClass4_Sub4_Sub1_1.aByteArray48.length;
    @Pc(36)
    int local36;
    if (arg0 && arg1.aClass4_Sub4_Sub1_1.aBoolean346) {
      @Pc(47)
      int local47 = local17 + local17 - arg1.aClass4_Sub4_Sub1_1.anInt3726;
  ...
  public synchronized void method1438() {
    for (@Pc(15) Node_Sub38 local15 = (Node_Sub38) this.aHashMap_8.head();
        local15 != null;
        local15 = (Node_Sub38) this.aHashMap_8.next()) {
      local15.method4393();
    }
  }

  @OriginalMember(owner = "client!dv", name = "a", descriptor = "(Lclient!lm;I)I")
  private int method1439(@OriginalArg(0) Node_Sub28 arg0) {
    @Pc(20)
    int local20 = this.anIntArray131[arg0.anInt4386];
    return local20 >= 8192
        ? 16384 - ((16384 - local20) * (-arg0.anInt4392 + 128) + 32 >> 6)
        : local20 * arg0.anInt4392 + 32 >> 6;
  }
  ...
  private void method1446(@OriginalArg(1) int arg0) {
    ...
    for (@Pc(26) Node_Sub28 local26 = (Node_Sub28) this.aClass4_Sub15_Sub4_1.aLinkedList_44.tail();
        local26 != null;
        local26 = (Node_Sub28) this.aClass4_Sub15_Sub4_1.aLinkedList_44.previous()) {
  ...
  public boolean method1449(
    ...
    @Pc(56)
    int local56 = arg0.anInt4398;
    if (local56 > 0) {
      local56 -=
          (int)
              (Math.pow(2.0D, (double) this.anIntArray123[arg0.anInt4386] * 4.921259842519685E-4D)
                      * 16.0D
                  + 0.5D);
      if (local56 < 0) {
        local56 = 0;
    ...
    @Pc(96)
    Class252 local96 = arg0.aClass252_1;
    arg0.anInt4397++;
    arg0.anInt4389 += local96.anInt6939;
    @Pc(120)
    boolean local120 = false;
    @Pc(138)
    double local138 =
        (double) ((arg0.anInt4390 * arg0.anInt4398 >> 12) + (arg0.anInt4384 - 60 << 8))
    ...
    if (local96.anInt6937 > 0) {
      if (local96.anInt6938 <= 0) {
        ...
        arg0.anInt4396 +=
            (int) (Math.pow(2.0D, (double) local96.anInt6938 * local138) * 128.0D + 0.5D);
      }
    ...
    if (local96.aByteArray100 != null) {
      if (local96.anInt6943 <= 0) {
        ...
        arg0.anInt4393 +=
            (int) (Math.pow(2.0D, (double) local96.anInt6943 * local138) * 128.0D + 0.5D);
      }
      while (arg0.anInt4395 < local96.aByteArray100.length - 2
          && arg0.anInt4393 > (local96.aByteArray100[arg0.anInt4395 + 2] & 0xFF) << 8) {
        arg0.anInt4395 += 2;
      }
      if (local96.aByteArray100.length - 2 == arg0.anInt4395
          && local96.aByteArray100[arg0.anInt4395 + 1] == 0) {
        local120 = true;
      }
    }
    if (arg0.anInt4394 >= 0
        && local96.aByteArray101 != null
        && (this.anIntArray133[arg0.anInt4386] & 0x1) == 0
        && (arg0.anInt4385 < 0
            || this.aClass4_Sub28ArrayArray2[arg0.anInt4386][arg0.anInt4385] != arg0)) {
      if (local96.anInt6941 > 0) {
        arg0.anInt4394 +=
            (int) (Math.pow(2.0D, (double) local96.anInt6941 * local138) * 128.0D + 0.5D);
      } else {
        arg0.anInt4394 += 128;
      }
      while (local96.aByteArray101.length - 2 > arg0.anInt4382
          && arg0.anInt4394 > (local96.aByteArray101[arg0.anInt4382 + 2] & 0xFF) << 8) {
        arg0.anInt4382 += 2;
      }
    ...
    if (!local120) {
      arg0.aClass4_Sub15_Sub3_3.method4480(
          arg0.anInt4380, this.method1435(arg0), this.method1439(arg0));
      return false;
    }
    ...
    if (arg0.anInt4394 >= 0) {
      arg0.popSelf();
      if (arg0.anInt4385 > 0
          && arg0 == this.aClass4_Sub28ArrayArray2[arg0.anInt4386][arg0.anInt4385]) {
        this.aClass4_Sub28ArrayArray2[arg0.anInt4386][arg0.anInt4385] = null;
      }
    }
    return true;
  ...
  public synchronized void method1450(
      @OriginalArg(0) boolean arg0, @OriginalArg(2) Node_Sub30 arg1) {
  ...
  private void method1451(@OriginalArg(1) int arg0) {
    ...
    for (@Pc(18) Node_Sub28 local18 = (Node_Sub28) this.aClass4_Sub15_Sub4_1.aLinkedList_44.tail();
        local18 != null;
        local18 = (Node_Sub28) this.aClass4_Sub15_Sub4_1.aLinkedList_44.previous()) {
      if (local18.anInt4386 == arg0
          && this.aClass4_Sub28ArrayArray1[arg0][local18.anInt4384] == null
          && local18.anInt4394 < 0) {
        local18.anInt4394 = 0;
      }
    }
  ...
  @OriginalMember(owner = "client!dv", name = "a", descriptor = "([III)V")
  @Override
  public synchronized void method4855(
      @OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
    if (this.aClass175_1.method4057()) {
      @Pc(14)
      int local14 = this.anInt1596 * this.aClass175_1.anInt5296 / Static261.anInt4928;
      do {
        @Pc(23)
        long local23 = (long) local14 * (long) arg2 + this.aLong56;
        if (this.aLong57 - local23 >= 0L) {
          this.aLong56 = local23;
          break;
        }
        @Pc(54)
        int local54 = (int) ((this.aLong57 + (long) local14 - this.aLong56 - 1L) / (long) local14);
  ...
  private void method1452(
    ...
    @Pc(12)
    Node_Sub28 local12 = this.aClass4_Sub28ArrayArray1[arg0][arg2];
    if (local12 == null) {
      return;
    }
    ...
    for (@Pc(49) Node_Sub28 local49 = (Node_Sub28) this.aClass4_Sub15_Sub4_1.aLinkedList_44.tail();
        local49 != null;
        local49 = (Node_Sub28) this.aClass4_Sub15_Sub4_1.aLinkedList_44.previous()) {
  ...
  private int method1454(@OriginalArg(1) Node_Sub28 arg0) {
    @Pc(14)
    int local14 = (arg0.anInt4398 * arg0.anInt4390 >> 12) + arg0.anInt4399;
    local14 +=
        (this.anIntArray126[arg0.anInt4386] - 8192) * this.anIntArray135[arg0.anInt4386] >> 12;
    @Pc(41)
    Class252 local41 = arg0.aClass252_1;
    @Pc(64)
    int local64;
    if (local41.anInt6939 > 0
        && (local41.anInt6940 > 0 || this.anIntArray128[arg0.anInt4386] > 0)) {
      local64 = local41.anInt6940 << 2;
      @Pc(69)
      int local69 = local41.anInt6944 << 1;
      if (local69 > arg0.anInt4397) {
        local64 = arg0.anInt4397 * local64 / local69;
      }
      local64 += this.anIntArray128[arg0.anInt4386] >> 7;
      @Pc(99)
      double local99 = Math.sin((double) (arg0.anInt4389 & 0x1FF) * 0.01227184630308513D);
      local14 += (int) (local99 * (double) local64);
    }
    local64 =
        (int)
            ((double) (arg0.aClass4_Sub4_Sub1_1.anInt3727 * 256)
                    * Math.pow(2.0D, (double) local14 * 3.255208333333333E-4D)
                    / (double) Static261.anInt4928
                + 0.5D);
  ...
  @OriginalMember(
      owner = "client!dv",
      name = "a",
      descriptor = "(ILclient!oj;ZLclient!fs;Lclient!nb;)Z")
  public synchronized boolean method1456(
      @OriginalArg(1) Class171 arg0, @OriginalArg(3) Js5 arg1, @OriginalArg(4) Node_Sub30 arg2) {
    arg2.method3726();
    @Pc(9)
    boolean local9 = true;
    @Pc(20)
    int[] local20 = new int[] {22050};
    for (@Pc(26) Node_Sub19 local26 = (Node_Sub19) arg2.aHashMap_23.head();
        local26 != null;
        local26 = (Node_Sub19) arg2.aHashMap_23.next()) {
      @Pc(32)
      int local32 = (int) local26.hashKey;
      @Pc(40)
      Node_Sub38 local40 = (Node_Sub38) this.aHashMap_8.get((long) local32);
      if (local40 == null) {
