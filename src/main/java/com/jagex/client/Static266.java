...
public final class Static266 {
  ...
  public static int method3825(@OriginalArg(1) int arg0) {
    @Pc(14)
    double local14 = (double) (arg0 >> 16 & 0xFF) / 256.0D;
    @Pc(23)
    double local23 = (double) (arg0 >> 8 & 0xFF) / 256.0D;
    @Pc(30)
    double local30 = (double) (arg0 & 0xFF) / 256.0D;
    @Pc(32)
    double local32 = local14;
    if (local14 > local23) {
      local32 = local23;
    }
    if (local32 > local30) {
    ...
    double local60 = 0.0D;
    @Pc(63)
    double local63 = (double) 0;
    @Pc(69)
    double local69 = (local32 + local46) / 2.0D;
    if (local32 != local46) {
      if (local69 < 0.5D) {
    ...
    local60 /= 6.0D;
    @Pc(157)
    int local157 = (int) (local60 * 256.0D);
    @Pc(162)
    int local162 = (int) (local63 * 256.0D);
    if (local162 < 0) {
      local162 = 0;
    ...
    @Pc(180)
    int local180 = (int) (local69 * 256.0D);
    if (local180 < 0) {
      local180 = 0;
  ...
  public static void method3827(
    ...
    if (arg3 >= Static354.anInt6186
        && Static208.anInt2656 >= arg2
        && arg0 >= Static376.anInt6287
        && arg5 <= Static168.anInt3256) {
