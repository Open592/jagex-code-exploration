...
public final class Static95 {
  ...
  public static void method1665(
      @OriginalArg(0) Packet arg0, @OriginalArg(1) int arg1, @OriginalArg(2) SignLink arg2) {
    @Pc(13)
    Node_Sub36 local13 = new Node_Sub36();
    ...
    for (@Pc(55) int local55 = 0; local55 < local13.anInt5309; local55++) {
      try {
        ...
        if (local61 == 0 || local61 == 1 || local61 == 2) {
          ...
          local13.aClass199Array1[local55] =
              arg2.emitGetDeclaredFieldMessage(Static323.method4383(local76), local80);
        } else if (local61 == 3 || local61 == 4) {
          local76 = arg0.gStringCP1252ToUTF8();
          local80 = arg0.gStringCP1252ToUTF8();
          local82 = arg0.g1();
          @Pc(135)
          String[] local135 = new String[local82];
          for (@Pc(137) int local137 = 0; local137 < local82; local137++) {
            local135[local137] = arg0.gStringCP1252ToUTF8();
          }
          @Pc(156)
          byte[][] local156 = new byte[local82][];
          @Pc(167)
          int local167;
          if (local61 == 3) {
          ...
          local13.anIntArray349[local55] = local61;
          @Pc(196)
          Class[] local196 = new Class[local82];
          for (local167 = 0; local167 < local82; local167++) {
            local196[local167] = Static323.method4383(local135[local167]);
          }
          local13.aClass199Array2[local55] =
              arg2.emitGetDeclaredMethodMessage(Static323.method4383(local76), local80, local196);
          local13.aByteArrayArrayArray4[local55] = local156;
        }
      } catch (
          @Pc(237)
          ClassNotFoundException local237) {
        local13.anIntArray351[local55] = -1;
      } catch (
          @Pc(244)
          SecurityException local244) {
        local13.anIntArray351[local55] = -2;
      } catch (
          @Pc(251)
          NullPointerException local251) {
