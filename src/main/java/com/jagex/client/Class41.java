...
public final class Class41 {
  ...
  public Class57 method937(
      @OriginalArg(0) boolean arg0, @OriginalArg(1) Class19 arg1, @OriginalArg(2) int arg2) {
    @Pc(24)
    long local24 =
        (long) (arg1.anInt5532 << 19 | (arg0 ? 262144 : 0) | this.anInt1024 | arg2 << 16);
    @Pc(32)
    Class57 local32 = (Class57) this.aClass265_1.aClass68_60.method1787(local24);
    if (local32 != null) {
      return local32;
    } else if (this.aClass265_1.aJs5_103.method2125(this.anInt1024)) {
      @Pc(61)
      Class18 local61 = Static456.method318(this.aClass265_1.aJs5_103, this.anInt1024, 0);
      if (local61 != null) {
  ...
  public void method938(@OriginalArg(0) Packet arg0) {
    while (true) {
      @Pc(17)
      int local17 = arg0.g1();
      if (local17 == 0) {
  ...
  private void method939(@OriginalArg(0) int arg0, @OriginalArg(1) Packet arg1) {
    if (arg0 == 1) {
