...
public final class Class16_Sub1_Sub5_Sub1 extends Class16_Sub1_Sub5 {
	...
	private boolean method3430(@OriginalArg(1) Class19 arg0, @OriginalArg(2) int arg1) {
		...
		@Pc(177) int local177;
		if (ClientSettings.MODEWHERE_LIVE != ClientSettings.modewhere && local148 < 50) {
		...
		} else if (ClientSettings.MODEWHERE_LIVE != ClientSettings.modewhere) {
