...
public final class Class16_Sub1_Sub5_Sub1 extends Class16_Sub1_Sub5 {
  ...
  public void method3422(@OriginalArg(0) Packet arg0) {
    arg0.pos = 0;
    @Pc(14)
    int local14 = arg0.g1();
    this.aByte46 = (byte) (local14 & 0x1);
    @Pc(31)
    boolean local31 = (local14 & 0x2) != 0;
    @Pc(42)
    boolean local42 = (local14 & 0x4) != 0;
    @Pc(46)
    int local46 = super.method4751();
    ...
    if (local42) {
      ...
      this.anInt4336 = 0;
      this.anInt4332 = arg0.g1();
      this.anInt4330 = arg0.g1();
      if (this.anInt4330 == 255) {
        this.anInt4330 = -1;
      }
    }
    local141 = this.anInt4334;
    this.anInt4334 = arg0.g1();
    @Pc(336)
    int local336;
    if (this.anInt4334 == 0) {
      ...
      @Pc(333)
      int local333 = this.anInt4319;
      local336 = this.anInt4333;
      @Pc(339)
      int local339 = this.anInt4322;
      @Pc(342)
      int local342 = this.anInt4348;
      this.anInt4313 = arg0.g2();
      this.anInt4319 = arg0.g2();
      this.anInt4333 = arg0.g2();
      this.anInt4322 = arg0.g2();
      this.anInt4348 = arg0.g1();
      if (local141 != this.anInt4334
          || this.anInt4313 != local180
          || this.anInt4319 != local333
          || this.anInt4333 != local336
          || local339 != this.anInt4322
          || this.anInt4348 != local342) {
    ...
    @Pc(422)
    int[] local422 = this.aClass37_1.anIntArray52;
    ...
    @Pc(521)
    Class151 local521 = this.method4757();
  ...
  public void method3423(
      @OriginalArg(0) byte arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
    ...
    if (super.anInt6029 != -1) {
      ...
      if (local36.aBoolean459
          && local36.anInt5002 != -1
          && Static182.aClass55_1.method1397(local36.anInt5002).anInt4410 == 1) {
        super.anInt6029 = -1;
      }
    }
    ...
    } else if (super.anIntArray426[0] >= 0
        && super.anIntArray426[0] < Static326.anInt5666
        && super.anIntArray427[0] >= 0
        && super.anIntArray427[0] < Static283.anInt5187) {
      if (arg0 == 2) {
  ...
  public boolean method5341(
    ...
    @Pc(19)
    Class31 local19 = arg1.method4289();
    @Pc(26)
    int local26 = super.aClass35_7.method811();
    local19.ra(local26);
    local19.o(super.anInt6893, super.anInt6889, super.anInt6892);
    @Pc(39)
    boolean local39 = false;
    for (@Pc(41) int local41 = 0; local41 < super.aClass110Array3.length; local41++) {
      if (super.aClass110Array3[local41] != null
          && super.aClass110Array3[local41].method4894(arg2, arg0, local19, true)) {
        local39 = true;
        break;
      }
    }
  ...
  public Class3_Sub3 method5339(@OriginalArg(0) Class19 arg0) {
    ...
    @Pc(19)
    Class31 local19 = arg0.method4289();
    @Pc(24)
    int local24 = super.aClass35_7.method811();
    local19.ra(local24);
    local19.o(super.anInt6893, super.anInt6889, super.anInt6892);
    @Pc(38)
    float local38 = arg0.W();
    @Pc(47)
    float local47 = arg0.xa();
    if (ClientPreferences.preferences.aBoolean302) {
      @Pc(54)
      ...
      if (local54.aBoolean428
        ...
        Class138 local85 =
            super.anInt6021 != -1 && super.anInt6046 == 0
                ? Static182.aClass55_1.method1397(super.anInt6021)
                : null;
        @Pc(105)
        Class138 local105 =
            super.anInt6076 == -1 || this.aBoolean402 || super.aBoolean562 && local85 != null
                ? null
                : Static182.aClass55_1.method1397(super.anInt6076);
        @Pc(139)
        Class110 local139 =
            Static6.method48(
                super.anInt6042,
                ...
                1,
                local24,
                local105 == null ? super.anInt6060 : super.anInt6016,
                super.aBoolean560,
                local105 == null ? local85 : local105,
                240);
        if (local139 != null) {
    ...
    if (Static1.aClass16_Sub1_Sub5_Sub1_1 == this) {
      ...
      for (@Pc(180) int local180 = Static306.aClass38Array1.length - 1; local180 >= 0; local180--) {
        @Pc(186)
        Class38 local186 = Static306.aClass38Array1[local180];
        if (local186 != null && local186.anInt888 != -1) {
          @Pc(228)
          int local228;
          @Pc(221)
          int local221;
          if (local186.anInt891 == 1
              && local186.anInt885 >= 0
              && local186.anInt885 < Static143.aClass16_Sub1_Sub5_Sub2Array1.length) {
            @Pc(212)
            Class16_Sub1_Sub5_Sub2 local212 =
                Static143.aClass16_Sub1_Sub5_Sub2Array1[local186.anInt885];
            if (local212 != null) {
          ...
          if (local186.anInt891 == 2) {
            @Pc(255)
            int local255 = local186.anInt892 + 64 - Static1.aClass16_Sub1_Sub5_Sub1_1.anInt6893;
          ...
          if (local186.anInt891 == 10
              && local186.anInt885 >= 0
              && Static267.aClass16_Sub1_Sub5_Sub1Array1.length > local186.anInt885) {
            @Pc(303)
            Class16_Sub1_Sub5_Sub1 local303 =
                Static267.aClass16_Sub1_Sub5_Sub1Array1[local186.anInt885];
            if (local303 != null) {
    ...
    @Pc(360)
    Class3_Sub3 local360 = Static38.method672(super.aClass110Array3.length);
    if (super.aClass3_Sub2_7 == null) {
      arg0.method4307(
          super.aClass110Array3,
          local19,
          local360.aClass3_Sub5Array1,
          Static1.aClass16_Sub1_Sub5_Sub1_1 == this ? 1 : 0);
    } else {
      @Pc(367)
      Class146 local367 = super.aClass3_Sub2_7.method171();
      arg0.method4299(
          super.aClass110Array3,
          local367,
          local19,
    ...
    if (super.aClass110Array3[2] != null) {
      ...
      super.aClass110Array3[2].JA(
          -super.aClass4_Sub23_3.anInt3198 + super.anInt6893,
          -super.aClass4_Sub23_3.anInt3188 + super.anInt6889,
          -super.aClass4_Sub23_3.anInt3203 + super.anInt6892);
    }
    super.aClass110Array3[0] =
        super.aClass110Array3[1] = super.aClass110Array3[2] = super.aClass110Array3[3] = null;
  ...
  public void method3427(
      @OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) byte arg2) {
  ...
  public String method3428() {
    ...
    if (local37 != null && local37[this.aByte44] != -1) {
      @Pc(58)
      Class200 local58 = Static416.aClass158_1.method3790(local37[this.aByte44]);
      if (local58.aChar4 == 's') {
  ...
  @OriginalMember(
      owner = "client!lh",
      name = "a",
      descriptor = "(ILclient!t;ILclient!ya;IIILclient!c;)V")
  private void method3429(
      @OriginalArg(0) int arg0,
      @OriginalArg(1) Class110 arg1,
      @OriginalArg(2) int arg2,
      @OriginalArg(3) Class19 arg3,
      @OriginalArg(5) int arg4,
      @OriginalArg(6) int arg5,
      @OriginalArg(7) Class31 arg6) {
    @Pc(11)
    int local11 = arg2 * arg2 + arg0 * arg0;
    if (local11 < 16384 || arg4 < local11) {
      return;
    }
    @Pc(35)
    int local35 = (int) (Math.atan2((double) arg2, (double) arg0) * 2607.5945876176133D) & 0x3FFF;
    @Pc(55)
    Class110 local55 =
        Static238.method3545(
            arg5, super.anInt6070, arg3, super.anInt6042, local35, super.anInt6040);
    if (local55 != null) {
  ...
  private boolean method3430(@OriginalArg(1) Class19 arg0, @OriginalArg(2) int arg1) {
    ...
    int local7 = arg1;
    @Pc(11)
    Class151 local11 = this.method4757();
    @Pc(30)
    Class138 local30 =
        super.anInt6021 != -1 && super.anInt6046 == 0
            ? Static182.aClass55_1.method1397(super.anInt6021)
    ...
    @Pc(50)
    Class138 local50 =
        super.anInt6076 == -1 || this.aBoolean402 || super.aBoolean562 && local30 != null
            ? null
            : Static182.aClass55_1.method1397(super.anInt6076);
    @Pc(59)
    int local59 = local11.anInt4662;
    @Pc(62)
    int local62 = local11.anInt4670;
    ...
    boolean local104 =
        super.aByte68 != 0
            && super.anInt6020 <= client.gameLogicStepCount
            && client.gameLogicStepCount < super.anInt6068;
    if (local104) {
      arg1 |= 0x80000;
    }
    @Pc(145)
    Class110 local145 =
        super.aClass110Array3[0] =
            this.aClass37_1.method833(
                ...
                super.anInt6073);
    @Pc(148)
    int local148 = Static317.method4232();
    if (Static70.anInt1503 < 96 && local148 > 50) {
      Static343.method743();
    }
    @Pc(177)
    int local177;
    if (!ClientSettings.modewhere.isLive() && local148 < 50) {
    ...
    } else if (!ClientSettings.modewhere.isLive()) {
    ...
    if (!this.aBoolean402 && super.aClass4_Sub23_3 != null) {
      if (client.gameLogicStepCount >= super.aClass4_Sub23_3.anInt3202) {
        ...
        @Pc(618)
        Class110 local618 = super.aClass4_Sub23_3.method2719(arg0, local7 | 0x7);
        if (local618 != null) {
          local618.JA(
              super.aClass4_Sub23_3.anInt3198 - super.anInt6893,
              super.aClass4_Sub23_3.anInt3188 - super.anInt6889,
              -super.anInt6892 + super.aClass4_Sub23_3.anInt3203);
          if (local177 != 0) {
