...
public final class Static23 {
  ...
  @OriginalMember(
      owner = "client!b",
      name = "a",
      descriptor = "(Ljava/awt/Canvas;IILclient!ga;)Lclient!ya;")
  public static Class19 method302(
      @OriginalArg(0) Canvas arg0, @OriginalArg(2) int arg1, @OriginalArg(3) Interface7 arg2) {
