...
public final class Static240 {
  ...
  public static GraphicsDeviceDisplayMode[] method5675() {
    if (Static287.aGraphicsDeviceDisplayModeArray1 == null) {
      @Pc(16)
      GraphicsDeviceDisplayMode[] local16 =
          FullScreenWindow.getFullScreenDisplayModes(GameShell.signLink);
      @Pc(20)
      GraphicsDeviceDisplayMode[] local20 = new GraphicsDeviceDisplayMode[local16.length];
      @Pc(22)
      int local22 = 0;
      @Pc(66)
      int local66;
      @Pc(72)
      GraphicsDeviceDisplayMode local72;
      label63:
      for (@Pc(24) int local24 = 0; local24 < local16.length; local24++) {
        @Pc(30)
        GraphicsDeviceDisplayMode local30 = local16[local24];
        if ((local30.bitDepth <= 0 || local30.bitDepth >= 24)
            && local30.width >= 800
            && local30.height >= 600
            && (Static70.anInt1503 >= 96
                || Static177.anInt2973 != 0
                || local30.width <= 1024 && local30.height <= 768)) {
      ...
      @Pc(128)
      int[] local128 = new int[Static287.aGraphicsDeviceDisplayModeArray1.length];
  ...
  public static void method5677() {
    ...
    @Pc(27)
    byte local27 = (byte) (Static361.anInt6264 - 4 & 0xFF);
    @Pc(31)
    int local31 = Static361.anInt6264 % Static326.anInt5666;
    @Pc(37)
    int local37;
    ...
    if (Static111.anInt2386 != 1) {
      ...
      if (local136 - Static100.anInt2024 >= 800
          || (Static79.aByteArrayArrayArray2[Static263.anInt4963][Static163.anInt3197 >> 7][
                      Static145.anInt2906 >> 7]
                  & 0x4)
              == 0) {
        return;
      }
      Static306.method4135(
          Static163.anInt3197 >> 7,
          false,
          Static145.anInt2906 >> 7,
          1,
          Static202.aClass164ArrayArrayArray5);
      return;
    }
    if ((Static79.aByteArrayArrayArray2[Static263.anInt4963][
    ...
    @Pc(140)
    int local140 = Static145.anInt2906 >> 7;
    @Pc(145)
    int local145 = Static1.aClass16_Sub1_Sub5_Sub1_1.anInt6893 >> 7;
    @Pc(150)
    int local150 = Static1.aClass16_Sub1_Sub5_Sub1_1.anInt6892 >> 7;
    @Pc(158)
    int local158;
    ...
    if ((local158 != 0 || local176 != 0)
        && local158 > -Static326.anInt5666
        && Static326.anInt5666 > local158
        && -Static283.anInt5187 < local176
        && Static283.anInt5187 > local176) {
      @Pc(249)
      int local249;
      @Pc(251)
      ...
      if (local158 <= local176) {
        ...
        while (local140 != local150) {
          ...
          if ((Static79.aByteArrayArrayArray2[Static263.anInt4963][local136][local140] & 0x4)
              != 0) {
          ...
          if (local251 >= 65536) {
            ...
            if ((Static79.aByteArrayArrayArray2[Static263.anInt4963][local136][local140] & 0x4)
                != 0) {
              Static306.method4135(
                  local136, false, local140, 1, Static202.aClass164ArrayArrayArray5);
              return;
            }
          }
        }
