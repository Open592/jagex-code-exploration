...
public final class Static12 {
  ...
  public static void method124(
    ...
    int local9 = arg0;
    @Pc(13)
    int local13 = arg3 * arg3;
    @Pc(17)
    int local17 = arg0 * arg0;
    @Pc(21)
    int local21 = local17 << 1;
    @Pc(29)
    int local29 = local13 << 1;
    @Pc(33)
    int local33 = arg0 << 1;
    @Pc(41)
    int local41 = local21 + local13 * (1 - local33);
    @Pc(49)
    int local49 = local17 - (local33 - 1) * local29;
    @Pc(53)
    int local53 = local13 << 2;
    @Pc(57)
    int local57 = local17 << 2;
    @Pc(65)
    int local65 = local21 * 3;
    @Pc(73)
    int local73 = local29 * ((arg0 << 1) - 3);
    @Pc(79)
    int local79 = local57;
    @Pc(85)
    int local85 = local53 * (arg0 - 1);
    @Pc(103)
    int local103;
    @Pc(111)
    int local111;
    ...
    while (local9 > 0) {
      ...
      if (Static376.anInt6287 <= local111 && Static168.anInt3256 >= local103) {
        @Pc(219)
        int local219 =
            Static332.method4519(Static208.anInt2656, arg1 + local7, Static354.anInt6186);
        @Pc(228)
        int local228 =
            Static332.method4519(Static208.anInt2656, arg1 - local7, Static354.anInt6186);
  ...
  public static Class247 method125(@OriginalArg(0) Class247 arg0) {
    ...
    @Pc(20)
    int local20 = arg0.anInt6809 >>> 16;
    @Pc(25)
    Class25 local25 = new Class25(Static325.aHashMap_29);
    for (@Pc(30) Node_Sub43 local30 = (Node_Sub43) local25.method641();
        local30 != null;
        local30 = (Node_Sub43) local25.method640()) {
  ...
  public static Class247 method126(@OriginalArg(1) Class247 arg0) {
    @Pc(6)
    Class247 local6 = Static53.method906(arg0);
    if (local6 == null) {
  ...
  public static void method127() {
    Static57.aClass19_7.B(
        ((float) ClientPreferences.preferences.anInt3436 * 0.1F + 0.7F) * Static350.aFloat187);
    Static57.aClass19_7.T(
        Static398.anInt6606,
        Static216.aFloat131,
        Static434.aFloat228,
        (float) (Static108.anInt2361 << 0),
        (float) (Static328.anInt5676 << 0),
        (float) (Static101.anInt2036 << 0));
  ...
  public static Class98 method128(@OriginalArg(0) int arg0) {
    @Pc(8)
    Class98[] local8 = Static62.method995();
