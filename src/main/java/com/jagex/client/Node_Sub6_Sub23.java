...
public final class Node_Sub6_Sub23 extends Node_Sub6 {
  ...
  public int[] method5510(@OriginalArg(1) int arg0) {
    ...
    if (super.aClass82_41.aBoolean243) {
      for (@Pc(25) int local25 = 0; local25 < Static80.anInt1616; local25++) {
        @Pc(31)
        int local31 = Static341.anIntArray504[local25];
        @Pc(35)
        int local35 = Static165.anIntArray209[arg0];
        @Pc(42)
        int local42 = local31 * this.anInt4742 >> 12;
        @Pc(49)
        int local49 = this.anInt4741 * local35 >> 12;
        @Pc(59)
        int local59 = this.anInt4742 * (local31 % (4096 / this.anInt4742));
        @Pc(69)
        int local69 = local35 % (4096 / this.anInt4741) * this.anInt4741;
  ...
  public void method5518(@OriginalArg(1) int arg0, @OriginalArg(2) Packet arg1) {
    if (arg0 == 0) {
      this.anInt4742 = arg1.g1();
    } else if (arg0 == 1) {
      this.anInt4741 = arg1.g1();
    } else if (arg0 == 2) {
      this.anInt4745 = arg1.g2();
    }
  }
}
