...
public final class Static230 {
  ...
  public static void method3465(@OriginalArg(0) Interface7 arg0, @OriginalArg(2) Class19 arg1) {
    ...
    if (Static69.anInt3429 < 10) {
      if (!Static148.aJs5_73.method2103(Static148.aClass4_Sub1_Sub5_3.aString16)) {
        Static69.anInt3429 =
            Static163.archive23.method2113(Static148.aClass4_Sub1_Sub5_3.aString16) / 10;
        return;
      }
    ...
    if (Static69.anInt3429 == 10) {
      ...
      Static148.anInt5729 =
          (Static148.aClass4_Sub1_Sub5_3.anInt1014 >> 6 << 6) + 64 - Static148.anInt5732;
      Static148.anInt5733 =
          (Static148.aClass4_Sub1_Sub5_3.anInt1019 >> 6 << 6) + 64 - Static148.anInt5724;
      @Pc(74)
      int[] local74 = new int[3];
      @Pc(76)
      int local76 = -1;
      @Pc(78)
      int local78 = -1;
      if (Static148.aClass4_Sub1_Sub5_3.method935(
          local74,
          Static1.aClass16_Sub1_Sub5_Sub1_1.aByte82,
          (Static1.aClass16_Sub1_Sub5_Sub1_1.anInt6892 >> 7) + Static86.anInt1771,
          Static180.anInt3453 - -(Static1.aClass16_Sub1_Sub5_Sub1_1.anInt6893 >> 7))) {
        local76 = local74[1] - Static148.anInt5732;
        local78 = local74[2] - Static148.anInt5724;
      }
      if (!Static58.aBoolean98
          && local76 >= 0
          && Static148.anInt5729 > local76
          && local78 >= 0
          && Static148.anInt5733 > local78) {
        ...
        Static148.aClass4_Sub1_Sub5_3.method931(
            local74,
            Static148.aClass4_Sub1_Sub5_3.anInt1023 & 0x3FFF,
            Static148.aClass4_Sub1_Sub5_3.anInt1023 >> 14 & 0x3FFF);
      ...
      if (Static148.aJs5_73.method2107(
          Static148.aClass4_Sub1_Sub5_3.aString16 + "_staticelements")) {
        if (!Static148.aJs5_73.method2103(
            Static148.aClass4_Sub1_Sub5_3.aString16 + "_staticelements")) {
          return;
        }
        Static148.aClass195_3 =
      ...
      Static258.aClass212_6 = new Class212(arg1, 11, true, GameShell.canvas);
      Static69.anInt3429 = 73;
      Static299.method4087(true);
      GameShell.method3660();
    } else if (Static69.anInt3429 == 73) {
      Static373.aClass212_8 = new Class212(arg1, 12, true, GameShell.canvas);
      Static69.anInt3429 = 76;
      Static299.method4087(true);
      GameShell.method3660();
    } else if (Static69.anInt3429 == 76) {
      Static239.aClass212_5 = new Class212(arg1, 14, true, GameShell.canvas);
      Static69.anInt3429 = 79;
      Static299.method4087(true);
      GameShell.method3660();
    } else if (Static69.anInt3429 == 79) {
      Static108.aClass212_3 = new Class212(arg1, 17, true, GameShell.canvas);
      Static69.anInt3429 = 82;
      Static299.method4087(true);
      GameShell.method3660();
    } else if (Static69.anInt3429 == 82) {
      Static262.aClass212_7 = new Class212(arg1, 19, true, GameShell.canvas);
      Static69.anInt3429 = 85;
      Static299.method4087(true);
      GameShell.method3660();
    } else if (Static69.anInt3429 == 85) {
      Static81.aClass212_2 = new Class212(arg1, 22, true, GameShell.canvas);
      Static69.anInt3429 = 88;
      Static299.method4087(true);
      GameShell.method3660();
    } else if (Static69.anInt3429 == 88) {
      Static58.aClass212_1 = new Class212(arg1, 26, true, GameShell.canvas);
      Static69.anInt3429 = 91;
      Static299.method4087(true);
      GameShell.method3660();
    } else {
      Static117.aClass212_4 = new Class212(arg1, 30, true, GameShell.canvas);
  ...
  public static boolean method3468(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
    return ((arg1 & 0x2000) != 0
            | Static72.method1353(arg0, arg1)
            | Static183.method2904(arg0, arg1))
        & Static49.method2002(arg1, arg0);
  }
  ...
  public static void method3470() {
    ...
    @Pc(11)
    int local11 = Static146.aClass4_Sub12_Sub1_3.g1_alt3();
    @Pc(15)
    int local15 = Static146.aClass4_Sub12_Sub1_3.g2_alt2();
    @Pc(19)
    int local19 = Static146.aClass4_Sub12_Sub1_3.g2_alt3();
    @Pc(30)
    boolean local30 = Static146.aClass4_Sub12_Sub1_3.g1_alt1() == 1;
    Static263.method3809(local11);
    @Pc(41)
    int local41 = (Static454.anInt4075 - Static146.aClass4_Sub12_Sub1_3.pos) / 16;
    ...
    local41 = 0;
    for (local51 = (local15 - (Static326.anInt5666 >> 4)) / 8;
        local51 <= ((Static326.anInt5666 >> 4) + local15) / 8;
        local51++) {
      for (@Pc(122) int local122 = (local19 - (Static283.anInt5187 >> 4)) / 8;
          local122 <= ((Static283.anInt5187 >> 4) + local19) / 8;
          local122++) {
        Static308.anIntArray372[local41] = local122 + (local51 << 8);
        Static225.anIntArray291[local41] =
            Static49.archive5.getGroupId("m" + local51 + "_" + local122);
        Static346.anIntArray418[local41] =
            Static49.archive5.getGroupId("l" + local51 + "_" + local122);
        Static95.anIntArray155[local41] =
            Static49.archive5.getGroupId("um" + local51 + "_" + local122);
        Static189.anIntArray236[local41] =
            Static49.archive5.getGroupId("ul" + local51 + "_" + local122);
        local41++;
      }
    }
