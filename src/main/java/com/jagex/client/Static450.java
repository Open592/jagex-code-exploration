...
public final class Static450 {
  ...
  public static void method5661(
      ...
      @OriginalArg(4) Class19 arg3) {
    @Pc(10)
    Class145 local10 = arg0.method5312(arg3);
    if (local10 == null) {
      return;
    }
    ...
    @Pc(98)
    int local98 = local63 / 32 + 208 + 48 - Static326.anInt5666 * 2;
    @Pc(117)
    int local117 = Static283.anInt5187 * 4 + 208 + 48 - Static283.anInt5187 * 2 - local54 / 32;
    Static228.aClass57_11.method5538(
        (float) arg1 + (float) arg0.anInt6833 / 2.0F,
        (float) arg2 + (float) arg0.anInt6805 / 2.0F,
        (float) local98,
        (float) local117,
        local60,
        local72 << 2,
    ...
    @Pc(200)
    int local200;
    for (@Pc(151) Node_Sub37 local151 = (Node_Sub37) Static181.A_LINKED_LIST___25.tail();
        local151 != null;
        local151 = (Node_Sub37) Static181.A_LINKED_LIST___25.previous()) {
      @Pc(156)
      int local156 = local151.anInt5426;
      local168 =
          (Static292.aClass195_2.anIntArray397[local156] >> 14 & 0x3FFF) - Static180.anInt3453;
      ...
      Static22.method294(
          local189,
          arg3,
          Static292.aClass195_2.anIntArray396[local156],
          arg0,
          local200,
          local10,
          arg1,
    ...
    for (local168 = 0; local168 < Static180.anInt3460; local168++) {
      ...
      @Pc(257)
      Class202 local257 = Static267.aClass262_2.method5560(Static446.anIntArray552[local168]);
    ...
    for (@Pc(293) Node_Sub18 local293 = (Node_Sub18) Static440.aHashMap_40.head();
        local293 != null;
        local293 = (Node_Sub18) Static440.aHashMap_40.next()) {
      local189 = (int) (local293.hashKey >> 28 & 0x3L);
      if (Static386.anInt3967 == local189) {
        local200 = (int) (local293.hashKey & 0x3FFFL) * 4 + 2 - local63 / 32;
        @Pc(342)
        int local342 = (int) (local293.hashKey >> 14 & 0x3FFFL) * 4 + 2 - local54 / 32;
        Static442.method5585(
            arg1, Static126.aClass57Array7[0], arg0, local10, local342, local200, arg2);
      }
    }
    @Pc(411)
    int local411;
    for (local189 = 0; local189 < Static12.anInt163; local189++) {
      @Pc(370)
      Class16_Sub1_Sub5_Sub2 local370 =
          Static143.aClass16_Sub1_Sub5_Sub2Array1[Static342.anIntArray412[local189]];
      if (local370 != null
          && local370.method4762()
        ...
        if (local384 != null && local384.aBoolean679 && local384.aBoolean682) {
          ...
          @Pc(421)
          int local421 = local370.anInt6892 / 32 - local54 / 32;
          if (local384.anInt7239 == -1) {
            Static442.method5585(
                arg1, Static126.aClass57Array7[1], arg0, local10, local421, local411, arg2);
          } else {
            Static22.method294(
                local411, arg3, local384.anInt7239, arg0, local421, local10, arg1, arg2);
          }
        }
      }
    }
    ...
    @Pc(461)
    int[] local461 = Static99.anIntArray157;
    @Pc(499)
    int local499;
    @Pc(509)
    int local509;
    ...
    for (local411 = 0; local411 < local200; local411++) {
      @Pc(471)
      Class16_Sub1_Sub5_Sub1 local471 = Static267.aClass16_Sub1_Sub5_Sub1Array1[local461[local411]];
      if (local471 != null
          && local471.method3425()
          && local471 != Static1.aClass16_Sub1_Sub5_Sub1_1
          && Static1.aClass16_Sub1_Sub5_Sub1_1.aByte82 == local471.aByte82) {
        ...
        @Pc(561)
        boolean local561 = false;
        if (Static1.aClass16_Sub1_Sub5_Sub1_1.anInt4328 != 0
            && local471.anInt4328 != 0
            && local471.anInt4328 == Static1.aClass16_Sub1_Sub5_Sub1_1.anInt4328) {
          local561 = true;
        }
        if (local471.aBoolean400) {
          Static442.method5585(
              arg1, Static126.aClass57Array7[6], arg0, local10, local509, local499, arg2);
        } else if (local511) {
          Static442.method5585(
              arg1, Static126.aClass57Array7[3], arg0, local10, local509, local499, arg2);
        } else if (local539) {
          Static442.method5585(
              arg1, Static126.aClass57Array7[5], arg0, local10, local509, local499, arg2);
        } else if (local561) {
          Static442.method5585(
              arg1, Static126.aClass57Array7[4], arg0, local10, local509, local499, arg2);
        } else {
          Static442.method5585(
              arg1, Static126.aClass57Array7[2], arg0, local10, local509, local499, arg2);
        }
      }
    }
    @Pc(658)
    Class38[] local658 = Static306.aClass38Array1;
    @Pc(754)
    int local754;
    for (local499 = 0; local499 < local658.length; local499++) {
      @Pc(666)
      Class38 local666 = local658[local499];
      if (local666 != null && local666.anInt891 != 0 && client.gameLogicStepCount % 20 < 10) {
        @Pc(727)
        int local727;
        if (local666.anInt891 == 1
            && local666.anInt885 >= 0
            && Static143.aClass16_Sub1_Sub5_Sub2Array1.length > local666.anInt885) {
          @Pc(705)
          Class16_Sub1_Sub5_Sub2 local705 =
              Static143.aClass16_Sub1_Sub5_Sub2Array1[local666.anInt885];
          if (local705 != null) {
            local513 = local705.anInt6893 / 32 - local63 / 32;
            local727 = local705.anInt6892 / 32 - local54 / 32;
            Static409.method5484(
                arg0, local10, local513, arg1, local666.anInt886, arg2, local727, 360000L);
          }
        }
        if (local666.anInt891 == 2) {
          ...
          @Pc(769)
          long local769 = (long) (local666.anInt889 << 5);
          @Pc(773)
          long local773 = local769 * local769;
          Static409.method5484(
              arg0, local10, local754, arg1, local666.anInt886, arg2, local513, local773);
        }
        if (local666.anInt891 == 10
            && local666.anInt885 >= 0
            && Static267.aClass16_Sub1_Sub5_Sub1Array1.length > local666.anInt885) {
          @Pc(803)
          Class16_Sub1_Sub5_Sub1 local803 =
              Static267.aClass16_Sub1_Sub5_Sub1Array1[local666.anInt885];
          if (local803 != null) {
    ...
    if (Static343.anInt771 != 0) {
      local509 =
          Static343.anInt771 * 4
              + Static1.aClass16_Sub1_Sub5_Sub1_1.method4751() * 2
              + 2
              - local63 / 32
              - 2;
      local754 =
          Static60.anInt1094 * 4
              + (Static1.aClass16_Sub1_Sub5_Sub1_1.method4751() + -1) * 2
              + 2
              - local54 / 32;
      Static442.method5585(
          arg1,
          Static333.aClass57Array12[Static350.aBoolean556 ? 1 : 0],
          arg0,
          local10,
          local754,
          local509,
  ...
  public static int method5662(@OriginalArg(0) int arg0) {
    @Pc(19)
    int local19 = (arg0 * arg0 >> 12) * arg0 >> 12;
    @Pc(25)
    int local25 = arg0 * 6 - 61440;
    @Pc(33)
    int local33 = (local25 * arg0 >> 12) + 40960;
  ...
  public static void method5663(
    ...
    for (@Pc(33) int local33 = local8; local33 <= local21; local33++) {
      @Pc(39)
      int[] local39 = Static96.anIntArrayArray21[local33];
