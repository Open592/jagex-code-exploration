...
public final class Static123 {
  ...
  public static String method4868(@OriginalArg(0) String arg0) {
    ...
    @Pc(54)
    int local54 = local19 - local16;
    if (local54 < 1 || local54 > 12) {
      return null;
    }
    @Pc(71)
    StringBuffer local71 = new StringBuffer(local54);
    for (@Pc(73) int local73 = local16; local73 < local19; local73++) {
      @Pc(79)
      char local79 = arg0.charAt(local73);
      if (Static210.method3198(local79)) {
        @Pc(87)
        char local87 = Static147.method2459(local79);
        if (local87 != '\u0000') {
