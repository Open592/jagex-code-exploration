...
public final class Static72 {
  ...
  public static void method1354() {
    ...
    Static439.method5554(
        Static67.archive4,
        Static363.aClass4_Sub15_Sub1_3,
        Static312.archive14,
        Static350.archive15);
    ...
    Static414.anInt6866 = Static46.archive6.getGroupId("scape main");
  }
  ...
  public static void method1355(
    ...
    int local9 = arg3;
    @Pc(13)
    int local13 = arg1 * arg1;
    @Pc(17)
    int local17 = arg3 * arg3;
    @Pc(21)
    int local21 = local17 << 1;
    @Pc(25)
    int local25 = local13 << 1;
    @Pc(29)
    int local29 = arg3 << 1;
    @Pc(39)
    int local39 = local13 * (1 - local29) + local21;
    @Pc(48)
    int local48 = local17 - (local29 - 1) * local25;
    @Pc(52)
    int local52 = local13 << 2;
    @Pc(56)
    int local56 = local17 << 2;
    @Pc(64)
    int local64 = local21 * 3;
    @Pc(72)
    int local72 = local25 * ((arg3 << 1) - 3);
    @Pc(78)
    int local78 = local56;
    Static251.method3640(arg4 - arg1, arg2, arg4 + arg1, Static96.anIntArrayArray21[arg0]);
    @Pc(98)
    int local98 = local52 * (arg3 - 1);
    while (local9 > 0) {
      if (local39 < 0) {
        while (local39 < 0) {
          local39 += local64;
      ...
      local72 -= local52;
      @Pc(174)
      int local174 = arg0 - local9;
      @Pc(178)
      int local178 = local9 + arg0;
      @Pc(182)
      int local182 = local7 + arg4;
      @Pc(187)
      int local187 = arg4 - local7;
