...
public final class Class220 {
  ...
  private void method4943(@OriginalArg(1) Interface2 arg0) {
    @Pc(9)
    long local9 = arg0.method3685();
    for (@Pc(16)
        SecondaryNode_Sub1_Sub9 local16 = (SecondaryNode_Sub1_Sub9) this.aHashMap_37.get(local9);
        local16 != null;
        local16 = (SecondaryNode_Sub1_Sub9) this.aHashMap_37.nextFoundNode()) {
  ...
  public Object method4946(@OriginalArg(0) Interface2 arg0) {
    ...
    long local9 = arg0.method3685();
    for (@Pc(23)
        SecondaryNode_Sub1_Sub9 local23 = (SecondaryNode_Sub1_Sub9) this.aHashMap_37.get(local9);
        local23 != null;
        local23 = (SecondaryNode_Sub1_Sub9) this.aHashMap_37.nextFoundNode()) {
      if (local23.anInterface2_3.method3684(arg0)) {
        @Pc(37)
        Object local37 = local23.method2571();
        if (local37 != null) {
          if (local23.method2567()) {
            @Pc(66)
            SecondaryNode_Sub1_Sub9_Sub2 local66 =
                new SecondaryNode_Sub1_Sub9_Sub2(arg0, local37, local23.anInt3025);
  ...
  public void method4950() {
    ...
    for (@Pc(21)
        SecondaryNode_Sub1_Sub9 local21 =
            (SecondaryNode_Sub1_Sub9) this.aSecondaryLinkedList_5.getHead();
        local21 != null;
        local21 = (SecondaryNode_Sub1_Sub9) this.aSecondaryLinkedList_5.next()) {
      if (local21.method2567()) {
        ...
        @Pc(47)
        SecondaryNode_Sub1_Sub9 local47 = Static224.aClass105_1.method5276(local21);
  ...
  public void method4952() {
    for (@Pc(5)
        SecondaryNode_Sub1_Sub9 local5 =
            (SecondaryNode_Sub1_Sub9) this.aSecondaryLinkedList_5.getHead();
        local5 != null;
        local5 = (SecondaryNode_Sub1_Sub9) this.aSecondaryLinkedList_5.next()) {
  ...
  @OriginalMember(
      owner = "client!sq",
      name = "a",
      descriptor = "(Lclient!bq;Ljava/lang/Object;ZI)V")
  private void method4955(@OriginalArg(0) Interface2 arg0, @OriginalArg(1) Object arg1) {
    ...
    while (this.anInt6338 < 0) {
      @Pc(36)
      SecondaryNode_Sub1_Sub9 local36 =
          (SecondaryNode_Sub1_Sub9) this.aSecondaryLinkedList_5.popHead();
      this.method4945(local36);
    }
    @Pc(59)
    SecondaryNode_Sub1_Sub9_Sub2 local59 = new SecondaryNode_Sub1_Sub9_Sub2(arg0, arg1, 1);
