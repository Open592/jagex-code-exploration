...
public final class Static443 {
	...
	public static void method5595(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
		...
		@Pc(25) LinkedEntry_Sub18 local25 = (LinkedEntry_Sub18) Static440.aLinkedHashMap_Iterator_40.get(local19);
		if (local25 == null) {
			Static411.method5275(arg0, arg1, arg2);
			return;
		}
		@Pc(41) LinkedEntry_Sub45 local41 = (LinkedEntry_Sub45) local25.aClass183_14.method4140();
		if (local41 == null) {
			Static411.method5275(arg0, arg1, arg2);
			return;
		}
		...
		label44: while (true) {
			@Pc(91) LinkedEntry_Sub45 local91 = (LinkedEntry_Sub45) local25.aClass183_14.method4144();
			if (local91 == null) {
				break;
			}
			if (local91.anInt7355 != local63.anInt755) {
				...
				while (true) {
					@Pc(112) LinkedEntry_Sub45 local112 = (LinkedEntry_Sub45) local25.aClass183_14.method4144();
					if (local112 == null) {
						break label44;
					}
