...
public final class Static443 {
  ...
  public static void method5589(
    ...
    @Pc(10)
    int local10 = (int) arg0 >> 14 & 0x1F;
    @Pc(17)
    int local17 = (int) arg0 >> 20 & 0x3;
    @Pc(28)
    int local28 = Integer.MAX_VALUE & (int) (arg0 >>> 32);
    if (local10 != 10 && local10 != 11 && local10 != 22) {
      Static166.method2734(local17, arg2, arg1, 0, true, 0, 0, local10);
      return;
    }
    @Pc(46)
    Class202 local46 = Static267.aClass262_2.method5560(local28);
    @Pc(62)
    int local62;
    @Pc(59)
    int local59;
  ...
  public static void method5592(@OriginalArg(0) Class19 arg0, @OriginalArg(2) Js5 arg1) {
    ...
    Static400.aClass57_23.method5534(
        (Static141.width - Static400.aClass57_23.j()) / 2,
        (Static302.height - Static400.aClass57_23.T()) / 2);
  ...
  public static void method5593(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1) {
    @Pc(15)
    int local15 = Static33.anInt606;
    @Pc(17)
    int[] local17 = Static99.anIntArray157;
    @Pc(19)
    boolean local19 = false;
    for (@Pc(21) int local21 = 0; local21 < local15; local21++) {
      @Pc(29)
      Class16_Sub1_Sub5_Sub1 local29 = Static267.aClass16_Sub1_Sub5_Sub1Array1[local17[local21]];
      if (local29 != null
  ...
  public static void method5595(
    ...
    @Pc(19)
    long local19 = (long) (arg2 << 14 | arg0 << 28 | arg1);
    @Pc(25)
    Node_Sub18 local25 = (Node_Sub18) Static440.aHashMap_40.get(local19);
    if (local25 == null) {
      Static411.method5275(arg0, arg1, arg2);
      return;
    }
    @Pc(41)
    Node_Sub45 local41 = (Node_Sub45) local25.aLinkedList_14.tail();
    if (local41 == null) {
      Static411.method5275(arg0, arg1, arg2);
      return;
    }
    @Pc(63)
    Class16_Sub3_Sub1 local63 = (Class16_Sub3_Sub1) Static411.method5275(arg0, arg1, arg2);
    if (local63 == null) {
    ...
    while (true) {
      @Pc(91)
      Node_Sub45 local91 = (Node_Sub45) local25.aLinkedList_14.previous();
      if (local91 == null) {
        break;
      }
      if (local91.anInt7355 != local63.anInt755) {
        ...
        while (true) {
          @Pc(112)
          Node_Sub45 local112 = (Node_Sub45) local25.aLinkedList_14.previous();
          if (local112 == null) {
            break label44;
          }
    ...
    @Pc(156)
    int local156 = Static13.method135((arg1 << 7) + 64, arg0, (arg2 << 7) + 64);
