...
public final class Static141 {
  ...
  public static int method2424(@OriginalArg(1) Class16_Sub1_Sub5 arg0) {
    ...
    if (arg0.anInt6034 != -1) {
      @Pc(19)
      Class16_Sub1_Sub5 local19 = null;
      ...
      if (local19 != null) {
        ...
        if (local49 != 0 || local56 != 0) {
          arg0.method4743(
              (int) (Math.atan2((double) local49, (double) local56) * 2607.5945876176133D)
                  & 0x3FFF);
        }
      }
    }
    if (arg0 instanceof Class16_Sub1_Sub5_Sub1) {
      @Pc(152)
      Class16_Sub1_Sub5_Sub1 local152 = (Class16_Sub1_Sub5_Sub1) arg0;
      ...
      @Pc(82)
      Class16_Sub1_Sub5_Sub2 local82 = (Class16_Sub1_Sub5_Sub2) arg0;
      if (local82.anInt6089 != -1 && (local82.anInt6086 == 0 || local82.anInt6085 > 0)) {
        local49 =
            local82.anInt6893
                - (local82.anInt6089 - Static180.anInt3453 - Static180.anInt3453) * 64;
        local56 =
            local82.anInt6892 - (local82.anInt6095 - Static86.anInt1771 - Static86.anInt1771) * 64;
        if (local49 != 0 || local56 != 0) {
          local82.method4743(
              (int) (Math.atan2((double) local49, (double) local56) * 2607.5945876176133D)
                  & 0x3FFF);
