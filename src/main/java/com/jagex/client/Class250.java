...
public final class Class250 {
  ...
  public Class250() {
    @Pc(4)
    int local4 = Static68.method1314(16);
    if (local4 != 1) {
      throw new RuntimeException();
    }
    @Pc(14)
    int local14 = Static68.method1314(5);
    @Pc(16)
    int local16 = 0;
    ...
    for (@Pc(163) int local163 = 0; local163 < local14; local163++) {
      @Pc(169)
      int local169 = this.anIntArray532[local163];
  ...
  public void method5362(@OriginalArg(0) float[] arg0, @OriginalArg(1) int arg1) {
    @Pc(3)
    int local3 = this.anIntArray529.length;
    @Pc(10)
    int local10 = Static418.anIntArray535[this.anInt6917 - 1];
    ...
    for (@Pc(20) int local20 = 2; local20 < local3; local20++) {
      ...
      local47 =
          this.method5369(
              Static418.anIntArray531[local25],
              Static418.anIntArray528[local25],
              Static418.anIntArray531[local29],
              Static418.anIntArray528[local29],
              Static418.anIntArray531[local20]);
      local51 = Static418.anIntArray528[local20];
      local55 = local10 - local47;
      @Pc(66)
      int local66 = (local55 < local47 ? local55 : local47) << 1;
      if (local51 == 0) {
        ...
        if (local51 >= local66) {
          Static418.anIntArray528[local20] =
              local55 > local47 ? local51 + local47 - local47 : local47 - local51 + local55 - 1;
        } else {
          Static418.anIntArray528[local20] =
              (local51 & 0x1) == 0 ? local47 + local51 / 2 : local47 - (local51 + 1) / 2;
        }
      }
    }
    ...
    @Pc(193)
    float local193 = Static418.aFloatArray31[local29];
  ...
  private void method5364(
    ...
    @Pc(3)
    int local3 = arg3 - arg1;
    @Pc(7)
    int local7 = arg2 - arg0;
    @Pc(14)
    int local14 = local3 < 0 ? -local3 : local3;
    @Pc(18)
    int local18 = local3 / local7;
    @Pc(20)
    int local20 = arg1;
    @Pc(22)
    int local22 = 0;
    @Pc(32)
    int local32 = local3 < 0 ? local18 - 1 : local18 + 1;
    @Pc(43)
    int local43 = local14 - (local18 < 0 ? -local18 : local18) * local7;
  ...
  public boolean method5367() {
    @Pc(5)
    boolean local5 = Static68.method1317() != 0;
    if (!local5) {
      return false;
    }
    @Pc(13)
    int local13 = this.anIntArray529.length;
    for (@Pc(15) int local15 = 0; local15 < local13; local15++) {
      Static418.anIntArray531[local15] = this.anIntArray529[local15];
    }
    @Pc(34)
    int local34 = Static418.anIntArray535[this.anInt6917 - 1];
    @Pc(40)
    int local40 = Static329.method4426(local34 - 1);
    ...
    for (@Pc(54) int local54 = 0; local54 < this.anIntArray532.length; local54++) {
      @Pc(60)
      int local60 = this.anIntArray532[local54];
      @Pc(65)
      int local65 = this.anIntArray534[local60];
      @Pc(70)
      int local70 = this.anIntArray530[local60];
      @Pc(76)
      int local76 = (0x1 << local70) - 1;
      @Pc(78)
      int local78 = 0;
      if (local70 > 0) {
      ...
      for (@Pc(90) int local90 = 0; local90 < local65; local90++) {
        @Pc(100)
        int local100 = this.anIntArrayArray59[local60][local78 & local76];
        local78 >>>= local70;
        Static418.anIntArray528[local52++] =
            local100 >= 0 ? Static68.aClass134Array1[local100].method3434() : 0;
      }
    }
    return true;
  }
  ...
  private void method5368(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
    ...
    int local5 = arg0;
    @Pc(9)
    int local9 = Static418.anIntArray531[arg0];
    @Pc(13)
    int local13 = Static418.anIntArray528[arg0];
    @Pc(17)
    boolean local17 = Static418.aBooleanArray22[arg0];
    for (@Pc(21) int local21 = arg0 + 1; local21 <= arg1; local21++) {
      @Pc(26)
      int local26 = Static418.anIntArray531[local21];
      if (local26 < local9) {
  ...
  private int method5369(
    ...
    int local14 = local3 < 0 ? -local3 : local3;
    @Pc(20)
    int local20 = local14 * (arg4 - arg0);
    @Pc(24)
    int local24 = local20 / local7;
