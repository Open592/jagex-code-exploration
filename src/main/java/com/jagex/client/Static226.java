...
public final class Static226 {
  ...
  public static SecondaryNode_Sub1 method3441(@OriginalArg(1) byte[] arg0) {
    @Pc(9)
    SecondaryNode_Sub1 local9 = new SecondaryNode_Sub1();
    @Pc(14)
    Packet local14 = new Packet(arg0);
    local14.pos = local14.data.length - 2;
    @Pc(25)
    int local25 = local14.g2();
    @Pc(36)
    int local36 = local14.data.length - local25 - 12 - 2;
    local14.pos = local36;
    @Pc(43)
    int local43 = local14.g4();
    ...
    if (local67 > 0) {
      ...
      for (@Pc(78) int local78 = 0; local78 < local67; local78++) {
        local84 = local14.g2();
        @Pc(91)
        HashMap local91 = new HashMap(Static370.method4949(local84));
        local9.aHashMapArray1[local78] = local91;
        while (local84-- > 0) {
          @Pc(102)
          int local102 = local14.g4();
          @Pc(106)
          int local106 = local14.g4();
  ...
  public static int method3443(@OriginalArg(1) Random arg0, @OriginalArg(2) int arg1) {
    if (arg1 <= 0) {
      ...
      @Pc(42)
      int local42 = Integer.MIN_VALUE - (int) (4294967296L % (long) arg1);
      @Pc(45)
      int local45;
      do {
