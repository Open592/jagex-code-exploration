...
public final class Node_Sub6_Sub39 extends Node_Sub6 {
  ...
  private void method5522() {
    ...
    int local21 = 0;
    @Pc(26)
    int local26 = 4096 / this.anInt7120;
    @Pc(33)
    int local33 = this.anInt7121 * local26 >> 12;
  ...
  public int[] method5510(@OriginalArg(1) int arg0) {
    ...
    if (super.aClass82_41.aBoolean243) {
      @Pc(27)
      int local27 = Static165.anIntArray209[arg0];
      @Pc(36)
      int local36;
      if (this.anInt7116 == 0) {
        @Pc(146)
        ...
        for (@Pc(32) int local32 = 0; local32 < Static80.anInt1616; local32++) {
          ...
          short local38 = 0;
          @Pc(42)
          int local42 = Static341.anIntArray504[local32];
          @Pc(45)
          int local45 = this.anInt7116;
          if (local45 == 1) {
            local36 = local42;
          } else if (local45 == 2) {
          ...
          for (local45 = 0; local45 < this.anInt7120; local45++) {
            if (local36 >= this.anIntArray539[local45]
                && local36 < this.anIntArray539[local45 + 1]) {
