...
public final class za extends Node {
  ...
  @OriginalMember(
      owner = "client!za",
      name = "<init>",
      descriptor = "(Lclient!qa;Ljava/awt/Canvas;)V")
  public za(@OriginalArg(0) qa arg0, @OriginalArg(1) Canvas arg1) {
    this.aCanvas8 = arg1;
    @Pc(7)
    Dimension local7 = arg1.getSize();
  ...
  public native void H(
      @OriginalArg(0) Canvas arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2);
