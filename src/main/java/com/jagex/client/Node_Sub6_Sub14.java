...
public final class Node_Sub6_Sub14 extends Node_Sub6 {
  ...
  public int[] method5510(@OriginalArg(1) int arg0) {
    ...
    if (super.aClass82_41.aBoolean243) {
      @Pc(37)
      int[] local37 = this.method5508(this.aBoolean321 ? Static211.anInt3929 - arg0 : arg0, 0);
      if (this.aBoolean322) {
  ...
  public int[][] method5514(@OriginalArg(1) int arg0) {
    ...
    if (super.aClass153_41.aBoolean437) {
      @Pc(34)
      int[][] local34 = this.method5516(0, this.aBoolean321 ? Static211.anInt3929 - arg0 : arg0);
      @Pc(38)
      int[] local38 = local34[0];
      @Pc(42)
      int[] local42 = local34[1];
      @Pc(46)
      int[] local46 = local34[2];
      @Pc(50)
      int[] local50 = local16[0];
      @Pc(54)
      int[] local54 = local16[1];
      @Pc(58)
      int[] local58 = local16[2];
      @Pc(63)
      int local63;
      if (this.aBoolean322) {
  ...
  public void method5518(@OriginalArg(1) int arg0, @OriginalArg(2) Packet arg1) {
    if (arg0 == 0) {
      this.aBoolean322 = arg1.g1() == 1;
    } else if (arg0 == 1) {
      this.aBoolean321 = arg1.g1() == 1;
    } else if (arg0 == 2) {
