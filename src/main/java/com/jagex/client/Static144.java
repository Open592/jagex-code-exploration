...
public final class Static144 {
  ...
  private static void method2433(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
    ...
    int local7 = arg0;
    @Pc(11)
    int local11 = anIntArray185[arg0];
    @Pc(17)
    int local17 = anIntArray185[arg0 + 1];
    @Pc(23)
    int local23 = anIntArray185[arg0 + 2];
    @Pc(29)
    int local29 = anIntArray185[arg0 + 3];
    for (@Pc(33) int local33 = arg0 + 4; local33 < arg1; local33 += 4) {
      @Pc(40)
      int local40 = anIntArray185[local33 + 1];
      if (local40 < local17) {
    ...
    while (true) {
      if (arg1 >= arg0 + 8) {
        ...
        for (@Pc(6) int local6 = arg0 + 4; local6 < arg1; local6 += 4) {
          @Pc(13)
          int local13 = anIntArray185[local6 - 4];
          @Pc(17)
          int local17 = anIntArray185[local6];
          if (local13 > local17) {
            local2 = false;
  ...
  private static boolean method2437(@OriginalArg(0) int arg0) {
    @Pc(1)
    int local1 = anInt2893;
    @Pc(3)
    int local3 = anInt2895;
    @Pc(5)
    int local5 = anInt2898;
    while (local3 >= local1) {
      local5++;
      anInt2898 = local5;
      if (local5 >= arg0) {
      ...
      while (local1 < anInt2896) {
        ...
        @Pc(36)
        int local36 = anIntArray185[local1 + 2];
        @Pc(42)
        int local42 = anIntArray185[local1 + 3];
        @Pc(52)
        int local52 = (local36 - local30 << 16) / (local42 - local23);
        @Pc(58)
        int local58 = (local30 << 16) + 32768;
  ...
  private static void method2438(
  ...
  private static void method2439(@OriginalArg(0) int arg0) {
    ...
    for (local26 = 0; local26 < anInt2896; local26 += 4) {
      @Pc(33)
      int local33 = anIntArray185[local26 + 1];
      if (local17 < local33) {
        break;
      }
      @Pc(40)
      int local40 = anIntArray185[local26];
      @Pc(46)
      int local46 = anIntArray185[local26 + 2];
      @Pc(52)
      int local52 = anIntArray185[local26 + 3];
      @Pc(62)
      int local62 = (local46 - local40 << 16) / (local52 - local33);
      @Pc(68)
      int local68 = (local40 << 16) + 32768;
  ...
  private static void method2441(@OriginalArg(0) int[] arg0, @OriginalArg(2) int arg1) {
    @Pc(5)
    int local5 = anInt2896 + (arg1 << 1);
    @Pc(16)
    int local16;
    if (anIntArray185 == null || anIntArray185.length < local5) {
      @Pc(14)
      int[] local14 = new int[local5];
    ...
    int local33 = arg1;
    @Pc(37)
    int local37 = local33 - 2;
    for (local16 = 0; local16 < local33; local16 += 2) {
      @Pc(46)
      int local46 = arg0[local37 + 1];
      @Pc(52)
      int local52 = arg0[local16 + 1];
      if (local46 < local52) {
