...
public final class ListNode_Sub15_Sub2 extends ListNode_Sub15 {
	...
	public synchronized void method2954(@OriginalArg(0) ListNode_Sub15 arg0) {
	...
	public ListNode_Sub15 method4857() {
		return (ListNode_Sub15) this.aClass183_26.method4144();
	}
	...
	private void method2956(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		for (@Pc(5) ListNode_Sub15 local5 = (ListNode_Sub15) this.aClass183_26.method4140(); local5 != null; local5 = (ListNode_Sub15) this.aClass183_26.method4144()) {
	...
	public ListNode_Sub15 method4860() {
		return (ListNode_Sub15) this.aClass183_26.method4140();
	}
	...
	private void method2957(@OriginalArg(0) ListNode_Sub44 arg0) {
		...
		if (local9 == this.aClass183_27.aListNode_207) {
			...
			this.anInt3580 = ((ListNode_Sub44) local9).anInt7350;
		}
	}
	...
	private void method2960() {
		...
		for (@Pc(8) ListNode_Sub44 local8 = (ListNode_Sub44) this.aClass183_27.method4140(); local8 != null; local8 = (ListNode_Sub44) this.aClass183_27.method4144()) {
	...
	public synchronized void method4861(@OriginalArg(0) int arg0) {
		do {
			...
			this.method2960();
			@Pc(50) ListNode_Sub44 local50 = (ListNode_Sub44) this.aClass183_27.method4140();
	...
	public synchronized void method4855(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		do {
			...
			this.method2960();
			@Pc(60) ListNode_Sub44 local60 = (ListNode_Sub44) this.aClass183_27.method4140();
