...
public final class Static353 {
  ...
  public static void method4771(
      ...
      @OriginalArg(4) Class79 arg1,
      @OriginalArg(5) float arg2,
      @OriginalArg(6) float arg3,
      @OriginalArg(7) byte[] arg4,
      @OriginalArg(9) int arg5,
      @OriginalArg(10) float arg6,
      @OriginalArg(11) int arg7,
      @OriginalArg(12) float arg8) {
    @Pc(12)
    float[] local12 = new float[16384];
    @Pc(23)
    int local23;
    @Pc(65)
    int local65;
  ...
  public static boolean method4772(@OriginalArg(1) boolean arg0) {
    @Pc(6)
    boolean local6 = Static122.aClass19_16.method4301();
    if (local6 == arg0) {
      return true;
    }
    if (!arg0) {
