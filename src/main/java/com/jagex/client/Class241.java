...
public final class Class241 {
  ...
  private byte[] method5243() {
    ...
    for (@Pc(3) int local3 = 0; local3 < 10; local3++) {
      if (this.aClass184Array1[local3] != null
          && this.aClass184Array1[local3].anInt5406 + this.aClass184Array1[local3].anInt5408
              > local1) {
    ...
    @Pc(49)
    int local49 = local1 * 22050 / 1000;
    @Pc(52)
    byte[] local52 = new byte[local49];
    for (@Pc(54) int local54 = 0; local54 < 10; local54++) {
      if (this.aClass184Array1[local54] != null) {
        @Pc(70)
        int local70 = this.aClass184Array1[local54].anInt5406 * 22050 / 1000;
        @Pc(80)
        int local80 = this.aClass184Array1[local54].anInt5408 * 22050 / 1000;
        @Pc(92)
        int[] local92 =
            this.aClass184Array1[local54].method4152(
                local70, this.aClass184Array1[local54].anInt5406);
        for (@Pc(94) int local94 = 0; local94 < local70; local94++) {
          @Pc(107)
          int local107 = local52[local94 + local80] + (local92[local94] >> 8);
  ...
  public Node_Sub4_Sub1 method5245() {
    @Pc(2)
    byte[] local2 = this.method5243();
    return new Node_Sub4_Sub1(
        22050, local2, this.anInt6706 * 22050 / 1000, this.anInt6707 * 22050 / 1000);
  }
  ...
  public int method5246() {
    ...
    for (@Pc(3) int local3 = 0; local3 < 10; local3++) {
      if (this.aClass184Array1[local3] != null
          && this.aClass184Array1[local3].anInt5408 / 20 < local1) {
