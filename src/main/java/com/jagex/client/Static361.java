...
public final class Static361 {
  ...
  public static void method4870(
      @OriginalArg(0) int arg0, @OriginalArg(2) Class247 arg1, @OriginalArg(3) int arg2) {
  ...
  public static boolean method4871(
    ...
    boolean local7 = true;
    @Pc(12)
    Packet local12 = new Packet(arg3);
    @Pc(14)
    int local14 = -1;
    label54:
    while (true) {
      @Pc(18)
      int local18 = local12.gSmartsExtend();
      if (local18 == 0) {
        return local7;
      }
      local14 += local18;
      ...
      while (true) {
        ...
        while (!local28) {
          ...
          local26 += local34 - 1;
          @Pc(61)
          int local61 = local26 & 0x3F;
          @Pc(67)
          int local67 = local26 >> 6 & 0x3F;
          @Pc(73)
          int local73 = local12.g1() >> 2;
          @Pc(77)
          int local77 = arg1 + local67;
          @Pc(81)
          int local81 = arg4 + local61;
          if (local77 > 0 && local81 > 0 && local77 < arg0 - 1 && arg2 - 1 > local81) {
            @Pc(110)
            Class202 local110 = Static267.aClass262_2.method5560(local14);
            if (local73 != 22
                || ClientPreferences.preferences.aBoolean305
                || local110.anInt5813 != 0
                || local110.anInt5851 == 1
                || local110.aBoolean539) {
              local28 = true;
