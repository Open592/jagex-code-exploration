...
public final class ContextualEntry_Sub1_Sub18 extends ContextualEntry {
	...
	private void method4667(@OriginalArg(0) Packet arg0, @OriginalArg(1) int arg1) {
		...
		for (local23 = 0; local23 < local14; local23++) {
			...
			@Pc(55) LinkedEntry local55;
			if (local42) {
				local55 = new LinkedEntry_Sub7(arg0.gStringCP1252ToUTF8());
			} else {
				local55 = new LinkedEntry_Sub37(arg0.g4());
			}
	...
	public int method4670(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		if (this.aLinkedHashMap_Iterator_35 == null) {
			...
			@Pc(23) LinkedEntry_Sub37 local23 = (LinkedEntry_Sub37) this.aLinkedHashMap_Iterator_35.get((long) arg1);
	...
	public String method4671(@OriginalArg(1) String arg0, @OriginalArg(2) int arg1) {
		if (this.aLinkedHashMap_Iterator_35 == null) {
			...
			@Pc(21) LinkedEntry_Sub7 local21 = (LinkedEntry_Sub7) this.aLinkedHashMap_Iterator_35.get((long) arg1);
