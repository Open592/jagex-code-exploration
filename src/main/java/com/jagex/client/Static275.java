...
public final class Static275 {
	...
	public static void method3929(@OriginalArg(0) SignLink arg0, @OriginalArg(1) String arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) boolean arg3) {
		if (!arg3) {
		...
		if (SignLink.systemOSName.startsWith("win") && SignLink.anInt1987 != 3) {
			local29 = null;
			if (arg0.loader != null) {
				local29 = arg0.loader.getParameter("haveie6");
			}
		...
		if (SignLink.systemOSName.startsWith("mac")) {
			local29 = null;
			if (arg0.loader != null) {
				local29 = arg0.loader.getParameter("havefirefox");
			}
