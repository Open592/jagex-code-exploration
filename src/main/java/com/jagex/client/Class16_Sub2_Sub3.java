...
public final class Class16_Sub2_Sub3 extends Class16_Sub2 implements Interface6 {
  ...
  @OriginalMember(
      owner = "client!mj",
      name = "<init>",
      descriptor = "(Lclient!ya;Lclient!rd;IIIIIZIIIIII)V")
  public Class16_Sub2_Sub3(
  ...
  public Class3_Sub3 method5339(@OriginalArg(0) Class19 arg0) {
    @Pc(16)
    Class110 local16 =
        this.aClass23_3.method578(super.anInt4552, true, arg0, super.anInt4566, 2048, false);
    if (local16 == null) {
      return null;
    }
    @Pc(23)
    ...
    local23.j(
        super.anInt4566 + super.anInt4550, super.anInt4559, super.anInt4552 + super.anInt4551);
    @Pc(41)
    Class3_Sub3 local41 = null;
    if (this.aBoolean421) {
    ...
    if (this.aClass23_3.aClass3_Sub2_1 == null) {
      ...
      @Pc(77)
      Class146 local77 = this.aClass23_3.aClass3_Sub2_1.method171();
      arg0.method4262(
          local16, local77, local23, local41 == null ? null : local41.aClass3_Sub5Array1[0]);
    }
    @Pc(96)
    int local96 = super.anInt4566 >> 7;
    @Pc(101)
    int local101 = super.anInt4552 >> 7;
  ...
  public boolean method5341(
    ...
    @Pc(16)
    Class110 local16 =
        this.aClass23_3.method578(super.anInt4552, false, arg1, super.anInt4566, 131072, false);
    if (local16 == null) {
      return false;
    } else {
      @Pc(28)
      Class31 local28 = arg1.method4289();
      local28.j(
          super.anInt4566 + super.anInt4550, super.anInt4559, super.anInt4552 + super.anInt4551);
  ...
  public void method5335(@OriginalArg(0) Class19 arg0) {
    @Pc(22)
    Class110 local22 =
        this.aClass23_3.method578(super.anInt4552, true, arg0, super.anInt4566, 262144, false);
    if (local22 != null) {
      @Pc(29)
      int local29 = super.anInt4566 >> 7;
      @Pc(34)
      int local34 = super.anInt4552 >> 7;
