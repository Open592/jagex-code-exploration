...
public final class Class124 {
  ...
  public Class124(
    ...
    this.aJs5_46 = arg2;
    this.anInt3845 = this.aJs5_46.method2108(4);
  }

  @OriginalMember(owner = "client!kb", name = "a", descriptor = "(B)V")
  public void method3149() {
    @Pc(2)
    Class68 local2 = this.aClass68_21;
    synchronized (this.aClass68_21) {
      this.aClass68_21.clear();
    }
  }
  ...
  public Class113 method3150(@OriginalArg(1) int arg0) {
    @Pc(6)
    Class68 local6 = this.aClass68_21;
    @Pc(16)
    Class113 local16;
    synchronized (this.aClass68_21) {
    ...
    @Pc(33)
    byte[] local33 = this.aJs5_46.method2104(arg0, 4);
    local16 = new Class113();
    local16.aClass124_4 = this;
    local16.anInt3385 = arg0;
    if (local33 != null) {
      local16.method2822(new Packet(local33));
    }
    local16.method2818();
    @Pc(60)
    Class68 local60 = this.aClass68_21;
    synchronized (this.aClass68_21) {
