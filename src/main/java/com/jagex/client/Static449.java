...
public final class Static449 {
  ...
  public static float[] method5652(
      ...
      @OriginalArg(7) float arg6) {
    @Pc(6)
    float[] local6 = new float[9];
    @Pc(9)
    float[] local9 = new float[9];
    @Pc(17)
    float local17 = (float) Math.cos((double) ((float) arg1 * 0.024543693F));
    @Pc(25)
    float local25 = (float) Math.sin((double) ((float) arg1 * 0.024543693F));
    local6[8] = local17;
    local6[3] = 0.0F;
    local6[0] = local17;
    local6[5] = 0.0F;
    ...
    local6[7] = 0.0F;
    @Pc(69)
    float[] local69 = new float[9];
    @Pc(71)
    float local71 = 1.0F;
    @Pc(73)
    float local73 = 0.0F;
    @Pc(78)
    float local78 = (float) arg2 / 32767.0F;
    @Pc(82)
    float local82 = 1.0F - local78;
    @Pc(98)
    float local98 = -((float) Math.sqrt((double) (1.0F - local78 * local78)));
    @Pc(110)
    float local110 = (float) Math.sqrt((double) (arg4 * arg4 + arg3 * arg3));
  ...
  public static void method5653() {
    ...
    for (@Pc(22) Node_Sub43 local22 = (Node_Sub43) Static325.aHashMap_29.head();
        local22 != null;
        local22 = (Node_Sub43) Static325.aHashMap_29.next()) {
      if (!local22.hasNext()) {
        local22 = (Node_Sub43) Static325.aHashMap_29.head();
        if (local22 == null) {
          break;
        }
      }
  ...
  public static void method5654() {
    for (@Pc(16)
        SecondaryNode_Sub1_Sub10 local16 =
            (SecondaryNode_Sub1_Sub10) Static292.A_LINKED_LIST___36.tail();
        local16 != null;
        local16 = (SecondaryNode_Sub1_Sub10) Static292.A_LINKED_LIST___36.previous()) {
      @Pc(21)
      Class16_Sub1_Sub2 local21 = local16.aClass16_Sub1_Sub2_1;
  ...
  public static byte[][][] method5655(@OriginalArg(1) int arg0) {
    @Pc(9)
    byte[][][] local9 = new byte[8][4][];
    @Pc(18)
    byte[] local18 = new byte[arg0 * arg0];
    @Pc(20)
    int local20 = 0;
    @Pc(26)
    int local26;
