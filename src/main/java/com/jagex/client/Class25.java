...
public final class Class25 {
	...
	private final HashMap aLinkedHashMap_Iterator_5;
	...
	public Node method640() {
		@Pc(30) Node local30;
		if (this.anInt626 > 0 && this.aNode_33 != this.aLinkedHashMap_Iterator_5.buckets[this.anInt626 - 1]) {
			local30 = this.aNode_33;
			this.aNode_33 = local30.previous;
			return local30;
		}
		while (this.anInt626 < this.aLinkedHashMap_Iterator_5.bucketCount) {
