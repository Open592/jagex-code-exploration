...
public final class Class261 {
  ...
  public Class261(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
    if (arg0 != arg1) {
      @Pc(12)
      int local12 = Static432.method5493(arg0, arg1);
      @Pc(16)
      int local16 = arg0 / local12;
      @Pc(20)
      int local20 = arg1 / local12;
      ...
      for (@Pc(33) int local33 = 0; local33 < local16; local33++) {
        @Pc(40)
        int[] local40 = this.anIntArrayArray60[local33];
        @Pc(48)
        double local48 = (double) local33 / (double) local16 + 6.0D;
        @Pc(56)
        int local56 = (int) Math.floor(local48 + 1.0D - 7.0D);
        if (local56 < 0) {
          local56 = 0;
        }
        @Pc(66)
        int local66 = (int) Math.ceil(local48 + 7.0D);
        if (local66 > 14) {
          local66 = 14;
        }
        @Pc(77)
        double local77 = (double) local20 / (double) local16;
        while (local66 > local56) {
          @Pc(86)
          double local86 = ((double) local56 - local48) * 3.141592653589793D;
          @Pc(88)
          double local88 = local77;
  ...
  public byte[] method5551(@OriginalArg(0) byte[] arg0) {
    if (this.anIntArrayArray60 != null) {
      @Pc(29)
      int local29 = (int) ((long) this.anInt7171 * (long) arg0.length / (long) this.anInt7176) + 14;
      @Pc(32)
      int[] local32 = new int[local29];
      @Pc(34)
      int local34 = 0;
      @Pc(36)
      int local36 = 0;
      ...
      for (@Pc(101) int local101 = 0; local101 < local29; local101++) {
        @Pc(111)
        int local111 = local32[local101] + 32768 >> 16;
        if (local111 < -128) {
          arg0[local101] = -128;
