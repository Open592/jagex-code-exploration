...
public final class Static338 {
	...
	public static void method4595(@OriginalArg(1) boolean arg0, @OriginalArg(2) String arg1) {
		...
		if (Static413.anInt6823 >= 100) {
			Static415.method5323(Static438.aClass83_147.method2267(Static178.langID));
			return;
		}
		...
		for (@Pc(31) int local31 = 0; local31 < Static413.anInt6823; local31++) {
			...
			if (local39 != null && local39.equals(local26)) {
				Static415.method5323(arg1 + Static188.aClass83_113.method2267(Static178.langID));
				return;
			}
		...
		for (@Pc(99) int local99 = 0; local99 < Static49.anInt2346; local99++) {
			...
			if (local69 != null && local69.equals(local26)) {
				Static415.method5323(Static256.aClass83_99.method2267(Static178.langID) + arg1 + Static232.aClass83_92.method2267(Static178.langID));
				return;
			}
		...
		if (Static123.method4868(Static1.aClass16_Sub1_Sub5_Sub1_1.aString44).equals(local26)) {
			...
			Static3.aClass4_Sub12_Sub1_5.writeByte(Static269.method3856(arg1) + 1);
			Static3.aClass4_Sub12_Sub1_5.writeString(arg1);
			Static3.aClass4_Sub12_Sub1_5.writeByte(arg0 ? 1 : 0);
		}
	}
}
