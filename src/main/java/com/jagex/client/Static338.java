  ...
  public static void method4595(@OriginalArg(1) boolean arg0, @OriginalArg(2) String arg1) {
    ...
    if (Static413.anInt6823 >= 100) {
      Static415.method5323(
          Static438.A_LOCALIZED_STRING___147.getLocalizedString(ClientSettings.langID));
      return;
    }
    @Pc(26)
    String local26 = Static123.method4868(arg1);
    if (local26 == null) {
      return;
    }
    @Pc(69)
    ...
    for (@Pc(31) int local31 = 0; local31 < Static413.anInt6823; local31++) {
      @Pc(39)
      String local39 = Static123.method4868(Static326.aStringArray27[local31]);
      if (local39 != null && local39.equals(local26)) {
        Static415.method5323(
            arg1 + Static188.A_LOCALIZED_STRING___113.getLocalizedString(ClientSettings.langID));
        return;
      }
    ...
    for (@Pc(99) int local99 = 0; local99 < Static49.anInt2346; local99++) {
      ...
      if (local69 != null && local69.equals(local26)) {
        Static415.method5323(
            Static256.A_LOCALIZED_STRING___99.getLocalizedString(ClientSettings.langID)
                + arg1
                + Static232.A_LOCALIZED_STRING___92.getLocalizedString(ClientSettings.langID));
        return;
      }
      if (Static57.aStringArray6[local99] != null) {
        @Pc(142)
        String local142 = Static123.method4868(Static57.aStringArray6[local99]);
    ...
    if (Static123.method4868(Static1.aClass16_Sub1_Sub5_Sub1_1.aString44).equals(local26)) {
      Static415.method5323(
          Static340.A_LOCALIZED_STRING___119.getLocalizedString(ClientSettings.langID));
    } else {
