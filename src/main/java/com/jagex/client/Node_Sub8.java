...
public final class Node_Sub8 extends Node {
  ...
  public Node_Sub15_Sub3 aClass4_Sub15_Sub3_1;
  ...
  public Node_Sub15_Sub3 aClass4_Sub15_Sub3_2;
  ...
  public void method638() {
    @Pc(8)
    int local8 = this.anInt616;
    if (this.aClass202_1 != null) {
      @Pc(88)
      Class202 local88 = this.aClass202_1.method4584(Static257.aClass114_1);
      if (local88 == null) {
        this.anInt616 = -1;
        this.anInt620 = 0;
        this.anInt622 = 0;
      ...
      @Pc(42)
      int local42 = Static325.method4392(this.aClass16_Sub1_Sub5_Sub2_1);
      if (local8 != local42) {
