...
public final class ListNode_Sub1_Sub17 extends ListNode_Sub1 {
	...
	public ListNode_Sub1_Sub17(@OriginalArg(0) int arg0) {
		this.anInt5488 = arg0;
	}
	...
	public boolean method4211() {
		...
		for (@Pc(121) int local121 = 0; local121 < local119.length; local121++) {
			...
			@Pc(144) ListNode_Sub32 local144 = null;
			for (@Pc(149) ListNode_Sub32 local149 = (ListNode_Sub32) local103.method4140(); local149 != null; local149 = (ListNode_Sub32) local103.method4144()) {
			...
			if (local144 == null) {
				local144 = new ListNode_Sub32(local142, Static414.aClass76_96.method2122(local142));
