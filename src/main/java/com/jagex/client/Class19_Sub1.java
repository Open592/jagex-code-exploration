...
public final class Class19_Sub1 extends Class19 {
  ...
  @OriginalMember(
      owner = "client!bc",
      name = "<init>",
      descriptor = "(ILjava/awt/Canvas;Lclient!ga;)V")
  public Class19_Sub1(
      @OriginalArg(0) int arg0, @OriginalArg(1) Canvas arg1, @OriginalArg(2) Interface7 arg2) {
    this(arg0, arg2);
  ...
  public void method4287(
    ...
    @Pc(2)
    Class145_Sub2 local2 = (Class145_Sub2) arg5;
    @Pc(5)
    int[] local5 = local2.anIntArray554;
    @Pc(8)
    int[] local8 = local2.anIntArray553;
    @Pc(17)
    int local17 = this.anInt425 > arg7 ? this.anInt425 : arg7;
    @Pc(32)
    int local32 = this.anInt421 < arg7 + local5.length ? this.anInt421 : arg7 + local5.length;
    arg2 -= arg0;
    arg3 -= arg1;
    if (arg2 + arg3 < 0) {
      arg0 += arg2;
    ...
    if (arg2 <= arg3) {
      ...
      if (local116 == 255) {
        while (arg1 <= arg3) {
          ...
          if (local129 >= this.lb
              && local129 < this.anInt402
              && local129 >= local145
              && local129 < local145 + local8[local133]) {
        ...
        local201 =
            ((arg4 & 0xFF00FF) * local116 >> 8 & 0xFF00FF)
                + ((arg4 & 0xFF00) * local116 >> 8 & 0xFF00)
                + (local116 << 24);
        ...
        while (arg1 <= arg3) {
          ...
          if (local133 >= this.lb
              && local133 < this.anInt402
              && local133 >= local226
              && local133 < local226 + local8[local145]) {
            local243 = local133 + arg1 * this.anInt430;
            local248 = this.anIntArray26[local243];
            @Pc(584)
            int local584 =
                ((local248 & 0xFF00FF) * local129 >> 8 & 0xFF00FF)
                    + ((local248 & 0xFF00) * local129 >> 8 & 0xFF00);
  ...
  private void method483() {
    ...
    for (@Pc(29) int local29 = 0; local29 < this.anInt420; local29++) {
      @Pc(36)
      Class201 local36 = this.aClass45Array1[local29].aClass201_1;
    ...
    @Pc(78)
    int local78 = this.anInt425 * this.anInt430 + this.lb;
  ...
  public void ca(
      ...
      @OriginalArg(3) int arg3) {
    @Pc(2)
    Class145_Sub2 local2 = (Class145_Sub2) arg1;
    @Pc(5)
    int[] local5 = local2.anIntArray554;
    @Pc(8)
    int[] local8 = local2.anIntArray553;
    ...
    @Pc(49)
    int local49 = arg3 * this.anInt430;
    for (@Pc(51) int local51 = local33; local51 < local20; local51++) {
      @Pc(58)
      int local58 = arg2 + local5[local51];
      @Pc(62)
      int local62 = local8[local51];
      if (this.lb > local58) {
  ...
  protected void NA(
    ...
    @Pc(8)
    int local8 = arg1 - arg2;
    if (local8 < this.anInt425) {
      local8 = this.anInt425;
    }
    @Pc(21)
    int local21 = arg1 + arg2 + 1;
    ...
    int local30 = local8;
    @Pc(34)
    int local34 = arg2 * arg2;
    @Pc(36)
    int local36 = 0;
    @Pc(40)
    int local40 = arg1 - local8;
    @Pc(44)
    int local44 = local40 * local40;
    @Pc(48)
    int local48 = local44 - local40;
    if (arg1 > local21) {
      arg1 = local21;
    }
    @Pc(57)
    ...
    if (arg4 == 1) {
      @Pc(277)
      int local277 =
          ((arg3 & 0xFF00FF) * local57 >> 8 & 0xFF00FF)
              + ((arg3 & 0xFF00) * local57 >> 8 & 0xFF00)
              + (local57 << 24);
      local91 = 256 - local57;
      while (local30 < arg1) {
        while (local48 <= local34 || local44 <= local34) {
        ...
        for (local334 = local102; local334 < local116; local334++) {
          ...
          local340 =
              ((local340 & 0xFF00FF) * local91 >> 8 & 0xFF00FF)
                  + ((local340 & 0xFF00) * local91 >> 8 & 0xFF00);
      ...
      while (local30 < arg1) {
        ...
        for (local118 = local91; local118 < local102; local118++) {
          ...
          @Pc(603)
          int local603 = (local593 & 0x1000100) + (local340 - local593 & 0x10000);
  ...
  private void method485() {
    ...
    @Pc(8)
    float local8 = (float) this.anInt405;
    @Pc(12)
    float local12 = (float) this.anInt406;
    @Pc(23)
    float local23 = -(local12 * 2.0F * local8) / (local8 - local12);
    @Pc(32)
    float local32 = this.aFloat12 / (this.aFloat13 + this.aFloat12);
    @Pc(36)
    float local36 = local32 * local32;
    @Pc(50)
    float local50 = -local23 * (1.0F - local32) * (1.0F - local32) / this.aFloat13;
    this.anInt403 =
        (int)
            (((float) this.anInt405 - local23 * local36)
                    / ((local8 + local12) / (local8 - local12) - local50)
                + 0.5F);
  }
  ...
  public void O(
    ...
    @Pc(67)
    int local67 = this.anInt430 - arg2;
    @Pc(74)
    int local74 = arg0 + arg1 * this.anInt430;
    @Pc(78)
    int local78 = arg4 >>> 24;
    @Pc(90)
    int local90;
    ...
    if (arg5 != 0 && (arg5 != 1 || local78 != 255)) {
      ...
      if (arg5 == 1) {
        @Pc(205)
        int local205 =
            ((arg4 & 0xFF00FF) * local78 >> 8 & 0xFF00FF)
                + ((arg4 & 0xFF00) * local78 >> 8 & 0xFF00)
                + (local78 << 24);
        local90 = 256 - local78;
        for (local94 = 0; local94 < arg3; local94++) {
          for (local101 = -arg2; local101 < 0; local101++) {
            ...
            local221 =
                ((local221 & 0xFF00FF) * local90 >> 8 & 0xFF00FF)
                    + ((local221 & 0xFF00) * local90 >> 8 & 0xFF00);
        ...
        for (local90 = 0; local90 < arg3; local90++) {
          for (local94 = -arg2; local94 < 0; local94++) {
            ...
            @Pc(288)
            int local288 = (arg4 & 0xFF00FF) + (local101 & 0xFF00FF);
            @Pc(298)
            int local298 = (local288 & 0x1000100) + (local221 - local288 & 0x10000);
  ...
  public void DA(
    ...
    int local8 = 0;
    @Pc(14)
    int local14 = (arg7 << 16) / arg2;
    @Pc(23)
    int local23 = (arg6.length / arg7 << 16) / arg3;
    @Pc(30)
    int local30 = arg0 + arg1 * this.anInt430;
    @Pc(35)
    int local35 = this.anInt430 - arg2;
    if (arg1 + arg3 > this.anInt421) {
    ...
    if (arg8 == 1) {
      ...
      for (local148 = -arg3; local148 < 0; local148++) {
        ...
        for (local158 = -arg2; local158 < 0; local158++) {
          ...
          this.anIntArray26[local30++] =
              ((local222 & 0xFF00FF) * local236 + (local245 & 0xFF00FF) * local240 & 0xFF00FF00)
                      + ((local222 & 0xFF00) * local236 + (local245 & 0xFF00) * local240 & 0xFF0000)
                  >> 8;
          local6 += local14;
        }
        local8 += local23;
      ...
      for (local148 = -arg3; local148 < 0; local148++) {
        ...
        for (local158 = -arg2; local158 < 0; local158++) {
          ...
          if (local222 == 0) {
            ...
            @Pc(360)
            int local360 = (local245 & 0x1000100) + (local240 - local245 & 0x10000);
  ...
  private int[] method487(@OriginalArg(0) int arg0) {
    @Pc(2)
    Class68 local2 = this.aClass68_2;
    @Pc(12)
    Node_Sub40 local12;
    synchronized (this.aClass68_2) {
      ...
      if (local12 == null) {
        ...
        @Pc(32)
        Class251 local32 = super.anInterface7_6.method2396(arg0);
        @Pc(42)
        int local42 = local32.aBoolean637 || this.aBoolean45 ? 64 : 128;
        local12 =
            new Node_Sub40(
                arg0,
                local42,
                super.anInterface7_6.method2395(arg0, 0.7F, local42, local42),
                local32.aBoolean641);
  ...
  public Class57 method4265(
    ...
    for (@Pc(5) int local5 = 0; local5 < arg3; local5++) {
      for (@Pc(8) int local8 = 0; local8 < arg2; local8++) {
        @Pc(16)
        int local16 = arg0[local3++] >>> 24;
        if (local16 != 0 && local16 != 255) {
          local1 = true;
          return local1
              ? new Class57_Sub1_Sub2(this, arg0, 0, arg1, arg2, arg3)
              : new Class57_Sub1_Sub1(this, arg0, 0, arg1, arg2, arg3);
        }
      }
    }
    return local1
  ...
  public void method4246(@OriginalArg(0) int arg0) {
    @Pc(4)
    int local4 = arg0 - this.anInt400;
    for (@Pc(9) Object local9 = this.aClass68_2.method1789();
        local9 != null;
        local9 = this.aClass68_2.method1782()) {
      @Pc(13)
      Node_Sub40 local13 = (Node_Sub40) local9;
      if (local13.aBoolean572) {
        local13.anInt6274 += local4;
        @Pc(27)
        int local27 = local13.anInt6274 / 20;
        if (local27 > 0) {
          @Pc(36)
          Class251 local36 = super.anInterface7_6.method2396(local13.anInt6273);
          local13.method4876(
              local36.aByte91 * local4 * 50 / 1000, local36.aByte93 * local4 * 50 / 1000);
  ...
  public void method4307(
      ...
      @OriginalArg(3) int arg3) {
    @Pc(3)
    Class110_Sub2[] local3 = new Class110_Sub2[arg0.length];
    ...
    @Pc(26)
    Class110_Sub2 local26 = Static364.method4912(this, local3);
  ...
  public void method4277(@OriginalArg(0) Class146 arg0) {
    @Pc(3)
    Class3_Sub1 local3 = arg0.aClass232_1.aClass3_Sub1_7;
    for (@Pc(6) Class3_Sub1 local6 = local3.aClass3_Sub1_6;
        local6 != local3;
        local6 = local6.aClass3_Sub1_6) {
      @Pc(10)
      Class3_Sub1_Sub1 local10 = (Class3_Sub1_Sub1) local6;
      @Pc(15)
      int local15 = local10.anInt4068 >> 12;
      @Pc(20)
      int local20 = local10.anInt4076 >> 12;
      @Pc(25)
      int local25 = local10.anInt4073 >> 12;
      @Pc(49)
      int local49 =
          this.aClass31_Sub2_1.anInt7333
              + (this.aClass31_Sub2_1.anInt7323 * local15
                      + this.aClass31_Sub2_1.anInt7330 * local20
                      + this.aClass31_Sub2_1.anInt7325 * local25
                  >> 15);
      if (local49 >= this.anInt406 && local49 <= this.anInt411) {
        ...
        int local90 =
            this.anInt424
                + this.anInt416
                    * (this.aClass31_Sub2_1.anInt7329
                        + (this.aClass31_Sub2_1.anInt7334 * local15
                                + this.aClass31_Sub2_1.anInt7328 * local20
                                + this.aClass31_Sub2_1.anInt7332 * local25
                            >> 15))
                    / local49;
        @Pc(122)
        int local122 =
            this.anInt422
                + this.anInt417
                    * (this.aClass31_Sub2_1.anInt7324
                        + (this.aClass31_Sub2_1.anInt7331 * local15
                                + this.aClass31_Sub2_1.anInt7326 * local20
                                + this.aClass31_Sub2_1.anInt7327 * local25
                            >> 15))
                    / local49;
        if (local90 >= this.lb
            && local90 <= this.anInt402
            && local122 >= this.anInt425
            && local122 <= this.anInt421) {
          if (local49 == 0) {
            local49 = 1;
          }
    ...
    if (arg3 == 0) {
      ...
      if (arg2 > arg3) {
        ...
        if (arg5 == 0 || arg5 == 1 && local137 == 255) {
          ...
          local204 =
              ((arg4 & 0xFF00FF) * local137 >> 8 & 0xFF00FF)
                  + ((arg4 & 0xFF00) * local137 >> 8 & 0xFF00)
                  + (local137 << 24);
          ...
          while (arg0 <= arg2) {
            ...
            if (local213 >= this.anInt425 && local213 < this.anInt421) {
              ...
              local233 =
                  ((local233 & 0xFF00FF) * local150 >> 8 & 0xFF00FF)
                      + ((local233 & 0xFF00) * local150 >> 8 & 0xFF00);
  ...
  public void method4249(@OriginalArg(0) Canvas arg0) {
    @Pc(8)
    Node_Sub22 local8 = (Node_Sub22) this.aHashMap_3.get((long) arg0.hashCode());
    if (local8 == null) {
  ...
  public void method491(
      @OriginalArg(0) Class3_Sub1_Sub1 arg0,
      @OriginalArg(1) int arg1,
      @OriginalArg(2) int arg2,
      @OriginalArg(3) int arg3) {
    @Pc(2)
    int local2 = arg0.anInt4077;
    @Pc(6)
    int local6 = arg3 >> 1;
    if (local2 == -1) {
    ...
    if (this.anInt431 != local2) {
      @Pc(30)
      Class57 local30 = (Class57) this.aClass68_1.method1787((long) local2);
      if (local30 == null) {
        @Pc(36)
        int[] local36 = this.method487(local2);
        if (local36 == null) {
          return;
        }
        @Pc(46)
        int local46 = this.method493(local2) ? 64 : 128;
  ...
  public Class31 method4289() {
    @Pc(3)
    Class45 local3 = this.method488(Thread.currentThread());
  ...
  public void X(
    ...
    int local23 =
        this.aClass31_Sub2_1.anInt7333
            + (this.aClass31_Sub2_1.anInt7323 * arg0
                    + this.aClass31_Sub2_1.anInt7330 * arg1
                    + this.aClass31_Sub2_1.anInt7325 * arg2
                >> 15);
    ...
    int local73 =
        this.anInt416
            * (this.aClass31_Sub2_1.anInt7329
                + (this.aClass31_Sub2_1.anInt7334 * arg0
                        + this.aClass31_Sub2_1.anInt7328 * arg1
                        + this.aClass31_Sub2_1.anInt7332 * arg2
                    >> 15))
            / local23;
    @Pc(102)
    int local102 =
        this.anInt417
            * (this.aClass31_Sub2_1.anInt7324
                + (this.aClass31_Sub2_1.anInt7331 * arg0
                        + this.aClass31_Sub2_1.anInt7326 * arg1
                        + this.aClass31_Sub2_1.anInt7327 * arg2
                    >> 15))
            / local23;
    if (local73 >= this.anInt423
        && local73 <= this.anInt428
        && local102 >= this.anInt415
        && local102 <= this.anInt408) {
  ...
  public void T(
    ...
    @Pc(26)
    float local26 = (float) Math.sqrt((double) (arg3 * arg3 + arg4 * arg4 + arg5 * arg5));
  ...
  public Class57 method4308(@OriginalArg(0) Class18 arg0) {
    @Pc(2)
    int[] local2 = arg0.anIntArray25;
    @Pc(5)
    byte[] local5 = arg0.aByteArray4;
    @Pc(8)
    int local8 = arg0.anInt367;
    @Pc(11)
    int local11 = arg0.anInt366;
    @Pc(76)
    Class57_Sub1 local76;
    @Pc(20)
    int[] local20;
    @Pc(25)
    byte[] local25;
    ...
    if (arg0.aByteArray5 == null) {
      ...
      if (local25 == null) {
        ...
        for (local27 = 0; local27 < local11; local27++) {
          local32 = local27 * local8;
          for (local34 = 0; local34 < local8; local34++) {
            local20[local32 + local34] =
                local2[local5[local32 + local34] & 0xFF] | local25[local32 + local34] << 24;
          }
        }
  ...
  public Class57 method4280(
    ...
    @Pc(4)
    int[] local4 = new int[arg2 * arg3];
    @Pc(11)
    int local11 = arg1 * this.anInt430 + arg0;
    @Pc(16)
    int local16 = this.anInt430 - arg2;
    for (@Pc(18) int local18 = 0; local18 < arg3; local18++) {
      @Pc(23)
      int local23 = local18 * arg2;
  ...
  public void method494(
    ...
    if (this.anInt431 != arg5) {
      @Pc(26)
      Class57 local26 = (Class57) this.aClass68_1.method1787((long) arg5);
      if (local26 == null) {
        @Pc(32)
        int[] local32 = this.method487(arg5);
        if (local32 == null) {
          return;
        }
        @Pc(43)
        int local43 = this.method493(arg5) ? 64 : 128;
  ...
  public void method4247() {
    ...
    try {
      @Pc(14)
      Graphics local14 = this.aCanvas1.getGraphics();
  ...
  public int[] F(
    ...
    for (@Pc(8) int local8 = 0; local8 < arg3; local8++) {
      @Pc(18)
      int local18 = (arg1 + local8) * this.anInt430 + arg0;
  ...
  public void method4276() {
    ...
    Class45 local3 = this.method488(Thread.currentThread());
    @Pc(6)
    Class201 local6 = local3.aClass201_1;
  ...
  public void TA(
    ...
    @Pc(40)
    int local40 = arg0 + arg1 * this.anInt430;
    @Pc(44)
    int local44 = arg3 >>> 24;
    @Pc(54)
    int local54;
    ...
    if (arg4 == 1) {
      @Pc(97)
      int local97 =
          ((arg3 & 0xFF00FF) * local44 >> 8 & 0xFF00FF)
              + ((arg3 & 0xFF00) * local44 >> 8 & 0xFF00)
              + (local44 << 24);
      local54 = 256 - local44;
      for (local103 = 0; local103 < arg2; local103++) {
        ...
        local116 =
            ((local116 & 0xFF00FF) * local54 >> 8 & 0xFF00FF)
                + ((local116 & 0xFF00) * local54 >> 8 & 0xFF00);
      ...
      for (local54 = 0; local54 < arg2; local54++) {
        ...
        @Pc(178)
        int local178 = (arg3 & 0xFF00FF) + (local111 & 0xFF00FF);
        @Pc(188)
        int local188 = (local178 & 0x1000100) + (local116 - local178 & 0x10000);
  ...
  public void method4263(@OriginalArg(0) Canvas arg0) {
    ...
    @Pc(15)
    Node_Sub22 local15 = (Node_Sub22) this.aHashMap_3.get((long) arg0.hashCode());
    if (local15 != null) {
      local15.popSelf();
    }
  }
  ...
  public void b(
    ...
    if (arg4 == 1) {
      ...
      for (local100 = 0; local100 < arg2; local100++) {
        ...
        local108 =
            ((local108 & 0xFF00FF) * local54 >> 8 & 0xFF00FF)
                + ((local108 & 0xFF00) * local54 >> 8 & 0xFF00);
      ...
      for (local54 = 0; local54 < arg2; local54++) {
        ...
        @Pc(167)
        int local167 = (arg3 & 0xFF00FF) + (local100 & 0xFF00FF);
        @Pc(177)
        int local177 = (local167 & 0x1000100) + (local108 - local167 & 0x10000);
  ...
  public void method4253(
    ...
    Class201 local6 = local3.aClass201_1;
    @Pc(10)
    int local10 = arg2 - arg0;
    @Pc(14)
    int local14 = arg3 - arg1;
    @Pc(21)
    int local21 = local10 >= 0 ? local10 : -local10;
    @Pc(28)
    int local28 = local14 >= 0 ? local14 : -local14;
    @Pc(30)
    int local30 = local21;
    if (local21 < local28) {
      local30 = local28;
    ...
    @Pc(44)
    int local44 = (local10 << 16) / local30;
    @Pc(50)
    int local50 = (local14 << 16) / local30;
    if (local50 <= local44) {
      local44 = -local44;
    } else {
      local50 = -local50;
    ...
    @Pc(66)
    int local66 = arg5 * local50 >> 17;
    @Pc(74)
    int local74 = arg5 * local50 + 1 >> 17;
    @Pc(80)
    int local80 = arg5 * local44 >> 17;
    @Pc(88)
    int local88 = arg5 * local44 + 1 >> 17;
    @Pc(93)
    int local93 = arg0 - local6.method4551();
    @Pc(98)
    int local98 = arg1 - local6.method4549();
    @Pc(102)
    int local102 = local93 + local66;
    @Pc(106)
    int local106 = local93 - local74;
    @Pc(112)
    int local112 = local93 + local10 - local74;
    @Pc(118)
    int local118 = local93 + local10 + local66;
    @Pc(122)
    int local122 = local98 + local80;
    @Pc(126)
    int local126 = local98 - local88;
    @Pc(132)
    int local132 = local98 + local14 - local88;
    @Pc(138)
    int local138 = local98 + local14 + local80;
    local6.anInt5774 = 0;
    local6.aBoolean519 =
        local102 < 0
            || local102 > local6.anInt5772
            || local106 < 0
            || local106 > local6.anInt5772
            || local112 < 0
            || local112 > local6.anInt5772;
  ...
  public Class46 method4275(@OriginalArg(0) Class89 arg0, @OriginalArg(1) Class18[] arg1) {
    @Pc(3)
    int[] local3 = new int[arg1.length];
    @Pc(7)
    int[] local7 = new int[arg1.length];
      ...
      if (local12 == null) {
        ...
        local12 =
            new Node_Sub40(
                arg0,
                local42,
                super.anInterface7_6.method2393(true, arg0, 0.7F, local42, local42),
                local32.aBoolean641);
        this.aClass68_2.method1779((long) arg0, local12);
      }
    }
  ...
  public void UA(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
    ...
    @Pc(11)
    int local11 = this.anInt409 >>> 16 & 0xFF;
    if (local11 < 2) {
      local11 = 2;
    }
    @Pc(23)
    int local23 = this.anInt409 >> 8 & 0xFF;
    if (local23 < 2) {
      local23 = 2;
    }
    @Pc(33)
    int local33 = this.anInt409 & 0xFF;
    if (local33 < 2) {
      local33 = 2;
    }
  ...
  public void method4290(@OriginalArg(0) Rectangle[] arg0, @OriginalArg(1) int arg1) {
    ...
    try {
      ...
      for (@Pc(16) int local16 = 0; local16 < arg1; local16++) {
        @Pc(21)
        Rectangle local21 = arg0[local16];
        if (local21.x <= this.anInt430
            && local21.y <= this.anInt418
            && local21.x + local21.width > 0
            && local21.y + local21.height > 0) {
          this.aClass4_Sub22_1.method4601(
              local21.y, local21.width, local21.x, local14, local21.height);
        }
      }
    } catch (
        @Pc(63)
  ...
  public boolean JA(
    ...
    @Pc(52)
    int local52 =
        (this.aClass31_Sub2_1.anInt7323 * arg3
                    + this.aClass31_Sub2_1.anInt7330 * arg4
                    + this.aClass31_Sub2_1.anInt7325 * arg5
                >> 15)
            + this.aClass31_Sub2_1.anInt7333;
    if (local52 < 1) {
      local52 = 1;
    }
    if (local23 < this.anInt406 && local52 < this.anInt406
        || !(local23 <= this.anInt405 || local52 <= this.anInt405)) {
      return false;
    }
    @Pc(104)
    int local104 =
    ...
    int local133 =
        this.anInt416
            * ((this.aClass31_Sub2_1.anInt7334 * arg3
                        + this.aClass31_Sub2_1.anInt7328 * arg4
                        + this.aClass31_Sub2_1.anInt7332 * arg5
                    >> 15)
                + this.aClass31_Sub2_1.anInt7329)
            / local52;
    if (local104 < this.anInt423 && local133 < this.anInt423
        || local104 > this.anInt428 && local133 > this.anInt428) {
      return false;
    } else {
      @Pc(180)
      int local180 =
      ...
      int local209 =
          this.anInt417
              * ((this.aClass31_Sub2_1.anInt7331 * arg3
                          + this.aClass31_Sub2_1.anInt7326 * arg4
                          + this.aClass31_Sub2_1.anInt7327 * arg5
                      >> 15)
                  + this.aClass31_Sub2_1.anInt7324)
              / local52;
      return (local180 >= this.anInt415 || local209 >= this.anInt415)
          && (local180 <= this.anInt408 || local209 <= this.anInt408);
    }
  }
  ...
  public void method4250(@OriginalArg(0) Canvas arg0) {
    ...
    @Pc(10)
    Node_Sub22 local10 = (Node_Sub22) this.aHashMap_3.get((long) arg0.hashCode());
    if (local10 == null) {
      return;
    }
    this.aCanvas1 = arg0;
