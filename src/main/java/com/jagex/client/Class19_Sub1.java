...
public final class Class19_Sub1 extends Class19 {
	...
	private LinkedEntry_Sub22 aClass4_Sub22_1;
	...
	private int[] method487(@OriginalArg(0) int arg0) {
		...
		@Pc(12) LinkedEntry_Sub40 local12;
		synchronized (this.aClass68_2) {
			local12 = (LinkedEntry_Sub40) this.aClass68_2.method1787((long) arg0);
			if (local12 == null) {
				...
				local12 = new LinkedEntry_Sub40(arg0, local42, super.anInterface7_6.method2395(arg0, 0.7F, local42, local42), local32.aBoolean641);
	...
	public void method4246(@OriginalArg(0) int arg0) {
		...
		for (@Pc(9) Object local9 = this.aClass68_2.method1789(); local9 != null; local9 = this.aClass68_2.method1782()) {
			@Pc(13) LinkedEntry_Sub40 local13 = (LinkedEntry_Sub40) local9;
	...
	public void method4249(@OriginalArg(0) Canvas arg0) {
		@Pc(8) LinkedEntry_Sub22 local8 = (LinkedEntry_Sub22) this.aLinkedHashMap_Iterator_3.get((long) arg0.hashCode());
		if (local8 == null) {
	...
	public void method4263(@OriginalArg(0) Canvas arg0) {
		...
		@Pc(15) LinkedEntry_Sub22 local15 = (LinkedEntry_Sub22) this.aLinkedHashMap_Iterator_3.get((long) arg0.hashCode());
		if (local15 != null) {
			local15.popSelf();
		}
	}
	...
	public int[] method495(@OriginalArg(0) int arg0) {
		...
		synchronized (this.aClass68_2) {
			...
			if (local12 == null) {
				...
				@Pc(32) Class251 local32 = super.anInterface7_6.method2396(arg0);
				@Pc(42) int local42 = local32.aBoolean637 || this.aBoolean45 ? 64 : 128;
				local12 = new LinkedEntry_Sub40(arg0, local42, super.anInterface7_6.method2393(true, arg0, 0.7F, local42, local42), local32.aBoolean641);
				this.aClass68_2.method1779((long) arg0, local12);
			}
		}
		local12.aBoolean572 = true;
	...
	public void method4250(@OriginalArg(0) Canvas arg0) {
		...
		@Pc(10) LinkedEntry_Sub22 local10 = (LinkedEntry_Sub22) this.aLinkedHashMap_Iterator_3.get((long) arg0.hashCode());
		if (local10 == null) {
			return;
		}
		this.aCanvas1 = arg0;
