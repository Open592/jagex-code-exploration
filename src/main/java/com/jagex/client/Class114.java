...
public final class Class114 implements Interface12 {
	...
	private LinkedHashMapIterator aLinkedHashMap_Iterator_16 = new LinkedHashMapIterator(128);
	...
	public void method2828(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(26) int local26 = LinkedHashEntry_Sub1_Sub3.anIntArray17[local19 - local16];
	...
	public void method2829() {
		...
		this.aLinkedHashMap_Iterator_16 = new LinkedHashMapIterator(128);
	}
	...
	public void method2830(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
		...
		@Pc(24) LinkedHashEntry_Sub29 local24 = (LinkedHashEntry_Sub29) this.aLinkedHashMap_Iterator_16.get((long) arg0);
		if (local24 == null) {
			local24 = new LinkedHashEntry_Sub29(4611686018427387905L);
			this.aLinkedHashMap_Iterator_16.set((long) arg0, local24);
	...
	public void method2831(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
		...
		@Pc(23) LinkedHashEntry_Sub29 local23 = (LinkedHashEntry_Sub29) this.aLinkedHashMap_Iterator_16.get((long) arg1);
		if (local23 == null) {
			local23 = new LinkedHashEntry_Sub29(MonotonicClock.getCurrentTimeInMilliseconds() + 500L);
			this.aLinkedHashMap_Iterator_16.set((long) arg1, local23);
		} else {
	...
	public int method2825(@OriginalArg(1) int arg0) {
		...
		@Pc(30) int local30 = LinkedHashEntry_Sub1_Sub3.anIntArray17[local24 - local21];
	...
	public int method2832(@OriginalArg(0) boolean arg0) {
		...
		for (@Pc(22) LinkedHashEntry_Sub29 local22 = arg0 ? (LinkedHashEntry_Sub29) this.aLinkedHashMap_Iterator_16.head() : (LinkedHashEntry_Sub29) this.aLinkedHashMap_Iterator_16.nextEntry(); local22 != null; local22 = (LinkedHashEntry_Sub29) this.aLinkedHashMap_Iterator_16.nextEntry()) {
			if ((local22.aLong153 & 0x3FFFFFFFFFFFFFFFL) < local8) {
				if ((local22.aLong153 & 0x4000000000000000L) != 0L) {
					@Pc(54) int local54 = (int) local22.hashKey;
	...
	public void method2835(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		...
		@Pc(32) int local32 = LinkedHashEntry_Sub1_Sub3.anIntArray17[local25 - local22];
