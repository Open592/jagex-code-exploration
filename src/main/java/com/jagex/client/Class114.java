...
public final class Class114 implements Interface12 {
	...
	public void method2830(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
		...
		@Pc(24) LinkedEntry_Sub29 local24 = (LinkedEntry_Sub29) this.aLinkedHashMap_Iterator_16.get((long) arg0);
		if (local24 == null) {
			local24 = new LinkedEntry_Sub29(4611686018427387905L);
	...
	public void method2831(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
		...
		@Pc(23) LinkedEntry_Sub29 local23 = (LinkedEntry_Sub29) this.aLinkedHashMap_Iterator_16.get((long) arg1);
		if (local23 == null) {
			local23 = new LinkedEntry_Sub29(MonotonicClock.getCurrentTimeInMilliseconds() + 500L);
	...
	public int method2832(@OriginalArg(0) boolean arg0) {
		...
		for (@Pc(22) LinkedEntry_Sub29 local22 = arg0 ? (LinkedEntry_Sub29) this.aLinkedHashMap_Iterator_16.head() : (LinkedEntry_Sub29) this.aLinkedHashMap_Iterator_16.nextEntry(); local22 != null; local22 = (LinkedEntry_Sub29) this.aLinkedHashMap_Iterator_16.nextEntry()) {
