...
public final class Class114 implements Interface12 {
	...
	private HashMap aLinkedHashMap_Iterator_16 = new HashMap(128);
	...
	public void method2828(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(26) int local26 = SecondaryNode_Sub1_Sub3.anIntArray17[local19 - local16];
	...
	public void method2829() {
		...
		this.aLinkedHashMap_Iterator_16 = new HashMap(128);
	}
	...
	public void method2830(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
		...
		@Pc(24) Node_Sub29 local24 = (Node_Sub29) this.aLinkedHashMap_Iterator_16.get((long) arg0);
		if (local24 == null) {
	...
	public void method2831(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
		...
		@Pc(23) Node_Sub29 local23 = (Node_Sub29) this.aLinkedHashMap_Iterator_16.get((long) arg1);
		if (local23 == null) {
	...
	public int method2825(@OriginalArg(1) int arg0) {
		...
		@Pc(30) int local30 = SecondaryNode_Sub1_Sub3.anIntArray17[local24 - local21];
	...
	public int method2832(@OriginalArg(0) boolean arg0) {
		...
		for (@Pc(22) Node_Sub29 local22 = arg0 ? (Node_Sub29) this.aLinkedHashMap_Iterator_16.head() : (Node_Sub29) this.aLinkedHashMap_Iterator_16.next(); local22 != null; local22 = (Node_Sub29) this.aLinkedHashMap_Iterator_16.next()) {
	...
	public void method2835(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		...
		@Pc(32) int local32 = SecondaryNode_Sub1_Sub3.anIntArray17[local25 - local22];
