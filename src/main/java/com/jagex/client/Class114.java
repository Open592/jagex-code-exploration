...
public final class Class114 implements Interface12 {
  ...
  private HashMap aHashMap_16 = new HashMap(128);
  ...
  public void method2828(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
    @Pc(10)
    Class126 local10 = Static26.aClass26_1.method647(arg1);
    @Pc(13)
    int local13 = local10.anInt3914;
    @Pc(16)
    int local16 = local10.anInt3919;
    @Pc(19)
    int local19 = local10.anInt3915;
    @Pc(26)
    int local26 = SecondaryNode_Sub1_Sub3.anIntArray17[local19 - local16];
  ...
  public void method2830(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
    ...
    @Pc(24)
    Node_Sub29 local24 = (Node_Sub29) this.aHashMap_16.get((long) arg0);
    if (local24 == null) {
      local24 = new Node_Sub29(4611686018427387905L);
      this.aHashMap_16.set((long) arg0, local24);
  ...
  public void method2831(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
    ...
    @Pc(23)
    Node_Sub29 local23 = (Node_Sub29) this.aHashMap_16.get((long) arg1);
    if (local23 == null) {
      local23 = new Node_Sub29(MonotonicClock.getCurrentTimeInMilliseconds() + 500L);
      this.aHashMap_16.set((long) arg1, local23);
    } else {
  ...
  public int method2825(@OriginalArg(1) int arg0) {
    @Pc(15)
    Class126 local15 = Static26.aClass26_1.method647(arg0);
    @Pc(18)
    int local18 = local15.anInt3914;
    @Pc(21)
    int local21 = local15.anInt3919;
    @Pc(24)
    int local24 = local15.anInt3915;
    @Pc(30)
    int local30 = SecondaryNode_Sub1_Sub3.anIntArray17[local24 - local21];
  ...
  public int method2832(@OriginalArg(0) boolean arg0) {
    @Pc(8)
    long local8 = MonotonicClock.getCurrentTimeInMilliseconds();
    for (@Pc(22)
        Node_Sub29 local22 =
            arg0 ? (Node_Sub29) this.aHashMap_16.head() : (Node_Sub29) this.aHashMap_16.next();
        local22 != null;
        local22 = (Node_Sub29) this.aHashMap_16.next()) {
      if ((local22.aLong153 & 0x3FFFFFFFFFFFFFFFL) < local8) {
        if ((local22.aLong153 & 0x4000000000000000L) != 0L) {
          @Pc(54)
          int local54 = (int) local22.hashKey;
  ...
  public void method2835(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
    @Pc(16)
    Class126 local16 = Static26.aClass26_1.method647(arg0);
    @Pc(19)
    int local19 = local16.anInt3914;
    @Pc(22)
    int local22 = local16.anInt3919;
    @Pc(25)
    int local25 = local16.anInt3915;
    @Pc(32)
    int local32 = SecondaryNode_Sub1_Sub3.anIntArray17[local25 - local22];
