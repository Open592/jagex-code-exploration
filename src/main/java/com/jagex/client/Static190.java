...
public final class Static190 {
  ...
  public static final LocalizedString A_LOCALIZED_STRING___76 =
      new LocalizedString("Walk here", "Hierhin gehen", "Atteindre", "Caminhar para cá");
  ...
  public static void method2978(@OriginalArg(0) Class16_Sub1 arg0) {
    for (@Pc(2) int local2 = arg0.aShort94; local2 <= arg0.aShort97; local2++) {
      for (@Pc(6) int local6 = arg0.aShort96; local6 <= arg0.aShort95; local6++) {
        @Pc(16)
        Class164 local16 = Static202.aClass164ArrayArrayArray5[arg0.aByte82][local2][local6];
        if (local16 != null) {
          @Pc(21)
          Class7 local21 = local16.aClass7_3;
          @Pc(23)
          Class7 local23 = null;
          while (local21 != null) {
          ...
          local16.aByte50 = 0;
          for (@Pc(56) Class7 local56 = local16.aClass7_3;
              local56 != null;
              local56 = local56.aClass7_1) {
