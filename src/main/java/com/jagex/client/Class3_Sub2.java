...
public final class Class3_Sub2 extends Class3 {
  ...
  public void method165() {
    ...
    for (@Pc(8)
        SecondaryNode_Sub1_Sub12 local8 = (SecondaryNode_Sub1_Sub12) this.aLinkedList_1.tail();
        local8 != null;
        local8 = (SecondaryNode_Sub1_Sub12) this.aLinkedList_1.previous()) {
  ...
  @OriginalMember(
      owner = "client!ao",
      name = "a",
      descriptor = "(Lclient!ya;J[Lclient!bu;[Lclient!pf;Z)V")
  public void method169(
      @OriginalArg(0) Class19 arg0,
      @OriginalArg(1) long arg1,
      @OriginalArg(2) Class29[] arg2,
      @OriginalArg(3) Class179[] arg3) {
    if (!this.aBoolean24) {
  ...
  public void method170() {
    ...
    for (@Pc(10) Class3_Sub6 local10 = (Class3_Sub6) this.aClass84_1.method2312();
        local10 != null;
        local10 = (Class3_Sub6) this.aClass84_1.method2309()) {
  ...
  public boolean method172(@OriginalArg(0) Class19 arg0, @OriginalArg(1) long arg1) {
    ...
    @Pc(27)
    int local27 = (int) (arg1 - this.aLong12);
    @Pc(36)
    Class3_Sub6 local36;
    if (this.aBoolean25) {
  ...
  private void method173(@OriginalArg(0) Class179[] arg0) {
    ...
    label68:
    for (@Pc(16)
        SecondaryNode_Sub1_Sub12 local16 = (SecondaryNode_Sub1_Sub12) this.aLinkedList_1.tail();
        local16 != null;
        local16 = (SecondaryNode_Sub1_Sub12) this.aLinkedList_1.previous()) {
      if (arg0 != null) {
        for (local21 = 0; local21 < arg0.length; local21++) {
          if (local16.aClass179_1 == arg0[local21]
              || local16.aClass179_1 == arg0[local21].aClass179_2) {
    ...
    for (local21 = 0; local21 < arg0.length && this.anInt216 != 8; local21++) {
      if (!Static16.aBooleanArray1[local21]) {
        @Pc(93)
        SecondaryNode_Sub1_Sub12 local93 = null;
  ...
  private void method175(@OriginalArg(0) Class19 arg0, @OriginalArg(1) Class29[] arg1) {
    ...
    int local21;
    label59:
    for (@Pc(16) Class3_Sub6 local16 = (Class3_Sub6) this.aClass84_1.method2312();
        local16 != null;
        local16 = (Class3_Sub6) this.aClass84_1.method2309()) {
      if (arg1 != null) {
        for (local21 = 0; local21 < arg1.length; local21++) {
          if (local16.aClass29_2 == arg1[local21]
              || local16.aClass29_2 == arg1[local21].aClass29_1) {
    ...
    for (local21 = 0; local21 < arg1.length && this.anInt213 != 8; local21++) {
      if (!Static16.aBooleanArray2[local21]) {
        @Pc(101)
        Class3_Sub6 local101 = new Class3_Sub6(arg0, arg1[local21], this, this.aLong11);
