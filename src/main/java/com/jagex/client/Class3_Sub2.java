...
public final class Class3_Sub2 extends Class3 {
	...
	public void method165() {
		...
		for (@Pc(8) LinkedHashEntry_Sub1_Sub12 local8 = (LinkedHashEntry_Sub1_Sub12) this.aClass183_1.method4140(); local8 != null; local8 = (LinkedHashEntry_Sub1_Sub12) this.aClass183_1.method4144()) {
	...
	private void method173(@OriginalArg(0) Class179[] arg0) {
		...
		@Pc(21) int local21;
		label68: for (@Pc(16) LinkedHashEntry_Sub1_Sub12 local16 = (LinkedHashEntry_Sub1_Sub12) this.aClass183_1.method4140(); local16 != null; local16 = (LinkedHashEntry_Sub1_Sub12) this.aClass183_1.method4144()) {
			if (arg0 != null) {
		...
		for (local21 = 0; local21 < arg0.length && this.anInt216 != 8; local21++) {
			if (!Static16.aBooleanArray1[local21]) {
				@Pc(93) LinkedHashEntry_Sub1_Sub12 local93 = null;
				if (arg0[local21].method4106().anInt121 == 1 && Static246.anInt4588 < 32) {
					local93 = new LinkedHashEntry_Sub1_Sub12(arg0[local21], this);
