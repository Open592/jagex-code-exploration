  ...
  public void method5542(
    ...
    for (@Pc(212) int local212 = local171; local212 < local210; local212++) {
      ...
      for (@Pc(304) int local304 = -local227; local304 < 0; local304++) {
        @Pc(311)
        byte local311 = this.aByteArray104[local19++];
        if (local311 == 0) {
          local41++;
        } else {
    ...
    if (super.aClass19_Sub1_11.method489()) {
      ...
      if (arg6 != 0) {
        ...
        if (arg6 == 1) {
              ...
              if ((arg5 & 0xFFFFFF) == 16777215) {
                ...
                for (local273 = -arg3; local273 < 0; local273++) {
                  ...
                  for (local343 = -arg2; local343 < 0; local343++) {
                    ...
                    if (local735 == 0) {
                      ...
                      local252[local64++] =
                          ((local361 & 0xFF00FF) * local262 + (local369 & 0xFF00FF) * local270
                                      & 0xFF00FF00)
                                  + ((local361 & 0xFF00) * local262 + (local369 & 0xFF00) * local270
                                      & 0xFF0000)
                              >> 8;
                    }
                    local14 += local44;
                ...
                for (local346 = -arg3; local346 < 0; local346++) {
                  ...
                  for (local369 = -arg2; local369 < 0; local369++) {
                    @Pc(852)
                    byte local852 = this.aByteArray104[(local14 >> 16) + local361];
                    if (local852 == 0) {
                      local64++;
                    } else {
                      ...
                      if (local335 == 255) {
                        ...
                        local252[local64++] =
                            ((local385 & 0xFF00FF) * local335 + (local900 & 0xFF00FF) * local343
                                        & 0xFF00FF00)
                                    + ((local385 & 0xFF00) * local335
                                            + (local900 & 0xFF00) * local343
                                        & 0xFF0000)
                                >> 8;
                      }
                    }
              ...
              for (local273 = -arg3; local273 < 0; local273++) {
                ...
                for (local343 = -arg2; local343 < 0; local343++) {
                  ...
                  if (local361 == 0 && local262 != 255) {
                    ...
                    local385 =
                        ((local361 & 0xFF00FF) * local262 + (local385 & 0xFF00FF) * local270
                                    & 0xFF00FF00)
                                + ((local361 & 0xFF00) * local262 + (local385 & 0xFF00) * local270
                                    & 0xFF0000)
                            >> 8;
                  }
          ...
          for (local335 = -arg3; local335 < 0; local335++) {
            ...
            for (local346 = -arg2; local346 < 0; local346++) {
              @Pc(1406)
              byte local1406 = this.aByteArray104[(local14 >> 16) + local343];
              if (local1406 == 0) {
                local64++;
              } else {
          ...
          for (local262 = -arg3; local262 < 0; local262++) {
            ...
            for (local273 = -arg2; local273 < 0; local273++) {
              ...
              @Pc(1583)
              int local1583 = local252[local64];
              local346 = local343 + local1583;
              local361 = (local343 & 0xFF00FF) + (local1583 & 0xFF00FF);
              @Pc(1605)
              int local1605 = (local361 & 0x1000100) + (local346 - local361 & 0x10000);
          ...
          for (local343 = -arg3; local343 < 0; local343++) {
            ...
            for (local361 = -arg2; local361 < 0; local361++) {
              ...
              if (local1196 == 0) {
                ...
                local273 = (local377 & 0xFF00) * local259 & 0xFF0000;
                @Pc(1731)
                int local1731 = ((local270 | local273) >>> 8) + local544;
                local385 = local252[local64];
                local872 = local1731 + local385;
                local880 = (local1731 & 0xFF00FF) + (local385 & 0xFF00FF);
                @Pc(1757)
                int local1757 = (local880 & 0x1000100) + (local872 - local880 & 0x10000);
        ...
        for (local262 = -arg3; local262 < 0; local262++) {
          ...
          for (local273 = -arg2; local273 < 0; local273++) {
            local252[local64++] =
                this.anIntArray542[this.aByteArray104[(local14 >> 16) + local270] & 0xFF];
            local14 += local44;
          }
          local16 += local50;
          local14 = local259;
    ...
    if (arg2 != 0) {
        ...
        for (local678 = -local32; local678 < 0; local678++) {
          for (local682 = -local35; local682 < 0; local682++) {
            ...
            if (local698 == 0 && local532 != 255) {
              ...
              local799 =
                  ((local698 & 0xFF00FF) * local532 + (local799 & 0xFF00FF) * local539 & 0xFF00FF00)
                          + ((local698 & 0xFF00) * local532 + (local799 & 0xFF00) * local539
                              & 0xFF0000)
                      >> 8;
            }
      ...
      for (local678 = -local32; local678 < 0; local678++) {
        for (local682 = -local35; local682 < 0; local682++) {
          ...
          if (local689 == 0) {
            ...
            local160[local27++] =
                ((local698 & 0xFF00FF) * local532 + (local702 & 0xFF00FF) * local539 & 0xFF00FF00)
                        + ((local698 & 0xFF00) * local532 + (local702 & 0xFF00) * local539
                            & 0xFF0000)
                    >> 8;
          }
        }
      ...
      for (local698 = -local32; local698 < 0; local698++) {
        for (local702 = -local35; local702 < 0; local702++) {
          @Pc(790)
          byte local790 = this.aByteArray104[local29++];
          if (local790 == 0) {
            local27++;
          } else {
            ...
            if (local682 == 255) {
              ...
              @Pc(838)
              int local838 = local160[local27];
              local160[local27++] =
                  ((local799 & 0xFF00FF) * local682 + (local838 & 0xFF00FF) * local776 & 0xFF00FF00)
                          + ((local799 & 0xFF00) * local682 + (local838 & 0xFF00) * local776
                              & 0xFF0000)
                      >> 8;
            }
          }
              ...
              if (arg0 == 1) {
                ...
                if (local227 != 0) {
                  ...
                  if ((Static359.anInt7160 & 0xFFFFFF) == 16777215) {
                    ...
                    local3[local51] =
                        ((local255 & 0xFF00FF) * local264 + (local272 & 0xFF00FF) * local268
                                    & 0xFF00FF00)
                                + ((local255 & 0xFF00) * local264 + (local272 & 0xFF00) * local268
                                    & 0xFF0000)
                            >> 8;
                    ...
                    local3[local51] =
                        ((local255 & 0xFF00FF) * Static359.anInt7161
                                        + (local344 & 0xFF00FF) * Static359.anInt7159
                                    & 0xFF00FF00)
                                + ((local255 & 0xFF00) * Static359.anInt7161
                                        + (local344 & 0xFF00) * Static359.anInt7159
                                    & 0xFF0000)
                            >> 8;
                  }
                }
