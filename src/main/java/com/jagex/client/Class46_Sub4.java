...
public final class Class46_Sub4 extends Class46 {
  ...
  @OriginalMember(
      owner = "client!th",
      name = "<init>",
      descriptor = "(Lclient!bc;Lclient!gt;[Lclient!bb;[I[I)V")
  public Class46_Sub4(
      @OriginalArg(0) Class19_Sub1 arg0,
      @OriginalArg(1) Class89 arg1,
      @OriginalArg(2) Class18[] arg2,
  ...
  protected void OA(
    ...
    @Pc(18)
    int local18 = this.anIntArray493[arg0];
    @Pc(23)
    int local23 = this.anIntArray494[arg0];
    @Pc(27)
    int local27 = this.aClass19_Sub1_10.anInt430;
    @Pc(33)
    int local33 = arg1 + arg2 * local27;
    @Pc(37)
    int local37 = local27 - local18;
    @Pc(39)
    int local39 = 0;
    @Pc(41)
    int local41 = 0;
    ...
    if ((arg3 & -16777216) == -16777216) {
      this.method5065(
          this.aByteArrayArray27[arg0],
          this.aClass19_Sub1_10.anIntArray26,
          arg3,
          local41,
          local33,
          local18,
  ...
  protected void method5051(
    ...
    arg2 += this.anIntArray492[arg0];
    @Pc(28)
    int local28 = this.anIntArray493[arg0];
    @Pc(33)
    int local33 = this.anIntArray494[arg0];
    @Pc(37)
    int local37 = this.aClass19_Sub1_10.anInt430;
    @Pc(43)
    int local43 = arg1 + arg2 * local37;
    @Pc(47)
    int local47 = local37 - local28;
    @Pc(49)
    int local49 = 0;
    @Pc(51)
    int local51 = 0;
  ...
  private void method5066(
      ...
      @OriginalArg(12) Class145 arg12,
      @OriginalArg(13) int arg13,
      @OriginalArg(14) int arg14) {
    @Pc(2)
    Class145_Sub2 local2 = (Class145_Sub2) arg12;
    @Pc(5)
    ...
    @Pc(50)
    int local50 = arg14 + local5.length < arg10 + arg6 ? arg14 + local5.length : arg10 + arg6;
    for (@Pc(52) int local52 = local10; local52 < local50; local52++) {
      @Pc(61)
      int local61 = arg13 + local5[local52 - arg14];
      @Pc(67)
      int local67 = local8[local52 - arg14];
      @Pc(69)
      int local69 = arg5;
      @Pc(76)
      int local76;
  ...
  private void method5067(
    ...
    int[] local8 = local2.anIntArray553;
    @Pc(14)
    int local14 = arg9 - this.aClass19_Sub1_10.lb;
    @Pc(16)
    int local16 = arg10;
    if (arg14 > arg10) {
      local16 = arg14;
    ...
    @Pc(56)
    int local56 = arg14 + local5.length < arg10 + arg6 ? arg14 + local5.length : arg10 + arg6;
    @Pc(60)
    int local60 = arg2 >>> 24;
    @Pc(64)
    int local64 = 255 - local60;
    for (@Pc(66) int local66 = local16; local66 < local56; local66++) {
      @Pc(75)
      int local75 = local5[local66 - arg14] + arg13;
      @Pc(81)
      int local81 = local8[local66 - arg14];
      @Pc(83)
      int local83 = arg5;
      @Pc(90)
      int local90;
      ...
      for (@Pc(158) int local158 = -local81; local158 < 0; local158++) {
        if (arg0[arg3++] == 0) {
          ...
          @Pc(182)
          int local182 =
              ((arg2 & 0xFF00FF) * local60 & 0xFF00FF00) + ((arg2 & 0xFF00) * local60 & 0xFF0000)
                  >> 8;
          @Pc(186)
          int local186 = arg1[arg4];
          arg1[arg4++] =
              (((local186 & 0xFF00FF) * local64 & 0xFF00FF00)
                          + ((local186 & 0xFF00) * local64 & 0xFF0000)
                      >> 8)
                  + local182;
        }
      }
    ...
    for (@Pc(10) int local10 = -arg6; local10 < 0; local10++) {
      for (@Pc(14) int local14 = -arg5; local14 < 0; local14++) {
        if (arg0[arg3++] == 0) {
          ...
          @Pc(38)
          int local38 =
              ((arg2 & 0xFF00FF) * local3 & 0xFF00FF00) + ((arg2 & 0xFF00) * local3 & 0xFF0000)
                  >> 8;
          @Pc(42)
          int local42 = arg1[arg4];
          arg1[arg4++] =
              (((local42 & 0xFF00FF) * local7 & 0xFF00FF00)
                          + ((local42 & 0xFF00) * local7 & 0xFF0000)
                      >> 8)
                  + local38;
        }
      }
