...
public final class Static124 {
  ...
  public static void method2241(@OriginalArg(1) boolean arg0) {
    ...
    for (@Pc(27) int local27 = 0; local27 < Static88.anInt1816; local27++) {
      ...
      if (client.gameLogicStepCount != Static143.aClass16_Sub1_Sub5_Sub2Array1[local33].anInt6015) {
        if (Static143.aClass16_Sub1_Sub5_Sub2Array1[local33].aNpc_Type_1.method5578()) {
    ...
    if (Static146.aClass4_Sub12_Sub1_3.pos != Static454.anInt4075) {
      throw new RuntimeException(
          "gnp1 pos:" + Static146.aClass4_Sub12_Sub1_3.pos + " psize:" + Static454.anInt4075);
    }
  ...
  public static boolean method2242(
    ...
    @Pc(10)
    int local10 = arg1 << Static231.anInt4434;
    @Pc(14)
    int local14 = arg2 << Static231.anInt4434;
    @Pc(23)
    int local23 = Static417.aClass65Array4[arg0].l(arg1, arg2) - 1;
    @Pc(31)
    int local31 = local23 - (0x78 << Static231.anInt4434 - 7);
    @Pc(39)
    int local39 = local23 - (0xE6 << Static231.anInt4434 - 7);
    @Pc(47)
    int local47 = local23 - (0xEE << Static231.anInt4434 - 7);
    if (arg3 == 1) {
      ...
      if (local14 < Static209.anInt3921) {
        ...
        if (!Static299.method4088(
            local10 + Static333.anInt5747, local23, local14 + Static4.anInt5935)) {
          return false;
        }
        if (!Static299.method4088(
            local10 + Static4.anInt5935, local23, local14 + Static4.anInt5935)) {
          return false;
        }
      }
      if (arg0 > 0) {
        ...
        if (!Static299.method4088(
            local10 + Static333.anInt5747, local31, local14 + Static4.anInt5935)) {
          return false;
        }
        if (!Static299.method4088(
            local10 + Static4.anInt5935, local31, local14 + Static4.anInt5935)) {
          return false;
        }
      }
      if (!Static299.method4088(local10, local39, local14 + Static4.anInt5935)) {
        return false;
      } else if (Static299.method4088(
          local10 + Static333.anInt5747, local39, local14 + Static4.anInt5935)) {
        return Static299.method4088(
            local10 + Static4.anInt5935, local39, local14 + Static4.anInt5935);
      } else {
        return false;
      }
    } else if (arg3 == 4) {
      if (local10 < Static153.anInt3073) {
        ...
        if (!Static299.method4088(
            local10 + Static4.anInt5935, local23, local14 + Static333.anInt5747)) {
          return false;
        }
        if (!Static299.method4088(
            local10 + Static4.anInt5935, local23, local14 + Static4.anInt5935)) {
      ...
      if (arg0 > 0) {
        ...
        if (!Static299.method4088(
            local10 + Static4.anInt5935, local31, local14 + Static333.anInt5747)) {
          return false;
        }
        if (!Static299.method4088(
            local10 + Static4.anInt5935, local31, local14 + Static4.anInt5935)) {
      ...
      if (!Static299.method4088(local10 + Static4.anInt5935, local39, local14)) {
        return false;
          ...
          local10 + Static4.anInt5935, local39, local14 + Static333.anInt5747)) {
        return Static299.method4088(
            local10 + Static4.anInt5935, local39, local14 + Static4.anInt5935);
      } else {
        return false;
      ...
      if (!Static299.method4088(local10, local39, local14)) {
        ...
        local10 + Static333.anInt5747, local47, local14 + Static333.anInt5747)) {
      return false;
    } else if (arg3 == 16) {
      return Static299.method4088(local10, local39, local14 + Static4.anInt5935);
    } else if (arg3 == 32) {
