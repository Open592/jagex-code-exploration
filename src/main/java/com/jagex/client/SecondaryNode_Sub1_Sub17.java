...
public final class SecondaryNode_Sub1_Sub17 extends SecondaryNode {
  ...
  public SecondaryNode_Sub1_Sub17(@OriginalArg(0) int arg0) {
    this.anInt5488 = arg0;
  }
  ...
  public boolean method4211() {
    ...
    if (this.aByteArrayArray24 == null) {
      ...
      @Pc(27)
      int[] local27 = Static10.aJs5_1.method2124(this.anInt5488);
      this.aByteArrayArray24 = new byte[local27.length][];
      for (local34 = 0; local34 < local27.length; local34++) {
        this.aByteArrayArray24[local34] =
            Static10.aJs5_1.method2104(local27[local34], this.anInt5488);
      }
    }
    @Pc(55)
    boolean local55 = true;
    @Pc(78)
    int local78;
    for (local34 = 0; local34 < this.aByteArrayArray24.length; local34++) {
      @Pc(64)
      byte[] local64 = this.aByteArrayArray24[local34];
    ...
    @Pc(103)
    LinkedList local103 = new LinkedList();
    local78 = Static10.aJs5_1.method2108(this.anInt5488);
    this.aClass88Array1 = new Class88[local78];
    @Pc(119)
    int[] local119 = Static10.aJs5_1.method2124(this.anInt5488);
    for (@Pc(121) int local121 = 0; local121 < local119.length; local121++) {
      @Pc(128)
      byte[] local128 = this.aByteArrayArray24[local121];
      @Pc(142)
      int local142 = local128[1] & 0xFF | (local128[0] & 0xFF) << 8;
      @Pc(144)
      Node_Sub32 local144 = null;
      for (@Pc(149) Node_Sub32 local149 = (Node_Sub32) local103.tail();
          local149 != null;
          local149 = (Node_Sub32) local103.previous()) {
