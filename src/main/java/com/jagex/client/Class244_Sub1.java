...
public final class Class244_Sub1 extends Class244 implements KeyListener, FocusListener {
  ...
  private void method5492(
      @OriginalArg(1) int arg0, @OriginalArg(2) char arg1, @OriginalArg(3) int arg2) {
    @Pc(15)
    Class30_Sub1 local15 = new Class30_Sub1();
  ...
  public synchronized void method5487() {
    for (@Pc(8) Class30_Sub1 local8 = this.aClass30_Sub1_2;
        local8 != null;
        local8 = local8.aClass30_Sub1_1) {
  ...
  public Class30 method5483() {
    @Pc(8)
    Class30_Sub1 local8;
    for (local8 = this.aClass30_Sub1_4;
        local8 != null && local8.anInt782 == -1;
        local8 = local8.aClass30_Sub1_1) {}
    if (local8 == null) {
  ...
  private void method5495(@OriginalArg(1) Component arg0) {
    ...
    @Pc(16)
    Method local16 = SignLink.setFocusTraversalKeysEnabled;
    if (local16 != null) {
      try {
