...
public final class Class9_Sub6 extends Class9 {
  ...
  public Class9_Sub6(@OriginalArg(0) Class19_Sub2 arg0) {
    ...
    if (arg0.aBoolean199) {
      ...
      @Pc(26)
      int local26 = this.aBoolean493 ? 48 : 127;
      @Pc(30)
      byte[][] local30 = new byte[6][4096];
      @Pc(34)
      byte[][] local34 = new byte[6][4096];
      @Pc(38)
      byte[][] local38 = new byte[6][4096];
      @Pc(40)
      int local40 = 0;
      for (@Pc(42) int local42 = 0; local42 < 64; local42++) {
        for (@Pc(46) int local46 = 0; local46 < 64; local46++) {
          @Pc(57)
          float local57 = (float) local46 * 2.0F / 64.0F - 1.0F;
          @Pc(66)
          float local66 = (float) local42 * 2.0F / 64.0F - 1.0F;
          @Pc(81)
          float local81 =
              (float) (1.0D / Math.sqrt((double) (local66 * local66 + local57 * local57 + 1.0F)));
          @Pc(85)
          float local85 = local57 * local81;
          @Pc(89)
          float local89 = local66 * local81;
      ...
      this.aClass6_Sub4Array1[0] =
          new Class6_Sub4(super.aClass19_Sub2_41, 6406, 64, false, local34, 6406);
      this.aClass6_Sub4Array1[1] =
          new Class6_Sub4(super.aClass19_Sub2_41, 6406, 64, false, local38, 6406);
      this.aClass6_Sub4Array1[2] =
          new Class6_Sub4(super.aClass19_Sub2_41, 6406, 64, false, local30, 6406);
      this.method4233();
    }
  }
