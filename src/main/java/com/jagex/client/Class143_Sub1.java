...
public final class Class143_Sub1 extends Class143 {
	...
	public void method3520() {
		if (this.aClass183_31 != null) {
			...
			@Pc(28) LinkedEntry local28;
			@Pc(34) int local34;
			@Pc(127) LinkedEntry local127;
			if (this.aBoolean412) {
				local21 = true;
	...
	public int method3521() {
		if (this.aClass209_2 == null) {
			...
			@Pc(25) LinkedEntry local25 = this.aClass183_31.method4140();
	...
	public void method3522() {
		...
		for (@Pc(23) LinkedEntry local23 = this.aClass183_30.method4140(); local23 != null; local23 = this.aClass183_30.method4144()) {
	...
	public void method3512(@OriginalArg(0) int arg0) {
		...
		for (@Pc(14) LinkedEntry local14 = this.aClass183_30.method4140(); local14 != null; local14 = this.aClass183_30.method4144()) {
			if (local14.hashKey == (long) arg0) {
				return;
			}
		}
		@Pc(43) LinkedEntry local43 = new LinkedEntry();
