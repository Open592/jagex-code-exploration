...
public final class Static308 {
  ...
  public static void method4154(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
    if (Static148.aFloat178 < Static148.aFloat179) {
      Static148.aFloat178 =
          (float) ((double) Static148.aFloat178 + (double) Static148.aFloat178 / 30.0D);
    ...
    if (Static127.anInt2674 != -1 && Static71.anInt6920 != -1) {
      @Pc(85)
      int local85 = Static127.anInt2674 - Static314.anInt5471;
      if (local85 < 2 || local85 > 2) {
        local85 /= 8;
      }
      @Pc(104)
      int local104 = Static71.anInt6920 - Static46.anInt5156;
    ...
    for (@Pc(177) Node_Sub14 local177 = (Node_Sub14) Static378.aLinkedList_29.tail();
        local177 != null;
        local177 = (Node_Sub14) Static378.aLinkedList_29.previous()) {
      @Pc(186)
      Class157 local186 = Static148.aClass182_3.method4124(local177.aClass4_Sub3_1.anInt234);
      if (local177.method1370(arg1, arg0)) {
        if (local186.aStringArray19 != null) {
          if (local186.aStringArray19[4] != null) {
            Static380.method5017(
                1006,
                false,
                (long) local177.aClass4_Sub3_1.anInt234,
                local186.anInt4919,
                local186.aString48,
                true,
                local186.aStringArray19[4],
                0,
                -1,
                -1);
          }
        ...
        if (!local177.aClass4_Sub3_1.aBoolean27) {
          ...
          Static271.method3899(
              Static312.aClass186_13, local177.aClass4_Sub3_1.anInt234, local186.anInt4919);
        }
        if (local177.aClass4_Sub3_1.aBoolean27) {
          Static271.method3899(
              Static92.aClass186_7, local177.aClass4_Sub3_1.anInt234, local186.anInt4919);
        }
      } else if (local177.aClass4_Sub3_1.aBoolean27) {
        local177.aClass4_Sub3_1.aBoolean27 = false;
        Static271.method3899(
            Static219.aClass186_16, local177.aClass4_Sub3_1.anInt234, local186.anInt4919);
      }
    }
  }

  @OriginalMember(owner = "client!pm", name = "a", descriptor = "(ILclient!kf;ZLclient!kf;IZB)I")
  public static int method4155(
      @OriginalArg(0) int arg0,
      @OriginalArg(1) Class78_Sub1 arg1,
      @OriginalArg(2) boolean arg2,
      @OriginalArg(3) Class78_Sub1 arg3,
      @OriginalArg(4) int arg4,
      @OriginalArg(5) boolean arg5) {
    @Pc(18)
    int local18 = Static283.method3963(arg5, arg0, arg1, arg3);
    if (local18 != 0) {
      ...
      @Pc(42)
      int local42 = Static283.method3963(arg2, arg4, arg1, arg3);
