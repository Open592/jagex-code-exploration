...
public final class Static256 {
  ...
  @OriginalMember(
      owner = "client!mu",
      name = "a",
      descriptor = "([Lclient!wl;Lclient!fd;I)Lclient!ru;")
  public static Class210 method3694(
      @OriginalArg(0) Class267[] arg0, @OriginalArg(1) Class19_Sub2 arg1) {
    ...
    @Pc(31)
    long local31 = OpenGL.glCreateProgramObjectARB();
    ...
    if (Static156.anIntArray198[0] == 0) {
      ...
      if (Static156.anIntArray198[1] > 1) {
        @Pc(89)
        byte[] local89 = new byte[Static156.anIntArray198[1]];
        OpenGL.glGetInfoLogARB(
            local31, Static156.anIntArray198[1], Static156.anIntArray198, 0, local89, 0);
