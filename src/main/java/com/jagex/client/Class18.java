...
public final class Class18 {
  ...
  public void method314(@OriginalArg(0) int arg0) {
    ...
    if (this.anIntArray25.length < 255) {
      ...
      if (local1 == -1) {
        ...
        @Pc(38)
        int[] local38 = new int[this.anIntArray25.length + 1];
      ...
      local69 = arg0 >> 8 & 0xFF;
      @Pc(73)
      int local73 = arg0 & 0xFF;
      for (@Pc(75) int local75 = 0; local75 < this.anIntArray25.length; local75++) {
        @Pc(81)
        int local81 = this.anIntArray25[local75];
        @Pc(87)
        int local87 = local81 >> 16 & 0xFF;
        @Pc(93)
        int local93 = local81 >> 8 & 0xFF;
        @Pc(97)
        int local97 = local81 & 0xFF;
        @Pc(101)
        int local101 = local63 - local87;
        if (local101 < 0) {
          local101 = -local101;
        }
        @Pc(110)
        int local110 = local69 - local93;
        if (local110 < 0) {
          local110 = -local110;
        }
        @Pc(119)
        int local119 = local73 - local97;
        if (local119 < 0) {
          local119 = -local119;
        }
        @Pc(130)
        int local130 = local101 + local110 + local119;
        if (local130 < local8) {
          local8 = local130;
          local1 = local75;
        }
    ...
    for (local8 = this.anInt366 - 1; local8 > 0; local8--) {
      ...
      for (local69 = this.anInt367 - 1; local69 > 0; local69--) {
        if (this.anIntArray25[this.aByteArray4[local69 + local63] & 0xFF] == 0
            && this.anIntArray25[this.aByteArray4[local69 + local63 - this.anInt367 - 1] & 0xFF]
                != 0) {
  ...
  public void method317(@OriginalArg(0) int arg0) {
    ...
    local8 = 0;
    @Pc(152)
    byte[] local152 = new byte[this.anInt367 * this.anInt366];
        ...
        if (this.anIntArray25[local75] == 0) {
          if (local73 > 0 && this.anIntArray25[this.aByteArray4[local8 - 1] & 0xFF] != 0) {
            local75 = local1;
              ...
              && this.anIntArray25[this.aByteArray4[local8 - this.anInt367] & 0xFF] != 0) {
            local75 = local1;
          } else if (local73 < this.anInt367 - 1
              && this.anIntArray25[this.aByteArray4[local8 + 1] & 0xFF] != 0) {
            local75 = local1;
          } else if (local69 < this.anInt366 - 1
              && this.anIntArray25[this.aByteArray4[local8 + this.anInt367] & 0xFF] != 0) {
            local75 = local1;
          }
        }
  ...
  public int[] method319() {
    @Pc(2)
    int local2 = this.method324();
    @Pc(8)
    int[] local8 = new int[local2 * this.method325()];
    @Pc(13)
    int local13;
    @Pc(19)
    int local19;
    ...
    if (this.aByteArray5 == null) {
      for (local13 = 0; local13 < this.anInt366; local13++) {
        ...
        for (local31 = 0; local31 < this.anInt367; local31++) {
          @Pc(96)
          int local96 = this.anIntArray25[this.aByteArray4[local19++] & 0xFF];
          if (local96 == 0) {
            local8[local29++] = 0;
          } else {
      ...
      for (local13 = 0; local13 < this.anInt366; local13++) {
        ...
        for (local31 = 0; local31 < this.anInt367; local31++) {
          local8[local29++] =
              this.aByteArray5[local19] << 24 | this.anIntArray25[this.aByteArray4[local19] & 0xFF];
          local19++;
        }
      }
    }
  ...
  public void method320() {
    @Pc(6)
    byte[] local6 = new byte[this.anInt367 * this.anInt366];
    @Pc(8)
    int local8 = 0;
    @Pc(13)
    int local13;
    ...
    if (this.aByteArray5 == null) {
      ...
      @Pc(52)
      byte[] local52 = new byte[this.anInt367 * this.anInt366];
  ...
  public void method322() {
    ...
    int local2 = this.method324();
    @Pc(5)
    int local5 = this.method325();
    if (this.anInt367 == local2 && this.anInt366 == local5) {
      return;
    }
    @Pc(19)
    byte[] local19 = new byte[local2 * local5];
    @Pc(29)
    int local29;
    @Pc(35)
    int local35;
    ...
    if (this.aByteArray5 == null) {
      ...
      @Pc(27)
      byte[] local27 = new byte[local2 * local5];
  ...
  public void method326(@OriginalArg(0) int arg0) {
    ...
    @Pc(77)
    int local77 = this.anInt367 + local16 + local25;
    @Pc(84)
    int local84 = this.anInt366 + local44 + local53;
    @Pc(89)
    byte[] local89 = new byte[local77 * local84];
    @Pc(100)
    int local100;
    @Pc(108)
    int local108;
    ...
    if (this.aByteArray5 == null) {
      ...
      @Pc(136)
      byte[] local136 = new byte[local77 * local84];
