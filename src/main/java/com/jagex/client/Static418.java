...
public final class Static418 {
  ...
  public static final float[] aFloatArray31 =
      new float[] {
        1.0649863E-7F,
        1.1341951E-7F,
        1.2079015E-7F,
  ...
  public static final int[] anIntArray535 = new int[] {256, 128, 86, 64};

  @OriginalMember(owner = "client!vc", name = "a", descriptor = "([II)I")
  public static int method5365(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1) {
    @Pc(3)
    int local3 = arg0[arg1];
    @Pc(5)
    int local5 = -1;
    @Pc(7)
  ...
  public static int method5366(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1) {
    @Pc(3)
    int local3 = arg0[arg1];
    @Pc(5)
    int local5 = -1;
    @Pc(7)
    int local7 = Integer.MIN_VALUE;
    for (@Pc(9) int local9 = 0; local9 < arg1; local9++) {
      @Pc(14)
      int local14 = arg0[local9];
      if (local14 < local3 && local14 > local7) {
