...
public final class LinkedHashEntry_Sub1_Sub18 extends LinkedHashEntry_Sub1 {
	...
	private void method4667(@OriginalArg(0) Packet arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(23) int local23;
		if (this.aLinkedHashMap_Iterator_35 == null) {
			local23 = Static370.method4949(local14);
			this.aLinkedHashMap_Iterator_35 = new LinkedHashMapIterator(local23);
		}
		for (local23 = 0; local23 < local14; local23++) {
			@Pc(42) boolean local42 = arg0.g1() == 1;
			@Pc(46) int local46 = arg0.g3();
			@Pc(55) LinkedHashEntry local55;
			if (local42) {
				local55 = new LinkedHashEntry_Sub7(arg0.gStringCP1252ToUTF8());
			} else {
				local55 = new LinkedHashEntry_Sub37(arg0.g4());
			}
			this.aLinkedHashMap_Iterator_35.set((long) local46, local55);
		}
	}
	...
	public int method4670(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		if (this.aLinkedHashMap_Iterator_35 == null) {
			...
			@Pc(23) LinkedHashEntry_Sub37 local23 = (LinkedHashEntry_Sub37) this.aLinkedHashMap_Iterator_35.get((long) arg1);
	...
	public String method4671(@OriginalArg(1) String arg0, @OriginalArg(2) int arg1) {
		if (this.aLinkedHashMap_Iterator_35 == null) {
			...
			@Pc(21) LinkedHashEntry_Sub7 local21 = (LinkedHashEntry_Sub7) this.aLinkedHashMap_Iterator_35.get((long) arg1);
