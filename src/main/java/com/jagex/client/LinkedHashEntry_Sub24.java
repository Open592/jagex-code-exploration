...
public final class LinkedHashEntry_Sub24 extends LinkedHashEntry {
	...
	private final LinkedHashEntry_Sub21 aClass4_Sub21_1;
	...
	private LinkedHashEntry_Sub12_Sub2 aClass4_Sub12_Sub2_2;

	@OriginalMember(owner = "client!iu", name = "E", descriptor = "Lclient!ib;")
	private LinkedHashMapIterator aLinkedHashMap_Iterator_17;
	...
	public LinkedHashEntry_Sub24(@OriginalArg(0) Class19_Sub2 arg0, @OriginalArg(1) Class65_Sub2 arg1, @OriginalArg(2) LinkedHashEntry_Sub21 arg2, @OriginalArg(3) int[] arg3) {
		...
		if (local123 > 0) {
			...
			this.aClass4_Sub12_Sub2_2 = new LinkedHashEntry_Sub12_Sub2(local123 * 16);
			this.aLinkedHashMap_Iterator_17 = new LinkedHashMapIterator(Static370.method4949(local123));
			local178 = 0;
			local141 = 0;
	...
	private void method2839(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		...
		if ((arg0 & 0x7F) == 0 || (arg1 & 0x7F) == 0) {
			...
			@Pc(66) LinkedHashEntry local66 = this.aLinkedHashMap_Iterator_17.get(local7);
			if (local66 != null) {
				this.method2840(((LinkedHashEntry_Sub31) local66).aShort62);
				return;
			}
		}
		@Pc(84) short local84 = (short) this.anInt3410++;
		if (local7 != -1L) {
			this.aLinkedHashMap_Iterator_17.set(local7, new LinkedHashEntry_Sub31(local84));
		}
