...
public final class Class75 {
	...
	public Class75(@OriginalArg(0) GameDetails arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class76 arg2) {
		this.aClass76_28 = arg2;
		this.aClass76_28.method2108(5);
	}

	@OriginalMember(owner = "client!fp", name = "a", descriptor = "(II)Lclient!an;")
	public LinkedHashEntry_Sub1_Sub2 method2079(@OriginalArg(1) int arg0) {
		@Pc(6) Class68 local6 = this.aClass68_11;
		@Pc(16) LinkedHashEntry_Sub1_Sub2 local16;
		synchronized (this.aClass68_11) {
			local16 = (LinkedHashEntry_Sub1_Sub2) this.aClass68_11.method1787((long) arg0);
		}
		if (local16 != null) {
			return local16;
		}
		@Pc(33) byte[] local33 = this.aClass76_28.method2104(arg0, 5);
		local16 = new LinkedHashEntry_Sub1_Sub2();
		if (local33 != null) {
