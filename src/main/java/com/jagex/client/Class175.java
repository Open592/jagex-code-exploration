...
public final class Class175 {
  ...
  private final Packet aPacket_6 = new Packet(null);
  ...
  private int method4046(@OriginalArg(0) int arg0) {
    ...
    @Pc(42)
    int local42 = this.aPacket_6.gVarInt();
    if (local13 == 247 && local42 > 0) {
      @Pc(57)
      int local57 = this.aPacket_6.data[this.aPacket_6.pos] & 0xFF;
      if (local57 >= 241 && local57 <= 243
          || local57 == 246
          || local57 == 248
          || local57 >= 250 && local57 <= 252
          || local57 == 254) {
        this.aPacket_6.pos++;
  ...
  public void method4050(@OriginalArg(0) int arg0) {
    @Pc(4)
    int local4 = this.aPacket_6.gVarInt();
  ...
  private int method4051(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
    ...
    if (arg1 != 255) {
      @Pc(78)
      byte local78 = Static295.aByteArray66[arg1 - 128];
      local12 = arg1;
      if (local78 >= 1) {
        local12 = arg1 | this.aPacket_6.g1() << 8;
      }
      if (local78 >= 2) {
        local12 |= this.aPacket_6.g1() << 16;
      }
      return local12;
    }
    @Pc(7)
    int local7 = this.aPacket_6.g1();
    ...
    if (local7 == 47) {
      ...
      @Pc(32)
      int local32 = this.aPacket_6.g3();
      local12 -= 3;
      @Pc(38)
      int local38 = this.anIntArray347[arg0];
  ...
  public boolean method4052() {
    @Pc(3)
    int local3 = this.anIntArray345.length;
  ...
  public void method4053(@OriginalArg(0) long arg0) {
    this.aLong178 = arg0;
    @Pc(6)
    int local6 = this.anIntArray345.length;
    for (@Pc(8) int local8 = 0; local8 < local6; local8++) {
      this.anIntArray347[local8] = 0;
      this.anIntArray348[local8] = 0;
      this.aPacket_6.pos = this.anIntArray346[local8];
      this.method4050(local8);
      this.anIntArray345[local8] = this.aPacket_6.pos;
    }
  }
  ...
  public void method4054(@OriginalArg(0) byte[] arg0) {
    ...
    while (local27 < local12) {
      ...
      @Pc(38)
      int local38 = this.aPacket_6.g4();
      if (local33 == 1297379947) {
        this.anIntArray346[local27] = this.aPacket_6.pos;
        local27++;
      }
      this.aPacket_6.pos += local38;
    }
    this.aLong178 = 0L;
