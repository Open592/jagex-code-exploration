...
public final class LinkedHashEntry_Sub23 extends LinkedHashEntry {
	...
	public Class110 method2719(@OriginalArg(1) Class19 arg0, @OriginalArg(2) int arg1) {
		...
		if (local8 == 0) {
			...
			@Pc(32) Class16_Sub1 local32 = Static36.method648(this.anInt3196, this.anInt3189, this.anInt3193, Interface6.class);
