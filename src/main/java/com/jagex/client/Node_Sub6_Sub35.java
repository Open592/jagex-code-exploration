...
public final class Node_Sub6_Sub35 extends Node_Sub6 {
  ...
  public int[][] method5514(@OriginalArg(1) int arg0) {
    ...
    if (super.aClass153_41.aBoolean437) {
      ...
      @Pc(30)
      int[] local30 = local26[0];
      @Pc(34)
      int[] local34 = local26[1];
      @Pc(38)
      int[] local38 = local26[2];
      @Pc(42)
      int[] local42 = local11[0];
      @Pc(46)
      int[] local46 = local11[1];
      @Pc(50)
      int[] local50 = local11[2];
      for (@Pc(52) int local52 = 0; local52 < Static80.anInt1616; local52++) {
        @Pc(58)
        int local58 = local30[local52];
        @Pc(65)
        int local65 = local58 - this.anIntArray506[0];
        if (local65 < 0) {
          local65 = -local65;
        }
