...
public final class Node_Sub6_Sub15 extends Node_Sub6 {

  @OriginalMember(owner = "client!jm", name = "<init>", descriptor = "()V")
  public Node_Sub6_Sub15() {
    super(0, true);
  }
  ...
  private int method2979(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
    @Pc(9)
    int local9 = arg0 * 57 + arg1;
    @Pc(20)
    int local20 = local9 << 1 ^ local9;
    return 4096
        - (Integer.MAX_VALUE & local20 * (local20 * 15731 * local20 + 789221) + 1376312589)
            / 262144;
  }
}
