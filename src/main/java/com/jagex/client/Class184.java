...
public final class Class184 {
  ...
  public int[] method4152(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
    ...
    @Pc(16)
    double local16 = (double) arg0 / ((double) arg1 + 0.0D);
    ...
    if (this.aClass61_7 != null) {
      ...
      local24 =
          (int)
              ((double) (this.aClass61_7.anInt1832 - this.aClass61_7.anInt1831)
                  * 32.768D
                  / local16);
    ...
    if (this.aClass61_1 != null) {
      ...
      local63 =
          (int)
              ((double) (this.aClass61_1.anInt1832 - this.aClass61_1.anInt1831)
                  * 32.768D
                  / local16);
    ...
    for (@Pc(102) int local102 = 0; local102 < 5; local102++) {
      if (this.anIntArray363[local102] != 0) {
        ...
        Static307.anIntArray371[local102] =
            (int)
                ((double) (this.aClass61_8.anInt1832 - this.aClass61_8.anInt1831)
                    * 32.768D
                    * Math.pow(1.0057929410678534D, (double) this.anIntArray361[local102])
                    / local16);
        Static307.anIntArray367[local102] =
            (int) ((double) this.aClass61_8.anInt1831 * 32.768D / local16);
      }
    }
    @Pc(182)
    int local182;
    ...
    for (@Pc(176) int local176 = 0; local176 < arg0; local176++) {
      ...
      if (this.aClass61_1 != null) {
        ...
        local187 =
            local187
                    * ((this.method4153(local67, local200, this.aClass61_1.anInt1830) >> 1) + 32768)
                >> 15;
      ...
      for (local195 = 0; local195 < 5; local195++) {
        if (this.anIntArray363[local195] != 0) {
          ...
          if (local200 < arg0) {
            Static307.anIntArray366[local200] +=
                this.method4153(
                    Static307.anIntArray369[local195],
                    local187 * Static307.anIntArray368[local195] >> 15,
                    this.aClass61_8.anInt1830);
            Static307.anIntArray369[local195] +=
                (local182 * Static307.anIntArray371[local195] >> 16)
                    + Static307.anIntArray367[local195];
          }
        }
      }
    }
    ...
    if (this.aClass61_9 != null) {
      ...
      local182 = 0;
      @Pc(339)
      boolean local339 = true;
      for (local200 = 0; local200 < arg0; local200++) {
        local347 = this.aClass61_9.method1604(arg0);
        local352 = this.aClass61_3.method1604(arg0);
        if (local339) {
          local187 =
              this.aClass61_9.anInt1831
                  + ((this.aClass61_9.anInt1832 - this.aClass61_9.anInt1831) * local347 >> 8);
        } else {
          local187 =
              this.aClass61_9.anInt1831
                  + ((this.aClass61_9.anInt1832 - this.aClass61_9.anInt1831) * local352 >> 8);
        }
        local182 += 256;
    ...
    if (this.anInt5407 > 0 && this.anInt5409 > 0) {
      ...
      for (local187 = local182; local187 < arg0; local187++) {
        Static307.anIntArray366[local187] +=
            Static307.anIntArray366[local187 - local182] * this.anInt5409 / 100;
      }
    }
    if (this.aClass20_1.anIntArray28[0] > 0 || this.aClass20_1.anIntArray28[1] > 0) {
      ...
      if (arg0 >= local187 + local195) {
        ...
        while (local200 < local347) {
          local352 =
              (int)
                  ((long) Static307.anIntArray366[local200 + local187] * (long) Static25.anInt432
                      >> 16);
          for (local519 = 0; local519 < local187; local519++) {
            local352 +=
                (int)
                    ((long) Static307.anIntArray366[local200 + local187 - local519 - 1]
                            * (long) Static25.anIntArrayArray3[0][local519]
                        >> 16);
          }
          for (local549 = 0; local549 < local200; local549++) {
            local352 -=
                (int)
                    ((long) Static307.anIntArray366[local200 - local549 - 1]
                            * (long) Static25.anIntArrayArray3[1][local549]
                        >> 16);
          }
