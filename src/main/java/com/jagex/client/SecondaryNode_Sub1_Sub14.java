...
public final class SecondaryNode_Sub1_Sub14 extends SecondaryNode {
  ...
  private final Node_Sub6 aClass4_Sub6_1;

  @OriginalMember(owner = "client!kv", name = "L", descriptor = "Lclient!oc;")
  private final Node_Sub6 aClass4_Sub6_2;

  @OriginalMember(owner = "client!kv", name = "Q", descriptor = "Lclient!oc;")
  private final Node_Sub6 aClass4_Sub6_3;

  @OriginalMember(owner = "client!kv", name = "G", descriptor = "[Lclient!oc;")
  private final Node_Sub6[] aClass4_Sub6Array23;

  @OriginalMember(owner = "client!kv", name = "<init>", descriptor = "()V")
  private SecondaryNode_Sub1_Sub14() {
    this.anIntArray264 = new int[0];
    this.anIntArray265 = new int[0];
    this.aClass4_Sub6_1 = new Node_Sub6_Sub21(0);
    this.aClass4_Sub6_1.anInt7106 = 1;
    this.aClass4_Sub6_2 = new Node_Sub6_Sub21();
    this.aClass4_Sub6_2.anInt7106 = 1;
    this.aClass4_Sub6_3 = new Node_Sub6_Sub21();
    this.aClass4_Sub6_3.anInt7106 = 1;
    this.aClass4_Sub6Array23 =
        new Node_Sub6[] {this.aClass4_Sub6_2, this.aClass4_Sub6_3, this.aClass4_Sub6_1};
  }

  @OriginalMember(owner = "client!kv", name = "<init>", descriptor = "(Lclient!iv;)V")
  public SecondaryNode_Sub1_Sub14(@OriginalArg(0) Packet arg0) {
    @Pc(7)
    int local7 = arg0.g1();
    @Pc(9)
    int local9 = 0;
    ...
    int local11 = 0;
    @Pc(14)
    int[][] local14 = new int[local7][];
    this.aClass4_Sub6Array23 = new Node_Sub6[local7];
    @Pc(50)
    int local50;
    for (@Pc(20) int local20 = 0; local20 < local7; local20++) {
      @Pc(26)
      Node_Sub6 local26 = Static158.method2680(arg0);
      ...
      @Pc(43)
      int local43 = local26.aClass4_Sub6Array42.length;
    ...
    for (@Pc(91) int local91 = 0; local91 < local7; local91++) {
      @Pc(98)
      Node_Sub6 local98 = this.aClass4_Sub6Array23[local91];
      local50 = local98.aClass4_Sub6Array42.length;
      for (@Pc(104) int local104 = 0; local104 < local50; local104++) {
        local98.aClass4_Sub6Array42[local104] =
            this.aClass4_Sub6Array23[local14[local91][local104]];
      }
      @Pc(126)
      int local126 = local98.method5511();
      @Pc(130)
      int local130 = local98.method5512();
      if (local126 > 0) {
  ...
  public int[] method3277(
      ...
      @OriginalArg(4) Js5 arg3,
      @OriginalArg(5) double arg4,
    ...
    for (@Pc(61) int local61 = 0; local61 < arg5; local61++) {
      ...
      if (this.aClass4_Sub6_2.aBoolean665) {
        @Pc(93)
        int[] local93 = this.aClass4_Sub6_2.method5510(local61);
        local77 = local93;
        local85 = local93;
        local81 = local93;
      } else {
        @Pc(73)
        int[][] local73 = this.aClass4_Sub6_2.method5514(local61);
        local77 = local73[0];
        local81 = local73[2];
        local85 = local73[1];
      }
      ...
      for (@Pc(105) int local105 = local47; local105 != local43; local105 += local49) {
        @Pc(113)
        int local113 = local77[local105] >> 4;
        if (local113 > 255) {
          local113 = 255;
        }
        if (local113 < 0) {
        ...
        @Pc(133)
        int local133 = local85[local105] >> 4;
        if (local133 > 255) {
          local133 = 255;
        }
        if (local133 < 0) {
        ...
        @Pc(150)
        int local150 = local81[local105] >> 4;
        if (local150 > 255) {
          local150 = 255;
        }
        ...
        @Pc(181)
        int local181 = local150 + (local113 << 16) + (local133 << 8);
        if (local181 != 0) {
          local181 |= 0xFF000000;
        }
  ...
  public int[] method3282(
      ...
      @OriginalArg(2) Js5 arg1,
      @OriginalArg(3) Interface7 arg2,
    ...
    @Pc(57)
    int[] local57 = new int[arg3 * arg0 * 4];
    @Pc(59)
    int local59 = 0;
    for (@Pc(61) int local61 = 0; local61 < arg3; local61++) {
      ...
      if (this.aClass4_Sub6_2.aBoolean665) {
        ...
        @Pc(89)
        int[][] local89 = this.aClass4_Sub6_2.method5514(local61);
        local81 = local89[0];
        local79 = local89[1];
        local77 = local89[2];
      }
      ...
      for (@Pc(129) int local129 = arg0 - 1; local129 >= 0; local129--) {
        @Pc(137)
        int local137 = local81[local129] >> 4;
        if (local137 > 255) {
          local137 = 255;
        }
        if (local137 < 0) {
        ...
        @Pc(152)
        int local152 = local79[local129] >> 4;
        if (local152 > 255) {
          local152 = 255;
        }
        if (local152 < 0) {
        ...
        @Pc(170)
        int local170 = local77[local129] >> 4;
        if (local170 > 255) {
          local170 = 255;
        }
        if (local170 < 0) {
  ...
  public float[] method3283(
      @OriginalArg(1) Interface7 arg0,
      @OriginalArg(2) Js5 arg1,
    ...
    @Pc(49)
    float[] local49 = new float[arg2 * 4 * arg4];
    @Pc(51)
    int local51 = 0;
    for (@Pc(53) int local53 = 0; local53 < arg4; local53++) {
      ...
      if (this.aClass4_Sub6_2.aBoolean665) {
        @Pc(85)
        int[] local85 = this.aClass4_Sub6_2.method5510(local53);
        local69 = local85;
        local77 = local85;
        local73 = local85;
      } else {
        @Pc(65)
        int[][] local65 = this.aClass4_Sub6_2.method5514(local53);
        local69 = local65[2];
        local73 = local65[0];
        local77 = local65[1];
      }
      ...
      for (@Pc(141) int local141 = arg2 - 1; local141 >= 0; local141--) {
        @Pc(150)
        float local150 = (float) local101[local141] / 4096.0F;
        @Pc(163)
        float local163 = ((float) local127[local141] * 31.0F / 4096.0F + 1.0F) / 4096.0F;
        if (local150 < 0.0F) {
          local150 = 0.0F;
