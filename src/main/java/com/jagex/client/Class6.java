...
public abstract class Class6 implements Interface9 {
  ...
  private int method4184() {
    @Pc(13)
    int local13 = this.aClass19_Sub2_31.method1920(this.anInt5443) * this.anInt5450;
