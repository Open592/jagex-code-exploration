...
public final class Class125 {
  ...
  @OriginalMember(
      owner = "client!kh",
      name = "<init>",
      descriptor = "(Lclient!fd;Lclient!uf;Lclient!oq;IIIII)V")
  public Class125(
      @OriginalArg(0) Class19_Sub2 arg0,
      @OriginalArg(1) Class236 arg1,
      @OriginalArg(2) Class65_Sub2 arg2,
    ...
    this.anInt3907 = arg6;
    @Pc(25)
    int local25 = 0x1 << arg5;
    @Pc(27)
    int local27 = 0;
    @Pc(31)
    int local31 = arg3 << arg5;
    @Pc(35)
    int local35 = arg4 << arg5;
    @Pc(50)
    int local50;
    for (@Pc(37) int local37 = 0; local37 < local25; local37++) {
      @Pc(48)
      int local48 = arg2.anInt5262 * (local37 + local35) + local31;
      for (local50 = 0; local50 < local25; local50++) {
        @Pc(58)
        short[] local58 = arg2.aShortArrayArray9[local48++];
        if (local58 != null) {
    ...
    if (local27 <= 0) {
      ...
      @Pc(96)
      Packet local96 = new Packet(local27 * 2);
      @Pc(115)
      int local115;
      @Pc(123)
      short[] local123;
  ...
  private void method3187() {
    ...
    @Pc(16)
    byte[] local16 = this.aClass236_1.aByteArray94;
    @Pc(18)
    byte[] local18 = Static426.aByteArray102;
    @Pc(20)
    int local20 = 0;
    @Pc(24)
    int local24 = this.aClass236_1.anInt6634;
    @Pc(34)
    int local34 = this.aClass236_1.anInt6634 * this.anInt3905 + this.anInt3907;
    @Pc(47)
    int local47;
    ...
    if (this.aClass6_Sub1_6 == null) {
      this.aClass6_Sub1_6 =
          new Class6_Sub1(
              this.aClass19_Sub2_23,
              3553,
              6406,
              128,
              128,
              false,
              Static426.aByteArray102,
              6406,
              false);
