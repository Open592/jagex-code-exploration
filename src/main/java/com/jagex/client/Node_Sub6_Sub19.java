...
public final class Node_Sub6_Sub19 extends Node_Sub6 {
  ...
  public void method5518(@OriginalArg(1) int arg0, @OriginalArg(2) Packet arg1) {
    if (arg0 == 0) {
      this.anInt3950 = arg1.g2();
    } else if (arg0 == 1) {
      this.anInt3957 = arg1.g2();
    } else if (arg0 == 2) {
      this.anInt3952 = arg1.g2();
    }
  }
  ...
  public int[][] method5514(@OriginalArg(1) int arg0) {
    ...
    if (super.aClass153_41.aBoolean437) {
      ...
      for (@Pc(55) int local55 = 0; local55 < Static80.anInt1616; local55++) {
        @Pc(61)
        int local61 = local33[local55];
        @Pc(65)
        int local65 = local41[local55];
        @Pc(69)
        int local69 = local37[local55];
