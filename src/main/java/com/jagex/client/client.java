...
public final class client extends GameShell {
  ...
  public static void method5430() {
    ...
    try {
      ...
      if (Static238.anInt4506 == 2) {
        ...
        Static36.aClass199_3 = null;
        @Pc(102)
        long local102 = Static286.aLong174 = Static96.method1684(Static2.aString1);
        Static3.aClass4_Sub12_Sub1_5.pos = 0;
      ...
      if (Static238.anInt4506 == 6) {
        ...
        if (Static238.anInt4506 == 10) {
          ...
          Static300.aClass22_246 =
              Static149.method2553()[Static146.aClass4_Sub12_Sub1_3.method1140()];
  ...
  public static boolean method4188() {
    try {
      ...
      String local77 =
          "T2 - "
              + (Static300.aClass22_246 == null ? -1 : Static300.aClass22_246.method527())
              + ","
              + (Static380.aClass22_294 == null ? -1 : Static380.aClass22_294.method527())
              + ","
              + (Static316.aClass22_257 == null ? -1 : Static316.aClass22_257.method527())
              + " - "
              + Static454.anInt4075
              + ","
  ...
  public static boolean method2816() throws IOException {
    ...
    @Pc(13)
    int local13 = Static125.aServerConnection_5.getEstimatedBytesAvailable();
    if (local13 == 0) {
      return false;
    }
    @Pc(70)
    ...
    if (Static300.aClass22_246 == null) {
      ...
      @Pc(66)
      Class22[] local66 = Static149.method2553();
                ...
                if (Static233.aClass22_195 == Static300.aClass22_246) {
                  ...
                  while (local70 > 0) {
                    ...
                    for (local335 = 0; local335 < local70; local335++) {
                      if (Static71.anIntArray536[local335] != Static56.anInt1028
                              && Static56.anInt1028 == Static71.anIntArray536[local335 + 1]
                    ...
                    if (Static372.aClass22_290 == Static300.aClass22_246) {
                            ...
                            if (local2152) {
                              if (local230) {
                                ...
                                if (local2477.anInt6045 != -1
                                    && gameLogicStepCount == local2477.anInt6066) {
                                  local2648 =
                                ...
                                if (local2477.anInt6029 != -1
                                    && gameLogicStepCount == local2477.anInt6057) {
                                  local2648 =
                            ...
                            if (local2152) {
                              if (local230) {
                                ...
                                if (local2773.anInt6045 != -1
                                    && local2773.anInt6066 == gameLogicStepCount) {
                                  local2648 =
                                ...
                                if (local2773.anInt6029 != -1
                                    && local2773.anInt6057 == gameLogicStepCount) {
                                  local2648 =
                      ...
                      if (Static435.aClass22_328 == Static300.aClass22_246) {
                        ...
                        if (Static4.aClass22_277 == Static300.aClass22_246) {
                          ...
                          if (local230) {
                            ...
                            for (local2473 = 0;
                                Static290.anInt6410 > local2473
                                    && (!aClass15Array2[local2473].aString7.equals(local210)
                                        || aClass15Array2[local2473].anInt272 != local224);
                                local2473++) {}
                            ...
                            for (local1267 = Static290.anInt6410 - 1; local1267 >= 0; local1267--) {
                              local2494 =
                                  aClass15Array2[local1267].aString6.compareTo(local4235.aString6);
                              if (local2494 == 0) {
                          ...
                          for (@Pc(5469)
                              Node_Sub18 local5469 = (Node_Sub18) Static440.aHashMap_40.head();
                              local5469 != null;
                          ...
                          for (@Pc(5544)
                              Node_Sub9 local5544 = (Node_Sub9) Static115.aLinkedList_15.tail();
                              local5544 != null;
                          ...
                          Static94.handleClientError(
                              ...
                              "T1 - "
                                  + (Static300.aClass22_246 == null
                                      ? -1
                                      : Static300.aClass22_246.method527())
                                  + ","
                                  + (Static380.aClass22_294 == null
                                      ? -1
                                      : Static380.aClass22_294.method527())
                                  + ","
                                  + (Static316.aClass22_257 == null
                                      ? -1
                                      : Static316.aClass22_257.method527())
                                  + " - "
                                  + Static454.anInt4075);
                          Static251.method3639();
                          return true;
  ...
  public static void method2572(@OriginalArg(1) Class21 arg0) {
    ...
    if (Static294.aClass21_4 == arg0) {
      ...
      if (local40 >= 0
        ...
        local309 =
            new Class16_Sub1_Sub3(
                ...
                local49,
                local196,
                local206 + gameLogicStepCount,
                local210 + gameLogicStepCount,
                local214,
                local223,
                local186,
                local202,
      ...
      if (local40 >= 0
        ...
        if (local395 != null) {
          for (@Pc(403) Node_Sub45 local403 = (Node_Sub45) local395.aLinkedList_14.tail();
              local403 != null;
      ...
      if (arg0 == Static38.aClass21_6) {
        ...
        if (local16 >= 0
          ...
          Class16_Sub1_Sub3 local918 =
              new Class16_Sub1_Sub3(
                  ...
                  local40,
                  local202,
                  gameLogicStepCount + local210,
                  local214 - -gameLogicStepCount,
                  local223,
                  local693,
                  local190,
                  local206,
        ...
        if (Static440.aHashMap_40 != null
          ...
          if (local1265 != null) {
            for (@Pc(1273) Node_Sub45 local1273 = (Node_Sub45) local1265.aLinkedList_14.tail();
                local1273 != null;
