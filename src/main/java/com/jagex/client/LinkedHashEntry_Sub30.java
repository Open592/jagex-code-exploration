...
public final class LinkedHashEntry_Sub30 extends LinkedHashEntry {

	@OriginalMember(owner = "client!nb", name = "m", descriptor = "Lclient!ib;")
	public LinkedHashMapIterator aLinkedHashMap_Iterator_23;
	...
	public LinkedHashEntry_Sub30(@OriginalArg(0) Packet arg0) {
		...
		@Pc(499) Packet local499 = new Packet(this.aByteArray58);
	...
	public void method3725() {
		this.aLinkedHashMap_Iterator_23 = null;
	}

	@OriginalMember(owner = "client!nb", name = "b", descriptor = "()V")
	public void method3726() {
		if (this.aLinkedHashMap_Iterator_23 != null) {
			return;
		}
		this.aLinkedHashMap_Iterator_23 = new LinkedHashMapIterator(16);
				...
				while (local29.anIntArray347[local51] == local56) {
					...
					if (local80 == 144) {
						...
						if (local99 > 0) {
							...
							@Pc(182) LinkedHashEntry_Sub19 local182 = (LinkedHashEntry_Sub19) this.aLinkedHashMap_Iterator_23.get((long) local174);
							if (local182 == null) {
								local182 = new LinkedHashEntry_Sub19(new byte[128]);
								this.aLinkedHashMap_Iterator_23.set((long) local174, local182);
							}
