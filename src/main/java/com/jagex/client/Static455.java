...
public final class Static455 {
  ...
  @OriginalMember(
      owner = "client!ya",
      name = "a",
      descriptor = "(Lclient!ga;ILjava/awt/Canvas;IBLclient!et;)Lclient!ya;")
  public static synchronized Class19 method4241(
      @OriginalArg(0) Interface7 arg0,
      @OriginalArg(1) int arg1,
      @OriginalArg(2) Canvas arg2,
      @OriginalArg(3) int arg3,
      @OriginalArg(5) SignLink arg4) {
    @Pc(7)
    int local7 = -1;
  ...
  public static void method4292() {
    Static7.anInt5461 = 0;
    label208:
    for (@Pc(3) int local3 = 0; local3 < Static93.anInt1878; local3++) {
      @Pc(8)
      Class136 local8 = Static91.aClass136Array2[local3];
      @Pc(12)
      int local12;
      if (Static29.anIntArray34 != null) {
        for (local12 = 0; local12 < Static29.anIntArray34.length; local12++) {
          if (Static29.anIntArray34[local12] != -1000000
              && (local8.anInt4368 <= Static29.anIntArray34[local12]
                  || local8.anInt4361 <= Static29.anIntArray34[local12])
              && (local8.anInt4355 <= Static85.anIntArray143[local12]
                  || local8.anInt4370 <= Static85.anIntArray143[local12])
              && (local8.anInt4355 >= Static248.anIntArray303[local12]
                  || local8.anInt4370 >= Static248.anIntArray303[local12])
              && (local8.anInt4359 <= Static64.anIntArray106[local12]
                  || local8.anInt4356 <= Static64.anIntArray106[local12])
              && (local8.anInt4359 >= Static223.anIntArray284[local12]
                  || local8.anInt4356 >= Static223.anIntArray284[local12])) {
            continue label208;
          }
        }
      }
      ...
      if (local8.anInt4360 == 1) {
        ...
        if (local12 > Static367.anInt6319) {
          ...
          @Pc(435)
          int local435 = local8.anInt4365 + Static230.anInt4431 - Static431.anInt7073;
          if (local435 < 0) {
            local435 = 0;
          ...
          @Pc(468)
          boolean local468 = false;
          label180:
          for (@Pc(470) int local470 = local435; local470 <= local164; local470++) {
  ...
  public static boolean method4305(
