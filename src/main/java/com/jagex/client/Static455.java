...
public final class Static455 {
	...
	public static synchronized Class19 method4241(@OriginalArg(0) Interface7 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Canvas arg2, @OriginalArg(3) int arg3, @OriginalArg(5) SignLink arg4) {
		@Pc(7) int local7 = -1;
