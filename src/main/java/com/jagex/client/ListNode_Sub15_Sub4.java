...
public final class ListNode_Sub15_Sub4 extends ListNode_Sub15 {
	...
	public final ListNode_Sub15_Sub2 aClass4_Sub15_Sub2_1 = new ListNode_Sub15_Sub2();

	@OriginalMember(owner = "client!se", name = "q", descriptor = "Lclient!dv;")
	private final ListNode_Sub15_Sub1 aClass4_Sub15_Sub1_2;

	@OriginalMember(owner = "client!se", name = "<init>", descriptor = "(Lclient!dv;)V")
	public ListNode_Sub15_Sub4(@OriginalArg(0) ListNode_Sub15_Sub1 arg0) {
	...
	public ListNode_Sub15 method4857() {
		@Pc(9) ListNode_Sub28 local9;
		do {
			local9 = (ListNode_Sub28) this.aClass183_44.method4144();
			if (local9 == null) {
				return null;
			}
	...
	public void method4855(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		for (@Pc(17) ListNode_Sub28 local17 = (ListNode_Sub28) this.aClass183_44.method4140(); local17 != null; local17 = (ListNode_Sub28) this.aClass183_44.method4144()) {
	...
	private void method4862(@OriginalArg(1) ListNode_Sub28 arg0, @OriginalArg(2) int arg1) {
	...
	public ListNode_Sub15 method4860() {
		@Pc(9) ListNode_Sub28 local9 = (ListNode_Sub28) this.aClass183_44.method4140();
		if (local9 == null) {
			return null;
	...
	private void method4863(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) ListNode_Sub28 arg3, @OriginalArg(4) int arg4) {
		if ((this.aClass4_Sub15_Sub1_2.anIntArray133[arg3.anInt4386] & 0x4) != 0 && arg3.anInt4394 < 0) {
			...
			while (true) {
				...
				@Pc(85) ListNode_Sub15_Sub3 local85 = arg3.aClass4_Sub15_Sub3_3;
	...
	public void method4861(@OriginalArg(0) int arg0) {
		...
		for (@Pc(15) ListNode_Sub28 local15 = (ListNode_Sub28) this.aClass183_44.method4140(); local15 != null; local15 = (ListNode_Sub28) this.aClass183_44.method4144()) {
