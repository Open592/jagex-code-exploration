...
public final class Class155 {
  ...
  public Class155(@OriginalArg(0) Packet arg0) {
    ...
    if ((local16 & 0x80) == 0) {
      ...
      @Pc(219)
      int local219 = arg0.g2();
      @Pc(223)
      int local223 = arg0.g2();
      @Pc(227)
      int local227 = arg0.g2();
      @Pc(231)
      int local231 = arg0.g2();
      @Pc(235)
      int local235 = arg0.g2();
      @Pc(239)
      int local239 = arg0.g2();
      this.aClass99_3 =
          Static204.method3186(local235, local227, local239, local219, local231, local223);
    }
  }

  @OriginalMember(owner = "client!mu", name = "a", descriptor = "(BLclient!iv;)V")
  public void method3692(@OriginalArg(1) Packet arg0) {
    this.aFloat148 = (float) (arg0.g1() * 8) / 255.0F;
    this.aFloat146 = (float) (arg0.g1() * 8) / 255.0F;
    this.aFloat147 = (float) (arg0.g1() * 8) / 255.0F;
  }

  @OriginalMember(owner = "client!mu", name = "a", descriptor = "(BLclient!mu;)Z")
  public boolean method3695(@OriginalArg(1) Class155 arg0) {
    return this.anInt4773 == arg0.anInt4773
        && this.aFloat150 == arg0.aFloat150
        && arg0.aFloat149 == this.aFloat149
        && this.aFloat151 == arg0.aFloat151
        && this.aFloat146 == arg0.aFloat146
        && arg0.aFloat148 == this.aFloat148
        && arg0.aFloat147 == this.aFloat147
        && this.anInt4774 == arg0.anInt4774
        && this.anInt4777 == arg0.anInt4777
        && arg0.aClass99_3 == this.aClass99_3;
  }
}
