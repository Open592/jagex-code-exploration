...
public final class Class208 {
  ...
  public Class208(
    ...
    this.aJs5_80 = arg2;
    if (this.aJs5_80 != null) {
      this.aJs5_80.method2108(35);
    }
  }
  ...
  public void method4721() {
    @Pc(6)
    Class68 local6 = this.aClass68_42;
    synchronized (this.aClass68_42) {
      this.aClass68_42.clear();
    }
  }
  ...
  public void method4722() {
    @Pc(2)
    Class68 local2 = this.aClass68_42;
    synchronized (this.aClass68_42) {
  ...
  public void method4723() {
    @Pc(10)
    Class68 local10 = this.aClass68_42;
    synchronized (this.aClass68_42) {
  ...
  public Class101 method4725(@OriginalArg(1) int arg0) {
    ...
    @Pc(33)
    byte[] local33 = this.aJs5_80.method2104(arg0, 35);
    local16 = new Class101();
    if (local33 != null) {
      local16.method2679(new Packet(local33));
    }
    local16.method2676();
    @Pc(57)
    Class68 local57 = this.aClass68_42;
    synchronized (this.aClass68_42) {
