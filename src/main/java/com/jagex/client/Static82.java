...
public final class Static82 {
  ...
  public static void method1468(
    ...
    int local65 = arg4 * 3;
    @Pc(74)
    int local74 = arg5 + local53 - local61 - arg7;
    @Pc(84)
    int local84 = local57 + arg2 - arg0 - local65;
    @Pc(94)
    int local94 = local45 + local61 - local53 - local53;
    @Pc(105)
    int local105 = local65 + local49 - local57 - local57;
    @Pc(110)
    int local110 = local53 - local45;
    @Pc(115)
    int local115 = local57 - local49;
    for (@Pc(117) int local117 = 128; local117 <= 4096; local117 += 128) {
      @Pc(125)
      int local125 = local117 * local117 >> 12;
      @Pc(131)
      int local131 = local125 * local117 >> 12;
      @Pc(135)
      int local135 = local74 * local131;
      @Pc(139)
      int local139 = local84 * local131;
      @Pc(143)
      int local143 = local125 * local94;
      @Pc(147)
      int local147 = local105 * local125;
      @Pc(151)
      int local151 = local117 * local110;
      @Pc(155)
      int local155 = local117 * local115;
      @Pc(166)
      int local166 = arg7 + (local151 + local143 + local135 >> 12);
      @Pc(177)
      int local177 = arg0 + (local147 + local139 + local155 >> 12);
  ...
  public static short method1470(@OriginalArg(1) int arg0) {
    @Pc(17)
    int local17 = arg0 >> 10 & 0x3F;
    @Pc(23)
    int local23 = arg0 >> 3 & 0x70;
    @Pc(27)
    int local27 = arg0 & 0x7F;
    @Pc(44)
    int local44 = local27 <= 64 ? local27 * local23 >> 7 : (127 - local27) * local23 >> 7;
    @Pc(48)
    int local48 = local44 + local27;
    @Pc(59)
    int local59;
    if (local48 == 0) {
      local59 = local44 << 1;
