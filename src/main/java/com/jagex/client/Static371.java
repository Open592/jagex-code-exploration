...
public final class Static371 {
  ...
  public static final LocalizedString A_LOCALIZED_STRING___125 =
      new LocalizedString(
          " has logged out.", " loggt sich aus.", " s'est déconnecté.", " saiu do jogo.");

  @OriginalMember(owner = "client!sr", name = "b", descriptor = "(I)I")
  public static int method4958() {
    @Pc(7)
    Class19 local7 = Static122.aClass19_16;
    @Pc(9)
    boolean local9 = false;
    if (Static177.anInt2973 != 0) {
      @Pc(15)
      Canvas local15 = new Canvas();
      local15.setSize(100, 100);
      local7 = Static455.method4241(null, 0, local15, 0, null);
      local9 = true;
    }
    @Pc(32)
    long local32 = MonotonicClock.getCurrentTimeInMilliseconds();
    for (@Pc(34) int local34 = 0; local34 < 10000; local34++) {
      local7.method4276();
    }
    @Pc(69)
    int local69 = (int) (MonotonicClock.getCurrentTimeInMilliseconds() - local32);
  ...
  public static void method4959(@OriginalArg(0) Class16_Sub1_Sub5 arg0) {
      ...
      if (local19 == null || local19.anIntArray295 == null) {
        ...
        label394:
        {
          ...
          if (arg0.anInt6016 < local19.anIntArray295.length
              && local19.anIntArray296[arg0.anInt6016] < arg0.anInt6065) {
            arg0.anInt6065 = 1;
            arg0.anInt6036++;
            arg0.anInt6016++;
            Static15.method156(
                ...
                arg0.anInt6892,
                local19,
                arg0 == Static1.aClass16_Sub1_Sub5_Sub1_1);
          }
          if (arg0.anInt6016 >= local19.anIntArray295.length) {
            arg0.anInt6016 = 0;
            arg0.anInt6065 = 0;
            ...
            Static15.method156(
                ...
                arg0.anInt6892,
                local19,
                Static1.aClass16_Sub1_Sub5_Sub1_1 == arg0);
          }
        ...
        label396:
        {
          ...
          if (local180.aBoolean459) {
            if (local196.anInt4401 == 3) {
              if (arg0.anInt6087 > 0
                  && client.gameLogicStepCount >= arg0.anInt6018
                  && client.gameLogicStepCount > arg0.anInt6023) {
                arg0.anInt6029 = -1;
                break label396;
              }
            } else if (local196.anInt4401 == 1
                && arg0.anInt6087 > 0
                && client.gameLogicStepCount >= arg0.anInt6018
                && client.gameLogicStepCount > arg0.anInt6023) {
          ...
          if (local196 == null || local196.anIntArray295 == null) {
            ...
            arg0.anInt6033++;
            if (local196.anIntArray295.length > arg0.anInt6027
                && arg0.anInt6033 > local196.anIntArray296[arg0.anInt6027]) {
              arg0.anInt6027++;
              arg0.anInt6033 = 1;
              Static15.method156(
                  arg0.anInt6893,
        ...
        label399:
        {
          ...
          if (local180.aBoolean459) {
            if (local196.anInt4401 == 3) {
              if (arg0.anInt6087 > 0
                ...
                && arg0.anInt6087 > 0
                && client.gameLogicStepCount >= arg0.anInt6018
                && arg0.anInt6023 < client.gameLogicStepCount) {
          ...
          if (local196 == null || local196.anIntArray295 == null) {
            ...
            if (arg0.anInt6022 < local196.anIntArray295.length
                && arg0.anInt6062 > local196.anIntArray296[arg0.anInt6022]) {
              arg0.anInt6022++;
              arg0.anInt6062 = 1;
              Static15.method156(
                  arg0.anInt6893,
    ...
    if (arg0.anInt6021 != -1 && arg0.anInt6046 <= 1) {
      ...
      if (local19.anInt4401 == 3) {
        if (arg0.anInt6087 > 0
            && arg0.anInt6018 <= client.gameLogicStepCount
            && client.gameLogicStepCount > arg0.anInt6023) {
          arg0.anInt6021 = -1;
        }
      } else if (local19.anInt4401 == 1
          && arg0.anInt6087 > 0
          && arg0.anInt6018 <= client.gameLogicStepCount
          && client.gameLogicStepCount > arg0.anInt6023) {
        arg0.anInt6046 = 2;
    ...
    if (arg0.anInt6021 != -1 && arg0.anInt6046 == 0) {
      ...
      if (local19 == null || local19.anIntArray295 == null) {
        ...
        if (arg0.anInt6060 < local19.anIntArray295.length
            && arg0.anInt6073 > local19.anIntArray296[arg0.anInt6060]) {
          arg0.anInt6073 = 1;
          arg0.anInt6060++;
          Static15.method156(
              arg0.anInt6893,
    ...
    for (@Pc(1066) int local1066 = 0; local1066 < arg0.aClass165Array3.length; local1066++) {
      @Pc(1073)
      Class165 local1073 = arg0.aClass165Array3[local1066];
      if (local1073 != null) {
        if (local1073.anInt5141 > 0) {
          ...
          if (local196 == null || local196.anIntArray295 == null) {
            ...
            local1073.anInt5142++;
            if (local196.anIntArray295.length > local1073.anInt5138
                && local196.anIntArray296[local1073.anInt5138] < local1073.anInt5142) {
              local1073.anInt5138++;
            ...
            if (local1073.anInt5138 >= local196.anIntArray295.length) {
              ...
              if (local1073.anInt5143 >= local196.anInt4412) {
                arg0.aClass165Array3[local1066] = null;
              } else if (local1073.anInt5138 >= 0
                  && local196.anIntArray295.length > local1073.anInt5138) {
                Static15.method156(
                    arg0.anInt6893,
                    local1073.anInt5138,
                    arg0.aByte82,
            ...
            if (local196.anIntArray295.length <= local1073.anInt5140) {
              ...
              } else if (local1073.anInt5140 < 0
                  || local196.anIntArray295.length <= local1073.anInt5140) {
                local1073.anInt5140 = -1;
              }
            }
          }
