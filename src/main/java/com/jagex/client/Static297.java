...
public final class Static297 {
  ...
  public static void method4069() {
    ...
    for (@Pc(47) int local47 = 0;
        local47 < Static143.aClass16_Sub1_Sub5_Sub2Array1.length;
        local47++) {
      @Pc(53)
      Class16_Sub1_Sub5_Sub2 local53 = Static143.aClass16_Sub1_Sub5_Sub2Array1[local47];
      if (local53 != null) {
        local53.anInt6034 = -1;
      }
    }
  ...
  public static void method4070(
    ...
    int local7;
    label56:
    for (@Pc(4) int local4 = arg2; local4 <= arg4; local4++) {
      label54:
      for (local7 = arg3; local7 <= arg5; local7++) {
        @Pc(16)
        long local16 = Static444.aLongArrayArrayArray2[arg1][local4][local7];
        @Pc(18)
        long local18 = 0L;
        while (true) {
          label49:
          while (true) {
            ...
            @Pc(27)
            int local27 = (int) (local16 >>> (int) local18 & 0xFFFFL);
            if (local27 <= 0) {
              continue label54;
            }
            @Pc(35)
            Class191 local35 = Static106.aClass191Array1[local27 - 1];
  ...
  public static void method4071(
    ...
    if (arg5 < 0
        || arg6 < 0
        || Static326.anInt5666 - 1 <= arg5
        || arg6 >= Static283.anInt5187 - 1) {
      return;
    }
    ...
    if (arg3 != 0) {
      if (arg3 != 1) {
        if (arg3 == 2) {
          local67 = (Interface6) Static36.method648(arg0, arg5, arg6, Interface6.class);
          if (local67 != null) {
            if (arg4 == 11) {
              arg4 = 10;
            }
      ...
      if (local67 != null) {
        if (!(local67 instanceof Class16_Sub2_Sub3)) {
          @Pc(148)
          int local148 = local67.method5350();
          if (arg4 != 4 && arg4 != 5) {
            if (arg4 == 6) {
    ...
    @Pc(256)
    Interface6 local256 = (Interface6) Static136.method2344(arg0, arg5, arg6);
