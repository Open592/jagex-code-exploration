...
public final class Static211 {
  ...
  public static final HashMap A_HASH_MAP___18 = new HashMap(512);
  ...
  public static SecondaryNode_Sub1 method3200(@OriginalArg(0) int arg0) {
    @Pc(10)
    SecondaryNode_Sub1 local10 = (SecondaryNode_Sub1) Static48.aClass142_1.method3483((long) arg0);
    if (local10 != null) {
      return local10;
    }
    @Pc(25)
  ...
  public static void method3203() {
    ...
    @Pc(20)
    int local20 = Static146.aClass4_Sub12_Sub1_3.g2_alt3();
    @Pc(29)
    boolean local29 = Static146.aClass4_Sub12_Sub1_3.g1_alt3() == 1;
    @Pc(35)
    int local35 = Static146.aClass4_Sub12_Sub1_3.g2_alt2();
    @Pc(39)
    int local39 = Static146.aClass4_Sub12_Sub1_3.g1_alt3();
    ...
    for (@Pc(47) int local47 = 0; local47 < 4; local47++) {
      for (local51 = 0; local51 < Static326.anInt5666 >> 3; local51++) {
        for (local55 = 0; local55 < Static283.anInt5187 >> 3; local55++) {
          ...
          if (local62 == 1) {
            Static313.anIntArrayArrayArray12[local47][local51][local55] =
                Static146.aClass4_Sub12_Sub1_3.method1143(26);
          } else {
    ...
    for (local62 = 0; local62 < 4; local62++) {
      for (@Pc(185) int local185 = 0; local185 < Static326.anInt5666 >> 3; local185++) {
        for (@Pc(189) int local189 = 0; local189 < Static283.anInt5187 >> 3; local189++) {
          @Pc(199)
          int local199 = Static313.anIntArrayArrayArray12[local62][local185][local189];
          if (local199 != -1) {
            @Pc(209)
            int local209 = local199 >> 14 & 0x3FF;
            @Pc(215)
            int local215 = local199 >> 3 & 0x7FF;
            @Pc(225)
            int local225 = local215 / 8 + (local209 / 8 << 8);
