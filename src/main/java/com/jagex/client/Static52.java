...
public final class Static52 {
  ...
  public static byte[] method841(@OriginalArg(0) byte[] arg0) {
    if (arg0 == null) {
      ...
      @Pc(11)
      byte[] local11 = new byte[arg0.length];
  ...
  public static void method842(@OriginalArg(0) int arg0) {
    @Pc(13)
    SecondaryNode_Sub1_Sub11 local13 = Static405.method5222(arg0, 7);
    local13.method2608();
  }
  ...
  public static boolean method844(
    ...
    if (Static417.aClass65Array4 != Static285.aClass65Array3) {
      @Pc(11)
      int local11 = Static67.aClass65Array1[arg1].a(arg2, arg3);
      for (@Pc(13) int local13 = 0; local13 <= arg1; local13++) {
        @Pc(18)
        Class65 local18 = Static67.aClass65Array1[local13];
        if (local18 != null) {
          @Pc(27)
          int local27 = local11 - local18.a(arg2, arg3);
          if (arg4 != null) {
