...
public final class Static52 {
	...
	public static void method842(@OriginalArg(0) int arg0) {
		@Pc(13) ContextualEntry_Sub1_Sub11 local13 = Static405.method5222(arg0, 7);
		local13.method2608();
	}

	@OriginalMember(owner = "client!ck", name = "a", descriptor = "(Lclient!ba;III[Z)Z")
	public static boolean method844(@OriginalArg(0) ContextualEntry_Sub1_Sub4 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean[] arg4) {
