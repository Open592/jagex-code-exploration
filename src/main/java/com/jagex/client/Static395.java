...
public final class Static395 {
  ...
  public static void method5163(
      @OriginalArg(1) boolean arg0, @OriginalArg(2) Class16_Sub1_Sub5 arg1) {
    @Pc(9)
    Class151 local9 = arg1.method4757();
    if (arg1.anInt6086 == 0) {
    ...
    if (arg1.anInt6021 != -1 && arg1.anInt6046 == 0) {
      @Pc(40)
      Class138 local40 = Static182.aClass55_1.method1397(arg1.anInt6021);
    ...
    @Pc(233)
    int local233 = arg1.anInt6893;
    @Pc(236)
    int local236 = arg1.anInt6892;
    @Pc(252)
    int local252 = arg1.anIntArray426[arg1.anInt6086 - 1] * 128 + arg1.method4751() * 64;
    @Pc(269)
    int local269 = arg1.anIntArray427[arg1.anInt6086 - 1] * 128 + arg1.method4751() * 64;
    ...
    @Pc(355)
    byte local355 = arg1.aByteArray84[arg1.anInt6086 - 1];
    if (!arg0
        && (local252 - local233 > 256
            || local252 - local233 < -256
            || local269 - local236 > 256
            || local269 - local236 < -256)) {
    ...
    if (local9.anInt4664 != -1) {
      ...
      if (arg1.anInt6086 == 1) {
        ...
        @Pc(576)
        int local576 =
            (local252 >= arg1.anInt6893 ? local252 - arg1.anInt6893 : arg1.anInt6893 - local252)
                << 7;
        @Pc(598)
        int local598 =
            (arg1.anInt6892 > local269 ? arg1.anInt6892 - local269 : local269 + -arg1.anInt6892)
                << 7;
        @Pc(609)
        int local609 = local598 < local576 ? local576 : local598;
        @Pc(616)
        int local616 = local609 * local9.anInt4664 * 2;
