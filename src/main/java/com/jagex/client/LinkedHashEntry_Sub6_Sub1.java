...
public final class LinkedHashEntry_Sub6_Sub1 extends LinkedHashEntry_Sub6 {
	...
	private LinkedHashEntry_Sub6_Sub1(@OriginalArg(0) int arg0) {
		super(0, false);
		this.method620(arg0);
	}

	@OriginalMember(owner = "client!bj", name = "<init>", descriptor = "()V")
	public LinkedHashEntry_Sub6_Sub1() {
		this(0);
	}
