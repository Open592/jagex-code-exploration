...
public final class Node_Sub16 extends Node {
  ...
  @OriginalMember(
      owner = "client!dw",
      name = "l",
      descriptor = "Lclient!jaggl/memory/NativeBuffer;")
  private NativeBuffer aNativeBuffer1;

  @OriginalMember(
      owner = "client!dw",
      name = "s",
      descriptor = "Lclient!jaggl/memory/NativeStream;")
  ...
  public Node_Sub16(
      @OriginalArg(0) Class65_Sub2 arg0,
  ...
  public void method1461(@OriginalArg(0) int arg0) {
    ...
    @Pc(18)
    Interface11 local18 = this.aClass19_Sub2_11.method1902(this.aNativeBuffer1, arg0 * 4, 4);
  ...
  public void method1462(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1) {
    ...
    int local7 = 0;
    @Pc(9)
    Packet local9 = Static383.aPacket_7;
    local9.pos = 0;
    @Pc(36)
    short[] local36;
    @Pc(30)
        ...
        if (local41 != 0 && local36 != null) {
          ...
          while (local52 < local36.length) {
            if ((local41 & 0x1 << local50++) == 0) {
              ...
              local7++;
              local9.p2(local36[local52++] & 0xFFFF);
              local7++;
              local9.p2(local36[local52++] & 0xFFFF);
              local9.p2(local36[local52++] & 0xFFFF);
              local7++;
        ...
        if (local41 != 0 && local36 != null) {
          ...
          while (local36.length > local52) {
            if ((0x1 << local50++ & local41) == 0) {
              ...
              local9.p2_alt1(local36[local52++] & 0xFFFF);
              local7++;
              local9.p2_alt1(local36[local52++] & 0xFFFF);
              local7++;
              local7++;
    ...
    this.aClass64_Sub1_1.method3657(local9.data, local9.pos);
    this.aClass19_Sub2_11.method1934(
        this.aClass177_4,
        this.aClass65_Sub2_1.aClass177_16,
        this.aClass65_Sub2_1.aClass177_14,
        this.aClass65_Sub2_1.aClass177_15);
    this.aClass19_Sub2_11.method1926(
        (this.aClass65_Sub2_1.anInt5285 & 0x7) != 0,
        this.anInt1647,
        (this.aClass65_Sub2_1.anInt5285 & 0x8) != 0);
  ...
  public void method1465(
    ...
    if (this.anInt1647 != -1) {
      @Pc(18)
      Class251 local18 = this.aClass19_Sub2_11.anInterface7_6.method2396(this.anInt1647);
      ...
      if (local23 != 0 && local18.aByte89 != 4) {
        ...
        if (local23 == 256) {
          ...
          local67 = 256 - local23;
          arg2 =
              (local67 * (arg2 & 0xFF00FF) + (local45 & 0xFF00FF) * local23 & 0xFF00FF00)
                      + (local67 * (arg2 & 0xFF00) + local23 * (local45 & 0xFF00) & 0xFF0000)
                  >> 8;
        }
      }
      ...
      if (local45 != 0) {
        local45 += 256;
        @Pc(114)
        int local114 = (arg2 >> 16 & 0xFF) * local45;
        if (local114 > 65535) {
          local114 = 65535;
        }
        ...
        @Pc(140)
        int local140 = local45 * (arg2 & 0xFF);
        if (local140 > 65535) {
          local140 = 65535;
        }
