...
public final class Static269 {
  ...
  public static void method3853(@OriginalArg(0) String arg0) {
    if (GameShell.aClass15Array2 != null) {
      ...
      Static3.aClass4_Sub12_Sub1_5.p1(method3856(arg0));
  ...
  public static void method3855() {
    ...
    @Pc(49)
    int local49 = Static394.anInt6578 >> 7;
    @Pc(53)
    int local53 = Static325.anInt5636 >> 7;
    @Pc(59)
    int local59 = Static13.method135(Static394.anInt6578, Static263.anInt4963, Static325.anInt5636);
    @Pc(61)
    int local61 = 0;
    @Pc(87)
    int local87;
    if (local49 > 3
        && local53 > 3
        && local49 < Static326.anInt5666 - 4
        && local53 < Static283.anInt5187 - 4) {
      for (local87 = local49 - 4; local87 <= local49 + 4; local87++) {
        for (@Pc(93) int local93 = local53 - 4; local93 <= local53 + 4; local93++) {
          @Pc(97)
          int local97 = Static263.anInt4963;
          if (local97 < 3 && Static378.method3229(local87, local93)) {
            local97++;
          }
          @Pc(110)
          int local110 = 0;
          if (Static67.aClass266_Sub1_1.aByteArrayArrayArray14 != null
              && Static67.aClass266_Sub1_1.aByteArrayArrayArray14[local97] != null) {
            local110 =
                (Static67.aClass266_Sub1_1.aByteArrayArrayArray14[local97][local87][local93] & 0xFF)
                    * 8;
          }
          @Pc(143)
          int local143 = local110 + local59 - Static417.aClass65Array4[local97].l(local87, local93);
          if (local61 < local143) {
            local61 = local143;
          }
        }
