...
public final class Class260 {
  ...
  private SecondaryNode_Sub1_Sub13 aClass4_Sub1_Sub13_1;
  ...
  private SecondaryNode_Sub1_Sub13 aClass4_Sub1_Sub13_2;
  ...
  private final LinkedList aLinkedList_50 = new LinkedList();
  ...
  public Class260(@OriginalArg(0) Class19_Sub2 arg0) {
    ...
    if (this.aClass19_Sub2_42.aBoolean191 && this.aClass19_Sub2_42.aBoolean207) {
      ...
      if (this.aClass19_Sub2_42.anInt2272 > 1
          && this.aClass19_Sub2_42.aBoolean204
          && this.aClass19_Sub2_42.aBoolean209) {
  ...
  public void method5524() {
    ...
    if (!this.aLinkedList_50.isEmpty()) {
      for (@Pc(42) Node local42 = this.aLinkedList_50.tail();
          local42 != this.aLinkedList_50.sentinelNode;
          local42 = local42.previous) {
        ((Node_Sub10) local42).method2006();
      }
    }
  ...
  public boolean method5525(@OriginalArg(1) Node_Sub10 arg0) {
    if (this.aClass150_5 != null) {
      if (arg0.method2004() || arg0.method2005()) {
        this.aLinkedList_50.addFirst(arg0);
        this.method5526();
        if (this.method5528()) {
  ...
  private void method5526() {
    ...
    @Pc(25)
    int local25;
    for (@Pc(19) Node_Sub10 local19 = (Node_Sub10) this.aLinkedList_50.tail();
        local19 != null;
        local19 = (Node_Sub10) this.aLinkedList_50.previous()) {
    ...
    @Pc(91)
    int local91 = this.anInt7137 > 2 ? 2 : this.anInt7137;
    @Pc(100)
    int local100 = local11 > 2 ? 2 : local11;
  ...
  private boolean method5528() {
    if (this.aBoolean670) {
      ...
      if (this.aClass150_6 != null) {
        this.aClass4_Sub1_Sub13_2 =
            new SecondaryNode_Sub1_Sub13(
                this.aClass19_Sub2_42,
                6402,
                this.anInt7128,
                this.anInt7127,
                this.aClass19_Sub2_42.anInt2272);
      }
      if (this.aBoolean673) {
        this.aClass6_Sub1_7 =
            new Class6_Sub1(this.aClass19_Sub2_42, 34037, 6402, this.anInt7128, this.anInt7127);
      } else if (this.aClass4_Sub1_Sub13_2 == null) {
        this.aClass4_Sub1_Sub13_2 =
            new SecondaryNode_Sub1_Sub13(
                this.aClass19_Sub2_42, 6402, this.anInt7128, this.anInt7127);
      }
    ...
    if (this.aBoolean674) {
      ...
      this.aClass6_Sub1Array4[0] =
          new Class6_Sub1(
              this.aClass19_Sub2_42, 34037, this.anInt7138, this.anInt7128, this.anInt7127);
      this.aClass6_Sub1Array4[1] =
          this.anInt7137 <= 1
              ? null
              : new Class6_Sub1(
                  this.aClass19_Sub2_42, 34037, this.anInt7138, this.anInt7128, this.anInt7127);
  ...
  public void method5529(@OriginalArg(1) Node_Sub10 arg0) {
  ...
  public boolean method5530(
    ...
    if (this.aClass150_5 == null || this.aLinkedList_50.isEmpty()) {
      return false;
    }
    if (this.anInt7128 != arg1 || arg3 != this.anInt7127) {
      this.anInt7127 = arg3;
      this.anInt7128 = arg1;
      for (@Pc(49) Node local49 = this.aLinkedList_50.tail();
          local49 != this.aLinkedList_50.sentinelNode;
          local49 = local49.previous) {
        ((Node_Sub10) local49).method2007(this.anInt7127, this.anInt7128);
      }
      this.aBoolean674 = true;
      this.aBoolean671 = true;
      this.aBoolean670 = true;
    ...
    this.aClass19_Sub2_42.method1931(
        this.anInt7127 - this.aClass150_5.method3615() - this.anInt7130, -this.anInt7132);
    return true;
  }
  ...
  public void method5532() {
    ...
    @Pc(117)
    Node_Sub10 local117;
    for (@Pc(109) Node_Sub10 local109 = (Node_Sub10) this.aLinkedList_50.tail();
        local109 != null;
        local109 = local117) {
      local117 = (Node_Sub10) this.aLinkedList_50.previous();
      @Pc(121)
      int local121 = local109.method2001();
