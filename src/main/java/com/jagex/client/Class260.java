...
public final class Class260 {
	...
	private ListNode_Sub1_Sub13 aClass4_Sub1_Sub13_1;
	...
	private ListNode_Sub1_Sub13 aClass4_Sub1_Sub13_2;
	...
	public void method5524() {
		...
		if (!this.aClass183_50.method4147()) {
			for (@Pc(42) ListNode local42 = this.aClass183_50.method4140(); local42 != this.aClass183_50.aListNode_207; local42 = local42.previous) {
				((ListNode_Sub10) local42).method2006();
			}
		}
	...
	public boolean method5525(@OriginalArg(1) ListNode_Sub10 arg0) {
	...
	private void method5526() {
		...
		@Pc(11) int local11 = 0;
		@Pc(25) int local25;
		for (@Pc(19) ListNode_Sub10 local19 = (ListNode_Sub10) this.aClass183_50.method4140(); local19 != null; local19 = (ListNode_Sub10) this.aClass183_50.method4144()) {
	...
	private boolean method5528() {
		if (this.aBoolean670) {
			...
			if (this.aClass150_6 != null) {
				this.aClass4_Sub1_Sub13_2 = new ListNode_Sub1_Sub13(this.aClass19_Sub2_42, 6402, this.anInt7128, this.anInt7127, this.aClass19_Sub2_42.anInt2272);
			}
			if (this.aBoolean673) {
				...
				this.aClass4_Sub1_Sub13_2 = new ListNode_Sub1_Sub13(this.aClass19_Sub2_42, 6402, this.anInt7128, this.anInt7127);
			}
		...
		if (this.aBoolean674) {
			...
			if (this.aClass150_6 != null) {
				this.aClass4_Sub1_Sub13_1 = new ListNode_Sub1_Sub13(this.aClass19_Sub2_42, this.anInt7138, this.anInt7128, this.anInt7127, this.aClass19_Sub2_42.anInt2272);
			}
	...
	public void method5529(@OriginalArg(1) ListNode_Sub10 arg0) {
	...
	public boolean method5530(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3) {
		...
		if (this.anInt7128 != arg1 || arg3 != this.anInt7127) {
			this.anInt7127 = arg3;
			this.anInt7128 = arg1;
			for (@Pc(49) ListNode local49 = this.aClass183_50.method4140(); local49 != this.aClass183_50.aListNode_207; local49 = local49.previous) {
				((ListNode_Sub10) local49).method2007(this.anInt7127, this.anInt7128);
			}
			this.aBoolean674 = true;
			this.aBoolean671 = true;
			this.aBoolean670 = true;
	...
	public void method5532() {
		...
		@Pc(117) ListNode_Sub10 local117;
		for (@Pc(109) ListNode_Sub10 local109 = (ListNode_Sub10) this.aClass183_50.method4140(); local109 != null; local109 = local117) {
			local117 = (ListNode_Sub10) this.aClass183_50.method4144();
