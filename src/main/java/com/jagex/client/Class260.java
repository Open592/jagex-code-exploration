...
public final class Class260 {
	...
	public void method5524() {
		...
		if (!this.aLinkedList_50.isEmpty()) {
			for (@Pc(42) Node local42 = this.aLinkedList_50.tail(); local42 != this.aLinkedList_50.sentinelNode; local42 = local42.previous) {
	...
	private void method5526() {
		...
		@Pc(11) int local11 = 0;
		@Pc(25) int local25;
		for (@Pc(19) Node_Sub10 local19 = (Node_Sub10) this.aLinkedList_50.tail(); local19 != null; local19 = (Node_Sub10) this.aLinkedList_50.previous()) {
	...
	private boolean method5528() {
		if (this.aBoolean670) {
			...
			if (this.aClass150_6 != null) {
				this.aClass4_Sub1_Sub13_2 = new SecondaryNode_Sub1_Sub13(this.aClass19_Sub2_42, 6402, this.anInt7128, this.anInt7127, this.aClass19_Sub2_42.anInt2272);
			}
			if (this.aBoolean673) {
				...
				this.aClass4_Sub1_Sub13_2 = new SecondaryNode_Sub1_Sub13(this.aClass19_Sub2_42, 6402, this.anInt7128, this.anInt7127);
			}
		...
		if (this.aBoolean674) {
			...
			if (this.aClass150_6 != null) {
				this.aClass4_Sub1_Sub13_1 = new SecondaryNode_Sub1_Sub13(this.aClass19_Sub2_42, this.anInt7138, this.anInt7128, this.anInt7127, this.aClass19_Sub2_42.anInt2272);
			}
	...
	public boolean method5530(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3) {
		...
		if (this.anInt7128 != arg1 || arg3 != this.anInt7127) {
			this.anInt7127 = arg3;
			this.anInt7128 = arg1;
			for (@Pc(49) Node local49 = this.aLinkedList_50.tail(); local49 != this.aLinkedList_50.sentinelNode; local49 = local49.previous) {
	...
	public void method5532() {
		...
		@Pc(117) Node_Sub10 local117;
		for (@Pc(109) Node_Sub10 local109 = (Node_Sub10) this.aLinkedList_50.tail(); local109 != null; local109 = local117) {
