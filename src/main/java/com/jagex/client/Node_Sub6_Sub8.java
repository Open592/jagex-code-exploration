...
public final class Node_Sub6_Sub8 extends Node_Sub6 {
  ...
  public int[][] method5514(@OriginalArg(1) int arg0) {
    ...
    if (super.aClass153_41.aBoolean437) {
      @Pc(23)
      int local23 = Static80.anInt1616;
      @Pc(25)
      int local25 = Static262.anInt4939;
      @Pc(29)
      int[][] local29 = new int[local25][local23];
      @Pc(34)
      int[][][] local34 = super.aClass153_41.method3680();
      this.method1699(local29);
      for (@Pc(40) int local40 = 0; local40 < Static262.anInt4939; local40++) {
        @Pc(46)
        int[] local46 = local29[local40];
        @Pc(50)
        int[][] local50 = local34[local40];
        @Pc(54)
        int[] local54 = local50[0];
        @Pc(58)
        int[] local58 = local50[1];
        @Pc(62)
        int[] local62 = local50[2];
        for (@Pc(64) int local64 = 0; local64 < Static80.anInt1616; local64++) {
          @Pc(70)
          int local70 = local46[local64];
  ...
  private void method1699(@OriginalArg(0) int[][] arg0) {
    @Pc(11)
    int local11 = Static80.anInt1616;
    @Pc(13)
    int local13 = Static262.anInt4939;
    ...
    for (@Pc(27) int local27 = 0; local27 < this.aClass27Array1.length; local27++) {
      @Pc(34)
      Class27 local34 = this.aClass27Array1[local27];
      @Pc(37)
      int local37 = local34.anInt5155;
      @Pc(40)
      int local40 = local34.anInt5152;
      if (local37 < 0) {
        if (local40 >= 0) {
  ...
  public void method5518(@OriginalArg(1) int arg0, @OriginalArg(2) Packet arg1) {
    if (arg0 == 0) {
      this.aClass27Array1 = new Class27[arg1.g1()];
