...
public final class Node_Sub15_Sub3 extends Node_Sub15 {
  ...
  public Node_Sub15_Sub3(
      @OriginalArg(0) Node_Sub4_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
  ...
  private int method4452(
    ...
    do {
      if (this.anInt5712 <= 0) {
        if (this.anInt5716 == -256 && (this.anInt5707 & 0xFF) == 0) {
          if (Static422.aBoolean649) {
            return Static462.method4453(
                ((Node_Sub4_Sub1) super.aClass4_Sub4_5).aByteArray48,
                arg0,
                this.anInt5707,
                arg1,
                this.anInt5717,
      ...
      @Pc(5)
      int local5 = arg1 + this.anInt5712;
      if (local5 > arg3) {
        local5 = arg3;
      }
      this.anInt5712 += arg1;
  ...
  public synchronized void method4861(@OriginalArg(0) int arg0) {
    ...
    @Pc(71)
    Node_Sub4_Sub1 local71 = (Node_Sub4_Sub1) super.aClass4_Sub4_5;
    @Pc(76)
    int local76 = this.anInt5706 << 8;
    @Pc(81)
    int local81 = this.anInt5713 << 8;
    @Pc(87)
    int local87 = local71.aByteArray48.length << 8;
    @Pc(91)
    int local91 = local81 - local76;
    if (local91 <= 0) {
      this.anInt5709 = 0;
    }
    if (this.anInt5707 < 0) {
  ...
  public synchronized void method4855(
    ...
    @Pc(13)
    Node_Sub4_Sub1 local13 = (Node_Sub4_Sub1) super.aClass4_Sub4_5;
    @Pc(18)
    int local18 = this.anInt5706 << 8;
    @Pc(23)
    int local23 = this.anInt5713 << 8;
    @Pc(29)
    int local29 = local13.aByteArray48.length << 8;
    @Pc(33)
    int local33 = local23 - local18;
    if (local33 <= 0) {
      this.anInt5709 = 0;
    }
    @Pc(40)
    ...
    if (this.anInt5709 >= 0) {
        ...
        if (this.aBoolean516) {
          label130:
          {
            if (this.anInt5716 < 0) {
              local40 =
                  this.method4452(
                      arg0, arg1, local18, local44, local13.aByteArray48[this.anInt5706]);
            ...
            do {
              local40 =
                  this.method4479(
                      arg0, local40, local23, local44, local13.aByteArray48[this.anInt5713 - 1]);
              ...
              local40 =
                  this.method4452(
                      arg0, local40, local18, local44, local13.aByteArray48[this.anInt5706]);
              if (this.anInt5707 >= local18) {
                return;
              }
              this.anInt5707 = local18 + local18 - this.anInt5707 - 1;
          ...
          if (this.anInt5716 < 0) {
            while (true) {
              local40 =
                  this.method4452(
                      arg0, local40, local18, local44, local13.aByteArray48[this.anInt5713 - 1]);
              if (this.anInt5707 >= local18) {
                return;
              }
            ...
            while (true) {
              local40 =
                  this.method4479(
                      arg0, local40, local23, local44, local13.aByteArray48[this.anInt5706]);
              if (this.anInt5707 < local23) {
                return;
              }
      ...
      if (this.anInt5716 < 0) {
        local40 =
            this.method4452(arg0, arg1, local18, local44, local13.aByteArray48[this.anInt5706]);
        if (this.anInt5707 >= local18) {
          return;
        }
        this.anInt5707 = local18 + local18 - this.anInt5707 - 1;
      ...
      while (true) {
        ...
        this.anInt5716 = -this.anInt5716;
        local40 =
            this.method4452(arg0, local40, local18, local44, local13.aByteArray48[this.anInt5706]);
        if (this.anInt5707 >= local18) {
          return;
        }
        this.anInt5707 = local18 + local18 - this.anInt5707 - 1;
      ...
      while (true) {
        local40 =
            this.method4479(arg0, local40, local23, local44, local13.aByteArray48[this.anInt5706]);
        if (this.anInt5707 < local23) {
          return;
        }
  ...
  public boolean method4462() {
    return this.anInt5707 < 0
        || this.anInt5707 >= ((Node_Sub4_Sub1) super.aClass4_Sub4_5).aByteArray48.length << 8;
  }
  ...
  public int method4856() {
    @Pc(6)
    int local6 = this.anInt5708 * 3 >> 6;
    local6 = (local6 ^ local6 >> 31) + (local6 >>> 31);
    if (this.anInt5709 == 0) {
      local6 -=
          local6
              * this.anInt5707
              / (((Node_Sub4_Sub1) super.aClass4_Sub4_5).aByteArray48.length << 8);
    } else if (this.anInt5709 >= 0) {
      local6 -=
          local6 * this.anInt5706 / ((Node_Sub4_Sub1) super.aClass4_Sub4_5).aByteArray48.length;
    }
  ...
  public synchronized void method4473(@OriginalArg(0) int arg0) {
    @Pc(7)
    int local7 = ((Node_Sub4_Sub1) super.aClass4_Sub4_5).aByteArray48.length << 8;
    if (arg0 < -1) {
      arg0 = -1;
    }
    if (arg0 > local7) {
  ...
  @OriginalMember(owner = "client!qo", name = "a", descriptor = "(III)V")
  public synchronized void method4480(
      @OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
    if (arg0 == 0) {
    ...
    @Pc(10)
    int local10 = Static462.method4458(arg1, arg2);
    @Pc(14)
    int local14 = Static462.method4485(arg1, arg2);
    if (this.anInt5717 == local10 && this.anInt5718 == local14) {
      this.anInt5712 = 0;
      return;
    }
    @Pc(31)
    int local31 = arg1 - this.anInt5708;
