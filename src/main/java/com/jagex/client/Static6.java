...
public final class Static6 {
  ...
  @OriginalMember(
      owner = "client!ae",
      name = "a",
      descriptor = "(IILclient!t;IIILclient!ya;IIIIIZLclient!lp;I)Lclient!t;")
  public static Class110 method48(
      @OriginalArg(0) int arg0,
      @OriginalArg(1) int arg1,
      @OriginalArg(2) Class110 arg2,
      ...
      @OriginalArg(12) boolean arg11,
      @OriginalArg(13) Class138 arg12,
    ...
    @Pc(48)
    long local48 =
        ((long) arg5 << 48) + (long) ((arg13 << 24) + (arg8 + (arg7 << 16))) + ((long) arg3 << 32);
    @Pc(50)
    Class68 local50 = Static221.aClass68_24;
    @Pc(58)
    Class110 local58;
    ...
    if (local58 == null || arg6.method4269(local58.P(), local11) != 0) {
      ...
      @Pc(137)
      int[] local137 = new int[] {64, 96, 128};
      @Pc(156)
      Class122 local156 = new Class122(local98 * 3 + 1, -local98 + local98 * 2 * 3, 0);
      local163 = local156.method3040(0, 0, 0);
      @Pc(167)
      int[][] local167 = new int[3][local98];
      @Pc(181)
      int local181;
      @Pc(205)
      int local205;
      ...
      for (local175 = 0; local175 < 3; local175++) {
        ...
        @Pc(256)
        byte local256 = (byte) (arg13 * local179 + local181 * arg7 >> 8);
        @Pc(301)
        short local301 =
            (short)
                ((local179 * (arg5 & 0x7F) + local181 * (arg3 & 0x7F) & 0x7F00)
                        + (local179 * (arg5 & 0xFC00) + (arg3 & 0xFC00) * local181 & 0xFC0000)
                        + ((arg3 & 0x380) * local181 + local179 * (arg5 & 0x380) & 0x38000)
                    >> 8);
        for (local205 = 0; local205 < local98; local205++) {
          if (local175 == 0) {
            local156.method3047(
                ...
                (byte) -1,
                local163,
                local167[0][(local205 + 1) % local98],
                local301,
                (byte) 1,
                local256);
          } else {
            local156.method3047(
                local167[local175][(local205 + 1) % local98],
                (short) -1,
                (byte) -1,
                local167[local175 - 1][local205],
                local167[local175 - 1][(local205 + 1) % local98],
                local301,
                (byte) 1,
                local256);
            local156.method3047(
                local167[local175][local205],
                (short) -1,
                (byte) -1,
                local167[local175 - 1][local205],
                local167[local175][(local205 + 1) % local98],
      ...
      @Pc(424)
      Class68 local424 = Static221.aClass68_24;
      synchronized (Static221.aClass68_24) {
        Static221.aClass68_24.method1779(local48, local58);
      }
    }
    @Pc(443)
    int local443 = (arg8 << 6) - 1;
    @Pc(446)
    int local446 = -local443;
    @Pc(449)
    int local449 = -local443;
    @Pc(451)
    int local451 = local443;
    local163 = local443;
    if (arg11) {
    ...
    @Pc(539)
    SecondaryNode_Sub1_Sub17 local539 = null;
    if (arg12 != null) {
      @Pc(546)
      int local546 = arg12.anIntArray295[arg10];
  ...
  public static int method49(
      @OriginalArg(1) Class213 arg0,
    ...
    if (arg5 == 1) {
      ...
      local55 =
          Static234.method3499(arg2, arg12, arg6, arg1, arg0, arg4, arg11, arg3, arg5, arg8, arg13);
    }
    @Pc(89)
    int local89 = arg1 - 64;
    @Pc(93)
    int local93 = arg11 - 64;
    @Pc(95)
    int local95 = Static389.anInt6521;
    @Pc(97)
    int local97 = Static102.anInt2045;
    @Pc(105)
    int local105;
    @Pc(107)
    int local107;
    ...
    if (!local55) {
      ...
      for (local114 = arg2 - 10; local114 <= arg2 + 10; local114++) {
        for (@Pc(120) int local120 = arg4 - 10; local120 <= arg4 + 10; local120++) {
          @Pc(127)
          int local127 = local114 - local89;
          @Pc(132)
          int local132 = local120 - local93;
          if (local127 >= 0
              && local132 >= 0
              && local127 < 128
              && local132 < 128
              && Static14.anIntArrayArray1[local127][local132] < 100) {
            @Pc(161)
            int local161 = 0;
            if (local114 < arg2) {
            ...
            @Pc(232)
            int local232 = local161 * local161 + local193 * local193;
