...
public final class ha extends Class65 implements Interface4 {
  ...
  @OriginalMember(
      owner = "client!ha",
      name = "<init>",
      descriptor = "(Lclient!qa;Lclient!na;II[[I[[IIII)V")
  public ha(
  ...
  public void method4023(
    ...
    @Pc(26)
    int local26 = arg9.length;
    @Pc(31)
    int[] local31 = new int[local26 * 3];
    @Pc(36)
    int[] local36 = new int[local26 * 3];
    @Pc(41)
    int[] local41 = new int[local26 * 3];
    @Pc(46)
    int[] local46 = new int[local26 * 3];
    @Pc(51)
    int[] local51 = new int[local26 * 3];
    @Pc(60)
    int[] local60 = arg10 == null ? null : new int[local26 * 3];
    @Pc(69)
    int[] local69 = arg3 == null ? null : new int[local26 * 3];
    @Pc(78)
    int[] local78 = arg5 == null ? null : new int[local26 * 3];
    @Pc(80)
    int local80 = 0;
    for (@Pc(82) int local82 = 0; local82 < local26; local82++) {
      @Pc(87)
      int local87 = arg6[local82];
      @Pc(91)
      int local91 = arg7[local82];
      @Pc(95)
      int local95 = arg8[local82];
    ...
    if (local1 || local60 != null) {
      this.B(
          arg0, arg1, local31, local69, local36, local78, local41, local60, local46, local51, arg13,
          arg14, arg15, false);
    }
  }
  ...
  public void method4029(
    ...
    int local1 = 0;
    @Pc(7)
    float[] local7 = new float[this.aLinkedList_19.count()];
    for (@Pc(13) Node_Sub21 local13 = (Node_Sub21) this.aLinkedList_19.tail();
        local13 != null;
        local13 = (Node_Sub21) this.aLinkedList_19.previous()) {
  ...
  public native SecondaryNode_Sub1_Sub4 k(
      @OriginalArg(0) int arg0,
      @OriginalArg(1) int arg1,
