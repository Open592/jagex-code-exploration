...
public final class ha extends Class65 implements Interface4 {
	...
	public native void b(@OriginalArg(0) LinkedHashEntry_Sub1_Sub4 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public native void p(@OriginalArg(0) LinkedHashEntry_Sub1_Sub4 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public void method4029(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4) {
		...
		for (@Pc(13) LinkedHashEntry_Sub21 local13 = (LinkedHashEntry_Sub21) this.aClass183_19.method4140(); local13 != null; local13 = (LinkedHashEntry_Sub21) this.aClass183_19.method4144()) {
	...
	public native LinkedHashEntry_Sub1_Sub4 k(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) LinkedHashEntry_Sub1_Sub4 arg2);
}
