...
public final class Class9_Sub1 extends Class9 {
  ...
  public Class9_Sub1(@OriginalArg(0) Class19_Sub2 arg0, @OriginalArg(1) Class144 arg1) {
    ...
    if (this.aClass144_1.aClass6_Sub3_2 != null
  ...
  public void method5371(@OriginalArg(1) boolean arg0) {
    @Pc(8)
    Class6_Sub4 local8 = super.aClass19_Sub2_41.method1946();
    ...
    @Pc(51)
    long local51 = this.aClass210_1.aLong202;
    ...
    OpenGL.glUniform3fARB(
        OpenGL.glGetUniformLocationARB(local51, "sunDir"),
    ...
    OpenGL.glUniform4fARB(
        OpenGL.glGetUniformLocationARB(local51, "sunColour"),
        super.aClass19_Sub2_41.aFloat72,
        super.aClass19_Sub2_41.aFloat58,
        super.aClass19_Sub2_41.aFloat74,
        1.0F);
    OpenGL.glUniform1fARB(
        OpenGL.glGetUniformLocationARB(local51, "sunExponent"),
        Math.abs(super.aClass19_Sub2_41.aFloatArray19[1]) * 928.0F + 96.0F);
  ...
  public void method5370(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
    ...
    @Pc(12)
    int local12 = 0x1 << (arg0 & 0x3);
    @Pc(23)
    float local23 = (float) (0x1 << (arg0 >> 3 & 0x7)) / 32.0F;
    @Pc(27)
    int local27 = arg1 & 0xFFFF;
    @Pc(36)
    float local36 = (float) (arg1 >> 16 & 0x3) / 8.0F;
    @Pc(40)
    long local40 = this.aClass210_1.aLong202;
    OpenGL.glUniform1fARB(
        OpenGL.glGetUniformLocationARB(local40, "time"),
        (float) (super.aClass19_Sub2_41.anInt2274 * local12 % 40000) / 40000.0F);
    OpenGL.glUniform1fARB(OpenGL.glGetUniformLocationARB(local40, "scale"), local23);
    OpenGL.glUniform1fARB(
        OpenGL.glGetUniformLocationARB(local40, "breakWaterDepth"), (float) local27);
