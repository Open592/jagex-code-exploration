...
public final class Class99_Sub1_Sub1 extends Class99_Sub1 {
  ...
  public boolean method2666(
      @OriginalArg(0) Class6_Sub4 arg0,
      @OriginalArg(1) float arg1,
      @OriginalArg(2) Class6_Sub4 arg2) {
    @Pc(7)
    boolean local7 = true;
    @Pc(11)
    Class150 local11 = this.aClass19_Sub2_18.aClass150_2;
    @Pc(15)
    Class150 local15 = this.aClass19_Sub2_18.aClass150_1;
    if (arg2.anInt3257 != this.aClass19_Sub2_18.aClass6_Sub1_2.anInt5466
        || this.aClass19_Sub2_18.aClass6_Sub1_2.anInt5458 != arg2.anInt3257) {
      this.aClass19_Sub2_18.aClass6_Sub1_2 =
          new Class6_Sub1(this.aClass19_Sub2_18, 3553, 6408, arg2.anInt3257, arg2.anInt3257);
    }
    if (this.aClass19_Sub2_18.aClass6_Sub1_1.anInt5466 != arg0.anInt3257
        || this.aClass19_Sub2_18.aClass6_Sub1_1.anInt5458 != arg0.anInt3257) {
      this.aClass19_Sub2_18.aClass6_Sub1_1 =
          new Class6_Sub1(this.aClass19_Sub2_18, 3553, 6408, arg0.anInt3257, arg0.anInt3257);
    }
    ...
    this.aClass19_Sub2_18.method1936(0);
    OpenGL.glPopAttrib();
    this.aClass19_Sub2_18.OA(
        Static266.anIntArray319[0],
        Static266.anIntArray319[1],
        Static266.anIntArray319[2],
        Static266.anIntArray319[3]);
    if (local7) {
