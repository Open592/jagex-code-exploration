...
public final class Class3_Sub6 extends Class3 {
  ...
  @OriginalMember(
      owner = "client!mo",
      name = "<init>",
      descriptor = "(Lclient!ya;Lclient!bu;Lclient!ao;J)V")
  public Class3_Sub6(
      @OriginalArg(0) Class19 arg0,
      @OriginalArg(1) Class29 arg1,
      @OriginalArg(2) Class3_Sub2 arg2,
  ...
  public void method3630() {
    ...
    if (this.anInt4638 == this.anInt4634
        && this.anInt4634 == this.anInt4630
        && this.anInt4637 == this.anInt4633
        && this.anInt4637 == this.anInt4644
        && this.anInt4651 == this.anInt4635
        && this.anInt4645 == this.anInt4651) {
      this.aBoolean426 = true;
      return;
    }
    this.aBoolean426 = false;
    @Pc(122)
    int local122 = (this.anInt4630 + this.anInt4634 + this.anInt4638) / 3;
    @Pc(134)
    int local134 = (this.anInt4644 + this.anInt4633 + this.anInt4637) / 3;
    @Pc(146)
    int local146 = (this.anInt4645 + this.anInt4635 + this.anInt4651) / 3;
    ...
    @Pc(182)
    int local182 = this.anInt4634 - this.anInt4638;
    @Pc(189)
    int local189 = this.anInt4637 - this.anInt4633;
    @Pc(196)
    int local196 = this.anInt4651 - this.anInt4635;
    @Pc(202)
    int local202 = this.anInt4630 - this.anInt4638;
    @Pc(208)
    int local208 = this.anInt4644 - this.anInt4633;
    @Pc(215)
    int local215 = this.anInt4645 - this.anInt4635;
    ...
    while (this.anInt4648 > 32767
        || this.anInt4628 > 32767
        || this.anInt4655 > 32767
        || this.anInt4648 < -32767
        || this.anInt4628 < -32767
        || this.anInt4655 < -32767) {
      this.anInt4648 >>= 0x1;
      this.anInt4628 >>= 0x1;
    ...
    int local317 =
        (int)
            Math.sqrt(
                (double)
                    (this.anInt4655 * this.anInt4655
                        + this.anInt4648 * this.anInt4648
                        + this.anInt4628 * this.anInt4628));
    if (local317 <= 0) {
      local317 = 1;
    }
    ...
    @Pc(370)
    int local370 =
        (int) (Math.atan2((double) this.anInt4655, (double) this.anInt4648) * 2607.5945876176133D);
    @Pc(392)
    int local392 =
        (int)
            (Math.atan2(
                    (double) this.anInt4628,
                    Math.sqrt(
                        (double)
  ...
  public void method3632(
    ...
    if (arg2) {
      ...
      if (this.anInt4642 > 63) {
        ...
        for (@Pc(151) int local151 = 0; local151 < local40; local151++) {
          ...
          local210 =
              this.anInt4634 * local196 + this.anInt4638 * local188 + local200 * this.anInt4630
                  >> 16;
          local218 =
              local200 * this.anInt4644 + this.anInt4637 * local196 + local188 * this.anInt4633
                  >> 16;
          local222 =
              this.anInt4651 * local196 + this.anInt4635 * local188 + this.anInt4645 * local200
                  >> 16;
          @Pc(344)
          int local344 =
              (int)
          ...
          if (Static305.anInt5385 == Static357.anInt6240) {
            ...
            Class3_Sub1_Sub1_Sub1 local547 =
                Static452.aClass3_Sub1_Sub1_Sub1Array2[Static357.anInt6240];
    ...
    this.anInt4650 = 0;
    for (@Pc(586)
        Class3_Sub1_Sub1_Sub1 local586 = (Class3_Sub1_Sub1_Sub1) this.aClass84_6.method2312();
        local586 != null;
        local586 = (Class3_Sub1_Sub1_Sub1) this.aClass84_6.method2309()) {
  ...
  public void method3635(@OriginalArg(1) long arg0) {
    for (@Pc(21)
        Class3_Sub1_Sub1_Sub1 local21 = (Class3_Sub1_Sub1_Sub1) this.aClass84_6.method2312();
        local21 != null;
        local21 = (Class3_Sub1_Sub1_Sub1) this.aClass84_6.method2309()) {
