...
public final class NativeHeap {
  ...
  @OriginalMember(
      owner = "client!jaggl/memory/NativeHeap",
      name = "deallocateHeap",
      descriptor = "()V")
  ...
  @OriginalMember(
      owner = "client!jaggl/memory/NativeHeap",
      name = "a",
      descriptor = "(I)Lclient!jaggl/memory/NativeBuffer;")
  ...
  public synchronized native void put(
  ...
  private synchronized native void get(
      @OriginalArg(0) int arg0,
      @OriginalArg(1) byte[] arg1,
      @OriginalArg(2) int arg2,
      @OriginalArg(3) int arg3);
