...
public final class Static386 {
  ...
  public static final LocalizedString A_LOCALIZED_STRING___80 =
      new LocalizedString(
  ...
  public static void method3233(
    ...
    Static3.aClass4_Sub12_Sub1_5.p2(arg3);
  ...
  @OriginalMember(
      owner = "client!tm",
      name = "a",
      descriptor = "(BLjava/awt/Canvas;ILclient!et;Lclient!ga;)Lclient!ya;")
  public static Class19 method3234(
      @OriginalArg(1) Canvas arg0,
  ...
  public static Class27_Sub4 method3235(@OriginalArg(1) Packet arg0) {
    return new Class27_Sub4(
        arg0.g2s(), arg0.g2s(), arg0.g2s(), arg0.g2s(), arg0.g3(), arg0.g3(), arg0.g1());
  }
  ...
  public static void method3236(
    ...
    @Pc(19)
    int local19 = Static332.method4519(Static168.anInt3256, arg3, Static376.anInt6287);
    @Pc(25)
    int local25 = Static332.method4519(Static168.anInt3256, arg6, Static376.anInt6287);
    @Pc(31)
    int local31 = Static332.method4519(Static208.anInt2656, arg0, Static354.anInt6186);
    @Pc(37)
    int local37 = Static332.method4519(Static208.anInt2656, arg5, Static354.anInt6186);
    @Pc(46)
    int local46 = Static332.method4519(Static168.anInt3256, arg3 + arg2, Static376.anInt6287);
    @Pc(55)
    int local55 = Static332.method4519(Static168.anInt3256, arg6 - arg2, Static376.anInt6287);
    ...
    @Pc(99)
    int local99 = Static332.method4519(Static208.anInt2656, arg0 + arg2, Static354.anInt6186);
    @Pc(107)
    int local107 = Static332.method4519(Static208.anInt2656, arg5 - arg2, Static354.anInt6186);
    for (@Pc(109) int local109 = local46; local109 <= local55; local109++) {
      @Pc(115)
      int[] local115 = Static96.anIntArrayArray21[local109];
