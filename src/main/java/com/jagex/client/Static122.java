    ...
    for (@Pc(12) int local12 = 0; local12 < arg1.length; local12++) {
      ...
      if (local18 != null && arg0 == local18.anInt6850 && !Static53.method895(local18)) {
        if (local18.anInt6840 == 0) {
          ...
          @Pc(56)
          Node_Sub43 local56 = (Node_Sub43) Static325.aHashMap_29.get((long) local18.anInt6809);
          if (local56 != null) {
        ...
        if (local18.anInt6840 == 6 && local18.anInt6788 != -1) {
          @Pc(77)
          Class138 local77 = Static182.aClass55_1.method1397(local18.anInt6788);
          if (local77 != null) {
