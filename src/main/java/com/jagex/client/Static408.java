...
public final class Static408 {
  ...
  public static final LocalizedString A_LOCALIZED_STRING___139 =
      new LocalizedString("flash2:", "blinken2:", "clignotant2:", "flash2:");

  @OriginalMember(owner = "client!uo", name = "a", descriptor = "(I[IILclient!fd;[IB)Lclient!wk;")
  public static Class145_Sub1 method5256(
      @OriginalArg(0) int arg0,
      @OriginalArg(1) int[] arg1,
      @OriginalArg(2) int arg2,
      @OriginalArg(3) Class19_Sub2 arg3,
      @OriginalArg(4) int[] arg4) {
    @Pc(10)
    byte[] local10 = new byte[arg2 * arg0];
    for (@Pc(12) int local12 = 0; local12 < arg0; local12++) {
      @Pc(22)
      int local22 = arg1[local12] + local12 * arg2;
  ...
  public static void method5258(
      @OriginalArg(0) int arg0, @OriginalArg(1) Js5 arg1, @OriginalArg(6) int arg2) {
