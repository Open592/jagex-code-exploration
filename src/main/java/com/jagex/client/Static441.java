...
public final class Static441 {
  ...
  public static void waitForSystemEventQueueToDrain(
      @OriginalArg(0) SignLink signLink, @OriginalArg(2) Object arg1) {
  ...
  public static int method5567(
    ...
    @Pc(12)
    float local12 = arg0 < 0.0F ? -arg0 : arg0;
    @Pc(21)
    float local21 = arg2 < 0.0F ? -arg2 : arg2;
    @Pc(35)
    float local35 = arg1 < 0.0F ? -arg1 : arg1;
  ...
  public static void method5568(@OriginalArg(1) String arg0) {
    ...
    @Pc(14)
    String[] local14 = Static113.method2058(arg0, '\n');
  ...
  public static void method5570(
    ...
    int local19 = -1;
    @Pc(27)
    int local27 = Static332.method4519(Static208.anInt2656, arg2 + arg3, Static354.anInt6186);
    @Pc(36)
    int local36 = Static332.method4519(Static208.anInt2656, arg3 - arg2, Static354.anInt6186);
