...
public final class Class59 {
  ...
  public Class6_Sub1 method1549(@OriginalArg(0) int arg0) {
    @Pc(17)
    Object local17 = this.aClass68_7.method1787((long) arg0);
    if (local17 != null) {
      return (Class6_Sub1) local17;
    } else if (this.anInterface7_4.method2392(arg0)) {
      @Pc(36)
      Class251 local36 = this.anInterface7_4.method2396(arg0);
      @Pc(45)
      int local45 = local36.aBoolean637 ? 64 : this.aClass19_Sub2_12.anInt2269;
      @Pc(80)
      Class6_Sub1 local80;
      if (local36.aBoolean638 && this.aClass19_Sub2_12.method4301()) {
        @Pc(62)
        float[] local62 = this.anInterface7_4.method2394(0.7F, arg0, local45, local45);
        local80 =
            new Class6_Sub1(
                this.aClass19_Sub2_12,
                3553,
                34842,
                local45,
                local45,
