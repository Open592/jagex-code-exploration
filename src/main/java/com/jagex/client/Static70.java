...
public final class Static70 {
  ...
  public static final LocalizedString A_LOCALIZED_STRING___31 =
      new LocalizedString(" more options", " weitere Optionen", " autres options", " mais opções");
  ...
  public static final short[][] aShortArrayArray3 =
      new short[][] {
        {
  ...
  public static void method1340(@OriginalArg(0) long arg0, @OriginalArg(1) Class19 arg1) {
    ...
    @Pc(18)
    long local18 = MonotonicClock.getCurrentTimeInMilliseconds();
    for (@Pc(23) Class3_Sub2 local23 = (Class3_Sub2) Static384.aClass84_8.method2312();
        local23 != null;
        local23 = (Class3_Sub2) Static384.aClass84_8.method2309()) {
    ...
    if (Static30.aBoolean53 && arg0 % 100L == 0L) {
      System.out.println(
          "Particle system count: "
              + Static384.aClass84_8.method2307()
              + ", running: "
              + Static275.anInt5137
              + ". Particles: "
              + Static435.anInt7099
              + ". Time taken: "
              + (MonotonicClock.getCurrentTimeInMilliseconds() - local18)
              + "ms");
    }
  }
}
