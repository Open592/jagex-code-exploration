...
public final class Node_Sub6_Sub13 extends Node_Sub6 {
  ...
  public void method5518(@OriginalArg(1) int arg0, @OriginalArg(2) Packet arg1) {
    if (arg0 == 0) {
      this.anInt3050 = arg1.g2();
    } else if (arg0 == 1) {
      this.anInt3051 = arg1.g2();
    } else if (arg0 == 2) {
  ...
  public int[][] method5514(@OriginalArg(1) int arg0) {
    ...
    if (super.aClass153_41.aBoolean437) {
      ...
      for (@Pc(47) int local47 = 0; local47 < Static80.anInt1616; local47++) {
        @Pc(53)
        int local53 = local25[local47];
        @Pc(57)
        int local57 = local29[local47];
        @Pc(61)
        int local61 = local33[local47];
