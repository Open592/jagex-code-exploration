...
public final class Class16_Sub1_Sub3 extends Class16_Sub1 {
  ...
  public Class16_Sub1_Sub3(
    ...
    super(
        arg1,
        arg2,
        Static13.method135(arg2, arg1, arg3) - arg4,
        arg3,
        arg2 >> 7,
        arg2 >> 7,
        arg3 >> 7,
    ...
    @Pc(78)
    int local78 = Static352.aClass194_2.method4421(this.anInt2591).anInt5002;
    if (local78 == -1) {
  ...
  public Class3_Sub3 method5339(@OriginalArg(0) Class19 arg0) {
    @Pc(9)
    Class110 local9 = this.method2196(2048, arg0);
    if (local9 == null) {
      return null;
    }
    @Pc(16)
    Class31 local16 = arg0.method4289();
    ...
    if (this.aClass3_Sub2_3 == null) {
      ...
      @Pc(49)
      Class146 local49 = this.aClass3_Sub2_3.method171();
  ...
  public void method5335(@OriginalArg(0) Class19 arg0) {
    @Pc(9)
    Class110 local9 = this.method2196(0, arg0);
    if (local9 == null) {
      return;
    }
    @Pc(15)
    Class31 local15 = arg0.method4289();
  ...
  private void method2195(@OriginalArg(1) Class110 arg0, @OriginalArg(2) Class19 arg1) {
    @Pc(11)
    Class29[] local11 = arg0.method4881();
    @Pc(14)
    Class179[] local14 = arg0.method4885();
    if ((this.aClass3_Sub2_3 == null || this.aClass3_Sub2_3.aBoolean24)
        && (local11 != null || local14 != null)) {
      this.aClass3_Sub2_3 = new Class3_Sub2(client.gameLogicStepCount);
    }
    if (this.aClass3_Sub2_3 != null) {
      this.aClass3_Sub2_3.method169(arg1, (long) client.gameLogicStepCount, local11, local14);
      this.aClass3_Sub2_3.method174(
  ...
  private Class110 method2196(@OriginalArg(0) int arg0, @OriginalArg(1) Class19 arg1) {
    @Pc(15)
    Class161 local15 = Static352.aClass194_2.method4421(this.anInt2591);
    return local15.method3830(
        this.anInt2576, this.anInt2596, Static182.aClass55_1, this.anInt2579, arg0, arg1);
  }
  ...
  public void method2197(
    ...
    if (!this.aBoolean239) {
      ...
      @Pc(20)
      double local20 = (double) (arg3 - super.anInt6892);
      @Pc(29)
      double local29 = Math.sqrt(local13 * local13 + local20 * local20);
      ...
      if (this.aBoolean240) {
        this.aDouble4 =
            Static13.method135((int) this.aDouble2, super.aByte82, (int) this.aDouble7)
                - this.anInt2602;
      } else {
    ...
    if (this.anInt2589 == -1) {
      ...
      this.aDouble3 =
          ((double) arg2 - this.aDouble4 - local13 * this.aDouble9) * 2.0D / (local13 * local13);
    }
  }
  ...
  public void method2198(@OriginalArg(1) int arg0) {
    ...
    if (this.aBoolean240) {
      ...
      this.aDouble4 +=
          (double) arg0 * (double) arg0 * this.aDouble3 * 0.5D + this.aDouble9 * (double) arg0;
      this.aDouble9 += this.aDouble3 * (double) arg0;
    }
    this.anInt2592 =
        (int) (Math.atan2(this.aDouble5, this.aDouble8) * 2607.5945876176133D) + 8192 & 0x3FFF;
    this.anInt2580 =
        (int) (Math.atan2(this.aDouble9, this.aDouble6) * 2607.5945876176133D) & 0x3FFF;
