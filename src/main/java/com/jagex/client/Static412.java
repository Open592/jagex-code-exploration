...
public final class Static412 {
	...
	public static final LocalizedString A_LOCALIZED_STRING___142 = new LocalizedString("Continue", "Weiter", "Continuer", "Continuar");
	...
	public static void method5294() {
		for (@Pc(18) Node_Sub23 local18 = (Node_Sub23) Static298.A_LINKED_LIST___38.tail(); local18 != null; local18 = (Node_Sub23) Static298.A_LINKED_LIST___38.previous()) {
			if (Static202.aClass164ArrayArrayArray5 == null) {
				...
				if (client.gameLogicStepCount >= local18.anInt3202) {
					...
					if (local44 == 0) {
						...
						local128 = Static36.method648(local18.anInt3196, local18.anInt3189, local18.anInt3193, Interface6.class);
						if (local128 instanceof Class16_Sub1_Sub1) {
							Static194.method3046(local18.anInt3196, local18.anInt3189, local18.anInt3193, Interface6.class);
