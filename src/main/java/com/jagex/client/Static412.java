...
public final class Static412 {
  ...
  public static final LocalizedString A_LOCALIZED_STRING___142 =
      new LocalizedString("Continue", "Weiter", "Continuer", "Continuar");
  ...
  public static void method5292(
    ...
    if (ClientPreferences.preferences.anInt3448 != 0
        ...
        && arg1 != -1) {
      Static86.aClass269Array1[Static109.anInt6886++] =
          new Class269((byte) 1, arg1, arg3, arg2, arg0, arg4);
    }
  }

  @OriginalMember(owner = "client!ut", name = "b", descriptor = "(B)V")
  public static void method5294() {
    for (@Pc(18) Node_Sub23 local18 = (Node_Sub23) Static298.A_LINKED_LIST___38.tail();
        local18 != null;
        local18 = (Node_Sub23) Static298.A_LINKED_LIST___38.previous()) {
      if (Static202.aClass164ArrayArrayArray5 == null) {
        ...
        int local44;
        @Pc(236)
        Class16_Sub4 local236;
        @Pc(255)
        Class16_Sub4_Sub1 local255;
        @Pc(128)
        Class16_Sub1 local128;
        @Pc(62)
        Class16_Sub2 local62;
        @Pc(273)
        Class16_Sub5 local273;
        @Pc(98)
        Class16_Sub2_Sub2 local98;
        @Pc(309)
        Class16_Sub5_Sub1 local309;
        if (client.gameLogicStepCount >= local18.anInt3202) {
          local44 = Static201.anIntArray410[local18.anInt3195];
          if (local44 == 0) {
            local273 =
                Static227.method3449(local18.anInt3196, local18.anInt3189, local18.anInt3193);
            ...
            local128 =
                Static36.method648(
                    local18.anInt3196, local18.anInt3189, local18.anInt3193, Interface6.class);
            if (local128 instanceof Class16_Sub1_Sub1) {
              Static194.method3046(
                  local18.anInt3196, local18.anInt3189, local18.anInt3193, Interface6.class);
              @Pc(417)
              Class16_Sub1_Sub1 local417 = (Class16_Sub1_Sub1) local128;
            ...
            local236 =
                Static117.method2096(local18.anInt3196, local18.anInt3189, local18.anInt3193);
            if (local236 instanceof Class16_Sub4_Sub1) {
              ...
              if (local255.aClass16_Sub4_1 != null) {
                Static379.method5008(
                    local18.anInt3196,
                    local18.anInt3189,
                    local18.anInt3193,
                    local255.aClass16_Sub4_1);
              }
            }
          }
          local18.popSelf();
          ...
          if (local44 == 0) {
            ...
            if (local273 instanceof Class16_Sub5_Sub1) {
              local18.popSelf();
            } else if (Static136.method2344(local18.anInt3196, local18.anInt3189, local18.anInt3193)
                == null) {
              local309 =
                  new Class16_Sub5_Sub1(
                      local18.anInt3195,
                      local18.anInt3190,
                      local18.anInt3198,
                      local18.anInt3188,
                      ...
                      local273);
              Static18.method181(
                  local18.anInt3196, local18.anInt3189, local18.anInt3193, local309, null);
            } else {
              local18.popSelf();
            }
          } else if (local44 == 1) {
            ...
            if (local62 instanceof Class16_Sub2_Sub2) {
              local18.popSelf();
            } else if (Static381.method5023(local18.anInt3196, local18.anInt3189, local18.anInt3193)
                == null) {
              local98 =
                  new Class16_Sub2_Sub2(
                      local18.anInt3195,
                      local18.anInt3190,
                      local18.anInt3198,
                      local18.anInt3188,
                      ...
                      local62);
              Static73.method1356(
                  local18.anInt3196, local18.anInt3189, local18.anInt3193, local98, null);
            } else {
              local18.popSelf();
            }
          } else if (local44 == 2) {
            ...
            if (local128 instanceof Class16_Sub1_Sub1) {
              ...
              Static194.method3046(
                  local18.anInt3196, local18.anInt3189, local18.anInt3193, Interface6.class);
              @Pc(157)
              Class202 local157 = Static267.aClass262_2.method5560(local18.anInt3194);
              @Pc(175)
              int local175;
              @Pc(172)
              int local172;
              ...
              @Pc(217)
              Class16_Sub1_Sub1 local217 =
                  new Class16_Sub1_Sub1(
                      local18.anInt3195,
                      local18.anInt3190,
                      local18.anInt3196,
                      local18.anInt3198,
                      ...
                      local18.anInt3203,
                      local18.anInt3189,
                      local175 + local18.anInt3189 - 1,
                      local18.anInt3193,
                      local18.anInt3193 + local172 - 1,
                      local128);
            ...
            if (local236 instanceof Class16_Sub4_Sub1) {
              ...
              local255 =
                  new Class16_Sub4_Sub1(
                      local18.anInt3198, local18.anInt3188, local18.anInt3203, local236);
              Static379.method5008(
                  local18.anInt3196, local18.anInt3189, local18.anInt3193, local255);
            }
          }
        }
      }
  ...
  public static boolean method5296(
    ...
    int local42 = 0;
    @Pc(45)
    int local45 = local36 + 1;
    Static416.anIntArray526[0] = arg8;
    @Pc(50)
    int[][] local50 = arg4.anIntArrayArray48;
    while (local45 != local42) {
      local9 = Static416.anIntArray526[local42];
      local7 = Static129.anIntArray182[local42];
      @Pc(65)
      int local65 = local9 - local28;
      local42 = local42 + 1 & 0xFFF;
      @Pc(77)
      int local77 = local7 - arg4.anInt6230;
      @Pc(82)
      int local82 = local7 - local18;
      @Pc(88)
      int local88 = local9 - arg4.anInt6235;
      if (arg2 == -4) {
      ...
      @Pc(245)
      int local245 = Static14.anIntArrayArray1[local82][local65] + 1;
      if (local82 > 0
          && Static159.anIntArrayArray30[local82 - 1][local65] == 0
          && (local50[local77 - 1][local88] & 0x42240000) == 0) {
      ...
      if (local82 < 127
          && Static159.anIntArrayArray30[local82 + 1][local65] == 0
          && (local50[local77 + 1][local88] & 0x60240000) == 0) {
        Static129.anIntArray182[local45] = local7 + 1;
        Static416.anIntArray526[local45] = local9;
        local45 = local45 + 1 & 0xFFF;
      ...
      if (local65 > 0
          && Static159.anIntArrayArray30[local82][local65 - 1] == 0
          && (local50[local77][local88 - 1] & 0x40A40000) == 0) {
      ...
      if (local65 < 127
          && Static159.anIntArrayArray30[local82][local65 + 1] == 0
          && (local50[local77][local88 + 1] & 0x48240000) == 0) {
        Static129.anIntArray182[local45] = local7;
        Static416.anIntArray526[local45] = local9 + 1;
      ...
      if (local82 > 0
          && local65 > 0
          && Static159.anIntArrayArray30[local82 - 1][local65 - 1] == 0
          && (local50[local77 - 1][local88 - 1] & 0x43A40000) == 0
          && (local50[local77 - 1][local88] & 0x42240000) == 0
          && (local50[local77][local88 - 1] & 0x40A40000) == 0) {
        Static129.anIntArray182[local45] = local7 - 1;
        Static416.anIntArray526[local45] = local9 - 1;
      ...
      if (local82 < 127
          && local65 > 0
          && Static159.anIntArrayArray30[local82 + 1][local65 - 1] == 0
          && (local50[local77 + 1][local88 - 1] & 0x60E40000) == 0
          && (local50[local77 + 1][local88] & 0x60240000) == 0
          && (local50[local77][local88 - 1] & 0x40A40000) == 0) {
        Static129.anIntArray182[local45] = local7 + 1;
        Static416.anIntArray526[local45] = local9 - 1;
      ...
      if (local82 > 0
          && local65 < 127
          && Static159.anIntArrayArray30[local82 - 1][local65 + 1] == 0
          && (local50[local77 - 1][local88 + 1] & 0x4E240000) == 0
          && (local50[local77 - 1][local88] & 0x42240000) == 0
          && (local50[local77][local88 + 1] & 0x48240000) == 0) {
        Static129.anIntArray182[local45] = local7 - 1;
        Static416.anIntArray526[local45] = local9 + 1;
      ...
      if (local82 < 127
          && local65 < 127
          && Static159.anIntArrayArray30[local82 + 1][local65 + 1] == 0
          && (local50[local77 + 1][local88 + 1] & 0x78240000) == 0
          && (local50[local77 + 1][local88] & 0x60240000) == 0
          && (local50[local77][local88 + 1] & 0x48240000) == 0) {
        Static129.anIntArray182[local45] = local7 + 1;
        Static416.anIntArray526[local45] = local9 + 1;
