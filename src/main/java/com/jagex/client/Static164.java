...
public final class Static164 {
	...
	public static void method3582() {
		...
		@Pc(28) ListNode_Sub5 local28 = (ListNode_Sub5) Static413.aClass183_47.method4140();
		if (local28 != null) {
	...
	public static ListNode_Sub22 method3584(@OriginalArg(0) Canvas arg0) {
		try {
			@Pc(6) Class local6 = Class.forName("Class4_Sub22_Sub1");
			@Pc(10) ListNode_Sub22 local10 = (ListNode_Sub22) local6.getDeclaredConstructor().newInstance();
			local10.method4606(arg0);
			return local10;
		} catch (@Pc(22) Throwable local22) {
			@Pc(26) ListNode_Sub22_Sub2 local26 = new ListNode_Sub22_Sub2();
	...
	public static void method3585(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
		@Pc(8) ListNode_Sub1_Sub11 local8 = Static405.method5222(arg1, 14);
		local8.method2604();
