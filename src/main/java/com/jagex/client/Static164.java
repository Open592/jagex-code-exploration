...
public final class Static164 {
  ...
  public static final int[][] anIntArrayArray37 =
      new int[][] {
        {2, 4, 6, 0},
        {0, 2, 3, 5, 6, 4},
        {0, 1, 4, 5},
  ...
  public static void method3579(
    ...
    int local62 = arg3 * 3;
    @Pc(71)
    int local71 = local50 + arg0 - local58 - arg4;
    @Pc(81)
    int local81 = arg6 + local54 - local62 - arg8;
    @Pc(91)
    int local91 = local42 + local58 - local50 - local50;
    @Pc(101)
    int local101 = local46 + local62 - local54 - local54;
    @Pc(106)
    int local106 = local50 - local42;
    @Pc(111)
    int local111 = local54 - local46;
    for (@Pc(113) int local113 = 128; local113 <= 4096; local113 += 128) {
      @Pc(121)
      int local121 = local113 * local113 >> 12;
      @Pc(127)
      int local127 = local121 * local113 >> 12;
      @Pc(131)
      int local131 = local71 * local127;
      @Pc(135)
      int local135 = local81 * local127;
      @Pc(139)
      int local139 = local91 * local121;
      @Pc(143)
      int local143 = local101 * local121;
      @Pc(147)
      int local147 = local113 * local106;
      @Pc(151)
      int local151 = local113 * local111;
      @Pc(162)
      int local162 = arg4 + (local139 + local131 + local147 >> 12);
      @Pc(173)
      int local173 = (local143 + local135 + local151 >> 12) + arg8;
  ...
  public static void method3580(
    ...
    if (Static354.anInt6186 <= arg3 - arg2
        && arg2 + arg3 <= Static208.anInt2656
        && Static376.anInt6287 <= arg0 - arg2
        && arg0 + arg2 <= Static168.anInt3256) {
  ...
  public static void method3582() {
    ...
    @Pc(17)
    int local17 = Static420.aClass80_1.method2234();
    @Pc(23)
    int local23 = Static420.aClass80_1.method2230();
    @Pc(28)
    Node_Sub5 local28 = (Node_Sub5) Static413.A_LINKED_LIST___47.tail();
    if (local28 != null) {
      local17 = local28.method518();
      local23 = local28.method519();
    }
    Static59.method988(
        0, 0, Static141.width, Static334.anInt5766, 0, 0, Static302.height, local23, local17);
  ...
  public static Node_Sub22 method3584(@OriginalArg(0) Canvas arg0) {
    try {
      ...
      return local10;
        ...
        Throwable local22) {
      @Pc(26)
      Node_Sub22_Sub2 local26 = new Node_Sub22_Sub2();
  ...
  public static void method3585(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
    @Pc(8)
    SecondaryNode_Sub1_Sub11 local8 = Static405.method5222(arg1, 14);
    local8.method2604();
