...
public final class Class70_Sub2 extends Class70 {
  ...
  private void method5083() {
    @Pc(8)
    int local8 = super.anInt6471++;
    if (super.anInt6471 >= 5000) {
      super.anInt6471 = 0;
    }
    this.anInt6476 = super.aByteArray91[local8];
    @Pc(34)
    Object local34 = super.anObjectArray5[local8];
    ...
    if (this.anInt6476 == 21) {
      ...
      @Pc(161)
      Class164 local161 = (Class164) local34;
      ...
      for (@Pc(204) Class7 local204 = local161.aClass7_3;
          local204 != null;
          local204 = local204.aClass7_1) {
