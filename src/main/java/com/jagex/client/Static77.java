...
public final class Static77 {
  ...
  public static void method1388(
      @OriginalArg(1) short[] arg0,
      @OriginalArg(2) String[] arg1,
    ...
    @Pc(28)
    int local28 = (arg2 + arg3) / 2;
    @Pc(30)
    int local30 = arg2;
    @Pc(34)
    String local34 = arg1[local28];
    arg1[local28] = arg1[arg3];
    arg1[arg3] = local34;
    @Pc(48)
    short local48 = arg0[local28];
    arg0[local28] = arg0[arg3];
    arg0[arg3] = local48;
    for (@Pc(60) int local60 = arg2; local60 < arg3; local60++) {
      if (local34 == null
          || arg1[local60] != null && (local60 & 0x1) > arg1[local60].compareTo(local34)) {
        @Pc(85)
        String local85 = arg1[local60];
        arg1[local60] = arg1[local30];
        arg1[local30] = local85;
        @Pc(99)
        short local99 = arg0[local60];
