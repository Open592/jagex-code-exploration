...
public final class Node_Sub6_Sub10 extends Node_Sub6 {
  ...
  public void method2283(@OriginalArg(0) int[] arg0, @OriginalArg(2) int arg1) {
    @Pc(12)
    int local12 = Static165.anIntArray209[arg1] * this.anInt2706;
    @Pc(114)
    int local114;
    @Pc(128)
    int local128;
    ...
    if (this.anInt2698 == 1) {
      ...
      if (this.aBoolean248) {
        for (local105 = 0; local105 < Static80.anInt1616; local105++) {
          ...
          local128 =
              this.method2284(
                  local94, local90, local103, local64, local114 * local44 >> 12, local379);
          @Pc(478)
          int local478 = local128 * local27 >> 12;
    ...
    if (local27 > 8 || local27 < -8) {
      ...
      for (local105 = 0; local105 < Static80.anInt1616; local105++) {
        local114 = Static341.anIntArray504[local105] * this.anInt2699;
        local128 =
            this.method2284(local94, local90, local103, local64, local114 * local44 >> 12, local50);
        arg0[local105] = local27 * local128 >> 12;
      }
    }
      ...
      if (local27 > 8 || local27 < -8) {
        ...
        if (this.aBoolean248 && this.anInt2698 - 1 == local146) {
          for (local105 = 0; local105 < Static80.anInt1616; local105++) {
            ...
            local128 =
                this.method2284(
                    local94, local90, local103, local64, local44 * local114 >> 12, local50);
  ...
  private int method2284(
    ...
    int local9 = arg4 >> 12;
    @Pc(13)
    int local13 = local9 + 1;
    @Pc(17)
    int local17 = arg4 & 0xFFF;
    @Pc(21)
    int local21 = local9 & 0xFF;
    if (local13 >= arg3) {
      local13 = 0;
    }
    local13 &= 0xFF;
    @Pc(38)
    int local38 = arg5 - 4096;
    @Pc(42)
    int local42 = local17 - 4096;
    @Pc(46)
    int local46 = Class75.anIntArray163[local17];
    @Pc(55)
    int local55 = this.aByteArray25[arg1 + local21] & 0x3;
    @Pc(71)
    int local71;
    if (local55 <= 1) {
    ...
    @Pc(149)
    int local149 = ((local114 - local71) * local46 >> 12) + local71;
    if (local55 <= 1) {
    ...
    @Pc(234)
    int local234 = local71 + ((local114 - local71) * local46 >> 12);
  ...
  public void method5518(@OriginalArg(1) int arg0, @OriginalArg(2) Packet arg1) {
    if (arg0 == 0) {
      ...
      this.anInt2699 = this.anInt2706 = arg1.g1();
    } else if (arg0 == 4) {
      this.anInt2707 = arg1.g1();
    } else if (arg0 == 5) {
      this.anInt2699 = arg1.g1();
    } else if (arg0 == 6) {
      this.anInt2706 = arg1.g1();
    }
  }
  ...
  private void method2286() {
    ...
    if (this.anInt2702 > 0) {
      ...
      for (local16 = 0; local16 < this.anInt2698; local16++) {
        this.aShortArray68[local16] =
            (short)
                (Math.pow((double) ((float) this.anInt2702 / 4096.0F), (double) local16) * 4096.0D);
  ...
  public void method5509() {
    ...
    for (@Pc(23) int local23 = this.anInt2698 - 1; local23 >= 1; local23--) {
      @Pc(30)
      short local30 = this.aShortArray68[local23];
      if (local30 > 8) {
        return;
      }
      if (local30 < -8) {
  ...
  public int[] method5510(@OriginalArg(1) int arg0) {
    @Pc(9)
    int[] local9 = super.aClass82_41.method2265(arg0);
