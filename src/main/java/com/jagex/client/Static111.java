...
public final class Static111 {
  ...
  public static void method2022(
      @OriginalArg(0) Class16_Sub1_Sub5_Sub1 arg0,
      @OriginalArg(1) int arg1,
      @OriginalArg(3) int arg2) {
    @Pc(14)
    int local14 = arg0.anIntArray426[0];
    @Pc(19)
    int local19 = arg0.anIntArray427[0];
    if (local14 < 0
        || Static326.anInt5666 <= local14
        || local19 < 0
        || Static283.anInt5187 <= local19
        || (arg1 < 0 || arg1 >= Static326.anInt5666 || arg2 < 0 || Static283.anInt5187 <= arg2)) {
      return;
    }
    @Pc(77)
    int local77 =
        Static6.method49(
            Static175.aClass213Array1[arg0.aByte82],
            local14,
            arg1,
            0,
            arg2,
  ...
  public static void method2023() {
    Static421.aLinkedList_48 = new LinkedList();
  }
}
