...
public final class Static213 {
  ...
  public static void method3223() {
    ...
    for (@Pc(44) int local44 = 0; local44 < Static190.anInt3602; local44++) {
      @Pc(52)
      int local52 = Static164.aClass30Array4[local44].method746();
      @Pc(58)
      char local58 = Static164.aClass30Array4[local44].method749();
      if (local52 == 84) {
        Static62.method997();
        ...
        if (Static348.aClipboard1 != null) {
          ...
          for (@Pc(78) int local78 = Static102.aStringArray8.length - 1; local78 >= 0; local78--) {
            if (Static102.aStringArray8[local78] != null
                && Static102.aStringArray8[local78].length() > 0) {
        ...
        if (Static348.aClipboard1 != null) {
          @Pc(343)
          Transferable local343 = Static348.aClipboard1.getContents(null);
          if (local343 != null) {
            try {
              @Pc(350)
              String local350 = (String) local343.getTransferData(DataFlavor.stringFlavor);
              if (local350 != null) {
                @Pc(357)
                String[] local357 = Static113.method2058(local350, '\n');
        ...
        Static117.aString29 =
            Static117.aString29.substring(0, Static238.anInt4511 - 1)
                + Static117.aString29.substring(Static238.anInt4511);
        Static238.anInt4511--;
      } else if (local52 == 101 && Static238.anInt4511 < Static117.aString29.length()) {
        Static117.aString29 =
            Static117.aString29.substring(0, Static238.anInt4511)
                + Static117.aString29.substring(Static238.anInt4511 + 1);
        ...
        Static455.method4270();
        Static238.anInt4511 = Static117.aString29.length();
      } else if (Static218.method3280(local58)
          || local58 == ':'
          || local58 == ','
          || local58 == ' '
          || local58 == '_'
        ...
        Static117.aString29 =
            Static117.aString29.substring(0, Static238.anInt4511)
                + Static164.aClass30Array4[local44].method749()
                + Static117.aString29.substring(Static238.anInt4511);
        Static238.anInt4511++;
      }
    }
