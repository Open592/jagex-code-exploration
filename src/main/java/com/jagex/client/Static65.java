...
public final class Static65 {
      ...
      for (@Pc(19) int local19 = 0; local19 < local17.length; local19++) {
        for (@Pc(23) int local23 = 0; local23 < local17[local19].length; local23++) {
          ...
          if (local31 != null) {
            ...
            for (@Pc(81) Class7 local81 = local31.aClass7_3;
                local81 != null;
                local81 = local81.aClass7_1) {
              @Pc(86)
              Class16_Sub1 local86 = local81.aClass16_Sub1_1;
  ...
  public static void method1249(@OriginalArg(0) Js5 arg0) {
    Static146.aJs5_4 = arg0;
  }
}
