...
public final class Static63 {
  ...
  public static void method1134() {
    Static263.method3809(ClientPreferences.preferences.anInt3434);
    @Pc(17)
    int local17 = (Static180.anInt3453 >> 3) + (Static163.anInt3197 >> 10);
    @Pc(25)
    int local25 = (Static86.anInt1771 >> 3) + (Static145.anInt2906 >> 10);
    ...
    @Pc(98)
    int local98;
    for (@Pc(87) int local87 = (local17 - (Static326.anInt5666 >> 4)) / 8;
        local87 <= (local17 + (Static326.anInt5666 >> 4)) / 8;
        local87++) {
      for (local98 = (local25 - (Static283.anInt5187 >> 4)) / 8;
          local98 <= ((Static283.anInt5187 >> 4) + local25) / 8;
          local98++) {
        @Pc(106)
