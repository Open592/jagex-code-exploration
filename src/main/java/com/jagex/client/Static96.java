...
public final class Static96 {
  ...
  public static final LocalizedString A_LOCALIZED_STRING___38 =
      new LocalizedString("Loading...", "Lade...", "Chargement en cours...", "Carregando...");

  @OriginalMember(owner = "client!eq", name = "a", descriptor = "(IILclient!uu;I)V")
  public static void method1680(
      @OriginalArg(1) int arg0, @OriginalArg(2) Class247 arg1, @OriginalArg(3) int arg2) {
    if (Static281.aClass247_12 != null
        || Static234.aBoolean411
        || (arg1 == null || Static12.method126(arg1) == null)) {
      return;
    }
  ...
  public static void method1683() {
    for (@Pc(10)
        SecondaryNode_Sub1_Sub7 local10 =
            (SecondaryNode_Sub1_Sub7) Static27.A_LINKED_LIST___2.tail();
        local10 != null;
        local10 = (SecondaryNode_Sub1_Sub7) Static27.A_LINKED_LIST___2.previous()) {
      @Pc(15)
      Class16_Sub1_Sub3 local15 = local10.aClass16_Sub1_Sub3_1;
      if (Static263.anInt4963 != local15.aByte82 || local15.anInt2581 < client.gameLogicStepCount) {
        ...
        if (local15.anInt2587 > 0) {
          @Pc(56)
          Class16_Sub1_Sub5_Sub2 local56 =
              Static143.aClass16_Sub1_Sub5_Sub2Array1[local15.anInt2587 - 1];
          if (local56 != null
              && local56.anInt6893 >= 0
              && Static326.anInt5666 * 128 > local56.anInt6893
              && local56.anInt6892 >= 0
              && Static283.anInt5187 * 128 > local56.anInt6892) {
            local15.method2197(
                client.gameLogicStepCount,
                local56.anInt6893,
                Static13.method135(local56.anInt6893, local15.aByte82, local56.anInt6892)
                    - local15.anInt2586,
                local56.anInt6892);
          }
        }
        if (local15.anInt2587 < 0) {
          @Pc(118)
          int local118 = -local15.anInt2587 - 1;
          @Pc(127)
          Class16_Sub1_Sub5_Sub1 local127;
          ...
          if (local127 != null
              && local127.anInt6893 >= 0
              && local127.anInt6893 < Static326.anInt5666 * 128
              && local127.anInt6892 >= 0
              && local127.anInt6892 < Static283.anInt5187 * 128) {
            local15.method2197(
                client.gameLogicStepCount,
                local127.anInt6893,
                Static13.method135(local127.anInt6893, local15.aByte82, local127.anInt6892)
                    - local15.anInt2586,
                local127.anInt6892);
          }
        }
