...
public final class Static348 {
  ...
  public static void method4697() {
    ...
    @Pc(16)
    int local16 = Static230.xPOS;
    @Pc(18)
    int local18 = Static303.yPOS;
    @Pc(25)
    int local25 = Static425.anInt7000 - Static141.width - local16;
    @Pc(33)
    int local33 = Static17.anInt222 - local18 - Static302.height;
    ...
    try {
      ...
      if (GameShell.frame == local49) {
        @Pc(63)
        Insets local63 = GameShell.frame.getInsets();
        local55 = local63.left;
        local57 = local63.top;
      }
      @Pc(72)
      Graphics local72 = local49.getGraphics();
      ...
      if (local25 > 0) {
        local72.fillRect(
            Static425.anInt7000 + local55 - local25, local57, local25, Static17.anInt222);
      }
      if (local33 > 0) {
        local72.fillRect(
            local55, local57 + Static17.anInt222 - local33, Static425.anInt7000, local33);
        return;
      }
    } catch (
        @Pc(125)
