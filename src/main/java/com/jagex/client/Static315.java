...
public final class Static315 {
  ...
  public static void method4208(
    ...
    @Pc(108)
    int local108 = Static314.anInt5471 - (int) ((float) arg1 / Static148.aFloat178);
    ...
    @Pc(146)
    int local146 = Static46.anInt5156 - (int) ((float) arg4 / Static148.aFloat178);
    ...
    Static148.method4513(
        local108 + Static148.anInt5732,
        local33 + Static148.anInt5724,
        Static148.anInt5732 + local52,
        Static148.anInt5724 + local146,
        arg0,
        arg5,
        arg0 + arg1,
        arg4 + arg5 - -1);
    ...
    @Pc(201)
    LinkedList local201 = Static148.method4501(arg3);
    ...
    @Pc(232)
    int local232 = arg1 + arg0 - 5;
    @Pc(238)
    int local238 = arg4 + arg5 - 8;
    Static207.aClass46_9.method5059(
        "Fps:" + GameShell.framesPerSecond, local238, 16776960, local232);
    @Pc(253)
    int local253 = local238 - 15;
    @Pc(255)
    Runtime local255 = Runtime.getRuntime();
    @Pc(265)
    int local265 = (int) ((local255.totalMemory() - local255.freeMemory()) / 1024L);
    @Pc(267)
    int local267 = 16776960;
    if (local265 > 65536) {
      local267 = 16711680;
    }
  ...
  public static boolean method4210(@OriginalArg(1) Interface6 arg0) {
    @Pc(15)
    Class202 local15 = Static267.aClass262_2.method5560(arg0.method5350());
    if (local15.anInt5803 == -1) {
      return true;
    } else {
      @Pc(28)
      Class41 local28 = Static76.aClass265_2.method5588(local15.anInt5803);
  ...
  public static int method4212(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
    return arg0 == 1 || arg0 == 3
        ? Static11.anIntArray10[arg1 & 0x3]
        : Static306.anIntArray359[arg1 & 0x3];
  }

  @OriginalMember(owner = "client!pt", name = "a", descriptor = "(ILclient!fs;I)Lclient!gt;")
  public static Class89 method4213(@OriginalArg(0) int arg0, @OriginalArg(1) Js5 arg1) {
    @Pc(8)
    byte[] local8 = arg1.method2122(arg0);
