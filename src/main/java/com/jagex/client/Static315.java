...
public final class Static315 {
	...
	public static void method4208(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Interface7 arg2, @OriginalArg(3) Class19 arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5) {
		...
		if (Static69.anInt3429 < 100) {
			...
			arg3.method4312(local33 - 152, local52, 304, 34, Static164.aColorArray6[ClientSettings.colourID].getRGB(), 0);
			arg3.O(local33 - 150, local52 + 2, Static69.anInt3429 * 3, 30, Static64.aColorArray3[ClientSettings.colourID].getRGB(), 0);
			Static331.aClass46_10.method5056(local33, Static171.aColorArray5[ClientSettings.colourID].getRGB(), local52 + 20, -1, Static96.A_LOCALIZED_STRING___38.getLocalizedString(ClientSettings.langID));
			return;
		}
