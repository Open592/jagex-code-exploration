...
public abstract class Class110 {
  ...
  public abstract void method4880(
  ...
  public final void method4883(
      ...
      @OriginalArg(5) SecondaryNode_Sub1_Sub17 arg5,
      @OriginalArg(6) SecondaryNode_Sub1_Sub17 arg6,
      @OriginalArg(7) int arg7) {
    if (arg3 == -1 || !this.w()) {
      return;
    }
    @Pc(16)
    Class88 local16 = arg5.aClass88Array1[arg3];
    @Pc(19)
    Node_Sub32 local19 = local16.aClass4_Sub32_1;
    @Pc(21)
    Class88 local21 = null;
    if (arg6 != null) {
  ...
  protected final void method4884(
    ...
    int local26 = -arg2 / 2;
    @Pc(35)
    int local35 = arg4.a(local21 + arg0, local26 + arg1);
    @Pc(39)
    int local39 = arg5 / 2;
    @Pc(44)
    int local44 = -arg2 / 2;
    @Pc(53)
    int local53 = arg4.a(local39 + arg0, local44 + arg1);
    @Pc(58)
    int local58 = -arg5 / 2;
    @Pc(62)
    int local62 = arg2 / 2;
    @Pc(71)
    int local71 = arg4.a(local58 + arg0, arg1 + local62);
    @Pc(75)
    int local75 = arg5 / 2;
    @Pc(79)
    int local79 = arg2 / 2;
    @Pc(89)
    int local89 = arg4.a(arg0 + local75, local79 + arg1);
    @Pc(100)
    int local100 = local53 > local35 ? local35 : local53;
    @Pc(107)
    int local107 = local71 >= local89 ? local89 : local71;
    @Pc(114)
    int local114 = local53 >= local89 ? local89 : local53;
    @Pc(121)
    int local121 = local71 > local35 ? local35 : local71;
    @Pc(148)
    int local148;
    if (arg2 != 0) {
      @Pc(137)
      int local137 =
          (int) (Math.atan2((double) (local100 - local107), (double) arg2) * 2607.5945876176133D)
              & 0x3FFF;
      if (local137 != 0) {
        if (arg3 != 0) {
          if (local137 > 8192) {
    ...
    @Pc(171)
    int local171 = local35 + local89;
    if (arg5 != 0) {
      @Pc(190)
      int local190 =
          (int) (Math.atan2((double) (local121 - local114), (double) arg5) * 2607.5945876176133D)
              & 0x3FFF;
      if (local190 != 0) {
        if (arg6 != 0) {
          if (local190 > 8192) {
  ...
  public abstract Class110 method4887(
  ...
  public abstract void method4889(
      @OriginalArg(0) Class31 arg0, @OriginalArg(1) Class3_Sub5 arg1, @OriginalArg(2) int arg2);
  ...
  public abstract void method4891(
  ...
  public final void method4892(
      @OriginalArg(1) int arg0, @OriginalArg(2) SecondaryNode_Sub1_Sub17 arg1) {
    if (arg0 == -1 || !this.w()) {
      return;
    }
    @Pc(18)
    Class88 local18 = arg1.aClass88Array1[arg0];
    @Pc(21)
    Node_Sub32 local21 = local18.aClass4_Sub32_1;
    for (@Pc(23) int local23 = 0; local23 < local18.anInt2756; local23++) {
      @Pc(30)
      short local30 = local18.aShortArray77[local23];
      if (local21.aBooleanArray16[local30]) {
        if (local18.aShortArray76[local23] != -1) {
          this.N(0, 0, 0, 0);
        }
        this.N(
            local21.anIntArray318[local30],
            local18.aShortArray72[local23],
            local18.aShortArray75[local23],
            local18.aShortArray80[local23]);
      }
    }
    this.j();
  }
  ...
  @OriginalMember(
      owner = "client!t",
      name = "a",
      descriptor = "(Lclient!gr;[ZLclient!nk;IZIILclient!gr;ZII[I)V")
  private void method4896(
      @OriginalArg(0) Class88 arg0,
      @OriginalArg(1) boolean[] arg1,
      @OriginalArg(2) Node_Sub32 arg2,
      @OriginalArg(3) int arg3,
      @OriginalArg(4) boolean arg4,
      @OriginalArg(5) int arg5,
      @OriginalArg(7) Class88 arg6,
      @OriginalArg(8) boolean arg7,
      @OriginalArg(9) int arg8,
    ...
    if (arg0 == null || arg3 == 0) {
      for (local11 = 0; local11 < arg6.anInt2756; local11++) {
        @Pc(18)
        short local18 = arg6.aShortArray77[local11];
        if (arg1 == null || arg1[local18] == arg7 || arg2.anIntArray318[local18] == 0) {
          @Pc(43)
          short local43 = arg6.aShortArray76[local11];
          if (local43 != -1) {
            this.method4888(
                0,
                arg10,
                0,
                arg2.anIntArray320[local43] & arg9,
                arg5,
                arg4,
                arg2.anIntArrayArray42[local43],
                0,
                0);
          }
          this.method4888(
              arg2.anIntArray318[local18],
              arg10,
              arg6.aShortArray80[local11],
              arg9 & arg2.anIntArray320[local18],
              arg5,
              arg4,
              arg2.anIntArrayArray42[local18],
              arg6.aShortArray75[local11],
              arg6.aShortArray72[local11]);
        }
      }
      return;
    }
    ...
    for (@Pc(117) int local117 = 0; local117 < arg2.anInt4981; local117++) {
      ...
      if (local121 || local139) {
        if (arg1 == null || arg1[local117] == arg7 || arg2.anIntArray318[local117] == 0) {
          ...
          short local181 = 0;
          @Pc(186)
          int local186 = arg2.anIntArray318[local117];
          ...
          if (local218 != -1) {
            this.method4888(
                ...
                arg10,
                0,
                arg2.anIntArray320[local218] & arg9,
                arg5,
                arg4,
                arg2.anIntArrayArray42[local218],
                0,
                0);
          } else if (local244 != -1) {
            this.method4888(
                ...
                arg10,
                0,
                arg9 & arg2.anIntArray320[local244],
                arg5,
                arg4,
                arg2.anIntArrayArray42[local244],
                0,
                0);
          }
          @Pc(386)
          ...
          if ((local208 & 0x2) == 0 && (local240 & 0x1) == 0) {
            ...
            if (local186 == 2) {
              ...
              @Pc(359)
              int local359 = local242 - local203 & 0x3FFF;
              if (local352 >= 8192) {
                local352 -= 16384;
              }
              @Pc(372)
              int local372 = local248 - local213 & 0x3FFF;
              if (local359 >= 8192) {
                local359 -= 16384;
              }
          ...
          this.method4888(
              ...
              arg10,
              local412,
              arg2.anIntArray320[local117] & arg9,
              arg5,
              arg4,
              arg2.anIntArrayArray42[local117],
              local402,
              local386);
        } else {
          if (local139) {
  ...
  @OriginalMember(
      owner = "client!t",
      name = "a",
      descriptor = "(ILclient!pt;[IZIIIILclient!pt;II)V")
  public final void method4897(
      @OriginalArg(0) int arg0,
      @OriginalArg(1) SecondaryNode_Sub1_Sub17 arg1,
      @OriginalArg(2) int[] arg2,
      @OriginalArg(3) boolean arg3,
      @OriginalArg(5) int arg4,
      @OriginalArg(7) int arg5,
      @OriginalArg(8) SecondaryNode_Sub1_Sub17 arg6,
    ...
    @Pc(17)
    Class88 local17 = arg6.aClass88Array1[arg4];
    @Pc(20)
    Node_Sub32 local20 = local17.aClass4_Sub32_1;
    @Pc(30)
    Class88 local30 = null;
    if (arg1 != null) {
  ...
  @OriginalMember(
      owner = "client!t",
      name = "a",
      descriptor = "(IILclient!pt;ZIIILclient!pt;Lclient!pt;I[ZLclient!pt;III)V")
  public final void method4899(
      @OriginalArg(0) int arg0,
      @OriginalArg(1) int arg1,
      @OriginalArg(2) SecondaryNode_Sub1_Sub17 arg2,
      @OriginalArg(3) boolean arg3,
      @OriginalArg(4) int arg4,
      @OriginalArg(5) int arg5,
      @OriginalArg(6) int arg6,
      @OriginalArg(7) SecondaryNode_Sub1_Sub17 arg7,
      @OriginalArg(8) SecondaryNode_Sub1_Sub17 arg8,
      @OriginalArg(9) int arg9,
      @OriginalArg(10) boolean[] arg10,
      @OriginalArg(11) SecondaryNode_Sub1_Sub17 arg11,
    ...
    if (arg10 == null || arg6 == -1) {
      ...
      @Pc(38)
      Class88 local38 = arg8.aClass88Array1[arg0];
      @Pc(41)
      Node_Sub32 local41 = local38.aClass4_Sub32_1;
      @Pc(43)
      Class88 local43 = null;
      if (arg11 != null) {
      ...
      @Pc(75)
      Class88 local75 = arg7.aClass88Array1[arg6];
      @Pc(77)
      Class88 local77 = null;
      if (arg2 != null) {
      ...
      this.method4896(
          local77, arg10, local75.aClass4_Sub32_1, arg5, arg3, 0, local75, true, arg4, 65535, null);
      this.j();
    }
  }
}
