						...
						if (arg0 < 1700) {
							...
							if (arg0 < 2800) {
								...
								if (arg0 < 3200) {
									...
									if (arg0 == 4107) {
										anInt5092 -= 2;
										anIntArray330[anInt5095++] = Static40.method698(aStringArray21[anInt5092 + 1], aStringArray21[anInt5092], ClientSettings.langID);
										return;
									}
									...
									if (arg0 == 4124) {
										local412 = anIntArray330[--anInt5095] != 0;
										local19 = anIntArray330[--anInt5095];
										aStringArray21[anInt5092++] = Static343.method748(local412, (long) local19, 0, ClientSettings.langID);
										return;
									}
									if (arg0 == 4125) {
										local3888 = aStringArray21[--anInt5092];
										local19 = anIntArray330[--anInt5095];
										@Pc(8210) Class89 local8210 = Static239.method3546(local19, Static209.aJs5_48);
	...
	private static void method3898(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1) {
		...
		if (arg0 < 5100) {
			...
			if (arg0 < 5300) {
				...
				if (arg0 == 5302) {
					@Pc(2769) GraphicsDeviceDisplayMode[] local2769 = Static240.method5675();
					anIntArray330[anInt5095++] = local2769.length;
					return;
				}
				if (arg0 == 5303) {
					local157 = anIntArray330[--anInt5095];
					@Pc(2793) GraphicsDeviceDisplayMode[] local2793 = Static240.method5675();
				...
				if (arg0 == 5305) {
					...
					local89 = -1;
					@Pc(2830) GraphicsDeviceDisplayMode[] local2830 = Static240.method5675();
					for (local2691 = 0; local2691 < local2830.length; local2691++) {
						@Pc(2837) GraphicsDeviceDisplayMode local2837 = local2830[local2691];
				...
				if (arg0 < 5500) {
					...
					if (arg0 == 5411) {
						...
						local75 = ClientSettings.quitURL == null ? Static22.method298() : ClientSettings.quitURL;
					...
					if (arg0 == 5421) {
						...
						Static275.method3929(GameShell.signLink, local3345, Static177.anInt2973 == 1, local1313);
						return;
					}
					if (arg0 == 5422) {
						anInt5092 -= 2;
