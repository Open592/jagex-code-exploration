...
public final class Static22 {
  ...
  public static void method293() {
    ...
    @Pc(19)
    double local19 = Math.random() * 0.03D + 0.7D - 0.015D;
    for (@Pc(29) int local29 = 0; local29 < 65536; local29++) {
      @Pc(42)
      double local42 = (double) (local29 >> 10 & 0x3F) / 64.0D + 0.0078125D;
      @Pc(53)
      double local53 = (double) (local29 >> 7 & 0x7) / 8.0D + 0.0625D;
      @Pc(60)
      double local60 = (double) (local29 & 0x7F) / 128.0D;
      @Pc(62)
      double local62 = local60;
      @Pc(64)
      double local64 = local60;
      @Pc(66)
      double local66 = local60;
      if (local53 != 0.0D) {
        @Pc(80)
        double local80;
        if (local60 < 0.5D) {
        ...
        @Pc(97)
        double local97 = local60 * 2.0D - local80;
        @Pc(101)
        double local101 = local42 + 0.3333333333333333D;
        if (local101 > 1.0D) {
          local101--;
        }
        @Pc(115)
        double local115 = local42 - 0.3333333333333333D;
        if (local115 < 0.0D) {
          local115++;
        }
      ...
      @Pc(296)
      int local296 = (int) (local62 * 256.0D);
      @Pc(301)
      int local301 = (int) (local64 * 256.0D);
      @Pc(306)
      int local306 = (int) (local66 * 256.0D);
      @Pc(317)
      int local317 = local306 + (local296 << 16) + (local301 << 8);
  ...
  public static void method294(
    ...
    if (local10.anIntArray317 != null) {
      @Pc(32)
      int[] local32 = new int[local10.anIntArray317.length];
      @Pc(44)
      int local44;
      for (local34 = 0; local34 < local32.length / 2; local34++) {
        ...
        local32[local34 * 2] =
            arg3.anInt6833 / 2
                + arg6
                + ((arg0 + local10.anIntArray317[local34 * 2] * 4) * local62
                        + local58 * (local10.anIntArray317[local34 * 2 + 1] * 4 + arg4)
                    >> 15);
        local32[local34 * 2 + 1] =
            arg7
                + arg3.anInt6805 / 2
                - ((arg4 + local10.anIntArray317[local34 * 2 + 1] * 4) * local62
                        - (arg0 + local10.anIntArray317[local34 * 2] * 4) * local58
                    >> 15);
      }
      Static144.method2440(
          arg1, local32, local10.anInt4927, arg3.anIntArray524, arg3.anIntArray519);
      for (local44 = 0; local44 < local32.length / 2 - 1; local44++) {
        arg1.method4287(
            local32[local44 * 2],
            local32[local44 * 2 + 1],
            local32[local44 * 2 + 2],
            local32[(local44 + 1) * 2 + 1],
            local10.anInt4908,
            arg5,
            arg6,
            arg7);
      ...
      arg1.method4287(
          local32[local32.length - 2],
          local32[local32.length - 1],
          local32[0],
          local32[1],
          local10.anInt4908,
          arg5,
    ...
    @Pc(296)
    Class46 local296 = Static43.aClass46_12;
    @Pc(298)
    Class89 local298 = Static387.aClass89_10;
  ...
  public static String method297(@OriginalArg(0) String arg0) {
    ...
    for (@Pc(17) int local17 = 0; local17 < local8; local17++) {
      @Pc(23)
      char local23 = arg0.charAt(local17);
      if (local23 == '<' || local23 == '>') {
        local10 += 3;
      }
    }
    @Pc(45)
    StringBuffer local45 = new StringBuffer(local10 + local8);
    for (@Pc(47) int local47 = 0; local47 < local8; local47++) {
      @Pc(53)
      char local53 = arg0.charAt(local47);
      if (local53 == '<') {
        local45.append("<lt>");
      } else if (local53 == '>') {
        local45.append("<gt>");
  ...
  public static String method298() {
    ...
    return "http://"
        + local12
        + "."
        + ClientSettings.modeGame.getName()
        + ".com/l="
