...
public final class Static388 {
  ...
  public static void method5094(@OriginalArg(0) boolean arg0) {
    for (@Pc(12) Node_Sub8 local12 = (Node_Sub8) Static281.A_LINKED_LIST___34.tail();
        local12 != null;
        local12 = (Node_Sub8) Static281.A_LINKED_LIST___34.previous()) {
    ...
    for (@Pc(58) Node_Sub8 local58 = (Node_Sub8) Static143.A_LINKED_LIST___20.tail();
        local58 != null;
        local58 = (Node_Sub8) Static143.A_LINKED_LIST___20.previous()) {
    ...
    for (@Pc(85) Node_Sub8 local85 = (Node_Sub8) Static341.A_HASH_MAP___38.head();
        local85 != null;
        local85 = (Node_Sub8) Static341.A_HASH_MAP___38.next()) {
  ...
  public static Class6_Sub1_Sub1 method5095(
    ...
    if (arg0.aBoolean213 || Static424.method5413(arg3) && Static424.method5413(arg1)) {
      ...
      return new Class6_Sub1_Sub1(
          arg0, arg3, arg1, Static370.method4949(arg3), Static370.method4949(arg1), arg2);
    }
  }

  @OriginalMember(owner = "client!to", name = "a", descriptor = "(IBII)I")
  public static int method5096(
    ...
    int local14 = -2;
    @Pc(24)
    int local24 = Integer.MAX_VALUE;
    @Pc(29)
    int local29 = arg0 - Static148.anInt5732;
    @Pc(34)
    int local34 = arg1 - Static148.anInt5724;
    for (@Pc(39) Node_Sub3 local39 = (Node_Sub3) Static148.A_LINKED_LIST___41.tail();
        local39 != null;
        local39 = (Node_Sub3) Static148.A_LINKED_LIST___41.previous()) {
      if (arg2 == local39.anInt234) {
        @Pc(48)
        int local48 = local39.anInt233;
        @Pc(51)
        int local51 = local39.anInt228;
        @Pc(61)
        int local61 = Static148.anInt5732 + local48 << 14 | Static148.anInt5724 + local51;
        @Pc(80)
        int local80 =
            (local34 - local51) * (local34 + -local51) + (local29 - local48) * (-local48 + local29);
  ...
  public static void method5098(
      ...
      @OriginalArg(4) long[] arg3) {
    if (arg0 >= arg1) {
      return;
    }
    @Pc(11)
    int local11 = (arg0 + arg1) / 2;
    @Pc(13)
    int local13 = arg0;
    @Pc(17)
    long local17 = arg3[local11];
    arg3[local11] = arg3[arg1];
    arg3[arg1] = local17;
    @Pc(31)
    int local31 = arg2[local11];
    arg2[local11] = arg2[arg1];
    arg2[arg1] = local31;
    @Pc(49)
    int local49 = local17 == Long.MAX_VALUE ? 0 : 1;
    for (@Pc(51) int local51 = arg0; local51 < arg1; local51++) {
      if (local17 + (long) (local49 & local51) > arg3[local51]) {
        @Pc(72)
        long local72 = arg3[local51];
        arg3[local51] = arg3[local13];
        arg3[local13] = local72;
        @Pc(86)
        int local86 = arg2[local51];
