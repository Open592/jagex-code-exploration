...
public final class Static272 {
  ...
  @OriginalMember(
      owner = "client!ns",
      name = "a",
      descriptor = "(Lclient!ya;BLclient!aq;Lclient!nf;II)Z")
  public static boolean method3908(
      @OriginalArg(0) Class19 arg0, @OriginalArg(2) Node_Sub3 arg1, @OriginalArg(3) Class157 arg2) {
    @Pc(7)
    int local7 = Integer.MAX_VALUE;
    @Pc(9)
    int local9 = Integer.MIN_VALUE;
    @Pc(11)
    int local11 = Integer.MAX_VALUE;
    @Pc(13)
    int local13 = Integer.MIN_VALUE;
    if (arg2.anIntArray317 != null) {
      local9 =
          Static148.anInt5723
              + (Static148.anInt5731 - Static148.anInt5723)
                  * (-Static148.anInt5726 + arg2.anInt4933 + arg1.anInt233)
                  / (Static148.anInt5728 - Static148.anInt5726);
      local13 =
          Static148.anInt5730
              - (arg2.anInt4915 + arg1.anInt228 - Static148.anInt5725)
                  * (-Static148.anInt5727 + Static148.anInt5730)
                  / (Static148.anInt5722 - Static148.anInt5725);
      local7 =
          Static148.anInt5723
              + (arg2.anInt4936 + arg1.anInt233 - Static148.anInt5726)
                  * (Static148.anInt5731 - Static148.anInt5723)
                  / (Static148.anInt5728 - Static148.anInt5726);
      local11 =
          Static148.anInt5730
              - (Static148.anInt5730 - Static148.anInt5727)
                  * (arg1.anInt228 + arg2.anInt4925 - Static148.anInt5725)
                  / (Static148.anInt5722 - Static148.anInt5725);
    }
    @Pc(104)
    Class57 local104 = null;
    @Pc(106)
    int local106 = 0;
    @Pc(108)
    int local108 = 0;
    ...
    if (arg2.aString47 != null) {
      ...
      if (local215 != null) {
        local217 =
            Static387.aClass89_10.method2339(null, null, Static381.aStringArray35, arg2.aString47);
        ...
        for (local279 = 0; local279 < local217; local279++) {
          @Pc(285)
          String local285 = Static381.aStringArray35[local279];
    ...
    if (Static148.anInt5723 > local9
        || local7 > Static148.anInt5731
        || Static148.anInt5727 > local13
        || Static148.anInt5730 < local11) {
      return true;
    }
    @Pc(414)
    int local414;
    if (arg2.anIntArray317 != null) {
      @Pc(412)
      int[] local412 = new int[arg2.anIntArray317.length];
      for (local414 = 0; local414 < local412.length / 2; local414++) {
        local306 = arg2.anIntArray317[local414 * 2] + arg1.anInt233;
        @Pc(438)
        int local438 = arg2.anIntArray317[local414 * 2 + 1] + arg1.anInt228;
        local412[local414 * 2] =
            Static148.anInt5723
                + (local306 - Static148.anInt5726)
                    * (Static148.anInt5731 - Static148.anInt5723)
                    / (Static148.anInt5728 - Static148.anInt5726);
        local412[local414 * 2 + 1] =
            Static148.anInt5730
                - (local438 - Static148.anInt5725)
                    * (-Static148.anInt5727 + Static148.anInt5730)
                    / (Static148.anInt5722 - Static148.anInt5725);
      }
      ...
      for (local306 = 0; local306 < local412.length / 2 - 1; local306++) {
        arg0.method4296(
            local412[local306 * 2 + 1],
            arg2.anInt4908,
            local412[local306 * 2],
            local412[(local306 + 1) * 2 + 1],
            local412[local306 * 2 + 2]);
      }
      arg0.method4296(
          local412[local412.length - 1],
          arg2.anInt4908,
          local412[local412.length - 2],
          local412[1],
          local412[0]);
    }
    if (local104 != null) {
      if (Static140.anInt2835 > 0
          && (Static85.anInt1763 != -1 && arg1.anInt234 == Static85.anInt1763
              || Static402.anInt6662 != -1 && arg2.anInt4919 == Static402.anInt6662)) {
    ...
    if (arg2.anInt4930 != -1 || arg2.aString47 != null) {
      @Pc(731)
      Node_Sub14 local731 = new Node_Sub14(arg1);
