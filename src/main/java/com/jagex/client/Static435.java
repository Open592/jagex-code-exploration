...
public final class Static435 {
  ...
  public static Class118 method5501(@OriginalArg(1) int arg0) {
    @Pc(17)
    Class118 local17 = (Class118) Static436.aClass68_53.method1787((long) arg0);
    if (local17 != null) {
      return local17;
    }
    @Pc(27)
    byte[] local27 = Static306.aJs5_65.method2104(arg0, 0);
  ...
  public static String method5504(@OriginalArg(0) int[] arg0) {
    @Pc(14)
    StringBuffer local14 = new StringBuffer();
    @Pc(16)
    int local16 = Static277.anInt5150;
    for (@Pc(18) int local18 = 0; local18 < arg0.length; local18++) {
      @Pc(27)
      Class101 local27 = Static426.aClass208_1.method4725(arg0[local18]);
