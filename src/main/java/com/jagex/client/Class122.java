...
public final class Class122 {
  ...
  public Class122(@OriginalArg(0) Class122[] arg0, @OriginalArg(1) int arg1) {
    ...
    @Pc(44)
    boolean local44 = false;
    @Pc(46)
    boolean local46 = false;
    this.aByte27 = -1;
    @Pc(51)
    boolean local51 = false;
    for (@Pc(53) int local53 = 0; local53 < arg1; local53++) {
      @Pc(59)
      Class122 local59 = arg0[local53];
      if (local59 != null) {
    ...
    for (@Pc(384) int local384 = 0; local384 < arg1; local384++) {
      @Pc(391)
      short local391 = (short) (0x1 << local384);
      @Pc(395)
      Class122 local395 = arg0[local384];
      if (local395 != null) {
        @Pc(402)
        int local402;
        if (local395.aClass147Array1 != null) {
          for (local402 = 0; local402 < local395.aClass147Array1.length; local402++) {
            @Pc(409)
            Class147 local409 = local395.aClass147Array1[local402];
            this.aClass147Array1[local36++] =
                local409.method3554(this.anInt3686 + local409.anInt4521);
          }
        }
        for (local402 = 0; local402 < local395.anInt3686; local402++) {
          ...
          this.aShortArray120[this.anInt3686] =
              (short) this.method3043(local395, local395.aShortArray120[local402], local391);
          this.aShortArray119[this.anInt3686] =
              (short) this.method3043(local395, local395.aShortArray119[local402], local391);
          this.aShortArray117[this.anInt3686] =
              (short) this.method3043(local395, local395.aShortArray117[local402], local391);
        ...
        if (local395.aClass29Array3 != null) {
          for (local603 = 0; local603 < local395.aClass29Array3.length; local603++) {
            local616 =
                this.method3043(local395, local395.aClass29Array3[local603].anInt706, local391);
            local627 =
                this.method3043(local395, local395.aClass29Array3[local603].anInt713, local391);
            @Pc(638)
            int local638 =
                this.method3043(local395, local395.aClass29Array3[local603].anInt698, local391);
            this.aClass29Array3[local32] =
                local395.aClass29Array3[local603].method694(local616, local627, local638);
            local32++;
          }
        }
        if (local395.aClass179Array3 != null) {
          for (local603 = 0; local603 < local395.aClass179Array3.length; local603++) {
            local616 =
                this.method3043(local395, local395.aClass179Array3[local603].anInt5338, local391);
    ...
    for (@Pc(706) int local706 = 0; local706 < arg1; local706++) {
      @Pc(713)
      short local713 = (short) (0x1 << local706);
      @Pc(717)
      Class122 local717 = arg0[local706];
      if (local717 != null) {
        for (local616 = 0; local616 < local717.anInt3686; local616++) {
          if (local44) {
            this.aByteArray46[local704++] =
                (byte)
                    (local717.aByteArray46 == null || local717.aByteArray46[local616] == -1
                        ? -1
                        : local717.aByteArray46[local616] + this.anInt3689);
          }
        }
        for (local627 = 0; local627 < local717.anInt3689; local627++) {
          @Pc(773)
          byte local773 = this.aByteArray47[this.anInt3689] = local717.aByteArray47[local627];
          if (local773 == 0) {
            this.aShortArray118[this.anInt3689] =
                (short) this.method3043(local717, local717.aShortArray118[local627], local713);
            this.aShortArray116[this.anInt3689] =
                (short) this.method3043(local717, local717.aShortArray116[local627], local713);
            this.aShortArray124[this.anInt3689] =
                (short) this.method3043(local717, local717.aShortArray124[local627], local713);
          }
  ...
  public int[][] method3037() {
    @Pc(16)
    int[] local16 = new int[256];
    @Pc(18)
    int local18 = 0;
    for (@Pc(20) int local20 = 0; local20 < this.aClass147Array1.length; local20++) {
      @Pc(28)
      int local28 = this.aClass147Array1[local20].anInt4527;
      if (local28 >= 0) {
        if (local18 < local28) {
          local18 = local28;
        }
        @Pc(39)
        int local39 = local16[local28]++;
      }
    }
    @Pc(57)
    int[][] local57 = new int[local18 + 1][];
    ...
    for (@Pc(82) int local82 = 0; local82 < this.aClass147Array1.length; local82++) {
      @Pc(90)
      int local90 = this.aClass147Array1[local82].anInt4527;
      if (local90 >= 0) {
  ...
  public int method3040(
    ...
    for (@Pc(7) int local7 = 0; local7 < this.anInt3668; local7++) {
      if (arg2 == this.anIntArray244[local7]
          && arg1 == this.anIntArray242[local7]
          && arg0 == this.anIntArray251[local7]) {
        return local7;
      }
    }
  ...
  private int method3043(
      @OriginalArg(0) Class122 arg0, @OriginalArg(1) int arg1, @OriginalArg(3) short arg2) {
    @Pc(10)
    int local10 = arg0.anIntArray244[arg1];
    @Pc(23)
    int local23 = arg0.anIntArray242[arg1];
    @Pc(28)
    int local28 = arg0.anIntArray251[arg1];
    for (@Pc(30) int local30 = 0; local30 < this.anInt3668; local30++) {
      if (local10 == this.anIntArray244[local30]
          && local23 == this.anIntArray242[local30]
          && this.anIntArray251[local30] == local28) {
  ...
  public int[][] method3045() {
    @Pc(13)
    int[] local13 = new int[256];
    @Pc(15)
    int local15 = 0;
    for (@Pc(17) int local17 = 0; local17 < this.anInt3686; local17++) {
      @Pc(24)
      int local24 = this.anIntArray245[local17];
      if (local24 >= 0) {
        if (local24 > local15) {
          local15 = local24;
        }
        @Pc(42)
        int local42 = local13[local24]++;
      }
    }
    @Pc(59)
    int[][] local59 = new int[local15 + 1][];
    ...
    for (@Pc(84) int local84 = 0; local84 < this.anInt3686; local84++) {
      @Pc(91)
      int local91 = this.anIntArray245[local84];
      if (local91 >= 0) {
  ...
  public int method3047(
      ...
      @OriginalArg(1) short arg1,
      @OriginalArg(2) byte arg2,
      @OriginalArg(3) int arg3,
      @OriginalArg(5) int arg4,
      @OriginalArg(6) short arg5,
      @OriginalArg(7) byte arg6,
      @OriginalArg(8) byte arg7) {
  ...
  public int[][] method3050() {
    @Pc(8)
    int[] local8 = new int[256];
    @Pc(10)
    int local10 = 0;
    for (@Pc(12) int local12 = 0; local12 < this.anInt3677; local12++) {
      @Pc(27)
      int local27 = this.anIntArray246[local12];
      if (local27 >= 0) {
        if (local27 > local10) {
          local10 = local27;
        }
        @Pc(41)
        int local41 = local8[local27]++;
      }
    }
    @Pc(58)
    int[][] local58 = new int[local10 + 1][];
    ...
    for (@Pc(83) int local83 = 0; local83 < this.anInt3677; local83++) {
      @Pc(90)
      int local90 = this.anIntArray246[local83];
      if (local90 >= 0) {
  ...
  private void method3051(@OriginalArg(1) byte[] arg0) {
    ...
    @Pc(15)
    Packet local15 = new Packet(arg0);
    @Pc(20)
    Packet local20 = new Packet(arg0);
    @Pc(25)
    Packet local25 = new Packet(arg0);
    @Pc(30)
    Packet local30 = new Packet(arg0);
    @Pc(35)
    Packet local35 = new Packet(arg0);
    @Pc(40)
    Packet local40 = new Packet(arg0);
    local10.pos = arg0.length - 23;
    this.anInt3668 = local10.g2();
    this.anInt3686 = local10.g2();
    this.anInt3689 = local10.g1();
    @Pc(65)
    int local65 = local10.g1();
    @Pc(76)
    boolean local76 = (local65 & 0x1) == 1;
    @Pc(85)
    boolean local85 = (local65 & 0x2) == 2;
    @Pc(94)
    boolean local94 = (local65 & 0x4) == 4;
    @Pc(103)
    boolean local103 = (local65 & 0x8) == 8;
    if (local103) {
      local10.pos -= 7;
      this.anInt3681 = local10.g1();
      local10.pos += 6;
    }
    @Pc(126)
    int local126 = local10.g1();
    @Pc(130)
    int local130 = local10.g1();
    @Pc(134)
    int local134 = local10.g1();
    @Pc(138)
    int local138 = local10.g1();
    @Pc(142)
    int local142 = local10.g1();
    @Pc(146)
    int local146 = local10.g2();
    @Pc(150)
    int local150 = local10.g2();
    @Pc(154)
    int local154 = local10.g2();
    @Pc(158)
    int local158 = local10.g2();
    @Pc(162)
    int local162 = local10.g2();
    @Pc(164)
    int local164 = 0;
    @Pc(166)
    int local166 = 0;
    ...
    if (this.anInt3689 > 0) {
      ...
      for (local181 = 0; local181 < this.anInt3689; local181++) {
        @Pc(192)
        byte local192 = this.aByteArray47[local181] = local10.g1s();
        if (local192 == 2) {
          local168++;
        }
    ...
    @Pc(222)
    int local222 = local181;
    local181 += this.anInt3668;
    @Pc(229)
    int local229 = local181;
    if (local76) {
      local181 += this.anInt3686;
    }
    @Pc(238)
    int local238 = local181;
    local181 += this.anInt3686;
    @Pc(245)
    int local245 = local181;
    if (local126 == 255) {
      local181 += this.anInt3686;
    }
    @Pc(255)
    int local255 = local181;
    if (local134 == 1) {
      local181 += this.anInt3686;
    }
    @Pc(265)
    int local265 = local181;
    if (local142 == 1) {
      local181 += this.anInt3668;
    }
    @Pc(277)
    int local277 = local181;
    if (local130 == 1) {
      local181 += this.anInt3686;
    }
    @Pc(289)
    int local289 = local181;
    local181 += local158;
    @Pc(295)
    int local295 = local181;
    if (local138 == 1) {
      local181 += this.anInt3686 * 2;
    }
    @Pc(309)
    int local309 = local181;
    local181 += local162;
    @Pc(315)
    int local315 = local181;
    local181 += this.anInt3686 * 2;
    @Pc(324)
    int local324 = local181;
    local181 += local146;
    @Pc(330)
    int local330 = local181;
    local181 += local150;
    @Pc(336)
    int local336 = local181;
    local181 += local154;
    @Pc(342)
    int local342 = local181;
    local181 += local164 * 6;
    @Pc(350)
    int local350 = local181;
    local181 += local166 * 6;
    @Pc(368)
    int local368 = this.anInt3681 < 14 ? 6 : 7;
    @Pc(370)
    int local370 = local181;
    local181 += local166 * local368;
    @Pc(378)
    int local378 = local181;
    local181 += local166;
    @Pc(384)
    int local384 = local181;
    local181 += local166;
    @Pc(390)
    int local390 = local181;
    ...
    local10.pos = local222;
    this.anIntArray251 = new int[this.anInt3668];
    local15.pos = local324;
    local20.pos = local330;
    local25.pos = local336;
    local30.pos = local265;
    @Pc(577)
    int local577 = 0;
    @Pc(579)
    int local579 = 0;
    ...
    for (@Pc(583) int local583 = 0; local583 < this.anInt3668; local583++) {
      ...
      int local591 = 0;
      if ((local589 & 0x1) != 0) {
        local591 = local15.gSmart1Or2s();
      }
      @Pc(604)
      int local604 = 0;
      if ((local589 & 0x2) != 0) {
        local604 = local20.gSmart1Or2s();
      }
      @Pc(614)
      int local614 = 0;
      if ((local589 & 0x4) != 0) {
        local614 = local25.gSmart1Or2s();
      }
      ...
      if (local142 == 1) {
        this.anIntArray246[local583] = local30.g1();
      }
    }
    local10.pos = local315;
    local15.pos = local229;
    local20.pos = local245;
    local25.pos = local277;
    local30.pos = local255;
    local35.pos = local295;
    local40.pos = local309;
    for (local589 = 0; local589 < this.anInt3686; local589++) {
      this.aShortArray123[local589] = (short) local10.g2();
      if (local76) {
      ...
      if (local138 == 1) {
        this.aShortArray125[local589] = (short) (local35.g2() - 1);
      }
      if (this.aByteArray46 != null) {
        if (this.aShortArray125[local589] == -1) {
          this.aByteArray46[local589] = -1;
        } else {
          this.aByteArray46[local589] = (byte) (local40.g1() - 1);
        }
      }
    }
    this.anInt3677 = -1;
    local10.pos = local289;
    local15.pos = local238;
    @Pc(812)
    short local812 = 0;
    @Pc(814)
    short local814 = 0;
    ...
    for (@Pc(820) int local820 = 0; local820 < this.anInt3686; local820++) {
      local826 = local15.g1();
      if (local826 == 1) {
        local812 = (short) (local818 + local10.gSmart1Or2s());
        local814 = (short) (local10.gSmart1Or2s() + local812);
        local816 = (short) (local10.gSmart1Or2s() + local814);
      ...
      if (local826 == 2) {
        local814 = local816;
        local816 = (short) (local818 + local10.gSmart1Or2s());
        this.aShortArray120[local820] = local812;
        local818 = local816;
        this.aShortArray119[local820] = local814;
        this.aShortArray117[local820] = local816;
      ...
      if (local826 == 3) {
        local812 = local816;
        local816 = (short) (local10.gSmart1Or2s() + local818);
        local818 = local816;
        this.aShortArray120[local820] = local812;
        this.aShortArray119[local820] = local814;
        this.aShortArray117[local820] = local816;
    ...
    local10.pos = local342;
    this.anInt3677++;
    local15.pos = local350;
    local20.pos = local370;
    local25.pos = local378;
    local30.pos = local384;
    local35.pos = local390;
    @Pc(1056)
    int local1056;
    for (local826 = 0; local826 < this.anInt3689; local826++) {
      local1056 = this.aByteArray47[local826] & 0xFF;
      if (local1056 == 0) {
        this.aShortArray118[local826] = (short) local10.g2();
        this.aShortArray116[local826] = (short) local10.g2();
        this.aShortArray124[local826] = (short) local10.g2();
      }
      if (local1056 == 1) {
        this.aShortArray118[local826] = (short) local15.g2();
        this.aShortArray116[local826] = (short) local15.g2();
        this.aShortArray124[local826] = (short) local15.g2();
        this.anIntArray249[local826] = local20.g2();
    ...
    if (local85) {
      ...
      if (local1056 > 0) {
        ...
        for (local1371 = 0; local1371 < local1056; local1371++) {
          ...
          this.aClass29Array3[local1371] =
              new Class29(
                  local1377,
                  this.aShortArray120[local1381],
                  this.aShortArray119[local1381],
                  this.aShortArray117[local1381],
                  local1389);
        }
      }
      local1371 = local10.g1();
      if (local1371 > 0) {
        this.aClass179Array3 = new Class179[local1371];
        for (local1377 = 0; local1377 < local1371; local1377++) {
          local1381 = local10.g2();
          local1443 = local10.g2();
  ...
  public void method3053(
    ...
    if (arg2 != 0) {
      ...
      for (local17 = 0; local17 < this.anInt3668; local17++) {
        ...
        this.anIntArray242[local17] =
            this.anIntArray242[local17] * local15 - local11 * this.anIntArray244[local17] >> 15;
    ...
    if (arg0 != 0) {
      ...
      for (local17 = 0; local17 < this.anInt3668; local17++) {
        ...
        this.anIntArray251[local17] =
            this.anIntArray242[local17] * local11 + this.anIntArray251[local17] * local15 >> 15;
    ...
    for (local17 = 0; local17 < this.anInt3668; local17++) {
      ...
      this.anIntArray251[local17] =
          local15 * this.anIntArray251[local17] - this.anIntArray244[local17] * local11 >> 15;
      this.anIntArray244[local17] = local35;
    }
  }
  ...
  private void method3054(@OriginalArg(1) byte[] arg0) {
    @Pc(7)
    boolean local7 = false;
    @Pc(9)
    boolean local9 = false;
    @Pc(14)
    Packet local14 = new Packet(arg0);
    @Pc(19)
    Packet local19 = new Packet(arg0);
    @Pc(24)
    Packet local24 = new Packet(arg0);
    @Pc(29)
    Packet local29 = new Packet(arg0);
    @Pc(34)
    Packet local34 = new Packet(arg0);
    local14.pos = arg0.length - 18;
    this.anInt3668 = local14.g2();
    this.anInt3686 = local14.g2();
    this.anInt3689 = local14.g1();
    @Pc(59)
    int local59 = local14.g1();
    @Pc(63)
    int local63 = local14.g1();
    @Pc(67)
    int local67 = local14.g1();
    @Pc(71)
    int local71 = local14.g1();
    @Pc(77)
    int local77 = local14.g1();
    @Pc(81)
    int local81 = local14.g2();
    @Pc(85)
    int local85 = local14.g2();
    @Pc(89)
    int local89 = local14.g2();
    @Pc(93)
    int local93 = local14.g2();
    @Pc(102)
    int local102 = this.anInt3668;
    @Pc(104)
    int local104 = local102;
    local102 += this.anInt3686;
    @Pc(111)
    int local111 = local102;
    if (local63 == 255) {
      local102 += this.anInt3686;
    }
    @Pc(121)
    int local121 = local102;
    if (local71 == 1) {
      local102 += this.anInt3686;
    }
    @Pc(133)
    int local133 = local102;
    if (local59 == 1) {
      local102 += this.anInt3686;
    }
    @Pc(149)
    int local149 = local102;
    if (local77 == 1) {
      local102 += this.anInt3668;
    }
    @Pc(159)
    int local159 = local102;
    if (local67 == 1) {
      local102 += this.anInt3686;
    }
    @Pc(169)
    int local169 = local102;
    local102 += local93;
    @Pc(175)
    int local175 = local102;
    local102 += this.anInt3686 * 2;
    @Pc(184)
    int local184 = local102;
    local102 += this.anInt3689 * 6;
    @Pc(193)
    int local193 = local102;
    local102 += local81;
    @Pc(199)
    int local199 = local102;
    local102 += local85;
    this.aShortArray117 = new short[this.anInt3686];
    if (local77 == 1) {
      this.anIntArray246 = new int[this.anInt3668];
    ...
    local19.pos = local193;
    local24.pos = local199;
    local29.pos = local102;
    local34.pos = local149;
    @Pc(351)
    int local351 = 0;
    @Pc(353)
    int local353 = 0;
    ...
    for (@Pc(357) int local357 = 0; local357 < this.anInt3668; local357++) {
      ...
      local367 = 0;
      if ((local365 & 0x1) != 0) {
        local367 = local19.gSmart1Or2s();
      }
      @Pc(377)
      int local377 = 0;
      if ((local365 & 0x2) != 0) {
        local377 = local24.gSmart1Or2s();
      }
      @Pc(390)
      int local390 = 0;
      if ((local365 & 0x4) != 0) {
        local390 = local29.gSmart1Or2s();
      }
      ...
      if (local77 == 1) {
        this.anIntArray246[local357] = local34.g1();
      }
    }
    local14.pos = local175;
    local19.pos = local133;
    local24.pos = local111;
    local29.pos = local159;
    local34.pos = local121;
    for (local365 = 0; local365 < this.anInt3686; local365++) {
      this.aShortArray123[local365] = (short) local14.g2();
      if (local59 == 1) {
        local367 = local19.g1();
        if ((local367 & 0x1) == 1) {
          local7 = true;
    ...
    for (@Pc(618) int local618 = 0; local618 < this.anInt3686; local618++) {
      local624 = local19.g1();
      if (local624 == 1) {
        local610 = (short) (local14.gSmart1Or2s() + local616);
        local612 = (short) (local14.gSmart1Or2s() + local610);
        local614 = (short) (local14.gSmart1Or2s() + local612);
      ...
      if (local624 == 2) {
        local612 = local614;
        local614 = (short) (local14.gSmart1Or2s() + local616);
        local616 = local614;
        this.aShortArray120[local618] = local610;
        this.aShortArray119[local618] = local612;
        this.aShortArray117[local618] = local614;
      ...
      if (local624 == 3) {
        local610 = local614;
        local614 = (short) (local616 + local14.gSmart1Or2s());
        local616 = local614;
        this.aShortArray120[local618] = local610;
        this.aShortArray119[local618] = local612;
        this.aShortArray117[local618] = local614;
    ...
    local14.pos = local184;
    this.anInt3677++;
    for (local624 = 0; local624 < this.anInt3689; local624++) {
      this.aByteArray47[local624] = 0;
      this.aShortArray118[local624] = (short) local14.g2();
      this.aShortArray116[local624] = (short) local14.g2();
      this.aShortArray124[local624] = (short) local14.g2();
    }
    if (this.aByteArray46 != null) {
      @Pc(881)
      boolean local881 = false;
      for (@Pc(883) int local883 = 0; local883 < this.anInt3686; local883++) {
        @Pc(892)
        int local892 = this.aByteArray46[local883] & 0xFF;
        if (local892 != 255) {
          if ((this.aShortArray118[local892] & 0xFFFF) == this.aShortArray120[local883]
              && (this.aShortArray116[local892] & 0xFFFF) == this.aShortArray119[local883]
              && this.aShortArray117[local883] == (this.aShortArray124[local892] & 0xFFFF)) {
