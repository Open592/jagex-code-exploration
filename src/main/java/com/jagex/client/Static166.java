...
public final class Static166 {
  ...
  public static boolean method2734(
    ...
    @Pc(8)
    int local8 = Static1.aClass16_Sub1_Sub5_Sub1_1.anIntArray426[0];
    @Pc(13)
    int local13 = Static1.aClass16_Sub1_Sub5_Sub1_1.anIntArray427[0];
    if (local8 < 0
        || Static326.anInt5666 <= local8
        || local13 < 0
        || local13 >= Static283.anInt5187) {
      return false;
    } else if (arg2 >= 0 && arg2 < Static326.anInt5666 && arg1 >= 0 && arg1 < Static283.anInt5187) {
      @Pc(82)
      int local82 =
          Static6.method49(
              Static175.aClass213Array1[Static1.aClass16_Sub1_Sub5_Sub1_1.aByte82],
              local8,
              arg2,
              arg5,
              arg1,
              Static1.aClass16_Sub1_Sub5_Sub1_1.method4751(),
              arg6,
  ...
  public static void method2735(
    ...
    if (arg4 >= Static354.anInt6186
        && Static208.anInt2656 >= arg0
        && Static376.anInt6287 <= arg5
        && Static168.anInt3256 >= arg3) {
      if (arg2 == 1) {
