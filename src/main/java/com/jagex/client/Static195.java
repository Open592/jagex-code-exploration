...
public final class Static195 {
  ...
  public static void method3072(
    ...
    @Pc(33)
    int local33 = (Static61.aShort13 - Static14.aShort1) * local7 / 100 + Static14.aShort1;
    @Pc(39)
    int local39 = local33 * arg1 >> 8;
    @Pc(46)
    int local46 = 16384 - arg6 & 0x3FFF;
    @Pc(53)
    int local53 = 16384 - arg3 & 0x3FFF;
    @Pc(55)
    int local55 = 0;
    @Pc(57)
    int local57 = 0;
