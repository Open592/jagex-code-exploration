...
public final class Static391 {
  ...
  public static final LocalizedString A_LOCALIZED_STRING___133 =
      new LocalizedString(
          "Choose Option", "Wähl eine Option", "Choisir une option", "Selecionar opção");
  ...
  public static void method5117(@OriginalArg(1) ISAACPacket arg0) {
    arg0.method1136();
    @Pc(10)
    int local10 = Static207.anInt5452;
    @Pc(20)
    Class16_Sub1_Sub5_Sub1 local20 =
        Static1.aClass16_Sub1_Sub5_Sub1_1 =
            Static267.aClass16_Sub1_Sub5_Sub1Array1[local10] = new Class16_Sub1_Sub5_Sub1();
    local20.anInt6037 = local10;
    @Pc(28)
    int local28 = arg0.method1143(30);
    @Pc(33)
    byte local33 = (byte) (local28 >> 28);
    @Pc(39)
    int local39 = local28 >> 14 & 0x3FFF;
    local20.anIntArray426[0] = local39 - Static180.anInt3453;
    @Pc(51)
    int local51 = local28 & 0x3FFF;
    ...
    for (@Pc(125) int local125 = 1; local125 < 2048; local125++) {
      if (local125 != local10) {
        @Pc(135)
        int local135 = arg0.method1143(18);
        @Pc(139)
        int local139 = local135 >> 16;
        @Pc(145)
        int local145 = local135 >> 8 & 0xFF;
        @Pc(149)
        int local149 = local135 & 0xFF;
        @Pc(157)
        Class253 local157 = Static306.aClass253Array1[local125] = new Class253();
  ...
  public static void method5118() {
    ...
    @Pc(12)
    int local12 = (Static1.aClass16_Sub1_Sub5_Sub1_1.anInt6893 >> 7) + Static180.anInt3453;
    @Pc(19)
    int local19 = Static86.anInt1771 + (Static1.aClass16_Sub1_Sub5_Sub1_1.anInt6892 >> 7);
