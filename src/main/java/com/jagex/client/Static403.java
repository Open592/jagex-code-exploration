...
public final class Static403 {
  ...
  public static void method5216(
    ...
    for (@Pc(3) int local3 = 0; local3 < Static229.anInt4407; local3++) {
      @Pc(9)
      Rectangle local9 = Node_Sub6_Sub23.aRectangleArray1[local3];
      if (arg3 < local9.width + local9.x
          && arg0 + arg3 > local9.x
          && local9.height + local9.y > arg2
          && arg1 + arg2 > local9.y) {
  ...
  public static Node_Sub3 method5217() {
    ...
    @Pc(18)
    Node_Sub3 local18 = (Node_Sub3) Static308.aClass63_1.method1611();
    if (local18 == null) {
      return null;
    } else {
      @Pc(28)
      Class157 local28 = Static148.aClass182_3.method4124(local18.anInt234);
      return local28 != null && local28.aBoolean448 && local28.method3778(Static148.anInterface12_2)
          ? local18
          : Static187.method2937();
    }
  }
}
