...
public final class Node_Sub6_Sub2 extends Node_Sub6 {
  ...
  private void method690() {
    ...
    if (local8 == 2) {
      for (local8 = 0; local8 < 257; local8++) {
        local26 = local8 << 4;
        for (local28 = 1;
            this.anIntArrayArray6.length - 1 > local28
                && this.anIntArrayArray6[local28][0] <= local26;
            local28++) {}
        ...
        @Pc(112)
        int local112 = (local26 - local63[0] << 12) / (local68[0] - local63[0]);
        @Pc(118)
        int local118 = local112 * local112 >> 12;
        @Pc(128)
        int local128 = local81 + local94 - local77 - local85;
        @Pc(135)
        int local135 = local77 - local128 - local81;
        @Pc(139)
        int local139 = local85 - local77;
        @Pc(151)
        int local151 = (local128 * local112 >> 12) * local118 >> 12;
        @Pc(157)
        int local157 = local135 * local118 >> 12;
        @Pc(163)
        int local163 = local112 * local139 >> 12;
        @Pc(172)
        int local172 = local81 + local163 + local151 + local157;
        if (local172 <= -32768) {
          local172 = -32767;
        }
        if (local172 >= 32768) {
      ...
      for (local8 = 0; local8 < 257; local8++) {
        local26 = local8 << 4;
        for (local28 = 1;
            local28 < this.anIntArrayArray6.length - 1
                && local26 >= this.anIntArrayArray6[local28][0];
            local28++) {}
        local63 = this.anIntArrayArray6[local28 - 1];
        local68 = this.anIntArrayArray6[local28];
  ...
  private void method691() {
    @Pc(8)
    int[] local8 = this.anIntArrayArray6[0];
    @Pc(13)
    int[] local13 = this.anIntArrayArray6[1];
    @Pc(22)
    int[] local22 = this.anIntArrayArray6[this.anIntArrayArray6.length - 2];
    @Pc(36)
    int[] local36 = this.anIntArrayArray6[this.anIntArrayArray6.length - 1];
    this.anIntArray39 =
        new int[] {local22[0] + local22[0] - local36[0], -local36[1] - -local22[1] + local22[1]};
    this.anIntArray38 =
        new int[] {local8[0] + local8[0] - local13[0], local8[1] + -local13[1] + local8[1]};
  }
