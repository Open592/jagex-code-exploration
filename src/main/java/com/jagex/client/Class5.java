...
public final class Class5 {
  ...
  private void method30(@OriginalArg(0) Class19 arg0, @OriginalArg(1) Class5 arg1) {
    @Pc(6)
    Class122 local6 = Static370.method4948(Static151.aJs5_38, this.anInt32);
    if (local6 == null) {
      return;
    }
    ...
    @Pc(172)
    Class110 local172 = arg0.method4254(local6, 2048, 0, 64, 768);
    local85 = local172.NA() - local172.HA();
    local89 = local172.WA() - local172.MA();
    local99 = local172.HA() + local85 / 2;
    @Pc(198)
    int local198 = local172.MA() + local89 / 2;
    @Pc(205)
    int local205 = local85 > local89 ? local85 : local89;
    arg0.H(local99, local198, local205, local205);
    arg0.ea(arg0.method4274());
    @Pc(218)
    Class31 local218 = arg0.method4289();
    ...
    arg0.OA(
        Static5.anIntArray3[0],
        Static5.anIntArray3[1],
        Static5.anIntArray3[2],
        Static5.anIntArray3[3]);
  }
    ...
    if (this.aClass57_3 == null) {
      if (this.anInt36 == 0) {
        if (Static402.anInterface7_8.method2392(this.anInt32)) {
          @Pc(23)
          int[] local23 =
              Static402.anInterface7_8.method2395(this.anInt32, 0.7F, this.anInt38, this.anInt38);
  ...
  public boolean method33(
    ...
    if (this.aBoolean3) {
      ...
      this.anInt34 =
          (int) Math.sqrt((double) (local7 * local7 + local12 * local12 + local17 * local17));
      if (this.anInt34 == 0) {
        this.anInt34 = 1;
      }
    ...
    int local90 =
        (int)
            (Math.sqrt((double) (local7 * local7 + local12 * local12 + local17 * local17))
                * 256.0D);
    if (local90 > 128) {
    ...
    @Pc(143)
    int local143 = Static370.method4949(this.anInt37);
    if (local143 > arg3) {
    ...
    this.anInt33 =
        (int) (Math.asin((double) ((float) local12 / 256.0F)) * 5215.189175235227D) & 0x3FFF;
    this.anInt39 =
        (int) (Math.atan2((double) local7, (double) -local17) * 5215.189175235227D) & 0x3FFF;
    this.aClass57_3 = null;
    return true;
  }
  ...
  private void method36(@OriginalArg(0) Class19 arg0, @OriginalArg(1) Class5 arg1) {
    ...
    @Pc(147)
    Class110 local147 = Static5.aClass110_1.method4887((byte) 0, 51200, true);
    if (arg0.method4251()) {
    ...
    arg0.ea(arg0.method4274());
    @Pc(223)
    Class31 local223 = arg0.method4274();
    local223.j(0, 0, arg0.a() - local147.PA());
    local147.method4880(local223, null, 1024);
    @Pc(245)
    int local245 = this.anInt38 * 13 / 16;
    @Pc(252)
    int local252 = (this.anInt38 - local245) / 2;
  ...
  public void method38(
    ...
    @Pc(10)
    int local10 = this.anInt33 - arg5 & 0x3FFF;
    @Pc(17)
    int local17 = this.anInt39 - arg6 & 0x3FFF;
    if (local17 > 8192) {
      local17 -= 16384;
    }
    if (local10 > 8192) {
    ...
    @Pc(38)
    int local38 = local10 * arg4 / 4096 + (arg4 - this.anInt37) / 2;
    @Pc(51)
    int local51 = local17 * arg4 / -4096 + (arg3 - this.anInt37) / 2;
    if (local38 < arg4
        && local38 + this.anInt37 > 0
        && local51 < arg3
        && local51 + this.anInt37 > 0) {
