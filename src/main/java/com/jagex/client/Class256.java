...
public final class Class256 implements Runnable {
  ...
  private void method5477(@OriginalArg(1) Node arg0) {
    @Pc(10)
    LinkedList local10 = this.aLinkedList_49;
  ...
  public Node_Sub42 method5479(@OriginalArg(1) String arg0) {
    if (this.aThread3 == null) {
      ...
      @Pc(23)
      Node_Sub42 local23 = new Node_Sub42(arg0);
  ...
  public void run() {
    while (true) {
      @Pc(8)
      LinkedList local8 = this.aLinkedList_49;
      @Pc(38)
      Node_Sub42 local38;
      synchronized (this.aLinkedList_49) {
        @Pc(15)
        Node local15;
        for (local15 = this.aLinkedList_49.pollLast();
            local15 == null;
            local15 = this.aLinkedList_49.pollLast()) {
          try {
            this.aLinkedList_49.wait();
          } catch (
              @Pc(22)
              InterruptedException local22) {
          }
        }
      ...
      try {
        @Pc(49)
        byte[] local49 = InetAddress.getByName(local38.aString69).getAddress();
