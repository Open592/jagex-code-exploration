...
public final class Class256 implements Runnable {
	...
	public void method5475() {
		...
		this.method5477(new LinkedHashEntry());
		try {
			this.aThread3.join();
	...
	private void method5477(@OriginalArg(1) LinkedHashEntry arg0) {
	...
	public LinkedHashEntry_Sub42 method5479(@OriginalArg(1) String arg0) {
		if (this.aThread3 == null) {
			throw new IllegalStateException("");
		} else if (arg0 == null) {
			throw new IllegalArgumentException("");
		} else {
			@Pc(23) LinkedHashEntry_Sub42 local23 = new LinkedHashEntry_Sub42(arg0);
	...
	public void run() {
		while (true) {
			...
			@Pc(38) LinkedHashEntry_Sub42 local38;
			synchronized (this.aClass183_49) {
				@Pc(15) LinkedHashEntry local15;
				...
				if (!(local15 instanceof LinkedHashEntry_Sub42)) {
					return;
				}
				local38 = (LinkedHashEntry_Sub42) local15;
			}
			@Pc(64) int local64;
			try {
