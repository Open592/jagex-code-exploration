...
public final class Node_Sub13 extends Node {
  ...
  public Node_Sub4_Sub1 method1322(@OriginalArg(0) int[] arg0) {
    ...
    while (this.anInt1468 < this.aByteArrayArray4.length) {
      ...
      @Pc(42)
      float[] local42 = this.method1325(this.anInt1468);
      if (local42 != null) {
        @Pc(47)
        int local47 = this.anInt1469;
        @Pc(50)
        int local50 = local42.length;
        if (local50 > this.anInt1465 - local47) {
          local50 = this.anInt1465 - local47;
        }
        for (@Pc(63) int local63 = 0; local63 < local50; local63++) {
          @Pc(73)
          int local73 = (int) (local42[local63] * 128.0F + 128.0F);
    ...
    @Pc(129)
    byte[] local129 = this.aByteArray16;
    this.aByteArray16 = null;
    return new Node_Sub4_Sub1(
        this.anInt1467, local129, this.anInt1462, this.anInt1463, this.aBoolean126);
  }
  ...
  private float[] method1325(@OriginalArg(0) int arg0) {
    ...
    Static68.method1317();
    @Pc(15)
    int local15 = Static68.method1314(Static329.method4426(Static68.anIntArray111.length - 1));
    @Pc(19)
    boolean local19 = Static68.aBooleanArray10[local15];
    @Pc(25)
    int local25 = local19 ? Static68.anInt1458 : Static68.anInt1466;
    @Pc(27)
    boolean local27 = false;
    @Pc(29)
    ...
    @Pc(123)
    Class77 local123 = Static68.aClass77Array1[Static68.anIntArray111[local15]];
    @Pc(126)
    int local126 = local123.anInt2528;
    @Pc(131)
    int local131 = local123.anIntArray171[local126];
    @Pc(140)
    boolean local140 = !Static68.aClass250Array1[local131].method5367();
    @Pc(154)
    float[] local154;
    for (@Pc(144) int local144 = 0; local144 < local123.anInt2529; local144++) {
      @Pc(152)
      Class198 local152 = Static68.aClass198Array1[local123.anIntArray172[local144]];
    ...
    if (local140) {
      ...
      local212 = local25 >> 3;
      @Pc(214)
      float[] local214 = Static68.aFloatArray8;
      ...
      @Pc(252)
      float[] local252 = local19 ? Static68.aFloatArray11 : Static68.aFloatArray9;
      @Pc(258)
      float[] local258 = local19 ? Static68.aFloatArray7 : Static68.aFloatArray10;
      @Pc(264)
      float[] local264 = local19 ? Static68.aFloatArray12 : Static68.aFloatArray6;
      @Pc(270)
      int[] local270 = local19 ? Static68.anIntArray110 : Static68.anIntArray109;
      @Pc(307)
      float local307;
      @Pc(313)
      float local313;
      ...
      for (@Pc(272) int local272 = 0; local272 < local176; local272++) {
        @Pc(289)
        float local289 = local214[local272 * 4] - local214[local25 - local272 * 4 - 1];
      ...
      for (@Pc(359) int local359 = 0; local359 < local212; local359++) {
        ...
        @Pc(396)
        float local396 = local214[local359 * 4 + 1];
        local214[local171 + local359 * 4 + 3] = local307 + local321;
        local214[local171 + local359 * 4 + 1] = local313 + local396;
        @Pc(430)
        float local430 = local252[local171 - local359 * 4 - 4];
        @Pc(440)
        float local440 = local252[local171 - local359 * 4 - 3];
        local214[local359 * 4 + 3] =
            (local307 - local321) * local430 - (local313 - local396) * local440;
        local214[local359 * 4 + 1] =
            (local313 - local396) * local430 + (local307 - local321) * local440;
      }
      @Pc(486)
      int local486 = Static329.method4426(local25 - 1);
      @Pc(520)
      int local520;
      @Pc(522)
      int local522;
      ...
      for (@Pc(488) int local488 = 0; local488 < local486 - 3; local488++) {
        ...
        for (local501 = 0; local501 < 0x2 << local488; local501++) {
          ...
          for (local522 = 0; local522 < local25 >> local488 + 4; local522++) {
            ...
            @Pc(593)
            float local593 = local252[local522 * local499 + 1];
            local214[local520 - local527 - 1] =
                (local535 - local551) * local585 - (local543 - local559) * local593;
            local214[local520 - local527 - 3] =
                (local543 - local559) * local585 + (local535 - local551) * local593;
          }
        }
      }
      @Pc(673)
      ...
      for (local510 = 0; local510 < local212; local510++) {
        ...
        @Pc(868)
        float local868 = local264[local510 * 2 + 1];
        @Pc(876)
        float local876 = local214[local171 + local510 * 2];
      ...
      for (local520 = 0; local520 < local176; local520++) {
        local214[local520] =
            local214[local520 * 2 + local171] * local258[local520 * 2]
                + local214[local520 * 2 + local171 + 1] * local258[local520 * 2 + 1];
        local214[local171 - local520 - 1] =
            local214[local520 * 2 + local171] * local258[local520 * 2 + 1]
                - local214[local520 * 2 + local171 + 1] * local258[local520 * 2];
      }
      ...
      for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
        local559 =
            (float)
                Math.sin(
                    ((double) (local1150 - local59) + 0.5D)
                        / (double) local71
                        * 0.5D
                        * 3.141592653589793D);
        Static68.aFloatArray8[local1150] *=
            (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
      }
      for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
        local585 =
            (float)
                Math.sin(
                    ((double) (local1188 - local94) + 0.5D)
                            / (double) local108
                            * 0.5D
                            * 3.141592653589793D
                        + 1.5707963267948966D);
        Static68.aFloatArray8[local1188] *=
            (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
      }
    }
    @Pc(1228)
    float[] local1228 = null;
    if (this.anInt1464 > 0) {
