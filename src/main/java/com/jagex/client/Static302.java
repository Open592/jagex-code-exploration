...
public final class Static302 {
  ...
  public static void method4101(@OriginalArg(0) Class120 arg0, @OriginalArg(1) Class164 arg1) {
    ...
    @Pc(6)
    short local6 = arg1.aShort64;
    @Pc(9)
    short local9 = arg1.aShort63;
    @Pc(12)
    byte local12 = arg1.aByte54;
    @Pc(15)
    byte local15 = arg1.aByte53;
    @Pc(21)
    int local21 = (local6 << Static231.anInt4434) + Static333.anInt5747;
    @Pc(27)
    int local27 = (local9 << Static231.anInt4434) + Static333.anInt5747;
    @Pc(31)
    Class164[][] local31 = Static202.aClass164ArrayArrayArray5[local12];
    @Pc(53)
    float local53;
    if (Static285.aClass65Array3 == Static417.aClass65Array4) {
      Static390.aClass19_37.GA(
          Static67.aClass65Array1[0].a(local21, local27),
          Static335.method4753(local6, local9),
          Static243.method3563(local6, local9),
          Static192.method3012(local6, local9));
      local53 = 251.5F;
    } else {
    ...
    boolean local330;
    @Pc(377)
    Class3_Sub3 local377;
    @Pc(408)
    int local408;
    @Pc(411)
    Class16_Sub5 local411;
    @Pc(706)
    int local706;
    if (arg1.aBoolean464) {
      if (Static152.aBoolean269) {
        ...
        if (local6 <= Static431.anInt7073 && local6 > Static105.anInt2325) {
          ...
          if (local86 != null
              && local86.aBoolean466
              && (local86.aBoolean464 || (arg1.aByte50 & 0x1) == 0)) {
            return;
          }
        }
        if (local6 >= Static431.anInt7073 && local6 < Static343.anInt775 - 1) {
          ...
          if (local86 != null
              && local86.aBoolean466
              && (local86.aBoolean464 || (arg1.aByte50 & 0x4) == 0)) {
            return;
          }
        }
        if (local9 <= Static93.anInt1887 && local9 > Static243.anInt4530) {
          ...
          if (local86 != null
              && local86.aBoolean466
              && (local86.aBoolean464 || (arg1.aByte50 & 0x8) == 0)) {
            return;
          }
        }
        if (local9 >= Static93.anInt1887 && local9 < Static153.anInt3087 - 1) {
          ...
          if (local86 != null
              && local86.aBoolean466
              && (local86.aBoolean464 || (arg1.aByte50 & 0x2) == 0)) {
            return;
          }
        }
      } else {
      ...
      if (arg1.aClass164_1 != null) {
        ...
        @Pc(249)
        Class16_Sub5 local249 = local86.aClass16_Sub5_3;
        if (local249 != null) {
        ...
        for (@Pc(286) Class7 local286 = local86.aClass7_3;
            local286 != null;
            local286 = local286.aClass7_1) {
          @Pc(290)
          Class16_Sub1 local290 = local286.aClass16_Sub1_1;
          if (local290 != null) {
            if (Static280.aBoolean470) {
              Static227.method3448(arg0, local12, local6, local9);
              Static390.aClass19_37.method4238(arg0.anInt5351, arg0.aClass4_Sub21Array3);
      ...
      if (local330) {
        ...
        @Pc(341)
        Class16_Sub4 local341 = arg1.aClass16_Sub4_2;
      ...
      @Pc(414)
      Class16_Sub2 local414 = arg1.aClass16_Sub2_2;
      ...
      if (local411 != null) {
        ...
        if ((local411.anInt6551 & local408) != 0
            && !Static124.method2242(local15, local6, local9, local411.anInt6551)) {
          if (Static280.aBoolean470) {
            Static227.method3448(arg0, local12, local6, local9);
            Static390.aClass19_37.method4238(arg0.anInt5351, arg0.aClass4_Sub21Array3);
          }
          @Pc(563)
          Class3_Sub3 local563 = local411.method5339(Static390.aClass19_37);
          if (local563 != null) {
        ...
        @Pc(584)
        Class16_Sub5 local584 = arg1.aClass16_Sub5_2;
        if (local584 != null
            && (local584.anInt6551 & local408) != 0
            && !Static124.method2242(local15, local6, local9, local584.anInt6551)) {
          if (Static280.aBoolean470) {
            Static227.method3448(arg0, local12, local6, local9);
            Static390.aClass19_37.method4238(arg0.anInt5351, arg0.aClass4_Sub21Array3);
          }
      ...
      if (local414 != null
          && !Static342.method4630(local15, local6, local9, local414.method3583())) {
        @Pc(647)
        Class16_Sub2 local647 = arg1.aClass16_Sub2_3;
      ...
      if (local330) {
        @Pc(814)
        Class16_Sub4 local814 = arg1.aClass16_Sub4_2;
        ...
        @Pc(880)
        Class16_Sub3 local880 = arg1.aClass16_Sub3_1;
        if (local880 != null && !local880.aBoolean73) {
          ...
          @Pc(903)
          Class3_Sub3 local903 = local880.method5339(Static390.aClass19_37);
          if (local903 != null) {
    ...
    if (arg1.aByte49 != 0) {
      ...
      for (local1030 = arg1.aClass7_3; local1030 != null; local1030 = local1030.aClass7_1) {
        if (local1030.aClass16_Sub1_1.anInt6890 != Static143.anInt2891
            && (local1030.anInt118 & arg1.aByte49) == arg1.aByte52) {
          local330 = false;
          break;
        }
      }
      if (local330) {
        ...
        if (!Static124.method2242(local15, local6, local9, local1057.anInt6551)) {
            ...
            label682:
            {
              if (local1057.anInt6551 >= 16) {
                ...
                if (local1057.anInt6551 == 16) {
                  ...
                  local1074 += Static333.anInt5747;
                  local1078 += Static333.anInt5747;
                  if (local1078 < -local1074
                      && local6 < Static422.anInt6945
                      && local9 < Static171.anInt3361) {
                    Static227.method3448(arg0, local12, local6 + 1, local9 + 1);
                    break label682;
                  }
          ...
          @Pc(1216)
          Class3_Sub3 local1216 = local1057.method5339(Static390.aClass19_37);
          if (local1216 != null) {
    ...
    if (arg1.aBoolean465) {
      try {
        ...
        for (local1030 = arg1.aClass7_3; local1030 != null; local1030 = local1030.aClass7_1) {
          @Pc(1252)
          Class16_Sub1 local1252 = local1030.aClass16_Sub1_1;
          if (local1252.anInt6890 != Static143.anInt2891) {
            for (local1074 = local1252.aShort94; local1074 <= local1252.aShort97; local1074++) {
              for (local1078 = local1252.aShort96; local1078 <= local1252.aShort95; local1078++) {
                @Pc(1270)
                Class164 local1270 = local31[local1074][local1078];
        ...
        while (local1245 > 0) {
          ...
          for (local1078 = 0; local1078 < local1245; local1078++) {
            ...
            if (local1384.anInt6890 != Static143.anInt2891) {
              ...
              if (local706 > local408) {
                ...
                if (local711 * local711 + local714 * local714
                    > local723 * local723 + local735 * local735) {
                  local1074 = local1078;
                }
              }
            }
          ...
          if (!Static10.method102(
              local15,
              local1384.aShort94,
              local1384.aShort97,
              local1384.aShort96,
              local1384.aShort95,
              local1384.method5342())) {
            if (Static280.aBoolean470) {
              if (local1384.aByte83 == 0) {
                Static297.method4070(
                    arg0,
                    local12,
                    local1384.aShort94,
                    local1384.aShort96,
          ...
          for (local706 = local1384.aShort94; local706 <= local1384.aShort97; local706++) {
            for (local711 = local1384.aShort96; local711 <= local1384.aShort95; local711++) {
              @Pc(1609)
              Class164 local1609 = local31[local706][local711];
    ...
    if (arg1.aClass146_2 != null && arg1.aByte48 == (byte) (Static326.anInt5665 & 0xFF)) {
      @Pc(1664)
      Class146 local1664 = arg1.aClass146_2;
      local406 = Static417.aClass65Array4[local12].l(local6, local9);
      if (local12 < Static235.anInt4487 - 1) {
        local408 =
            Static417.aClass65Array4[local12].l(local6, local9)
                - Static417.aClass65Array4[local12 + 1].l(local6, local9);
      } else {
    ...
    Static314.anInt5476--;
    @Pc(1855)
    Class16_Sub3 local1855 = arg1.aClass16_Sub3_1;
    if (local1855 != null && local1855.aBoolean73) {
      ...
      @Pc(1878)
      Class3_Sub3 local1878 = local1855.method5339(Static390.aClass19_37);
      if (local1878 != null) {
    ...
    if (arg1.aShort65 != 0) {
      @Pc(1902)
      Class16_Sub2 local1902 = arg1.aClass16_Sub2_2;
      if (local1902 != null
          && !Static342.method4630(local15, local6, local9, local1902.method3583())) {
        if ((local1902.anInt4556 & arg1.aShort65) != 0) {
          ...
          @Pc(2012)
          Class16_Sub2 local2012 = arg1.aClass16_Sub2_3;
          @Pc(2020)
          Class3_Sub3 local2020;
      ...
      @Pc(2105)
      Class3_Sub3 local2105;
      if (local411 != null
          && (local411.anInt6551 & arg1.aShort65) != 0
          && !Static124.method2242(local15, local6, local9, local411.anInt6551)) {
        if (Static280.aBoolean470) {
      ...
      if (local1057 != null
          && (local1057.anInt6551 & arg1.aShort65) != 0
          && !Static124.method2242(local15, local6, local9, local1057.anInt6551)) {
        if (Static280.aBoolean470) {
  ...
  @OriginalMember(
      owner = "client!pf",
      name = "a",
      descriptor = "(Lclient!nf;Lclient!aq;BLclient!ya;)V")
  public static void method4102(
      @OriginalArg(0) Class157 arg0, @OriginalArg(1) Node_Sub3 arg1, @OriginalArg(3) Class19 arg2) {
    @Pc(10)
    Class57 local10 = arg0.method3780(arg2);
    if (local10 == null) {
      return;
    }
    @Pc(16)
    int local16 = local10.la();
    if (local16 < local10.ma()) {
      local16 = local10.ma();
    }
    @Pc(28)
    int local28 = arg1.anInt235;
    @Pc(31)
    int local31 = arg1.anInt231;
    @Pc(33)
    int local33 = 0;
    @Pc(35)
    int local35 = 0;
    ...
    if (arg0.aString47 != null) {
      local33 =
          Static387.aClass89_10.method2339(null, null, Static381.aStringArray35, arg0.aString47);
      for (local51 = 0; local51 < local33; local51++) {
        @Pc(57)
        String local57 = Static381.aStringArray35[local51];
      ...
      local37 =
          local33 * Static239.aClass212_5.method4818() + Static239.aClass212_5.method4821() / 2;
    }
    local51 = arg1.anInt235 + local16 / 2;
    @Pc(107)
    int local107 = arg1.anInt231;
    ...
    local74 =
        (int)
                (Math.atan2((double) (local28 - arg1.anInt235), (double) (local31 - arg1.anInt231))
                    / 3.141592653589793D
                    * 32767.0D)
            & 0xFFFF;
    local10.method5541(
        (float) local28 + (float) local16 / 2.0F,
        (float) local16 / 2.0F + (float) local31,
        4096,
        local74);
    @Pc(251)
    int local251 = -2;
    ...
    if (arg0.aString47 != null) {
      ...
      if (arg0.anInt4918 != 0) {
        arg2.method4293(
            local251, local255 - local251, local107, arg0.anInt4918, local257 - local107);
      }
      if (arg0.anInt4906 != 0) {
        arg2.method4295(
            local251, arg0.anInt4906, local257 - local107, -local251 + local255, local107);
      }
      for (@Pc(322) int local322 = 0; local322 < local33; local322++) {
        @Pc(328)
        String local328 = Static381.aStringArray35[local322];
    ...
    @Pc(379)
    Node_Sub14 local379 = new Node_Sub14(arg1);
    local16 >>= 0x1;
  ...
  public static void method4103(
    ...
    for (@Pc(1) int local1 = 0; local1 < Static229.anInt4407; local1++) {
      @Pc(9)
      Rectangle local9 = Node_Sub6_Sub23.aRectangleArray1[local1];
      if (arg0 < local9.width + local9.x
          && local9.x < arg2 + arg0
          && arg3 < local9.height + local9.y
          && local9.y < arg1 + arg3) {
  ...
  public static boolean method4105() {
    if (ClientSettings.hasJS) {
      try {
        if ((Boolean)
            Static458.callJavaScriptMethod(GameShell.signLink.hostApplet, "showingVideoAd")) {
          return false;
        }
        return true;
      } catch (
