...
public final class Node_Sub30 extends Node {

  @OriginalMember(owner = "client!nb", name = "m", descriptor = "Lclient!ib;")
  public HashMap aHashMap_23;
  ...
  public Node_Sub30(@OriginalArg(0) Packet arg0) {
    ...
    local46 = arg0.pos;
    local50 =
        local12 + local27 + local29 + local31 + local33 + local35 + local37 + local39 + local41;
    for (@Pc(157) int local157 = 0; local157 < local50; local157++) {
      arg0.gVarInt();
    }
    local22 += arg0.pos - local46;
    @Pc(176)
    int local176 = arg0.pos;
    @Pc(178)
    int local178 = 0;
    @Pc(180)
    int local180 = 0;
    ...
    int local294 = 0;
    @Pc(297)
    int local297 = arg0.pos;
    arg0.pos += local198;
    @Pc(306)
    int local306 = arg0.pos;
    arg0.pos += local39;
    @Pc(315)
    int local315 = arg0.pos;
    arg0.pos += local37;
    @Pc(324)
    int local324 = arg0.pos;
    arg0.pos += local35;
    @Pc(333)
    int local333 = arg0.pos;
    arg0.pos += local178;
    @Pc(342)
    int local342 = arg0.pos;
    arg0.pos += local182;
    @Pc(351)
    int local351 = arg0.pos;
    arg0.pos += local186;
    @Pc(360)
    int local360 = arg0.pos;
    arg0.pos += local31 + local33 + local39;
    @Pc(373)
    int local373 = arg0.pos;
    arg0.pos += local31;
    @Pc(382)
    int local382 = arg0.pos;
    arg0.pos += local200;
    @Pc(391)
    int local391 = arg0.pos;
    arg0.pos += local33;
    @Pc(400)
    int local400 = arg0.pos;
    arg0.pos += local180;
    @Pc(409)
    int local409 = arg0.pos;
    arg0.pos += local184;
    @Pc(418)
    int local418 = arg0.pos;
    arg0.pos += local188;
    @Pc(427)
    int local427 = arg0.pos;
    arg0.pos += local41;
    @Pc(436)
    int local436 = arg0.pos;
    arg0.pos += local35;
    @Pc(445)
    int local445 = arg0.pos;
    arg0.pos += local190;
    @Pc(454)
    int local454 = arg0.pos;
    arg0.pos += local192;
    @Pc(463)
    int local463 = arg0.pos;
    arg0.pos += local194;
    @Pc(472)
    int local472 = arg0.pos;
    arg0.pos += local196;
    @Pc(481)
    int local481 = arg0.pos;
    arg0.pos += local27 * 3;
    this.aByteArray58 = new byte[local22];
    @Pc(499)
    Packet local499 = new Packet(this.aByteArray58);
    ...
    int local541 = 0;
    @Pc(544)
    int[] local544 = new int[128];
    local202 = 0;
    label220:
    for (@Pc(548) int local548 = 0; local548 < local12; local548++) {
      local499.p4(1297379947);
      local499.pos += 4;
      @Pc(562)
      int local562 = local499.pos;
      @Pc(564)
      int local564 = -1;
      while (true) {
        while (true) {
          @Pc(568)
          int local568 = arg0.gVarInt();
          local499.pVarInt(local568);
          @Pc(580)
          int local580 = arg0.data[local294++] & 0xFF;
          @Pc(587)
          boolean local587 = local580 != local564;
          ...
          if (local580 == 23) {
            ...
            if (local564 == 0) {
              ...
              @Pc(907)
              int local907 = local772 + local544[local202];
  ...
  public void method3725() {
    this.aHashMap_23 = null;
  }

  @OriginalMember(owner = "client!nb", name = "b", descriptor = "()V")
  public void method3726() {
    if (this.aHashMap_23 != null) {
      return;
    }
    this.aHashMap_23 = new HashMap(16);
    @Pc(12)
    int[] local12 = new int[16];
    @Pc(15)
    int[] local15 = new int[16];
    local12[9] = local15[9] = 128;
    @Pc(29)
    Class175 local29 = new Class175(this.aByteArray58);
    @Pc(32)
    int local32 = local29.method4060();
    ...
    do {
      while (true) {
        @Pc(51)
        int local51 = local29.method4055();
        @Pc(56)
        int local56 = local29.anIntArray347[local51];
        while (local29.anIntArray347[local51] == local56) {
          local29.method4056(local51);
          @Pc(64)
          int local64 = local29.method4058(local51);
          if (local64 == 1) {
            local29.method4045();
          ...
          if (local80 == 144) {
            ...
            if (local99 > 0) {
              @Pc(174)
              int local174 = local15[local87];
              @Pc(182)
              Node_Sub19 local182 = (Node_Sub19) this.aHashMap_23.get((long) local174);
              if (local182 == null) {
                local182 = new Node_Sub19(new byte[128]);
                this.aHashMap_23.set((long) local174, local182);
              }
