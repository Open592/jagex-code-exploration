...
public final class Static350 {
  ...
  public static void method4720(
    ...
    label51:
    for (@Pc(22) int local22 = 0; local22 < arg0.anInt5351; local22++) {
      @Pc(31)
      long local31 = Static444.aLongArrayArrayArray2[arg1][arg2][arg3];
      @Pc(41)
      Class191 local41;
      while (local31 != 0L) {
  ...
  @OriginalMember(
      owner = "client!rq",
      name = "a",
      descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lclient!mn;")
  public static RuntimeException_Sub1 method4724(
      @OriginalArg(0) Throwable arg0, @OriginalArg(1) String arg1) {
    @Pc(9)
    RuntimeException_Sub1 local9;
