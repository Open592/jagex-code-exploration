...
public final class Class182 {
  ...
  private final Js5 aJs5_64;

  @OriginalMember(owner = "client!pj", name = "b", descriptor = "Lclient!fs;")
  public final Js5 aJs5_63;

  @OriginalMember(
      owner = "client!pj",
      name = "<init>",
      descriptor = "(Lclient!jk;ILclient!fs;Lclient!fs;)V")
  public Class182(
  ...
  public Class157 method4124(@OriginalArg(0) int arg0) {
    ...
    @Pc(40)
    byte[] local40 = this.aJs5_64.method2104(arg0, 36);
    local21 = new Class157();
    local21.anInt4914 = arg0;
    local21.aClass182_2 = this;
    if (local40 != null) {
      local21.method3784(new Packet(local40));
    }
    local21.method3781();
    @Pc(67)
    Class68 local67 = this.aClass68_33;
    synchronized (this.aClass68_33) {
  ...
  public void method4127() {
    @Pc(2)
    Class68 local2 = this.aClass68_33;
    synchronized (this.aClass68_33) {
      this.aClass68_33.clear();
    }
    local2 = this.aClass68_34;
    synchronized (this.aClass68_34) {
      this.aClass68_34.clear();
    }
  }
  ...
  public void method4128() {
    @Pc(6)
    Class68 local6 = this.aClass68_33;
    synchronized (this.aClass68_33) {
