...
public final class Class213 {
  ...
  public void method4835(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
    @Pc(4)
    int local4 = arg1 - this.anInt6230;
    @Pc(13)
    int local13 = arg0 - this.anInt6235;
  ...
  public void method4836(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
    @Pc(8)
    int local8 = arg1 - this.anInt6235;
    @Pc(21)
    int local21 = arg0 - this.anInt6230;
  ...
  public void method4837(
    ...
    @Pc(52)
    int local52 = arg4 - this.anInt6230;
    @Pc(57)
    int local57 = arg0 - this.anInt6235;
  ...
  public boolean method4840(
    ...
    if (arg1 > 1) {
      return Static455.method4305(arg1, arg5, arg1, arg4, arg0, arg7, arg6, arg2)
          ? true
          : this.method4844(arg2, arg1, arg4, arg6, arg3, arg5, arg7, arg0, arg1);
    }
    @Pc(50)
    int local50 = arg0 + arg2 - 1;
    @Pc(57)
    int local57 = arg5 + arg4 - 1;
    if (arg2 <= arg6 && local50 >= arg6 && arg5 <= arg7 && arg7 <= local57) {
      return true;
    } else if (arg6 == arg2 - 1
        && arg5 <= arg7
        && arg7 <= local57
        && (this.anIntArrayArray48[arg6 - this.anInt6230][arg7 - this.anInt6235] & 0x8) == 0
        && (arg3 & 0x8) == 0) {
      return true;
    } else if (arg6 == local50 + 1
        && arg5 <= arg7
        && arg7 <= local57
        && (this.anIntArrayArray48[arg6 - this.anInt6230][arg7 - this.anInt6235] & 0x80) == 0
        && (arg3 & 0x2) == 0) {
      return true;
    } else if (arg5 - 1 == arg7
        && arg2 <= arg6
        && arg6 <= local50
        && (this.anIntArrayArray48[arg6 - this.anInt6230][arg7 - this.anInt6235] & 0x2) == 0
        && (arg3 & 0x4) == 0) {
      return true;
    } else {
      return arg7 == local57 + 1
          && arg6 >= arg2
          && local50 >= arg6
          && (this.anIntArrayArray48[arg6 - this.anInt6230][arg7 - this.anInt6235] & 0x20) == 0
          && (arg3 & 0x1) == 0;
    }
  }
  ...
  public void method4841(
    ...
    @Pc(24)
    int local24 = arg5 - this.anInt6235;
    @Pc(29)
    int local29 = arg4 - this.anInt6230;
  ...
  public boolean method4842(
    ...
    @Pc(63)
    int local63 = arg4 - this.anInt6230;
    @Pc(68)
    int local68 = arg0 - this.anInt6235;
    @Pc(73)
    int local73 = arg2 - this.anInt6235;
    @Pc(78)
    int local78 = arg5 - this.anInt6230;
    if (arg3 == 1) {
      if (arg6 == 0) {
        if (arg1 == 0) {
          ...
          if (local63 == local78
              && local68 == local73 + 1
              && (this.anIntArrayArray48[local63][local68] & 0x2C0120) == 0) {
            return true;
          }
          if (local78 == local63
              && local73 - 1 == local68
              && (this.anIntArrayArray48[local63][local68] & 0x2C0102) == 0) {
            return true;
          }
        } else if (arg1 == 1) {
          ...
          if (local78 - 1 == local63
              && local73 == local68
              && (this.anIntArrayArray48[local63][local68] & 0x2C0108) == 0) {
            return true;
          }
          if (local78 + 1 == local63
              && local68 == local73
              && (this.anIntArrayArray48[local63][local68] & 0x2C0180) == 0) {
            return true;
          }
        } else if (arg1 == 2) {
      ...
      if (arg6 == 9) {
        if (local78 == local63
            && local73 + 1 == local68
            && (this.anIntArrayArray48[local63][local68] & 0x20) == 0) {
          return true;
        }
        if (local78 == local63
            && local68 == local73 - 1
            && (this.anIntArrayArray48[local63][local68] & 0x2) == 0) {
          return true;
        }
        if (local78 - 1 == local63
            && local68 == local73
            && (this.anIntArrayArray48[local63][local68] & 0x8) == 0) {
          return true;
        }
        if (local78 + 1 == local63
            && local73 == local68
            && (this.anIntArrayArray48[local63][local68] & 0x80) == 0) {
          return true;
        }
      }
    } else {
      @Pc(799)
      int local799 = local63 + arg3 - 1;
      @Pc(805)
      int local805 = arg3 + local68 - 1;
      if (arg6 == 0) {
        if (arg1 == 0) {
          ...
          if (local78 >= local63
              && local78 <= local799
              && local73 + 1 == local68
              && (this.anIntArrayArray48[local78][local68] & 0x2C0120) == 0) {
            return true;
          }
          if (local63 <= local78
              && local799 >= local78
              && local68 == local73 - arg3
              && (this.anIntArrayArray48[local78][local805] & 0x2C0102) == 0) {
            return true;
          }
        } else if (arg1 == 1) {
          ...
          if (local63 == local78 - arg3
              && local73 >= local68
              && local805 >= local73
              && (this.anIntArrayArray48[local799][local73] & 0x2C0108) == 0) {
            return true;
          }
          if (local63 == local78 + 1
              && local68 <= local73
              && local73 <= local805
              && (this.anIntArrayArray48[local63][local73] & 0x2C0180) == 0) {
            return true;
          }
        } else if (arg1 == 2) {
  ...
  public boolean method4844(
    ...
    @Pc(9)
    int local9 = arg1 + arg3;
    @Pc(14)
    int local14 = arg6 + arg8;
    @Pc(22)
    int local22 = arg0 + arg7;
    @Pc(26)
    int local26 = arg2 + arg5;
    @Pc(47)
    int local47;
    @Pc(54)
    int local54;
    if (arg3 == local22 && (arg4 & 0x2) == 0) {
      ...
      while (local47 < local54) {
        if ((this.anIntArrayArray48[local22 - this.anInt6230 - 1][local47 - this.anInt6235] & 0x8)
            == 0) {
          return true;
        }
        local47++;
      ...
      while (local47 < local54) {
        if ((this.anIntArrayArray48[local47 - this.anInt6230][local26 - this.anInt6235 - 1] & 0x2)
            == 0) {
          return true;
        }
        local47++;
  ...
  public void method4845(
      ...
      @OriginalArg(6) int arg5) {
    @Pc(4)
    int local4 = arg2 - this.anInt6230;
    @Pc(9)
    int local9 = arg0 - this.anInt6235;
    if (arg5 == 0) {
      if (arg3 == 0) {
  ...
  public void method4847(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
    @Pc(8)
    int local8 = arg0 - this.anInt6230;
    @Pc(17)
    int local17 = arg1 - this.anInt6235;
  ...
  public void method4848(
      ...
      @OriginalArg(6) boolean arg5) {
    @Pc(8)
    int local8 = arg3 - this.anInt6230;
    @Pc(13)
    int local13 = arg2 - this.anInt6235;
    if (arg1 == 0) {
      if (arg0 == 0) {
  ...
  public boolean method4849(
    ...
    @Pc(55)
    int local55 = arg5 - this.anInt6235;
    @Pc(60)
    int local60 = arg3 - this.anInt6230;
    @Pc(65)
    int local65 = arg1 - this.anInt6230;
    @Pc(70)
    int local70 = arg4 - this.anInt6235;
    if (arg6 == 1) {
      if (arg2 == 6 || arg2 == 7) {
        if (arg2 == 7) {
          arg0 = arg0 + 2 & 0x3;
        ...
        if (arg0 == 0) {
          if (local60 + 1 == local65
              && local70 == local55
              && (this.anIntArrayArray48[local65][local70] & 0x80) == 0) {
            return true;
          }
          if (local65 == local60
              && local70 == local55 - 1
              && (this.anIntArrayArray48[local65][local70] & 0x2) == 0) {
            return true;
          }
        } else if (arg0 == 1) {
          if (local60 - 1 == local65
              && local55 == local70
              && (this.anIntArrayArray48[local65][local70] & 0x8) == 0) {
            return true;
          }
          if (local65 == local60
              && local55 - 1 == local70
          ...
          if (local60 == local65
              && local55 + 1 == local70
              && (this.anIntArrayArray48[local65][local70] & 0x20) == 0) {
            return true;
          }
        } else if (arg0 == 3) {
          if (local60 + 1 == local65
      ...
      @Pc(414)
      int local414 = arg6 + local65 - 1;
      @Pc(420)
      int local420 = arg6 + local70 - 1;
      if (arg2 == 6 || arg2 == 7) {
        if (arg2 == 7) {
          arg0 = arg0 + 2 & 0x3;
        }
        if (arg0 == 0) {
          if (local65 == local60 + 1
              && local55 >= local70
              && local420 >= local55
              && (this.anIntArrayArray48[local65][local55] & 0x80) == 0) {
            return true;
          }
          if (local65 <= local60
              && local414 >= local60
              && local55 - arg6 == local70
              && (this.anIntArrayArray48[local60][local420] & 0x2) == 0) {
            return true;
          }
        } else if (arg0 == 1) {
          if (local65 == local60 - arg6
              && local70 <= local55
              && local55 <= local420
              && (this.anIntArrayArray48[local414][local55] & 0x8) == 0) {
            return true;
          }
          if (local65 <= local60
              && local414 >= local60
          ...
          if (local60 >= local65
              && local414 >= local60
              && local55 + 1 == local70
              && (this.anIntArrayArray48[local60][local70] & 0x20) == 0) {
            return true;
          }
        } else if (arg0 == 3) {
          if (local65 == local60 + 1
  ...
  public void method4850(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
    @Pc(8)
    int local8 = arg0 - this.anInt6235;
    @Pc(13)
    int local13 = arg1 - this.anInt6230;
  ...
  public void method4851() {
    for (@Pc(22) int local22 = 0; local22 < this.anInt6231; local22++) {
      for (@Pc(26) int local26 = 0; local26 < this.anInt6225; local26++) {
        if (local22 == 0
            || local26 == 0
            || this.anInt6231 - 5 <= local22
            || this.anInt6225 - 5 <= local26) {
