...
public final class Class255 {
	...
	private Node_Sub1_Sub6_Sub1 aClass4_Sub1_Sub6_Sub1_2;
	...
	public void method5461(@OriginalArg(1) ServerConnection serverConnection, @OriginalArg(2) boolean arg1) {
		...
		while (true) {
			@Pc(40) Node_Sub1_Sub6_Sub1 local40 = (Node_Sub1_Sub6_Sub1) this.aClass229_8.method5091();
			if (local40 == null) {
				while (true) {
					local40 = (Node_Sub1_Sub6_Sub1) this.aClass229_10.method5091();
					if (local40 == null) {
						if (this.aByte94 != 0) {
							try {
	...
	public Node_Sub1_Sub6_Sub1 method5465(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1, @OriginalArg(3) boolean arg2, @OriginalArg(4) int arg3) {
		@Pc(19) long local19 = (long) ((arg0 << 16) + arg3);
		@Pc(23) Node_Sub1_Sub6_Sub1 local23 = new Node_Sub1_Sub6_Sub1();
	...
	public boolean method5468() {
		...
		try {
			...
			for (@Pc(76) Node_Sub1_Sub6_Sub1 local76 = (Node_Sub1_Sub6_Sub1) this.aClass229_7.method5089(); local76 != null; local76 = (Node_Sub1_Sub6_Sub1) this.aClass229_7.method5092()) {
				this.aPacket_8.pos = 0;
				this.aPacket_8.p1(1);
			...
			for (@Pc(122) Node_Sub1_Sub6_Sub1 local122 = (Node_Sub1_Sub6_Sub1) this.aClass229_9.method5089(); local122 != null; local122 = (Node_Sub1_Sub6_Sub1) this.aClass229_9.method5092()) {
				this.aPacket_8.pos = 0;
				this.aPacket_8.p1(0);
				...
				if (local190 <= 0) {
					...
					if (local190 <= this.aPacket_9.pos) {
						if (this.aClass4_Sub1_Sub6_Sub1_2 == null) {
							...
							@Pc(496) Node_Sub1_Sub6_Sub1 local496;
							if (local479) {
								for (local496 = (Node_Sub1_Sub6_Sub1) this.aClass229_10.method5089(); local496 != null && local496.aLong198 != local486; local496 = (Node_Sub1_Sub6_Sub1) this.aClass229_10.method5092()) {
								}
							} else {
								for (local496 = (Node_Sub1_Sub6_Sub1) this.aClass229_8.method5089(); local496 != null && local496.aLong198 != local486; local496 = (Node_Sub1_Sub6_Sub1) this.aClass229_8.method5092()) {
								}
							}
							if (local496 == null) {
								throw new IOException();
