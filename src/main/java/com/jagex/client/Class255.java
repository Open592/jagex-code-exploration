...
public final class Class255 {
	...
	private ServerConnection aServerConnection_13;
	...
	public void method5461(@OriginalArg(1) ServerConnection arg0, @OriginalArg(2) boolean arg1) {
		if (this.aServerConnection_13 != null) {
			try {
				this.aServerConnection_13.shutdown();
			} catch (@Pc(14) Exception local14) {
			}
			this.aServerConnection_13 = null;
		}
		this.aServerConnection_13 = arg0;
		this.method5462();
