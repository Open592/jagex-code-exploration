...
public final class Class57_Sub2 extends Class57 {
  ...
  protected void method5535(
    ...
    @Pc(7)
    Class6_Sub1_Sub1 local7 = ((Class145_Sub1) arg6).aClass6_Sub1_Sub1_5;
    @Pc(14)
    float local14;
    @Pc(18)
    float local18;
    ...
    if (this.aBoolean608) {
      ...
      @Pc(39)
      float local39 = (arg4 - arg0) / local18;
      @Pc(46)
      float local46 = (arg5 - arg1) / local18;
      @Pc(52)
      float local52 = (float) this.anInt6750 * local39;
      @Pc(58)
      float local58 = local46 * (float) this.anInt6750;
      @Pc(64)
      float local64 = (float) this.anInt6763 * local25;
      @Pc(70)
      float local70 = (float) this.anInt6763 * local32;
      @Pc(77)
      float local77 = -local25 * (float) this.anInt6747;
      @Pc(84)
      float local84 = -local32 * (float) this.anInt6747;
      @Pc(91)
      float local91 = -local39 * (float) this.anInt6751;
      ...
      @Pc(128)
      float local128 = -local46 * (float) this.anInt6751;
    ...
    OpenGL.glMultiTexCoord2f(
        33985,
        local25 * (arg0 - (float) arg7),
        local7.aFloat171 - local32 * ((float) -arg8 + arg1));
    OpenGL.glVertex2f(arg0, arg1);
    OpenGL.glMultiTexCoord2f(33984, 0.0F, 0.0F);
    OpenGL.glMultiTexCoord2f(
        33985,
        ((float) -arg7 + arg4) * local25,
        local7.aFloat171 - (arg5 - (float) arg8) * local32);
    OpenGL.glVertex2f(arg4, arg5);
    OpenGL.glMultiTexCoord2f(33984, this.aClass6_Sub1_Sub1_4.aFloat172, 0.0F);
    OpenGL.glMultiTexCoord2f(
        33985,
        ((float) -arg7 + local14) * local25,
        local7.aFloat171 - ((float) -arg8 + local18) * local32);
    OpenGL.glVertex2f(local14, local18);
    OpenGL.glMultiTexCoord2f(
        33984, this.aClass6_Sub1_Sub1_4.aFloat172, this.aClass6_Sub1_Sub1_4.aFloat171);
    OpenGL.glMultiTexCoord2f(
        33985,
        local25 * (arg2 - (float) arg7),
        local7.aFloat171 - local32 * ((float) -arg8 + arg3));
  ...
  public void BA(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
    ...
    this.aClass6_Sub1_Sub1_3 =
        Static331.method4516(
            arg1,
            this.aClass6_Sub1_Sub1_4.anInt5474,
            arg0,
            this.aClass6_Sub1_Sub1_4.anInt5470,
            this.aClass19_Sub2_39);
    this.anInt6749 = arg2;
  ...
  protected void a(
    ...
    if (this.aBoolean608) {
      ...
      local14 = this.T();
      @Pc(20)
      float local20 = (arg2 - arg0) / local10;
      @Pc(26)
      float local26 = (arg3 - arg1) / local10;
      @Pc(32)
      float local32 = (arg4 - arg0) / local14;
      @Pc(39)
      float local39 = (arg5 - arg1) / local14;
      @Pc(45)
      float local45 = local32 * (float) this.anInt6750;
      @Pc(51)
      float local51 = (float) this.anInt6750 * local39;
      @Pc(57)
      float local57 = local20 * (float) this.anInt6763;
      @Pc(63)
      float local63 = local26 * (float) this.anInt6763;
      @Pc(70)
      float local70 = -local20 * (float) this.anInt6747;
      @Pc(77)
      float local77 = -local26 * (float) this.anInt6747;
      @Pc(84)
      float local84 = (float) this.anInt6751 * -local32;
      arg0 = arg0 + local57 + local45;
      arg1 = local63 + arg1 + local51;
      @Pc(103)
      float local103 = -local39 * (float) this.anInt6751;
  ...
  public void method5542(
      ...
      @OriginalArg(4) int arg4) {
    @Pc(6)
    Class145_Sub1 local6 = (Class145_Sub1) arg2;
    @Pc(9)
    ...
    this.aClass19_Sub2_39.method1958(1);
    @Pc(62)
    int local62 = arg1 + this.anInt6750;
    @Pc(67)
    int local67 = arg0 + this.anInt6763;
    @Pc(74)
    int local74 = local67 + this.aClass6_Sub1_Sub1_4.anInt5470;
    @Pc(81)
    int local81 = local62 + this.aClass6_Sub1_Sub1_4.anInt5474;
    @Pc(88)
    float local88 = local9.aFloat172 / (float) local9.anInt5470;
    @Pc(95)
    float local95 = local9.aFloat171 / (float) local9.anInt5474;
    @Pc(102)
    float local102 = local88 * (float) (local67 - arg3);
    @Pc(110)
    float local110 = local88 * (float) (local74 - arg3);
    @Pc(121)
    float local121 = local9.aFloat171 - local95 * (float) (local62 - arg4);
    @Pc(132)
    float local132 = local9.aFloat171 - local95 * (float) (local81 - arg4);
    OpenGL.glBegin(7);
    OpenGL.glColor3f(1.0F, 1.0F, 1.0F);
    OpenGL.glMultiTexCoord2f(33984, 0.0F, this.aClass6_Sub1_Sub1_4.aFloat171);
    ...
    OpenGL.glVertex2i(
        local67 + this.aClass6_Sub1_Sub1_4.anInt5470, local62 + this.aClass6_Sub1_Sub1_4.anInt5474);
    OpenGL.glMultiTexCoord2f(
        33984, this.aClass6_Sub1_Sub1_4.aFloat172, this.aClass6_Sub1_Sub1_4.aFloat171);
  ...
  public void r(
    ...
    @Pc(37)
    int local37 = arg1 + this.anInt6750;
    @Pc(42)
    int local42 = arg0 + this.anInt6763;
    if (this.aClass6_Sub1_Sub1_3 == null) {
      ...
      OpenGL.glTexCoord2f(this.aClass6_Sub1_Sub1_4.aFloat172, 0.0F);
      OpenGL.glVertex2i(
          this.aClass6_Sub1_Sub1_4.anInt5470 + local42,
          this.aClass6_Sub1_Sub1_4.anInt5474 + local37);
      OpenGL.glTexCoord2f(this.aClass6_Sub1_Sub1_4.aFloat172, this.aClass6_Sub1_Sub1_4.aFloat171);
    ...
    OpenGL.glVertex2i(
        this.aClass6_Sub1_Sub1_4.anInt5470 + local42,
        local37 - -this.aClass6_Sub1_Sub1_4.anInt5474);
    OpenGL.glMultiTexCoord2f(
        33985, this.aClass6_Sub1_Sub1_4.aFloat172, this.aClass6_Sub1_Sub1_4.aFloat171);
    OpenGL.glTexCoord2f(this.aClass6_Sub1_Sub1_4.aFloat172, this.aClass6_Sub1_Sub1_4.aFloat171);
  ...
  public void JA(
      ...
      @OriginalArg(6) int arg6) {
    @Pc(10)
    int local10 = arg0 + arg2;
    this.aClass6_Sub1_Sub1_4.method4181(false);
    @Pc(19)
    int local19 = arg1 + arg3;
    this.aClass19_Sub2_39.method1930();
    this.aClass19_Sub2_39.method1905(this.aClass6_Sub1_Sub1_4);
    ...
    if (this.aClass6_Sub1_Sub1_4.aBoolean491 && !this.aBoolean608) {
      ...
      float local73 =
          (float) arg3
              * this.aClass6_Sub1_Sub1_4.aFloat171
              / (float) this.aClass6_Sub1_Sub1_4.anInt5474;
      @Pc(85)
      float local85 =
          (float) arg2
              * this.aClass6_Sub1_Sub1_4.aFloat172
              / (float) this.aClass6_Sub1_Sub1_4.anInt5470;
      OpenGL.glBegin(7);
    ...
    int local128 = this.T();
    @Pc(135)
    int local135 = arg1 + this.aClass6_Sub1_Sub1_4.anInt5474;
    OpenGL.glBegin(7);
    @Pc(139)
    int local139 = arg1;
    @Pc(147)
    ...
    if (local19 > local139) {
      @Pc(281)
      float local281 =
          (float) (local139 + this.aClass6_Sub1_Sub1_4.anInt5474 - local19)
              * this.aClass6_Sub1_Sub1_4.aFloat171
              / (float) this.aClass6_Sub1_Sub1_4.anInt5474;
      @Pc(288)
      int local288 = arg0 + this.aClass6_Sub1_Sub1_4.anInt5470;
      local147 = arg0;
  ...
  public void MA(
    ...
    this.anInt6750 = arg1;
    this.aBoolean608 =
        this.anInt6763 != 0 || this.anInt6750 != 0 || this.anInt6747 != 0 || this.anInt6751 != 0;
  }
  ...
  public void s(
    ...
    if (this.aBoolean608) {
      @Pc(182)
      float local182 = (float) arg2 / (float) this.j();
      @Pc(189)
      float local189 = (float) arg3 / (float) this.T();
      @Pc(198)
      float local198 = local182 * (float) this.anInt6763 + (float) arg0;
      @Pc(207)
      float local207 = (float) arg1 + local189 * (float) this.anInt6750;
      @Pc(216)
      float local216 = (float) this.aClass6_Sub1_Sub1_4.anInt5470 * local182 + local198;
      @Pc(225)
      float local225 = local207 + (float) this.aClass6_Sub1_Sub1_4.anInt5474 * local189;
      if (this.aClass6_Sub1_Sub1_3 == null) {
        this.aClass19_Sub2_39.method1905(this.aClass6_Sub1_Sub1_4);
        this.aClass19_Sub2_39.method1900(arg4);
        OpenGL.glBegin(7);
