...
public final class Class236 {
  ...
  public Class236(@OriginalArg(0) Class19_Sub2 arg0, @OriginalArg(1) Class65_Sub2 arg1) {
    ...
    this.anInt6634 =
        (this.aClass65_Sub2_3.anInt5262 * this.aClass65_Sub2_3.anInt5261
                >> this.aClass19_Sub2_38.anInt2275)
            + 2;
    this.anInt6630 =
        (this.aClass65_Sub2_3.anInt5261 * this.aClass65_Sub2_3.anInt5258
                >> this.aClass19_Sub2_38.anInt2275)
            + 2;
  ...
  public boolean method5190(
      @OriginalArg(1) SecondaryNode_Sub1_Sub4 arg0,
      @OriginalArg(2) int arg1,
      @OriginalArg(3) int arg2) {
    @Pc(6)
    SecondaryNode_Sub1_Sub4_ local6 = (SecondaryNode_Sub1_Sub4_) arg0;
    arg2 += local6.anInt2727 + 1;
    arg1 += local6.anInt2725 + 1;
    @Pc(32)
    int local32 = this.anInt6634 * arg1 + arg2;
    @Pc(35)
    int local35 = local6.anInt2722;
    @Pc(38)
    int local38 = local6.anInt2728;
    @Pc(48)
    int local48;
    if (arg1 <= 0) {
      local48 = 1 - arg1;
    ...
    @Pc(67)
    int local67 = this.anInt6634 - local38;
  ...
  public void method5191(
    ...
    @Pc(39)
    float local39 = 1.0F / (float) (this.aClass19_Sub2_38.anInt2273 * 128);
    @Pc(43)
    int local43;
    @Pc(50)
    int local50;
    ...
    if (arg0) {
          ...
          for (local75 = local66; local75 < local73; local75++) {
            if (local75 - arg2 >= -arg4 && arg4 >= local75 - arg2) {
              for (@Pc(99) int local99 = local50; local99 < local57; local99++) {
                if (-arg4 <= local99 - arg1
                    && arg4 >= local99 - arg1
                    && arg3[arg4 + local75 - arg2][arg4 + local99 - arg1]) {
      ...
      for (local43 = 0; local43 < this.anInt6633; local43++) {
        ...
        for (local59 = 0; local59 < this.anInt6637; local59++) {
          ...
          @Pc(219)
          Packet local219 = Static383.aPacket_7;
          local219.pos = 0;
          for (@Pc(224) int local224 = local50; local224 < local57; local224++) {
            if (local224 - arg1 >= -arg4 && arg4 >= local224 - arg1) {
              @Pc(251)
              int local251 = local73 + this.aClass65_Sub2_3.anInt5262 * local224;
              for (@Pc(253) int local253 = local73; local253 < local75; local253++) {
                if (-arg4 <= local253 - arg2
                    && arg4 >= local253 - arg2
                    && arg3[arg4 + local253 - arg2][arg4 + local224 - arg1]) {
                  @Pc(297)
                  short[] local297 = this.aClass65_Sub2_3.aShortArrayArray9[local251];
                  if (local297 != null) {
                    @Pc(305)
                    int local305;
                    if (this.aClass19_Sub2_38.aBoolean215) {
                      for (local305 = 0; local305 < local297.length; local305++) {
                        local66++;
                        local219.p2(local297[local305] & 0xFFFF);
                      }
                    } else {
                      for (local305 = 0; local305 < local297.length; local305++) {
                        local66++;
                        local219.p2_alt1(local297[local305] & 0xFFFF);
                      }
                    }
                  }
                }
          ...
          if (local66 > 0) {
            ...
            OpenGL.glTranslatef((float) -local59 / local39, (float) -local43 / local39, 1.0F);
            OpenGL.glMatrixMode(5888);
            this.aClass125ArrayArray1[local59][local43].method3190(local219.data, local66);
          }
        }
      }
    }
  ...
  private void method5192(
    ...
    @Pc(15)
    int local15 = arg1 - 1 >> 7;
    @Pc(25)
    int local25 = arg0 + arg1 - 1 - 1 >> 7;
    @Pc(31)
    int local31 = arg2 - 1 >> 7;
    @Pc(41)
    int local41 = arg2 + arg3 - 1 - 1 >> 7;
    for (@Pc(43) int local43 = local15; local43 <= local25; local43++) {
      @Pc(50)
      Class125[] local50 = this.aClass125ArrayArray1[local43];
  ...
  public void method5193() {
    ...
    for (@Pc(24) int local24 = 0; local24 < this.anInt6633; local24++) {
      for (@Pc(28) int local28 = 0; local28 < this.anInt6637; local28++) {
        this.aClass125ArrayArray1[local28][local24] =
            new Class125(
                this.aClass19_Sub2_38,
                this,
                this.aClass65_Sub2_3,
                local28,
                local24,
                this.anInt6636,
                local28 * 128 + 1,
  ...
  public void method5194(
    ...
    @Pc(6)
    SecondaryNode_Sub1_Sub4_ local6 = (SecondaryNode_Sub1_Sub4_) arg2;
    arg0 += local6.anInt2725 + 1;
    arg1 += local6.anInt2727 + 1;
    @Pc(27)
    int local27 = arg0 * this.anInt6634 + arg1;
    @Pc(29)
    int local29 = 0;
    @Pc(32)
    int local32 = local6.anInt2722;
    @Pc(35)
    int local35 = local6.anInt2728;
    @Pc(41)
    int local41 = this.anInt6634 - local35;
    @Pc(48)
    int local48;
    if (arg0 <= 0) {
      local48 = 1 - arg0;
  ...
  public void method5195(
      ...
      @OriginalArg(2) int arg1,
      @OriginalArg(3) SecondaryNode_Sub1_Sub4 arg2) {
    @Pc(6)
    SecondaryNode_Sub1_Sub4_ local6 = (SecondaryNode_Sub1_Sub4_) arg2;
    arg1 += local6.anInt2727 + 1;
    arg0 += local6.anInt2725 + 1;
    @Pc(28)
    int local28 = arg1 + this.anInt6634 * arg0;
    @Pc(30)
    int local30 = 0;
    @Pc(33)
    int local33 = local6.anInt2722;
    @Pc(36)
    int local36 = local6.anInt2728;
    @Pc(42)
    int local42 = this.anInt6634 - local36;
    @Pc(63)
    int local63;
    if (arg0 <= 0) {
      local63 = 1 - arg0;
