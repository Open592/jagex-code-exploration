...
public final class Class3_Sub5 extends Class3 {
  ...
  public boolean method3568(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
    ...
    @Pc(10)
    int local10 = this.anInt4543 - this.anInt4542;
    @Pc(16)
    int local16 = this.anInt4541 - this.anInt4540;
    @Pc(24)
    int local24 = local10 * local10 + local16 * local16;
    @Pc(42)
    int local42 =
        arg0 * local10 + arg1 * local16 - this.anInt4542 * local10 - this.anInt4540 * local16;
    @Pc(49)
    int local49;
    @Pc(54)
    int local54;
