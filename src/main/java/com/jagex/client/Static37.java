...
public final class Static37 {
  ...
  public static void method665(
    ...
    if (arg3 > 0 && !Static424.method5413(arg3)) {
      ...
      int local45 = 0;
      @Pc(56)
      int local56 = arg2 <= arg3 ? arg2 : arg3;
      @Pc(60)
      int local60 = arg3 >> 1;
      @Pc(64)
      int local64 = arg2 >> 1;
      ...
      int[] local66 = arg0;
      @Pc(71)
      int[] local71 = new int[local60 * local64];
      while (true) {
        ...
        for (@Pc(99) int local99 = 0; local99 < local64; local99++) {
          for (@Pc(103) int local103 = 0; local103 < local60; local103++) {
            @Pc(110)
            int local110 = local66[local91++];
            @Pc(115)
            int local115 = local66[local95++];
            @Pc(120)
            int local120 = local66[local91++];
            @Pc(126)
            int local126 = local110 >> 16 & 0xFF;
            @Pc(130)
            int local130 = local110 & 0xFF;
            @Pc(136)
            int local136 = local110 >> 24 & 0xFF;
            @Pc(141)
            int local141 = local66[local95++];
            @Pc(147)
            int local147 = local110 >> 8 & 0xFF;
            @Pc(155)
            int local155 = local147 + (local120 >> 8 & 0xFF);
            @Pc(163)
            int local163 = local126 + (local120 >> 16 & 0xFF);
            @Pc(171)
            int local171 = local136 + (local120 >> 24 & 0xFF);
            @Pc(177)
            int local177 = local130 + (local120 & 0xFF);
            @Pc(183)
            int local183 = local177 + (local115 & 0xFF);
            @Pc(191)
            int local191 = local163 + (local115 >> 16 & 0xFF);
            @Pc(199)
            int local199 = local155 + (local115 >> 8 & 0xFF);
            @Pc(207)
            int local207 = local171 + (local115 >> 24 & 0xFF);
            @Pc(215)
            int local215 = local191 + (local141 >> 16 & 0xFF);
            @Pc(221)
            int local221 = local183 + (local141 & 0xFF);
            @Pc(229)
            int local229 = local207 + (local141 >> 24 & 0xFF);
            @Pc(237)
            int local237 = local199 + (local141 >> 8 & 0xFF);
            local71[local89++] =
                local221 >> 2 & 0xFF
                    | (local237 & 0x3FC) << 6
                    | (local215 & 0x3FC) << 14
