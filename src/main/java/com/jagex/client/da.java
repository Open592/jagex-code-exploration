...
public final class da extends Class110 implements Interface4 {
  ...
  @OriginalMember(
      owner = "client!da",
      name = "<init>",
      descriptor = "(Lclient!qa;Lclient!na;Lclient!jq;IIII)V")
  public da(
      @OriginalArg(0) qa arg0,
      @OriginalArg(1) na arg1,
      @OriginalArg(2) Class122 arg2,
    ...
    @Pc(24)
    int local24 = arg2.aClass29Array3 == null ? 0 : arg2.aClass29Array3.length;
    @Pc(33)
    int local33 = arg2.aClass179Array3 == null ? 0 : arg2.aClass179Array3.length;
    @Pc(35)
    int local35 = 0;
    @Pc(42)
    int[] local42 = new int[local24 * 3 + local33];
    ...
    @Pc(101)
    int local101 = arg2.aClass147Array1 == null ? 0 : arg2.aClass147Array1.length;
    @Pc(106)
    int[] local106 = new int[local101 * 8];
    @Pc(108)
    int local108 = 0;
    for (@Pc(110) int local110 = 0; local110 < local101; local110++) {
      @Pc(116)
      Class147 local116 = arg2.aClass147Array1[local110];
      @Pc(121)
      Class118 local121 = Static435.method5501(local116.anInt4526);
    ...
    for (@Pc(173) int local173 = 0; local173 < local101; local173++) {
      @Pc(179)
      Class147 local179 = arg2.aClass147Array1[local173];
  ...
  public native SecondaryNode_Sub1_Sub4 fa(@OriginalArg(0) SecondaryNode_Sub1_Sub4 arg0);
  ...
  public native void ya(
      @OriginalArg(0) da arg0,
      @OriginalArg(1) da arg1,
      @OriginalArg(2) int arg2,
      @OriginalArg(3) boolean arg3,
      @OriginalArg(4) boolean arg4);
  ...
  @OriginalMember(
      ...
      name = "q",
      descriptor =
          "(Lclient!qa;Lclient!na;II[I[I[I[I[SI[S[S[S[B[B[B[B[S[S[IB[SI[B[S[S[S[I[I[I[B[B[I[I[I[IIIIIII[I)V")
  private native void q(
      ...
      @OriginalArg(10) short[] arg10,
      @OriginalArg(11) short[] arg11,
      @OriginalArg(12) short[] arg12,
      @OriginalArg(13) byte[] arg13,
      @OriginalArg(14) byte[] arg14,
      @OriginalArg(15) byte[] arg15,
      @OriginalArg(16) byte[] arg16,
      @OriginalArg(17) short[] arg17,
      @OriginalArg(18) short[] arg18,
      @OriginalArg(19) int[] arg19,
      @OriginalArg(20) byte arg20,
      @OriginalArg(21) short[] arg21,
      @OriginalArg(22) int arg22,
      @OriginalArg(23) byte[] arg23,
      @OriginalArg(24) short[] arg24,
      @OriginalArg(25) short[] arg25,
      @OriginalArg(26) short[] arg26,
      @OriginalArg(27) int[] arg27,
      @OriginalArg(28) int[] arg28,
      @OriginalArg(29) int[] arg29,
      @OriginalArg(30) byte[] arg30,
      @OriginalArg(31) byte[] arg31,
      @OriginalArg(32) int[] arg32,
      @OriginalArg(33) int[] arg33,
      @OriginalArg(34) int[] arg34,
      @OriginalArg(35) int[] arg35,
      @OriginalArg(36) int arg36,
      @OriginalArg(37) int arg37,
      @OriginalArg(38) int arg38,
      @OriginalArg(39) int arg39,
      @OriginalArg(40) int arg40,
      @OriginalArg(41) int arg41,
      @OriginalArg(42) int[] arg42);
  ...
  public void method1184(@OriginalArg(0) int arg0, @OriginalArg(1) Class31 arg1) {
    ...
    if (this.aClass29Array1 != null) {
      for (local6 = 0; local6 < this.aClass29Array1.length; local6++) {
        @Pc(12)
        Class29 local12 = this.aClass29Array1[local6];
    ...
    for (local6 = 0; local6 < this.aClass179Array1.length; local6++) {
      @Pc(83)
      Class179 local83 = this.aClass179Array1[local6];
      @Pc(85)
      Class179 local85 = local83;
