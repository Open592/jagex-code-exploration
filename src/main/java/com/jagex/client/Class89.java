...
public final class Class89 {
  ...
  public Class89(@OriginalArg(0) byte[] arg0) {
    @Pc(8)
    Packet local8 = new Packet(arg0);
    @Pc(12)
    int local12 = local8.g1();
    if (local12 != 0) {
      throw new RuntimeException("");
    }
    @Pc(28)
    boolean local28 = local8.g1() == 1;
    this.aByteArray29 = new byte[256];
    local8.gArrayBuffer(256, this.aByteArray29);
    if (local28) {
      @Pc(44)
      int[] local44 = new int[256];
      for (@Pc(46) int local46 = 0; local46 < 256; local46++) {
        local44[local46] = local8.g1();
      }
      @Pc(63)
      int[] local63 = new int[256];
      for (@Pc(65) int local65 = 0; local65 < 256; local65++) {
        local63[local65] = local8.g1();
      }
      @Pc(80)
      byte[][] local80 = new byte[256][];
      @Pc(95)
      int local95;
        ...
        if (local178 != 32 && local178 != 160) {
          for (local143 = 0; local143 < 256; local143++) {
            if (local143 != 32 && local143 != 160) {
              this.aByteArrayArray8[local178][local143] =
                  (byte)
                      Static301.method5345(
                          local143,
                          local63,
                          local128,
                          this.aByteArray29,
      ...
      this.anInt2786 = local8.g1();
    }
    local8.g1();
    local8.g1();
    this.anInt2783 = local8.g1();
    this.anInt2778 = local8.g1();
  }

  @OriginalMember(
      owner = "client!gt",
      name = "a",
      descriptor = "([Lclient!l;[IB[Ljava/lang/String;Ljava/lang/String;)I")
  public int method2339(
      @OriginalArg(0) Class57[] arg0,
    ...
    int local33 = 0;
    @Pc(36)
    int local36 = arg3.length();
    for (@Pc(38) int local38 = 0; local38 < local36; local38++) {
      @Pc(48)
      int local48 = Cp1252.encodeChar(arg3.charAt(local38)) & 0xFF;
      @Pc(50)
      int local50 = 0;
      if (local48 == 60) {
        local29 = local38;
        ...
        if (local29 == -1) {
          ...
          local72 = local29;
          @Pc(103)
          String local103 = arg3.substring(local29 + 1, local38);
          local29 = -1;
  ...
  public int method2342(@OriginalArg(0) String arg0, @OriginalArg(2) Class57[] arg1) {
    ...
    for (@Pc(25) int local25 = 0; local25 < local18; local25++) {
      @Pc(31)
      char local31 = arg0.charAt(local25);
      if (local31 == '<') {
        local11 = local25;
      } else {
        if (local31 == '>' && local11 != -1) {
          @Pc(54)
          String local54 = arg0.substring(local11 + 1, local25);
          local11 = -1;
        ...
        if (local11 == -1) {
          local15 += this.aByteArray29[Cp1252.encodeChar(local31) & 0xFF] & 0xFF;
  ...
  @OriginalMember(
      owner = "client!gt",
      name = "a",
      descriptor = "(Ljava/lang/String;II[Lclient!l;I)I")
  public int method2345(@OriginalArg(0) String arg0, @OriginalArg(3) Class57[] arg1) {
    @Pc(11)
    int local11 = this.anInt2786;
    @Pc(24)
    int local24 = this.method2339(arg1, new int[] {100}, Static312.aStringArray25, arg0);
    @Pc(30)
    int local30 = local11 * (local24 - 1);
  ...
  @OriginalMember(
      owner = "client!gt",
      name = "a",
      descriptor = "(I[Lclient!l;Ljava/lang/String;I)Ljava/lang/String;")
  public String method2346(
      @OriginalArg(1) Class57[] arg0, @OriginalArg(2) String arg1, @OriginalArg(3) int arg2) {
    if (arg2 >= this.method2342(arg1, arg0)) {
      return arg1;
    }
    @Pc(26)
    int local26 = arg2 - this.method2342("...", null);
    @Pc(28)
    int local28 = -1;
    @Pc(30)
    int local30 = -1;
    ...
    int local32 = 0;
    @Pc(35)
    int local35 = arg1.length();
    @Pc(37)
    String local37 = "";
    for (@Pc(39) int local39 = 0; local39 < local35; local39++) {
      @Pc(45)
      char local45 = arg1.charAt(local39);
      if (local45 == '<') {
        local28 = local39;
      } else {
        if (local45 == '>' && local28 != -1) {
          @Pc(68)
          String local68 = arg1.substring(local28 + 1, local39);
          local28 = -1;
  ...
  @OriginalMember(
      owner = "client!gt",
      name = "a",
      descriptor = "(I[Lclient!l;ILjava/lang/String;)I")
  public int method2347(
      @OriginalArg(1) Class57[] arg0, @OriginalArg(2) int arg1, @OriginalArg(3) String arg2) {
  ...
  @OriginalMember(
      owner = "client!gt",
      name = "a",
      descriptor = "(BLjava/lang/String;I[Lclient!l;)I")
  public int method2349(
      @OriginalArg(1) String arg0, @OriginalArg(2) int arg1, @OriginalArg(3) Class57[] arg2) {
    @Pc(18)
    int local18 = this.method2339(arg2, new int[] {arg1}, Static312.aStringArray25, arg0);
    @Pc(20)
    int local20 = 0;
    for (@Pc(22) int local22 = 0; local22 < local18; local22++) {
      @Pc(40)
      int local40 = this.method2342(Static312.aStringArray25[local22], arg2);
      if (local20 < local40) {
        local20 = local40;
      }
    }
