...
public final class Static105 {
  ...
  public static void method1980(
    ...
    if (arg5 >= Static376.anInt6287 && Static168.anInt3256 >= arg5) {
      @Pc(56)
      int[] local56 = Static96.anIntArrayArray21[arg5];
    ...
    while (local26 > local10) {
      ...
      if (local29 >= 0) {
        ...
        if (Static376.anInt6287 <= local64 && local150 <= Static168.anInt3256) {
          if (local15 <= local26) {
            local72 =
                Static332.method4519(Static208.anInt2656, arg4 + local10, Static354.anInt6186);
            local81 =
                Static332.method4519(Static208.anInt2656, arg4 - local10, Static354.anInt6186);
            ...
            local89 =
                Static332.method4519(Static208.anInt2656, arg4 - local10, Static354.anInt6186);
            local238 =
                Static332.method4519(Static208.anInt2656, arg4 + local72, Static354.anInt6186);
            local246 =
                Static332.method4519(Static208.anInt2656, arg4 - local72, Static354.anInt6186);
            if (local64 <= Static168.anInt3256) {
      ...
      if (Static376.anInt6287 <= local64 && local150 <= Static168.anInt3256) {
        ...
        if (Static354.anInt6186 <= local72 && local81 <= Static208.anInt2656) {
          ...
          if (local10 < local15) {
            ...
            local238 =
                Static332.method4519(Static208.anInt2656, arg4 + local89, Static354.anInt6186);
            local246 =
                Static332.method4519(Static208.anInt2656, arg4 - local89, Static354.anInt6186);
            if (local64 <= Static168.anInt3256) {
              local257 = Static96.anIntArrayArray21[local64];
