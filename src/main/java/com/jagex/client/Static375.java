...
public final class Static375 {
  ...
  public static void method4999() {
    ...
    while (true) {
      while (Static168.anInt3258 < Static392.aClass78_Sub1Array1.length) {
        @Pc(30)
        Class78_Sub1 local30 = Static392.aClass78_Sub1Array1[Static168.anInt3258];
        if (local30 != null && local30.anInt3887 == -1) {
          ...
          @Pc(53)
          int local53 = Static7.aClass4_Sub42_3.anInt6883;
          if (local53 == -1) {
            return;
          }
          Static168.anInt3258++;
  ...
  public static void method5000(
      ...
      @OriginalArg(2) Class16_Sub1_Sub5_Sub1 arg2,
      @OriginalArg(4) int[] arg3) {
    for (@Pc(8) int local8 = 0; local8 < arg3.length; local8++) {
      @Pc(14)
      int local14 = arg3[local8];
      @Pc(18)
      int local18 = arg0[local8];
      @Pc(22)
      int local22 = arg1[local8];
      @Pc(24)
      int local24 = 0;
      while (local18 != 0 && local24 < arg2.aClass165Array3.length) {
        if ((local18 & 0x1) != 0) {
          if (local14 == -1) {
            ...
            @Pc(48)
            Class138 local48 = Static182.aClass55_1.method1397(local14);
            @Pc(51)
            int local51 = local48.anInt4406;
            @Pc(56)
            Class165 local56 = arg2.aClass165Array3[local24];
            if (local56 != null) {
              if (local56.anInt5139 == local14) {
                if (local51 == 0) {
                  ...
                  Static15.method156(
                      ...
                      arg2.anInt6892,
                      local48,
                      arg2 == Static1.aClass16_Sub1_Sub5_Sub1_1);
                } else if (local51 == 2) {
                  local56.anInt5143 = 0;
                }
              } else if (local48.anInt4413
                  >= Static182.aClass55_1.method1397(local56.anInt5139).anInt4413) {
                local56 = arg2.aClass165Array3[local24] = null;
              }
            }
            if (local56 == null) {
  ...
  public static void method5001(
    ...
    if (local16 && local38) {
      for (local97 = arg3; local97 <= arg1; local97++) {
        @Pc(103)
        int[] local103 = Static96.anIntArrayArray21[local97];
