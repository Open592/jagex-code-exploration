...
public final class Bzip2Decompressor {
  ...
  private static void method2375(@OriginalArg(0) Class44 arg0) {
    ...
    @Pc(56)
    boolean local56 = true;
    while (true) {
      while (local56) {
        @Pc(60)
        byte local60 = method2378(arg0);
        if (local60 == 23) {
          return;
        }
        ...
        method2380(arg0);
        @Pc(213)
        int local213 = arg0.anInt1111 + 2;
        @Pc(217)
        int local217 = method2382(3, arg0);
        @Pc(221)
        int local221 = method2382(15, arg0);
        ...
        for (local138 = 0; local138 < local221; local138++) {
          ...
          @Pc(273)
          byte local273 = local246[local248];
          while (local248 > 0) {
        ...
        for (local304 = 0; local304 < local217; local304++) {
          @Pc(309)
          int local309 = method2382(5, arg0);
        ...
        for (local304 = 0; local304 < local217; local304++) {
          ...
          method2377(
              arg0.anIntArrayArray12[local304],
              arg0.anIntArrayArray10[local304],
              arg0.anIntArrayArray11[local304],
              arg0.aByteArrayArray2[local304],
              local347,
              local349,
              local213);
        ...
        int local470 = 0;
        @Pc(473)
        int local473 = local422 + 1;
        @Pc(475)
        byte local475 = 50;
        @Pc(480)
        byte local480 = arg0.aByteArray8[0];
        @Pc(485)
        int local485 = arg0.anIntArray63[local480];
        @Pc(490)
        int[] local490 = arg0.anIntArrayArray12[local480];
        @Pc(495)
        int[] local495 = arg0.anIntArrayArray11[local480];
        @Pc(500)
        int[] local500 = arg0.anIntArrayArray10[local480];
        @Pc(501)
        int local501 = local475 - 1;
        @Pc(503)
        int local503 = local485;
        @Pc(507)
        int local507;
        @Pc(516)
        byte local516;
        for (local507 = method2382(local485, arg0);
            local507 > local490[local503];
            local507 = local507 << 1 | local516) {
          local503++;
          local516 = method2381(arg0);
        }
        @Pc(531)
        int local531 = local495[local507 - local500[local503]];
        while (true) {
          while (local531 != local420) {
            if (local531 == 0 || local531 == 1) {
              ...
              if (local669 < 16) {
                ...
                while (local669 > 3) {
                  @Pc(689)
                  int local689 = local677 + local669;
                ...
                @Pc(767)
                int local767 = local669 / 16;
                @Pc(771)
                int local771 = local669 % 16;
                ...
                @Pc(806)
                int local806 = arg0.anIntArray66[local767]++;
                while (local767 > 0) {
                  local806 = arg0.anIntArray66[local767]--;
                  arg0.aByteArray7[arg0.anIntArray66[local767]] =
                      arg0.aByteArray7[arg0.anIntArray66[local767 - 1] + 16 - 1];
                  local767--;
                }
                ...
                if (arg0.anIntArray66[0] == 0) {
                  ...
                  for (@Pc(866) int local866 = 15; local866 >= 0; local866--) {
                    for (@Pc(869) int local869 = 15; local869 >= 0; local869--) {
                      arg0.aByteArray7[local864] =
                          arg0.aByteArray7[arg0.anIntArray66[local866] + local869];
                      local864--;
                    }
  ...
  public static int uncompress(
      @OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte[] arg2) {
    synchronized (aClass44_1) {
      ...
      @Pc(37)
      int local37 = arg1 - aClass44_1.anInt1112;
  ...
  private static void method2377(
  ...
  private static void method2379(@OriginalArg(0) Class44 arg0) {
    @Pc(2)
    byte local2 = arg0.aByte13;
    @Pc(5)
    int local5 = arg0.anInt1102;
    @Pc(8)
    int local8 = arg0.anInt1101;
    @Pc(11)
    int local11 = arg0.anInt1098;
    @Pc(13)
    int[] local13 = Static393.anIntArray501;
    @Pc(16)
    int local16 = arg0.anInt1100;
    @Pc(19)
    byte[] local19 = arg0.aByteArray9;
    @Pc(22)
    int local22 = arg0.anInt1106;
    @Pc(25)
    int local25 = arg0.anInt1112;
    @Pc(27)
    int local27 = local25;
    @Pc(32)
    int local32 = arg0.anInt1113 + 1;
    label57:
    while (true) {
      if (local5 > 0) {
        while (true) {
  ...
  private static int method2382(@OriginalArg(0) int arg0, @OriginalArg(1) Class44 arg1) {
    ...
    @Pc(17)
    int local17 = arg1.anInt1108 >> arg1.anInt1110 - arg0 & (0x1 << arg0) - 1;
    arg1.anInt1110 -= arg0;
    return local17;
  }
}
