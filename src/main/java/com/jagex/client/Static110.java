...
public final class Static110 {
  ...
  public static void method2015(
    ...
    @Pc(9)
    int local9 = Static67.aClass65Array1[arg1].a(arg2, arg3);
    for (@Pc(11) int local11 = 0; local11 <= arg1; local11++) {
      if (arg4 == null || arg4[local11]) {
        @Pc(22)
        Class65 local22 = Static67.aClass65Array1[local11];
        if (local22 != null) {
  ...
  public static void method2016(@OriginalArg(0) Class247 arg0) {
    @Pc(11)
    Class247 local11 = Static12.method125(arg0);
    @Pc(17)
    int local17;
    @Pc(15)
    int local15;
  ...
  public static void method2017(
    ...
    int local15 = 0;
    @Pc(29)
    int local29 = arg3.anInt620 * ClientPreferences.preferences.anInt3449 >> 8;
    ...
    if (arg3.anInt611 == 0
        || local15 - 64 > arg3.anInt611
        || ClientPreferences.preferences.anInt3449 == 0
        || arg3.anInt619 != arg0) {
    ...
    @Pc(149)
    int local149 = (arg3.anInt611 - local15) * local29 / arg3.anInt611;
    if (arg3.aClass4_Sub15_Sub3_2 != null) {
      arg3.aClass4_Sub15_Sub3_2.method4478(local149);
    } else if (arg3.anInt616 >= 0) {
      @Pc(161)
      Class241 local161 = Static464.method5244(Static67.archive4, arg3.anInt616, 0);
      if (local161 != null) {
        @Pc(168)
        Node_Sub4_Sub1 local168 = local161.method5245().method3079(Static275.aClass261_1);
        @Pc(173)
        Node_Sub15_Sub3 local173 = Static462.method4489(local168, local149);
    ...
    if (arg3.aClass4_Sub15_Sub3_1 != null) {
      ...
      @Pc(210)
      int local210 = (int) (Math.random() * (double) arg3.anIntArray37.length);
      @Pc(218)
      Class241 local218 = Static464.method5244(Static67.archive4, arg3.anIntArray37[local210], 0);
      if (local218 != null) {
        @Pc(225)
        Node_Sub4_Sub1 local225 = local218.method5245().method3079(Static275.aClass261_1);
        @Pc(230)
        Node_Sub15_Sub3 local230 = Static462.method4489(local225, local149);
        local230.method4461(0);
        Static360.aClass4_Sub15_Sub2_2.method2954(local230);
        arg3.anInt618 =
            (int) ((double) (arg3.anInt622 - arg3.anInt623) * Math.random()) + arg3.anInt623;
