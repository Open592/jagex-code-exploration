...
public final class Class82 {
	...
	private ListNode_Sub11[] aClass4_Sub11Array1;
	...
	public Class82(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		this.anInt2673 = arg1;
		this.anInt2667 = arg0;
		this.aClass4_Sub11Array1 = new ListNode_Sub11[this.anInt2673];
	...
	public int[] method2265(@OriginalArg(1) int arg0) {
		if (this.anInt2673 == this.anInt2667) {
			...
			@Pc(24) ListNode_Sub11 local24 = this.aClass4_Sub11Array1[arg0];
			if (local24 == null) {
				this.aBoolean243 = true;
				if (this.anInt2667 > this.anInt2670) {
					local24 = new ListNode_Sub11(arg0, this.anInt2670);
					this.anInt2670++;
				} else {
					@Pc(59) ListNode_Sub11 local59 = (ListNode_Sub11) this.aClass183_18.method4139();
					local24 = new ListNode_Sub11(arg0, local59.anInt1037);
