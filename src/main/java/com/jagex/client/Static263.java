...
public final class Static263 {
  ...
  public static int method3807(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
    ...
    @Pc(20)
    int local20 = local9 << 13 ^ local9;
    @Pc(34)
    int local34 = (local20 * local20 * 15731 + 789221) * local20 + 1376312589 & Integer.MAX_VALUE;
  ...
  public static void method3809(@OriginalArg(1) int arg0) {
    ...
    Static313.anIntArrayArrayArray12 =
        new int[4][Static326.anInt5666 >> 3][Static283.anInt5187 >> 3];
    ...
    for (@Pc(40) int local40 = 0; local40 < 4; local40++) {
      Static175.aClass213Array1[local40] =
