...
public final class Js5NetResourceProvider extends Js5ResourceProvider {
	...
	private final LinkedList aLinkedList_30 = new LinkedList();
	...
	private LinkedList aLinkedList_31;
	...
	public Js5NetResourceProvider(int archive, Class222 arg1, Class222 arg2, Js5NetQueue js5NetQueue, Js5DiskCache arg4, int checksum, int version, boolean arg7) {
		...
		if (this.aClass222_3 == null) {
			...
			this.aLinkedList_31 = new LinkedList();
		}
	...
	private Js5QueueRequest method3518(int arg0, int group) {
		...
		try {
			...
			int local371 = ((local161[local161.length - 2] & 0xFF) << 8) + (local161[local161.length - 1] & 0xFF);
	...
	public void method3520() {
		if (this.aLinkedList_31 != null) {
			...
			if (this.aBoolean412) {
				...
				for (local28 = this.aLinkedList_31.tail(); local28 != null; local28 = this.aLinkedList_31.previous()) {
				...
				while (this.anInt4489 < this.index.anIntArray428.length) {
					if (this.index.anIntArray428[this.anInt4489] == 0) {
						...
						if (this.aByteArray56[this.anInt4489] == 0) {
							...
							local21 = false;
							this.aLinkedList_31.addFirst(local127);
						}
						this.anInt4489++;
					}
				}
		...
		for (Js5QueueRequest request = (Js5QueueRequest) this.groupRequests.head(); request != null; request = (Js5QueueRequest) this.groupRequests.next()) {
	...
	public int method3521() {
		if (this.index == null) {
			...
			Node local25 = this.aLinkedList_31.tail();
	...
	public void method3522() {
		if (this.aLinkedList_31 == null || this.fetchIndex() == null) {
			return;
		}

		for (Node local23 = this.aLinkedList_30.tail(); local23 != null; local23 = this.aLinkedList_30.previous()) {
			int local29 = (int) local23.hashKey;

			if (local29 < 0 || local29 >= this.index.anInt6112 || this.index.anIntArray428[local29] == 0) {
				local23.popSelf();
			} else {
	...
	public void method3512(int arg0) {
		...
		for (Node local14 = this.aLinkedList_30.tail(); local14 != null; local14 = this.aLinkedList_30.previous()) {
		...
		this.aLinkedList_30.addFirst(local43);
	}
