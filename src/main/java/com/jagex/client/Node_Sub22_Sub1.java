...
public final class Node_Sub22_Sub1 extends Node_Sub22 {
  ...
  public void method4606(@OriginalArg(1) Canvas arg0) {
    ...
    @Pc(40)
    DataBufferInt local40 = new DataBufferInt(this.anIntArray409, this.anIntArray409.length);
    @Pc(48)
    DirectColorModel local48 = new DirectColorModel(32, 16711680, 65280, 255);
    @Pc(58)
    WritableRaster local58 =
        Raster.createWritableRaster(
            local48.createCompatibleSampleModel(this.anInt5857, this.anInt5856), local40, null);
