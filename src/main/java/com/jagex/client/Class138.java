...
public final class Class138 {
  ...
  private void method3454(@OriginalArg(0) Packet arg0, @OriginalArg(1) int arg1) {
    @Pc(31)
    int local31;
    @Pc(33)
    int local33;
    ...
    if (arg1 == 1) {
      ...
      local31 = arg0.g1();
      for (local33 = 0; local33 < local31; local33++) {
        this.aBooleanArray14[arg0.g1()] = true;
      }
    } else if (arg1 == 4) {
      ...
      this.anInt4401 = arg0.g1();
    } else if (arg1 == 10) {
      this.anInt4410 = arg0.g1();
    } else if (arg1 == 11) {
  ...
  public void method3455(@OriginalArg(0) Packet arg0) {
    while (true) {
      @Pc(13)
      int local13 = arg0.g1();
      if (local13 == 0) {
  ...
  public Class110 method3456(
      @OriginalArg(0) int arg0,
      @OriginalArg(1) int arg1,
      @OriginalArg(2) int arg2,
      @OriginalArg(3) int arg3,
      @OriginalArg(4) Class110 arg4) {
    @Pc(14)
    int local14 = this.anIntArray296[arg3];
    @Pc(19)
    int local19 = this.anIntArray295[arg3];
    @Pc(27)
    SecondaryNode_Sub1_Sub17 local27 = this.aClass55_2.method1391(local19 >> 16);
    @Pc(31)
    int local31 = local19 & 0xFFFF;
    if (local27 == null) {
    ...
    if ((this.aBoolean405 || Static127.isForcedTweeningEnabled)
      ...
      @Pc(60)
      int local60 = this.anIntArray295[arg2];
      local41 = this.aClass55_2.method1391(local60 >> 16);
      arg2 = local60 & 0xFFFF;
    }
    @Pc(74)
    SecondaryNode_Sub1_Sub17 local74 = null;
    @Pc(76)
    SecondaryNode_Sub1_Sub17 local76 = null;
    @Pc(78)
    int local78 = 0;
    @Pc(80)
    int local80 = 0;
    ...
    arg1 |= 0x20;
    @Pc(281)
    Class110 local281 = arg4.method4887((byte) 1, arg1, true);
    local281.method4883(0, local14, this.aBoolean406, local31, arg2, local27, local41, arg0 - 1);
    if (local74 != null) {
      local281.method4883(
          0, local14, this.aBoolean406, local78, local80, local74, local76, arg0 - 1);
    }
    return local281;
  }
  ...
  public int method3457(
      @OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) boolean arg2) {
    @Pc(5)
    int local5 = 0;
    @Pc(7)
    int local7 = 0;
    @Pc(20)
    int local20 = this.anIntArray295[arg0];
    @Pc(22)
    SecondaryNode_Sub1_Sub17 local22 = null;
    @Pc(30)
    SecondaryNode_Sub1_Sub17 local30 = this.aClass55_2.method1391(local20 >> 16);
    @Pc(34)
    int local34 = local20 & 0xFFFF;
    if (local30 == null) {
      return 0;
    }
    if ((this.aBoolean405 || Static127.isForcedTweeningEnabled)
    ...
    if (this.anIntArray297 != null && arg2) {
      ...
      int local151;
      @Pc(164)
      SecondaryNode_Sub1_Sub17 local164;
  ...
  public Class110 method3459(
    ...
    @Pc(8)
    int local8 = this.anIntArray296[arg0];
    @Pc(13)
    int local13 = this.anIntArray295[arg0];
    @Pc(23)
    SecondaryNode_Sub1_Sub17 local23 = this.aClass55_2.method1391(local13 >> 16);
    @Pc(27)
    int local27 = local13 & 0xFFFF;
    if (local23 == null) {
    ...
    if ((this.aBoolean405 || Static127.isForcedTweeningEnabled)
      ...
      @Pc(55)
      int local55 = this.anIntArray295[arg4];
    ...
    arg6 |= 0x20;
    @Pc(150)
    Class110 local150 = arg2.method4887(arg1, arg6, true);
