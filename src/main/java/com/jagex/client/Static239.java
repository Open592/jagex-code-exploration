...
public final class Static239 {
  ...
  public static Class89 method3546(@OriginalArg(2) int arg0, @OriginalArg(3) Js5 arg1) {
    @Pc(14)
    byte[] local14 = arg1.method2104(0, arg0);
  ...
  public static void method3547(@OriginalArg(0) Node_Sub15 arg0) {
    ...
    for (@Pc(24) Node_Sub15 local24 = arg0.method4860();
        local24 != null;
        local24 = arg0.method4857()) {
      method3547(local24);
    }
  }
  ...
  public static void method3548(
    ...
    int local11 = 0;
    @Pc(16)
    int local16 = arg2 - arg6;
    @Pc(21)
    int local21 = arg4 - arg6;
    @Pc(25)
    int local25 = arg2 * arg2;
    @Pc(29)
    int local29 = arg4 * arg4;
    @Pc(33)
    int local33 = local16 * local16;
    @Pc(37)
    int local37 = local21 * local21;
    @Pc(41)
    int local41 = local29 << 1;
    @Pc(45)
    int local45 = local25 << 1;
    @Pc(49)
    int local49 = local37 << 1;
    @Pc(53)
    int local53 = local33 << 1;
    @Pc(57)
    int local57 = arg4 << 1;
    @Pc(68)
    int local68 = local21 << 1;
    @Pc(77)
    int local77 = (1 - local57) * local25 + local41;
    @Pc(85)
    int local85 = local29 - local45 * (local57 - 1);
    @Pc(95)
    int local95 = local33 * (1 - local68) + local49;
    @Pc(104)
    int local104 = local37 - local53 * (local68 - 1);
    @Pc(108)
    int local108 = local25 << 2;
    @Pc(112)
    int local112 = local29 << 2;
    @Pc(116)
    int local116 = local33 << 2;
    @Pc(120)
    int local120 = local37 << 2;
    @Pc(124)
    int local124 = local41 * 3;
    @Pc(130)
    int local130 = (local57 - 3) * local45;
    @Pc(134)
    int local134 = local49 * 3;
    @Pc(140)
    int local140 = (local68 - 3) * local53;
    @Pc(142)
    int local142 = local112;
    @Pc(148)
    int local148 = local108 * (arg4 - 1);
    @Pc(150)
    int local150 = local120;
    @Pc(156)
    int local156 = (local21 - 1) * local116;
    @Pc(179)
    int local179;
    @Pc(188)
    int local188;
    ...
    if (arg5 >= Static376.anInt6287 && Static168.anInt3256 >= arg5) {
      @Pc(170)
      int[] local170 = Static96.anIntArrayArray21[arg5];
    ...
    while (local9 > 0) {
      @Pc(237)
      boolean local237 = local9 <= local21;
      if (local77 < 0) {
        while (local77 < 0) {
          local77 += local124;
          local85 += local142;
      ...
      if (local188 >= Static376.anInt6287 && Static168.anInt3256 >= local179) {
        ...
        if (local237) {
          @Pc(417)
          int local417 =
              Static332.method4519(Static208.anInt2656, local11 + arg0, Static354.anInt6186);
          @Pc(426)
          int local426 =
              Static332.method4519(Static208.anInt2656, arg0 - local11, Static354.anInt6186);
          @Pc(433)
          int[] local433;
