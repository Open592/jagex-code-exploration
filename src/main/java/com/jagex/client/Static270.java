...
public final class Static270 {
  ...
  public static boolean method3868(@OriginalArg(1) int arg0, @OriginalArg(2) Class19 arg1) {
    @Pc(11)
    int local11 = (Static326.anInt5666 - 104) / 2;
    @Pc(17)
    int local17 = (Static283.anInt5187 - 104) / 2;
    @Pc(19)
    boolean local19 = true;
    @Pc(29)
    int local29;
    @Pc(40)
    int local40;
    ...
    local40 =
        ((int) (Math.random() * 20.0D) + 238 - 10 << 16)
                + ((int) (Math.random() * 20.0D) + 238 - 10 << 8)
                + (int) (Math.random() * 20.0D)
                + 238
                - 10
            | 0xFF000000;
    @Pc(164)
    int local164 = ((int) (Math.random() * 20.0D) + 238 - 10 | 0xFF00) << 16;
    @Pc(183)
    int local183 =
        (int) (Math.random() * 8.0D) << 16
            | (int) (Math.random() * 8.0D) << 8
            | (int) (Math.random() * 8.0D);
    @Pc(187)
    boolean[][] local187 = new boolean[Static152.anInt3061][Static152.anInt3061];
    @Pc(193)
    int local193;
    @Pc(210)
    int local210;
    ...
    @Pc(304)
    int local304;
    for (@Pc(189) int local189 = local11;
        local189 < local11 + 104;
        local189 += Static152.anInt3061) {
      for (local193 = local17; local193 < local17 + 104; local193 += Static152.anInt3061) {
        ...
        for (local210 = arg0; local210 <= 3; local210++) {
          for (local214 = 0; local214 < Static152.anInt3061; local214++) {
            for (local218 = 0; local218 < Static152.anInt3061; local218++) {
              local187[local214][local218] =
                  Static310.method4164(local189 + local214, arg0, local210, local193 + local218);
            }
          }
          Static67.aClass65Array1[local210].method4025(
              local189,
              local193,
              local189 + Static152.anInt3061,
              local193 - -Static152.anInt3061,
              local187);
          if (!Static247.aBoolean424) {
            for (local218 = -4; local218 < Static152.anInt3061; local218++) {
              for (local274 = -4; local274 < Static152.anInt3061; local274++) {
                ...
                if (local280 >= local11
                    && local17 <= local285
                    && Static310.method4164(local280, arg0, local210, local285)) {
                  local304 = local210;
                  ...
                  if (local304 >= 0) {
                    Static86.method1548(
                        ...
                        local40,
                        local285,
                        (Static152.anInt3061 - local274) * 4 - 4,
                        arg1,
                        local280,
                        local218 * 4,
                        local164);
        ...
        if (Static247.aBoolean424) {
          @Pc(357)
          Class213 local357 = Static175.aClass213Array1[arg0];
          for (local218 = 0; local218 < Static152.anInt3061; local218++) {
            for (local274 = 0; local274 < Static152.anInt3061; local274++) {
              ...
              local304 =
                  local357
                      .anIntArrayArray48[local280 - local357.anInt6230][
                      local285 - local357.anInt6235];
              if ((local304 & 0x40240000) != 0) {
                arg1.method4293(
                    local218 * 4, 4, (Static152.anInt3061 - local274) * 4 - 4, -1713569622, 4);
              } else if ((local304 & 0x800000) != 0) {
                arg1.method4256(
                    4, (Static152.anInt3061 - local274) * 4 - 4, local218 * 4, -1713569622);
              } else if ((local304 & 0x2000000) != 0) {
                arg1.method4240(
                    (Static152.anInt3061 - local274) * 4 - 4, 4, local218 * 4 + 3, -1713569622);
              } else if ((local304 & 0x8000000) != 0) {
                arg1.method4256(
                    4, (Static152.anInt3061 - local274) * 4 + 3 - 4, local218 * 4, -1713569622);
              } else if ((local304 & 0x20000000) != 0) {
                arg1.method4240(
                    (Static152.anInt3061 - local274) * 4 - 4, 4, local218 * 4, -1713569622);
              }
            }
          }
        }
        arg1.O(0, 0, Static152.anInt3061 * 4, Static152.anInt3061 * 4, local183, 2);
        Static228.aClass57_11.t(
            (local189 - local11) * 4 + 48,
            -(Static152.anInt3061 * 4) + -((local193 + -local17) * 4) + 464,
            Static152.anInt3061 * 4,
            Static152.anInt3061 * 4,
            0,
            0);
      }
    ...
    Static181.A_LINKED_LIST___25.clear();
    if (!Static247.aBoolean424) {
        ...
        for (local210 = local17; local210 < local17 + 104; local210++) {
          for (local214 = arg0; local214 <= arg0 + 1 && local214 <= 3; local214++) {
            if (Static310.method4164(local193, arg0, local214, local210)) {
              @Pc(641)
              Interface6 local641 = (Interface6) Static117.method2096(local214, local193, local210);
              if (local641 == null) {
                local641 =
                    (Interface6) Static36.method648(local214, local193, local210, Interface6.class);
              }
              if (local641 == null) {
              ...
              if (local641 != null) {
                @Pc(682)
                Class202 local682 = Static267.aClass262_2.method5560(local641.method5350());
                if (!local682.aBoolean532 || Static325.aBoolean506) {
                  ...
                  if (local682.anIntArray407 != null) {
                    for (local285 = 0; local285 < local682.anIntArray407.length; local285++) {
                      if (local682.anIntArray407[local285] != -1) {
                        @Pc(711)
                        Class202 local711 =
                            Static267.aClass262_2.method5560(local682.anIntArray407[local285]);
                  ...
                  if (local280 >= 0) {
                    @Pc(731)
                    boolean local731 = false;
                    if (local280 >= 0) {
                      @Pc(741)
                      Class157 local741 = Static348.aClass182_4.method4124(local280);
                    ...
                    local304 = local193;
                    @Pc(752)
                    int local752 = local210;
                    if (local731) {
                      @Pc(759)
                      int[][] local759 = Static175.aClass213Array1[local214].anIntArrayArray48;
                      @Pc(764)
                      int local764 = Static175.aClass213Array1[local214].anInt6230;
                      @Pc(769)
                      int local769 = Static175.aClass213Array1[local214].anInt6235;
                      for (@Pc(771) int local771 = 0; local771 < 10; local771++) {
                        @Pc(778)
                        int local778 = (int) (Math.random() * 4.0D);
                        if (local778 == 0
                            && local11 < local304
                            && local193 - 3 < local304
                            && (local759[local304 - local764 - 1][local752 - local769] & 0x2C0108)
                                == 0) {
                          local304--;
                        }
                        if (local778 == 1
                            && local304 < local11 + 104 - 1
                            && local193 + 3 > local304
                            && (local759[local304 + 1 - local764][local752 - local769] & 0x2C0180)
                                == 0) {
                          local304++;
                        }
                        if (local778 == 2
                            && local752 > local17
                            && local752 > local210 - 3
                            && (local759[local304 - local764][local752 - local769 - 1] & 0x2C0102)
                                == 0) {
                          local752--;
                        }
                        if (local778 == 3
                            && local752 < local17 + 103
                            && local210 + 3 > local752
                            && (local759[local304 - local764][local752 + 1 - local769] & 0x2C0120)
                                == 0) {
                          local752++;
                        }
                      }
      ...
      if (Static292.aClass195_2 != null) {
        ...
        for (local210 = 0; local210 < Static292.aClass195_2.anInt5679; local210++) {
          ...
          if (Static1.aClass16_Sub1_Sub5_Sub1_1.aByte82 == local214 >> 28) {
            ...
            if (local218 >= 0
                && local218 < Static326.anInt5666
                && local274 >= 0
                && local274 < Static283.anInt5187) {
              Static181.A_LINKED_LIST___25.addFirst(new Node_Sub37(local210));
            } else {
              @Pc(1041)
              Class157 local1041 =
                  Static348.aClass182_4.method4124(Static292.aClass195_2.anIntArray396[local210]);
              if (local1041.anIntArray317 != null
                  && local1041.anInt4933 + local218 >= 0
                  && Static326.anInt5666 > local1041.anInt4936 + local218
                  && local1041.anInt4925 + local274 >= 0
                  && Static283.anInt5187 > local1041.anInt4915 + local274) {
                Static181.A_LINKED_LIST___25.addFirst(new Node_Sub37(local210));
              }
            }
          }
