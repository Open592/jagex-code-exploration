...
public final class ka extends Class46 implements Interface4 {
  ...
  @OriginalMember(
      owner = "client!ka",
      name = "<init>",
      descriptor = "(Lclient!qa;Lclient!na;Lclient!gt;[Lclient!bb;[Lclient!l;)V")
  public ka(
      @OriginalArg(0) qa arg0,
      @OriginalArg(1) na arg1,
      @OriginalArg(2) Class89 arg2,
      @OriginalArg(3) Class18[] arg3,
      @OriginalArg(4) Class57[] arg4) {
    super(arg0, arg2);
    @Pc(7)
    byte[][] local7 = new byte[arg3.length][];
    @Pc(11)
    int[] local11 = new int[arg3.length];
    @Pc(15)
    int[] local15 = new int[arg3.length];
    @Pc(19)
    int[] local19 = new int[arg3.length];
    @Pc(23)
    int[] local23 = new int[arg3.length];
  ...
  @OriginalMember(
      owner = "client!ka",
      name = "ta",
      descriptor = "(Lclient!qa;Lclient!na;[[B[I[I[I[I[I)V")
