...
public final class Class16_Sub3_Sub1 extends Class16_Sub3 {
  ...
  public boolean method5341(
    ...
    @Pc(6)
    Class31 local6 = arg1.method4289();
    local6.j(super.anInt744, super.anInt739, super.anInt737);
    @Pc(31)
    Class110 local31 =
        Static444.aClass206_3
            .method4703(this.anInt755)
            .method4773(0, this.anInt756, null, 131072, -1, null, 0, arg1);
    ...
    if (this.anInt758 != -1) {
      local31 =
          Static444.aClass206_3
              .method4703(this.anInt758)
              .method4773(0, this.anInt752, null, 131072, -1, null, 0, arg1);
      if (local31 != null && local31.method4894(arg2, arg0, local6, true)) {
        return true;
      }
    }
    if (this.anInt746 != -1) {
      local31 =
          Static444.aClass206_3
              .method4703(this.anInt746)
              .method4773(0, this.anInt749, null, 131072, -1, null, 0, arg1);
      if (local31 != null && local31.method4894(arg2, arg0, local6, true)) {
        return true;
      }
    }
  ...
  public Class3_Sub3 method5339(@OriginalArg(0) Class19 arg0) {
    @Pc(6)
    Class31 local6 = arg0.method4289();
    local6.j(super.anInt744, super.anInt739, super.anInt737);
    @Pc(18)
    Class3_Sub3 local18 = Static38.method672(3);
    @Pc(46)
    Class110 local46;
    if (this.anInt746 != -1) {
      local46 =
          Static444.aClass206_3
              .method4703(this.anInt746)
              .method4773(0, this.anInt749, null, 2048, -1, null, 0, arg0);
      if (local46 != null) {
    ...
    if (this.anInt758 != -1) {
      local46 =
          Static444.aClass206_3
              .method4703(this.anInt758)
              .method4773(0, this.anInt752, null, 2048, -1, null, 0, arg0);
      if (local46 != null) {
    ...
    local46 =
        Static444.aClass206_3
            .method4703(this.anInt755)
            .method4773(0, this.anInt756, null, 2048, -1, null, 0, arg0);
    if (local46 != null) {
