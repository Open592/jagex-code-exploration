...
public final class Class16_Sub5_Sub2 extends Class16_Sub5 implements Interface6 {
  ...
  @OriginalMember(
      owner = "client!rj",
      name = "<init>",
      descriptor = "(Lclient!ya;Lclient!rd;IIIIZIIZ)V")
  public Class16_Sub5_Sub2(
    ...
    @Pc(83)
    Class149 local83 = this.method4653(local68, arg0, this.aBoolean548);
    if (local83 != null) {
  ...
  public void method5348(@OriginalArg(0) Class19 arg0) {
    @Pc(21)
    SecondaryNode_Sub1_Sub4 local21;
    if (this.aClass4_Sub1_Sub4_5 == null && this.aBoolean548) {
      @Pc(34)
      Class149 local34 = this.method4653(262144, arg0, true);
  ...
  private Class149 method4653(
      @OriginalArg(1) int arg0, @OriginalArg(2) Class19 arg1, @OriginalArg(3) boolean arg2) {
    @Pc(13)
    Class202 local13 = Static267.aClass262_2.method5560(this.aShort74 & 0xFFFF);
    @Pc(44)
    Class65 local44;
    @Pc(30)
    Class65 local30;
  ...
  public void method5337(
    ...
    if (arg2 instanceof Class16_Sub5_Sub2) {
      @Pc(5)
      Class16_Sub5_Sub2 local5 = (Class16_Sub5_Sub2) arg2;
      ...
      @Pc(28)
      Class16_Sub1_Sub6 local28 = (Class16_Sub1_Sub6) arg2;
  ...
  private Class110 method4657(@OriginalArg(1) int arg0, @OriginalArg(2) Class19 arg1) {
    if (this.aClass110_6 != null && arg1.method4269(this.aClass110_6.P(), arg0) == 0) {
      ...
      @Pc(33)
      Class149 local33 = this.method4653(arg0, arg1, false);
  ...
  public boolean method5341(
    ...
    @Pc(13)
    Class110 local13 = this.method4657(131072, arg1);
    if (local13 == null) {
      return false;
    } else {
      @Pc(18)
      Class31 local18 = arg1.method4289();
  ...
  public void method5349(@OriginalArg(1) Class19 arg0) {
    ...
    if (this.aClass4_Sub1_Sub4_5 == null && this.aBoolean548) {
      @Pc(25)
      Class149 local25 = this.method4653(262144, arg0, true);
