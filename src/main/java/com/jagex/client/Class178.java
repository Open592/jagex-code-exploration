...
public final class Class178 {
  ...
  public boolean method4093() {
    ...
    @Pc(19)
    Js5 local19 = this.aClass109_1.aJs5_41;
    synchronized (this.aClass109_1.aJs5_41) {
      for (@Pc(23) int local23 = 0; local23 < 5; local23++) {
        if (this.anIntArray355[local23] != -1
            && !this.aClass109_1.aJs5_41.method2098(0, this.anIntArray355[local23])) {
          local15 = false;
        }
      }
      return local15;
  ...
  public boolean method4095() {
    ...
    @Pc(23)
    Js5 local23 = this.aClass109_1.aJs5_41;
    synchronized (this.aClass109_1.aJs5_41) {
  ...
  public Class122 method4096() {
    ...
    @Pc(15)
    Class122[] local15 = new Class122[this.anIntArray356.length];
    @Pc(19)
    Js5 local19 = this.aClass109_1.aJs5_41;
    @Pc(23)
    int local23;
    synchronized (this.aClass109_1.aJs5_41) {
      ...
      while (true) {
        ...
        local15[local23] =
            Static370.method4948(this.aClass109_1.aJs5_41, this.anIntArray356[local23]);
        local23++;
      }
    }
  ...
  public Class122 method4099() {
    @Pc(8)
    Class122[] local8 = new Class122[5];
    @Pc(10)
    int local10 = 0;
    @Pc(14)
    Js5 local14 = this.aClass109_1.aJs5_41;
    @Pc(18)
    int local18;
    synchronized (this.aClass109_1.aJs5_41) {
      local18 = 0;
      while (true) {
        ...
        if (this.anIntArray355[local18] != -1) {
          local8[local10++] =
              Static370.method4948(this.aClass109_1.aJs5_41, this.anIntArray355[local18]);
        }
        local18++;
      }
    }
    ...
    @Pc(83)
    Class122 local83 = new Class122(local8, local10);
    if (this.aShortArray181 != null) {
