...
public final class Class88 {
  ...
  public Node_Sub32 aClass4_Sub32_1 = null;
  ...
  public Class88(@OriginalArg(0) byte[] arg0, @OriginalArg(1) Node_Sub32 arg1) {
    ...
    try {
      ...
      @Pc(42)
      int local42 = -1;
      local29.pos = local24.pos + local36;
      @Pc(57)
      int local57;
      for (@Pc(50) int local50 = 0; local50 < local36; local50++) {
        ...
        if (local65 > 0) {
          ...
          if (local57 == 2 || local57 == 9) {
            Static134.aShortArray71[local38] =
                (short)
                    (((Static134.aShortArray71[local38] & 0xFF) << 3)
                        + (Static134.aShortArray71[local38] >> 8 & 0x7));
            Static134.aShortArray74[local38] =
                (short)
                    (((Static134.aShortArray74[local38] & 0xFF) << 3)
                        + (Static134.aShortArray74[local38] >> 8 & 0x7));
            Static134.aShortArray79[local38] =
                (short)
                    (((Static134.aShortArray79[local38] & 0xFF) << 3)
                        + (Static134.aShortArray79[local38] >> 8 & 0x7));
