...
public final class Class88 {
	...
	public ListNode_Sub32 aClass4_Sub32_1 = null;
	...
	public Class88(@OriginalArg(0) byte[] arg0, @OriginalArg(1) ListNode_Sub32 arg1) {
		this.aClass4_Sub32_1 = arg1;
		try {
			@Pc(24) Packet local24 = new Packet(arg0);
			@Pc(29) Packet local29 = new Packet(arg0);
			local24.pos = 2;
			@Pc(36) int local36 = local24.g1();
			@Pc(38) int local38 = 0;
			@Pc(40) int local40 = -1;
			@Pc(42) int local42 = -1;
