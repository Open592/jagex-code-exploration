...
public final class Static454 {
  ...
  public static final LocalizedString A_LOCALIZED_STRING___89 =
      new LocalizedString("flash1:", "blinken1:", "clignotant1:", "flash1:");
  ...
  public static int method3300(
    ...
    if (Static417.aClass65Array4 == null) {
      ...
      if (arg0 < 0
          || arg2 < 0
          || Static326.anInt5666 - 1 < arg0
          || Static283.anInt5187 - 1 < arg2) {
        return 0;
      } else if (local21 >= 1
          && local25 >= 1
          && local21 <= Static326.anInt5666 - 1
          && Static283.anInt5187 - 1 >= local25) {
        @Pc(104)
        boolean local104 = (Static79.aByteArrayArrayArray2[1][arg1 >> 7][arg3 >> 7] & 0x2) != 0;
        @Pc(129)
        boolean local129;
        @Pc(148)
        boolean local148;
