...
public abstract class Node_Sub15 extends Node {
  ...
  public Node_Sub15 aClass4_Sub15_8;

  @OriginalMember(owner = "client!ti", name = "o", descriptor = "Lclient!aw;")
  public Node_Sub4 aClass4_Sub4_5;
  ...
  public abstract void method4855(
  ...
  public abstract Node_Sub15 method4857();

  @OriginalMember(owner = "client!ti", name = "b", descriptor = "([III)V")
  protected final void method4858(
      @OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
    if (this.aBoolean569) {
  ...
  public abstract Node_Sub15 method4860();
