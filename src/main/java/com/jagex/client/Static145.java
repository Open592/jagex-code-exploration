...
public final class Static145 {
  ...
  public static void method2449(
    ...
    @Pc(7)
    Node_Sub9 local7 = null;
    for (@Pc(12) Node_Sub9 local12 = (Node_Sub9) Static115.aLinkedList_15.tail();
        local12 != null;
        local12 = (Node_Sub9) Static115.aLinkedList_15.previous()) {
      if (arg5 == local12.anInt800
          && arg0 == local12.anInt793
          && arg4 == local12.anInt790
          && arg3 == local12.anInt792) {
        local7 = local12;
        break;
      }
    }
    if (local7 == null) {
      local7 = new Node_Sub9();
