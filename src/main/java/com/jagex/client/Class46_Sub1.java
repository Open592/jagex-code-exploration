...
public final class Class46_Sub1 extends Class46 {
  ...
  private void method1223(
    ...
    @Pc(14)
    int local14 = arg9 - this.aClass19_Sub1_2.lb;
    @Pc(16)
    int local16 = arg10;
    if (arg14 > arg10) {
      local16 = arg14;
    ...
    for (@Pc(58) int local58 = local16; local58 < local56; local58++) {
      @Pc(67)
      int local67 = local5[local58 - arg14] + arg13;
      @Pc(73)
      int local73 = local8[local58 - arg14];
      @Pc(75)
      int local75 = arg5;
      @Pc(82)
      int local82;
      ...
      for (@Pc(150) int local150 = -local73; local150 < 0; local150++) {
        @Pc(158)
        int local158 = arg0[arg3++] & 0xFF;
        if (local158 == 0) {
          arg4++;
        } else {
          @Pc(178)
          int local178 =
              ((arg2 & 0xFF00FF) * local158 & 0xFF00FF00) + ((arg2 & 0xFF00) * local158 & 0xFF0000)
                  >> 8;
          local158 = 256 - local158;
          @Pc(186)
          int local186 = arg1[arg4];
          arg1[arg4++] =
              (((local186 & 0xFF00FF) * local158 & 0xFF00FF00)
                          + ((local186 & 0xFF00) * local158 & 0xFF0000)
                      >> 8)
                  + local178;
        }
      }
  ...
  protected void method5051(
    ...
    @Pc(28)
    int local28 = this.anIntArray100[arg0];
    @Pc(33)
    int local33 = this.anIntArray101[arg0];
    @Pc(37)
    int local37 = this.aClass19_Sub1_2.anInt430;
    @Pc(43)
    ...
    if (local28 > 0 && local33 > 0) {
      this.method1223(
          this.aByteArrayArray3[arg0],
          this.aClass19_Sub1_2.anIntArray26,
          arg3,
          local51,
          local43,
          local28,
  ...
  protected void OA(
    ...
    arg2 += this.anIntArray103[arg0];
    @Pc(18)
    int local18 = this.anIntArray100[arg0];
    @Pc(23)
    int local23 = this.anIntArray101[arg0];
    @Pc(27)
    int local27 = this.aClass19_Sub1_2.anInt430;
    @Pc(33)
  ...
  private void method1224(
    ...
    for (@Pc(2) int local2 = -arg6; local2 < 0; local2++) {
      for (@Pc(6) int local6 = -arg5; local6 < 0; local6++) {
        @Pc(14)
        int local14 = arg0[arg3++] & 0xFF;
        if (local14 == 0) {
          arg4++;
        } else {
          @Pc(34)
          int local34 =
              ((arg2 & 0xFF00FF) * local14 & 0xFF00FF00) + ((arg2 & 0xFF00) * local14 & 0xFF0000)
                  >> 8;
          local14 = 256 - local14;
          @Pc(42)
          int local42 = arg1[arg4];
          arg1[arg4++] =
              (((local42 & 0xFF00FF) * local14 & 0xFF00FF00)
                          + ((local42 & 0xFF00) * local14 & 0xFF0000)
                      >> 8)
                  + local34;
        }
      }
