...
public final class Node_Sub6_Sub38 extends Node_Sub6 {
  ...
  private void method5455(
    ...
    @Pc(29)
    int local29 = arg1 <= 2048 ? arg1 * (arg0 + 4096) >> 12 : arg0 + arg1 - (arg1 * arg0 >> 12);
    if (local29 <= 0) {
    ...
    int local46 = arg2 * 6;
    @Pc(53)
    int local53 = arg1 + arg1 - local29;
    @Pc(62)
    int local62 = (local29 - local53 << 12) / local29;
    @Pc(66)
    int local66 = local46 >> 12;
    @Pc(73)
    int local73 = local46 - (local66 << 12);
    @Pc(81)
    int local81 = local29 * local62 >> 12;
    @Pc(87)
    int local87 = local81 * local73 >> 12;
    @Pc(92)
    int local92 = local53 + local87;
    @Pc(97)
    int local97 = local29 - local87;
    if (local66 == 0) {
  ...
  private void method5457(
    ...
    @Pc(16)
    int local16 = arg1 >= arg0 ? arg1 : arg0;
    @Pc(23)
    int local23 = arg2 > local16 ? arg2 : local16;
    @Pc(34)
    int local34 = arg0 < arg1 ? arg0 : arg1;
    @Pc(45)
    int local45 = arg2 >= local34 ? local34 : arg2;
    @Pc(50)
    int local50 = local23 - local45;
    this.anInt7034 = (local45 + local23) / 2;
    if (local50 > 0) {
      @Pc(72)
      int local72 = (local23 - arg0 << 12) / local50;
      @Pc(81)
      int local81 = (local23 - arg1 << 12) / local50;
      @Pc(90)
      int local90 = (local23 - arg2 << 12) / local50;
      if (arg0 == local23) {
    ...
    if (this.anInt7034 > 0 && this.anInt7034 < 4096) {
      this.anInt7042 =
          (local50 << 12)
              / (this.anInt7034 <= 2048 ? this.anInt7034 * 2 : 8192 - (this.anInt7034 * 2));
    } else {
      this.anInt7042 = 0;
    }
  }
  ...
  public int[][] method5514(@OriginalArg(1) int arg0) {
    ...
    if (super.aClass153_41.aBoolean437) {
      @Pc(21)
      int[][] local21 = this.method5516(0, arg0);
      @Pc(25)
      int[] local25 = local21[0];
      @Pc(29)
      int[] local29 = local21[1];
      @Pc(33)
      int[] local33 = local21[2];
      @Pc(37)
      int[] local37 = local11[0];
      @Pc(41)
      int[] local41 = local11[1];
      @Pc(45)
      int[] local45 = local11[2];
