...
public final class Static31 {
  ...
  public static void method617(@OriginalArg(0) ISAACPacket arg0) {
    @Pc(7)
    int local7 = 0;
    arg0.method1136();
    @Pc(20)
    ...
    for (local131 = 0; local131 < Static334.anInt5761; local131++) {
      ...
      if ((Static116.aByteArray63[local213] & 0x1) == 0) {
        if (local7 > 0) {
          ...
          @Pc(299)
          int local299 = arg0.method1143(1);
          if (local299 == 0) {
            local7 = Static413.method5308(arg0);
            Static116.aByteArray63[local213] = (byte) (Static116.aByteArray63[local213] | 0x2);
    ...
    for (local213 = 1; local213 < 2048; local213++) {
      ...
      @Pc(369)
      Class16_Sub1_Sub5_Sub1 local369 = Static267.aClass16_Sub1_Sub5_Sub1Array1[local213];
      if (local369 == null) {
  ...
  public static void method619(
    ...
    @Pc(5)
    int local5 = arg0 - arg8;
    @Pc(13)
    int local13 = arg4 - arg7;
    @Pc(21)
    int local21 = arg2 - arg3;
    @Pc(42)
    float local42 =
        arg5[2] * (float) local5 + (float) local13 * arg5[1] + arg5[0] * (float) local21;
    @Pc(63)
    float local63 =
        (float) local5 * arg5[5] + arg5[4] * (float) local13 + (float) local21 * arg5[3];
    @Pc(84)
    float local84 =
        arg5[8] * (float) local5 + arg5[7] * (float) local13 + (float) local21 * arg5[6];
    @Pc(99)
    float local99 =
        (float) Math.sqrt((double) (local84 * local84 + local63 * local63 + local42 * local42));
    @Pc(110)
    float local110 = (float) Math.atan2((double) local42, (double) local84) / 6.2831855F + 0.5F;
    @Pc(123)
    float local123 = (float) Math.asin((double) (local63 / local99)) / 3.1415927F + arg1 + 0.5F;
    @Pc(130)
    float local130;
    if (arg6 == 1) {
      local130 = local110;
