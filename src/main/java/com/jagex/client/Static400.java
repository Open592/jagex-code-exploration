...
public final class Static400 {
  ...
  public static void method5186(@OriginalArg(0) String command, @OriginalArg(1) boolean arg1) {
    ...
    try {
      ...
      if (command.startsWith("bloom")) {
        @Pc(812)
        boolean local812 = Static122.aClass19_16.method4301();
      ...
      if (command.equalsIgnoreCase("getheight")) {
        Static441.method5568(
            "Height: "
                + Static417.aClass65Array4[Static1.aClass16_Sub1_Sub5_Sub1_1.aByte82].l(
                    Static1.aClass16_Sub1_Sub5_Sub1_1.anInt6893 >> 7,
                    Static1.aClass16_Sub1_Sub5_Sub1_1.anInt6892 >> 7));
        return;
      }
      ...
      if (command.startsWith("cachespace")) {
        Static441.method5568(
            "I(s): "
                + Static259.aClass68_26.method1781()
                + "/"
                + Static259.aClass68_26.method1785());
        Static441.method5568(
            "I(m): "
                + Static232.aClass68_25.method1781()
                + "/"
                + Static232.aClass68_25.method1785());
        Static441.method5568(
            "O(s): "
                + Static444.aClass206_3.aClass220_1.method4944()
                + "/"
                + Static444.aClass206_3.aClass220_1.method4954());
        return;
      }
      if (command.equalsIgnoreCase("getcamerapos")) {
        Static441.method5568(
            "Pos: "
                ...
                + ","
                + (Static180.anInt3453 + (Static163.anInt3197 >> 7) >> 6)
                + ","
                + (Static86.anInt1771 + (Static145.anInt2906 >> 7) >> 6)
                + ","
                + (Static180.anInt3453 + (Static163.anInt3197 >> 7) & 0x3F)
                + ","
                + ((Static145.anInt2906 >> 7) + Static86.anInt1771 & 0x3F)
                + " Height: "
                + (Static13.method135(
                        Static163.anInt3197,
                        Static1.aClass16_Sub1_Sub5_Sub1_1.aByte82,
        ...
        Static441.method5568(
            "Look: "
                + Static1.aClass16_Sub1_Sub5_Sub1_1.aByte82
                + ","
                + (Static180.anInt3453 + Static111.anInt2379 >> 6)
                + ","
                + (Static419.anInt6924 + Static86.anInt1771 >> 6)
                + ","
                + (Static111.anInt2379 + Static180.anInt3453 & 0x3F)
                + ","
                + (Static86.anInt1771 + Static419.anInt6924 & 0x3F)
                + " Height: "
                + (Static13.method135(
                        Static111.anInt2379,
                        Static1.aClass16_Sub1_Sub5_Sub1_1.aByte82,
  ...
  public static void method5189(
    ...
    @Pc(13)
    SecondaryNode_Sub1_Sub11 local13 = Static405.method5222(arg0, 11);
    local13.method2604();
