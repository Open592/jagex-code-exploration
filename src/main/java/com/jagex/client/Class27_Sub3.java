...
public final class Class27_Sub3 extends Class27 {
  ...
  public void method3935(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
    @Pc(10)
    int local10 = this.anInt3899 * arg1 >> 12;
    @Pc(22)
    int local22 = this.anInt3894 * arg1 >> 12;
    @Pc(29)
    int local29 = arg0 * this.anInt3901 >> 12;
    @Pc(36)
    int local36 = this.anInt3898 * arg0 >> 12;
  ...
  public void method3939(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
    ...
    int local10 = this.anInt3899 * arg1 >> 12;
    @Pc(17)
    int local17 = arg1 * this.anInt3894 >> 12;
    @Pc(34)
    int local34 = arg0 * this.anInt3901 >> 12;
    @Pc(41)
    int local41 = arg0 * this.anInt3898 >> 12;
  ...
  public void method3936(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
    @Pc(10)
    int local10 = arg1 * this.anInt3899 >> 12;
    @Pc(17)
    int local17 = arg1 * this.anInt3894 >> 12;
    @Pc(24)
    int local24 = this.anInt3901 * arg0 >> 12;
    @Pc(31)
    int local31 = arg0 * this.anInt3898 >> 12;
    Static266.method3827(
        local24, super.anInt5152, local17, local10, super.anInt5154, local31, super.anInt5155);
  }
}
