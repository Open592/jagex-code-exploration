...
public final class Static238 {
  ...
  public static void method3543() {
    ...
    for (@Pc(23) int local23 = 0; local23 < 512; local23++) {
      @Pc(36)
      float local36 = ((float) (local23 >> 3) / 64.0F + 0.0078125F) * 360.0F;
      @Pc(45)
      float local45 = (float) (local23 & 0x7) / 8.0F + 0.0625F;
      for (@Pc(47) int local47 = 0; local47 < 128; local47++) {
        @Pc(54)
        float local54 = (float) local47 / 128.0F;
        @Pc(56)
        float local56 = 0.0F;
        @Pc(58)
        float local58 = 0.0F;
        ...
        float local60 = 0.0F;
        @Pc(64)
        float local64 = local36 / 60.0F;
        @Pc(67)
        int local67 = (int) local64;
        @Pc(71)
        int local71 = local67 % 6;
        @Pc(76)
        float local76 = local64 - (float) local67;
        @Pc(83)
        float local83 = (1.0F - local45) * local54;
        @Pc(92)
        float local92 = (1.0F - local76 * local45) * local54;
        @Pc(103)
        float local103 = local54 * (1.0F - local45 * (1.0F - local76));
        if (local71 == 0) {
          local60 = local83;
          local58 = local103;
          local56 = local54;
        ...
        @Pc(193)
        int local193 = (int) (local56 * 256.0F);
        @Pc(198)
        int local198 = (int) (local58 * 256.0F);
        @Pc(203)
        int local203 = (int) (local60 * 256.0F);
        @Pc(217)
        int local217 = local203 + (local193 << 16) + (local198 << 8) - 16777216;
  ...
  public static Class110 method3545(
