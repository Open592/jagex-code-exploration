...
public final class Node_Sub6_Sub22 extends Node_Sub6 {
  ...
  public int[] method5510(@OriginalArg(1) int arg0) {
    ...
    if (super.aClass82_41.aBoolean243) {
      @Pc(29)
      int[] local29 = this.method5508(arg0, 1);
      @Pc(35)
      int[] local35 = this.method5508(arg0, 2);
      for (@Pc(37) int local37 = 0; local37 < Static80.anInt1616; local37++) {
        @Pc(47)
        int local47 = local29[local37] >> 4 & 0xFF;
        @Pc(56)
        int local56 = local35[local37] * this.anInt4463 >> 12;
        @Pc(64)
        int local64 = Static345.anIntArray416[local47] * local56 >> 12;
        @Pc(72)
        int local72 = local56 * Static277.anIntArray336[local47] >> 12;
        @Pc(80)
        int local80 = local37 + (local64 >> 12) & Static203.anInt3883;
        @Pc(88)
        int local88 = Static211.anInt3929 & (local72 >> 12) + arg0;
        @Pc(94)
        int[] local94 = this.method5508(local88, 0);
  ...
  public int[][] method5514(@OriginalArg(1) int arg0) {
    ...
    if (super.aClass153_41.aBoolean437) {
      @Pc(21)
      int[] local21 = this.method5508(arg0, 1);
      @Pc(27)
      int[] local27 = this.method5508(arg0, 2);
      @Pc(31)
      int[] local31 = local11[0];
      @Pc(35)
      int[] local35 = local11[1];
      @Pc(39)
      int[] local39 = local11[2];
      for (@Pc(41) int local41 = 0; local41 < Static80.anInt1616; local41++) {
        @Pc(53)
        int local53 = local21[local41] * 255 >> 12 & 0xFF;
        @Pc(62)
        int local62 = this.anInt4463 * local27[local41] >> 12;
        @Pc(70)
        int local70 = Static345.anIntArray416[local53] * local62 >> 12;
        @Pc(78)
        int local78 = Static277.anIntArray336[local53] * local62 >> 12;
        @Pc(86)
        int local86 = Static203.anInt3883 & local41 + (local70 >> 12);
        @Pc(94)
        int local94 = Static211.anInt3929 & arg0 + (local78 >> 12);
        @Pc(100)
        int[][] local100 = this.method5516(0, local94);
