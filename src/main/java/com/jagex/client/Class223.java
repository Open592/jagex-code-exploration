...
public final class Class223 {
  ...
  public Class223(
    ...
    if (this.aJs5_86 == null) {
      ...
      this.anInt6400 = this.aJs5_86.method2108(16);
    }
  }
  ...
  public void method5002() {
    @Pc(6)
    Class68 local6 = this.aClass68_45;
    synchronized (this.aClass68_45) {
      this.aClass68_45.clear();
    }
  }
  ...
  public Class111 method5004(@OriginalArg(0) int arg0) {
    ...
    @Pc(33)
    byte[] local33 = this.aJs5_86.method2104(arg0, 16);
    local16 = new Class111();
    if (local33 != null) {
      local16.method2810(new Packet(local33));
    }
    @Pc(49)
    Class68 local49 = this.aClass68_45;
    synchronized (this.aClass68_45) {
  ...
  public void method5005() {
    @Pc(2)
    Class68 local2 = this.aClass68_45;
    synchronized (this.aClass68_45) {
