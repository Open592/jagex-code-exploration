...
public abstract class GameShell extends Applet implements Runnable, FocusListener, WindowListener {
  ...
  public static void method873() {
    for (@Pc(1) int local1 = 0; local1 < Static1.anInt6; local1++) {
      @Pc(6)
      Class16_Sub1 local6 = Static427.aClass16_Sub1Array3[local1];
  ...
  public static void method875(
      ...
      @OriginalArg(8) float arg7,
      @OriginalArg(9) int arg8,
      @OriginalArg(10) int arg9) {
    @Pc(5)
    int local5 = arg3 - arg2;
    @Pc(13)
    int local13 = arg5 - arg6;
    @Pc(17)
    int local17 = arg0 - arg9;
    @Pc(38)
    float local38 =
        (float) local17 * arg4[2] + (float) local5 * arg4[1] + arg4[0] * (float) local13;
    @Pc(59)
    float local59 =
        arg4[3] * (float) local13 + (float) local5 * arg4[4] + arg4[5] * (float) local17;
    @Pc(80)
    float local80 =
        arg4[7] * (float) local5 + (float) local13 * arg4[6] + arg4[8] * (float) local17;
    @Pc(91)
    float local91 = (float) Math.atan2((double) local38, (double) local80) / 6.2831855F + 0.5F;
    if (arg7 != 1.0F) {
      local91 *= arg7;
    }
    @Pc(105)
    float local105 = arg1 + local59 + 0.5F;
    @Pc(112)
    float local112;
    if (arg8 == 1) {
      local112 = local91;
  ...
  public static void method878(
    ...
    @Pc(43)
    int local43 = (Static128.aShort24 - Static298.aShort67) * local21 / 100 + Static298.aShort67;
    ...
    @Pc(69)
    int local69 = arg4 * 512 * local43 / (arg1 * 334);
    @Pc(106)
    int local106;
    @Pc(112)
    int local112;
    ...
    for (@Pc(3) int local3 = 0; local3 < Static422.anInt6945; local3++) {
      for (@Pc(6) int local6 = 0; local6 < Static171.anInt3361; local6++) {
        if (Static202.aClass164ArrayArrayArray5[arg0][local3][local6] == null) {
          Static202.aClass164ArrayArrayArray5[arg0][local3][local6] =
              new Class164(arg0, local3, local6);
        }
      }
    }
  }
  ...
  public static void method884() {
    for (@Pc(11) int local11 = 0; local11 < Static12.anInt163; local11++) {
      @Pc(17)
      int local17 = Static342.anIntArray412[local11];
      @Pc(21)
  ...
  public static void method3558(
    ...
    int local16 = 0;
    @Pc(21)
    int local21 = arg2 - arg4;
    @Pc(25)
    int local25 = arg1 - arg4;
    @Pc(29)
    int local29 = arg2 * arg2;
    @Pc(33)
    int local33 = arg1 * arg1;
    @Pc(37)
    int local37 = local21 * local21;
    @Pc(41)
    int local41 = local25 * local25;
    @Pc(45)
    int local45 = local33 << 1;
    @Pc(49)
    int local49 = local29 << 1;
    @Pc(53)
    int local53 = local41 << 1;
    @Pc(57)
    int local57 = local37 << 1;
    @Pc(61)
    int local61 = arg1 << 1;
    @Pc(65)
    int local65 = local25 << 1;
    @Pc(75)
    int local75 = local29 * (1 - local61) + local45;
    @Pc(84)
    int local84 = local33 - (local61 - 1) * local49;
    @Pc(93)
    int local93 = local53 + (1 - local65) * local37;
    @Pc(101)
    int local101 = local41 - local57 * (local65 - 1);
    @Pc(105)
    int local105 = local29 << 2;
    @Pc(109)
    int local109 = local33 << 2;
    @Pc(113)
    int local113 = local37 << 2;
    @Pc(117)
    int local117 = local41 << 2;
    @Pc(121)
    int local121 = local45 * 3;
    @Pc(127)
    int local127 = local49 * (local61 - 3);
    @Pc(131)
    int local131 = local53 * 3;
    @Pc(137)
    int local137 = (local65 - 3) * local57;
    @Pc(139)
    int local139 = local109;
    @Pc(145)
    int local145 = (arg1 - 1) * local105;
    @Pc(147)
    int local147 = local117;
    @Pc(153)
    int local153 = (local25 - 1) * local113;
    @Pc(157)
    int[] local157 = Static96.anIntArrayArray21[arg0];
    ...
    while (local14 > 0) {
      @Pc(205)
      boolean local205 = local25 >= local14;
      if (local75 < 0) {
        while (local75 < 0) {
          local84 += local139;
          local75 += local121;
      ...
      local14--;
      @Pc(342)
      int local342 = arg0 - local14;
      @Pc(346)
      int local346 = local14 + arg0;
      @Pc(350)
      int local350 = local12 + arg5;
      @Pc(354)
      int local354 = arg5 - local12;
      if (local205) {
        @Pc(378)
        int local378 = arg5 + local16;
        @Pc(383)
        int local383 = arg5 - local16;
    ...
    try {
      ...
      try {
        ...
        canvasGraphics.drawImage(
            Static253.loadingBoxImage, Static141.width / 2 - 152, Static302.height / 2 + -18, null);
      } catch (Exception e) {
        ...
        canvasGraphics.fillRect(
            currentProgress * 3 + local155 + 2, local161 - -2, 300 - currentProgress * 3, 30);

        canvasGraphics.setFont(helveticaBoldFont);
        canvasGraphics.setColor(textColor);
        canvasGraphics.drawString(
            message, (304 - message.length() * 6) / 2 + local155, local161 - -22);
      }
      ...
      if (gameNameIsLoadingPleaseWaitMessage != null) {
        ...
        canvasGraphics.drawString(
            ...
            Static141.width / 2 - gameNameIsLoadingPleaseWaitMessage.length() * 6 / 2,
            Static302.height / 2 - 26);
      }
    } catch (Exception e) {
      canvas.repaint();
    }
    ...
    if (Static281.aClass247_12 == null) {
      if (!Static234.aBoolean411 && Static407.anInt6710 > 0) {
        if (Static434.isShiftClickEnabled
          ...
          return ((Node_Sub39) Static206.A_LINKED_LIST___28.sentinelNode.next.next).anInt5698;
        }
        return ((Node_Sub39) Static206.A_LINKED_LIST___28.sentinelNode.next).anInt5698;
      }
      @Pc(20)
      int local20 = Static420.aClass80_1.method2234();
      @Pc(24)
      int local24 = Static420.aClass80_1.method2230();
      @Pc(26)
      int local26 = Static310.anInt5424;
      @Pc(28)
      int local28 = Static172.anInt3367;
      @Pc(30)
      int local30 = Static173.anInt3370;
      if (local20 > local26 && local30 + local26 > local20) {
        ...
        if (local44 != -1) {
          local64 = 0;
          @Pc(133)
          Class63 local133 = new Class63(Static206.A_LINKED_LIST___28);
          for (@Pc(138) Node_Sub39 local138 = (Node_Sub39) local133.method1611();
              local138 != null;
              local138 = (Node_Sub39) local133.method1612()) {
            if (local64++ == local44) {
  ...
  public static void method4020(
    ...
    if (fullScreenFrame != null) {
      ...
      local91 = frame.getInsets();
      Static425.anInt7000 = frame.getSize().width - local91.left - local91.right;
      @Pc(108)
      int local108 = -local91.bottom;
      Static17.anInt222 = frame.getSize().height + local108 - local91.top;
      local78 = frame;
    }
    @Pc(166)
    int local166;
    if (arg0 == 1) {
      ...
      @Pc(173)
      int local173 = Static17.anInt222 > 768 ? 768 : Static17.anInt222;
    ...
    if (arg3) {
      ...
      Static122.aClass19_16.method4272(canvas);
      if (local78 == frame) {
        local91 = frame.getInsets();
        canvas.setLocation(local91.left + Static230.xPOS, local91.top - -Static303.yPOS);
      } else {
    ...
    if (Static125.aServerConnection_5 != null
        && (Static403.anInt6667 == 30 || Static403.anInt6667 == 25)) {
      Static1.method5();
    }
  ...
  private void triggerGameLogicStep() {
    ...
    @Pc(17)
    long previousTimeInMilliseconds = aLongArray6[anInt290];
    ...
    if (previousTimeInMilliseconds == 0L
  ...
  protected final void handleGameError(@OriginalArg(1) String arg0) {
    ...
    try {
      this.getAppletContext()
          .showDocument(new URL(this.getCodeBase(), "error_game_" + arg0 + ".ws"), "_top");
    } catch (
        @Pc(51)
        Exception ignored) {
    }
  ...
  public final AppletContext getAppletContext() {
    if (frame == null) {
      return signLink == null || signLink.hostApplet == this
          ? super.getAppletContext()
          : signLink.hostApplet.getAppletContext();
    } else {
      return null;
    }
  }
  ...
  public final synchronized void method874() {
    ...
    if (local18 == frame) {
      @Pc(60)
      Insets local60 = frame.getInsets();
  ...
  public final synchronized void paint(@OriginalArg(0) Graphics arg0) {
    ...
    aBoolean189 = true;
    if (isRunningModernJavaVersion
        && MonotonicClock.getCurrentTimeInMilliseconds() - aLong59 > 1000L) {
      @Pc(24)
      Rectangle local24 = arg0.getClipBounds();
      if (local24 == null
          || Static425.anInt7000 <= local24.width && Static17.anInt222 <= local24.height) {
  ...
  public final String getParameter(@OriginalArg(0) String arg0) {
    if (frame == null) {
      return signLink == null || signLink.hostApplet == this
          ? super.getParameter(arg0)
          : signLink.hostApplet.getParameter(arg0);
    } else {
      return null;
    }
  }
  ...
  private void shutdown(@OriginalArg(1) boolean clean) {
    ...
    if (signLink.hostApplet != null) {
      signLink.hostApplet.destroy();
    }
    ...
    @Pc(48)
    Message local48 =
        signLink.emitPerformClassLoaderNativeLibrariesCleanupMessage(instance.getClass());
  ...
  public final void method877() {
    ...
    try {
      @Pc(22)
      Message local22 = signLink.emitLoadJagMiscNativesMessage(instance.getClass());
  ...
  public final void destroy() {
    if (instance == this && !Static438.aBoolean675) {
      ...
      ThreadingUtilities.sleepFor(5000L);
  ...
  protected final void load(
      @OriginalArg(1) int modewhat, @OriginalArg(2) int height, @OriginalArg(3) int width) {
    try {
      if (instance == null) {
        Static303.yPOS = 0;
        Static230.xPOS = 0;
        ...
        if (signLink == null) {
          Static386.signLink = signLink = new SignLink(this, modewhat, null, 0);
        }

        @Pc(67)
        Message threadInitializationMessage = signLink.emitThreadInitializationMessage(1, this);
    ...
    try {
      gameLoop:
      {
        if (SignLink.javaVendor != null) {
          @Pc(10)
          String javaVendorLowerCase = SignLink.javaVendor.toLowerCase();
          ...
          if (javaVendorLowerCase.contains("sun") || javaVendorLowerCase.contains("apple")) {
            ...
            if (javaVersion.equals("1.1")
                ...
                || javaVersion.equals("1.2")
                || javaVersion.startsWith("1.2.")) {
              this.handleGameError("wrongjava");

              break gameLoop;
            }
          } else if (javaVendorLowerCase.contains("ibm")
        ...
        if (SignLink.javaVersion != null && SignLink.javaVersion.startsWith("1.")) {
          ...
          while (SignLink.javaVersion.length() > versionStringPOS) {
            @Pc(78)
            char numChar = SignLink.javaVersion.charAt(versionStringPOS);
        ...
        if (signLink.hostApplet != null) {
          ...
          if (setFocusCycleRoot != null) {
            try {
              setFocusCycleRoot.invoke(signLink.hostApplet, Boolean.TRUE);
            } catch (
                @Pc(129)
                Throwable ignored) {
            }
        ...
        while (timeToShutdown == 0L
            || MonotonicClock.getCurrentTimeInMilliseconds() < timeToShutdown) {
          ...
          Static441.waitForSystemEventQueueToDrain(signLink, canvas);
        }
      }
    } catch (
        @Pc(190)
  ...
  protected final void method885(@OriginalArg(5) String arg0, @OriginalArg(7) int arg1) {
    try {
      ...
      frame.toFront();
      @Pc(38)
      Insets local38 = frame.getInsets();
      frame.setSize(
          local38.right + Static425.anInt7000 + local38.left,
          local38.bottom + Static17.anInt222 + local38.top);
      Static386.signLink = signLink = new SignLink(null, arg1, arg0, 30);
      @Pc(70)
      Message local70 = signLink.emitThreadInitializationMessage(1, this);
  ...
  public final URL getDocumentBase() {
    if (frame == null) {
      return signLink == null || signLink.hostApplet == this
          ...
          : signLink.hostApplet.getDocumentBase();
    } else {
      return null;
    }
  }
  ...
  public final URL getCodeBase() {
    if (frame == null) {
      return signLink == null || signLink.hostApplet == this
          ? super.getCodeBase()
          : signLink.hostApplet.getCodeBase();
    } else {
      return null;
    }
  }
  ...
  private void triggerGraphicsStep() {
    ...
    if (graphicsStepCount++ > 50) {
      ...
      if (frame != null && fullScreenFrame == null) {
        @Pc(86)
        Insets local86 = frame.getInsets();
