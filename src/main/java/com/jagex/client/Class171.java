...
public final class Class171 {
  ...
  private Node_Sub4_Sub1 method3970(
      @OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int[] arg2) {
    @Pc(15)
    int local15 = (arg0 << 4 & 0xFFF4 | arg0 >>> 12) ^ arg1;
    @Pc(21)
    int local21 = local15 | arg0 << 16;
    @Pc(24)
    long local24 = (long) local21;
    @Pc(31)
    Node_Sub4_Sub1 local31 = (Node_Sub4_Sub1) this.aHashMap_26.get(local24);
    if (local31 != null) {
      return local31;
    } else if (arg2 == null || arg2[0] > 0) {
      @Pc(54)
      Class241 local54 = Static464.method5244(this.aJs5_57, arg0, arg1);
      if (local54 == null) {
        return null;
      }
  ...
  private Node_Sub4_Sub1 method3972(
      @OriginalArg(0) int arg0, @OriginalArg(1) int[] arg1, @OriginalArg(3) int arg2) {
    @Pc(15)
    int local15 = arg2 ^ (arg0 << 4 & 0xFFF2 | arg0 >>> 12);
    @Pc(26)
    int local26 = local15 | arg0 << 16;
    @Pc(31)
    long local31 = (long) local26 ^ 0x100000000L;
    @Pc(38)
    Node_Sub4_Sub1 local38 = (Node_Sub4_Sub1) this.aHashMap_26.get(local31);
    if (local38 != null) {
      return local38;
    } else if (arg1 == null || arg1[0] > 0) {
      @Pc(57)
      Node_Sub13 local57 = (Node_Sub13) this.aHashMap_25.get(local31);
      if (local57 == null) {
