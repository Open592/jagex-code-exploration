...
public final class Static1 {
  ...
  public static final boolean[][] aBooleanArrayArray1 =
      new boolean[][] {
        new boolean[4],
  ...
  public static void method1() {
    for (@Pc(14) Node_Sub9 local14 = (Node_Sub9) Static115.aLinkedList_15.tail();
        local14 != null;
        local14 = (Node_Sub9) Static115.aLinkedList_15.previous()) {
      if (local14.anInt796 == -1) {
        local14.anInt799 = 0;
        if (local14.anInt793 >= 0
            && local14.anInt790 >= 0
            && Static326.anInt5666 > local14.anInt793
            && Static283.anInt5187 > local14.anInt790) {
  ...
  public static void method3() {
    ...
    if (Static361.aBoolean570 && Static390.aBoolean584) {
      @Pc(32)
      int local32 = Static420.aClass80_1.method2234();
      @Pc(36)
      int local36 = Static420.aClass80_1.method2230();
      local32 -= Static187.anInt3559;
      local36 -= Static452.anInt7359;
      if (local32 < Static455.anInt5535) {
        local32 = Static455.anInt5535;
      }
      if (Static57.aClass247_1.anInt6833 + Static455.anInt5535
          < local32 + Static281.aClass247_12.anInt6833) {
        local32 =
            Static455.anInt5535 + Static57.aClass247_1.anInt6833 - Static281.aClass247_12.anInt6833;
      }
      if (Static373.anInt6383 > local36) {
        local36 = Static373.anInt6383;
      }
      if (local36 + Static281.aClass247_12.anInt6805
          > Static57.aClass247_1.anInt6805 + Static373.anInt6383) {
        local36 =
            Static373.anInt6383 + Static57.aClass247_1.anInt6805 - Static281.aClass247_12.anInt6805;
      }
      @Pc(110)
      int local110 = local32 + Static57.aClass247_1.anInt6825 - Static455.anInt5535;
      @Pc(118)
      int local118 = Static57.aClass247_1.anInt6849 + local36 - Static373.anInt6383;
      @Pc(172)
      Node_Sub34 local172;
      if (Static420.aClass80_1.method2228()) {
        if (Static315.anInt5487 > Static281.aClass247_12.anInt6786) {
          @Pc(130)
          int local130 = local32 - Static247.anInt4615;
          @Pc(135)
          int local135 = local36 - Static374.anInt6394;
          if (Static281.aClass247_12.anInt6795 < local130
              || -Static281.aClass247_12.anInt6795 > local130
              || Static281.aClass247_12.anInt6795 < local135
              || local135 < -Static281.aClass247_12.anInt6795) {
        ...
        if (Static15.aBoolean22) {
          ...
          Static102.method1794(
              Static187.anInt3559 + Static247.anInt4615, Static374.anInt6394 + Static452.anInt7359);
