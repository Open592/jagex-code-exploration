...
public final class Static38 {
  ...
  public static final LocalizedString A_LOCALIZED_STRING___19 =
      new LocalizedString("Discard", "Ablegen", "Jeter", "Descartar");
  ...
  public static void method670(@OriginalArg(0) int arg0) {
    @Pc(16)
    SecondaryNode_Sub1_Sub11 local16 = Static405.method5222(arg0, 1);
    local16.method2608();
  }

  @OriginalMember(owner = "client!bs", name = "a", descriptor = "(ZB[BLclient!fd;IIII)Lclient!ps;")
  public static Class6_Sub1_Sub1 method671(
      @OriginalArg(2) byte[] arg0,
      @OriginalArg(3) Class19_Sub2 arg1,
    ...
    if (arg1.aBoolean213 || Static424.method5413(arg2) && Static424.method5413(arg3)) {
      ...
      return new Class6_Sub1_Sub1(
          ...
          arg2,
          arg3,
          Static370.method4949(arg2),
          Static370.method4949(arg3),
          arg0,
          6406);
    }
  }
  ...
  public static Class3_Sub3 method672(@OriginalArg(0) int arg0) {
    @Pc(7)
    Class84[] local7 = Class147.aClass84Array1;
    synchronized (Class147.aClass84Array1) {
      ...
      if (Class147.aClass84Array1.length <= arg0 || Class147.aClass84Array1[arg0].method2313()) {
        ...
        local36.method5676();
        @Pc(75)
        int local75 = Static95.anIntArray154[arg0]--;
      }
      return local36;
    }
  }
  ...
  public static void method673() {
    @Pc(9)
    int[] local9 = new int[Static444.aClass206_3.anInt5987];
    @Pc(11)
    int local11 = 0;
    for (@Pc(17) int local17 = 0; local17 < Static444.aClass206_3.anInt5987; local17++) {
      @Pc(24)
      Class211 local24 = Static444.aClass206_3.method4703(local17);
