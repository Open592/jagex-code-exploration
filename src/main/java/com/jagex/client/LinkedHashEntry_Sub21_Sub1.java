...
public final class LinkedHashEntry_Sub21_Sub1 extends LinkedHashEntry_Sub21 {

	@OriginalMember(owner = "client!hc", name = "<init>", descriptor = "(IIIIIF)V")
	public LinkedHashEntry_Sub21_Sub1(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) float arg5) {
