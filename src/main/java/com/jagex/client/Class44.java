...
public final class Class44 {
  ...
  public final byte[] aByteArray8 = new byte[18002];
  ...
  public final int[] anIntArray63 = new int[6];

  @OriginalMember(owner = "client!cu", name = "m", descriptor = "[[I")
  public final int[][] anIntArrayArray10 = new int[6][258];

  @OriginalMember(owner = "client!cu", name = "z", descriptor = "[[I")
  public final int[][] anIntArrayArray11 = new int[6][258];

  @OriginalMember(owner = "client!cu", name = "w", descriptor = "[I")
  public final int[] anIntArray64 = new int[257];

  @OriginalMember(owner = "client!cu", name = "C", descriptor = "[[I")
  public final int[][] anIntArrayArray12 = new int[6][258];
  ...
  public final byte[][] aByteArrayArray2 = new byte[6][258];
  ...
  public final int[] anIntArray67 = new int[256];

  @OriginalMember(owner = "client!cu", name = "f", descriptor = "[B")
  public final byte[] aByteArray7 = new byte[4096];

  @OriginalMember(owner = "client!cu", name = "H", descriptor = "[I")
  public final int[] anIntArray66 = new int[16];
}
