...
public final class Node_Sub32 extends Node {
  ...
  public Node_Sub32(@OriginalArg(0) int arg0, @OriginalArg(1) byte[] arg1) {
    this.anInt4984 = arg0;
    @Pc(11)
    Packet local11 = new Packet(arg1);
    this.anInt4981 = local11.g1();
    ...
    for (@Pc(38) int local38 = 0; local38 < this.anInt4981; local38++) {
      this.anIntArray318[local38] = local11.g1();
    }
    ...
    for (@Pc(118) int local118 = 0; local118 < this.anInt4981; local118++) {
      for (@Pc(122) int local122 = 0;
          local122 < this.anIntArrayArray42[local118].length;
          local122++) {
        this.anIntArrayArray42[local118][local122] = local11.g1();
      }
    }
  }
}
