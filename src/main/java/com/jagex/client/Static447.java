...
public final class Static447 {
  ...
  public static final int[][] anIntArrayArray65 =
      new int[][] {
        {6, 6},
        {6, 6},
        {6, 5, 5},
  ...
  public static void method5628(
      @OriginalArg(0) Class16_Sub1_Sub5 arg0,
      @OriginalArg(1) int arg1,
      @OriginalArg(2) int arg2,
      @OriginalArg(3) int arg3) {
    @Pc(11)
    Class151 local11 = arg0.method4757();
    @Pc(20)
    int local20 = arg0.anInt6063 - arg0.aClass35_7.anInt858 & 0x3FFF;
    if (arg1 == -1) {
      ...
      @Pc(117)
      int local117 = Static379.anIntArray489[arg2] - arg0.aClass35_7.anInt858 & 0x3FFF;
      arg0.aBoolean562 = false;
  ...
  public static void method5629(@OriginalArg(0) int arg0) {
    for (@Pc(9) Node local9 = Static211.A_HASH_MAP___18.head();
        local9 != null;
        local9 = Static211.A_HASH_MAP___18.next()) {
