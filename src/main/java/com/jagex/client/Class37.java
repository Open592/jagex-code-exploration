...
public final class Class37 {
  ...
  @OriginalMember(
      ...
      name = "a",
      descriptor =
          "(IIZLclient!uk;Lclient!ro;Lclient!vs;ILclient!lp;Lclient!in;Lclient!ya;Lclient!du;I)Lclient!t;")
  public Class110 method830(
      ...
      @OriginalArg(8) Class109 arg7,
      @OriginalArg(9) Class19 arg8,
      @OriginalArg(10) Class55 arg9) {
    if (this.anInt871 != -1) {
    ...
    if (arg6 != null) {
      ...
      local59 = local55 >>> 16;
      @Pc(63)
      int local63 = local55 & 0xFFFF;
      @Pc(68)
      SecondaryNode_Sub1_Sub17 local68 = arg9.method1391(local59);
      if (local68 != null) {
      ...
      if ((arg6.aBoolean405 || Static127.aBoolean244)
        ...
        @Pc(123)
        int local123 = local119 >>> 16;
        @Pc(127)
        int local127 = local119 & 0xFFFF;
        @Pc(141)
        SecondaryNode_Sub1_Sub17 local141 =
            local59 == local123 ? local68 : arg9.method1391(local123);
        if (local141 != null) {
    ...
    @Pc(190)
    Class68 local190 = Static190.aClass68_20;
    @Pc(199)
    Class110 local199;
    ...
    if (local199 == null || arg8.method4269(local199.P(), local28) != 0) {
      ...
      for (@Pc(227) int local227 = 0; local227 < 12; local227++) {
        ...
        if ((local55 & 0x40000000) == 0) {
          if ((local55 & Integer.MIN_VALUE) != 0
              && !arg7.method2758(local55 & 0x3FFFFFFF).method4093()) {
            local36 = true;
          }
      ...
      @Pc(281)
      Class122[] local281 = new Class122[12];
      local119 = 0;
      for (@Pc(285) int local285 = 0; local285 < 12; local285++) {
        @Pc(292)
        int local292 = this.anIntArray51[local285];
        @Pc(310)
        Class122 local310;
      ...
      @Pc(352)
      int local352 = local28 | 0x4000;
      @Pc(358)
      Class122 local358 = new Class122(local281, local119);
      ...
      for (local59 = 0; local59 < 5; local59++) {
        if (this.anIntArray52[local59] < Static26.aShortArrayArray2[local59].length) {
          local199.BA(
              Static299.aShortArray179[local59],
              Static26.aShortArrayArray2[local59][this.anIntArray52[local59]]);
        }
        if (Static15.aShortArrayArray1[local59].length > this.anIntArray52[local59]) {
          local199.BA(
              Static434.aShortArray252[local59],
              Static15.aShortArrayArray1[local59][this.anIntArray52[local59]]);
        }
      }
      local199.UA(local28);
      @Pc(433)
      Class68 local433 = Static190.aClass68_20;
      synchronized (Static190.aClass68_20) {
  ...
  public void method832(
      @OriginalArg(0) int arg0, @OriginalArg(1) Class109 arg1, @OriginalArg(2) int arg2) {
    @Pc(32)
    int local32 = Static299.anIntArray353[arg2];
  ...
  @OriginalMember(
      ...
      name = "a",
      descriptor =
          "(Lclient!v;Lclient!in;Lclient!lp;I[Lclient!nv;Lclient!uk;IILclient!lp;BLclient!du;IILclient!ya;Lclient!ro;ILclient!vs;IZ)Lclient!t;")
  public Class110 method833(
      @OriginalArg(0) Class249 arg0,
      @OriginalArg(1) Class109 arg1,
      ...
      @OriginalArg(14) Class206 arg13,
      @OriginalArg(15) int arg14,
      @OriginalArg(16) Interface12 arg15,
      @OriginalArg(17) int arg16) {
    if (this.anInt871 != -1) {
      return arg5.method5229(this.anInt871)
          .method5575(
              arg14, arg8, arg15, arg6, arg3, arg16, arg11, arg12, arg7, arg10, arg4, arg2, arg9,
              arg0);
    }
    @Pc(34)
    int local34 = arg3;
    @Pc(37)
    long local37 = this.aLong35;
    @Pc(40)
    int[] local40 = this.anIntArray51;
    ...
    @Pc(136)
    boolean local136 = false;
    @Pc(144)
    boolean local144 = false;
    @Pc(152)
    boolean local152 = arg8 != null || arg2 != null;
    @Pc(159)
    int local159 = arg4 == null ? 0 : arg4.length;
    @Pc(193)
    int local193;
    @Pc(198)
    int local198;
    for (@Pc(161) int local161 = 0; local161 < local159; local161++) {
      ...
      if (arg4[local161] != null) {
        @Pc(179)
        Class138 local179 = arg9.method1397(arg4[local161].anInt5139);
        if (local179.anIntArray295 != null) {
          ...
          @Pc(203)
          int local203 = local179.anIntArray295[local193];
          Static36.aClass4_Sub1_Sub17Array4[local161] = arg9.method1391(local203 >>> 16);
          @Pc(216)
          int local216 = local203 & 0xFFFF;
          ...
          if ((local179.aBoolean405 || Static127.aBoolean244)
            ...
            @Pc(283)
            int local283 = local179.anIntArray295[local198];
            Static397.aClass4_Sub1_Sub17Array6[local161] = arg9.method1391(local283 >>> 16);
            @Pc(296)
            int local296 = local283 & 0xFFFF;
    ...
    local198 = 0;
    @Pc(365)
    SecondaryNode_Sub1_Sub17 local365 = null;
    @Pc(367)
    SecondaryNode_Sub1_Sub17 local367 = null;
    @Pc(369)
    int local369 = -1;
    @Pc(371)
    int local371 = -1;
    ...
    int local373 = 0;
    @Pc(375)
    SecondaryNode_Sub1_Sub17 local375 = null;
    @Pc(377)
    SecondaryNode_Sub1_Sub17 local377 = null;
    if (local152) {
      @Pc(390)
      int local390;
      @Pc(450)
    ...
    @Pc(619)
    Class68 local619 = Static442.aClass68_58;
    @Pc(627)
    Class110 local627;
    ...
    int local684;
    if (local627 == null
        || arg12.method4269(local627.P(), local34) != 0
        || local635 != null
            && local635.anIntArrayArray38 != null
            && this.anIntArrayArray9 == null) {
      if (local627 != null) {
        local34 = arg12.method4282(local34, local627.P());
      }
      @Pc(676)
      boolean local676 = false;
      local678 = 0;
      while (true) {
        if (local678 >= 12) {
          if (local676) {
            if (this.aLong36 != -1L) {
              @Pc(736)
              Class68 local736 = Static442.aClass68_58;
              synchronized (Static442.aClass68_58) {
            ...
            @Pc(772)
            Class122[] local772 = new Class122[12];
            @Pc(780)
            int local780;
            ...
            if (local635 != null && local635.anIntArrayArray38 != null) {
              for (local780 = 0; local780 < local635.anIntArrayArray38.length; local780++) {
                if (local635.anIntArrayArray38[local780] != null && local772[local780] != null) {
                  ...
                  @Pc(860)
                  int local860 = local635.anIntArrayArray38[local780][1];
                  @Pc(867)
                  int local867 = local635.anIntArrayArray38[local780][2];
                  @Pc(876)
                  int local876 = local635.anIntArrayArray38[local780][3] << 3;
                  @Pc(885)
                  int local885 = local635.anIntArrayArray38[local780][4] << 3;
                  @Pc(894)
                  int local894 = local635.anIntArrayArray38[local780][5] << 3;
                  ...
                  if (this.anIntArrayArray9[local780] == null) {
                    @Pc(916)
                    int[] local916 = this.anIntArrayArray9[local780] = new int[15];
                    if (local876 == 0 && local885 == 0 && local894 == 0) {
                      ...
                      @Pc(932)
                      int local932 = Class50_Sub1.anIntArray224[local876];
                      @Pc(936)
                      int local936 = Class50_Sub1.anIntArray225[local876];
                      @Pc(940)
                      int local940 = Class50_Sub1.anIntArray224[local885];
                      @Pc(944)
                      int local944 = Class50_Sub1.anIntArray225[local885];
                      @Pc(948)
                      int local948 = Class50_Sub1.anIntArray224[local894];
                      @Pc(952)
                      int local952 = Class50_Sub1.anIntArray225[local894];
                      @Pc(960)
                      int local960 = local948 * local936 + 16384 >> 15;
                      @Pc(968)
                      int local968 = local936 * local952 + 16384 >> 15;
            ...
            @Pc(1255)
            int local1255 = local34 | 0x4000;
            @Pc(1262)
            Class122 local1262 = new Class122(local772, local772.length);
            ...
            for (local853 = 0; local853 < 5; local853++) {
              if (this.anIntArray52[local853] < Static26.aShortArrayArray2[local853].length) {
                local627.BA(
                    Static299.aShortArray179[local853],
                    Static26.aShortArrayArray2[local853][this.anIntArray52[local853]]);
              }
              if (this.anIntArray52[local853] < Static15.aShortArrayArray1[local853].length) {
                local627.BA(
                    Static434.aShortArray252[local853],
                    Static15.aShortArrayArray1[local853][this.anIntArray52[local853]]);
              }
            }
            local627.UA(local34);
            @Pc(1333)
            Class68 local1333 = Static442.aClass68_58;
            synchronized (Static442.aClass68_58) {
        ...
        if ((local684 & 0x40000000) == 0) {
          if ((local684 & Integer.MIN_VALUE) != 0
              && !arg1.method2758(local684 & 0x3FFFFFFF).method4095()) {
            local676 = true;
          }
    ...
    @Pc(1355)
    Class110 local1355 = local627.method4887((byte) 4, local34, true);
    if (!local152) {
      return local1355;
    }
    @Pc(1361)
    ...
    while (local159 > local1361) {
      if (Static36.aClass4_Sub1_Sub17Array4[local1361] != null) {
        local1355.method4897(
            Static54.anIntArray56[local1361],
            Static397.aClass4_Sub1_Sub17Array6[local1361],
            this.anIntArrayArray9 == null ? null : this.anIntArrayArray9[local1361],
            false,
            Static254.anIntArray311[local1361],
            Static227.anIntArray292[local1361],
            Static36.aClass4_Sub1_Sub17Array4[local1361],
            Static361.anIntArray443[local1361] - 1,
            local678);
      }
      local1361++;
      local678 <<= 0x1;
  ...
  private void method834() {
    this.aLong35 = -1L;
    @Pc(10)
    long[] local10 = Class80.aLongArray4;
    this.aLong35 =
        local10[(int) ((this.aLong35 ^ (long) (this.anInt881 >> 8)) & 0xFFL)] ^ this.aLong35 >>> 8;
    this.aLong35 =
        this.aLong35 >>> 8 ^ local10[(int) ((this.aLong35 ^ (long) this.anInt881) & 0xFFL)];
    for (@Pc(50) int local50 = 0; local50 < 12; local50++) {
      this.aLong35 =
          local10[(int) (((long) (this.anIntArray51[local50] >> 24) ^ this.aLong35) & 0xFFL)]
              ^ this.aLong35 >>> 8;
      this.aLong35 =
          this.aLong35 >>> 8
              ^ local10[(int) ((this.aLong35 ^ (long) (this.anIntArray51[local50] >> 16)) & 0xFFL)];
      this.aLong35 =
          this.aLong35 >>> 8
              ^ local10[(int) ((this.aLong35 ^ (long) (this.anIntArray51[local50] >> 8)) & 0xFFL)];
      this.aLong35 =
          this.aLong35 >>> 8
              ^ local10[(int) ((this.aLong35 ^ (long) this.anIntArray51[local50]) & 0xFFL)];
    }
    for (@Pc(153) int local153 = 0; local153 < 5; local153++) {
      this.aLong35 =
          local10[(int) ((this.aLong35 ^ (long) this.anIntArray52[local153]) & 0xFFL)]
              ^ this.aLong35 >>> 8;
    }
    this.aLong35 =
        this.aLong35 >>> 8
            ^ local10[(int) (((long) (this.aBoolean83 ? 1 : 0) ^ this.aLong35) & 0xFFL)];
  }
  ...
  @OriginalMember(
      owner = "client!cj",
      name = "a",
      descriptor = "(Lclient!lp;ILclient!du;IILclient!in;IIILclient!ya;II)Lclient!t;")
  public Class110 method837(
      @OriginalArg(0) Class138 arg0,
      @OriginalArg(2) Class55 arg1,
      @OriginalArg(3) int arg2,
      @OriginalArg(4) int arg3,
      @OriginalArg(5) Class109 arg4,
      @OriginalArg(7) int arg5,
      @OriginalArg(8) int arg6,
      @OriginalArg(9) Class19 arg7,
    ...
    if (arg0 != null) {
      ...
      @Pc(13)
      boolean local13 = false;
      @Pc(15)
      boolean local15 = false;
      @Pc(17)
      boolean local17 = false;
      @Pc(28)
      int local28 = arg0.anIntArray295[arg9];
      local7 = 2080;
      @Pc(38)
      int local38 = local28 >>> 16;
      @Pc(43)
      SecondaryNode_Sub1_Sub17 local43 = arg1.method1391(local38);
      @Pc(47)
      int local47 = local28 & 0xFFFF;
      if (local43 != null) {
      ...
      if ((arg0.aBoolean405 || Static127.aBoolean244)
        ...
        @Pc(97)
        int local97 = local93 >>> 16;
        @Pc(101)
        int local101 = local93 & 0xFFFF;
        @Pc(115)
        SecondaryNode_Sub1_Sub17 local115;
        if (local38 == local97) {
          local115 = local43;
        } else {
    ...
    @Pc(178)
    long local178 = (long) arg2 | (long) (arg5 << 16) | (long) arg3 << 32;
    @Pc(180)
    Class68 local180 = Static190.aClass68_20;
    @Pc(188)
    Class110 local188;
    synchronized (Static190.aClass68_20) {
    ...
    if (local188 == null || arg7.method4269(local188.P(), local7) != 0) {
      ...
      @Pc(218)
      Class122[] local218 = new Class122[3];
      local93 = 0;
      if (!arg4.method2758(arg2).method4093()
          || !arg4.method2758(arg5).method4093()
          || !arg4.method2758(arg3).method4093()) {
        return null;
      }
      @Pc(248)
      Class122 local248 = arg4.method2758(arg2).method4099();
      if (local248 != null) {
        local93++;
        local218[0] = local248;
      }
      ...
      for (@Pc(303) int local303 = 0; local303 < 5; local303++) {
        if (this.anIntArray52[local303] < Static26.aShortArrayArray2[local303].length) {
          local188.BA(
              Static299.aShortArray179[local303],
              Static26.aShortArrayArray2[local303][this.anIntArray52[local303]]);
        }
        if (this.anIntArray52[local303] < Static15.aShortArrayArray1[local303].length) {
          local188.BA(
              Static434.aShortArray252[local303],
              Static15.aShortArrayArray1[local303][this.anIntArray52[local303]]);
        }
      }
      local188.UA(local7);
      @Pc(362)
      Class68 local362 = Static190.aClass68_20;
      synchronized (Static190.aClass68_20) {
