...
public final class Static392 {
  ...
  public static Class247 method5121(@OriginalArg(1) int arg0) {
    ...
    int local15 = arg0 >> 16;
    @Pc(19)
    int local19 = arg0 & 0xFFFF;
    if (Static297.aClass247ArrayArray2[local15] == null
        || Static297.aClass247ArrayArray2[local15][local19] == null) {
      @Pc(35)
      boolean local35 = Static112.method2034(local15);
      if (!local35) {
        return null;
      }
    }
  ...
  @OriginalMember(
      owner = "client!ts",
      name = "a",
      descriptor = "(IBLclient!fd;Ljava/lang/String;)Lclient!td;")
  public static Class225 method5125(
      @OriginalArg(2) Class19_Sub2 arg0, @OriginalArg(3) String arg1) {
    @Pc(5)
    int local5 = OpenGL.glGenProgramARB();
