...
public final class Static36 {
	...
	public static final Node_Sub1_Sub17[] aClass4_Sub1_Sub17Array4 = new Node_Sub1_Sub17[14];

	@OriginalMember(owner = "client!bp", name = "a", descriptor = "(II)[B")
	public static byte[] method643(@OriginalArg(1) int arg0) {
		@Pc(12) Node_Sub1_Sub15 local12 = (Node_Sub1_Sub15) Static392.aClass142_3.method3483((long) arg0);
		if (local12 == null) {
			...
			local12 = new Node_Sub1_Sub15(local25);
