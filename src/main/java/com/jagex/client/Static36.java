...
public final class Static36 {
  ...
  public static final SecondaryNode_Sub1_Sub17[] aClass4_Sub1_Sub17Array4 =
      new SecondaryNode_Sub1_Sub17[14];

  @OriginalMember(owner = "client!bp", name = "a", descriptor = "(II)[B")
  public static byte[] method643(@OriginalArg(1) int arg0) {
    @Pc(12)
    SecondaryNode_Sub1_Sub15 local12 =
        (SecondaryNode_Sub1_Sub15) Static392.aClass142_3.method3483((long) arg0);
    if (local12 == null) {
      @Pc(25)
      byte[] local25 = new byte[512];
      @Pc(31)
      Random local31 = new Random((long) arg0);
      for (@Pc(33) int local33 = 0; local33 < 255; local33++) {
        local25[local33] = (byte) local33;
      }
      for (@Pc(48) int local48 = 0; local48 < 255; local48++) {
        @Pc(55)
        int local55 = 255 - local48;
        @Pc(60)
        int local60 = Static226.method3443(local31, local55);
        @Pc(64)
        byte local64 = local25[local60];
        local25[local60] = local25[local55];
        local25[local55] = local25[511 - local48] = local64;
      }
      local12 = new SecondaryNode_Sub1_Sub15(local25);
  ...
  public static Class16_Sub1 method648(
    ...
    for (@Pc(14) Class7 local14 = local7.aClass7_3; local14 != null; local14 = local14.aClass7_1) {
      @Pc(18)
      Class16_Sub1 local18 = local14.aClass16_Sub1_1;
      if (arg3.isAssignableFrom(local18.getClass())
          && local18.aShort94 == arg1
          && local18.aShort96 == arg2) {
        return local18;
      }
    }
    return null;
