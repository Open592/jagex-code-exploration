...
public final class Static298 {
  ...
  public static final LocalizedString A_LOCALIZED_STRING___112 =
      new LocalizedString("slide:", "gleiten:", "glissement:", "deslizamento:");
  ...
  public static boolean method4083(
    ...
    for (@Pc(7) int local7 = arg4; local7 <= arg2; local7++) {
      for (@Pc(11) int local11 = arg1; local11 <= arg0; local11++) {
        if (Static50.anIntArrayArray8[local7][local11] == arg3
            && Static44.anIntArrayArray7[local7][local11] <= 1) {
          return true;
        }
      }
    }
