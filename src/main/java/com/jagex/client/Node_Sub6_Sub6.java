...
public final class Node_Sub6_Sub6 extends Node_Sub6 {
  ...
  private void method1540() {
    @Pc(13)
    int local13 = this.anIntArrayArray19.length;
    if (local13 <= 0) {
      return;
    }
    for (@Pc(20) int local20 = 0; local20 < 257; local20++) {
      ...
      int local24 = 0;
      @Pc(28)
      int local28 = local20 << 4;
      for (@Pc(30) int local30 = 0;
          local13 > local30 && this.anIntArrayArray19[local30][0] <= local28;
          local30++) {
        local24++;
      }
      @Pc(75)
      ...
      if (local13 <= local24) {
        ...
        if (local24 <= 0) {
          ...
          @Pc(105)
          int[] local105 = this.anIntArrayArray19[local24 - 1];
          @Pc(123)
          int local123 = (local28 - local105[0] << 12) / (local63[0] - local105[0]);
          @Pc(127)
          int local127 = 4096 - local123;
  ...
  public int[][] method5514(@OriginalArg(1) int arg0) {
    ...
    if (super.aClass153_41.aBoolean437) {
      @Pc(28)
      int[] local28 = this.method5508(arg0, 0);
      @Pc(32)
      int[] local32 = local11[0];
      @Pc(36)
      int[] local36 = local11[1];
      @Pc(40)
      int[] local40 = local11[2];
      for (@Pc(42) int local42 = 0; local42 < Static80.anInt1616; local42++) {
        @Pc(50)
        int local50 = local28[local42] >> 4;
        if (local50 < 0) {
          local50 = 0;
        }
        if (local50 > 256) {
