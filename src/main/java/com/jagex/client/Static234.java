...
public final class Static234 {
  ...
  public static final LocalizedString A_LOCALIZED_STRING___93 =
      new LocalizedString("glow3:", "leuchten3:", "brillant3:", "brilho3:");
  ...
  public static boolean method3499(
    ...
    @Pc(55)
    int[][] local55 = arg4.anIntArrayArray48;
    while (true) {
      label282:
      while (true) {
        @Pc(74)
          ...
          do {
            do {
              ...
              do {
                ...
                if (local74 > 0
                    && Static159.anIntArrayArray30[local74 - 1][local69] == 0
                    && (local55[local86 - 1][local92] & 0x43A40000) == 0
                    && (local55[local86 - 1][local92 + arg8 - 1] & 0x4E240000) == 0) {
                  local289 = 1;
                  while (true) {
                    if (local289 >= arg8 - 1) {
                ...
                if (local74 < 128 - arg8
                    && Static159.anIntArrayArray30[local74 + 1][local69] == 0
                    && (local55[local86 + arg8][local92] & 0x60E40000) == 0
                    && (local55[arg8 + local86][local92 + arg8 - 1] & 0x78240000) == 0) {
                  local289 = 1;
                  while (true) {
                    if (local289 >= arg8 - 1) {
                      Static129.anIntArray182[local50] = local7 + 1;
                ...
                if (local69 > 0
                    && Static159.anIntArrayArray30[local74][local69 - 1] == 0
                    && (local55[local86][local92 - 1] & 0x43A40000) == 0
                    && (local55[arg8 + local86 - 1][local92 - 1] & 0x60E40000) == 0) {
                  local289 = 1;
                  while (true) {
                    if (arg8 - 1 <= local289) {
                ...
                if (local69 < 128 - arg8
                    && Static159.anIntArrayArray30[local74][local69 + 1] == 0
                    && (local55[local86][local92 + arg8] & 0x4E240000) == 0
                    && (local55[local86 + arg8 - 1][local92 + arg8] & 0x78240000) == 0) {
                  local289 = 1;
                  while (true) {
                    if (arg8 - 1 <= local289) {
                      Static129.anIntArray182[local50] = local7;
                ...
                if (local74 > 0
                    && local69 > 0
                    && Static159.anIntArrayArray30[local74 - 1][local69 - 1] == 0
                    && (local55[local86 - 1][local92 - 1] & 0x43A40000) == 0) {
                  local289 = 1;
                  while (true) {
                    if (arg8 <= local289) {
                      Static129.anIntArray182[local50] = local7 - 1;
                    ...
                    if ((local55[local86 - 1][local92 + local289 - 1] & 0x4FA40000) != 0
                        || (local55[local86 + local289 - 1][local92 - 1] & 0x63E40000) != 0) {
                      break;
                    }
                    local289++;
                  }
                ...
                if (local74 < 128 - arg8
                    && local69 > 0
                    && Static159.anIntArrayArray30[local74 + 1][local69 - 1] == 0
                    && (local55[local86 + arg8][local92 - 1] & 0x60E40000) == 0) {
                  local289 = 1;
                  while (true) {
                    if (arg8 <= local289) {
                      Static129.anIntArray182[local50] = local7 + 1;
                    ...
                    if ((local55[local86 + arg8][local289 + local92 - 1] & 0x78E40000) != 0
                        || (local55[local86 + local289][local92 - 1] & 0x63E40000) != 0) {
                      break;
                    }
                    local289++;
                  }
                ...
                if (local74 > 0
                    && 128 - arg8 > local69
                    && Static159.anIntArrayArray30[local74 - 1][local69 + 1] == 0
                    && (local55[local86 - 1][local92 + arg8] & 0x4E240000) == 0) {
                  for (local289 = 1; local289 < arg8; local289++) {
                    if ((local55[local86 - 1][local92 + local289] & 0x4FA40000) != 0
                        || (local55[local86 + local289 - 1][arg8 + local92] & 0x7E240000) != 0) {
                      continue label259;
                    }
                  }
                  Static129.anIntArray182[local50] = local7 - 1;
        ...
        for (local289 = 1; local289 < arg8; local289++) {
          if ((local55[local289 + local86][arg8 + local92] & 0x7E240000) != 0
              || (local55[arg8 + local86][local92 + local289] & 0x78E40000) != 0) {
            continue label282;
          }
        }
        Static129.anIntArray182[local50] = local7 + 1;
  ...
  public static void method3502(@OriginalArg(0) int arg0) {
    @Pc(8)
    SecondaryNode_Sub1_Sub11 local8 = Static405.method5222(arg0, 14);
    local8.method2608();
  }
}
