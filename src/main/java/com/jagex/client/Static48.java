    ...
    for (@Pc(8) int local8 = 0; local8 < arg1.length; local8++) {
      ...
      if (local14 != null) {
        if (local14.anInt6840 == 0) {
          ...
          @Pc(38)
          Node_Sub43 local38 = (Node_Sub43) Static325.aHashMap_29.get((long) local14.anInt6809);
          if (local38 != null) {
        ...
        if (arg0 == 1 && local14.anObjectArray10 != null) {
          if (local14.anInt6865 >= 0) {
            @Pc(79)
            Class247 local79 = Static392.method5121(local14.anInt6809);
            if (local79 == null
                || local79.aClass247Array2 == null
                || local14.anInt6865 >= local79.aClass247Array2.length
                || local79.aClass247Array2[local14.anInt6865] != local14) {
              continue;
            }
          }
          local54 = new Node_Sub34();
