		...
		for (@Pc(8) int local8 = 0; local8 < arg1.length; local8++) {
			...
			if (local14 != null) {
				if (local14.anInt6840 == 0) {
					...
					@Pc(38) LinkedEntry_Sub43 local38 = (LinkedEntry_Sub43) Static325.aLinkedHashMap_Iterator_29.get((long) local14.anInt6809);
					if (local38 != null) {
						Static310.method4165(local38.anInt6979, arg0);
					}
				}
				@Pc(54) LinkedEntry_Sub34 local54;
				if (arg0 == 0 && local14.anObjectArray29 != null) {
					local54 = new LinkedEntry_Sub34();
