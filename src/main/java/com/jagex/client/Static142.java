...
public final class Static142 {
  ...
  public static void method2425(@OriginalArg(0) Packet arg0) {
    @Pc(9)
    int local9 = arg0.gSmart1Or2();
    Static136.aClass10Array1 = new Class10[local9];
    for (@Pc(14) int local14 = 0; local14 < local9; local14++) {
      Static136.aClass10Array1[local14] = new Class10();
      Static136.aClass10Array1[local14].anInt169 = arg0.gSmart1Or2();
      Static136.aClass10Array1[local14].aString3 = arg0.gjstr2();
    }
    Static396.anInt4816 = arg0.gSmart1Or2();
    Static339.anInt5874 = arg0.gSmart1Or2();
    Static33.anInt602 = arg0.gSmart1Or2();
    ...
    for (@Pc(67) int local67 = 0; local67 < Static33.anInt602; local67++) {
      @Pc(73)
      int local73 = arg0.gSmart1Or2();
      @Pc(81)
      Class78_Sub1 local81 = Static407.aClass78_Sub1Array2[local73] = new Class78_Sub1();
  ...
  public static void method2429(
    ...
    for (@Pc(6) Class3_Sub8 local6 = (Class3_Sub8) GameShell.aClass84_4.method2312();
        local6 != null;
        local6 = (Class3_Sub8) GameShell.aClass84_4.method2309()) {
      if (client.gameLogicStepCount >= local6.anInt7367) {
        local6.method5676();
      } else {
        Static270.method3871(
            (local6.anInt7366 << 7) + 64,
            (local6.anInt7374 << 7) + 64,
            local6.anInt7372,
            local6.anInt7375 * 2,
            arg0 >> 1,
            arg2 >> 1);
        Static331.aClass46_10.method5056(
            arg3 + Static449.anIntArray557[0],
            local6.anInt7376 | 0xFF000000,
            arg1 + Static449.anIntArray557[1],
            0,
            local6.aString71);
      }
    }
