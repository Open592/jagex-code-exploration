...
public final class Static462 {
  ...
  public static int method4453(
      @OriginalArg(1) byte[] arg0,
      ...
      @OriginalArg(10) Node_Sub15_Sub3 arg8) {
    arg2 >>= 0x8;
    @Pc(7)
    int local7 = arg7 >> 8;
    @Pc(11)
    ...
    while (arg3 < local24) {
      ...
      @Pc(56)
      int local56 = local46 + 1;
      arg1[local46] += local43 * local15;
      @Pc(66)
      int local66 = local41 - 1;
      @Pc(68)
      byte local68 = arg0[local41];
      @Pc(71)
      int local71 = local56 + 1;
      arg1[local56] += local68 * local11;
      @Pc(81)
      int local81 = local71 + 1;
      arg1[local71] += local68 * local15;
      @Pc(91)
      int local91 = local66 - 1;
      @Pc(93)
      byte local93 = arg0[local66];
      @Pc(96)
      int local96 = local81 + 1;
      arg1[local81] += local93 * local11;
      @Pc(106)
      int local106 = local96 + 1;
      arg1[local96] += local93 * local15;
      arg2 = local91 - 1;
      @Pc(118)
      byte local118 = arg0[local91];
      @Pc(121)
      int local121 = local106 + 1;
  ...
  public static int method4455(
      @OriginalArg(2) byte[] arg0,
      ...
      @OriginalArg(11) Node_Sub15_Sub3 arg8,
  ...
  public static int method4456(
      ...
      @OriginalArg(9) Node_Sub15_Sub3 arg8) {
    arg2 >>= 0x8;
    @Pc(7)
    int local7 = arg7 >> 8;
    arg4 <<= 0x2;
    ...
    while (arg3 < local24) {
      local54 = arg3++;
      @Pc(57)
      int local57 = arg1[local54];
      @Pc(60)
      int local60 = arg2 - 1;
      arg1[local54] = local57 + arg0[arg2] * arg4;
      @Pc(69)
      int local69 = arg4 + local15;
      @Pc(71)
      int local71 = arg3++;
      @Pc(74)
      int local74 = arg1[local71];
      @Pc(77)
      int local77 = local60 - 1;
      arg1[local71] = local74 + arg0[local60] * local69;
      @Pc(86)
      int local86 = local69 + local15;
      @Pc(88)
      int local88 = arg3++;
      @Pc(91)
      int local91 = arg1[local88];
      @Pc(94)
      int local94 = local77 - 1;
      arg1[local88] = local91 + arg0[local77] * local86;
      @Pc(103)
      int local103 = local86 + local15;
      @Pc(105)
      int local105 = arg3++;
      @Pc(108)
      int local108 = arg1[local105];
      arg2 = local94 - 1;
  ...
  public static int method4457(
      ...
      @OriginalArg(6) int arg5,
      @OriginalArg(7) int arg6,
      @OriginalArg(8) Node_Sub15_Sub3 arg7) {
    arg2 >>= 0x8;
    @Pc(7)
    int local7 = arg6 >> 8;
    @Pc(11)
    ...
    while (arg3 < local20) {
      ...
      int local41 = arg3++;
      @Pc(44)
      int local44 = arg1[local41];
      @Pc(47)
      int local47 = local34 - 1;
      ...
      int local57 = arg1[local54];
      @Pc(60)
      int local60 = local47 - 1;
      arg1[local54] = local57 + arg0[local47] * local11;
      @Pc(67)
      int local67 = arg3++;
      @Pc(70)
      int local70 = arg1[local67];
      arg2 = local60 - 1;
  ...
  public static int method4458(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
    return arg1 < 0
        ? arg0
        : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
  }
  ...
  public static int method4463(
    ...
    while (arg3 < local22) {
      ...
      @Pc(54)
      int local54 = local44 + 1;
      arg1[local44] += local41 * local15;
      @Pc(64)
      int local64 = local39 + 1;
      @Pc(66)
      byte local66 = arg0[local39];
      @Pc(69)
      int local69 = local54 + 1;
      arg1[local54] += local66 * local11;
      @Pc(79)
      int local79 = local69 + 1;
      arg1[local69] += local66 * local15;
      @Pc(89)
      int local89 = local64 + 1;
      @Pc(91)
      byte local91 = arg0[local64];
      @Pc(94)
      int local94 = local79 + 1;
      arg1[local79] += local91 * local11;
      @Pc(104)
      int local104 = local94 + 1;
      arg1[local94] += local91 * local15;
      arg2 = local89 + 1;
      @Pc(116)
      byte local116 = arg0[local89];
      @Pc(119)
      int local119 = local104 + 1;
  ...
  public static int method4464(
      ...
      @OriginalArg(12) Node_Sub15_Sub3 arg10) {
    arg2 >>= 0x8;
    @Pc(7)
    int local7 = arg9 >> 8;
    arg4 <<= 0x2;
    ...
    while (arg3 < local30) {
      ...
      @Pc(74)
      int local74 = arg4 + local19;
      @Pc(77)
      int local77 = local63 + 1;
      arg1[local63] += local60 * arg5;
      @Pc(88)
      int local88 = arg5 + local23;
      @Pc(91)
      int local91 = local58 + 1;
      @Pc(93)
      byte local93 = arg0[local58];
      @Pc(96)
      int local96 = local77 + 1;
      arg1[local77] += local93 * local74;
      @Pc(107)
      int local107 = local74 + local19;
      @Pc(110)
      int local110 = local96 + 1;
      arg1[local96] += local93 * local88;
      @Pc(121)
      int local121 = local88 + local23;
      @Pc(124)
      int local124 = local91 + 1;
      @Pc(126)
      byte local126 = arg0[local91];
      @Pc(129)
      int local129 = local110 + 1;
      arg1[local110] += local126 * local107;
      @Pc(140)
      int local140 = local107 + local19;
      @Pc(143)
      int local143 = local129 + 1;
      arg1[local129] += local126 * local121;
      @Pc(154)
      int local154 = local121 + local23;
      arg2 = local124 + 1;
      @Pc(159)
      byte local159 = arg0[local124];
      @Pc(162)
      int local162 = local143 + 1;
  ...
  public static int method4465(
      ...
      @OriginalArg(9) int arg6,
      @OriginalArg(10) Node_Sub15_Sub3 arg7,
  ...
  public static int method4470(
      ...
      @OriginalArg(11) int arg8,
      @OriginalArg(12) int arg9,
      @OriginalArg(13) Node_Sub15_Sub3 arg10,
      @OriginalArg(14) int arg11,
  ...
  public static int method4476(
    ...
    while (arg3 < local18) {
      ...
      int local39 = arg3++;
      @Pc(42)
      int local42 = arg1[local39];
      @Pc(45)
      int local45 = local32 + 1;
      arg1[local39] = local42 + arg0[local32] * local11;
      @Pc(52)
      int local52 = arg3++;
      @Pc(55)
      int local55 = arg1[local52];
      @Pc(58)
      int local58 = local45 + 1;
      arg1[local52] = local55 + arg0[local45] * local11;
      @Pc(65)
      int local65 = arg3++;
      @Pc(68)
      int local68 = arg1[local65];
      arg2 = local58 + 1;
  ...
  public static int method4483(
    ...
    while (arg3 < local22) {
      ...
      @Pc(67)
      int local67 = arg4 + local15;
      @Pc(69)
      int local69 = arg3++;
      @Pc(72)
      int local72 = arg1[local69];
      @Pc(75)
      int local75 = local58 + 1;
      arg1[local69] = local72 + arg0[local58] * local67;
      @Pc(84)
      int local84 = local67 + local15;
      @Pc(86)
      int local86 = arg3++;
      @Pc(89)
      int local89 = arg1[local86];
      @Pc(92)
      int local92 = local75 + 1;
      arg1[local86] = local89 + arg0[local75] * local84;
      @Pc(101)
      int local101 = local84 + local15;
      @Pc(103)
      int local103 = arg3++;
      @Pc(106)
      int local106 = arg1[local103];
      arg2 = local92 + 1;
  ...
  public static int method4485(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
    return arg1 < 0
        ? -arg0
        : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
  }

  @OriginalMember(owner = "client!qo", name = "a", descriptor = "(Lclient!js;III)Lclient!qo;")
  public static Node_Sub15_Sub3 method4486(
      @OriginalArg(0) Node_Sub4_Sub1 arg0,
      @OriginalArg(1) int arg1,
      @OriginalArg(2) int arg2,
      @OriginalArg(3) int arg3) {
    return arg0.aByteArray48 == null || arg0.aByteArray48.length == 0
        ? null
        : new Node_Sub15_Sub3(arg0, arg1, arg2, arg3);
  }

  @OriginalMember(owner = "client!qo", name = "a", descriptor = "(Lclient!js;II)Lclient!qo;")
  public static Node_Sub15_Sub3 method4489(
      @OriginalArg(0) Node_Sub4_Sub1 arg0, @OriginalArg(2) int arg1) {
    return arg0.aByteArray48 == null || arg0.aByteArray48.length == 0
        ? null
        : new Node_Sub15_Sub3(
            arg0,
            (int) ((long) arg0.anInt3727 * 256L * (long) 100 / (long) (Static261.anInt4928 * 100)),
            arg1 << 6);
  }

  @OriginalMember(owner = "client!qo", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!qo;)I")
  public static int method4491(
      @OriginalArg(1) byte[] arg0,
      @OriginalArg(2) int[] arg1,
      @OriginalArg(3) int arg2,
      @OriginalArg(4) int arg3,
    ...
    while (arg3 < local32) {
      ...
      @Pc(76)
      int local76 = arg4 + local19;
      @Pc(79)
      int local79 = local65 + 1;
      arg1[local65] += local62 * arg5;
      @Pc(90)
      int local90 = arg5 + local23;
      @Pc(93)
      int local93 = local60 - 1;
      @Pc(95)
      byte local95 = arg0[local60];
      @Pc(98)
      int local98 = local79 + 1;
      arg1[local79] += local95 * local76;
      @Pc(109)
      int local109 = local76 + local19;
      @Pc(112)
      int local112 = local98 + 1;
      arg1[local98] += local95 * local90;
      @Pc(123)
      int local123 = local90 + local23;
      @Pc(126)
      int local126 = local93 - 1;
      @Pc(128)
      byte local128 = arg0[local93];
      @Pc(131)
      int local131 = local112 + 1;
      arg1[local112] += local128 * local109;
      @Pc(142)
      int local142 = local109 + local19;
      @Pc(145)
      int local145 = local131 + 1;
      arg1[local131] += local128 * local123;
      @Pc(156)
      int local156 = local123 + local23;
      arg2 = local126 - 1;
      @Pc(161)
      byte local161 = arg0[local126];
      @Pc(164)
      int local164 = local145 + 1;
