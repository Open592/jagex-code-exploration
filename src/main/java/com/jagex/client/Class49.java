...
public class Class49 {
  ...
  private Node_Sub15 aClass4_Sub15_5;
  ...
  private final Node_Sub15[] aClass4_Sub15Array5 = new Node_Sub15[8];
  ...
  private final Node_Sub15[] aClass4_Sub15Array6 = new Node_Sub15[8];
  ...
  public final synchronized void method2069() {
    ...
    @Pc(14)
    long local14 = MonotonicClock.getCurrentTimeInMilliseconds();
    try {
  ...
  public final synchronized void method2070(@OriginalArg(0) Node_Sub15 arg0) {
  ...
  private void method2075(@OriginalArg(1) int arg0, @OriginalArg(2) Node_Sub15 arg1) {
    @Pc(7)
    int local7 = arg0 >> 5;
    @Pc(12)
    Node_Sub15 local12 = this.aClass4_Sub15Array5[local7];
    if (local12 == null) {
  ...
  private void method2076(@OriginalArg(0) int[] arg0) {
    ...
    if (this.aClass4_Sub15_5 != null && this.anInt2444 <= 0) {
      ...
      while (local47 != 0) {
        ...
        for (@Pc(72) int local72 = local47 >>> local56 & 0x11111111;
            local72 != 0;
            local72 >>>= 0x4) {
          if ((local72 & 0x1) != 0) {
            local47 &= ~(0x1 << local56);
            @Pc(88)
            Node_Sub15 local88 = null;
            @Pc(93)
            Node_Sub15 local93 = this.aClass4_Sub15Array6[local56];
            label97:
            while (true) {
              while (true) {
                if (local93 == null) {
                ...
                @Pc(97)
                Node_Sub4 local97 = local93.aClass4_Sub4_5;
                if (local97 == null || local97.anInt3724 <= local61) {
                  local93.aBoolean569 = true;
                  @Pc(121)
                  int local121 = local93.method4859();
                  local45 += local121;
                  if (local97 != null) {
                  ...
                  @Pc(140)
                  Node_Sub15 local140 = local93.method4860();
                  if (local140 != null) {
                    @Pc(145)
                    int local145 = local93.anInt6248;
                    while (local140 != null) {
                  ...
                  @Pc(164)
                  Node_Sub15 local164 = local93.aClass4_Sub15_8;
      ...
      for (local56 = 0; local56 < 8; local56++) {
        @Pc(207)
        Node_Sub15 local207 = this.aClass4_Sub15Array6[local56];
        this.aClass4_Sub15Array6[local56] = this.aClass4_Sub15Array5[local56] = null;
        while (local207 != null) {
          @Pc(221)
          Node_Sub15 local221 = local207.aClass4_Sub15_8;
