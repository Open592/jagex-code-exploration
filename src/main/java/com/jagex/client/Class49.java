...
public class Class49 {
	...
	private void method2075(@OriginalArg(1) int arg0, @OriginalArg(2) Node_Sub15 arg1) {
		...
		@Pc(12) Node_Sub15 local12 = this.aClass4_Sub15Array5[local7];
		if (local12 == null) {
		...
		if (this.aClass4_Sub15_5 != null && this.anInt2444 <= 0) {
			...
			label103: while (local47 != 0) {
				...
				for (@Pc(72) int local72 = local47 >>> local56 & 0x11111111; local72 != 0; local72 >>>= 0x4) {
					if ((local72 & 0x1) != 0) {
						local47 &= ~(0x1 << local56);
						@Pc(88) Node_Sub15 local88 = null;
						@Pc(93) Node_Sub15 local93 = this.aClass4_Sub15Array6[local56];
						label97: while (true) {
							while (true) {
								if (local93 == null) {
									break label97;
								}
								@Pc(97) Node_Sub4 local97 = local93.aClass4_Sub4_5;
								if (local97 == null || local97.anInt3724 <= local61) {
									...
									@Pc(140) Node_Sub15 local140 = local93.method4860();
									if (local140 != null) {
									...
									@Pc(164) Node_Sub15 local164 = local93.aClass4_Sub15_8;
			...
			for (local56 = 0; local56 < 8; local56++) {
				@Pc(207) Node_Sub15 local207 = this.aClass4_Sub15Array6[local56];
				this.aClass4_Sub15Array6[local56] = this.aClass4_Sub15Array5[local56] = null;
				while (local207 != null) {
					@Pc(221) Node_Sub15 local221 = local207.aClass4_Sub15_8;
