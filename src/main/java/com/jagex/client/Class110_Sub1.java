...
public final class Class110_Sub1 extends Class110 {
				...
				if (local1147 == -1) {
					...
					if (local1523 == 0) {
						...
						if (local1523 == 1) {
							...
							GameShell.method875(arg1.anIntArray251[local1530], local1569, local1548, arg1.anIntArray242[local1530], local1556, arg1.anIntArray244[local1530], local1544, local1580, local1561, local1552);
							local1476 = Static244.aFloat102;
							local1474 = Static403.aFloat211;
							GameShell.method875(arg1.anIntArray251[local1535], local1569, local1548, arg1.anIntArray242[local1535], local1556, arg1.anIntArray244[local1535], local1544, local1580, local1561, local1552);
							local1478 = Static403.aFloat211;
							local991 = Static244.aFloat102;
							GameShell.method875(arg1.anIntArray251[local1540], local1569, local1548, arg1.anIntArray242[local1540], local1556, arg1.anIntArray244[local1540], local1544, local1580, local1561, local1552);
	...
	public boolean method4894(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class31 arg2, @OriginalArg(3) boolean arg3) {
		...
		GameShell.aFloat30 = local8.aFloat204 * local12.aFloat207 + local8.aFloat207 * local12.aFloat202 + local8.aFloat203 * local12.aFloat208;
		...
		for (@Pc(383) int local383 = 0; local383 < 8; local383++) {
			...
			local442 = local33 + local390 * GameShell.aFloat30 + Static234.aFloat140 * local395 + Static69.aFloat113 * local400;
	...
	private void method2799(@OriginalArg(1) boolean arg0) {
		...
		if (arg0) {
			if (this.anInterface11_4 == null) {
				this.anInterface11_4 = this.aClass19_Sub2_21.method1960(Static370.aNode_Sub12_Sub2_3.pos, Static370.aNode_Sub12_Sub2_3.data, true, local106);
			} else {
				this.anInterface11_4.method5184(Static370.aNode_Sub12_Sub2_3.pos, local106, Static370.aNode_Sub12_Sub2_3.data);
			}
			local1410 = this.anInterface11_4;
			this.aByte19 = 0;
		} else {
			local1410 = this.aClass19_Sub2_21.method1960(Static370.aNode_Sub12_Sub2_3.pos, Static370.aNode_Sub12_Sub2_3.data, false, local106);
			this.aBoolean281 = true;
		}
		if (local38) {
	...
	private void method2801() {
		...
		for (@Pc(51) int local51 = 0; local51 < this.anInt3354; local51++) {
			...
			if (!local58.aBoolean287 || !this.aClass19_Sub2_21.method4301()) {
				...
				@Pc(148) float local148 = Static445.aFloat222 + local112 * GameShell.aFloat30 + Static234.aFloat140 * local91 + Static69.aFloat113 * local134;
	...
	public void method4880(@OriginalArg(0) Class31 arg0, @OriginalArg(1) Class3_Sub5 arg1, @OriginalArg(2) int arg2) {
		...
		GameShell.aFloat30 = local13.aFloat202 * local22.aFloat207 + local22.aFloat204 * local13.aFloat207 + local13.aFloat208 * local22.aFloat203;
		...
		@Pc(170) float local170 = Static445.aFloat222 + (float) this.lb * GameShell.aFloat30;
		@Pc(178) float local178 = GameShell.aFloat30 * (float) this.aShort28 + Static445.aFloat222;
		...
		if (arg1 != null) {
			...
			@Pc(526) int local526 = (int) (Static69.aFloat113 * (float) local507 + (float) this.lb * GameShell.aFloat30 + (float) local498 * Static234.aFloat140 + Static445.aFloat222);
			...
			@Pc(583) int local583 = (int) ((float) local507 * Static69.aFloat113 + (float) local498 * Static234.aFloat140 + Static445.aFloat222 + (float) this.aShort28 * GameShell.aFloat30);
	...
	public void method4889(@OriginalArg(0) Class31 arg0, @OriginalArg(1) Class3_Sub5 arg1, @OriginalArg(2) int arg2) {
		...
		GameShell.aFloat30 = local16.aFloat203 * local13.aFloat208 + local16.aFloat204 * local13.aFloat207 + local13.aFloat202 * local16.aFloat207;
		@Pc(174) float local174 = GameShell.aFloat30 * (float) this.lb + Static445.aFloat222;
		@Pc(182) float local182 = GameShell.aFloat30 * (float) this.aShort28 + Static445.aFloat222;
		...
		if (arg1 != null) {
			...
			@Pc(530) int local530 = (int) (Static69.aFloat113 * (float) local511 + Static234.aFloat140 * (float) local503 + Static445.aFloat222 + GameShell.aFloat30 * (float) this.lb);
			...
			@Pc(627) int local627 = (int) ((float) local511 * Static69.aFloat113 + Static445.aFloat222 + Static234.aFloat140 * (float) local503 + GameShell.aFloat30 * (float) this.aShort28);
	...
	private void method2808(@OriginalArg(0) boolean arg0) {
		...
		if (arg0) {
			if (this.anInterface1_2 == null) {
				this.anInterface1_2 = this.aClass19_Sub2_21.method1955(Static370.aNode_Sub12_Sub2_3.pos, true, Static370.aNode_Sub12_Sub2_3.data);
			} else {
				this.anInterface1_2.method3657(Static370.aNode_Sub12_Sub2_3.data, Static370.aNode_Sub12_Sub2_3.pos);
			}
			this.aClass230_1.anInterface1_5 = this.anInterface1_2;
		} else {
			this.aClass230_1.anInterface1_5 = this.aClass19_Sub2_21.method1955(Static370.aNode_Sub12_Sub2_3.pos, false, Static370.aNode_Sub12_Sub2_3.data);
		}
		if (!arg0) {
			this.aBoolean281 = true;
		}
