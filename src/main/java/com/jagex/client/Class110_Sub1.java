...
public final class Class110_Sub1 extends Class110 {
	...
	public Node_Sub1_Sub4 fa(@OriginalArg(0) Node_Sub1_Sub4 arg0) {
		...
		@Pc(182) Node_Sub1_Sub4_Sub1 local182 = (Node_Sub1_Sub4_Sub1) arg0;
		@Pc(198) Node_Sub1_Sub4_Sub1 local198;
		if (local182 != null && local182.method2301(local172, local179)) {
			local198 = local182;
			local182.method2304();
		} else {
			local198 = new Node_Sub1_Sub4_Sub1(this.aClass19_Sub2_21, local172, local179);
		}
	...
	private void method2799(@OriginalArg(1) boolean arg0) {
		...
		if (Static370.aClass4_Sub12_Sub2_3.data.length >= this.anInt3336 * local106) {
			...
			Static370.aClass4_Sub12_Sub2_3 = new Node_Sub12_Sub2(local106 * (this.anInt3336 + 100));
		}
		@Pc(191) int local191;
		@Pc(200) int local200;
		@Pc(228) int local228;
	...
	private void method2800(@OriginalArg(0) Node_Sub1_Sub4_Sub1 arg0) {
		if (Static231.anIntArray298.length < this.anInt3336) {
			Static231.anIntArray298 = new int[this.anInt3336];
			Static173.anIntArray219 = new int[this.anInt3336];
		}
	...
	private void method2808(@OriginalArg(0) boolean arg0) {
		if (this.anInt3301 * 6 > Static370.aClass4_Sub12_Sub2_3.data.length) {
			Static370.aClass4_Sub12_Sub2_3 = new Node_Sub12_Sub2(this.anInt3301 * 6 + 600);
		} else {
			Static370.aClass4_Sub12_Sub2_3.pos = 0;
		}
		@Pc(44) int local44;
