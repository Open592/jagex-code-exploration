...
public final class Class27_Sub4 extends Class27 {
  ...
  public void method3939(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
    @Pc(10)
    int local10 = this.anInt5157 * arg1 >> 12;
    @Pc(17)
    int local17 = arg1 * this.anInt5161 >> 12;
    @Pc(24)
    int local24 = arg0 * this.anInt5163 >> 12;
    @Pc(31)
    int local31 = this.anInt5160 * arg0 >> 12;
  ...
  public void method3936(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
    ...
    int local10 = this.anInt5157 * arg1 >> 12;
    @Pc(22)
    int local22 = this.anInt5161 * arg1 >> 12;
    @Pc(29)
    int local29 = this.anInt5163 * arg0 >> 12;
    @Pc(36)
    int local36 = this.anInt5160 * arg0 >> 12;
    Static237.method5623(
        super.anInt5152, super.anInt5154, local10, super.anInt5155, local29, local22, local36);
  }
