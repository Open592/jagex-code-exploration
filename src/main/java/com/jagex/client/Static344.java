...
public final class Static344 {
  ...
  public static void method4655(@OriginalArg(1) Class266_Sub1 arg0, @OriginalArg(2) byte[][] arg1) {
    @Pc(15)
    int local15 = Static386.aByteArrayArray15.length;
    for (@Pc(17) int local17 = 0; local17 < local15; local17++) {
      @Pc(23)
      byte[] local23 = arg1[local17];
      if (local23 != null) {
        @Pc(35)
        int local35 = (Static308.anIntArray372[local17] >> 8) * 64 - Static180.anInt3453;
        @Pc(46)
        int local46 = (Static308.anIntArray372[local17] & 0xFF) * 64 - Static86.anInt1771;
        Static159.method2701();
        arg0.method5646(
            Static175.aClass213Array1, local46, local23, local35, Static122.aClass19_16);
      }
    }
  }
  ...
  public static boolean method4656(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
    return (arg1 & 0x70000) != 0 | Static83.method1510(arg1, arg0)
        || Static273.method3914(arg0, arg1);
  }
  ...
  public static void method4658(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
    ...
    for (@Pc(18) Node_Sub39 local18 = (Node_Sub39) Static206.A_LINKED_LIST___28.tail();
        local18 != null;
        local18 = (Node_Sub39) Static206.A_LINKED_LIST___28.previous()) {
