...
public final class Class31_Sub1 extends Class31 {
    ...
    arg3[0] =
        (int)
            (this.aFloat208 * (float) arg2
                + (float) arg0 * this.aFloat202
                + (float) arg1 * this.aFloat207
                + this.aFloat209);
    arg3[1] =
        (int)
            (this.aFloat205
                + this.aFloat201 * (float) arg2
                + this.aFloat204 * (float) arg1
                + (float) arg0 * this.aFloat200);
    arg3[2] =
        (int)
            (this.aFloat206 * (float) arg0
                + this.aFloat203 * (float) arg1
                + this.aFloat199 * (float) arg2
                + this.aFloat198);
  }
  ...
  public void ka(@OriginalArg(0) int arg0) {
    @Pc(9)
    float local9 = Class21.aFloatArray3[arg0 & 0x3FFF];
    @Pc(15)
    float local15 = Class21.aFloatArray2[arg0 & 0x3FFF];
    @Pc(18)
    float local18 = this.aFloat200;
    @Pc(21)
    float local21 = this.aFloat204;
    @Pc(24)
    float local24 = this.aFloat201;
    @Pc(27)
    float local27 = this.aFloat205;
  ...
  public void s(
    ...
    @Pc(9)
    float local9 = Class21.aFloatArray3[arg3 & 0x3FFF];
    @Pc(15)
    float local15 = Class21.aFloatArray2[arg3 & 0x3FFF];
    @Pc(21)
    float local21 = Class21.aFloatArray3[arg4 & 0x3FFF];
    @Pc(27)
    float local27 = Class21.aFloatArray2[arg4 & 0x3FFF];
    @Pc(33)
    float local33 = Class21.aFloatArray3[arg5 & 0x3FFF];
    @Pc(39)
    float local39 = Class21.aFloatArray2[arg5 & 0x3FFF];
    @Pc(43)
    float local43 = local33 * local15;
    @Pc(47)
    float local47 = local39 * local15;
    ...
    this.aFloat209 =
        this.aFloat202 * (float) -arg0
            - (float) arg1 * this.aFloat207
            - (float) arg2 * this.aFloat208;
    this.aFloat205 =
        (float) -arg0 * this.aFloat200
            - this.aFloat204 * (float) arg1
            - (float) arg2 * this.aFloat201;
    this.aFloat198 =
        -((float) arg2 * this.aFloat199)
            + this.aFloat206 * (float) -arg0
            - (float) arg1 * this.aFloat203;
  }
  ...
  public void m(@OriginalArg(0) int[] arg0) {
    @Pc(11)
    float local11 = (float) arg0[0] - this.aFloat209;
    @Pc(20)
    float local20 = (float) arg0[1] - this.aFloat205;
    @Pc(28)
    float local28 = (float) arg0[2] - this.aFloat198;
    arg0[2] =
        (int) (local11 * this.aFloat208 + local20 * this.aFloat201 + local28 * this.aFloat199);
    arg0[1] =
        (int) (this.aFloat207 * local11 + this.aFloat204 * local20 + local28 * this.aFloat203);
    arg0[0] =
        (int) (local28 * this.aFloat206 + this.aFloat202 * local11 + local20 * this.aFloat200);
  }
  ...
  public void method5158(@OriginalArg(0) Class31 arg0) {
    ...
    this.aFloat209 =
        -(local6.aFloat205 * this.aFloat207
            + local6.aFloat209 * this.aFloat202
            + this.aFloat208 * local6.aFloat198);
    this.aFloat203 = local6.aFloat201;
    this.aFloat199 = local6.aFloat199;
    this.aFloat205 =
        -(this.aFloat201 * local6.aFloat198
            + this.aFloat200 * local6.aFloat209
            + this.aFloat204 * local6.aFloat205);
    this.aFloat198 =
        -(this.aFloat206 * local6.aFloat209
            + this.aFloat203 * local6.aFloat205
            + this.aFloat199 * local6.aFloat198);
  }
  ...
  public void method5159(
      ...
      @OriginalArg(6) float arg5) {
    if (arg0 == 0) {
      this.aFloat199 = 1.0F;
      this.aFloat200 =
          this.aFloat206 = this.aFloat207 = this.aFloat203 = this.aFloat208 = this.aFloat201 = 0.0F;
      this.aFloat202 = arg1;
      this.aFloat204 = arg3;
    } else {
      @Pc(10)
      float local10 = Class21.aFloatArray3[arg0 & 0x3FFF];
      @Pc(16)
      float local16 = Class21.aFloatArray2[arg0 & 0x3FFF];
      this.aFloat199 = 1.0F;
  ...
  public void ja(@OriginalArg(0) int arg0) {
    ...
    float local15 = Class21.aFloatArray2[arg0 & 0x3FFF];
    @Pc(18)
    float local18 = this.aFloat202;
    @Pc(21)
    float local21 = this.aFloat207;
    @Pc(24)
    float local24 = this.aFloat208;
    this.aFloat202 = local15 * this.aFloat206 + local9 * local18;
    @Pc(37)
    float local37 = this.aFloat209;
  ...
  public void ra(@OriginalArg(0) int arg0) {
    ...
    this.aFloat207 =
        this.aFloat209 =
            this.aFloat200 =
                this.aFloat201 = this.aFloat205 = this.aFloat203 = this.aFloat198 = 0.0F;
  ...
  public void p(
    ...
    arg3[1] =
        (int)
            ((float) arg0 * this.aFloat200
                + (float) arg1 * this.aFloat204
                + (float) arg2 * this.aFloat201);
    arg3[0] =
        (int)
            (this.aFloat207 * (float) arg1
                + this.aFloat202 * (float) arg0
                + (float) arg2 * this.aFloat208);
    arg3[2] =
        (int)
  ...
  public Class31 method5657() {
    @Pc(7)
    Class31_Sub1 local7 = new Class31_Sub1();
  ...
  public void O(@OriginalArg(0) int arg0) {
    ...
    this.aFloat208 =
        this.aFloat209 =
            this.aFloat201 =
                this.aFloat205 = this.aFloat206 = this.aFloat203 = this.aFloat198 = 0.0F;
  ...
  public void N(@OriginalArg(0) int arg0) {
    ...
    this.aFloat207 =
        this.aFloat208 =
            this.aFloat209 =
                this.aFloat200 = this.aFloat205 = this.aFloat206 = this.aFloat198 = 0.0F;
