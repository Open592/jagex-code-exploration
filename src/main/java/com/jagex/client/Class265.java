...
public final class Class265 {
  ...
  public Class41 method5588(@OriginalArg(1) int arg0) {
    @Pc(6)
    Class68 local6 = this.aClass68_59;
    @Pc(16)
    Class41 local16;
    synchronized (this.aClass68_59) {
    ...
    @Pc(38)
    byte[] local38 = this.aJs5_102.method2104(arg0, 34);
    local16 = new Class41();
    local16.aClass265_1 = this;
    if (local38 != null) {
      local16.method938(new Packet(local38));
    }
    @Pc(57)
    Class68 local57 = this.aClass68_59;
    synchronized (this.aClass68_59) {
