...
public final class ContextualEntry_Sub1_Sub17 extends ContextualEntry {
	...
	public boolean method4211() {
		...
		for (@Pc(121) int local121 = 0; local121 < local119.length; local121++) {
			...
			@Pc(144) LinkedEntry_Sub32 local144 = null;
			for (@Pc(149) LinkedEntry_Sub32 local149 = (LinkedEntry_Sub32) local103.method4140(); local149 != null; local149 = (LinkedEntry_Sub32) local103.method4144()) {
			...
			if (local144 == null) {
				local144 = new LinkedEntry_Sub32(local142, Static414.aClass76_96.method2122(local142));
