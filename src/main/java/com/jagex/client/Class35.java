...
public final class Class35 {
  ...
  static {
    new LocalizedString(
        "Your clan channel has now been disabled!",
  ...
  public boolean method816(
    ...
    int local54;
    if (this.anInt857 == 0) {
      if (this.anInt858 < arg2 && this.anInt858 + arg0 >= arg2
          || this.anInt858 > arg2 && this.anInt858 - arg0 <= arg2) {
        this.anInt858 = arg2;
        return false;
      }
      local42 = true;
