...
public final class LinkedHashEntry_Sub38 extends LinkedHashEntry {
	...
	public LinkedHashEntry_Sub4_Sub1[] aClass4_Sub4_Sub1Array1;
	...
	private LinkedHashEntry_Sub38() {
	}

	@OriginalMember(owner = "client!qh", name = "<init>", descriptor = "([B)V")
	public LinkedHashEntry_Sub38(@OriginalArg(0) byte[] arg0) {
		this.aShortArray192 = new short[128];
		this.aByteArray71 = new byte[128];
		this.aClass4_Sub4_Sub1Array1 = new LinkedHashEntry_Sub4_Sub1[128];
		...
		local36.pos++;
		local88++;
		@Pc(133) int local133 = local36.pos;
		local36.pos += local88;
		@Pc(141) int local141;
		...
		for (local202 = 0; local202 < local241.length; local202++) {
			...
			@Pc(257) int local257 = local36.g1();
			if (local257 > 0) {
	...
	public boolean method4398(@OriginalArg(0) Class171 arg0, @OriginalArg(2) byte[] arg1, @OriginalArg(3) int[] arg2) {
		...
		@Pc(18) int local18 = 0;
		@Pc(20) LinkedHashEntry_Sub4_Sub1 local20 = null;
