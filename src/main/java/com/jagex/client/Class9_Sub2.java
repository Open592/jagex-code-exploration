...
public final class Class9_Sub2 extends Class9 {
  ...
  public Class9_Sub2(@OriginalArg(0) Class19_Sub2 arg0, @OriginalArg(1) Class144 arg1) {
    ...
    if (this.aClass144_2.aClass6_Sub3_2 != null
        && super.aClass19_Sub2_41.aBoolean217
        && super.aClass19_Sub2_41.aBoolean214) {
      @Pc(30)
      Class267 local30 =
          Static325.method4397(
              super.aClass19_Sub2_41,
              35633,
      ...
      this.aClass210_3 =
          Static256.method3694(new Class267[] {local30, local37}, super.aClass19_Sub2_41);
  ...
  public void method5371(@OriginalArg(1) boolean arg0) {
    @Pc(13)
    Class6_Sub4 local13 = super.aClass19_Sub2_41.method1946();
    if (!this.aBoolean146 || local13 == null) {
      return;
    }
    @Pc(31)
    float local31 = (1.0F - Math.abs(super.aClass19_Sub2_41.aFloatArray19[1])) * 2.0F + 1.0F;
    ...
    @Pc(59)
    long local59 = this.aClass210_3.aLong202;
    ...
    OpenGL.glUniform3fARB(
        OpenGL.glGetUniformLocationARB(local59, "sunDir"),
        -super.aClass19_Sub2_41.aFloatArray19[0],
        -super.aClass19_Sub2_41.aFloatArray19[1],
        -super.aClass19_Sub2_41.aFloatArray19[2]);
    OpenGL.glUniform4fARB(
        OpenGL.glGetUniformLocationARB(local59, "sunColour"),
        local31 * super.aClass19_Sub2_41.aFloat72,
        super.aClass19_Sub2_41.aFloat58 * local31,
        super.aClass19_Sub2_41.aFloat74 * local31,
        1.0F);
    OpenGL.glUniform1fARB(
        OpenGL.glGetUniformLocationARB(local59, "sunExponent"),
        Math.abs(super.aClass19_Sub2_41.aFloatArray19[1]) * 928.0F + 64.0F);
  ...
  public void method5370(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
    ...
    @Pc(8)
    int local8 = 0x1 << (arg0 & 0x3);
    @Pc(19)
    float local19 = (float) (0x1 << (arg0 >> 3 & 0x7)) / 32.0F;
    @Pc(23)
    int local23 = arg1 & 0xFFFF;
    @Pc(32)
    float local32 = (float) (arg1 >> 16 & 0x3) / 8.0F;
    @Pc(41)
    float local41 = (float) (arg1 >> 19 & 0xF) / 16.0F;
    @Pc(50)
    float local50 = (float) (arg1 >> 23 & 0xF) / 16.0F;
    @Pc(56)
    int local56 = arg1 >> 27 & 0xF;
    @Pc(60)
    long local60 = this.aClass210_3.aLong202;
    OpenGL.glUniform1fARB(
        OpenGL.glGetUniformLocationARB(local60, "time"),
        (float) (super.aClass19_Sub2_41.anInt2274 * local8 % 40000) / 40000.0F);
    OpenGL.glUniform1fARB(OpenGL.glGetUniformLocationARB(local60, "scale"), local19);
    OpenGL.glUniform1fARB(
        OpenGL.glGetUniformLocationARB(local60, "breakWaterDepth"), (float) local23);
    OpenGL.glUniform1fARB(OpenGL.glGetUniformLocationARB(local60, "breakWaterOffset"), local32);
    OpenGL.glUniform2fARB(
        OpenGL.glGetUniformLocationARB(local60, "waveIntensity"), local50, local41);
