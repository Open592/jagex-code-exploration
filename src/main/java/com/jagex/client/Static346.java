...
public final class Static346 {
  ...
  public static long method4675(
      @OriginalArg(1) int arg0, @OriginalArg(2) Interface6 arg1, @OriginalArg(3) int arg2) {
    @Pc(5)
    long local5 = 4194304L;
    @Pc(7)
    long local7 = 2147483648L;
    @Pc(9)
    long local9 = Long.MIN_VALUE;
    @Pc(16)
    Class202 local16 = Static267.aClass262_2.method5560(arg1.method5350());
    @Pc(37)
    long local37 =
        (long) ((arg2 | 0x800000) << 7 | arg0 | arg1.method5354() << 14 | arg1.method5347() << 20);
