...
public final class Class55 {
  ...
  @OriginalMember(
      owner = "client!du",
      name = "<init>",
      descriptor = "(Lclient!jk;ILclient!fs;Lclient!fs;Lclient!fs;)V")
  public Class55(
    ...
    if (this.aJs5_21 != null) {
      @Pc(26)
      int local26 = this.aJs5_21.method2100() - 1;
  ...
  public SecondaryNode_Sub1_Sub17 method1391(@OriginalArg(0) int arg0) {
    @Pc(6)
    Class68 local6 = this.aClass68_6;
    @Pc(22)
    SecondaryNode_Sub1_Sub17 local22;
  ...
  public void method1392() {
    @Pc(2)
    Class68 local2 = this.aClass68_5;
  ...
  public void method1394() {
    @Pc(10)
    Class68 local10 = this.aClass68_5;
    synchronized (this.aClass68_5) {
  ...
  public void method1396() {
    @Pc(6)
    Class68 local6 = this.aClass68_5;
    synchronized (this.aClass68_5) {
      this.aClass68_5.clear();
    }
    local6 = this.aClass68_6;
    synchronized (this.aClass68_6) {
      this.aClass68_6.clear();
    }
  }
  ...
  public Class138 method1397(@OriginalArg(1) int arg0) {
    ...
    @Pc(37)
    byte[] local37 =
        this.aJs5_21.method2104(Static127.method2266(arg0), Static132.method2318(arg0));
    local16 = new Class138();
    local16.anInt4411 = arg0;
    local16.aClass55_2 = this;
    if (local37 != null) {
      local16.method3455(new Packet(local37));
    }
    local16.method3460();
    @Pc(68)
    Class68 local68 = this.aClass68_5;
    synchronized (this.aClass68_5) {
