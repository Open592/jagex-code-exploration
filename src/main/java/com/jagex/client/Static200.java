...
public final class Static200 {
  ...
  public static String method3166(@OriginalArg(1) Node_Sub39 arg0) {
  ...
  public static void method3167(
    ...
    @Pc(10)
    int local10 = arg3 - arg4;
    @Pc(15)
    int local15 = arg1 - arg2;
    if (local10 == 0) {
      if (local15 != 0) {
      ...
      @Pc(55)
      int local55 = (local15 << 12) / local10;
      @Pc(63)
      int local63 = arg2 - (local55 * arg4 >> 12);
      @Pc(80)
      int local80;
      @Pc(78)
      int local78;
  ...
  public static int method3169(@OriginalArg(0) Class113 arg0, @OriginalArg(1) Class19 arg1) {
    ...
    if (arg0.anInt3378 != -1) {
      @Pc(35)
      Class251 local35 =
          arg1.anInterface7_6.method2396(arg1.method4243() ? arg0.anInt3378 : arg0.anInt3375);
