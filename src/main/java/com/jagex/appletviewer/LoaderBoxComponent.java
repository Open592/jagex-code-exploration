...
final class LoaderBoxComponent extends Component {
  ...
  public void paint(Graphics graphics) {
    try {
      ...
      graphics.fillRect(
          ...
          (this.getSize().height / 2) - 16,
          this.currentProgress * 300 / 100,
          30);
      ...
      graphics.drawString(
          loaderBoxContent,
          (this.getSize().width - this.loadingTextFontMetrics.stringWidth(loaderBoxContent)) / 2,
          4 + this.getSize().height / 2);
  ...
  static void initialize() {
    ...
    classInstance.loadingTextFontMetrics =
        classInstance.getFontMetrics(classInstance.loadingTextFont);
