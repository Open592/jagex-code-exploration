  ...
  static void initialize(Language language) {
    switch (language) {
      case ENGLISH:
        {
          ...
          AppletViewer.localeStrings.put(
              "err_load_config",
      ...
      case FRENCH:
        {
          AppletViewer.localeStrings.put(
              "err_missing_config", "Paramètre com.jagex.config manquant");
          AppletViewer.localeStrings.put(
              "err_invalid_config", "Paramètre com.jagex.config non valide");
          ...
          AppletViewer.localeStrings.put(
              "err_decode_config", "Erreur de décodage de configuration");
      ...
      case GERMAN:
        {
          AppletViewer.localeStrings.put(
              "err_missing_config", "Einstellung com.jagex.config fehlt");
          AppletViewer.localeStrings.put(
              "err_invalid_config", "Einstellung com.jagex.config ist ungültig");
          AppletViewer.localeStrings.put("loading_config", "Lade Konfiguration");
          AppletViewer.localeStrings.put(
              "err_load_config",
              "Beim Laden der Spielkonfiguration von der Website ist ein Fehler aufgetreten.\nBitte überprüfen Sie Ihre Firewall-Einstellungen.");
          AppletViewer.localeStrings.put(
              "err_decode_config", "Fehler beim Entschlüsseln der Konfiguration");
      ...
      case BRAZILIAN_PORTUGUESE:
        {
          AppletViewer.localeStrings.put(
              "err_missing_config", "Faltando configuração de com.jagex.config");
          AppletViewer.localeStrings.put(
              "err_invalid_config", "Configuração inválida de com.jagex.config");
